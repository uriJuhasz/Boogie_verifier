...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_108) (and (not $is_unwrap_check) (not $is_stuttering_check)))
      (= (= true $@bf_207) (forall ((|f_$8| $pure_function))(!(< ($frame_level f_$8) $current_frame_level):pattern ( ($frame_level f_$8))  )))
      (= (= true $@bf_209) (forall ((|f_$10| $pure_function))(!(< ($pure_post_level f_$10) $current_frame_level):pattern ( ($frame_level f_$10))  )))
