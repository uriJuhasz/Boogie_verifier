...
PreconditionGeneratedEntry:
	...
	assume $non_null($rd_phys_ptr($s,Node.right,$phys_ptr_cast(P#x,^Node),^Node));
...
anon46:
	...
	assume $def_writes($s,#wrTime$1^203.1,lambda#23(^Tree,P#t));
	...
	assert  $wrapped($s_$_0,$phys_ptr_cast(P#x,^Node),^Node);
	assert  $top_writable($s_$_0,#wrTime$1^203.1,$phys_ptr_cast(P#x,^Node));
	assume $inv($s_$_0,$phys_ptr_cast(P#x,^Node),^Node);
	...
	assert  (!$is_claimable($typ(call0formal_$_o_$_0_$1))) || ($ref_cnt($s_$_0,call0formal_$_o_$_0_$1) == 0);
	...
	assume L#y_$_0 == $rd_phys_ptr($s_$_1,Node.right,$phys_ptr_cast(P#x,^Node),^Node);
	...
	assert  $wrapped($s_$_1,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	assert  $top_writable($s_$_1,#wrTime$1^203.1,$phys_ptr_cast(L#y_$_0,^Node));
	assume $inv($s_$_1,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	...
	assert  (!$is_claimable($typ(call0formal_$_o_$_0_$2))) || ($ref_cnt($s_$_1,call0formal_$_o_$_0_$2) == 0);
	...
	assert  $writable_prim($s_$_2,#wrTime$1^203.1,$dot($phys_ptr_cast(P#x,^Node),Node.right));
	assert  $thread_local($s_$_2,$phys_ptr_cast(L#y_$_0,^Node));
	assume call1formal_$_p_$_0 == $phys_ptr_cast(P#x,^Node);
	assume call2formal_$_v_$_0 == $ptr_to_int($rd_phys_ptr($s_$_2,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node));
	assume $specials_eq($s_$_2,$s_$_3);
	assume $heap($s_$_3) == $update($heap($s_$_2),call1formal_$_p_$_0,Node.right,call2formal_$_v_$_0);
...
anon00_Then:
	assume $non_null($rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node));
	...
	assert  $wrapped($s_$_3,$rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node),^Node);
	assert  $top_writable($s_$_3,#wrTime$1^203.1,$rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node));
	assume $inv($s_$_3,$rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node),^Node);
	assume owns#53_$_0 == $owns($s_$_3,$rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node));
	assume $pre_static_unwrap($s_$_3);
	assume call0formal_$_o_$_0_$8 == $rd_phys_ptr($s_$_3,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	assert  (!$is_claimable($typ(call0formal_$_o_$_0_$8))) || ($ref_cnt($s_$_3,call0formal_$_o_$_0_$8) == 0);
	...
	assert  $writable_prim($s_$_4,#wrTime$1^203.1,$dot($rd_phys_ptr($s_$_4,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node),Node.parent));
	assert  $thread_local($s_$_4,$phys_ptr_cast(L#y_$_0,^Node));
	assume call1formal_$_p_$_0_$9 == $rd_phys_ptr($s_$_4,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	assume call2formal_$_v_$_0_$9 == $ptr_to_int($phys_ptr_cast(P#x,^Node));
	assume $specials_eq($s_$_4,$s_$_5);
	assume $heap($s_$_5) == $update($heap($s_$_4),call1formal_$_p_$_0_$9,Node.parent,call2formal_$_v_$_0_$9);
	...
	assert  $top_writable($s_$_5,#wrTime$1^203.1,$rd_phys_ptr($s_$_5,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node));
	assume $pre_static_wrap($s_$_5);
	assume call0formal_$_o_$_0_$9 == $rd_phys_ptr($s_$_5,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	assert  $pre_static_wrap($s_$_5);
	assert  $is_non_primitive($typ(call0formal_$_o_$_0_$9));
	assert  $mutable($s_$_5,call0formal_$_o_$_0_$9);
	assume $is_wrapped($s_$_5,$s_$_6,call0formal_$_o_$_0_$9,owns#56_$_0);
	assume $heap($s_$_6) == $update($heap($s_$_5),call0formal_$_o_$_0_$9,$f_owns($typ(call0formal_$_o_$_0_$9)),$ptrset_to_int(owns#56_$_0));
	assume $f_owner($s_$_6) == $f_owner(staticWrapState#55_$_0);
	assume $good_state_ext(#tok$1^218.34,$s_$_6);
	assert  $set_eq($owns($s_$_6,$rd_phys_ptr($s_$_6,Node.left,$phys_ptr_cast(L#y_$_0,^Node),^Node)),$set_empty());
...
anon00_Else:
	...
	goto anon47;
anon47:
	assert  $writable_prim($s_$_7,#wrTime$1^203.1,$dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent));
	assert  $thread_local($s_$_7,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$1 == $phys_ptr_cast(L#y_$_0,^Node);
	assume call2formal_$_v_$_0_$1 == $ptr_to_int($rd_phys_ptr($s_$_7,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assume $specials_eq($s_$_7,$s_$_8);
	assume $heap($s_$_8) == $update($heap($s_$_7),call1formal_$_p_$_0_$1,Node.parent,call2formal_$_v_$_0_$1);
...
anon01_Then:
	assume $is_null($rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assert  $writable_prim($s_$_8,#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.root));
	assume call1formal_$_p_$_0_$8 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$8 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume $specials_eq($s_$_8,$s_$_9);
	assume $heap($s_$_9) == $update($heap($s_$_8),call1formal_$_p_$_0_$8,Tree.root,call2formal_$_v_$_0_$8);
...
anon01_Else:
	assume !$is_null($rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assert  F#doMark($rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assume F#doMark($rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	...
	assert  $wrapped($s_$_8,$rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),^Node);
	assert  $top_writable($s_$_8,#wrTime$1^203.1,$rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assume $inv($s_$_8,$rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),^Node);
	assume owns#59_$_0 == $owns($s_$_8,$rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assume $pre_static_unwrap($s_$_8);
	assume call0formal_$_o_$_0_$3 == $rd_phys_ptr($s_$_8,Node.parent,$phys_ptr_cast(P#x,^Node),^Node);
	assert  (!$is_claimable($typ(call0formal_$_o_$_0_$3))) || ($ref_cnt($s_$_8,call0formal_$_o_$_0_$3) == 0);
	...
	assert  $thread_local($s_$_10,$rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume true;
	if ($_$_condition_$1) { goto anon02_Then; } else { goto anon02_Else; }
anon48:
	assert  $writable_prim($s_$_15,#wrTime$1^203.1,$dot($phys_ptr_cast(L#y_$_0,^Node),Node.left));
	assume call1formal_$_p_$_0_$3 == $phys_ptr_cast(L#y_$_0,^Node);
	assume call2formal_$_v_$_0_$3 == $ptr_to_int($phys_ptr_cast(P#x,^Node));
	assume $specials_eq($s_$_15,$s_$_16);
	assume $heap($s_$_16) == $update($heap($s_$_15),call1formal_$_p_$_0_$3,Node.left,call2formal_$_v_$_0_$3);
	assume $timestamp_post_strict($s_$_15,$s_$_16);
	assume $full_stop_ext(#tok$1^231.3,$s_$_16);
	assert  $writable_prim($s_$_16,#wrTime$1^203.1,$dot($phys_ptr_cast(P#x,^Node),Node.parent));
	...
	assume $heap($s_$_17) == $update($heap($s_$_16),call1formal_$_p_$_0_$4,Node.parent,call2formal_$_v_$_0_$4);
	...
	assert  $is_non_primitive($typ(call0formal_$_o_$_0_$5));
	assert  $mutable($s_$_17,call0formal_$_o_$_0_$5);
	assume $is_wrapped($s_$_17,$s_$_18,call0formal_$_o_$_0_$5,owns#65_$_0);
	assume $heap($s_$_18) == $update($heap($s_$_17),call0formal_$_o_$_0_$5,$f_owns($typ(call0formal_$_o_$_0_$5)),$ptrset_to_int(owns#65_$_0));
	...
	assume $heap($s_$_19) == $update($heap($s_$_18),call0formal_$_o_$_0_$6,$f_owns($typ(call0formal_$_o_$_0_$6)),$ptrset_to_int(owns#68_$_0));
	...
	assert  F#doMark($rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node));
	assume F#doMark($rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node));
	assert  (forall  Q#m$1^236.26#dt1 : $ptr :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(L#y_$_0,^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)) ==> ($rd_inv($s_$_19,Node.key,$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)) > $rd_inv($s_$_19,Node.key,$phys_ptr_cast(P#x,^Node))) ));
	assume (forall  Q#m$1^236.26#dt1_$0 : $ptr :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(L#y_$_0,^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_19,Node.right,$phys_ptr_cast(P#x,^Node),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)) ==> ($rd_inv($s_$_19,Node.key,$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)) > $rd_inv($s_$_19,Node.key,$phys_ptr_cast(P#x,^Node))) ));
	assert  $writable_prim($s_$_19,#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.R));
	assert  $thread_local($s_$_19,$phys_ptr_cast(P#t,^Tree));
	assert  $thread_local($s_$_19,$phys_ptr_cast(P#t,^Tree));
	assume call1formal_$_p_$_0_$5 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$5 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(L#y_$_0,^Node),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_19,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(P#x,^Node))));
	assume $specials_eq($s_$_19,$s_$_20);
	assume $heap($s_$_20) == $update($heap($s_$_19),call1formal_$_p_$_0_$5,Tree.R,call2formal_$_v_$_0_$5);
	...
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#t,^Tree));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#x,^Node));
	assume call0formal_$_#l2_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_20,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_20,Node.right,$phys_ptr_cast(P#x,^Node),^Node));
	assume call1formal_$_#l1_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_20,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_20,Node.left,$phys_ptr_cast(P#x,^Node),^Node));
	...
	assert  $writable_prim($s_$_20,#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.R));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#t,^Tree));
	assume call1formal_$_p_$_0_$6 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$6 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_20,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(P#x,^Node),call3formal_$_$result_$_0));
	assume $specials_eq($s_$_20,$s_$_21);
	assume $heap($s_$_21) == $update($heap($s_$_20),call1formal_$_p_$_0_$6,Tree.R,call2formal_$_v_$_0_$6);
	...
	assert  (forall  #writes$1^243.19 : $ptr :: {$dont_instantiate(#writes$1^243.19)} ( $set_in(#writes$1^243.19,$owns($s_$_21,$phys_ptr_cast(P#t,^Tree))) ==> $top_writable($s_$_21,#wrTime$1^203.1,#writes$1^243.19) ));
	...
	assert  (forall  p_$222 : $ptr :: {$dont_instantiate(p_$222)} ( $set_in0(p_$222,$owns($s_$_21,call0formal_$_o_$_0_$7)) ==> $wrapped($s_$_21,p_$222,$typ(p_$222)) ));
	...
	assert  (forall  Q#m$1^82.29#dt1_$5 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast($null,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$5,^Node))} {:weight  10}( !$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast($null,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$5,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$10 : $ptr, Q#m$1^82.29#dt1_$6 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)),^Node),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)),^Node),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node)) ==> ($rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node)) < $rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$11 : $ptr, Q#m$1^82.29#dt1_$7 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)),^Node),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)),^Node),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node)) ==> ($rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node)) > $rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)))) ));
	assert  (forall  Q#m$1^82.29#dt1_$8 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node))} {F#mark2($phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node))} {sk_hack(F#mark2($phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node)))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node)) <==> $set_in($phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node),$owns($s_$_22,$phys_ptr_cast(P#t,^Tree))) ));
	assert  (forall  Q#n$1^82.29#dt1_$12 : $ptr, Q#m$1^82.29#dt1_$9 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$12,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$12,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$13 : $ptr, Q#m$1^82.29#dt1_$10 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$10,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$10,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$14 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),^Node),^Node))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),$rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$15 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)),^Node),^Node))) ==> ($rd_phys_ptr($s_$_22,Node.parent,$rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node),^Node),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$16 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),^Node),^Node))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),$rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$17 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)),^Node),^Node))) ==> ($rd_phys_ptr($s_$_22,Node.parent,$rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node),^Node),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$18 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)),^Node),^Node))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$19 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)) && $non_null($rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)),^Node),^Node))) ==> (($rd_phys_ptr($s_$_22,Node.left,$rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node),^Node),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)) || ($rd_phys_ptr($s_$_22,Node.right,$rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node),^Node),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node))) ));
	assert  (forall  Q#n$1^82.29#dt1_$20 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)) ));
	assert  true;
	assert  (forall  Q#m$1^83.29#dt1_$1 : $ptr :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($rd_inv($s_$_22,Tree.abs,$phys_ptr_cast(P#t,^Tree))),$rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($rd_inv($s_$_22,Tree.abs,$phys_ptr_cast(P#t,^Tree))),$rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node))) == $rd_inv($s_$_22,Node.value,$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node))) ));
	assert  (forall  Q#k$1^83.29#tc2_$0 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($rd_inv($s_$_22,Tree.abs,$phys_ptr_cast(P#t,^Tree))),Q#k$1^83.29#tc2_$0)} {:weight  10}( $in_range_i4(Q#k$1^83.29#tc2_$0) ==> (((forall  Q#m$1^83.29#dt1_$2 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node)) ==> (!($rd_inv($s_$_22,Node.key,$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node)) == Q#k$1^83.29#tc2_$0)) ))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($rd_inv($s_$_22,Tree.abs,$phys_ptr_cast(P#t,^Tree))),Q#k$1^83.29#tc2_$0) == 0)) ));
	assert  (forall  Q#n$1^84.29#dt1_$1 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)) && $is_null($rd_phys_ptr($s_$_22,Node.parent,$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)),^Node),^Node))) ==> (($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node) == $phys_ptr_cast($null,^Node)) || ($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node) == $rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node))) ));
	assert  (forall  Q#n$1^84.29#dt1_$2 : $ptr, Q#m$1^84.29#dt1_$0 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node)) <==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)) && ((((($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node) == $phys_ptr_cast($null,^Node)) && ($phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node) == $phys_ptr_cast($null,^Node))) || ($phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node) == $phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.left,$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Node.right,$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node)))) ));
	assume $full_stop($s_$_22);
	assert  $position_marker();
	assert  $eq.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node)),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($rd_inv($s_$_22,Tree.R,$phys_ptr_cast(P#t,^Tree))),$rd_phys_ptr($s_$_22,Tree.root,$phys_ptr_cast(P#t,^Tree),^Node))) && $eq.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($rd_inv($s,Tree.abs,$phys_ptr_cast(P#t,^Tree))),$int_to_map_t..^^i4.^^i4($rd_inv($s_$_22,Tree.abs,$phys_ptr_cast(P#t,^Tree))));
	assert  $wrapped($s_$_22,$phys_ptr_cast(P#t,^Tree),^Tree);
	goto $exit;
anon02_Then:
	assume $ptr_eq($rd_phys_ptr($s_$_10,Node.left,$rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),^Node),$phys_ptr_cast(P#x,^Node));
	assert  $writable_prim($s_$_10,#wrTime$1^203.1,$dot($rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),Node.left));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$7 == $rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node);
	assume call2formal_$_v_$_0_$7 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume $specials_eq($s_$_10,$s_$_11);
	assume $heap($s_$_11) == $update($heap($s_$_10),call1formal_$_p_$_0_$7,Node.left,call2formal_$_v_$_0_$7);
...
anon02_Else:
	assume !$ptr_eq($rd_phys_ptr($s_$_10,Node.left,$rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),^Node),$phys_ptr_cast(P#x,^Node));
	assert  $writable_prim($s_$_10,#wrTime$1^203.1,$dot($rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node),Node.right));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$2 == $rd_phys_ptr($s_$_10,Node.parent,$phys_ptr_cast(P#x,^Node),^Node);
	assume call2formal_$_v_$_0_$2 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume $specials_eq($s_$_10,$s_$_12);
	assume $heap($s_$_12) == $update($heap($s_$_10),call1formal_$_p_$_0_$2,Node.right,call2formal_$_v_$_0_$2);
...
anon45:
	...
	assert  $top_writable($s_$_13,#wrTime$1^203.1,$rd_phys_ptr($s_$_13,Node.parent,$phys_ptr_cast(P#x,^Node),^Node));
	assume $pre_static_wrap($s_$_13);
	assume call0formal_$_o_$_0_$4 == $rd_phys_ptr($s_$_13,Node.parent,$phys_ptr_cast(P#x,^Node),^Node);
	...
	assume $heap($s_$_14) == $update($heap($s_$_13),call0formal_$_o_$_0_$4,$f_owns($typ(call0formal_$_o_$_0_$4)),$ptrset_to_int(owns#62_$_0));
	assume $f_owner($s_$_14) == $f_owner(staticWrapState#61_$_0);
	assume $good_state_ext(#tok$1^224.32,$s_$_14);
	assert  $set_eq($owns($s_$_14,$rd_phys_ptr($s_$_14,Node.parent,$phys_ptr_cast(P#x,^Node),^Node)),$set_empty());
