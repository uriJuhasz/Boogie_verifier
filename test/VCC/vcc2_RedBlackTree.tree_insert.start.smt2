...
(let (($@hash@break_11@39 (=> (and true
    $position_marker
    (= $s@23 $s@22)
  )
    $@hash@exit
)))
(let ((anon00_Then@39 (=> (and true
    $position_marker
    (= $s@23 $s@9)
  )
    $@hash@exit
