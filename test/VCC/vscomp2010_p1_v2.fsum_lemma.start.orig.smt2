...
(declare-fun anon9@2_assertion ( ) Bool)
(declare-fun anon9@3 ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_137) (forall ((|f_$22| $pure_function))(!(< ($frame_level f_$22) $current_frame_level):pattern ( ($frame_level f_$22))  )))
      (= (= true $@bf_150) (and (not $is_unwrap_check) (not $is_stuttering_check)))
      (= (= true $@bf_48) ($is_volatile_field ($f_owns ^^claim)))
      (= (= true $@bf_49) ($is_sequential_field ($f_owns ^^claim)))
      (= (= true $@bf_50) ($is_volatile_field ($f_owns ^$@volatile_version_t)))
      (= (= true $@bf_51) ($is_sequential_field ($f_owns ^$@volatile_version_t)))
      (= (= true $@bf_53) ($is_volatile_field ($f_owns ^$@thread_id_t)))
      (= (= true $@bf_54) ($is_sequential_field ($f_owns ^$@thread_id_t)))
      (= (= true $@bf_56) ($is_volatile_field ($f_owns $inactive_union_owner_type)))
      (= (= true $@bf_57) ($is_sequential_field ($f_owns $inactive_union_owner_type)))
...
(or anon9@2_assertion anon9@3)
)) :named ax_anon9@2))
(assert (! (=> anon9@2_assertion (not (and true
   (and true
      (<= SP@i SP@j)
   )
))) :named ax_anon9@2_assertion))
(assert (! (=> anon9@3 (and true 
   (and true
      (<= SP@i SP@j)
   )
anon00_LoopHead
...
(assert (! (=> $@hash@break_5 (and true 
   (and true
   )
(or $@hash@break_5@1 $@hash@break_5_assertion)
)) :named ax_$@hash@break_5))
