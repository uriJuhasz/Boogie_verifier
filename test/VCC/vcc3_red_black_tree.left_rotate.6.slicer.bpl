...
var call0formal_$_o_$_0_$9 : $ptr;
var $s_$_6 : $state;
...
PreconditionGeneratedEntry:
	...
	assume !($phys_ptr_cast($int_to_ptr($heap($s)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node)))));
...
anon46:
	...
	assume $writes_at(#wrTime$1^203.1) == lambda#23(^Tree,P#t);
	...
	assert  ((($is($phys_ptr_cast(P#x,^Node),^Node) && $is_proper($phys_ptr_cast(P#x,^Node))) && ($owner($s_$_0,$phys_ptr_cast(P#x,^Node)) == $me())) && $closed($s_$_0,$phys_ptr_cast(P#x,^Node))) && (!$is_primitive(^Node));
	assert  $top_writable($s_$_0,#wrTime$1^203.1,$phys_ptr_cast(P#x,^Node));
	assume $inv2($s_$_0,$s_$_0,$phys_ptr_cast(P#x,^Node),^Node);
	assume owns#47_$_0 == $owns($s_$_0,$phys_ptr_cast(P#x,^Node));
	assume $pre_static_unwrap($s_$_0);
	assume call0formal_$_o_$_0_$1 == $phys_ptr_cast(P#x,^Node);
	assert  (!$is_claimable($field_type($field(call0formal_$_o_$_0_$1)))) || ($ref_cnt($s_$_0,call0formal_$_o_$_0_$1) == 0);
	assert  $pre_static_unwrap($s_$_0);
	assume $is_unwrapped($s_$_0,$s_$_1,call0formal_$_o_$_0_$1);
	assume $f_owner($s_$_1) == $f_owner(prestate#48_$_0);
	assume $f_timestamp($s_$_1) == $f_timestamp(prestate#48_$_0)[call0formal_$_o_$_0_$1 := $current_timestamp($s_$_0)];
	assume $good_state_ext(#tok$1^212.53,$s_$_1);
	assume $full_stop($s_$_1);
	assert  $thread_local($s_$_1,$phys_ptr_cast(P#x,^Node));
	assume L#y_$_0 == $phys_ptr_cast($int_to_ptr($heap($s_$_1)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node);
	assume $local_value_is($s_$_1,#tok$1^213.3,#loc.y,$ptr_to_int(L#y_$_0),$ptr_to(^Node));
	assert  F#doMark($phys_ptr_cast(L#y_$_0,^Node));
	assume F#doMark($phys_ptr_cast(L#y_$_0,^Node));
	...
	assert  ((($is($phys_ptr_cast(L#y_$_0,^Node),^Node) && $is_proper($phys_ptr_cast(L#y_$_0,^Node))) && ($owner($s_$_1,$phys_ptr_cast(L#y_$_0,^Node)) == $me())) && $closed($s_$_1,$phys_ptr_cast(L#y_$_0,^Node))) && (!$is_primitive(^Node));
	assert  $top_writable($s_$_1,#wrTime$1^203.1,$phys_ptr_cast(L#y_$_0,^Node));
	assume $inv2($s_$_1,$s_$_1,$phys_ptr_cast(L#y_$_0,^Node),^Node);
	assume owns#50_$_0 == $owns($s_$_1,$phys_ptr_cast(L#y_$_0,^Node));
	assume $pre_static_unwrap($s_$_1);
	assume call0formal_$_o_$_0_$2 == $phys_ptr_cast(L#y_$_0,^Node);
	assert  (!$is_claimable($field_type($field(call0formal_$_o_$_0_$2)))) || ($ref_cnt($s_$_1,call0formal_$_o_$_0_$2) == 0);
	assert  $pre_static_unwrap($s_$_1);
	assume $is_unwrapped($s_$_1,$s_$_2,call0formal_$_o_$_0_$2);
	assume $f_owner($s_$_2) == $f_owner(prestate#51_$_0);
	assume $f_timestamp($s_$_2) == $f_timestamp(prestate#51_$_0)[call0formal_$_o_$_0_$2 := $current_timestamp($s_$_1)];
	assume $good_state_ext(#tok$1^214.53,$s_$_2);
	assume $full_stop($s_$_2);
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(P#x,^Node),Node.right)))) && $is_proper($dot($phys_ptr_cast(P#x,^Node),Node.right))) && ($mutable($s_$_2,$emb0($dot($phys_ptr_cast(P#x,^Node),Node.right))) && (($timestamp($s_$_2,$emb0($dot($phys_ptr_cast(P#x,^Node),Node.right))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(P#x,^Node),Node.right))));
	assert  $thread_local($s_$_2,$phys_ptr_cast(L#y_$_0,^Node));
	assume call1formal_$_p_$_0 == $phys_ptr_cast(P#x,^Node);
	assume call2formal_$_v_$_0 == $ptr_to_int($phys_ptr_cast($int_to_ptr($heap($s_$_2)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node));
	...
	assume $heap($s_$_3) == $heap($s_$_2)[Node.right := $heap($s_$_2)[Node.right][call1formal_$_p_$_0 := call2formal_$_v_$_0]];
	...
	assert  $thread_local($s_$_3,$phys_ptr_cast(L#y_$_0,^Node));
	assume true;
	if ($_$_condition) { goto anon00_Then; } else { goto anon00_Else; }
anon00_Then:
	assume $_$_condition;
	assume $_$_condition <==> (!($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node))))));
	assume !($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node)))));
	...
	assert  ((($is($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),^Node) && $is_proper($phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node))) && ($owner($s_$_3,$phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node)) == $me())) && $closed($s_$_3,$phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node))) && (!$is_primitive(^Node));
	assert  $top_writable($s_$_3,#wrTime$1^203.1,$phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node));
	assume $inv2($s_$_3,$s_$_3,$phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),^Node);
	assume owns#53_$_0 == $owns($s_$_3,$phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node));
	assume $pre_static_unwrap($s_$_3);
	assume call0formal_$_o_$_0_$8 == $phys_ptr_cast($int_to_ptr($heap($s_$_3)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node);
	assert  (!$is_claimable($field_type($field(call0formal_$_o_$_0_$8)))) || ($ref_cnt($s_$_3,call0formal_$_o_$_0_$8) == 0);
	assert  $pre_static_unwrap($s_$_3);
	assume $is_unwrapped($s_$_3,$s_$_4,call0formal_$_o_$_0_$8);
	assume $f_owner($s_$_4) == $f_owner(prestate#54_$_0);
	assume $f_timestamp($s_$_4) == $f_timestamp(prestate#54_$_0)[call0formal_$_o_$_0_$8 := $current_timestamp($s_$_3)];
	assume $good_state_ext(#tok$1^218.34,$s_$_4);
	assume $full_stop($s_$_4);
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),Node.parent)))) && $is_proper($dot($phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),Node.parent))) && ($mutable($s_$_4,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),Node.parent))) && (($timestamp($s_$_4,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),Node.parent))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node),Node.parent))));
	assert  $thread_local($s_$_4,$phys_ptr_cast(L#y_$_0,^Node));
	assume call1formal_$_p_$_0_$9 == $phys_ptr_cast($int_to_ptr($heap($s_$_4)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node);
	...
	assume $heap($s_$_5) == $heap($s_$_4)[Node.parent := $heap($s_$_4)[Node.parent][call1formal_$_p_$_0_$9 := call2formal_$_v_$_0_$9]];
	...
	assert  $top_writable($s_$_5,#wrTime$1^203.1,$phys_ptr_cast($int_to_ptr($heap($s_$_5)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node));
	assume $pre_static_wrap($s_$_5);
	assume call0formal_$_o_$_0_$9 == $phys_ptr_cast($int_to_ptr($heap($s_$_5)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node);
	assert  $pre_static_wrap($s_$_5);
	assert  !$is_primitive($field_type($field(call0formal_$_o_$_0_$9)));
	assert  $mutable($s_$_5,call0formal_$_o_$_0_$9);
	assume $is_wrapped($s_$_5,$s_$_6,call0formal_$_o_$_0_$9,owns#56_$_0);
	assume $heap($s_$_6) == $heap($s_$_5)[$f_owns($field_type($field(call0formal_$_o_$_0_$9))) := $heap($s_$_5)[$f_owns($field_type($field(call0formal_$_o_$_0_$9)))][call0formal_$_o_$_0_$9 := $ptrset_to_int(owns#56_$_0)]];
	assume $f_owner($s_$_6) == $f_owner(staticWrapState#55_$_0);
	assume $good_state_ext(#tok$1^218.34,$s_$_6);
	assert  $set_eq($owns($s_$_6,$phys_ptr_cast($int_to_ptr($heap($s_$_6)[Node.left][$phys_ptr_cast(L#y_$_0,^Node)]),^Node)),$set_empty());
...
anon00_Else:
	...
	goto anon47;
anon47:
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent)))) && $is_proper($dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent))) && ($mutable($s_$_7,$emb0($dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent))) && (($timestamp($s_$_7,$emb0($dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(L#y_$_0,^Node),Node.parent))));
	assert  $thread_local($s_$_7,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$1 == $phys_ptr_cast(L#y_$_0,^Node);
	assume call2formal_$_v_$_0_$1 == $ptr_to_int($phys_ptr_cast($int_to_ptr($heap($s_$_7)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume ((($f_timestamp($s_$_7) == $f_timestamp($s_$_8)) && ($f_closed($s_$_7) == $f_closed($s_$_8))) && ($f_owner($s_$_7) == $f_owner($s_$_8))) && ($roots($s_$_7) == $roots($s_$_8));
	assume $heap($s_$_8) == $heap($s_$_7)[Node.parent := $heap($s_$_7)[Node.parent][call1formal_$_p_$_0_$1 := call2formal_$_v_$_0_$1]];
	assume ($current_timestamp($s_$_7) < $current_timestamp($s_$_8)) && $call_transition($s_$_7,$s_$_8);
	assume $good_state_ext(#tok$1^219.3,$s_$_8) && $full_stop($s_$_8);
	assert  $thread_local($s_$_8,$phys_ptr_cast(P#x,^Node));
	assume true;
	if ($_$_condition_$0) { goto anon01_Then; } else { goto anon01_Else; }
anon01_Then:
	assume $_$_condition_$0;
	assume $_$_condition_$0 <==> ($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)))));
	assume $phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node))));
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(P#t,^Tree),Tree.root)))) && $is_proper($dot($phys_ptr_cast(P#t,^Tree),Tree.root))) && ($mutable($s_$_8,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.root))) && (($timestamp($s_$_8,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.root))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.root))));
	assume call1formal_$_p_$_0_$8 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$8 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume ((($f_timestamp($s_$_8) == $f_timestamp($s_$_9)) && ($f_closed($s_$_8) == $f_closed($s_$_9))) && ($f_owner($s_$_8) == $f_owner($s_$_9))) && ($roots($s_$_8) == $roots($s_$_9));
	assume $heap($s_$_9) == $heap($s_$_8)[Tree.root := $heap($s_$_8)[Tree.root][call1formal_$_p_$_0_$8 := call2formal_$_v_$_0_$8]];
	assume ($current_timestamp($s_$_8) < $current_timestamp($s_$_9)) && $call_transition($s_$_8,$s_$_9);
...
anon01_Else:
	...
	assume $_$_condition_$0 <==> ($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)))));
	assume !($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)))));
	assert  F#doMark($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume F#doMark($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	...
	assert  ((($is($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),^Node) && $is_proper($phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node))) && ($owner($s_$_8,$phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)) == $me())) && $closed($s_$_8,$phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node))) && (!$is_primitive(^Node));
	assert  $top_writable($s_$_8,#wrTime$1^203.1,$phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume $inv2($s_$_8,$s_$_8,$phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),^Node);
	assume owns#59_$_0 == $owns($s_$_8,$phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume $pre_static_unwrap($s_$_8);
	assume call0formal_$_o_$_0_$3 == $phys_ptr_cast($int_to_ptr($heap($s_$_8)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node);
	assert  (!$is_claimable($field_type($field(call0formal_$_o_$_0_$3)))) || ($ref_cnt($s_$_8,call0formal_$_o_$_0_$3) == 0);
	assert  $pre_static_unwrap($s_$_8);
	assume $is_unwrapped($s_$_8,$s_$_10,call0formal_$_o_$_0_$3);
	assume $f_owner($s_$_10) == $f_owner(prestate#60_$_0);
	assume $f_timestamp($s_$_10) == $f_timestamp(prestate#60_$_0)[call0formal_$_o_$_0_$3 := $current_timestamp($s_$_8)];
	assume $good_state_ext(#tok$1^224.32,$s_$_10);
	assume $full_stop($s_$_10);
	assert  $thread_local($s_$_10,$phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume true;
	if ($_$_condition_$1) { goto anon02_Then; } else { goto anon02_Else; }
anon48:
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(L#y_$_0,^Node),Node.left)))) && $is_proper($dot($phys_ptr_cast(L#y_$_0,^Node),Node.left))) && ($mutable($s_$_15,$emb0($dot($phys_ptr_cast(L#y_$_0,^Node),Node.left))) && (($timestamp($s_$_15,$emb0($dot($phys_ptr_cast(L#y_$_0,^Node),Node.left))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(L#y_$_0,^Node),Node.left))));
	assume call1formal_$_p_$_0_$3 == $phys_ptr_cast(L#y_$_0,^Node);
	assume call2formal_$_v_$_0_$3 == $ptr_to_int($phys_ptr_cast(P#x,^Node));
	assume ((($f_timestamp($s_$_15) == $f_timestamp($s_$_16)) && ($f_closed($s_$_15) == $f_closed($s_$_16))) && ($f_owner($s_$_15) == $f_owner($s_$_16))) && ($roots($s_$_15) == $roots($s_$_16));
	assume $heap($s_$_16) == $heap($s_$_15)[Node.left := $heap($s_$_15)[Node.left][call1formal_$_p_$_0_$3 := call2formal_$_v_$_0_$3]];
	assume ($current_timestamp($s_$_15) < $current_timestamp($s_$_16)) && $call_transition($s_$_15,$s_$_16);
	assume $good_state_ext(#tok$1^231.3,$s_$_16) && $full_stop($s_$_16);
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(P#x,^Node),Node.parent)))) && $is_proper($dot($phys_ptr_cast(P#x,^Node),Node.parent))) && ($mutable($s_$_16,$emb0($dot($phys_ptr_cast(P#x,^Node),Node.parent))) && (($timestamp($s_$_16,$emb0($dot($phys_ptr_cast(P#x,^Node),Node.parent))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(P#x,^Node),Node.parent))));
	assume call1formal_$_p_$_0_$4 == $phys_ptr_cast(P#x,^Node);
	assume call2formal_$_v_$_0_$4 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	...
	assume $heap($s_$_17) == $heap($s_$_16)[Node.parent := $heap($s_$_16)[Node.parent][call1formal_$_p_$_0_$4 := call2formal_$_v_$_0_$4]];
	...
	assert  $top_writable($s_$_17,#wrTime$1^203.1,$phys_ptr_cast(P#x,^Node));
	assume $pre_static_wrap($s_$_17);
	assume call0formal_$_o_$_0_$5 == $phys_ptr_cast(P#x,^Node);
	assert  $pre_static_wrap($s_$_17);
	assert  !$is_primitive($field_type($field(call0formal_$_o_$_0_$5)));
	assert  $mutable($s_$_17,call0formal_$_o_$_0_$5);
	assume $is_wrapped($s_$_17,$s_$_18,call0formal_$_o_$_0_$5,owns#65_$_0);
	assume $heap($s_$_18) == $heap($s_$_17)[$f_owns($field_type($field(call0formal_$_o_$_0_$5))) := $heap($s_$_17)[$f_owns($field_type($field(call0formal_$_o_$_0_$5)))][call0formal_$_o_$_0_$5 := $ptrset_to_int(owns#65_$_0)]];
	assume $f_owner($s_$_18) == $f_owner(staticWrapState#64_$_0);
	assume $good_state_ext(#tok$1^233.19,$s_$_18);
	assert  $set_eq($owns($s_$_18,$phys_ptr_cast(P#x,^Node)),$set_empty());
	...
	assert  $top_writable($s_$_18,#wrTime$1^203.1,$phys_ptr_cast(L#y_$_0,^Node));
	assume $pre_static_wrap($s_$_18);
	assume call0formal_$_o_$_0_$6 == $phys_ptr_cast(L#y_$_0,^Node);
	assert  $pre_static_wrap($s_$_18);
	assert  !$is_primitive($field_type($field(call0formal_$_o_$_0_$6)));
	assert  $mutable($s_$_18,call0formal_$_o_$_0_$6);
	assume $is_wrapped($s_$_18,$s_$_19,call0formal_$_o_$_0_$6,owns#68_$_0);
	assume $heap($s_$_19) == $heap($s_$_18)[$f_owns($field_type($field(call0formal_$_o_$_0_$6))) := $heap($s_$_18)[$f_owns($field_type($field(call0formal_$_o_$_0_$6)))][call0formal_$_o_$_0_$6 := $ptrset_to_int(owns#68_$_0)]];
	assume $f_owner($s_$_19) == $f_owner(staticWrapState#67_$_0);
	assume $good_state_ext(#tok$1^233.43,$s_$_19);
	assert  $set_eq($owns($s_$_19,$phys_ptr_cast(L#y_$_0,^Node)),$set_empty());
	assume $full_stop($s_$_19);
	assert  F#doMark($phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume F#doMark($phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node));
	assert  (forall  Q#m$1^236.26#dt1 : $ptr :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(L#y_$_0,^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)) ==> ($heap($s_$_19)[Node.key][$phys_ptr_cast(Q#m$1^236.26#dt1,^Node)] > $heap($s_$_19)[Node.key][$phys_ptr_cast(P#x,^Node)]) ));
	assume (forall  Q#m$1^236.26#dt1_$0 : $ptr :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(L#y_$_0,^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_19)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)) ==> ($heap($s_$_19)[Node.key][$phys_ptr_cast(Q#m$1^236.26#dt1_$0,^Node)] > $heap($s_$_19)[Node.key][$phys_ptr_cast(P#x,^Node)]) ));
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(P#t,^Tree),Tree.R)))) && $is_proper($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) && ($mutable($s_$_19,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) && (($timestamp($s_$_19,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.R))));
	assert  $thread_local($s_$_19,$phys_ptr_cast(P#t,^Tree));
	assert  $thread_local($s_$_19,$phys_ptr_cast(P#t,^Tree));
	assume call1formal_$_p_$_0_$5 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$5 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(L#y_$_0,^Node),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_19)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(P#x,^Node))));
	...
	assume $heap($s_$_20) == $heap($s_$_19)[Tree.R := $heap($s_$_19)[Tree.R][call1formal_$_p_$_0_$5 := call2formal_$_v_$_0_$5]];
	...
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#t,^Tree));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#x,^Node));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#t,^Tree));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#x,^Node));
	assume call0formal_$_#l2_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_20)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_20)[Node.right][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume call1formal_$_#l1_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_20)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_20)[Node.left][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume call2formal_$_#l0_$_0 == $phys_ptr_cast(P#x,^Node);
	...
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast(P#t,^Tree),Tree.R)))) && $is_proper($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) && ($mutable($s_$_20,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) && (($timestamp($s_$_20,$emb0($dot($phys_ptr_cast(P#t,^Tree),Tree.R))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast(P#t,^Tree),Tree.R))));
	assert  $thread_local($s_$_20,$phys_ptr_cast(P#t,^Tree));
	assume call1formal_$_p_$_0_$6 == $phys_ptr_cast(P#t,^Tree);
	assume call2formal_$_v_$_0_$6 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_20)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(P#x,^Node),call3formal_$_$result_$_0));
	assume ((($f_timestamp($s_$_20) == $f_timestamp($s_$_21)) && ($f_closed($s_$_20) == $f_closed($s_$_21))) && ($f_owner($s_$_20) == $f_owner($s_$_21))) && ($roots($s_$_20) == $roots($s_$_21));
	assume $heap($s_$_21) == $heap($s_$_20)[Tree.R := $heap($s_$_20)[Tree.R][call1formal_$_p_$_0_$6 := call2formal_$_v_$_0_$6]];
	assume ($current_timestamp($s_$_20) < $current_timestamp($s_$_21)) && $call_transition($s_$_20,$s_$_21);
	...
	assert  $top_writable($s_$_21,#wrTime$1^203.1,$phys_ptr_cast(P#t,^Tree));
	assert  (forall  #writes$1^243.19 : $ptr :: {$dont_instantiate(#writes$1^243.19)} ( $owns($s_$_21,$phys_ptr_cast(P#t,^Tree))[#writes$1^243.19] ==> $top_writable($s_$_21,#wrTime$1^203.1,#writes$1^243.19) ));
	assume call0formal_$_o_$_0_$7 == $phys_ptr_cast(P#t,^Tree);
	assert  $pre_wrap($s_$_21);
	assert  !$is_primitive($field_type($field(call0formal_$_o_$_0_$7)));
	assert  $mutable($s_$_21,call0formal_$_o_$_0_$7);
	assert  (forall  p_$222 : $ptr :: {$dont_instantiate(p_$222)} ( $set_in0(p_$222,$owns($s_$_21,call0formal_$_o_$_0_$7)) ==> (((($is(p_$222,$field_type($field(p_$222))) && $is_proper(p_$222)) && ($owner($s_$_21,p_$222) == $me())) && $closed($s_$_21,p_$222)) && (!$is_primitive($field_type($field(p_$222))))) ));
	assume $is_wrapped_dynamic($s_$_21,$s_$_22,call0formal_$_o_$_0_$7);
	...
	assert  (forall  Q#m$1^82.29#dt1_$5 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($null,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$5,^Node))} {:weight  10}( !$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($null,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$5,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$10 : $ptr, Q#m$1^82.29#dt1_$6 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)),^Node)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)),^Node)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node)) ==> ($heap($s_$_22)[Node.key][$phys_ptr_cast(Q#m$1^82.29#dt1_$6,^Node)] < $heap($s_$_22)[Node.key][$phys_ptr_cast(Q#n$1^82.29#dt1_$10,^Node)])) ));
	assert  (forall  Q#n$1^82.29#dt1_$11 : $ptr, Q#m$1^82.29#dt1_$7 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)),^Node)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)),^Node)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node)) ==> ($heap($s_$_22)[Node.key][$phys_ptr_cast(Q#m$1^82.29#dt1_$7,^Node)] > $heap($s_$_22)[Node.key][$phys_ptr_cast(Q#n$1^82.29#dt1_$11,^Node)])) ));
	assert  (forall  Q#m$1^82.29#dt1_$8 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node))} {F#mark2($phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node))} {sk_hack(F#mark2($phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node)))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node)) <==> $owns($s_$_22,$phys_ptr_cast(P#t,^Tree))[$phys_ptr_cast(Q#m$1^82.29#dt1_$8,^Node)] ));
	assert  (forall  Q#n$1^82.29#dt1_$12 : $ptr, Q#m$1^82.29#dt1_$9 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$12,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$12,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$9,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$13 : $ptr, Q#m$1^82.29#dt1_$10 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$10,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)),$phys_ptr_cast(Q#m$1^82.29#dt1_$10,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$13,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$14 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),^Node)]),^Node))))))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(Q#n$1^82.29#dt1_$14,^Node)]),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$15 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)),^Node)]),^Node))))))) ==> ($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)]),^Node)]),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$15,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$16 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),^Node)]),^Node))))))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(Q#n$1^82.29#dt1_$16,^Node)]),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$17 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)),^Node)]),^Node))))))) ==> ($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)]),^Node)]),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$17,^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$18 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)),^Node)]),^Node))))))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(Q#n$1^82.29#dt1_$18,^Node)]),^Node)) ));
	assert  (forall  Q#n$1^82.29#dt1_$19 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)) && (!($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)),^Node)]),^Node))))))) ==> (($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)]),^Node)]),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)) || ($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node)]),^Node)]),^Node) == $phys_ptr_cast(Q#n$1^82.29#dt1_$19,^Node))) ));
	assert  (forall  Q#n$1^82.29#dt1_$20 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)),$phys_ptr_cast(Q#n$1^82.29#dt1_$20,^Node)) ));
	assert  true;
	assert  (forall  Q#m$1^83.29#dt1_$1 : $ptr :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($heap($s_$_22)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]),$heap($s_$_22)[Node.key][$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)])} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($heap($s_$_22)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]),$heap($s_$_22)[Node.key][$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)]) == $heap($s_$_22)[Node.value][$phys_ptr_cast(Q#m$1^83.29#dt1_$1,^Node)]) ));
	assert  (forall  Q#k$1^83.29#tc2_$0 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($heap($s_$_22)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]),Q#k$1^83.29#tc2_$0)} {:weight  10}( (($min.i4 <= Q#k$1^83.29#tc2_$0) && (Q#k$1^83.29#tc2_$0 <= $max.i4)) ==> (((forall  Q#m$1^83.29#dt1_$2 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node)) ==> (!($heap($s_$_22)[Node.key][$phys_ptr_cast(Q#m$1^83.29#dt1_$2,^Node)] == Q#k$1^83.29#tc2_$0)) ))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($heap($s_$_22)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]),Q#k$1^83.29#tc2_$0) == 0)) ));
	assert  (forall  Q#n$1^84.29#dt1_$1 : $ptr :: {$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)),^Node)} {:weight  10}( ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)) && ($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)),^Node)]),^Node) == $phys_ptr_cast($null,$field_type($field($phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.parent][$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node)),^Node)]),^Node)))))) ==> (($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node) == $phys_ptr_cast($null,^Node)) || ($phys_ptr_cast(Q#n$1^84.29#dt1_$1,^Node) == $phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node))) ));
	assert  (forall  Q#n$1^84.29#dt1_$2 : $ptr, Q#m$1^84.29#dt1_$0 : $ptr :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node))} {:weight  10}( $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast(F#mark($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node)) <==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)) && ((((($phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node) == $phys_ptr_cast($null,^Node)) && ($phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node) == $phys_ptr_cast($null,^Node))) || ($phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node) == $phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.left][$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Node.right][$phys_ptr_cast(Q#n$1^84.29#dt1_$2,^Node)]),^Node)),$phys_ptr_cast(Q#m$1^84.29#dt1_$0,^Node)))) ));
	assume $full_stop($s_$_22);
	assert  $position_marker();
	assert  $eq.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node)),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($heap($s_$_22)[Tree.R][$phys_ptr_cast(P#t,^Tree)]),$phys_ptr_cast($int_to_ptr($heap($s_$_22)[Tree.root][$phys_ptr_cast(P#t,^Tree)]),^Node))) && $eq.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($heap($s)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]),$int_to_map_t..^^i4.^^i4($heap($s_$_22)[Tree.abs][$phys_ptr_cast(P#t,^Tree)]));
	assert  ((($is($phys_ptr_cast(P#t,^Tree),^Tree) && $is_proper($phys_ptr_cast(P#t,^Tree))) && ($owner($s_$_22,$phys_ptr_cast(P#t,^Tree)) == $me())) && $closed($s_$_22,$phys_ptr_cast(P#t,^Tree))) && (!$is_primitive(^Tree));
	goto $exit;
anon02_Then:
	assume $_$_condition_$1;
	assume $_$_condition_$1 <==> $ptr_eq($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.left][$phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)]),^Node),$phys_ptr_cast(P#x,^Node));
	assume $ptr_eq($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.left][$phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)]),^Node),$phys_ptr_cast(P#x,^Node));
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.left)))) && $is_proper($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.left))) && ($mutable($s_$_10,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.left))) && (($timestamp($s_$_10,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.left))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.left))));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$7 == $phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node);
	assume call2formal_$_v_$_0_$7 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume ((($f_timestamp($s_$_10) == $f_timestamp($s_$_11)) && ($f_closed($s_$_10) == $f_closed($s_$_11))) && ($f_owner($s_$_10) == $f_owner($s_$_11))) && ($roots($s_$_10) == $roots($s_$_11));
	assume $heap($s_$_11) == $heap($s_$_10)[Node.left := $heap($s_$_10)[Node.left][call1formal_$_p_$_0_$7 := call2formal_$_v_$_0_$7]];
	assume ($current_timestamp($s_$_10) < $current_timestamp($s_$_11)) && $call_transition($s_$_10,$s_$_11);
...
anon02_Else:
	...
	assume $_$_condition_$1 <==> $ptr_eq($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.left][$phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)]),^Node),$phys_ptr_cast(P#x,^Node));
	assume !$ptr_eq($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.left][$phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)]),^Node),$phys_ptr_cast(P#x,^Node));
	assert  ($is_primitive($field_type($field($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.right)))) && $is_proper($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.right))) && ($mutable($s_$_10,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.right))) && (($timestamp($s_$_10,$emb0($dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.right))) >= #wrTime$1^203.1) || $in_writes_at(#wrTime$1^203.1,$dot($phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node),Node.right))));
	assert  $thread_local($s_$_10,$phys_ptr_cast(P#x,^Node));
	assume call1formal_$_p_$_0_$2 == $phys_ptr_cast($int_to_ptr($heap($s_$_10)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node);
	assume call2formal_$_v_$_0_$2 == $ptr_to_int($phys_ptr_cast(L#y_$_0,^Node));
	assume ((($f_timestamp($s_$_10) == $f_timestamp($s_$_12)) && ($f_closed($s_$_10) == $f_closed($s_$_12))) && ($f_owner($s_$_10) == $f_owner($s_$_12))) && ($roots($s_$_10) == $roots($s_$_12));
	assume $heap($s_$_12) == $heap($s_$_10)[Node.right := $heap($s_$_10)[Node.right][call1formal_$_p_$_0_$2 := call2formal_$_v_$_0_$2]];
	assume ($current_timestamp($s_$_10) < $current_timestamp($s_$_12)) && $call_transition($s_$_10,$s_$_12);
...
anon45:
	...
	assert  $top_writable($s_$_13,#wrTime$1^203.1,$phys_ptr_cast($int_to_ptr($heap($s_$_13)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node));
	assume $pre_static_wrap($s_$_13);
	assume call0formal_$_o_$_0_$4 == $phys_ptr_cast($int_to_ptr($heap($s_$_13)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node);
	assert  $pre_static_wrap($s_$_13);
	assert  !$is_primitive($field_type($field(call0formal_$_o_$_0_$4)));
	assert  $mutable($s_$_13,call0formal_$_o_$_0_$4);
	assume $is_wrapped($s_$_13,$s_$_14,call0formal_$_o_$_0_$4,owns#62_$_0);
	assume $heap($s_$_14) == $heap($s_$_13)[$f_owns($field_type($field(call0formal_$_o_$_0_$4))) := $heap($s_$_13)[$f_owns($field_type($field(call0formal_$_o_$_0_$4)))][call0formal_$_o_$_0_$4 := $ptrset_to_int(owns#62_$_0)]];
	assume $f_owner($s_$_14) == $f_owner(staticWrapState#61_$_0);
	assume $good_state_ext(#tok$1^224.32,$s_$_14);
	assert  $set_eq($owns($s_$_14,$phys_ptr_cast($int_to_ptr($heap($s_$_14)[Node.parent][$phys_ptr_cast(P#x,^Node)]),^Node)),$set_empty());
