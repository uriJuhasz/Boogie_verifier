...
$start:
	...
	assume (forall  p_$109 : $ptr, T_$14 : $ctype, sz_$31 : Integer :: {$as_array(p_$109,T_$14,sz_$31)} ( $as_array(p_$109,T_$14,sz_$31) == (if (($is_proper(p_$109) && ($field_type($field($base(p_$109))) == $array(T_$14,sz_$31))) && ($field(p_$109) == $array_emb(T_$14,sz_$31))) then $base(p_$109) else $phys_ptr_cast($null,$array(T_$14,sz_$31))) ));
	...
	assume (forall  Q#__vcc_state$1^65.32#tc3 : $state, Q#x$1^65.32#tc1 : Integer, #l1_$0 : $ptr, #l0_$0 : Integer :: {$select.$map_t..^^mathint.^^mathint(F#lambda#4(Q#__vcc_state$1^65.32#tc3,$phys_ptr_cast(#l1_$0,^^u4),#l0_$0),Q#x$1^65.32#tc1)} {:weight  10}( (($good_state(Q#__vcc_state$1^65.32#tc3) && true) && ((0 <= #l0_$0) && (#l0_$0 <= $max.u4))) ==> ($select.$map_t..^^mathint.^^mathint(F#lambda#4(Q#__vcc_state$1^65.32#tc3,$phys_ptr_cast(#l1_$0,^^u4),#l0_$0),Q#x$1^65.32#tc1) == (if ((Q#x$1^65.32#tc1 < 0) || (Q#x$1^65.32#tc1 >= #l0_$0)) then 0 else $heap(Q#__vcc_state$1^65.32#tc3)[$field($idx($phys_ptr_cast(#l1_$0,^^u4),Q#x$1^65.32#tc1))][$emb0($idx($phys_ptr_cast(#l1_$0,^^u4),Q#x$1^65.32#tc1))])) ));
	...
	assume (forall  Q#__vcc_state$1^65.32#tc3_$0 : $state, Q#x$1^65.32#tc1_$0 : Integer, #l1_$2 : $ptr, #l0_$2 : Integer :: {$select.$map_t..^^mathint.^^mathint(F#lambda#3(Q#__vcc_state$1^65.32#tc3_$0,$phys_ptr_cast(#l1_$2,^^u4),#l0_$2),Q#x$1^65.32#tc1_$0)} {:weight  10}( (($good_state(Q#__vcc_state$1^65.32#tc3_$0) && true) && ((0 <= #l0_$2) && (#l0_$2 <= $max.u4))) ==> ($select.$map_t..^^mathint.^^mathint(F#lambda#3(Q#__vcc_state$1^65.32#tc3_$0,$phys_ptr_cast(#l1_$2,^^u4),#l0_$2),Q#x$1^65.32#tc1_$0) == (if ((Q#x$1^65.32#tc1_$0 < 0) || (Q#x$1^65.32#tc1_$0 >= #l0_$2)) then 0 else $heap(Q#__vcc_state$1^65.32#tc3_$0)[$field($idx($phys_ptr_cast(#l1_$2,^^u4),Q#x$1^65.32#tc1_$0))][$emb0($idx($phys_ptr_cast(#l1_$2,^^u4),Q#x$1^65.32#tc1_$0))])) ));
	...
	assume (forall  Q#__vcc_state$1^41.49#tc3 : $state, Q#x$1^41.49#tc1 : Integer, #l1_$4 : $ptr, #l0_$4 : Integer :: {$select.$map_t..^^mathint.^^mathint(F#lambda#2(Q#__vcc_state$1^41.49#tc3,$phys_ptr_cast(#l1_$4,^^u4),#l0_$4),Q#x$1^41.49#tc1)} {:weight  10}( (($good_state(Q#__vcc_state$1^41.49#tc3) && true) && ((0 <= #l0_$4) && (#l0_$4 <= $max.u4))) ==> ($select.$map_t..^^mathint.^^mathint(F#lambda#2(Q#__vcc_state$1^41.49#tc3,$phys_ptr_cast(#l1_$4,^^u4),#l0_$4),Q#x$1^41.49#tc1) == (if ((Q#x$1^41.49#tc1 < 0) || (Q#x$1^41.49#tc1 >= #l0_$4)) then 0 else $heap(Q#__vcc_state$1^41.49#tc3)[$field($idx($phys_ptr_cast(#l1_$4,^^u4),Q#x$1^41.49#tc1))][$emb0($idx($phys_ptr_cast(#l1_$4,^^u4),Q#x$1^41.49#tc1))])) ));
	...
	assume (forall  q_$25 : $ptr, $fk_base_$0 : $field_kind, p_$202 : $ptr, T_$18 : $ctype, sz_$36 : Integer :: {lambda#0($fk_base_$0,p_$202,T_$18,sz_$36)[q_$25]} ( lambda#0($fk_base_$0,p_$202,T_$18,sz_$36)[q_$25] <==> (((((($emb0(q_$25) == $emb0(p_$202)) && ($field_type($field(q_$25)) == T_$18)) && ($field_arr_root($field(q_$25)) == $field_arr_root($field(p_$202)))) && ((0 <= $index_within(q_$25,p_$202)) && ($index_within(q_$25,p_$202) <= (sz_$36 - 1)))) && (q_$25 == $dot($base(p_$202),$field_plus($field(p_$202),$index_within(q_$25,p_$202))))) && (!($field_kind($field(q_$25)) == $fk_base_$0))) ));
	assume (forall  q_$26 : $ptr, sz_$37 : Integer, p_$203 : $ptr :: {lambda#1(sz_$37,p_$203)[q_$26]} ( lambda#1(sz_$37,p_$203)[q_$26] <==> (((0 <= $index_within(q_$26,p_$203)) && ($index_within(q_$26,p_$203) <= (sz_$37 - 1))) && $full_extent($idx(p_$203,$index_within(q_$26,p_$203)))[q_$26]) ));
	assume (forall  q_$27 : $ptr, sz_$38 : Integer, p_$204 : $ptr, T_$19 : $ctype :: {lambda#2(sz_$38,p_$204,T_$19)[q_$27]} ( lambda#2(sz_$38,p_$204,T_$19)[q_$27] <==> (((0 <= $index_within(q_$27,p_$204)) && ($index_within(q_$27,p_$204) <= (sz_$38 - 1))) && (q_$27 == $idx(p_$204,$index_within(q_$27,p_$204)))) ));
	...
	assume (forall  p_$205 : $ptr, r_$20 : $ptr, S_$134 : $state :: {lambda#10(r_$20,S_$134)[p_$205]} ( lambda#10(r_$20,S_$134)[p_$205] <==> ($is_proper($dot($base(p_$205),$field(p_$205))) && $composite_extent(S_$134,r_$20,$field_type($field(r_$20)))[$emb0(p_$205)]) ));
	assume (forall  p_$206 : $ptr, r_$21 : $ptr, $full_extent_state_$0 : $state :: {lambda#11(r_$21,$full_extent_state_$0)[p_$206]} ( lambda#11(r_$21,$full_extent_state_$0)[p_$206] <==> ($is_proper(p_$206) && $composite_extent($full_extent_state_$0,r_$21,$field_type($field(r_$21)))[$emb0(p_$206)]) ));
	...
	assume (forall  o_$18 : $ptr, p_$210 : $ptr :: {lambda#16(p_$210)[o_$18]} ( lambda#16(p_$210)[o_$18] <==> ((!(p_$210 == $phys_ptr_cast($null,$field_type($field(p_$210))))) && (p_$210 == o_$18)) ));
...
PreconditionGeneratedEntry:
	assume (0 <= L#max) && (L#max <= $max.u4);
	assume (0 <= L#sum) && (L#sum <= $max.u4);
	assume (0 <= L#i) && (L#i <= $max.u4);
	assume ((($is($as_array($phys_ptr_cast(P#a,^^u4),^^u4,P#N),$array(^^u4,P#N)) && $is_proper($as_array($phys_ptr_cast(P#a,^^u4),^^u4,P#N))) && ($owner($s,$as_array($phys_ptr_cast(P#a,^^u4),^^u4,P#N)) == $me())) && $closed($s,$as_array($phys_ptr_cast(P#a,^^u4),^^u4,P#N))) && (!$is_primitive($array(^^u4,P#N)));
	goto anon17;
anon17:
	assume $function_entry($s);
	assume $good_state_ext(#tok$1^30.1,$s) && $full_stop($s);
	...
	assume $writes_at(#wrTime$1^30.1) == lambda#20(^^u4,P#maxout);
	assume $mutable($s,$phys_ptr_cast(P#maxout,^^u4));
	assume true;
	assume (0 <= P#N) && (P#N <= $max.u4);
	assume true;
	...
	assume $good_state_ext(#tok$1^41.49,$s) && $full_stop($s);
	...
	assume $good_state_ext(#tok$1^43.3,$s_$_0) && $full_stop($s_$_0);
	assume #wrTime$1^43.3 == $current_timestamp($s_$_0);
	assume $writes_at(#wrTime$1^43.3) == lambda#20(^^u4,P#maxout);
	assert  (forall  #loopWrites^$1^43.3 : $ptr :: {$dont_instantiate(#loopWrites^$1^43.3)} ( $in_writes_at(#wrTime$1^43.3,#loopWrites^$1^43.3) ==> $top_writable($s_$_0,#wrTime$1^30.1,#loopWrites^$1^43.3) ));
	assert  0 == F#fsum(0,call2formal_$_$result_$_0);
	assert  (forall  Q#k$1^45.31#tc2 : Integer :: {$idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2)} {:weight  10}( ((0 <= Q#k$1^45.31#tc2) && (Q#k$1^45.31#tc2 <= $max.u4)) ==> ((Q#k$1^45.31#tc2 < 0) ==> ($heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2))][$emb0($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2))] <= 0)) ));
	assert  0 <= $op_mul(0,0);
	assert  0 <= P#N;
	goto anon00_LoopHead;
anon00_LoopHead:
	assume (0 <= L#sum_$_0) && (L#sum_$_0 <= $max.u4);
	assume (0 <= L#i_$_0) && (L#i_$_0 <= $max.u4);
	assume (0 <= L#max_$_0) && (L#max_$_0 <= $max.u4);
	assume 0 <= L#i_$_0;
	assume L#sum_$_0 == F#fsum(L#i_$_0,call2formal_$_$result_$_0);
	assume (forall  Q#k$1^45.31#tc2_$0 : Integer :: {$idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$0)} {:weight  10}( ((0 <= Q#k$1^45.31#tc2_$0) && (Q#k$1^45.31#tc2_$0 <= $max.u4)) ==> ((Q#k$1^45.31#tc2_$0 < L#i_$_0) ==> ($heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$0))] <= L#max_$_0)) ));
...
anon00_LoopBody:
	...
	assume ($current_timestamp($s_$_0) <= $current_timestamp($s_$_0)) && $call_transition($s_$_0,$s_$_0);
	assume $good_state_ext(#tok$1^43.3,$s_$_0) && $full_stop($s_$_0);
	...
	assume ((($f_timestamp($s_$_0) == $f_timestamp($s_$_0)) && ($f_closed($s_$_0) == $f_closed($s_$_0))) && ($f_owner($s_$_0) == $f_owner($s_$_0))) && ($roots($s_$_0) == $roots($s_$_0));
	assume true;
	if ($_$_condition_$0) { goto anon01_Then; } else { goto anon01_Else; }
$#break_6:
	assert  ($is_primitive($field_type($field($phys_ptr_cast(P#maxout,^^u4)))) && $is_proper($phys_ptr_cast(P#maxout,^^u4))) && ($mutable($s_$_0,$emb0($phys_ptr_cast(P#maxout,^^u4))) && (($timestamp($s_$_0,$emb0($phys_ptr_cast(P#maxout,^^u4))) >= #wrTime$1^30.1) || $in_writes_at(#wrTime$1^30.1,$phys_ptr_cast(P#maxout,^^u4))));
	...
	assume $heap($s_$_1) == $heap($s_$_0)[call0formal_$_f_$_0 := $heap($s_$_0)[call0formal_$_f_$_0][call1formal_$_p_$_0 := L#max_$_0]];
	assume ($current_timestamp($s_$_0) < $current_timestamp($s_$_1)) && $call_transition($s_$_0,$s_$_1);
	assume $good_state_ext(#tok$1^62.4,$s_$_1) && $full_stop($s_$_1);
...
anon02_Then:
	...
	assume L#max_$_0 < $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))];
	assert  $thread_local($s_$_0,$idx($phys_ptr_cast(P#a,^^u4),L#i_$_0));
	assume L#max_$_1 == $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))];
	assume $local_value_is($s_$_0,#tok$1^51.7,#loc.max,L#max_$_1,^^u4);
	assume L#max_$_2 == L#max_$_1;
	goto anon14;
anon02_Else:
	assume !$_$_condition_$1;
	assume $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))] <= L#max_$_0;
...
anon14:
	...
	assert  F#fsum(L#i_$_0 + 1,call2formal_$_$result_$_0) == ($heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))] + F#fsum(L#i_$_0,call2formal_$_$result_$_0));
	assume F#fsum(L#i_$_0 + 1,call2formal_$_$result_$_0) == ($heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))] + F#fsum(L#i_$_0,call2formal_$_$result_$_0));
	assert  (0 <= (L#i_$_0 + 1)) && ((L#i_$_0 + 1) <= $max.u4);
	...
	assume $good_state_ext(#tok$1^57.27,$s_$_0) && $full_stop($s_$_0);
	assert  F#fsum(L#i_$_0 + 1,call2formal_$_$result_$_0) < 4294967295;
	assume F#fsum(L#i_$_0 + 1,call2formal_$_$result_$_0) < 4294967295;
	assert  (0 <= (L#sum_$_0 + $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))])) && ((L#sum_$_0 + $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))]) <= $max.u4);
	assert  $thread_local($s_$_0,$idx($phys_ptr_cast(P#a,^^u4),L#i_$_0));
	assume L#sum_$_1 == (L#sum_$_0 + $heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))][$emb0($idx($phys_ptr_cast(P#a,^^u4),L#i_$_0))]);
	...
	assert  (forall  Q#k$1^45.31#tc2_$1 : Integer :: {$idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$1)} {:weight  10}( ((0 <= Q#k$1^45.31#tc2_$1) && (Q#k$1^45.31#tc2_$1 <= $max.u4)) ==> ((Q#k$1^45.31#tc2_$1 < L#i_$_1) ==> ($heap($s_$_0)[$field($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$1))][$emb0($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^45.31#tc2_$1))] <= L#max_$_2)) ));
...
GeneratedUnifiedExit:
	assert  (forall  Q#k$1^34.27#tc2 : Integer :: {$idx($phys_ptr_cast(P#a,^^u4),Q#k$1^34.27#tc2)} {:weight  10}( ((0 <= Q#k$1^34.27#tc2) && (Q#k$1^34.27#tc2 <= $max.u4)) ==> ((Q#k$1^34.27#tc2 < P#N) ==> ($heap($s_$_2)[$field($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^34.27#tc2))][$emb0($idx($phys_ptr_cast(P#a,^^u4),Q#k$1^34.27#tc2))] <= $heap($s_$_2)[$field($phys_ptr_cast(P#maxout,^^u4))][$emb0($phys_ptr_cast(P#maxout,^^u4))])) ));
	assert  $result_$_0 <= $op_mul(P#N,$heap($s_$_2)[$field($phys_ptr_cast(P#maxout,^^u4))][$emb0($phys_ptr_cast(P#maxout,^^u4))]);
	assert  $mutable($s_$_2,$phys_ptr_cast(P#maxout,^^u4));
	assert  $emb0($phys_ptr_cast(P#maxout,^^u4)) == $emb0($phys_ptr_cast(P#maxout,^^u4));
	goto $exit;
}
