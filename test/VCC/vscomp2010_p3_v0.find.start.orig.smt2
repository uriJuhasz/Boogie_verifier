...
(declare-fun $@hash@break_2@1 ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_109) (and (not $is_unwrap_check) (not $is_stuttering_check)))
      (= (= true $@bf_208) (forall ((|f_$8| $pure_function))(!(< ($frame_level f_$8) $current_frame_level):pattern ( ($frame_level f_$8))  )))
      (= (= true $@bf_210) (forall ((|f_$10| $pure_function))(!(< ($pure_post_level f_$10) $current_frame_level):pattern ( ($frame_level f_$10))  )))
...
(assert (! (=> $@hash@break_2@1 (and true 
   (and true
      $position_marker
      (= $result@0 L@i@0)
   )
GeneratedUnifiedExit
)) :named ax_$@hash@break_2@1))
