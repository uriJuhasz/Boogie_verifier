...
;Axioms
   ...
   (assert (! (not (= $@loc._this_ $@file^C?3A?5Cdev?5Cfelt?5Cvcc?5CTest?5Ctestsuite?5Cvscomp2010?5Cvscomp2010_p3_v0.c)) :named ax_38))
   (assert (! (not (= $@loc._this_ $@file^C?3A?5Cdev?5Cfelt?5Cvcc?5CTest?5Ctestsuite?5Cvscomp2010?5Cvscomp2010_p3_v0.c)) :named ax_39))
   (assert (! (not (= $@loc._this_ $@tok$1^9.31)) :named ax_40))
   (assert (! (not (= $@tok$1^9.31 $@file^C?3A?5Cdev?5Cfelt?5Cvcc?5CTest?5Ctestsuite?5Cvscomp2010?5Cvscomp2010_p3_v0.c)) :named ax_41))
   (assert (! (not (= $@tok$1^9.31 $@file^C?3A?5Cdev?5Cfelt?5Cvcc?5CTest?5Ctestsuite?5Cvscomp2010?5Cvscomp2010_p3_v0.c)) :named ax_42))
   (assert (! (not (= $@tok$1^9.31 $@loc._this_)) :named ax_43))
   (assert (! (not (= $kind_array $kind_thread)) :named ax_44))
   (assert (! (not (= $kind_composite $kind_array)) :named ax_45))
   (assert (! (not (= $kind_composite $kind_array)) :named ax_46))
   (assert (! (not (= $kind_composite $kind_primitive)) :named ax_47))
   (assert (! (not (= $kind_composite $kind_thread)) :named ax_48))
   (assert (! (not (= $kind_primitive $kind_array)) :named ax_49))
   (assert (! (not (= $kind_primitive $kind_array)) :named ax_50))
   (assert (! (not (= $kind_primitive $kind_composite)) :named ax_51))
   (assert (! (not (= $kind_primitive $kind_thread)) :named ax_52))
   (assert (! (not (= $kind_thread $kind_array)) :named ax_53))
   (assert (! (not (= $kind_thread $kind_composite)) :named ax_54))
   (assert (! (not (= $kind_thread $kind_primitive)) :named ax_55))
   (assert (! (not (= $memory_allocator_type $@distTp1)) :named ax_56))
   (assert (! (not (= $memory_allocator_type $@distTp2)) :named ax_57))
   (assert (! (not (= $memory_allocator_type $@distTp3)) :named ax_58))
   (assert (! (not (= $memory_allocator_type $@distTp4)) :named ax_59))
   (assert (! (not (= $memory_allocator_type $@distTp5)) :named ax_60))
   (assert (! (not (= $memory_allocator_type $@distTp6)) :named ax_61))
   (assert (! (not (= $memory_allocator_type ^$@thread_id)) :named ax_62))
   (assert (! (not (= $memory_allocator_type ^List)) :named ax_63))
   (assert (! (not (= $memory_allocator_type ^Node)) :named ax_64))
   (assert (! (not (= ^$@ptrset $@distTp1)) :named ax_65))
   (assert (! (not (= ^$@ptrset $@distTp1)) :named ax_66))
   (assert (! (not (= ^$@ptrset $@distTp2)) :named ax_67))
   (assert (! (not (= ^$@ptrset $@distTp2)) :named ax_68))
   (assert (! (not (= ^$@ptrset $@distTp3)) :named ax_69))
   (assert (! (not (= ^$@ptrset $@distTp3)) :named ax_70))
   (assert (! (not (= ^$@ptrset $@distTp4)) :named ax_71))
   (assert (! (not (= ^$@ptrset $@distTp4)) :named ax_72))
   (assert (! (not (= ^$@ptrset $@distTp5)) :named ax_73))
   (assert (! (not (= ^$@ptrset $@distTp5)) :named ax_74))
   (assert (! (not (= ^$@ptrset $@distTp6)) :named ax_75))
   (assert (! (not (= ^$@ptrset $@distTp6)) :named ax_76))
   (assert (! (not (= ^$@ptrset $memory_allocator_type)) :named ax_77))
   (assert (! (not (= ^$@ptrset $memory_allocator_type)) :named ax_78))
   (assert (! (not (= ^$@ptrset ^$@state_t)) :named ax_79))
   (assert (! (not (= ^$@ptrset ^$@struct)) :named ax_80))
   (assert (! (not (= ^$@ptrset ^$@thread_id)) :named ax_81))
   (assert (! (not (= ^$@ptrset ^List)) :named ax_82))
   (assert (! (not (= ^$@ptrset ^Node)) :named ax_83))
   (assert (! (not (= ^$@state_t $@distTp1)) :named ax_84))
   (assert (! (not (= ^$@state_t $@distTp1)) :named ax_85))
   (assert (! (not (= ^$@state_t $@distTp2)) :named ax_86))
   (assert (! (not (= ^$@state_t $@distTp2)) :named ax_87))
   (assert (! (not (= ^$@state_t $@distTp3)) :named ax_88))
   (assert (! (not (= ^$@state_t $@distTp3)) :named ax_89))
   (assert (! (not (= ^$@state_t $@distTp4)) :named ax_90))
   (assert (! (not (= ^$@state_t $@distTp4)) :named ax_91))
   (assert (! (not (= ^$@state_t $@distTp5)) :named ax_92))
   (assert (! (not (= ^$@state_t $@distTp5)) :named ax_93))
   (assert (! (not (= ^$@state_t $@distTp6)) :named ax_94))
   (assert (! (not (= ^$@state_t $@distTp6)) :named ax_95))
   (assert (! (not (= ^$@state_t $memory_allocator_type)) :named ax_96))
   (assert (! (not (= ^$@state_t $memory_allocator_type)) :named ax_97))
   (assert (! (not (= ^$@state_t ^$@ptrset)) :named ax_98))
   (assert (! (not (= ^$@state_t ^$@struct)) :named ax_99))
   (assert (! (not (= ^$@state_t ^$@thread_id)) :named ax_100))
   (assert (! (not (= ^$@state_t ^List)) :named ax_101))
   (assert (! (not (= ^$@state_t ^Node)) :named ax_102))
   (assert (! (not (= ^$@struct $@distTp1)) :named ax_103))
   (assert (! (not (= ^$@struct $@distTp1)) :named ax_104))
   (assert (! (not (= ^$@struct $@distTp2)) :named ax_105))
   (assert (! (not (= ^$@struct $@distTp2)) :named ax_106))
   (assert (! (not (= ^$@struct $@distTp3)) :named ax_107))
   (assert (! (not (= ^$@struct $@distTp3)) :named ax_108))
   (assert (! (not (= ^$@struct $@distTp4)) :named ax_109))
   (assert (! (not (= ^$@struct $@distTp4)) :named ax_110))
   (assert (! (not (= ^$@struct $@distTp5)) :named ax_111))
   (assert (! (not (= ^$@struct $@distTp5)) :named ax_112))
   (assert (! (not (= ^$@struct $@distTp6)) :named ax_113))
   (assert (! (not (= ^$@struct $@distTp6)) :named ax_114))
   (assert (! (not (= ^$@struct $memory_allocator_type)) :named ax_115))
   (assert (! (not (= ^$@struct $memory_allocator_type)) :named ax_116))
   (assert (! (not (= ^$@struct ^$@ptrset)) :named ax_117))
   (assert (! (not (= ^$@struct ^$@state_t)) :named ax_118))
   (assert (! (not (= ^$@struct ^$@thread_id)) :named ax_119))
   (assert (! (not (= ^$@struct ^List)) :named ax_120))
   (assert (! (not (= ^$@struct ^Node)) :named ax_121))
   (assert (! (not (= ^$@thread_id $@distTp1)) :named ax_122))
   (assert (! (not (= ^$@thread_id $@distTp1)) :named ax_123))
   (assert (! (not (= ^$@thread_id $@distTp2)) :named ax_124))
   (assert (! (not (= ^$@thread_id $@distTp2)) :named ax_125))
   (assert (! (not (= ^$@thread_id $@distTp3)) :named ax_126))
   (assert (! (not (= ^$@thread_id $@distTp3)) :named ax_127))
   (assert (! (not (= ^$@thread_id $@distTp4)) :named ax_128))
   (assert (! (not (= ^$@thread_id $@distTp4)) :named ax_129))
   (assert (! (not (= ^$@thread_id $@distTp5)) :named ax_130))
   (assert (! (not (= ^$@thread_id $@distTp5)) :named ax_131))
   (assert (! (not (= ^$@thread_id $@distTp6)) :named ax_132))
   (assert (! (not (= ^$@thread_id $@distTp6)) :named ax_133))
   (assert (! (not (= ^$@thread_id $memory_allocator_type)) :named ax_134))
   (assert (! (not (= ^$@thread_id ^$@ptrset)) :named ax_135))
   (assert (! (not (= ^$@thread_id ^$@state_t)) :named ax_136))
   (assert (! (not (= ^$@thread_id ^$@struct)) :named ax_137))
   (assert (! (not (= ^$@thread_id ^List)) :named ax_138))
   (assert (! (not (= ^$@thread_id ^Node)) :named ax_139))
   (assert (! (not (= ^$@thread_id_t $@distTp1)) :named ax_140))
   (assert (! (not (= ^$@thread_id_t $@distTp1)) :named ax_141))
   (assert (! (not (= ^$@thread_id_t $@distTp2)) :named ax_142))
   (assert (! (not (= ^$@thread_id_t $@distTp2)) :named ax_143))
   (assert (! (not (= ^$@thread_id_t $@distTp3)) :named ax_144))
   (assert (! (not (= ^$@thread_id_t $@distTp3)) :named ax_145))
   (assert (! (not (= ^$@thread_id_t $@distTp4)) :named ax_146))
   (assert (! (not (= ^$@thread_id_t $@distTp4)) :named ax_147))
   (assert (! (not (= ^$@thread_id_t $@distTp5)) :named ax_148))
   (assert (! (not (= ^$@thread_id_t $@distTp5)) :named ax_149))
   (assert (! (not (= ^$@thread_id_t $@distTp6)) :named ax_150))
   (assert (! (not (= ^$@thread_id_t $@distTp6)) :named ax_151))
   (assert (! (not (= ^$@thread_id_t $memory_allocator_type)) :named ax_152))
   (assert (! (not (= ^$@thread_id_t $memory_allocator_type)) :named ax_153))
   (assert (! (not (= ^$@thread_id_t ^$@ptrset)) :named ax_154))
   (assert (! (not (= ^$@thread_id_t ^$@ptrset)) :named ax_155))
   (assert (! (not (= ^$@thread_id_t ^$@state_t)) :named ax_156))
   (assert (! (not (= ^$@thread_id_t ^$@state_t)) :named ax_157))
   (assert (! (not (= ^$@thread_id_t ^$@struct)) :named ax_158))
   (assert (! (not (= ^$@thread_id_t ^$@struct)) :named ax_159))
   (assert (! (not (= ^$@thread_id_t ^$@thread_id)) :named ax_160))
   (assert (! (not (= ^$@thread_id_t ^$@thread_id)) :named ax_161))
   (assert (! (not (= ^$@thread_id_t ^List)) :named ax_162))
   (assert (! (not (= ^$@thread_id_t ^Node)) :named ax_163))
   (assert (! (not (= ^^bool $@distTp1)) :named ax_164))
   (assert (! (not (= ^^bool $@distTp1)) :named ax_165))
   (assert (! (not (= ^^bool $@distTp2)) :named ax_166))
   (assert (! (not (= ^^bool $@distTp2)) :named ax_167))
   (assert (! (not (= ^^bool $@distTp3)) :named ax_168))
   (assert (! (not (= ^^bool $@distTp3)) :named ax_169))
   (assert (! (not (= ^^bool $@distTp4)) :named ax_170))
   (assert (! (not (= ^^bool $@distTp4)) :named ax_171))
   (assert (! (not (= ^^bool $@distTp5)) :named ax_172))
   (assert (! (not (= ^^bool $@distTp5)) :named ax_173))
   (assert (! (not (= ^^bool $@distTp6)) :named ax_174))
   (assert (! (not (= ^^bool $@distTp6)) :named ax_175))
   (assert (! (not (= ^^bool $memory_allocator_type)) :named ax_176))
   (assert (! (not (= ^^bool $memory_allocator_type)) :named ax_177))
   (assert (! (not (= ^^bool ^$@ptrset)) :named ax_178))
   (assert (! (not (= ^^bool ^$@ptrset)) :named ax_179))
   (assert (! (not (= ^^bool ^$@state_t)) :named ax_180))
   (assert (! (not (= ^^bool ^$@state_t)) :named ax_181))
   (assert (! (not (= ^^bool ^$@struct)) :named ax_182))
   (assert (! (not (= ^^bool ^$@struct)) :named ax_183))
   (assert (! (not (= ^^bool ^$@thread_id)) :named ax_184))
   (assert (! (not (= ^^bool ^$@thread_id)) :named ax_185))
   (assert (! (not (= ^^bool ^$@thread_id_t)) :named ax_186))
   (assert (! (not (= ^^bool ^$@thread_id_t)) :named ax_187))
   (assert (! (not (= ^^bool ^^claim)) :named ax_188))
   (assert (! (not (= ^^bool ^^f4)) :named ax_189))
   (assert (! (not (= ^^bool ^^f8)) :named ax_190))
   (assert (! (not (= ^^bool ^^mathint)) :named ax_191))
   (assert (! (not (= ^^bool ^^root_emb)) :named ax_192))
   (assert (! (not (= ^^bool ^List)) :named ax_193))
   (assert (! (not (= ^^bool ^Node)) :named ax_194))
   (assert (! (not (= ^^claim $@distTp1)) :named ax_195))
   (assert (! (not (= ^^claim $@distTp1)) :named ax_196))
   (assert (! (not (= ^^claim $@distTp2)) :named ax_197))
   (assert (! (not (= ^^claim $@distTp2)) :named ax_198))
   (assert (! (not (= ^^claim $@distTp3)) :named ax_199))
   (assert (! (not (= ^^claim $@distTp3)) :named ax_200))
   (assert (! (not (= ^^claim $@distTp4)) :named ax_201))
   (assert (! (not (= ^^claim $@distTp4)) :named ax_202))
   (assert (! (not (= ^^claim $@distTp5)) :named ax_203))
   (assert (! (not (= ^^claim $@distTp5)) :named ax_204))
   (assert (! (not (= ^^claim $@distTp6)) :named ax_205))
   (assert (! (not (= ^^claim $@distTp6)) :named ax_206))
   (assert (! (not (= ^^claim $memory_allocator_type)) :named ax_207))
   (assert (! (not (= ^^claim $memory_allocator_type)) :named ax_208))
   (assert (! (not (= ^^claim ^$@ptrset)) :named ax_209))
   (assert (! (not (= ^^claim ^$@ptrset)) :named ax_210))
   (assert (! (not (= ^^claim ^$@state_t)) :named ax_211))
   (assert (! (not (= ^^claim ^$@state_t)) :named ax_212))
   (assert (! (not (= ^^claim ^$@struct)) :named ax_213))
   (assert (! (not (= ^^claim ^$@struct)) :named ax_214))
   (assert (! (not (= ^^claim ^$@thread_id)) :named ax_215))
   (assert (! (not (= ^^claim ^$@thread_id)) :named ax_216))
   (assert (! (not (= ^^claim ^$@thread_id_t)) :named ax_217))
   (assert (! (not (= ^^claim ^$@thread_id_t)) :named ax_218))
   (assert (! (not (= ^^claim ^^bool)) :named ax_219))
   (assert (! (not (= ^^claim ^^mathint)) :named ax_220))
   (assert (! (not (= ^^claim ^^root_emb)) :named ax_221))
   (assert (! (not (= ^^claim ^List)) :named ax_222))
   (assert (! (not (= ^^claim ^Node)) :named ax_223))
   (assert (! (not (= ^^f4 $@distTp1)) :named ax_224))
   (assert (! (not (= ^^f4 $@distTp1)) :named ax_225))
   (assert (! (not (= ^^f4 $@distTp2)) :named ax_226))
   (assert (! (not (= ^^f4 $@distTp2)) :named ax_227))
   (assert (! (not (= ^^f4 $@distTp3)) :named ax_228))
   (assert (! (not (= ^^f4 $@distTp3)) :named ax_229))
   (assert (! (not (= ^^f4 $@distTp4)) :named ax_230))
   (assert (! (not (= ^^f4 $@distTp4)) :named ax_231))
   (assert (! (not (= ^^f4 $@distTp5)) :named ax_232))
   (assert (! (not (= ^^f4 $@distTp5)) :named ax_233))
   (assert (! (not (= ^^f4 $@distTp6)) :named ax_234))
   (assert (! (not (= ^^f4 $@distTp6)) :named ax_235))
   (assert (! (not (= ^^f4 $memory_allocator_type)) :named ax_236))
   (assert (! (not (= ^^f4 $memory_allocator_type)) :named ax_237))
   (assert (! (not (= ^^f4 ^$@ptrset)) :named ax_238))
   (assert (! (not (= ^^f4 ^$@ptrset)) :named ax_239))
   (assert (! (not (= ^^f4 ^$@state_t)) :named ax_240))
   (assert (! (not (= ^^f4 ^$@state_t)) :named ax_241))
   (assert (! (not (= ^^f4 ^$@struct)) :named ax_242))
   (assert (! (not (= ^^f4 ^$@struct)) :named ax_243))
   (assert (! (not (= ^^f4 ^$@thread_id)) :named ax_244))
   (assert (! (not (= ^^f4 ^$@thread_id)) :named ax_245))
   (assert (! (not (= ^^f4 ^$@thread_id_t)) :named ax_246))
   (assert (! (not (= ^^f4 ^$@thread_id_t)) :named ax_247))
   (assert (! (not (= ^^f4 ^^bool)) :named ax_248))
   (assert (! (not (= ^^f4 ^^claim)) :named ax_249))
   (assert (! (not (= ^^f4 ^^claim)) :named ax_250))
   (assert (! (not (= ^^f4 ^^f8)) :named ax_251))
   (assert (! (not (= ^^f4 ^^mathint)) :named ax_252))
   (assert (! (not (= ^^f4 ^^root_emb)) :named ax_253))
   (assert (! (not (= ^^f4 ^List)) :named ax_254))
   (assert (! (not (= ^^f4 ^Node)) :named ax_255))
   (assert (! (not (= ^^f8 $@distTp1)) :named ax_256))
   (assert (! (not (= ^^f8 $@distTp1)) :named ax_257))
   (assert (! (not (= ^^f8 $@distTp2)) :named ax_258))
   (assert (! (not (= ^^f8 $@distTp2)) :named ax_259))
   (assert (! (not (= ^^f8 $@distTp3)) :named ax_260))
   (assert (! (not (= ^^f8 $@distTp3)) :named ax_261))
   (assert (! (not (= ^^f8 $@distTp4)) :named ax_262))
   (assert (! (not (= ^^f8 $@distTp4)) :named ax_263))
   (assert (! (not (= ^^f8 $@distTp5)) :named ax_264))
   (assert (! (not (= ^^f8 $@distTp5)) :named ax_265))
   (assert (! (not (= ^^f8 $@distTp6)) :named ax_266))
   (assert (! (not (= ^^f8 $@distTp6)) :named ax_267))
   (assert (! (not (= ^^f8 $memory_allocator_type)) :named ax_268))
   (assert (! (not (= ^^f8 $memory_allocator_type)) :named ax_269))
   (assert (! (not (= ^^f8 ^$@ptrset)) :named ax_270))
   (assert (! (not (= ^^f8 ^$@ptrset)) :named ax_271))
   (assert (! (not (= ^^f8 ^$@state_t)) :named ax_272))
   (assert (! (not (= ^^f8 ^$@state_t)) :named ax_273))
   (assert (! (not (= ^^f8 ^$@struct)) :named ax_274))
   (assert (! (not (= ^^f8 ^$@struct)) :named ax_275))
   (assert (! (not (= ^^f8 ^$@thread_id)) :named ax_276))
   (assert (! (not (= ^^f8 ^$@thread_id)) :named ax_277))
   (assert (! (not (= ^^f8 ^$@thread_id_t)) :named ax_278))
   (assert (! (not (= ^^f8 ^$@thread_id_t)) :named ax_279))
   (assert (! (not (= ^^f8 ^^bool)) :named ax_280))
   (assert (! (not (= ^^f8 ^^claim)) :named ax_281))
   (assert (! (not (= ^^f8 ^^claim)) :named ax_282))
   (assert (! (not (= ^^f8 ^^f4)) :named ax_283))
   (assert (! (not (= ^^f8 ^^mathint)) :named ax_284))
   (assert (! (not (= ^^f8 ^^root_emb)) :named ax_285))
   (assert (! (not (= ^^f8 ^List)) :named ax_286))
   (assert (! (not (= ^^f8 ^Node)) :named ax_287))
   (assert (! (not (= ^^i1 $@distTp1)) :named ax_288))
   (assert (! (not (= ^^i1 $@distTp1)) :named ax_289))
   (assert (! (not (= ^^i1 $@distTp2)) :named ax_290))
   (assert (! (not (= ^^i1 $@distTp2)) :named ax_291))
   (assert (! (not (= ^^i1 $@distTp3)) :named ax_292))
   (assert (! (not (= ^^i1 $@distTp3)) :named ax_293))
   (assert (! (not (= ^^i1 $@distTp4)) :named ax_294))
   (assert (! (not (= ^^i1 $@distTp4)) :named ax_295))
   (assert (! (not (= ^^i1 $@distTp5)) :named ax_296))
   (assert (! (not (= ^^i1 $@distTp5)) :named ax_297))
   (assert (! (not (= ^^i1 $@distTp6)) :named ax_298))
   (assert (! (not (= ^^i1 $@distTp6)) :named ax_299))
   (assert (! (not (= ^^i1 $memory_allocator_type)) :named ax_300))
   (assert (! (not (= ^^i1 $memory_allocator_type)) :named ax_301))
   (assert (! (not (= ^^i1 ^$@ptrset)) :named ax_302))
   (assert (! (not (= ^^i1 ^$@ptrset)) :named ax_303))
   (assert (! (not (= ^^i1 ^$@state_t)) :named ax_304))
   (assert (! (not (= ^^i1 ^$@state_t)) :named ax_305))
   (assert (! (not (= ^^i1 ^$@struct)) :named ax_306))
   (assert (! (not (= ^^i1 ^$@struct)) :named ax_307))
   (assert (! (not (= ^^i1 ^$@thread_id)) :named ax_308))
   (assert (! (not (= ^^i1 ^$@thread_id)) :named ax_309))
   (assert (! (not (= ^^i1 ^$@thread_id_t)) :named ax_310))
   (assert (! (not (= ^^i1 ^$@thread_id_t)) :named ax_311))
   (assert (! (not (= ^^i1 ^^bool)) :named ax_312))
   (assert (! (not (= ^^i1 ^^bool)) :named ax_313))
   (assert (! (not (= ^^i1 ^^claim)) :named ax_314))
   (assert (! (not (= ^^i1 ^^claim)) :named ax_315))
   (assert (! (not (= ^^i1 ^^f4)) :named ax_316))
   (assert (! (not (= ^^i1 ^^f4)) :named ax_317))
   (assert (! (not (= ^^i1 ^^f8)) :named ax_318))
   (assert (! (not (= ^^i1 ^^f8)) :named ax_319))
   (assert (! (not (= ^^i1 ^^i2)) :named ax_320))
   (assert (! (not (= ^^i1 ^^i4)) :named ax_321))
   (assert (! (not (= ^^i1 ^^i8)) :named ax_322))
   (assert (! (not (= ^^i1 ^^mathint)) :named ax_323))
   (assert (! (not (= ^^i1 ^^root_emb)) :named ax_324))
   (assert (! (not (= ^^i1 ^^u1)) :named ax_325))
   (assert (! (not (= ^^i1 ^^u2)) :named ax_326))
   (assert (! (not (= ^^i1 ^^u4)) :named ax_327))
   (assert (! (not (= ^^i1 ^^u8)) :named ax_328))
   (assert (! (not (= ^^i1 ^^void)) :named ax_329))
   (assert (! (not (= ^^i1 ^List)) :named ax_330))
   (assert (! (not (= ^^i1 ^Node)) :named ax_331))
   (assert (! (not (= ^^i2 $@distTp1)) :named ax_332))
   (assert (! (not (= ^^i2 $@distTp1)) :named ax_333))
   (assert (! (not (= ^^i2 $@distTp2)) :named ax_334))
   (assert (! (not (= ^^i2 $@distTp2)) :named ax_335))
   (assert (! (not (= ^^i2 $@distTp3)) :named ax_336))
   (assert (! (not (= ^^i2 $@distTp3)) :named ax_337))
   (assert (! (not (= ^^i2 $@distTp4)) :named ax_338))
   (assert (! (not (= ^^i2 $@distTp4)) :named ax_339))
   (assert (! (not (= ^^i2 $@distTp5)) :named ax_340))
   (assert (! (not (= ^^i2 $@distTp5)) :named ax_341))
   (assert (! (not (= ^^i2 $@distTp6)) :named ax_342))
   (assert (! (not (= ^^i2 $@distTp6)) :named ax_343))
   (assert (! (not (= ^^i2 $memory_allocator_type)) :named ax_344))
   (assert (! (not (= ^^i2 $memory_allocator_type)) :named ax_345))
   (assert (! (not (= ^^i2 ^$@ptrset)) :named ax_346))
   (assert (! (not (= ^^i2 ^$@ptrset)) :named ax_347))
   (assert (! (not (= ^^i2 ^$@state_t)) :named ax_348))
   (assert (! (not (= ^^i2 ^$@state_t)) :named ax_349))
   (assert (! (not (= ^^i2 ^$@struct)) :named ax_350))
   (assert (! (not (= ^^i2 ^$@struct)) :named ax_351))
   (assert (! (not (= ^^i2 ^$@thread_id)) :named ax_352))
   (assert (! (not (= ^^i2 ^$@thread_id)) :named ax_353))
   (assert (! (not (= ^^i2 ^$@thread_id_t)) :named ax_354))
   (assert (! (not (= ^^i2 ^$@thread_id_t)) :named ax_355))
   (assert (! (not (= ^^i2 ^^bool)) :named ax_356))
   (assert (! (not (= ^^i2 ^^bool)) :named ax_357))
   (assert (! (not (= ^^i2 ^^claim)) :named ax_358))
   (assert (! (not (= ^^i2 ^^claim)) :named ax_359))
   (assert (! (not (= ^^i2 ^^f4)) :named ax_360))
   (assert (! (not (= ^^i2 ^^f4)) :named ax_361))
   (assert (! (not (= ^^i2 ^^f8)) :named ax_362))
   (assert (! (not (= ^^i2 ^^f8)) :named ax_363))
   (assert (! (not (= ^^i2 ^^i1)) :named ax_364))
   (assert (! (not (= ^^i2 ^^i4)) :named ax_365))
   (assert (! (not (= ^^i2 ^^i8)) :named ax_366))
   (assert (! (not (= ^^i2 ^^mathint)) :named ax_367))
   (assert (! (not (= ^^i2 ^^root_emb)) :named ax_368))
   (assert (! (not (= ^^i2 ^^u1)) :named ax_369))
   (assert (! (not (= ^^i2 ^^u2)) :named ax_370))
   (assert (! (not (= ^^i2 ^^u4)) :named ax_371))
   (assert (! (not (= ^^i2 ^^u8)) :named ax_372))
   (assert (! (not (= ^^i2 ^^void)) :named ax_373))
   (assert (! (not (= ^^i2 ^List)) :named ax_374))
   (assert (! (not (= ^^i2 ^Node)) :named ax_375))
   (assert (! (not (= ^^i4 $@distTp1)) :named ax_376))
   (assert (! (not (= ^^i4 $@distTp1)) :named ax_377))
   (assert (! (not (= ^^i4 $@distTp2)) :named ax_378))
   (assert (! (not (= ^^i4 $@distTp2)) :named ax_379))
   (assert (! (not (= ^^i4 $@distTp3)) :named ax_380))
   (assert (! (not (= ^^i4 $@distTp3)) :named ax_381))
   (assert (! (not (= ^^i4 $@distTp4)) :named ax_382))
   (assert (! (not (= ^^i4 $@distTp4)) :named ax_383))
   (assert (! (not (= ^^i4 $@distTp5)) :named ax_384))
   (assert (! (not (= ^^i4 $@distTp5)) :named ax_385))
   (assert (! (not (= ^^i4 $@distTp6)) :named ax_386))
   (assert (! (not (= ^^i4 $@distTp6)) :named ax_387))
   (assert (! (not (= ^^i4 $memory_allocator_type)) :named ax_388))
   (assert (! (not (= ^^i4 $memory_allocator_type)) :named ax_389))
   (assert (! (not (= ^^i4 ^$@ptrset)) :named ax_390))
   (assert (! (not (= ^^i4 ^$@ptrset)) :named ax_391))
   (assert (! (not (= ^^i4 ^$@state_t)) :named ax_392))
   (assert (! (not (= ^^i4 ^$@state_t)) :named ax_393))
   (assert (! (not (= ^^i4 ^$@struct)) :named ax_394))
   (assert (! (not (= ^^i4 ^$@struct)) :named ax_395))
   (assert (! (not (= ^^i4 ^$@thread_id)) :named ax_396))
   (assert (! (not (= ^^i4 ^$@thread_id)) :named ax_397))
   (assert (! (not (= ^^i4 ^$@thread_id_t)) :named ax_398))
   (assert (! (not (= ^^i4 ^$@thread_id_t)) :named ax_399))
   (assert (! (not (= ^^i4 ^^bool)) :named ax_400))
   (assert (! (not (= ^^i4 ^^bool)) :named ax_401))
   (assert (! (not (= ^^i4 ^^claim)) :named ax_402))
   (assert (! (not (= ^^i4 ^^claim)) :named ax_403))
   (assert (! (not (= ^^i4 ^^f4)) :named ax_404))
   (assert (! (not (= ^^i4 ^^f4)) :named ax_405))
   (assert (! (not (= ^^i4 ^^f8)) :named ax_406))
   (assert (! (not (= ^^i4 ^^f8)) :named ax_407))
   (assert (! (not (= ^^i4 ^^i1)) :named ax_408))
   (assert (! (not (= ^^i4 ^^i2)) :named ax_409))
   (assert (! (not (= ^^i4 ^^i8)) :named ax_410))
   (assert (! (not (= ^^i4 ^^mathint)) :named ax_411))
   (assert (! (not (= ^^i4 ^^root_emb)) :named ax_412))
   (assert (! (not (= ^^i4 ^^u1)) :named ax_413))
   (assert (! (not (= ^^i4 ^^u2)) :named ax_414))
   (assert (! (not (= ^^i4 ^^u4)) :named ax_415))
   (assert (! (not (= ^^i4 ^^u8)) :named ax_416))
   (assert (! (not (= ^^i4 ^^void)) :named ax_417))
   (assert (! (not (= ^^i4 ^List)) :named ax_418))
   (assert (! (not (= ^^i4 ^Node)) :named ax_419))
   (assert (! (not (= ^^i8 $@distTp1)) :named ax_420))
   (assert (! (not (= ^^i8 $@distTp1)) :named ax_421))
   (assert (! (not (= ^^i8 $@distTp2)) :named ax_422))
   (assert (! (not (= ^^i8 $@distTp2)) :named ax_423))
   (assert (! (not (= ^^i8 $@distTp3)) :named ax_424))
   (assert (! (not (= ^^i8 $@distTp3)) :named ax_425))
   (assert (! (not (= ^^i8 $@distTp4)) :named ax_426))
   (assert (! (not (= ^^i8 $@distTp4)) :named ax_427))
   (assert (! (not (= ^^i8 $@distTp5)) :named ax_428))
   (assert (! (not (= ^^i8 $@distTp5)) :named ax_429))
   (assert (! (not (= ^^i8 $@distTp6)) :named ax_430))
   (assert (! (not (= ^^i8 $@distTp6)) :named ax_431))
   (assert (! (not (= ^^i8 $memory_allocator_type)) :named ax_432))
   (assert (! (not (= ^^i8 $memory_allocator_type)) :named ax_433))
   (assert (! (not (= ^^i8 ^$@ptrset)) :named ax_434))
   (assert (! (not (= ^^i8 ^$@ptrset)) :named ax_435))
   (assert (! (not (= ^^i8 ^$@state_t)) :named ax_436))
   (assert (! (not (= ^^i8 ^$@state_t)) :named ax_437))
   (assert (! (not (= ^^i8 ^$@struct)) :named ax_438))
   (assert (! (not (= ^^i8 ^$@struct)) :named ax_439))
   (assert (! (not (= ^^i8 ^$@thread_id)) :named ax_440))
   (assert (! (not (= ^^i8 ^$@thread_id)) :named ax_441))
   (assert (! (not (= ^^i8 ^$@thread_id_t)) :named ax_442))
   (assert (! (not (= ^^i8 ^$@thread_id_t)) :named ax_443))
   (assert (! (not (= ^^i8 ^^bool)) :named ax_444))
   (assert (! (not (= ^^i8 ^^bool)) :named ax_445))
   (assert (! (not (= ^^i8 ^^claim)) :named ax_446))
   (assert (! (not (= ^^i8 ^^claim)) :named ax_447))
   (assert (! (not (= ^^i8 ^^f4)) :named ax_448))
   (assert (! (not (= ^^i8 ^^f4)) :named ax_449))
   (assert (! (not (= ^^i8 ^^f8)) :named ax_450))
   (assert (! (not (= ^^i8 ^^f8)) :named ax_451))
   (assert (! (not (= ^^i8 ^^i1)) :named ax_452))
   (assert (! (not (= ^^i8 ^^i2)) :named ax_453))
   (assert (! (not (= ^^i8 ^^i4)) :named ax_454))
   (assert (! (not (= ^^i8 ^^mathint)) :named ax_455))
   (assert (! (not (= ^^i8 ^^root_emb)) :named ax_456))
   (assert (! (not (= ^^i8 ^^u1)) :named ax_457))
   (assert (! (not (= ^^i8 ^^u2)) :named ax_458))
   (assert (! (not (= ^^i8 ^^u4)) :named ax_459))
   (assert (! (not (= ^^i8 ^^u8)) :named ax_460))
   (assert (! (not (= ^^i8 ^^void)) :named ax_461))
   (assert (! (not (= ^^i8 ^List)) :named ax_462))
   (assert (! (not (= ^^i8 ^Node)) :named ax_463))
   (assert (! (not (= ^^mathint $@distTp1)) :named ax_464))
   (assert (! (not (= ^^mathint $@distTp1)) :named ax_465))
   (assert (! (not (= ^^mathint $@distTp2)) :named ax_466))
   (assert (! (not (= ^^mathint $@distTp2)) :named ax_467))
   (assert (! (not (= ^^mathint $@distTp3)) :named ax_468))
   (assert (! (not (= ^^mathint $@distTp3)) :named ax_469))
   (assert (! (not (= ^^mathint $@distTp4)) :named ax_470))
   (assert (! (not (= ^^mathint $@distTp4)) :named ax_471))
   (assert (! (not (= ^^mathint $@distTp5)) :named ax_472))
   (assert (! (not (= ^^mathint $@distTp5)) :named ax_473))
   (assert (! (not (= ^^mathint $@distTp6)) :named ax_474))
   (assert (! (not (= ^^mathint $@distTp6)) :named ax_475))
   (assert (! (not (= ^^mathint $memory_allocator_type)) :named ax_476))
   (assert (! (not (= ^^mathint $memory_allocator_type)) :named ax_477))
   (assert (! (not (= ^^mathint ^$@ptrset)) :named ax_478))
   (assert (! (not (= ^^mathint ^$@ptrset)) :named ax_479))
   (assert (! (not (= ^^mathint ^$@state_t)) :named ax_480))
   (assert (! (not (= ^^mathint ^$@state_t)) :named ax_481))
   (assert (! (not (= ^^mathint ^$@struct)) :named ax_482))
   (assert (! (not (= ^^mathint ^$@struct)) :named ax_483))
   (assert (! (not (= ^^mathint ^$@thread_id)) :named ax_484))
   (assert (! (not (= ^^mathint ^$@thread_id)) :named ax_485))
   (assert (! (not (= ^^mathint ^$@thread_id_t)) :named ax_486))
   (assert (! (not (= ^^mathint ^$@thread_id_t)) :named ax_487))
   (assert (! (not (= ^^mathint ^^bool)) :named ax_488))
   (assert (! (not (= ^^mathint ^^claim)) :named ax_489))
   (assert (! (not (= ^^mathint ^^f4)) :named ax_490))
   (assert (! (not (= ^^mathint ^^f8)) :named ax_491))
   (assert (! (not (= ^^mathint ^^i1)) :named ax_492))
   (assert (! (not (= ^^mathint ^^i2)) :named ax_493))
   (assert (! (not (= ^^mathint ^^i4)) :named ax_494))
   (assert (! (not (= ^^mathint ^^i8)) :named ax_495))
   (assert (! (not (= ^^mathint ^List)) :named ax_496))
   (assert (! (not (= ^^mathint ^Node)) :named ax_497))
   (assert (! (not (= ^^root_emb $@distTp1)) :named ax_498))
   (assert (! (not (= ^^root_emb $@distTp1)) :named ax_499))
   (assert (! (not (= ^^root_emb $@distTp2)) :named ax_500))
   (assert (! (not (= ^^root_emb $@distTp2)) :named ax_501))
   (assert (! (not (= ^^root_emb $@distTp3)) :named ax_502))
   (assert (! (not (= ^^root_emb $@distTp3)) :named ax_503))
   (assert (! (not (= ^^root_emb $@distTp4)) :named ax_504))
   (assert (! (not (= ^^root_emb $@distTp4)) :named ax_505))
   (assert (! (not (= ^^root_emb $@distTp5)) :named ax_506))
   (assert (! (not (= ^^root_emb $@distTp5)) :named ax_507))
   (assert (! (not (= ^^root_emb $@distTp6)) :named ax_508))
   (assert (! (not (= ^^root_emb $@distTp6)) :named ax_509))
   (assert (! (not (= ^^root_emb $memory_allocator_type)) :named ax_510))
   (assert (! (not (= ^^root_emb $memory_allocator_type)) :named ax_511))
   (assert (! (not (= ^^root_emb ^$@ptrset)) :named ax_512))
   (assert (! (not (= ^^root_emb ^$@ptrset)) :named ax_513))
   (assert (! (not (= ^^root_emb ^$@state_t)) :named ax_514))
   (assert (! (not (= ^^root_emb ^$@state_t)) :named ax_515))
   (assert (! (not (= ^^root_emb ^$@struct)) :named ax_516))
   (assert (! (not (= ^^root_emb ^$@struct)) :named ax_517))
   (assert (! (not (= ^^root_emb ^$@thread_id)) :named ax_518))
   (assert (! (not (= ^^root_emb ^$@thread_id)) :named ax_519))
   (assert (! (not (= ^^root_emb ^$@thread_id_t)) :named ax_520))
   (assert (! (not (= ^^root_emb ^$@thread_id_t)) :named ax_521))
   (assert (! (not (= ^^root_emb ^^bool)) :named ax_522))
   (assert (! (not (= ^^root_emb ^^claim)) :named ax_523))
   (assert (! (not (= ^^root_emb ^^f4)) :named ax_524))
   (assert (! (not (= ^^root_emb ^^f8)) :named ax_525))
   (assert (! (not (= ^^root_emb ^^i1)) :named ax_526))
   (assert (! (not (= ^^root_emb ^^i2)) :named ax_527))
   (assert (! (not (= ^^root_emb ^^i4)) :named ax_528))
   (assert (! (not (= ^^root_emb ^^i8)) :named ax_529))
   (assert (! (not (= ^^root_emb ^^mathint)) :named ax_530))
   (assert (! (not (= ^^root_emb ^^mathint)) :named ax_531))
   (assert (! (not (= ^^root_emb ^List)) :named ax_532))
   (assert (! (not (= ^^root_emb ^Node)) :named ax_533))
   (assert (! (not (= ^^u1 $@distTp1)) :named ax_534))
   (assert (! (not (= ^^u1 $@distTp1)) :named ax_535))
   (assert (! (not (= ^^u1 $@distTp2)) :named ax_536))
   (assert (! (not (= ^^u1 $@distTp2)) :named ax_537))
   (assert (! (not (= ^^u1 $@distTp3)) :named ax_538))
   (assert (! (not (= ^^u1 $@distTp3)) :named ax_539))
   (assert (! (not (= ^^u1 $@distTp4)) :named ax_540))
   (assert (! (not (= ^^u1 $@distTp4)) :named ax_541))
   (assert (! (not (= ^^u1 $@distTp5)) :named ax_542))
   (assert (! (not (= ^^u1 $@distTp5)) :named ax_543))
   (assert (! (not (= ^^u1 $@distTp6)) :named ax_544))
   (assert (! (not (= ^^u1 $@distTp6)) :named ax_545))
   (assert (! (not (= ^^u1 $memory_allocator_type)) :named ax_546))
   (assert (! (not (= ^^u1 $memory_allocator_type)) :named ax_547))
   (assert (! (not (= ^^u1 ^$@ptrset)) :named ax_548))
   (assert (! (not (= ^^u1 ^$@ptrset)) :named ax_549))
   (assert (! (not (= ^^u1 ^$@state_t)) :named ax_550))
   (assert (! (not (= ^^u1 ^$@state_t)) :named ax_551))
   (assert (! (not (= ^^u1 ^$@struct)) :named ax_552))
   (assert (! (not (= ^^u1 ^$@struct)) :named ax_553))
   (assert (! (not (= ^^u1 ^$@thread_id)) :named ax_554))
   (assert (! (not (= ^^u1 ^$@thread_id)) :named ax_555))
   (assert (! (not (= ^^u1 ^$@thread_id_t)) :named ax_556))
   (assert (! (not (= ^^u1 ^$@thread_id_t)) :named ax_557))
   (assert (! (not (= ^^u1 ^^bool)) :named ax_558))
   (assert (! (not (= ^^u1 ^^bool)) :named ax_559))
   (assert (! (not (= ^^u1 ^^claim)) :named ax_560))
   (assert (! (not (= ^^u1 ^^claim)) :named ax_561))
   (assert (! (not (= ^^u1 ^^f4)) :named ax_562))
   (assert (! (not (= ^^u1 ^^f4)) :named ax_563))
   (assert (! (not (= ^^u1 ^^f8)) :named ax_564))
   (assert (! (not (= ^^u1 ^^f8)) :named ax_565))
   (assert (! (not (= ^^u1 ^^i1)) :named ax_566))
   (assert (! (not (= ^^u1 ^^i2)) :named ax_567))
   (assert (! (not (= ^^u1 ^^i4)) :named ax_568))
   (assert (! (not (= ^^u1 ^^i8)) :named ax_569))
   (assert (! (not (= ^^u1 ^^mathint)) :named ax_570))
   (assert (! (not (= ^^u1 ^^mathint)) :named ax_571))
   (assert (! (not (= ^^u1 ^^root_emb)) :named ax_572))
   (assert (! (not (= ^^u1 ^^root_emb)) :named ax_573))
   (assert (! (not (= ^^u1 ^^u2)) :named ax_574))
   (assert (! (not (= ^^u1 ^^u4)) :named ax_575))
   (assert (! (not (= ^^u1 ^^u8)) :named ax_576))
   (assert (! (not (= ^^u1 ^^void)) :named ax_577))
   (assert (! (not (= ^^u1 ^List)) :named ax_578))
   (assert (! (not (= ^^u1 ^Node)) :named ax_579))
   (assert (! (not (= ^^u2 $@distTp1)) :named ax_580))
   (assert (! (not (= ^^u2 $@distTp1)) :named ax_581))
   (assert (! (not (= ^^u2 $@distTp2)) :named ax_582))
   (assert (! (not (= ^^u2 $@distTp2)) :named ax_583))
   (assert (! (not (= ^^u2 $@distTp3)) :named ax_584))
   (assert (! (not (= ^^u2 $@distTp3)) :named ax_585))
   (assert (! (not (= ^^u2 $@distTp4)) :named ax_586))
   (assert (! (not (= ^^u2 $@distTp4)) :named ax_587))
   (assert (! (not (= ^^u2 $@distTp5)) :named ax_588))
   (assert (! (not (= ^^u2 $@distTp5)) :named ax_589))
   (assert (! (not (= ^^u2 $@distTp6)) :named ax_590))
   (assert (! (not (= ^^u2 $@distTp6)) :named ax_591))
   (assert (! (not (= ^^u2 $memory_allocator_type)) :named ax_592))
   (assert (! (not (= ^^u2 $memory_allocator_type)) :named ax_593))
   (assert (! (not (= ^^u2 ^$@ptrset)) :named ax_594))
   (assert (! (not (= ^^u2 ^$@ptrset)) :named ax_595))
   (assert (! (not (= ^^u2 ^$@state_t)) :named ax_596))
   (assert (! (not (= ^^u2 ^$@state_t)) :named ax_597))
   (assert (! (not (= ^^u2 ^$@struct)) :named ax_598))
   (assert (! (not (= ^^u2 ^$@struct)) :named ax_599))
   (assert (! (not (= ^^u2 ^$@thread_id)) :named ax_600))
   (assert (! (not (= ^^u2 ^$@thread_id)) :named ax_601))
   (assert (! (not (= ^^u2 ^$@thread_id_t)) :named ax_602))
   (assert (! (not (= ^^u2 ^$@thread_id_t)) :named ax_603))
   (assert (! (not (= ^^u2 ^^bool)) :named ax_604))
   (assert (! (not (= ^^u2 ^^bool)) :named ax_605))
   (assert (! (not (= ^^u2 ^^claim)) :named ax_606))
   (assert (! (not (= ^^u2 ^^claim)) :named ax_607))
   (assert (! (not (= ^^u2 ^^f4)) :named ax_608))
   (assert (! (not (= ^^u2 ^^f4)) :named ax_609))
   (assert (! (not (= ^^u2 ^^f8)) :named ax_610))
   (assert (! (not (= ^^u2 ^^f8)) :named ax_611))
   (assert (! (not (= ^^u2 ^^i1)) :named ax_612))
   (assert (! (not (= ^^u2 ^^i2)) :named ax_613))
   (assert (! (not (= ^^u2 ^^i4)) :named ax_614))
   (assert (! (not (= ^^u2 ^^i8)) :named ax_615))
   (assert (! (not (= ^^u2 ^^mathint)) :named ax_616))
   (assert (! (not (= ^^u2 ^^mathint)) :named ax_617))
   (assert (! (not (= ^^u2 ^^root_emb)) :named ax_618))
   (assert (! (not (= ^^u2 ^^root_emb)) :named ax_619))
   (assert (! (not (= ^^u2 ^^u1)) :named ax_620))
   (assert (! (not (= ^^u2 ^^u4)) :named ax_621))
   (assert (! (not (= ^^u2 ^^u8)) :named ax_622))
   (assert (! (not (= ^^u2 ^^void)) :named ax_623))
   (assert (! (not (= ^^u2 ^List)) :named ax_624))
   (assert (! (not (= ^^u2 ^Node)) :named ax_625))
   (assert (! (not (= ^^u4 $@distTp1)) :named ax_626))
   (assert (! (not (= ^^u4 $@distTp1)) :named ax_627))
   (assert (! (not (= ^^u4 $@distTp2)) :named ax_628))
   (assert (! (not (= ^^u4 $@distTp2)) :named ax_629))
   (assert (! (not (= ^^u4 $@distTp3)) :named ax_630))
   (assert (! (not (= ^^u4 $@distTp3)) :named ax_631))
   (assert (! (not (= ^^u4 $@distTp4)) :named ax_632))
   (assert (! (not (= ^^u4 $@distTp4)) :named ax_633))
   (assert (! (not (= ^^u4 $@distTp5)) :named ax_634))
   (assert (! (not (= ^^u4 $@distTp5)) :named ax_635))
   (assert (! (not (= ^^u4 $@distTp6)) :named ax_636))
   (assert (! (not (= ^^u4 $@distTp6)) :named ax_637))
   (assert (! (not (= ^^u4 $memory_allocator_type)) :named ax_638))
   (assert (! (not (= ^^u4 $memory_allocator_type)) :named ax_639))
   (assert (! (not (= ^^u4 ^$@ptrset)) :named ax_640))
   (assert (! (not (= ^^u4 ^$@ptrset)) :named ax_641))
   (assert (! (not (= ^^u4 ^$@state_t)) :named ax_642))
   (assert (! (not (= ^^u4 ^$@state_t)) :named ax_643))
   (assert (! (not (= ^^u4 ^$@struct)) :named ax_644))
   (assert (! (not (= ^^u4 ^$@struct)) :named ax_645))
   (assert (! (not (= ^^u4 ^$@thread_id)) :named ax_646))
   (assert (! (not (= ^^u4 ^$@thread_id)) :named ax_647))
   (assert (! (not (= ^^u4 ^$@thread_id_t)) :named ax_648))
   (assert (! (not (= ^^u4 ^$@thread_id_t)) :named ax_649))
   (assert (! (not (= ^^u4 ^^bool)) :named ax_650))
   (assert (! (not (= ^^u4 ^^bool)) :named ax_651))
   (assert (! (not (= ^^u4 ^^claim)) :named ax_652))
   (assert (! (not (= ^^u4 ^^claim)) :named ax_653))
   (assert (! (not (= ^^u4 ^^f4)) :named ax_654))
   (assert (! (not (= ^^u4 ^^f4)) :named ax_655))
   (assert (! (not (= ^^u4 ^^f8)) :named ax_656))
   (assert (! (not (= ^^u4 ^^f8)) :named ax_657))
   (assert (! (not (= ^^u4 ^^i1)) :named ax_658))
   (assert (! (not (= ^^u4 ^^i2)) :named ax_659))
   (assert (! (not (= ^^u4 ^^i4)) :named ax_660))
   (assert (! (not (= ^^u4 ^^i8)) :named ax_661))
   (assert (! (not (= ^^u4 ^^mathint)) :named ax_662))
   (assert (! (not (= ^^u4 ^^mathint)) :named ax_663))
   (assert (! (not (= ^^u4 ^^root_emb)) :named ax_664))
   (assert (! (not (= ^^u4 ^^root_emb)) :named ax_665))
   (assert (! (not (= ^^u4 ^^u1)) :named ax_666))
   (assert (! (not (= ^^u4 ^^u2)) :named ax_667))
   (assert (! (not (= ^^u4 ^^u8)) :named ax_668))
   (assert (! (not (= ^^u4 ^^void)) :named ax_669))
   (assert (! (not (= ^^u4 ^List)) :named ax_670))
   (assert (! (not (= ^^u4 ^Node)) :named ax_671))
   (assert (! (not (= ^^u8 $@distTp1)) :named ax_672))
   (assert (! (not (= ^^u8 $@distTp1)) :named ax_673))
   (assert (! (not (= ^^u8 $@distTp2)) :named ax_674))
   (assert (! (not (= ^^u8 $@distTp2)) :named ax_675))
   (assert (! (not (= ^^u8 $@distTp3)) :named ax_676))
   (assert (! (not (= ^^u8 $@distTp3)) :named ax_677))
   (assert (! (not (= ^^u8 $@distTp4)) :named ax_678))
   (assert (! (not (= ^^u8 $@distTp4)) :named ax_679))
   (assert (! (not (= ^^u8 $@distTp5)) :named ax_680))
   (assert (! (not (= ^^u8 $@distTp5)) :named ax_681))
   (assert (! (not (= ^^u8 $@distTp6)) :named ax_682))
   (assert (! (not (= ^^u8 $@distTp6)) :named ax_683))
   (assert (! (not (= ^^u8 $memory_allocator_type)) :named ax_684))
   (assert (! (not (= ^^u8 $memory_allocator_type)) :named ax_685))
   (assert (! (not (= ^^u8 ^$@ptrset)) :named ax_686))
   (assert (! (not (= ^^u8 ^$@ptrset)) :named ax_687))
   (assert (! (not (= ^^u8 ^$@state_t)) :named ax_688))
   (assert (! (not (= ^^u8 ^$@state_t)) :named ax_689))
   (assert (! (not (= ^^u8 ^$@struct)) :named ax_690))
   (assert (! (not (= ^^u8 ^$@struct)) :named ax_691))
   (assert (! (not (= ^^u8 ^$@thread_id)) :named ax_692))
   (assert (! (not (= ^^u8 ^$@thread_id)) :named ax_693))
   (assert (! (not (= ^^u8 ^$@thread_id_t)) :named ax_694))
   (assert (! (not (= ^^u8 ^$@thread_id_t)) :named ax_695))
   (assert (! (not (= ^^u8 ^^bool)) :named ax_696))
   (assert (! (not (= ^^u8 ^^bool)) :named ax_697))
   (assert (! (not (= ^^u8 ^^claim)) :named ax_698))
   (assert (! (not (= ^^u8 ^^claim)) :named ax_699))
   (assert (! (not (= ^^u8 ^^f4)) :named ax_700))
   (assert (! (not (= ^^u8 ^^f4)) :named ax_701))
   (assert (! (not (= ^^u8 ^^f8)) :named ax_702))
   (assert (! (not (= ^^u8 ^^f8)) :named ax_703))
   (assert (! (not (= ^^u8 ^^i1)) :named ax_704))
   (assert (! (not (= ^^u8 ^^i2)) :named ax_705))
   (assert (! (not (= ^^u8 ^^i4)) :named ax_706))
   (assert (! (not (= ^^u8 ^^i8)) :named ax_707))
   (assert (! (not (= ^^u8 ^^mathint)) :named ax_708))
   (assert (! (not (= ^^u8 ^^mathint)) :named ax_709))
   (assert (! (not (= ^^u8 ^^root_emb)) :named ax_710))
   (assert (! (not (= ^^u8 ^^root_emb)) :named ax_711))
   (assert (! (not (= ^^u8 ^^u1)) :named ax_712))
   (assert (! (not (= ^^u8 ^^u2)) :named ax_713))
   (assert (! (not (= ^^u8 ^^u4)) :named ax_714))
   (assert (! (not (= ^^u8 ^^void)) :named ax_715))
   (assert (! (not (= ^^u8 ^List)) :named ax_716))
   (assert (! (not (= ^^u8 ^Node)) :named ax_717))
   (assert (! (not (= ^^void $@distTp1)) :named ax_718))
   (assert (! (not (= ^^void $@distTp1)) :named ax_719))
   (assert (! (not (= ^^void $@distTp2)) :named ax_720))
   (assert (! (not (= ^^void $@distTp2)) :named ax_721))
   (assert (! (not (= ^^void $@distTp3)) :named ax_722))
   (assert (! (not (= ^^void $@distTp3)) :named ax_723))
   (assert (! (not (= ^^void $@distTp4)) :named ax_724))
   (assert (! (not (= ^^void $@distTp4)) :named ax_725))
   (assert (! (not (= ^^void $@distTp5)) :named ax_726))
   (assert (! (not (= ^^void $@distTp5)) :named ax_727))
   (assert (! (not (= ^^void $@distTp6)) :named ax_728))
   (assert (! (not (= ^^void $@distTp6)) :named ax_729))
   (assert (! (not (= ^^void $memory_allocator_type)) :named ax_730))
   (assert (! (not (= ^^void $memory_allocator_type)) :named ax_731))
   (assert (! (not (= ^^void ^$@ptrset)) :named ax_732))
   (assert (! (not (= ^^void ^$@ptrset)) :named ax_733))
   (assert (! (not (= ^^void ^$@state_t)) :named ax_734))
   (assert (! (not (= ^^void ^$@state_t)) :named ax_735))
   (assert (! (not (= ^^void ^$@struct)) :named ax_736))
   (assert (! (not (= ^^void ^$@struct)) :named ax_737))
   (assert (! (not (= ^^void ^$@thread_id)) :named ax_738))
   (assert (! (not (= ^^void ^$@thread_id)) :named ax_739))
   (assert (! (not (= ^^void ^$@thread_id_t)) :named ax_740))
   (assert (! (not (= ^^void ^$@thread_id_t)) :named ax_741))
   (assert (! (not (= ^^void ^^bool)) :named ax_742))
   (assert (! (not (= ^^void ^^bool)) :named ax_743))
   (assert (! (not (= ^^void ^^claim)) :named ax_744))
   (assert (! (not (= ^^void ^^claim)) :named ax_745))
   (assert (! (not (= ^^void ^^f4)) :named ax_746))
   (assert (! (not (= ^^void ^^f4)) :named ax_747))
   (assert (! (not (= ^^void ^^f8)) :named ax_748))
   (assert (! (not (= ^^void ^^f8)) :named ax_749))
   (assert (! (not (= ^^void ^^i1)) :named ax_750))
   (assert (! (not (= ^^void ^^i2)) :named ax_751))
   (assert (! (not (= ^^void ^^i4)) :named ax_752))
   (assert (! (not (= ^^void ^^i8)) :named ax_753))
   (assert (! (not (= ^^void ^^mathint)) :named ax_754))
   (assert (! (not (= ^^void ^^mathint)) :named ax_755))
   (assert (! (not (= ^^void ^^root_emb)) :named ax_756))
   (assert (! (not (= ^^void ^^root_emb)) :named ax_757))
   (assert (! (not (= ^^void ^^u1)) :named ax_758))
   (assert (! (not (= ^^void ^^u2)) :named ax_759))
   (assert (! (not (= ^^void ^^u4)) :named ax_760))
   (assert (! (not (= ^^void ^^u8)) :named ax_761))
   (assert (! (not (= ^^void ^List)) :named ax_762))
   (assert (! (not (= ^^void ^Node)) :named ax_763))
   (assert (! (not (= ^List $@distTp1)) :named ax_764))
   (assert (! (not (= ^List $@distTp1)) :named ax_765))
   (assert (! (not (= ^List $@distTp2)) :named ax_766))
   (assert (! (not (= ^List $@distTp2)) :named ax_767))
   (assert (! (not (= ^List $@distTp3)) :named ax_768))
   (assert (! (not (= ^List $@distTp3)) :named ax_769))
   (assert (! (not (= ^List $@distTp4)) :named ax_770))
   (assert (! (not (= ^List $@distTp4)) :named ax_771))
   (assert (! (not (= ^List $@distTp5)) :named ax_772))
   (assert (! (not (= ^List $@distTp5)) :named ax_773))
   (assert (! (not (= ^List $@distTp6)) :named ax_774))
   (assert (! (not (= ^List $@distTp6)) :named ax_775))
   (assert (! (not (= ^List $memory_allocator_type)) :named ax_776))
   (assert (! (not (= ^List ^$@ptrset)) :named ax_777))
   (assert (! (not (= ^List ^$@state_t)) :named ax_778))
   (assert (! (not (= ^List ^$@struct)) :named ax_779))
   (assert (! (not (= ^List ^$@thread_id)) :named ax_780))
   (assert (! (not (= ^List ^$@thread_id_t)) :named ax_781))
   (assert (! (not (= ^List ^^bool)) :named ax_782))
   (assert (! (not (= ^List ^^claim)) :named ax_783))
   (assert (! (not (= ^List ^^f4)) :named ax_784))
   (assert (! (not (= ^List ^^f8)) :named ax_785))
   (assert (! (not (= ^List ^^i1)) :named ax_786))
   (assert (! (not (= ^List ^^i2)) :named ax_787))
   (assert (! (not (= ^List ^^i4)) :named ax_788))
   (assert (! (not (= ^List ^^i8)) :named ax_789))
   (assert (! (not (= ^List ^^mathint)) :named ax_790))
   (assert (! (not (= ^List ^^root_emb)) :named ax_791))
   (assert (! (not (= ^List ^^u1)) :named ax_792))
   (assert (! (not (= ^List ^^u2)) :named ax_793))
   (assert (! (not (= ^List ^^u4)) :named ax_794))
   (assert (! (not (= ^List ^^u8)) :named ax_795))
   (assert (! (not (= ^List ^^void)) :named ax_796))
   (assert (! (not (= ^Node $@distTp1)) :named ax_797))
   (assert (! (not (= ^Node $@distTp1)) :named ax_798))
   (assert (! (not (= ^Node $@distTp2)) :named ax_799))
   (assert (! (not (= ^Node $@distTp2)) :named ax_800))
   (assert (! (not (= ^Node $@distTp3)) :named ax_801))
   (assert (! (not (= ^Node $@distTp3)) :named ax_802))
   (assert (! (not (= ^Node $@distTp4)) :named ax_803))
   (assert (! (not (= ^Node $@distTp4)) :named ax_804))
   (assert (! (not (= ^Node $@distTp5)) :named ax_805))
   (assert (! (not (= ^Node $@distTp5)) :named ax_806))
   (assert (! (not (= ^Node $@distTp6)) :named ax_807))
   (assert (! (not (= ^Node $@distTp6)) :named ax_808))
   (assert (! (not (= ^Node $memory_allocator_type)) :named ax_809))
   (assert (! (not (= ^Node ^$@ptrset)) :named ax_810))
   (assert (! (not (= ^Node ^$@state_t)) :named ax_811))
   (assert (! (not (= ^Node ^$@struct)) :named ax_812))
   (assert (! (not (= ^Node ^$@thread_id)) :named ax_813))
   (assert (! (not (= ^Node ^$@thread_id_t)) :named ax_814))
   (assert (! (not (= ^Node ^^bool)) :named ax_815))
   (assert (! (not (= ^Node ^^claim)) :named ax_816))
   (assert (! (not (= ^Node ^^f4)) :named ax_817))
   (assert (! (not (= ^Node ^^f8)) :named ax_818))
   (assert (! (not (= ^Node ^^i1)) :named ax_819))
   (assert (! (not (= ^Node ^^i2)) :named ax_820))
   (assert (! (not (= ^Node ^^i4)) :named ax_821))
   (assert (! (not (= ^Node ^^i8)) :named ax_822))
   (assert (! (not (= ^Node ^^mathint)) :named ax_823))
   (assert (! (not (= ^Node ^^root_emb)) :named ax_824))
   (assert (! (not (= ^Node ^^u1)) :named ax_825))
   (assert (! (not (= ^Node ^^u2)) :named ax_826))
   (assert (! (not (= ^Node ^^u4)) :named ax_827))
   (assert (! (not (= ^Node ^^u8)) :named ax_828))
   (assert (! (not (= ^Node ^^void)) :named ax_829))
   (assert (! (not (= ^Node ^List)) :named ax_830))
   (assert (! (not (= ^Node ^List)) :named ax_831))
   (assert (! (not (= cf@classifier@default cf@lambda@1)) :named ax_832))
   (assert (! (not (= cf@lambda@1 cf@classifier@default)) :named ax_833))
   (assert (! (not (= List.$owns List.followers)) :named ax_834))
   (assert (! (not (= List.$owns List.head)) :named ax_835))
   (assert (! (not (= List.$owns List.idx)) :named ax_836))
   (assert (! (not (= List.$owns List.length)) :named ax_837))
   (assert (! (not (= List.$owns List.length_acc)) :named ax_838))
   (assert (! (not (= List.$owns List.seq)) :named ax_839))
   (assert (! (not (= List.followers List.$owns)) :named ax_840))
   (assert (! (not (= List.followers List.length)) :named ax_841))
   (assert (! (not (= List.followers List.length_acc)) :named ax_842))
   (assert (! (not (= List.head List.$owns)) :named ax_843))
   (assert (! (not (= List.head List.followers)) :named ax_844))
   (assert (! (not (= List.head List.followers)) :named ax_845))
   (assert (! (not (= List.head List.idx)) :named ax_846))
   (assert (! (not (= List.head List.length)) :named ax_847))
   (assert (! (not (= List.head List.length_acc)) :named ax_848))
   (assert (! (not (= List.head List.seq)) :named ax_849))
   (assert (! (not (= List.idx List.$owns)) :named ax_850))
   (assert (! (not (= List.idx List.followers)) :named ax_851))
   (assert (! (not (= List.idx List.followers)) :named ax_852))
   (assert (! (not (= List.idx List.head)) :named ax_853))
   (assert (! (not (= List.idx List.length)) :named ax_854))
   (assert (! (not (= List.idx List.length_acc)) :named ax_855))
   (assert (! (not (= List.length List.$owns)) :named ax_856))
   (assert (! (not (= List.length List.followers)) :named ax_857))
   (assert (! (not (= List.length List.head)) :named ax_858))
   (assert (! (not (= List.length List.idx)) :named ax_859))
   (assert (! (not (= List.length_acc List.$owns)) :named ax_860))
   (assert (! (not (= List.length_acc List.followers)) :named ax_861))
   (assert (! (not (= List.length_acc List.head)) :named ax_862))
   (assert (! (not (= List.length_acc List.idx)) :named ax_863))
   (assert (! (not (= List.length_acc List.length)) :named ax_864))
   (assert (! (not (= List.length_acc List.length)) :named ax_865))
   (assert (! (not (= List.seq List.$owns)) :named ax_866))
   (assert (! (not (= List.seq List.followers)) :named ax_867))
   (assert (! (not (= List.seq List.followers)) :named ax_868))
   (assert (! (not (= List.seq List.head)) :named ax_869))
   (assert (! (not (= List.seq List.idx)) :named ax_870))
   (assert (! (not (= List.seq List.idx)) :named ax_871))
   (assert (! (not (= List.seq List.length)) :named ax_872))
   (assert (! (not (= List.seq List.length)) :named ax_873))
   (assert (! (not (= List.seq List.length_acc)) :named ax_874))
   (assert (! (not (= List.seq List.length_acc)) :named ax_875))
   (assert (! (not (= Node.$owns List.$owns)) :named ax_876))
   (assert (! (not (= Node.$owns List.$owns)) :named ax_877))
   (assert (! (not (= Node.$owns List.followers)) :named ax_878))
   (assert (! (not (= Node.$owns List.followers)) :named ax_879))
   (assert (! (not (= Node.$owns List.head)) :named ax_880))
   (assert (! (not (= Node.$owns List.head)) :named ax_881))
   (assert (! (not (= Node.$owns List.idx)) :named ax_882))
   (assert (! (not (= Node.$owns List.idx)) :named ax_883))
   (assert (! (not (= Node.$owns List.length)) :named ax_884))
   (assert (! (not (= Node.$owns List.length)) :named ax_885))
   (assert (! (not (= Node.$owns List.length_acc)) :named ax_886))
   (assert (! (not (= Node.$owns List.length_acc)) :named ax_887))
   (assert (! (not (= Node.$owns List.seq)) :named ax_888))
   (assert (! (not (= Node.$owns List.seq)) :named ax_889))
   (assert (! (not (= Node.$owns Node.data)) :named ax_890))
   (assert (! (not (= Node.$owns Node.next)) :named ax_891))
   (assert (! (not (= Node.data List.$owns)) :named ax_892))
   (assert (! (not (= Node.data List.$owns)) :named ax_893))
   (assert (! (not (= Node.data List.followers)) :named ax_894))
   (assert (! (not (= Node.data List.followers)) :named ax_895))
   (assert (! (not (= Node.data List.head)) :named ax_896))
   (assert (! (not (= Node.data List.head)) :named ax_897))
   (assert (! (not (= Node.data List.idx)) :named ax_898))
   (assert (! (not (= Node.data List.idx)) :named ax_899))
   (assert (! (not (= Node.data List.length)) :named ax_900))
   (assert (! (not (= Node.data List.length)) :named ax_901))
   (assert (! (not (= Node.data List.length_acc)) :named ax_902))
   (assert (! (not (= Node.data List.length_acc)) :named ax_903))
   (assert (! (not (= Node.data List.seq)) :named ax_904))
   (assert (! (not (= Node.data List.seq)) :named ax_905))
   (assert (! (not (= Node.data Node.$owns)) :named ax_906))
   (assert (! (not (= Node.next List.$owns)) :named ax_907))
   (assert (! (not (= Node.next List.$owns)) :named ax_908))
   (assert (! (not (= Node.next List.followers)) :named ax_909))
   (assert (! (not (= Node.next List.followers)) :named ax_910))
   (assert (! (not (= Node.next List.head)) :named ax_911))
   (assert (! (not (= Node.next List.head)) :named ax_912))
   (assert (! (not (= Node.next List.idx)) :named ax_913))
   (assert (! (not (= Node.next List.idx)) :named ax_914))
   (assert (! (not (= Node.next List.length)) :named ax_915))
   (assert (! (not (= Node.next List.length)) :named ax_916))
   (assert (! (not (= Node.next List.length_acc)) :named ax_917))
   (assert (! (not (= Node.next List.length_acc)) :named ax_918))
   (assert (! (not (= Node.next List.seq)) :named ax_919))
   (assert (! (not (= Node.next List.seq)) :named ax_920))
   (assert (! (not (= Node.next Node.$owns)) :named ax_921))
   (assert (! (not (= Node.next Node.data)) :named ax_922))
   (assert (! (not (= Node.next Node.data)) :named ax_923))
...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_111) (and (not $is_unwrap_check) (not $is_stuttering_check)))
      (= (= true $@bf_210) (forall ((|f_$8| $pure_function))(!(< ($frame_level f_$8) $current_frame_level):pattern ( ($frame_level f_$8))  )))
      (= (= true $@bf_212) (forall ((|f_$10| $pure_function))(!(< ($pure_post_level f_$10) $current_frame_level):pattern ( ($frame_level f_$10))  )))
      ...
      (forall( (|M_$12| $map_t..^^i4.^^bool) (|p_$178| Int) (|v_$17| Bool))(=> ($in_range_t ^^i4 |p_$178|) (= ($select.$map_t..^^i4.^^bool ($store.$map_t..^^i4.^^bool |M_$12| |p_$178| |v_$17|) |p_$178|) |v_$17|)))
      (forall( (|M_$13| $map_t..^^i4.^^bool) (|p_$179| Int) (|v_$18| Bool) (|q_$30| Int))(=> (not (= |p_$179| |q_$30|)) (= ($select.$map_t..^^i4.^^bool ($store.$map_t..^^i4.^^bool |M_$13| |q_$30| |v_$18|) |p_$179|) ($select.$map_t..^^i4.^^bool |M_$13| |p_$179|))))
      (forall( (|M_$14| $map_t..$ptr_to..^Node.$map_t..^^i4.^^bool) (|p_$182| Int) (|v_$19| $map_t..^^i4.^^bool))(= ($select.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool ($store.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool |M_$14| |p_$182| |v_$19|) |p_$182|) |v_$19|))
      (forall( (|M_$15| $map_t..$ptr_to..^Node.$map_t..^^i4.^^bool) (|p_$183| Int) (|v_$20| $map_t..^^i4.^^bool) (|q_$31| Int))(=> (not (= |p_$183| |q_$31|)) (= ($select.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool ($store.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool |M_$15| |q_$31| |v_$20|) |p_$183|) ($select.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool |M_$15| |p_$183|))))
      (forall( (|M_$16| $map_t..$ptr_to..^Node.^^u4) (|p_$186| Int) (|v_$21| Int))(= ($select.$map_t..$ptr_to..^Node.^^u4 ($store.$map_t..$ptr_to..^Node.^^u4 |M_$16| |p_$186| |v_$21|) |p_$186|) ($unchecked ^^u4 |v_$21|)))
      (forall( (|M_$17| $map_t..$ptr_to..^Node.^^u4) (|p_$187| Int) (|v_$22| Int) (|q_$32| Int))(=> (not (= |p_$187| |q_$32|)) (= ($select.$map_t..$ptr_to..^Node.^^u4 ($store.$map_t..$ptr_to..^Node.^^u4 |M_$17| |q_$32| |v_$22|) |p_$187|) ($select.$map_t..$ptr_to..^Node.^^u4 |M_$17| |p_$187|))))
      (forall( (|M_$18| $map_t..$ptr_to..^Node.^^u4) (|p_$190| Int))($in_range_t ^^u4 ($select.$map_t..$ptr_to..^Node.^^u4 |M_$18| |p_$190|)))
      (forall( (|M_$19| $map_t..^^u4.$ptr_to..^Node) (|p_$191| Int) (|v_$23| Int))(=> ($in_range_t ^^u4 |p_$191|) (= ($select.$map_t..^^u4.$ptr_to..^Node ($store.$map_t..^^u4.$ptr_to..^Node |M_$19| |p_$191| |v_$23|) |p_$191|) |v_$23|)))
      (forall( (|M_$2| $typemap_t) (|p_$57| $ptr) (|v_$3| $type_state))(!(= ($select.tm ($store.tm |M_$2| |p_$57| |v_$3|) |p_$57|) |v_$3|)  :weight  0))
      (forall( (|M_$20| $map_t..^^u4.$ptr_to..^Node) (|p_$192| Int) (|v_$24| Int) (|q_$33| Int))(=> (not (= |p_$192| |q_$33|)) (= ($select.$map_t..^^u4.$ptr_to..^Node ($store.$map_t..^^u4.$ptr_to..^Node |M_$20| |q_$33| |v_$24|) |p_$192|) ($select.$map_t..^^u4.$ptr_to..^Node |M_$20| |p_$192|))))
      (forall( (|M_$21| $map_t..^^u4.$ptr_to..^Node) (|p_$195| Int))($in_range_phys_ptr ($select.$map_t..^^u4.$ptr_to..^Node |M_$21| |p_$195|)))
      ...
      (forall( (|M1_$10| $map_t..^^u4.$ptr_to..^Node) (|M2_$10| $map_t..^^u4.$ptr_to..^Node))(!(=> (forall( (|p_$193| Int))(=> ($in_range_t ^^u4 |p_$193|) (= ($select.$map_t..^^u4.$ptr_to..^Node |M1_$10| |p_$193|) ($select.$map_t..^^u4.$ptr_to..^Node |M2_$10| |p_$193|)))) ($eq.$map_t..^^u4.$ptr_to..^Node |M1_$10| |M2_$10|))  :pattern ( ($eq.$map_t..^^u4.$ptr_to..^Node |M1_$10| |M2_$10|))))
      ...
      (forall( (|M1_$4| $map_t..^^i4.^^bool) (|M2_$4| $map_t..^^i4.^^bool))(!(=> (forall( (|p_$180| Int))(=> ($in_range_t ^^i4 |p_$180|) (= ($select.$map_t..^^i4.^^bool |M1_$4| |p_$180|) ($select.$map_t..^^i4.^^bool |M2_$4| |p_$180|)))) ($eq.$map_t..^^i4.^^bool |M1_$4| |M2_$4|))  :pattern ( ($eq.$map_t..^^i4.^^bool |M1_$4| |M2_$4|))))
      ...
      (forall( (|M1_$8| $map_t..$ptr_to..^Node.^^u4) (|M2_$8| $map_t..$ptr_to..^Node.^^u4))(!(=> (forall( (|p_$188| Int))(= ($unchecked ^^u4 ($select.$map_t..$ptr_to..^Node.^^u4 |M1_$8| |p_$188|)) ($unchecked ^^u4 ($select.$map_t..$ptr_to..^Node.^^u4 |M2_$8| |p_$188|)))) ($eq.$map_t..$ptr_to..^Node.^^u4 |M1_$8| |M2_$8|))  :pattern ( ($eq.$map_t..$ptr_to..^Node.^^u4 |M1_$8| |M2_$8|))))
      ...
      (forall( (|p_$181| Int))(= ($select.$map_t..^^i4.^^bool $zero.$map_t..^^i4.^^bool |p_$181|) false))
      (forall( (|p_$185| Int))(= ($select.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool $zero.$map_t..$ptr_to..^Node.$map_t..^^i4.^^bool |p_$185|) $zero.$map_t..^^i4.^^bool))
      (forall( (|p_$189| Int))(= ($select.$map_t..$ptr_to..^Node.^^u4 $zero.$map_t..$ptr_to..^Node.^^u4 |p_$189|) 0))
      ...
      (forall( (|p_$194| Int))(= ($select.$map_t..^^u4.$ptr_to..^Node $zero.$map_t..^^u4.$ptr_to..^Node |p_$194|) 0))
      ...
      (forall( (|S_$114| $state))(!(=> ($good_state |S_$114|) (forall( (|#p_$10_$1| $ptr) (|#q_$13| $ptr))(!(=> (and (and ($good_state |S_$114|) ($set_in |#p_$10_$1| ($owns |S_$114| |#q_$13|))) ($closed |S_$114| |#q_$13|)) (and ($closed |S_$114| |#p_$10_$1|) (not (= ($ref |#p_$10_$1|) 0))))  :pattern ( ($set_in |#p_$10_$1| ($owns |S_$114| |#q_$13|))))))  :pattern ( ($good_state |S_$114|))))
      ...
      (forall( (|S_$24| $state))(= (forall( (|#p_$10_$0| $ptr) (|#q_$12| $ptr))(!(=> (and (and ($good_state |S_$24|) ($set_in |#p_$10_$0| ($owns |S_$24| |#q_$12|))) ($closed |S_$24| |#q_$12|)) (and ($closed |S_$24| |#p_$10_$0|) (not (= ($ref |#p_$10_$0|) 0))))  :pattern ( ($set_in |#p_$10_$0| ($owns |S_$24| |#q_$12|))))) (forall( (|#p_$10| $ptr) (|#q| $ptr))(!(=> (and (and ($good_state |S_$24|) ($set_in |#p_$10| ($owns |S_$24| |#q|))) ($closed |S_$24| |#q|)) (and ($closed |S_$24| |#p_$10|) (not (= ($ref |#p_$10|) 0))))  :pattern ( ($set_in |#p_$10| ($owns |S_$24| |#q|)))))))
...
(assert (! (=> anon6 (and true 
   (and true
      ($full_stop $s)
      ($function_entry $s)
      ($good_state_ext $@tok$1^9.31 $s)
      ($local_value_is $s $@tok$1^9.31 $@loc._this_ ($ptr_to_int ($ptr ^List P@_this_)) ($ptr_to ^List))
      ($local_value_is_ptr $s $@tok$1^9.31 $@loc._this_ ($ptr ^List P@_this_) ($ptr_to ^List))
      (= $@wrTime$1^9.31 ($current_timestamp $s))
      (forall( (|#p_$59| $ptr))(!(= ($in_writes_at $@wrTime$1^9.31 |#p_$59|) false)  :pattern ( ($in_writes_at $@wrTime$1^9.31 |#p_$59|))))
