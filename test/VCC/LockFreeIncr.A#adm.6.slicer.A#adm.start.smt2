...
(let (($$$start (=> (and true
    ...
    (forall( (|#p_$35| $ptr) (|#s1_$13| $state) (|#s2_$11| $state))(!(= ($state_nonvolatile_spans_the_same |#s1_$13| |#s2_$11| |#p_$35| ^A) (= ($select.mem ($memory |#s1_$13|) ($dot |#p_$35| A.$owns)) ($select.mem ($memory |#s2_$11|) ($dot |#p_$35| A.$owns))))  :pattern ( ($state_nonvolatile_spans_the_same |#s1_$13| |#s2_$11| |#p_$35| ^A))))
    ...
    (forall( (|#p_$37| $ptr) (|#s_$1| $state))(!(=> (and ($is |#p_$37| ^A) ($typed |#s_$1| |#p_$37|)) (and (and (and (and ($is ($dot |#p_$37| A.$owns) ^$@ptrset) ($typed |#s_$1| ($dot |#p_$37| A.$owns))) (= ($ts_emb ($ts |#s_$1| ($dot |#p_$37| A.$owns))) |#p_$37|)) (= ($ts_path ($ts |#s_$1| ($dot |#p_$37| A.$owns))) A.$owns)) (= ($ts_is_volatile ($ts |#s_$1| ($dot |#p_$37| A.$owns))) false)))  :pattern ( ($select.tm ($typemap |#s_$1|) ($dot |#p_$37| A.$owns))) :pattern ( ($select.sm ($statusmap |#s_$1|) ($dot |#p_$37| A.$owns)))))
    (forall( (|#p_$38| $ptr))(!(=> ($is |#p_$38| ^A) (and (= ($dot |#p_$38| A.x) ($ptr ^^i4 (+ ($ref |#p_$38|) 0))) ($extent_hint ($dot |#p_$38| A.x) |#p_$38|)))  :pattern ( ($dot |#p_$38| A.x))))
    (forall( (|#p_$39| $ptr) (|#s_$2| $state))(!(=> (and ($is |#p_$39| ^A) ($typed |#s_$2| |#p_$39|)) (and (and (and (and ($is ($dot |#p_$39| A.x) ^^i4) ($typed |#s_$2| ($dot |#p_$39| A.x))) (= ($ts_emb ($ts |#s_$2| ($dot |#p_$39| A.x))) |#p_$39|)) (= ($ts_path ($ts |#s_$2| ($dot |#p_$39| A.x))) A.x)) (= ($ts_is_volatile ($ts |#s_$2| ($dot |#p_$39| A.x))) true)))  :pattern ( ($select.tm ($typemap |#s_$2|) ($dot |#p_$39| A.x))) :pattern ( ($select.sm ($statusmap |#s_$2|) ($dot |#p_$39| A.x)))))
    (forall( (|#p_$40| $ptr))(!(= ($in_writes_at $@wrTime$1^13.1 |#p_$40|) false)  :pattern ( ($in_writes_at $@wrTime$1^13.1 |#p_$40|))))
    ...
    (forall( (|#s_$0| $state) (|#q_$4| $ptr) (|#r_$18| Int))(!(=> ($typed |#s_$0| ($ptr ^A |#r_$18|)) (= ($set_in |#q_$4| ($extent |#s_$0| ($ptr ^A |#r_$18|))) (or (= |#q_$4| ($ptr ^A |#r_$18|)) (= ($ts_emb ($select.tm ($typemap |#s_$0|) |#q_$4|)) ($ptr ^A |#r_$18|)))))  :pattern ( ($set_in |#q_$4| ($extent |#s_$0| ($ptr ^A |#r_$18|))))))
    (forall( (|#s| $state) (|#q_$3| $ptr) (|#r_$17| Int))(!(= ($set_in |#q_$3| ($extent |#s| ($ptr ^A |#r_$17|))) ($set_in |#q_$3| ($full_extent ($ptr ^A |#r_$17|))))  :pattern ( ($set_in |#q_$3| ($extent |#s| ($ptr ^A |#r_$17|))))))
    ...
    (forall( (|p_$27| $ptr) (|S_$28| $state))(= (and (and ($closed |S_$28| |p_$27|) ($inv2 |S_$28| |S_$28| |p_$27| ($typ |p_$27|))) (and (forall( (|#q_$0_$7| $ptr))(!(=> ($closed |S_$28| |#q_$0_$7|) ($inv |S_$28| |#q_$0_$7| ($typ |#q_$0_$7|)))  :pattern ( ($st |S_$28| |#q_$0_$7|)))) ($good_for_admissibility |S_$28|))) (and (and ($closed |S_$28| |p_$27|) ($inv2 |S_$28| |S_$28| |p_$27| ($typ |p_$27|))) (and (forall( (|#q_$0_$3| $ptr))(!(=> ($closed |S_$28| |#q_$0_$3|) ($inv2 |S_$28| |S_$28| |#q_$0_$3| ($typ |#q_$0_$3|)))  :pattern ( ($select.sm ($statusmap |S_$28|) |#q_$0_$3|)))) ($good_for_admissibility |S_$28|)))))
    ...
    (forall( (|S_$114| $state))(!(=> ($good_state |S_$114|) (forall( (|#p_$10_$1_$0| $ptr) (|#q_$9| $ptr))(!(=> (and (and ($good_state |S_$114|) ($set_in |#p_$10_$1_$0| ($owns |S_$114| |#q_$9|))) ($closed |S_$114| |#q_$9|)) (and ($closed |S_$114| |#p_$10_$1_$0|) (not (= ($ref |#p_$10_$1_$0|) 0))))  :pattern ( ($set_in |#p_$10_$1_$0| ($owns |S_$114| |#q_$9|))))))  :pattern ( ($good_state |S_$114|))))
    ...
    (forall( (|tok_$0| $token) (|c_$0| $ptr) (|#s2_$2| $state) (|#s1_$4| $state))(= (and (and (and (and (and (and (and (and ($good_state_ext |tok_$0| |#s1_$4|) ($full_stop |#s1_$4|)) ($good_state_ext |tok_$0| |#s2_$2|)) (forall( (|#p_$10_$8| $ptr) (|#q_$16| $ptr))(!(=> (and (and ($good_state |#s1_$4|) ($set_in |#p_$10_$8| ($owns |#s1_$4| |#q_$16|))) ($closed |#s1_$4| |#q_$16|)) (and ($closed |#s1_$4| |#p_$10_$8|) (not (= ($ref |#p_$10_$8|) 0))))  :pattern ( ($set_in |#p_$10_$8| ($owns |#s1_$4| |#q_$16|)))))) (forall( (|#p_$10_$9| $ptr) (|#q_$17| $ptr))(!(=> (and (and ($good_state |#s2_$2|) ($set_in |#p_$10_$9| ($owns |#s2_$2| |#q_$17|))) ($closed |#s2_$2| |#q_$17|)) (and ($closed |#s2_$2| |#p_$10_$9|) (not (= ($ref |#p_$10_$9|) 0))))  :pattern ( ($set_in |#p_$10_$9| ($owns |#s2_$2| |#q_$17|)))))) (forall( (|#p_$9_$3| $ptr))(!($inv2_when_closed |#s1_$4| |#s2_$2| |#p_$9_$3| ($typ |#p_$9_$3|))  :pattern ( ($closed |#s1_$4| |#p_$9_$3|)) :pattern ( ($closed |#s2_$2| |#p_$9_$3|))))) ($valid_claim |#s1_$4| |c_$0|)) ($closed |#s2_$2| |c_$0|)) true) (and (and (and (and (and (and (and (and ($good_state_ext |tok_$0| |#s1_$4|) ($full_stop |#s1_$4|)) ($good_state_ext |tok_$0| |#s2_$2|)) (forall( (|#p_$10_$3| $ptr) (|#q_$11| $ptr))(!(=> (and (and ($good_state |#s1_$4|) ($set_in |#p_$10_$3| ($owns |#s1_$4| |#q_$11|))) ($closed |#s1_$4| |#q_$11|)) (and ($closed |#s1_$4| |#p_$10_$3|) (not (= ($ref |#p_$10_$3|) 0))))  :pattern ( ($set_in |#p_$10_$3| ($owns |#s1_$4| |#q_$11|)))))) (forall( (|#p_$10_$4| $ptr) (|#q_$12| $ptr))(!(=> (and (and ($good_state |#s2_$2|) ($set_in |#p_$10_$4| ($owns |#s2_$2| |#q_$12|))) ($closed |#s2_$2| |#q_$12|)) (and ($closed |#s2_$2| |#p_$10_$4|) (not (= ($ref |#p_$10_$4|) 0))))  :pattern ( ($set_in |#p_$10_$4| ($owns |#s2_$2| |#q_$12|)))))) (forall( (|#p_$9_$1_$0| $ptr))(!(or (and (not ($closed |#s1_$4| |#p_$9_$1_$0|)) (not ($closed |#s2_$2| |#p_$9_$1_$0|))) (and ($inv2 |#s1_$4| |#s2_$2| |#p_$9_$1_$0| ($typ |#p_$9_$1_$0|)) ($nonvolatile_spans_the_same |#s1_$4| |#s2_$2| |#p_$9_$1_$0| ($typ |#p_$9_$1_$0|))))  :pattern ( ($closed |#s1_$4| |#p_$9_$1_$0|)) :pattern ( ($closed |#s2_$2| |#p_$9_$1_$0|))))) ($valid_claim |#s1_$4| |c_$0|)) ($closed |#s2_$2| |c_$0|)) true)))
...
(let (($start (=> (and true
    ...
    (forall( (|S_$24| $state))(= (forall( (|#p_$10_$6| $ptr) (|#q_$14| $ptr))(!(=> (and (and ($good_state |S_$24|) ($set_in |#p_$10_$6| ($owns |S_$24| |#q_$14|))) ($closed |S_$24| |#q_$14|)) (and ($closed |S_$24| |#p_$10_$6|) (not (= ($ref |#p_$10_$6|) 0))))  :pattern ( ($set_in |#p_$10_$6| ($owns |S_$24| |#q_$14|))))) (forall( (|#p_$10| $ptr) (|#q| $ptr))(!(=> (and (and ($good_state |S_$24|) ($set_in |#p_$10| ($owns |S_$24| |#q|))) ($closed |S_$24| |#q|)) (and ($closed |S_$24| |#p_$10|) (not (= ($ref |#p_$10|) 0))))  :pattern ( ($set_in |#p_$10| ($owns |S_$24| |#q|)))))))
