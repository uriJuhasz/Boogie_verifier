...
anon81_Else:
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$8) { goto anon82_Then; } else { goto anon82_Else; }
anon74_Then:
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	if ($_$_condition_$9) { goto anon75_Then; } else { goto anon75_Else; }
anon74_Else:
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$10) { goto anon75_Then; } else { goto anon75_Else; }
anon82_Then:
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	if ($_$_condition_$11) { goto anon83_Then; } else { goto anon83_Else; }
anon82_Else:
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$12) { goto anon83_Then; } else { goto anon83_Else; }
anon75_Then:
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
...
anon75_Else:
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$14) { goto anon76_Then; } else { goto anon76_Else; }
anon83_Then:
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
...
anon83_Else:
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$16) { goto anon84_Then; } else { goto anon84_Else; }
anon76_Then:
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
...
anon77_Else:
	...
	if ($_$_condition_$20) { goto anon78_Then; } else { goto anon78_Else; }
anon85_Then:
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
...
anon85_Else:
	...
	if ($_$_condition_$22) { goto anon86_Then; } else { goto anon86_Else; }
anon78_Then:
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
...
anon78_Else:
	...
	if ($_$_condition_$24) { goto anon79_Then; } else { goto anon79_Else; }
anon86_Then:
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
...
anon79_Else:
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$28) { goto anon80_Then; } else { goto anon80_Else; }
anon87_Then:
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	if ($_$_condition_$29) { goto anon88_Then; } else { goto anon88_Else; }
anon87_Else:
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	if ($_$_condition_$30) { goto anon88_Then; } else { goto anon88_Else; }
anon80_Then:
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	goto anon31;
anon80_Else:
...
anon56:
	...
	if ($_$_condition_$32) { goto anon89_Then; } else { goto anon89_Else; }
anon89_Then:
	assume !(treeRoot#10 == null);
...
anon89_Else:
	assume treeRoot#10 == null;
	if ($_$_condition_$34) { goto anon90_Then; } else { goto anon90_Else; }
anon90_Then:
	assume treeRoot#10 == null;
...
anon91_Else:
	assume treeRoot#10 == null;
	if ($_$_condition_$37) { goto anon92_Then; } else { goto anon92_Else; }
anon92_Then:
	assume treeRoot#10 == null;
	goto anon69;
anon92_Else:
