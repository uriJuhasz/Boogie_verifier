...
(declare-fun $@bf_39 ( Seq$Int$ Seq$Int$ ) Bool)
(declare-fun $@bf_7 ( $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@ ref Field$ref$ ) Bool)
...
;Axioms
   ...
   (assert (! (< (* 1000 methodK@_106) (Fractions 1)) :named ax_1))
   (assert (! (< (* 1000 unfoldK@_110) methodK@_106) :named ax_2))
   (assert (! (< 0 channelK) :named ax_3))
   (assert (! (< 0 methodK@_106) :named ax_4))
   (assert (! (< 0 Permission$denominator) :named ax_5))
   (assert (! (< 0 Permission$FullFraction) :named ax_6))
   (assert (! (< 0 unfoldK@_110) :named ax_7))
   (assert (! (< unfoldK@_110 (Fractions 1)) :named ax_8))
   (assert (! (= (= true $@bf_20) (ite$Bool$ true true true)) :named ax_9))
   (assert (! (= (= true $@bf_21) (ite$Bool$ true true false)) :named ax_10))
   (assert (! (= (= true $@bf_22) (ite$Bool$ true false true)) :named ax_11))
   (assert (! (= (= true $@bf_23) (ite$Bool$ true false false)) :named ax_12))
   (assert (! (= (= true $@bf_24) (ite$Bool$ false true true)) :named ax_13))
   (assert (! (= (= true $@bf_25) (ite$Bool$ false true false)) :named ax_14))
   (assert (! (= (= true $@bf_26) (ite$Bool$ false false true)) :named ax_15))
   (assert (! (= (= true $@bf_27) (ite$Bool$ false false false)) :named ax_16))
   ...
   (assert (! (= false $@bf_22) :named ax_24))
   (assert (! (= false $@bf_23) :named ax_25))
   (assert (! (= false $@bf_25) :named ax_26))
   (assert (! (= false $@bf_27) :named ax_27))
   (assert (! (= Heap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@0 this SortedTree.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_109@0 this SortedTree.keys))) :named ax_28))
   (assert (! (= Heap Heap@1) :named ax_29))
   (assert (! (= Heap@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_109@0 this SortedTree.valid)) :named ax_30))
   (assert (! (= Heap@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap this SortedTree.valid Heap@0)) :named ax_31))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this SortedTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this SortedTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this SortedTree.keys) perm$R) methodK@_106)))) :named ax_32))
   (assert (! (= Mask Mask@1) :named ax_33))
   (assert (! (= Mask@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid) perm$R) Permission$FullFraction)))) :named ax_34))
   ...
   (assert (! (= true $@bf_20) :named ax_37))
   (assert (! (= true $@bf_21) :named ax_38))
   (assert (! (= true $@bf_24) :named ax_39))
   (assert (! (= true $@bf_26) :named ax_40))
   ...
   (assert (! (forall ((|v_9| $@Map@@PermissionComponent@To@Int@@)(|i_19| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$)(|i_18| ref)(|j_15| Field$Bool$)(|j_14| ref)(|m_10| $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ m_10 j_14 j_15) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ m_10 i_18 i_19 v_9) j_14 j_15)):pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ m_10 i_18 i_19 v_9) j_14 j_15)) :qid map_3_$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@__Bool__$@Map@@$T0@@ref@Field$$T0$@To@$T0@@ :weight 0 )) :named ax_98))
   (assert (! (forall( (|a_$2| Int) (|b_$2| Int) (|d| Int))(!(=> (and (< |a_$2| |b_$2|) (and (<= 2 |d|) (= (mod |b_$2| |d|) (mod |a_$2| |d|)))) (<= (+ |a_$2| |d|) |b_$2|))  :pattern ( (mod |a_$2| |d|) (mod |b_$2| |d|)))) :named ax_99))
   (assert (! (forall( (|a_$3_$0| Seq$Int$) (|b_$3_$0| Seq$Int$))(!(=> (Seq@Equal$Int$ |a_$3_$0| |b_$3_$0|) (= |b_$3_$0| |a_$3_$0|))  :pattern ( (Seq@Equal$Int$ |a_$3_$0| |b_$3_$0|)))) :named ax_100))
   (assert (! (forall( (|a_$3_$1| Seq$ref$) (|b_$3_$1| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$3_$1| |b_$3_$1|) (= |b_$3_$1| |a_$3_$1|))  :pattern ( (Seq@Equal$ref$ |a_$3_$1| |b_$3_$1|)))) :named ax_101))
   ...
   (assert (! (forall( (|con_$0_$11| Bool) (|a_$1_$11| $@Map@@ref@To@Int@@) (|b_$1_$11| $@Map@@ref@To@Int@@))(!(=> (not |con_$0_$11|) (= (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|) |b_$1_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|)))) :named ax_105))
   (assert (! (forall( (|con_$0_$12| Bool) (|a_$1_$12| Seq$ref$) (|b_$1_$12| Seq$ref$))(!(=> (not |con_$0_$12|) (= (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|) |b_$1_$12|))  :pattern ( (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|)))) :named ax_106))
   (assert (! (forall( (|con_$0_$13| Bool) (|a_$1_$13| Seq$Int$) (|b_$1_$13| Seq$Int$))(!(=> (not |con_$0_$13|) (= (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|) |b_$1_$13|))  :pattern ( (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|)))) :named ax_107))
   (assert (! (forall( (|con_$0_$14| Bool) (|a_$1_$14| Field$ref$) (|b_$1_$14| Field$ref$))(!(=> (not |con_$0_$14|) (= (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|) |b_$1_$14|))  :pattern ( (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|)))) :named ax_108))
   (assert (! (forall( (|con_$0_$15| Bool) (|a_$1_$15| Field$Seq$Int$$) (|b_$1_$15| Field$Seq$Int$$))(!(=> (not |con_$0_$15|) (= (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|) |b_$1_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|)))) :named ax_109))
   (assert (! (forall( (|con_$0_$16| Bool) (|a_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> (not |con_$0_$16|) (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|) |b_$1_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|)))) :named ax_110))
   ...
   (assert (! (forall( (|con_$0_$7| Bool) (|a_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (not |con_$0_$7|) (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|) |b_$1_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|)))) :named ax_118))
   ...
   (assert (! (forall( (|con_$12| Bool) (|a_$0_$11| $@Map@@ref@To@Int@@) (|b_$0_$11| $@Map@@ref@To@Int@@))(!(=> |con_$12| (= (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|) |a_$0_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|)))) :named ax_124))
   (assert (! (forall( (|con_$13| Bool) (|a_$0_$12| Seq$ref$) (|b_$0_$12| Seq$ref$))(!(=> |con_$13| (= (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|) |a_$0_$12|))  :pattern ( (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|)))) :named ax_125))
   (assert (! (forall( (|con_$14| Bool) (|a_$0_$13| Seq$Int$) (|b_$0_$13| Seq$Int$))(!(=> |con_$14| (= (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|) |a_$0_$13|))  :pattern ( (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|)))) :named ax_126))
   (assert (! (forall( (|con_$15| Bool) (|a_$0_$14| Field$ref$) (|b_$0_$14| Field$ref$))(!(=> |con_$15| (= (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|) |a_$0_$14|))  :pattern ( (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|)))) :named ax_127))
   (assert (! (forall( (|con_$16| Bool) (|a_$0_$15| Field$Seq$Int$$) (|b_$0_$15| Field$Seq$Int$$))(!(=> |con_$16| (= (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|) |a_$0_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|)))) :named ax_128))
   (assert (! (forall( (|con_$17| Bool) (|a_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> |con_$17| (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|) |a_$0_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|)))) :named ax_129))
   ...
   (assert (! (forall( (|con_$8| Bool) (|a_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> |con_$8| (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|) |a_$0_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|)))) :named ax_138))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_278))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_279))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_280))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_281))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_282))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_283))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_284))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_285))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_286))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_287))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_288))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_289))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_290))
   (assert (! (IsGoodInhaleState inhaleHeap@_109@0 Heap ZeroMask) :named ax_291))
   (assert (! (IsGoodMask Mask) :named ax_292))
   (assert (! (IsGoodMask Mask@0) :named ax_293))
   (assert (! (IsGoodMask ZeroMask) :named ax_294))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@0) :named ax_295))
   (assert (! (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_109@0 this SortedTree.keys)) :named ax_296))
   (assert (! (ite$Bool$ false false true) :named ax_297))
   (assert (! (ite$Bool$ false true true) :named ax_298))
   (assert (! (ite$Bool$ true true false) :named ax_299))
   (assert (! (ite$Bool$ true true true) :named ax_300))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_301))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_302))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_303))
   (assert (! (NonPredicateField$Int$ held) :named ax_304))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_305))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_306))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_307))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_308))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_309))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_310))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_311))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_312))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_313))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_314))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_315))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_316))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_106))) :named ax_317))
   (assert (! (not (= 0 channelK)) :named ax_318))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_319))
   (assert (! (not (= forkK joinable)) :named ax_320))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_321))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_322))
   (assert (! (not (= held forkK)) :named ax_323))
   (assert (! (not (= held joinable)) :named ax_324))
   (assert (! (not (= held SortedTree.numClones)) :named ax_325))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_326))
   (assert (! (not (= joinable forkK)) :named ax_327))
   (assert (! (not (= joinable held)) :named ax_328))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_329))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_330))
   (assert (! (not (= methodK@_106 (* 1000 unfoldK@_110))) :named ax_331))
   (assert (! (not (= methodK@_106 0)) :named ax_332))
   (assert (! (not (= perm$R perm$N)) :named ax_333))
   (assert (! (not (= Permission$denominator 0)) :named ax_334))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_335))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_336))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_337))
   (assert (! (not (= SortedTree.numClones held)) :named ax_338))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_339))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_340))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_341))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_342))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_343))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_344))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_345))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_346))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_347))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_348))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_349))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_350))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_351))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_352))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_353))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_354))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_355))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_356))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_357))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_358))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_359))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_360))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_361))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_362))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_363))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_364))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_365))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_366))
   (assert (! (not (= this null)) :named ax_367))
   (assert (! (not (= unfoldK@_110 (Fractions 1))) :named ax_368))
   (assert (! (not (= unfoldK@_110 0)) :named ax_369))
   (assert (! (not (ite$Bool$ false false false)) :named ax_370))
   (assert (! (not (ite$Bool$ false true false)) :named ax_371))
   (assert (! (not (ite$Bool$ true false false)) :named ax_372))
   (assert (! (not (ite$Bool$ true false true)) :named ax_373))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_374))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_375))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_376))
   (assert (! (wf Heap Mask) :named ax_377))
   (assert (! (wf Heap Mask@0) :named ax_378))
   (assert (! (wf Heap@0 Mask@0) :named ax_379))
   (assert (! (wf Heap@0 ZeroMask) :named ax_380))
   (assert (! (wf inhaleHeap@_109@0 Mask) :named ax_381))
   (assert (! (wf inhaleHeap@_109@0 Mask@0) :named ax_382))
...
(assert (! (=> anon64_Then (and true 
   (and true
      ...
      (= Heap@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_113@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@5 this SortedTree.root) SortedTreeNode.valid))
...
(assert (! (=> anon68_Else (and true 
   (and true
      ...
      (not $@condition_$6)
      (not (= (Fractions 1) (* 1000 methodCallK@_125)))
      (not (= 0 methodCallK@_125))
      (not (= methodK@_106 (* 1000 methodCallK@_125)))
      (not (= null this@52@0))
   )
...
(assert (! (=> anon68_Then (and true 
   (and true
      ...
      (< 0 foldK@_114)
      (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTree.root))
      (not (= (Fractions 1) (* 1000 foldK@_114)))
      (not (= 0 foldK@_114))
      (not (= methodK@_106 (* 1000 foldK@_114)))
   )
...
(assert (! (=> anon68_Then@2 (and true 
   (and true
      (not (< (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@8 this SortedTree.numClones) 0))
   )
...
(assert (! (=> anon68_Else@5 (and true 
   (and true
      (= exhaleMask@_126@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$R) (* (- 1) (Fractions 1))))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$R) (Fractions 1)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$R))))
...
(assert (! (=> anon68_Then@3 (and true 
   (and true
      ...
      (not $@condition_$7)
      (not $@condition_$9)
      (not (= 50 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@8 this SortedTree.numClones)))
   )
...
(assert (! (=> anon68_Else@7 (and true 
   (and true
      ...
      (= Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_131@0 this@52@0 SortedTreeNode.valid))
      (= Heap@9 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@8 this@52@0 SortedTreeNode.valid Heap@9))
      ...
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_126@0 this@52@0 SortedTreeNode.keys) perm$R) (Fractions 1)))
      (not (= (Fractions 1) (* 1000 foldK@_132)))
      (not (= 0 foldK@_132))
      (not (= methodK@_106 (* 1000 foldK@_132)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_126@0 this@52@0 SortedTreeNode.keys) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_126@0 this@52@0 SortedTreeNode.keys) perm$R))))
      (or (not (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this@52@0 SortedTreeNode.keys) k@6)) b@54@0)
      (or (not b@54@0) (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this@52@0 SortedTreeNode.keys) k@6))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this@52@0 SortedTreeNode.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this@52@0 SortedTreeNode.keys))
      (wf Heap@10 Mask@10)
      (wf Heap@10 Mask@9)
...
(assert (! (=> anon25@2 (and true 
   (and true
      (= exhaleMask@_115@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root) perm$R) (* (- 1) (Fractions 100))))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root) perm$R) (Fractions 100)))
      (not (= (Fractions 50) 0))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@8 this SortedTree.root) perm$R))))
...
(assert (! (=> anon25@4 (and true 
   (and true
      (= exhaleMask@_115@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys) perm$R) (* (- 1) (Fractions 50))))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys) perm$R) (Fractions 50)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_115@0 this SortedTree.keys) perm$R))))
...
(assert (! (=> anon25@6 (and true 
   (and true
      ...
      (= exhaleMask@_115@2 exhaleMask@_115@4)
      (= exhaleMask@_115@2 exhaleMask@_115@6)
      (= Heap@13 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_121@0 this SortedTree.valid))
      (= Heap@13 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@8 this SortedTree.valid Heap@13))
      (= Heap@14 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@13 this SortedTree.valid Heap@13))
      (= Heap@14 Heap@15)
      (= Mask@12 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_115@2 this SortedTree.valid (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_115@2 this SortedTree.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_115@2 this SortedTree.valid) perm$R) (Fractions 100)))))
      (= Mask@12 Mask@13)
      (IsGoodInhaleState inhaleHeap@_121@0 Heap@8 exhaleMask@_115@2)
      (IsGoodMask Mask@12)
      (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@13)
      (not $@condition_$21)
      (not $@condition_$23)
      (not $@condition_$27)
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_115@1 this SortedTree.numClones) perm$R) (Fractions 100)))
      (not b@7@0)
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_115@1 this SortedTree.numClones) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_115@1 this SortedTree.numClones) perm$R))))
      (wf Heap@13 exhaleMask@_115@2)
      (wf Heap@13 Mask@12)
      (wf Heap@14 Mask@12)
...
(assert (! (=> anon79_Then@1 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this SortedTree.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this SortedTree.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this SortedTree.keys))
   )
$branchMerge_8
...
(assert (! (=> anon80_Then@1 (and true 
   (and true
      (= Seq@Empty$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this SortedTree.keys))
      (not (= (Fractions 100) 0))
      (Seq@Equal$Int$ Seq@Empty$Int$ Seq@Empty$Int$)
   )
anon50
...
(assert (! (=> anon50@2 (and true 
   (and true
      (= exhaleMask@_133@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root) perm$R) (* (- 1) (Fractions 100))))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root) perm$R) (Fractions 100)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this SortedTree.root) perm$R))))
...
(assert (! (=> anon50@4 (and true 
   (and true
      (= exhaleMask@_133@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys) perm$R) (* (- 1) (Fractions 50))))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys) perm$R) (Fractions 50)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@0 this SortedTree.keys) perm$R))))
...
(assert (! (=> anon50@6 (and true 
   (and true
      ...
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_133@1 this SortedTree.numClones) perm$R) (Fractions 100)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_133@1 this SortedTree.numClones) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_133@1 this SortedTree.numClones) perm$R))))
...
(assert (! (=> anon81_Else (and true 
   (and true
      (= exhaleMask@_133@2 exhaleMask@_133@4)
      (= exhaleMask@_133@2 exhaleMask@_133@6)
      (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root))
      (not $@condition_$22)
      (not $@condition_$25)
      (not $@condition_$29)
...
(assert (! (=> anon81_Then@2 (and true 
   (and true
      ...
      (= exhaleMask@_133@3 exhaleMask@_133@4)
...
(assert (! (=> anon82_Then@1 (and true 
   (and true
      (< 0 (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones)))))
      (not (= 0 (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones))))))
   )
...
(assert (! (=> anon82_Then@2 (and true 
   (and true
      $@condition_$29
      (= exhaleMask@_133@5 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R) (* (- 1) (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones)))))))))
      (= exhaleMask@_133@5 exhaleMask@_133@6)
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R) (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones))))))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$N) 0)) (not (= (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones)))) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_133@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R))))
...
(assert (! (=> anon62 (and true 
   (and true
      (= Heap@11 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_139@0 this SortedTree.valid))
...
(assert (! (=> anon63@1 (and true 
   (and true
      (or (not (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@15 this SortedTree.keys) k@6)) b@7@0)
      (or (not b@7@0) (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@15 this SortedTree.keys) k@6))
   )
...
(assert (! (=> anon63@3 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@13 this SortedTree.valid) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@13 this SortedTree.valid) perm$R))))
...
(assert (! (=> anon63@5 (and true 
   (and true
      (= exhaleMask@_140@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$R) (* (- 1) methodK@_106)))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$R) methodK@_106))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$N) 0)) (not (= methodK@_106 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$R))))
