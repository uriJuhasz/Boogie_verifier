...
var methodK#_10 : int;
var inhaleHeap#_11_$_0 : HeapType;
...
var inhaleHeap#_12_$_0 : HeapType;
...
procedure SortedTree.init$checkDefinedness (this : ref)
{
	var methodK#_10 : int;
	var inhaleHeap#_11 : HeapType;
	var inhaleHeap#_12 : HeapType;
...
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_11_$_0,Heap,ZeroMask);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTree.root := inhaleHeap#_11_$_0[this,SortedTree.root]];
	...
	assume IsGoodState(inhaleHeap#_11_$_0[this,SortedTree.root]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_11_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTree.keys := inhaleHeap#_11_$_0[this,SortedTree.keys]];
	...
	assume IsGoodState(inhaleHeap#_11_$_0[this,SortedTree.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_11_$_0,Mask_$_1);
	assume !(this == null);
	assume Heap_$_2 == Heap_$_1[this,SortedTree.numClones := inhaleHeap#_11_$_0[this,SortedTree.numClones]];
	...
	assume IsGoodState(inhaleHeap#_11_$_0[this,SortedTree.numClones]);
	assume wf(Heap_$_2,Mask_$_2);
	assume wf(inhaleHeap#_11_$_0,Mask_$_2);
	assume IsGoodMask(Mask_$_2);
	assume wf(Heap_$_2,Mask_$_2);
	assume Heap_$_2 == Heap;
	assume Mask_$_2 == Mask;
	assume ZeroCredits == Credits;
	assume IsGoodInhaleState(inhaleHeap#_12_$_0,Heap_$_3,ZeroMask);
	assert { :msg "  29.11: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_4 == Heap_$_3[this,SortedTree.valid := inhaleHeap#_12_$_0[this,SortedTree.valid]];
	assume wf(Heap_$_4,ZeroMask);
	assume inhaleHeap#_12_$_0[this,SortedTree.valid] == Heap_$_4;
	assume Fractions(100) > 0;
	assume Mask_$_3 == ZeroMask[this,SortedTree.valid := ZeroMask[this,SortedTree.valid][perm$R := ZeroMask[this,SortedTree.valid][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_3);
	assume IsGoodState(inhaleHeap#_12_$_0[this,SortedTree.valid]);
	assume wf(Heap_$_4,Mask_$_3);
	assume wf(inhaleHeap#_12_$_0,Mask_$_3);
	assume !(this == null);
	assume Heap_$_5 == Heap_$_4[this,SortedTree.keys := inhaleHeap#_12_$_0[this,SortedTree.keys]];
	assume wf(Heap_$_5,Mask_$_3);
	assume true;
	assume Fractions(50) > 0;
	assume Mask_$_4 == Mask_$_3[this,SortedTree.keys := Mask_$_3[this,SortedTree.keys][perm$R := Mask_$_3[this,SortedTree.keys][perm$R] + Fractions(50)]];
	assume IsGoodMask(Mask_$_4);
	assume IsGoodState(inhaleHeap#_12_$_0[this,SortedTree.keys]);
	assume wf(Heap_$_5,Mask_$_4);
	assume wf(inhaleHeap#_12_$_0,Mask_$_4);
	assert { :msg "  31.11: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  31.11: Location might not be readable." } true ==> CanRead(Mask_$_4,this,SortedTree.keys);
	assume Seq#Equal(Heap_$_5[this,SortedTree.keys],(Seq#Empty() : Seq (Integer) ));
	assume IsGoodMask(Mask_$_4);
	assume wf(Heap_$_5,Mask_$_4);
	goto $exit;
}
