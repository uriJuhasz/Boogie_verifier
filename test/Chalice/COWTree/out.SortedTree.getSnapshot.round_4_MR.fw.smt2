...
;Axioms
   ...
   (assert (! (= false $@bf_29) :named ax_26))
   (assert (! (= false $@bf_31) :named ax_27))
   (assert (! (= false $@bf_33) :named ax_28))
   (assert (! (= Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_29@0 this SortedTree.valid)) :named ax_29))
   (assert (! (= Heap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap this SortedTree.valid Heap)) :named ax_30))
   (assert (! (= Heap Heap@0) :named ax_31))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask this SortedTree.valid))) :named ax_32))
   (assert (! (= Mask Mask@0) :named ax_33))
   (assert (! (= module@default CurrentModule) :named ax_34))
   (assert (! (= Permission$FullFraction (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid) perm$R) Permission$FullFraction)) :named ax_35))
   ...
   (assert (! (= true $@bf_26) :named ax_39))
   (assert (! (= true $@bf_27) :named ax_40))
   (assert (! (= true $@bf_30) :named ax_41))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_294))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_295))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_296))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_297))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_298))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_299))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_300))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_301))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_302))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_303))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_304))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_305))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_306))
   (assert (! (IsGoodInhaleState inhaleHeap@_29@0 Heap ZeroMask) :named ax_307))
   (assert (! (IsGoodMask Mask) :named ax_308))
   (assert (! (IsGoodMask ZeroMask) :named ax_309))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap) :named ax_310))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ nostate) :named ax_311))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_312))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_313))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_314))
   (assert (! (NonPredicateField$Int$ held) :named ax_315))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_316))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_317))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_318))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_319))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_320))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_321))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_322))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_323))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_324))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_325))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_326))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_327))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_26))) :named ax_328))
   (assert (! (not (= 0 channelK)) :named ax_329))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_330))
   (assert (! (not (= forkK joinable)) :named ax_331))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_332))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_333))
   (assert (! (not (= held forkK)) :named ax_334))
   (assert (! (not (= held joinable)) :named ax_335))
   (assert (! (not (= held SortedTree.numClones)) :named ax_336))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_337))
   (assert (! (not (= joinable forkK)) :named ax_338))
   (assert (! (not (= joinable held)) :named ax_339))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_340))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_341))
   (assert (! (not (= methodK@_26 (* 1000 unfoldK@_30))) :named ax_342))
   (assert (! (not (= methodK@_26 0)) :named ax_343))
   (assert (! (not (= perm$R perm$N)) :named ax_344))
   (assert (! (not (= Permission$denominator 0)) :named ax_345))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_346))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_347))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_348))
   (assert (! (not (= SortedTree.numClones held)) :named ax_349))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_350))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_351))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_352))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_353))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_354))
   (assert (! (not (= SortedTree@t SortedTreeSnapshot@t)) :named ax_355))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_356))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_357))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_358))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_359))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_360))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_361))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_362))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_363))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_364))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_365))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_366))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_367))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_368))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_369))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_370))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_371))
   (assert (! (not (= SortedTreeNode@t SortedTreeSnapshot@t)) :named ax_372))
   ...
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_375))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_376))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_377))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_378))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_379))
   (assert (! (not (= SortedTreeSnapshot@t SortedTree@t)) :named ax_380))
   (assert (! (not (= SortedTreeSnapshot@t SortedTreeNode@t)) :named ax_381))
   (assert (! (not (= this null)) :named ax_382))
   (assert (! (not (= unfoldK@_30 (Fractions 1))) :named ax_383))
   (assert (! (not (= unfoldK@_30 0)) :named ax_384))
   (assert (! (not (ite$Bool$ false false false)) :named ax_385))
   (assert (! (not (ite$Bool$ false true false)) :named ax_386))
   (assert (! (not (ite$Bool$ true false false)) :named ax_387))
   (assert (! (not (ite$Bool$ true false true)) :named ax_388))
   (assert (! (or (= SortedTreeSnapshot@t (dtype r@0)) (= r@0 null)) :named ax_389))
   (assert (! (or (= this@34 null) (= SortedTreeSnapshot@t (dtype this@34))) :named ax_390))
   (assert (! (or (= treeRoot@35 null) (= SortedTreeNode@t (dtype treeRoot@35))) :named ax_391))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_392))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_393))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_394))
   (assert (! (wf Heap Mask) :named ax_395))
   (assert (! (wf Heap ZeroMask) :named ax_396))
   (assert (! (wf inhaleHeap@_29@0 Mask) :named ax_397))
   (assert (! CanAssumeFunctionDefs :named ax_398))
   (assert (! true :named ax_399))
...
(assert (! (=> anon0@3 (and true 
   (and true
      ...
      (< 0 (Fractions 100))
      (< 0 (Fractions 50))
      (= (Fractions 100) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this SortedTree.numClones) perm$R) (Fractions 100)))
      (= (Fractions 100) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_31@0 this SortedTree.root) perm$R) (Fractions 100)))
      (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@0 this SortedTree.valid) perm$R))
      (= (Fractions 50) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@1 this SortedTree.keys) perm$R) (Fractions 50)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_31@0 this SortedTree.valid) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@0 this SortedTree.valid) perm$R (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_31@0 this SortedTree.valid) perm$R)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 this SortedTree.numClones) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this SortedTree.numClones) perm$R (Fractions 100)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this SortedTree.root) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_31@0 this SortedTree.root) perm$R (Fractions 100)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@2 this SortedTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@1 this SortedTree.keys) perm$R (Fractions 50)))
      ...
      (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_31@0 this SortedTree.valid) perm$R) (+ (Fractions 100) (* (- 1) (Fractions 100))))
      ...
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@0 this SortedTree.valid) perm$N) 0))
      (not (= 0 (Fractions 100)))
      (not (= 0 (Fractions 50)))
...
(assert (! (=> anon58_Then (and true 
   (and true
      ...
      (not (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid) perm$R)))
...
(assert (! (=> anon59_Then (and true 
   (and true
      $@condition_$0
      (< 0 (Fractions 0))
      (= (Fractions 0) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@5 this SortedTree.root) SortedTreeNode.keys) perm$R) (Fractions 0)))
...
(assert (! (=> anon60_Then (and true 
   (and true
      $@condition_$2
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 this SortedTree.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTree.root) SortedTreeNode.keys))
      (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTree.root)))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 this SortedTree.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 this SortedTree.keys))
   )
$branchMerge_2
...
(assert (! (=> anon61_Then (and true 
   (and true
      $@condition_$4
      (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTree.root))
      (= Seq@Empty$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 this SortedTree.keys))
...
(assert (! (=> anon12@2 (and true 
   (and true
      ...
      (= (Fractions 100) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@7 nw@_34@0 SortedTreeSnapshot.root) perm$R) (Fractions 100)))
      (= (Fractions 100) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@8 nw@_34@0 SortedTreeSnapshot.keys) perm$R) (Fractions 100)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 nw@_34@0 SortedTreeSnapshot.root) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@7 nw@_34@0 SortedTreeSnapshot.root) perm$R (Fractions 100)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@10 nw@_34@0 SortedTreeSnapshot.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@8 nw@_34@0 SortedTreeSnapshot.keys) perm$R (Fractions 100)))
...
(assert (! (=> anon19@2 (and true 
   (and true
      ...
      (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_39@0 this SortedTree.valid) perm$R) (+ (Fractions 100) (* (- 1) (Fractions 100))))
      (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 nw@_34@0 SortedTreeSnapshot.root) perm$N))
      (= exhaleMask@_39@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 nw@_34@0 SortedTreeSnapshot.root (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 nw@_34@0 SortedTreeSnapshot.root) perm$R (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_39@0 this SortedTree.valid) perm$R))))
      (IsGoodMask Mask@10)
...
(assert (! (=> anon19@4 (and true 
   (and true
      ...
      (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@0 nw@_34@0 SortedTreeSnapshot.keys) perm$N))
...
(assert (! (=> anon66_Then@2 (and true 
   (and true
      (= (Fractions 0) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@3 treeRoot@35@0 SortedTreeNode.keys) perm$R))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@4 treeRoot@35@0 SortedTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@3 treeRoot@35@0 SortedTreeNode.keys) perm$R (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@4 treeRoot@35@0 SortedTreeNode.keys) perm$R)))
      (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@4 treeRoot@35@0 SortedTreeNode.keys) perm$R) (+ (Fractions 0) (* (- 1) (Fractions 1))))
      ...
      (=> (= (Fractions 1) (Fractions 0)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@3 treeRoot@35@0 SortedTreeNode.keys) perm$N)))
      (not (< (Fractions 0) (Fractions 1)))
...
(assert (! (=> anon25 (and true 
   (and true
      ...
      (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_39@5 nw@_34@0 SortedTreeSnapshot.valid) perm$R))
...
(assert (! (=> anon67_Then (and true 
   (and true
      $@condition_$13
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@9 nw@_34@0 SortedTreeSnapshot.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 treeRoot@35@0 SortedTreeNode.keys))
      (not (= null treeRoot@35@0))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@9 nw@_34@0 SortedTreeSnapshot.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@9 nw@_34@0 SortedTreeSnapshot.keys))
   )
$branchMerge_5
...
(assert (! (=> anon68_Then (and true 
   (and true
      $@condition_$14
      (= null treeRoot@35@0)
      (= Seq@Empty$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@9 nw@_34@0 SortedTreeSnapshot.keys))
      (Seq@Equal$Int$ Seq@Empty$Int$ Seq@Empty$Int$)
   )
anon31
...
(assert (! (=> anon43@2 (and true 
   (and true
      (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root) perm$R))
      (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_48@0 this SortedTree.valid) perm$R) (+ (Fractions 100) (* (- 1) (Fractions 100))))
      (= exhaleMask@_48@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root) perm$R (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_48@0 this SortedTree.valid) perm$R))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root) perm$N) 0))
...
(assert (! (=> anon43@4 (and true 
   (and true
      (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys) perm$R))
      (= exhaleMask@_48@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys) perm$R (+ (Fractions 50) (* (- 1) (Fractions 50))))))
      (not (< (Fractions 50) (Fractions 50)))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys) perm$N) 0))
...
(assert (! (=> anon43@6 (and true 
   (and true
      (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_48@1 this SortedTree.numClones) perm$R))
      (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_48@1 this SortedTree.valid) perm$R) (+ (Fractions 100) (* (- 1) (Fractions 100))))
      (= exhaleMask@_48@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_48@1 this SortedTree.numClones (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_48@1 this SortedTree.numClones) perm$R (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_48@1 this SortedTree.valid) perm$R))))
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_48@1 this SortedTree.numClones) perm$N) 0))
...
(assert (! (=> anon74_Then@2 (and true 
   (and true
      $@condition_$26
      (= (+ (Fractions 0) (* (- 1) (Fractions 1))) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R))
      (= exhaleMask@_48@5 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$R (+ (+ (Fractions 0) (* (- 1) (Fractions 1))) (* (- 1) (Fractions 0))))))
      (= exhaleMask@_48@5 exhaleMask@_48@6)
      (=> (= (Fractions 0) (+ (Fractions 0) (* (- 1) (Fractions 1)))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@10 this SortedTree.root) SortedTreeNode.keys) perm$N)))
      (not (< (+ (Fractions 0) (* (- 1) (Fractions 1))) (Fractions 0)))
