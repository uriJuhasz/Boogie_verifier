...
procedure SortedTree.valid$checkDefinedness (this : ref)
{
	var predicateK#_8 : int;
	var inhaleHeap#_9 : HeapType;
	var inhaleHeap#_9_$_0 : HeapType;
...
anon0:
	...
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTree.root := inhaleHeap#_9_$_0[this,SortedTree.root]];
	...
	assume IsGoodState(inhaleHeap#_9_$_0[this,SortedTree.root]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_9_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTree.keys := inhaleHeap#_9_$_0[this,SortedTree.keys]];
	...
	assume IsGoodState(inhaleHeap#_9_$_0[this,SortedTree.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_9_$_0,Mask_$_1);
	assume !(this == null);
	assume Heap_$_2 == Heap_$_1[this,SortedTree.numClones := inhaleHeap#_9_$_0[this,SortedTree.numClones]];
	...
	assume IsGoodState(inhaleHeap#_9_$_0[this,SortedTree.numClones]);
	assume wf(Heap_$_2,Mask_$_2);
	assume wf(inhaleHeap#_9_$_0,Mask_$_2);
	assert { :msg "  15.6: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  15.6: Location might not be readable." } true ==> CanRead(Mask_$_2,this,SortedTree.numClones);
	assume Heap_$_2[this,SortedTree.numClones] >= 0;
	assert { :msg "  16.6: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  16.6: Location might not be readable." } true ==> CanRead(Mask_$_2,this,SortedTree.numClones);
	assume Heap_$_2[this,SortedTree.numClones] < 50;
	assert { :msg "  17.7: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  17.7: Location might not be readable." } true ==> CanRead(Mask_$_2,this,SortedTree.root);
	if ($_$_condition) { goto anon13_Then; } else { goto anon13_Else; }
anon13_Then:
	assume !(Heap_$_2[this,SortedTree.root] == null);
	assert { :msg "  17.26: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  17.26: Location might not be readable." } true ==> CanRead(Mask_$_2,this,SortedTree.root);
	assert { :msg "  17.42: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  17.42: Location might not be readable." } true ==> CanRead(Mask_$_2,this,SortedTree.numClones);
	assume !(Heap_$_2[this,SortedTree.root] == null);
	assume Heap_$_3 == Heap_$_2[Heap_$_2[this,SortedTree.root],SortedTreeNode.valid := inhaleHeap#_9_$_0[Heap_$_2[this,SortedTree.root],SortedTreeNode.valid]];
	assume wf(Heap_$_3,Mask_$_2);
	assume inhaleHeap#_9_$_0[Heap_$_3[this,SortedTree.root],SortedTreeNode.valid] == Heap_$_3;
	assume (Fractions(100) - Fractions(Heap_$_3[this,SortedTree.numClones])) > 0;
	assume Mask_$_3 == Mask_$_2[Heap_$_3[this,SortedTree.root],SortedTreeNode.valid := Mask_$_2[Heap_$_3[this,SortedTree.root],SortedTreeNode.valid][perm$R := Mask_$_2[Heap_$_3[this,SortedTree.root],SortedTreeNode.valid][perm$R] + (Fractions(100) - Fractions(Heap_$_3[this,SortedTree.numClones]))]];
	assume IsGoodMask(Mask_$_3);
	assume IsGoodState(inhaleHeap#_9_$_0[Heap_$_3[this,SortedTree.root],SortedTreeNode.valid]);
	assume wf(Heap_$_3,Mask_$_3);
	assume wf(inhaleHeap#_9_$_0,Mask_$_3);
...
anon3:
	...
	assert { :msg "  18.7: Location might not be readable." } true ==> CanRead(Mask_$_4,this,SortedTree.root);
	if ($_$_condition_$0) { goto anon14_Then; } else { goto anon14_Else; }
anon14_Then:
	assume !(Heap_$_4[this,SortedTree.root] == null);
	assert { :msg "  18.26: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  18.26: Location might not be readable." } true ==> CanRead(Mask_$_4,this,SortedTree.root);
	assert { :msg "  18.39: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  18.39: Location might not be readable." } true ==> CanRead(Mask_$_4,this,SortedTree.numClones);
	assume !(Heap_$_4[this,SortedTree.root] == null);
	assume Heap_$_5 == Heap_$_4[Heap_$_4[this,SortedTree.root],SortedTreeNode.keys := inhaleHeap#_9_$_0[Heap_$_4[this,SortedTree.root],SortedTreeNode.keys]];
	assume wf(Heap_$_5,Mask_$_4);
	assume true;
	assume Fractions(50 - Heap_$_5[this,SortedTree.numClones]) > 0;
	assume Mask_$_5 == Mask_$_4[Heap_$_5[this,SortedTree.root],SortedTreeNode.keys := Mask_$_4[Heap_$_5[this,SortedTree.root],SortedTreeNode.keys][perm$R := Mask_$_4[Heap_$_5[this,SortedTree.root],SortedTreeNode.keys][perm$R] + Fractions(50 - Heap_$_5[this,SortedTree.numClones])]];
	assume IsGoodMask(Mask_$_5);
	assume IsGoodState(inhaleHeap#_9_$_0[Heap_$_5[this,SortedTree.root],SortedTreeNode.keys]);
	assume wf(Heap_$_5,Mask_$_5);
	assume wf(inhaleHeap#_9_$_0,Mask_$_5);
...
anon6:
	...
	assert { :msg "  19.7: Location might not be readable." } true ==> CanRead(Mask_$_6,this,SortedTree.root);
	if ($_$_condition_$1) { goto anon15_Then; } else { goto anon15_Else; }
anon15_Then:
	assume !(Heap_$_6[this,SortedTree.root] == null);
	assert { :msg "  19.22: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  19.22: Location might not be readable." } true ==> CanRead(Mask_$_6,this,SortedTree.keys);
	assert { :msg "  19.30: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  19.30: Location might not be readable." } true ==> CanRead(Mask_$_6,this,SortedTree.root);
	assert { :msg "  19.30: Receiver might be null." } true ==> (!(Heap_$_6[this,SortedTree.root] == null));
	assert { :msg "  19.30: Location might not be readable." } true ==> CanRead(Mask_$_6,Heap_$_6[this,SortedTree.root],SortedTreeNode.keys);
	assume Seq#Equal(Heap_$_6[this,SortedTree.keys],Heap_$_6[Heap_$_6[this,SortedTree.root],SortedTreeNode.keys]);
	goto anon9;
anon15_Else:
	assume Heap_$_6[this,SortedTree.root] == null;
	goto anon9;
anon9:
	...
	assert { :msg "  20.7: Location might not be readable." } true ==> CanRead(Mask_$_6,this,SortedTree.root);
	if ($_$_condition_$2) { goto anon16_Then; } else { goto anon16_Else; }
anon16_Then:
	assume Heap_$_6[this,SortedTree.root] == null;
	assert { :msg "  20.22: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  20.22: Location might not be readable." } true ==> CanRead(Mask_$_6,this,SortedTree.keys);
	assume Seq#Equal(Heap_$_6[this,SortedTree.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon12;
anon16_Else:
	assume !(Heap_$_6[this,SortedTree.root] == null);
	goto anon12;
