...
procedure SortedTree.has$checkDefinedness (this : ref,k#6 : int) returns (b#7 : bool)
{
	var methodK#_106 : int;
	var inhaleHeap#_107 : HeapType;
	var inhaleHeap#_108 : HeapType;
...
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_107_$_0,Heap,ZeroMask);
	assert { :msg "  85.12: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTree.valid := inhaleHeap#_107_$_0[this,SortedTree.valid]];
	assume wf(Heap_$_0,ZeroMask);
	assume inhaleHeap#_107_$_0[this,SortedTree.valid] == Heap_$_0;
	...
	assume IsGoodState(inhaleHeap#_107_$_0[this,SortedTree.valid]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_107_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTree.keys := inhaleHeap#_107_$_0[this,SortedTree.keys]];
	...
	assume IsGoodState(inhaleHeap#_107_$_0[this,SortedTree.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_107_$_0,Mask_$_1);
	assume IsGoodMask(Mask_$_1);
	assume wf(Heap_$_1,Mask_$_1);
	assume Heap_$_1 == Heap;
	assume Mask_$_1 == Mask;
	assume ZeroCredits == Credits;
	assume IsGoodInhaleState(inhaleHeap#_108_$_0,Heap_$_2,ZeroMask);
	assert { :msg "  88.11: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_3 == Heap_$_2[this,SortedTree.valid := inhaleHeap#_108_$_0[this,SortedTree.valid]];
	assume wf(Heap_$_3,ZeroMask);
	assume inhaleHeap#_108_$_0[this,SortedTree.valid] == Heap_$_3;
	assume Fractions(100) > 0;
	...
	assume IsGoodState(inhaleHeap#_108_$_0[this,SortedTree.valid]);
	assume wf(Heap_$_3,Mask_$_2);
	assume wf(inhaleHeap#_108_$_0,Mask_$_2);
	assume !(this == null);
	assume Heap_$_4 == Heap_$_3[this,SortedTree.keys := inhaleHeap#_108_$_0[this,SortedTree.keys]];
	assume wf(Heap_$_4,Mask_$_2);
	assume true;
	assume methodK#_106 > 0;
	assume Mask_$_3 == Mask_$_2[this,SortedTree.keys := Mask_$_2[this,SortedTree.keys][perm$R := Mask_$_2[this,SortedTree.keys][perm$R] + methodK#_106]];
	assume IsGoodMask(Mask_$_3);
	assume IsGoodState(inhaleHeap#_108_$_0[this,SortedTree.keys]);
	assume wf(Heap_$_4,Mask_$_3);
	assume wf(inhaleHeap#_108_$_0,Mask_$_3);
	assert { :msg "  90.22: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  90.22: Location might not be readable." } true ==> CanRead(Mask_$_3,this,SortedTree.keys);
	assume b#7 <==> Seq#Contains(Heap_$_4[this,SortedTree.keys],k#6);
	assume IsGoodMask(Mask_$_3);
	assume wf(Heap_$_4,Mask_$_3);
	goto $exit;
}
