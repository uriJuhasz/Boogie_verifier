...
var inhaleHeap#_153_$_0 : HeapType;
...
procedure SortedTreeSnapshot.valid$checkDefinedness (this : ref)
{
	var predicateK#_152 : int;
	var inhaleHeap#_153 : HeapType;
	var inhaleHeap#_153_$_0 : HeapType;
...
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_153_$_0,Heap,ZeroMask);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTreeSnapshot.root := inhaleHeap#_153_$_0[this,SortedTreeSnapshot.root]];
	...
	assume IsGoodState(inhaleHeap#_153_$_0[this,SortedTreeSnapshot.root]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_153_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTreeSnapshot.keys := inhaleHeap#_153_$_0[this,SortedTreeSnapshot.keys]];
	assume wf(Heap_$_1,Mask_$_0);
	assume true;
	assume Fractions(50) > 0;
	assume Mask_$_1 == Mask_$_0[this,SortedTreeSnapshot.keys := Mask_$_0[this,SortedTreeSnapshot.keys][perm$R := Mask_$_0[this,SortedTreeSnapshot.keys][perm$R] + Fractions(50)]];
	assume IsGoodMask(Mask_$_1);
	assume IsGoodState(inhaleHeap#_153_$_0[this,SortedTreeSnapshot.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_153_$_0,Mask_$_1);
	assert { :msg "  117.7: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  117.7: Location might not be readable." } true ==> CanRead(Mask_$_1,this,SortedTreeSnapshot.root);
	if ($_$_condition) { goto anon13_Then; } else { goto anon13_Else; }
anon13_Then:
	assume !(Heap_$_1[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  117.26: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  117.26: Location might not be readable." } true ==> CanRead(Mask_$_1,this,SortedTreeSnapshot.root);
	assume !(Heap_$_1[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_2 == Heap_$_1[Heap_$_1[this,SortedTreeSnapshot.root],SortedTreeNode.valid := inhaleHeap#_153_$_0[Heap_$_1[this,SortedTreeSnapshot.root],SortedTreeNode.valid]];
	assume wf(Heap_$_2,Mask_$_1);
	assume inhaleHeap#_153_$_0[Heap_$_2[this,SortedTreeSnapshot.root],SortedTreeNode.valid] == Heap_$_2;
	assume Fractions(1) > 0;
	assume Mask_$_2 == Mask_$_1[Heap_$_2[this,SortedTreeSnapshot.root],SortedTreeNode.valid := Mask_$_1[Heap_$_2[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R := Mask_$_1[Heap_$_2[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R] + Fractions(1)]];
	assume IsGoodMask(Mask_$_2);
	assume IsGoodState(inhaleHeap#_153_$_0[Heap_$_2[this,SortedTreeSnapshot.root],SortedTreeNode.valid]);
	assume wf(Heap_$_2,Mask_$_2);
	assume wf(inhaleHeap#_153_$_0,Mask_$_2);
...
anon3:
	...
	assert { :msg "  118.7: Location might not be readable." } true ==> CanRead(Mask_$_3,this,SortedTreeSnapshot.root);
	if ($_$_condition_$0) { goto anon14_Then; } else { goto anon14_Else; }
anon14_Then:
	assume !(Heap_$_3[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  118.26: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  118.26: Location might not be readable." } true ==> CanRead(Mask_$_3,this,SortedTreeSnapshot.root);
	assume !(Heap_$_3[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_4 == Heap_$_3[Heap_$_3[this,SortedTreeSnapshot.root],SortedTreeNode.keys := inhaleHeap#_153_$_0[Heap_$_3[this,SortedTreeSnapshot.root],SortedTreeNode.keys]];
	assume wf(Heap_$_4,Mask_$_3);
	assume true;
	assume Fractions(1) > 0;
	assume Mask_$_4 == Mask_$_3[Heap_$_4[this,SortedTreeSnapshot.root],SortedTreeNode.keys := Mask_$_3[Heap_$_4[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R := Mask_$_3[Heap_$_4[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R] + Fractions(1)]];
	assume IsGoodMask(Mask_$_4);
	assume IsGoodState(inhaleHeap#_153_$_0[Heap_$_4[this,SortedTreeSnapshot.root],SortedTreeNode.keys]);
	assume wf(Heap_$_4,Mask_$_4);
	assume wf(inhaleHeap#_153_$_0,Mask_$_4);
...
anon6:
	...
	assert { :msg "  119.7: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.root);
	if ($_$_condition_$1) { goto anon15_Then; } else { goto anon15_Else; }
anon15_Then:
	assume !(Heap_$_5[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  119.22: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  119.22: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.keys);
	assert { :msg "  119.30: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  119.30: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.root);
	assert { :msg "  119.30: Receiver might be null." } true ==> (!(Heap_$_5[this,SortedTreeSnapshot.root] == null));
	assert { :msg "  119.30: Location might not be readable." } true ==> CanRead(Mask_$_5,Heap_$_5[this,SortedTreeSnapshot.root],SortedTreeNode.keys);
	assume Seq#Equal(Heap_$_5[this,SortedTreeSnapshot.keys],Heap_$_5[Heap_$_5[this,SortedTreeSnapshot.root],SortedTreeNode.keys]);
	goto anon9;
anon15_Else:
	assume Heap_$_5[this,SortedTreeSnapshot.root] == null;
	goto anon9;
anon9:
	...
	assert { :msg "  120.7: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.root);
	if ($_$_condition_$2) { goto anon16_Then; } else { goto anon16_Else; }
anon16_Then:
	assume Heap_$_5[this,SortedTreeSnapshot.root] == null;
	assert { :msg "  120.22: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  120.22: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.keys);
	assume Seq#Equal(Heap_$_5[this,SortedTreeSnapshot.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon12;
anon16_Else:
	assume !(Heap_$_5[this,SortedTreeSnapshot.root] == null);
	goto anon12;
