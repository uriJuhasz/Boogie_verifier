...
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_27_$_0,Heap,ZeroMask);
	assert { :msg "  41.12: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTree.valid := inhaleHeap#_27_$_0[this,SortedTree.valid]];
	assume wf(Heap_$_0,ZeroMask);
	assume inhaleHeap#_27_$_0[this,SortedTree.valid] == Heap_$_0;
	...
	assume IsGoodState(inhaleHeap#_27_$_0[this,SortedTree.valid]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_27_$_0,Mask_$_0);
	assume IsGoodMask(Mask_$_0);
	assume wf(Heap_$_0,Mask_$_0);
	assume Heap_$_0 == Heap;
	assume Mask_$_0 == Mask;
	assume ZeroCredits == Credits;
	assume IsGoodInhaleState(inhaleHeap#_28_$_0,Heap_$_1,ZeroMask);
	assert { :msg "  42.11: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_2 == Heap_$_1[this,SortedTree.valid := inhaleHeap#_28_$_0[this,SortedTree.valid]];
	assume wf(Heap_$_2,ZeroMask);
	assume inhaleHeap#_28_$_0[this,SortedTree.valid] == Heap_$_2;
	assume Fractions(100) > 0;
	assume Mask_$_1 == ZeroMask[this,SortedTree.valid := ZeroMask[this,SortedTree.valid][perm$R := ZeroMask[this,SortedTree.valid][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_1);
	assume IsGoodState(inhaleHeap#_28_$_0[this,SortedTree.valid]);
	assume wf(Heap_$_2,Mask_$_1);
	assume wf(inhaleHeap#_28_$_0,Mask_$_1);
	assume IsGoodMask(Mask_$_1);
	assume wf(Heap_$_2,Mask_$_1);
	goto $exit;
}
