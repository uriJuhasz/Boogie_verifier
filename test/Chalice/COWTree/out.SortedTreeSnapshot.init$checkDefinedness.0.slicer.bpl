...
var inhaleHeap#_155_$_0 : HeapType;
...
var inhaleHeap#_156_$_0 : HeapType;
...
procedure SortedTreeSnapshot.init$checkDefinedness (this : ref,treeRoot#10 : ref)
{
	var methodK#_154 : int;
	var inhaleHeap#_155 : HeapType;
	var inhaleHeap#_156 : HeapType;
...
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_155_$_0,Heap,ZeroMask);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTreeSnapshot.root := inhaleHeap#_155_$_0[this,SortedTreeSnapshot.root]];
	...
	assume IsGoodState(inhaleHeap#_155_$_0[this,SortedTreeSnapshot.root]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_155_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTreeSnapshot.keys := inhaleHeap#_155_$_0[this,SortedTreeSnapshot.keys]];
	...
	assume IsGoodState(inhaleHeap#_155_$_0[this,SortedTreeSnapshot.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_155_$_0,Mask_$_1);
	if ($_$_condition) { goto anon13_Then; } else { goto anon13_Else; }
anon13_Then:
	assume !(treeRoot#10 == null);
	assume !(treeRoot#10 == null);
	assume Heap_$_2 == Heap_$_1[treeRoot#10,SortedTreeNode.valid := inhaleHeap#_155_$_0[treeRoot#10,SortedTreeNode.valid]];
	assume wf(Heap_$_2,Mask_$_1);
	assume inhaleHeap#_155_$_0[treeRoot#10,SortedTreeNode.valid] == Heap_$_2;
	...
	assume IsGoodState(inhaleHeap#_155_$_0[treeRoot#10,SortedTreeNode.valid]);
	assume wf(Heap_$_2,Mask_$_2);
	assume wf(inhaleHeap#_155_$_0,Mask_$_2);
...
anon14_Then:
	assume !(treeRoot#10 == null);
	assume !(treeRoot#10 == null);
	assume Heap_$_4 == Heap_$_3[treeRoot#10,SortedTreeNode.keys := inhaleHeap#_155_$_0[treeRoot#10,SortedTreeNode.keys]];
	...
	assume IsGoodState(inhaleHeap#_155_$_0[treeRoot#10,SortedTreeNode.keys]);
	assume wf(Heap_$_4,Mask_$_4);
	assume wf(inhaleHeap#_155_$_0,Mask_$_4);
...
anon6:
	...
	assume IsGoodInhaleState(inhaleHeap#_156_$_0,Heap_$_6,ZeroMask);
	assert { :msg "  131.11: Receiver might be null." } !(this == null);
	assume !(this == null);
	assume Heap_$_7 == Heap_$_6[this,SortedTreeSnapshot.valid := inhaleHeap#_156_$_0[this,SortedTreeSnapshot.valid]];
	assume wf(Heap_$_7,ZeroMask);
	assume inhaleHeap#_156_$_0[this,SortedTreeSnapshot.valid] == Heap_$_7;
	assume Fractions(100) > 0;
	assume Mask_$_6 == ZeroMask[this,SortedTreeSnapshot.valid := ZeroMask[this,SortedTreeSnapshot.valid][perm$R := ZeroMask[this,SortedTreeSnapshot.valid][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_6);
	assume IsGoodState(inhaleHeap#_156_$_0[this,SortedTreeSnapshot.valid]);
	assume wf(Heap_$_7,Mask_$_6);
	assume wf(inhaleHeap#_156_$_0,Mask_$_6);
	assume !(this == null);
	assume Heap_$_8 == Heap_$_7[this,SortedTreeSnapshot.keys := inhaleHeap#_156_$_0[this,SortedTreeSnapshot.keys]];
	assume wf(Heap_$_8,Mask_$_6);
	assume true;
	assume Fractions(50) > 0;
	assume Mask_$_7 == Mask_$_6[this,SortedTreeSnapshot.keys := Mask_$_6[this,SortedTreeSnapshot.keys][perm$R := Mask_$_6[this,SortedTreeSnapshot.keys][perm$R] + Fractions(50)]];
	assume IsGoodMask(Mask_$_7);
	assume IsGoodState(inhaleHeap#_156_$_0[this,SortedTreeSnapshot.keys]);
	assume wf(Heap_$_8,Mask_$_7);
	assume wf(inhaleHeap#_156_$_0,Mask_$_7);
	if ($_$_condition_$2) { goto anon15_Then; } else { goto anon15_Else; }
anon15_Then:
	assume !(treeRoot#10 == null);
	assert { :msg "  134.30: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  134.30: Location might not be readable." } true ==> CanRead(Mask_$_7,this,SortedTreeSnapshot.keys);
	assert { :msg "  134.42: Receiver might be null." } true ==> (!(treeRoot#10 == null));
	assert { :msg "  134.42: Location might not be readable." } true ==> CanRead(Mask,treeRoot#10,SortedTreeNode.keys);
	assume Seq#Equal(Heap_$_8[this,SortedTreeSnapshot.keys],Heap[treeRoot#10,SortedTreeNode.keys]);
	if ($_$_condition_$3) { goto anon16_Then; } else { goto anon16_Else; }
anon15_Else:
	assume treeRoot#10 == null;
...
anon16_Then:
	...
	assert { :msg "  135.30: Location might not be readable." } true ==> CanRead(Mask_$_7,this,SortedTreeSnapshot.keys);
	assume Seq#Equal(Heap_$_8[this,SortedTreeSnapshot.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon12;
anon16_Else:
	assume !(treeRoot#10 == null);
	goto anon12;
