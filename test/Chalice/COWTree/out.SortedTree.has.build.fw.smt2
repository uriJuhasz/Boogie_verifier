...
;Axioms
   ...
   (assert (! (= module@default CurrentModule) :named ax_35))
   ...
   (assert (! (= SortedTree@t (dtype this)) :named ax_38))
   (assert (! (= true $@bf_20) :named ax_39))
   (assert (! (= true $@bf_21) :named ax_40))
   (assert (! (= true $@bf_24) :named ax_41))
   (assert (! (= true $@bf_26) :named ax_42))
   (assert (! (= ZeroCredits Credits) :named ax_43))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_281))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_282))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_283))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_284))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_285))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_286))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_287))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_288))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_289))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_290))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_291))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_292))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_293))
   (assert (! (IsGoodInhaleState inhaleHeap@_109@0 Heap ZeroMask) :named ax_294))
   (assert (! (IsGoodMask Mask) :named ax_295))
   (assert (! (IsGoodMask Mask@0) :named ax_296))
   (assert (! (IsGoodMask ZeroMask) :named ax_297))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@0) :named ax_298))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ nostate) :named ax_299))
   (assert (! (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_109@0 this SortedTree.keys)) :named ax_300))
   (assert (! (ite$Bool$ false false true) :named ax_301))
   (assert (! (ite$Bool$ false true true) :named ax_302))
   (assert (! (ite$Bool$ true true false) :named ax_303))
   (assert (! (ite$Bool$ true true true) :named ax_304))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_305))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_306))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_307))
   (assert (! (NonPredicateField$Int$ held) :named ax_308))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_309))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_310))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_311))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_312))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_313))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_314))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_315))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_316))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_317))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_318))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_319))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_320))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_106))) :named ax_321))
   (assert (! (not (= 0 channelK)) :named ax_322))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_323))
   (assert (! (not (= forkK joinable)) :named ax_324))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_325))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_326))
   (assert (! (not (= held forkK)) :named ax_327))
   (assert (! (not (= held joinable)) :named ax_328))
   (assert (! (not (= held SortedTree.numClones)) :named ax_329))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_330))
   (assert (! (not (= joinable forkK)) :named ax_331))
   (assert (! (not (= joinable held)) :named ax_332))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_333))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_334))
   (assert (! (not (= methodK@_106 (* 1000 unfoldK@_110))) :named ax_335))
   (assert (! (not (= methodK@_106 0)) :named ax_336))
   (assert (! (not (= perm$R perm$N)) :named ax_337))
   (assert (! (not (= Permission$denominator 0)) :named ax_338))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_339))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_340))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_341))
   (assert (! (not (= SortedTree.numClones held)) :named ax_342))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_343))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_344))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_345))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_346))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_347))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_348))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_349))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_350))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_351))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_352))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_353))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_354))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_355))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_356))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_357))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_358))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_359))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_360))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_361))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_362))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_363))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_364))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_365))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_366))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_367))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_368))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_369))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_370))
   (assert (! (not (= this null)) :named ax_371))
   (assert (! (not (= unfoldK@_110 (Fractions 1))) :named ax_372))
   (assert (! (not (= unfoldK@_110 0)) :named ax_373))
   (assert (! (not (ite$Bool$ false false false)) :named ax_374))
   (assert (! (not (ite$Bool$ false true false)) :named ax_375))
   (assert (! (not (ite$Bool$ true false false)) :named ax_376))
   (assert (! (not (ite$Bool$ true false true)) :named ax_377))
   (assert (! (or (= this@52 null) (= SortedTreeNode@t (dtype this@52))) :named ax_378))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_379))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_380))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_381))
   (assert (! (wf Heap Mask) :named ax_382))
   (assert (! (wf Heap Mask@0) :named ax_383))
   (assert (! (wf Heap@0 Mask@0) :named ax_384))
   (assert (! (wf Heap@0 ZeroMask) :named ax_385))
   (assert (! (wf inhaleHeap@_109@0 Mask) :named ax_386))
   (assert (! (wf inhaleHeap@_109@0 Mask@0) :named ax_387))
   (assert (! CanAssumeFunctionDefs :named ax_388))
   (assert (! true :named ax_389))
...
(assert (! (=> anon68_Else@7 (and true 
   (and true
      ...
      (= (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@10 this@52@0 SortedTreeNode.keys) k@6) b@54@0)
...
(assert (! (=> anon63@1 (and true 
   (and true
      (= (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@15 this SortedTree.keys) k@6) b@7@0)
   )
