...
;Axioms
   ...
   (assert (! (= SortedTree@t (dtype this)) :named ax_36))
   ...
   (assert (! (forall( (|con_$0_$11| Bool) (|a_$1_$11| $@Map@@ref@To@Int@@) (|b_$1_$11| $@Map@@ref@To@Int@@))(!(=> (not |con_$0_$11|) (= (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|) |b_$1_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|)))) :named ax_113))
   (assert (! (forall( (|con_$0_$12| Bool) (|a_$1_$12| Seq$ref$) (|b_$1_$12| Seq$ref$))(!(=> (not |con_$0_$12|) (= (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|) |b_$1_$12|))  :pattern ( (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|)))) :named ax_114))
   (assert (! (forall( (|con_$0_$13| Bool) (|a_$1_$13| Seq$Int$) (|b_$1_$13| Seq$Int$))(!(=> (not |con_$0_$13|) (= (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|) |b_$1_$13|))  :pattern ( (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|)))) :named ax_115))
   (assert (! (forall( (|con_$0_$14| Bool) (|a_$1_$14| Field$ref$) (|b_$1_$14| Field$ref$))(!(=> (not |con_$0_$14|) (= (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|) |b_$1_$14|))  :pattern ( (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|)))) :named ax_116))
   (assert (! (forall( (|con_$0_$15| Bool) (|a_$1_$15| Field$Seq$Int$$) (|b_$1_$15| Field$Seq$Int$$))(!(=> (not |con_$0_$15|) (= (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|) |b_$1_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|)))) :named ax_117))
   (assert (! (forall( (|con_$0_$16| Bool) (|a_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> (not |con_$0_$16|) (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|) |b_$1_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|)))) :named ax_118))
   ...
   (assert (! (forall( (|con_$0_$7| Bool) (|a_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (not |con_$0_$7|) (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|) |b_$1_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|)))) :named ax_126))
   ...
   (assert (! (forall( (|con_$12| Bool) (|a_$0_$11| $@Map@@ref@To@Int@@) (|b_$0_$11| $@Map@@ref@To@Int@@))(!(=> |con_$12| (= (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|) |a_$0_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|)))) :named ax_132))
   (assert (! (forall( (|con_$13| Bool) (|a_$0_$12| Seq$ref$) (|b_$0_$12| Seq$ref$))(!(=> |con_$13| (= (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|) |a_$0_$12|))  :pattern ( (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|)))) :named ax_133))
   (assert (! (forall( (|con_$14| Bool) (|a_$0_$13| Seq$Int$) (|b_$0_$13| Seq$Int$))(!(=> |con_$14| (= (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|) |a_$0_$13|))  :pattern ( (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|)))) :named ax_134))
   (assert (! (forall( (|con_$15| Bool) (|a_$0_$14| Field$ref$) (|b_$0_$14| Field$ref$))(!(=> |con_$15| (= (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|) |a_$0_$14|))  :pattern ( (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|)))) :named ax_135))
   (assert (! (forall( (|con_$16| Bool) (|a_$0_$15| Field$Seq$Int$$) (|b_$0_$15| Field$Seq$Int$$))(!(=> |con_$16| (= (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|) |a_$0_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|)))) :named ax_136))
   (assert (! (forall( (|con_$17| Bool) (|a_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> |con_$17| (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|) |a_$0_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|)))) :named ax_137))
   ...
   (assert (! (forall( (|con_$8| Bool) (|a_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> |con_$8| (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|) |a_$0_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|)))) :named ax_146))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_292))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_293))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_294))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_295))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_296))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_297))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_298))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_299))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_300))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_301))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_302))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_303))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_304))
   (assert (! (IsGoodInhaleState inhaleHeap@_29@0 Heap ZeroMask) :named ax_305))
   (assert (! (IsGoodMask Mask) :named ax_306))
   (assert (! (IsGoodMask ZeroMask) :named ax_307))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap) :named ax_308))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ nostate) :named ax_309))
   (assert (! (ite$Bool$ false false true) :named ax_310))
   (assert (! (ite$Bool$ false true true) :named ax_311))
   (assert (! (ite$Bool$ true true false) :named ax_312))
   (assert (! (ite$Bool$ true true true) :named ax_313))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_314))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_315))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_316))
   (assert (! (NonPredicateField$Int$ held) :named ax_317))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_318))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_319))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_320))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_321))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_322))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_323))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_324))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_325))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_326))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_327))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_328))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_329))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_26))) :named ax_330))
   (assert (! (not (= 0 channelK)) :named ax_331))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_332))
   (assert (! (not (= forkK joinable)) :named ax_333))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_334))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_335))
   (assert (! (not (= held forkK)) :named ax_336))
   (assert (! (not (= held joinable)) :named ax_337))
   ...
   (assert (! (not (= joinable held)) :named ax_341))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_342))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_343))
   (assert (! (not (= methodK@_26 (* 1000 unfoldK@_30))) :named ax_344))
   (assert (! (not (= methodK@_26 0)) :named ax_345))
   ...
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_349))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_350))
   (assert (! (not (= SortedTree.numClones held)) :named ax_351))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_352))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_353))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_354))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_355))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_356))
   (assert (! (not (= SortedTree@t SortedTreeSnapshot@t)) :named ax_357))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_358))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_359))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_360))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_361))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_362))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_363))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_364))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_365))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_366))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_367))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_368))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_369))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_370))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_371))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_372))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_373))
   (assert (! (not (= SortedTreeNode@t SortedTreeSnapshot@t)) :named ax_374))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_375))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_376))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_377))
   ...
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_380))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_381))
   (assert (! (not (= SortedTreeSnapshot@t SortedTree@t)) :named ax_382))
   (assert (! (not (= SortedTreeSnapshot@t SortedTreeNode@t)) :named ax_383))
   (assert (! (not (= this null)) :named ax_384))
   (assert (! (not (= unfoldK@_30 (Fractions 1))) :named ax_385))
   (assert (! (not (= unfoldK@_30 0)) :named ax_386))
   (assert (! (not (ite$Bool$ false false false)) :named ax_387))
   (assert (! (not (ite$Bool$ false true false)) :named ax_388))
   (assert (! (not (ite$Bool$ true false false)) :named ax_389))
   (assert (! (not (ite$Bool$ true false true)) :named ax_390))
   (assert (! (or (= SortedTreeSnapshot@t (dtype r@0)) (= r@0 null)) :named ax_391))
   (assert (! (or (= this@34 null) (= SortedTreeSnapshot@t (dtype this@34))) :named ax_392))
   (assert (! (or (= treeRoot@35 null) (= SortedTreeNode@t (dtype treeRoot@35))) :named ax_393))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_394))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_395))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_396))
   (assert (! (wf Heap Mask) :named ax_397))
   (assert (! (wf Heap ZeroMask) :named ax_398))
   (assert (! (wf inhaleHeap@_29@0 Mask) :named ax_399))
   (assert (! CanAssumeFunctionDefs :named ax_400))
   (assert (! true :named ax_401))
