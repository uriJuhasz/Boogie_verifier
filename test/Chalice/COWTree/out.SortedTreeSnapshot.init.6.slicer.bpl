...
var inhaleHeap#_157_$_0 : HeapType;
...
var foldK#_165 : int;
var exhaleMask#_166_$_0 : MaskType;
var exhaleMask#_166_$_1 : MaskType;
var exhaleMask#_166_$_3 : MaskType;
var exhaleMask#_166_$_5 : MaskType;
var inhaleHeap#_171_$_0 : HeapType;
var Heap_$_9 : HeapType;
var Mask_$_6 : MaskType;
var Heap_$_10 : HeapType;
var Mask_$_8 : MaskType;
var Heap_$_13 : HeapType;
var exhaleMask#_172_$_0 : MaskType;
var exhaleMask#_172_$_1 : MaskType;
var exhaleMask#_166_$_4 : MaskType;
var exhaleMask#_166_$_2 : MaskType;
var Heap_$_7 : HeapType;
var foldK#_158 : int;
var exhaleMask#_159_$_0 : MaskType;
var exhaleMask#_159_$_1 : MaskType;
var exhaleMask#_159_$_3 : MaskType;
var exhaleMask#_159_$_5 : MaskType;
var inhaleHeap#_164_$_0 : HeapType;
var Heap_$_11 : HeapType;
var Mask_$_7 : MaskType;
var Heap_$_12 : HeapType;
var exhaleMask#_159_$_4 : MaskType;
var exhaleMask#_159_$_2 : MaskType;
...
procedure SortedTreeSnapshot.init (this : ref,treeRoot#10 : ref)
{
	var methodK#_154 : int;
	var foldK#_158 : int;
	var foldK#_165 : int;
...
PreconditionGeneratedEntry:
	...
	assume (this == null) || (dtype(this) == SortedTreeSnapshot#t);
	assume (treeRoot#10 == null) || (dtype(treeRoot#10) == SortedTreeNode#t);
	assume !(this == null);
	assume wf(Heap,Mask);
	goto anon0;
anon0:
	...
	assume IsGoodInhaleState(inhaleHeap#_157_$_0,Heap,ZeroMask);
	assume !(this == null);
	assume Heap_$_0 == Heap[this,SortedTreeSnapshot.root := inhaleHeap#_157_$_0[this,SortedTreeSnapshot.root]];
	assume wf(Heap_$_0,ZeroMask);
	assume (Heap_$_0[this,SortedTreeSnapshot.root] == null) || (dtype(Heap_$_0[this,SortedTreeSnapshot.root]) == SortedTreeNode#t);
	assume Fractions(100) > 0;
	assume Mask_$_0 == ZeroMask[this,SortedTreeSnapshot.root := ZeroMask[this,SortedTreeSnapshot.root][perm$R := ZeroMask[this,SortedTreeSnapshot.root][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_0);
	assume IsGoodState(inhaleHeap#_157_$_0[this,SortedTreeSnapshot.root]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_157_$_0,Mask_$_0);
	assume !(this == null);
	assume Heap_$_1 == Heap_$_0[this,SortedTreeSnapshot.keys := inhaleHeap#_157_$_0[this,SortedTreeSnapshot.keys]];
	assume wf(Heap_$_1,Mask_$_0);
	assume true;
	assume Fractions(100) > 0;
	assume Mask_$_1 == Mask_$_0[this,SortedTreeSnapshot.keys := Mask_$_0[this,SortedTreeSnapshot.keys][perm$R := Mask_$_0[this,SortedTreeSnapshot.keys][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_1);
	assume IsGoodState(inhaleHeap#_157_$_0[this,SortedTreeSnapshot.keys]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_157_$_0,Mask_$_1);
	if ($_$_condition) { goto anon70_Then; } else { goto anon70_Else; }
anon70_Then:
	assume $_$_condition;
	assume $_$_condition <==> (!(treeRoot#10 == null));
	assume !(treeRoot#10 == null);
	assume !(treeRoot#10 == null);
	assume Heap_$_2 == Heap_$_1[treeRoot#10,SortedTreeNode.valid := inhaleHeap#_157_$_0[treeRoot#10,SortedTreeNode.valid]];
	assume wf(Heap_$_2,Mask_$_1);
	assume inhaleHeap#_157_$_0[treeRoot#10,SortedTreeNode.valid] == Heap_$_2;
	assume Fractions(1) > 0;
	assume Mask_$_2 == Mask_$_1[treeRoot#10,SortedTreeNode.valid := Mask_$_1[treeRoot#10,SortedTreeNode.valid][perm$R := Mask_$_1[treeRoot#10,SortedTreeNode.valid][perm$R] + Fractions(1)]];
	assume IsGoodMask(Mask_$_2);
	assume IsGoodState(inhaleHeap#_157_$_0[treeRoot#10,SortedTreeNode.valid]);
	assume wf(Heap_$_2,Mask_$_2);
	assume wf(inhaleHeap#_157_$_0,Mask_$_2);
...
anon71_Then:
	...
	assume $_$_condition_$0 <==> (!(treeRoot#10 == null));
	assume !(treeRoot#10 == null);
	assume !(treeRoot#10 == null);
	assume Heap_$_4 == Heap_$_3[treeRoot#10,SortedTreeNode.keys := inhaleHeap#_157_$_0[treeRoot#10,SortedTreeNode.keys]];
	assume wf(Heap_$_4,Mask_$_3);
	assume true;
	assume Fractions(1) > 0;
	assume Mask_$_4 == Mask_$_3[treeRoot#10,SortedTreeNode.keys := Mask_$_3[treeRoot#10,SortedTreeNode.keys][perm$R := Mask_$_3[treeRoot#10,SortedTreeNode.keys][perm$R] + Fractions(1)]];
	assume IsGoodMask(Mask_$_4);
	assume IsGoodState(inhaleHeap#_157_$_0[treeRoot#10,SortedTreeNode.keys]);
	assume wf(Heap_$_4,Mask_$_4);
	assume wf(inhaleHeap#_157_$_0,Mask_$_4);
...
anon6:
	...
	assert { :msg "  138.3: Location might not be writable" } CanWrite(Mask_$_5,this,SortedTreeSnapshot.root);
	assume Heap_$_6 == Heap_$_5[this,SortedTreeSnapshot.root := treeRoot#10];
	assume wf(Heap_$_6,Mask_$_5);
	assert { :msg "  139.7: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  139.7: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.root);
	if ($_$_condition_$2) { goto anon72_Then; } else { goto anon72_Else; }
anon72_Then:
	assume $_$_condition_$2;
	assume $_$_condition_$2 <==> (!(Heap_$_6[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_6[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  140.4: Location might not be writable" } CanWrite(Mask_$_5,this,SortedTreeSnapshot.keys);
	assert { :msg "  140.12: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  140.12: Location might not be readable." } true ==> CanRead(Mask_$_5,this,SortedTreeSnapshot.root);
	assert { :msg "  140.12: Receiver might be null." } true ==> (!(Heap_$_6[this,SortedTreeSnapshot.root] == null));
	assert { :msg "  140.12: Location might not be readable." } true ==> CanRead(Mask_$_5,Heap_$_6[this,SortedTreeSnapshot.root],SortedTreeNode.keys);
	assume Heap_$_7 == Heap_$_6[this,SortedTreeSnapshot.keys := Heap_$_6[Heap_$_6[this,SortedTreeSnapshot.root],SortedTreeNode.keys]];
	assume wf(Heap_$_7,Mask_$_5);
	...
	if ($_$_condition_$3) { goto anon73_Then; } else { goto anon73_Else; }
anon72_Else:
	assume !$_$_condition_$2;
	assume $_$_condition_$2 <==> (!(Heap_$_6[this,SortedTreeSnapshot.root] == null));
	assume Heap_$_6[this,SortedTreeSnapshot.root] == null;
	assert { :msg "  143.4: Location might not be writable" } CanWrite(Mask_$_5,this,SortedTreeSnapshot.keys);
	assume Heap_$_8 == Heap_$_6[this,SortedTreeSnapshot.keys := (Seq#Empty() : Seq (Integer) )];
	assume wf(Heap_$_8,Mask_$_5);
	...
	if ($_$_condition_$4) { goto anon81_Then; } else { goto anon81_Else; }
anon73_Then:
	assume $_$_condition_$3;
	assume $_$_condition_$3 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_1;
anon73_Else:
	assume !$_$_condition_$3;
	assume $_$_condition_$3 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
...
anon81_Then:
	...
	assume $_$_condition_$4 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_2;
anon81_Else:
	assume !$_$_condition_$4;
	assume $_$_condition_$4 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
...
anon74_Then:
	...
	assume $_$_condition_$5 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_3;
anon74_Else:
	assume !$_$_condition_$5;
...
anon82_Then:
	...
	assume $_$_condition_$7 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_4;
anon82_Else:
	assume !$_$_condition_$7;
...
anon75_Then:
	...
	assume $_$_condition_$9 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. The expression at 119.22 might not evaluate to true." } Seq#Equal(Heap_$_7[this,SortedTreeSnapshot.keys],Heap_$_7[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys]);
	goto $branchMerge_5;
anon75_Else:
	assume !$_$_condition_$9;
	assume $_$_condition_$9 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
...
anon83_Then:
	...
	assume $_$_condition_$11 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. The expression at 119.22 might not evaluate to true." } Seq#Equal(Heap_$_8[this,SortedTreeSnapshot.keys],Heap_$_8[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys]);
	goto $branchMerge_6;
anon83_Else:
	assume !$_$_condition_$11;
	assume $_$_condition_$11 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
...
anon76_Then:
	...
	assume $_$_condition_$13 <==> (Heap_$_7[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. The expression at 120.22 might not evaluate to true." } Seq#Equal(Heap_$_7[this,SortedTreeSnapshot.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon19;
anon76_Else:
	assume !$_$_condition_$13;
	assume $_$_condition_$13 <==> (Heap_$_7[this,SortedTreeSnapshot.root] == null);
...
anon84_Then:
	...
	assume $_$_condition_$15 <==> (Heap_$_8[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. The expression at 120.22 might not evaluate to true." } Seq#Equal(Heap_$_8[this,SortedTreeSnapshot.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon44;
anon84_Else:
	assume !$_$_condition_$15;
	assume $_$_condition_$15 <==> (Heap_$_8[this,SortedTreeSnapshot.root] == null);
...
anon19:
	...
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 115.6 for SortedTreeSnapshot.root." } (Fractions(100) <= Mask_$_5[this,SortedTreeSnapshot.root][perm$R]) && ((Fractions(100) == Mask_$_5[this,SortedTreeSnapshot.root][perm$R]) ==> (0 <= Mask_$_5[this,SortedTreeSnapshot.root][perm$N]));
	assume exhaleMask#_159_$_0 == Mask_$_5[this,SortedTreeSnapshot.root := Mask_$_5[this,SortedTreeSnapshot.root][perm$R := Mask_$_5[this,SortedTreeSnapshot.root][perm$R] - Fractions(100)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_7,Mask_$_5);
	assume wf(Heap_$_7,exhaleMask#_159_$_0);
	...
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 116.6 for SortedTreeSnapshot.keys." } (Fractions(50) <= exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys][perm$R]) && ((Fractions(50) == exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys][perm$R]) ==> (0 <= exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys][perm$N]));
	assume exhaleMask#_159_$_1 == exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys := exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys][perm$R := exhaleMask#_159_$_0[this,SortedTreeSnapshot.keys][perm$R] - Fractions(50)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_7,Mask_$_5);
	assume wf(Heap_$_7,exhaleMask#_159_$_1);
	if ($_$_condition_$17) { goto anon77_Then; } else { goto anon77_Else; }
anon44:
	...
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 115.6 for SortedTreeSnapshot.root." } (Fractions(100) <= Mask_$_5[this,SortedTreeSnapshot.root][perm$R]) && ((Fractions(100) == Mask_$_5[this,SortedTreeSnapshot.root][perm$R]) ==> (0 <= Mask_$_5[this,SortedTreeSnapshot.root][perm$N]));
	assume exhaleMask#_166_$_0 == Mask_$_5[this,SortedTreeSnapshot.root := Mask_$_5[this,SortedTreeSnapshot.root][perm$R := Mask_$_5[this,SortedTreeSnapshot.root][perm$R] - Fractions(100)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_8,Mask_$_5);
	assume wf(Heap_$_8,exhaleMask#_166_$_0);
	...
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 116.6 for SortedTreeSnapshot.keys." } (Fractions(50) <= exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys][perm$R]) && ((Fractions(50) == exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys][perm$R]) ==> (0 <= exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys][perm$N]));
	assume exhaleMask#_166_$_1 == exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys := exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys][perm$R := exhaleMask#_166_$_0[this,SortedTreeSnapshot.keys][perm$R] - Fractions(50)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_8,Mask_$_5);
	assume wf(Heap_$_8,exhaleMask#_166_$_1);
	if ($_$_condition_$18) { goto anon85_Then; } else { goto anon85_Else; }
anon77_Then:
	assume $_$_condition_$17;
	assume $_$_condition_$17 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	...
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 117.22 for SortedTreeNode.valid." } (Fractions(1) <= exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R]) && ((Fractions(1) == exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R]) ==> (0 <= exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$N]));
	assume exhaleMask#_159_$_2 == exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid := exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R := exhaleMask#_159_$_1[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R] - Fractions(1)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_7,Mask_$_5);
	assume wf(Heap_$_7,exhaleMask#_159_$_2);
	assume exhaleMask#_159_$_3 == exhaleMask#_159_$_2;
	goto $branchMerge_7;
anon77_Else:
	assume !$_$_condition_$17;
	assume $_$_condition_$17 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	assume exhaleMask#_159_$_3 == exhaleMask#_159_$_1;
	goto $branchMerge_7;
anon85_Then:
	assume $_$_condition_$18;
	assume $_$_condition_$18 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	...
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 117.22 for SortedTreeNode.valid." } (Fractions(1) <= exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R]) && ((Fractions(1) == exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R]) ==> (0 <= exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$N]));
	assume exhaleMask#_166_$_2 == exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid := exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R := exhaleMask#_166_$_1[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.valid][perm$R] - Fractions(1)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_8,Mask_$_5);
	assume wf(Heap_$_8,exhaleMask#_166_$_2);
	assume exhaleMask#_166_$_3 == exhaleMask#_166_$_2;
	goto $branchMerge_8;
anon85_Else:
	assume !$_$_condition_$18;
	assume $_$_condition_$18 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	assume exhaleMask#_166_$_3 == exhaleMask#_166_$_1;
	goto $branchMerge_8;
anon78_Then:
	assume $_$_condition_$19;
	assume $_$_condition_$19 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	...
	assert { :msg "  141.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 118.22 for SortedTreeNode.keys." } (Fractions(1) <= exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R]) && ((Fractions(1) == exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R]) ==> (0 <= exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$N]));
	assume exhaleMask#_159_$_4 == exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys := exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R := exhaleMask#_159_$_3[Heap_$_7[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R] - Fractions(1)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_7,Mask_$_5);
	assume wf(Heap_$_7,exhaleMask#_159_$_4);
	assume exhaleMask#_159_$_5 == exhaleMask#_159_$_4;
	goto $branchMerge_9;
anon78_Else:
	assume !$_$_condition_$19;
	assume $_$_condition_$19 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	assume exhaleMask#_159_$_5 == exhaleMask#_159_$_3;
	goto $branchMerge_9;
anon86_Then:
	assume $_$_condition_$21;
	assume $_$_condition_$21 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	...
	assert { :msg "  144.4: Fold might fail because the definition of SortedTreeSnapshot.valid does not hold. Insufficient fraction at 118.22 for SortedTreeNode.keys." } (Fractions(1) <= exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R]) && ((Fractions(1) == exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R]) ==> (0 <= exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$N]));
	assume exhaleMask#_166_$_4 == exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys := exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R := exhaleMask#_166_$_3[Heap_$_8[this,SortedTreeSnapshot.root],SortedTreeNode.keys][perm$R] - Fractions(1)]];
	assume IsGoodMask(Mask_$_5);
	assume wf(Heap_$_8,Mask_$_5);
	assume wf(Heap_$_8,exhaleMask#_166_$_4);
	assume exhaleMask#_166_$_5 == exhaleMask#_166_$_4;
	goto $branchMerge_10;
anon86_Else:
	assume !$_$_condition_$21;
	assume $_$_condition_$21 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	assume exhaleMask#_166_$_5 == exhaleMask#_166_$_3;
	goto $branchMerge_10;
anon79_Then:
	assume $_$_condition_$23;
	assume $_$_condition_$23 <==> (!(Heap_$_7[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_7[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_11;
anon79_Else:
	assume !$_$_condition_$23;
...
anon87_Then:
	...
	assume $_$_condition_$25 <==> (!(Heap_$_8[this,SortedTreeSnapshot.root] == null));
	assume !(Heap_$_8[this,SortedTreeSnapshot.root] == null);
	goto $branchMerge_12;
anon87_Else:
	assume !$_$_condition_$25;
...
anon80_Then:
	...
	assume $_$_condition_$27 <==> (Heap_$_7[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_7[this,SortedTreeSnapshot.root] == null;
	goto anon31;
anon80_Else:
	assume !$_$_condition_$27;
...
anon88_Then:
	...
	assume $_$_condition_$29 <==> (Heap_$_8[this,SortedTreeSnapshot.root] == null);
	assume Heap_$_8[this,SortedTreeSnapshot.root] == null;
	goto anon56;
anon88_Else:
	assume !$_$_condition_$29;
	...
	goto anon56;
anon31:
	assume wf(Heap_$_7,exhaleMask#_159_$_5);
	assume IsGoodInhaleState(inhaleHeap#_164_$_0,Heap_$_7,exhaleMask#_159_$_5);
	assume !(this == null);
	assume Heap_$_11 == Heap_$_7[this,SortedTreeSnapshot.valid := inhaleHeap#_164_$_0[this,SortedTreeSnapshot.valid]];
	assume wf(Heap_$_11,exhaleMask#_159_$_5);
	assume inhaleHeap#_164_$_0[this,SortedTreeSnapshot.valid] == Heap_$_11;
	assume Fractions(100) > 0;
	assume Mask_$_7 == exhaleMask#_159_$_5[this,SortedTreeSnapshot.valid := exhaleMask#_159_$_5[this,SortedTreeSnapshot.valid][perm$R := exhaleMask#_159_$_5[this,SortedTreeSnapshot.valid][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_7);
	assume IsGoodState(inhaleHeap#_164_$_0[this,SortedTreeSnapshot.valid]);
	assume wf(Heap_$_11,Mask_$_7);
	assume wf(inhaleHeap#_164_$_0,Mask_$_7);
	assume IsGoodMask(Mask_$_7);
	assume wf(Heap_$_11,Mask_$_7);
	assume Heap_$_12 == Heap_$_11[this,SortedTreeSnapshot.valid := Heap_$_11];
	assume wf(Heap_$_12,Mask_$_7);
	assume Mask_$_8 == Mask_$_7;
	assume Heap_$_13 == Heap_$_12;
	goto $branchMerge_13;
anon56:
	assume wf(Heap_$_8,exhaleMask#_166_$_5);
	assume IsGoodInhaleState(inhaleHeap#_171_$_0,Heap_$_8,exhaleMask#_166_$_5);
	assume !(this == null);
	assume Heap_$_9 == Heap_$_8[this,SortedTreeSnapshot.valid := inhaleHeap#_171_$_0[this,SortedTreeSnapshot.valid]];
	assume wf(Heap_$_9,exhaleMask#_166_$_5);
	assume inhaleHeap#_171_$_0[this,SortedTreeSnapshot.valid] == Heap_$_9;
	assume Fractions(100) > 0;
	assume Mask_$_6 == exhaleMask#_166_$_5[this,SortedTreeSnapshot.valid := exhaleMask#_166_$_5[this,SortedTreeSnapshot.valid][perm$R := exhaleMask#_166_$_5[this,SortedTreeSnapshot.valid][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_6);
	assume IsGoodState(inhaleHeap#_171_$_0[this,SortedTreeSnapshot.valid]);
	assume wf(Heap_$_9,Mask_$_6);
	assume wf(inhaleHeap#_171_$_0,Mask_$_6);
	assume IsGoodMask(Mask_$_6);
	assume wf(Heap_$_9,Mask_$_6);
	assume Heap_$_10 == Heap_$_9[this,SortedTreeSnapshot.valid := Heap_$_9];
	assume wf(Heap_$_10,Mask_$_6);
	assume Mask_$_8 == Mask_$_6;
	assume Heap_$_13 == Heap_$_10;
	goto $branchMerge_13;
anon89_Then:
	assume $_$_condition_$31;
	assume $_$_condition_$31 <==> (!(treeRoot#10 == null));
	assume !(treeRoot#10 == null);
	assert { :msg "  124.2: The postcondition at 134.11 might not hold. The expression at 134.30 might not evaluate to true." } Seq#Equal(Heap_$_13[this,SortedTreeSnapshot.keys],Heap[treeRoot#10,SortedTreeNode.keys]);
	goto $branchMerge_14;
anon89_Else:
	assume !$_$_condition_$31;
	assume $_$_condition_$31 <==> (!(treeRoot#10 == null));
...
anon90_Then:
	...
	assume $_$_condition_$33 <==> (treeRoot#10 == null);
	assume treeRoot#10 == null;
	assert { :msg "  124.2: The postcondition at 135.11 might not hold. The expression at 135.30 might not evaluate to true." } Seq#Equal(Heap_$_13[this,SortedTreeSnapshot.keys],(Seq#Empty() : Seq (Integer) ));
	goto anon63;
anon90_Else:
	assume !$_$_condition_$33;
	assume $_$_condition_$33 <==> (treeRoot#10 == null);
...
anon63:
	...
	assert { :msg "  124.2: The postcondition at 131.11 might not hold. Insufficient fraction at 131.11 for SortedTreeSnapshot.valid." } (Fractions(100) <= Mask_$_8[this,SortedTreeSnapshot.valid][perm$R]) && ((Fractions(100) == Mask_$_8[this,SortedTreeSnapshot.valid][perm$R]) ==> (0 <= Mask_$_8[this,SortedTreeSnapshot.valid][perm$N]));
	assume exhaleMask#_172_$_0 == Mask_$_8[this,SortedTreeSnapshot.valid := Mask_$_8[this,SortedTreeSnapshot.valid][perm$R := Mask_$_8[this,SortedTreeSnapshot.valid][perm$R] - Fractions(100)]];
	assume IsGoodMask(Mask_$_8);
	assume wf(Heap_$_13,Mask_$_8);
	assume wf(Heap_$_13,exhaleMask#_172_$_0);
	...
	assert { :msg "  124.2: The postcondition at 132.11 might not hold. Insufficient fraction at 132.11 for SortedTreeSnapshot.keys." } (Fractions(50) <= exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys][perm$R]) && ((Fractions(50) == exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys][perm$R]) ==> (0 <= exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys][perm$N]));
	assume exhaleMask#_172_$_1 == exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys := exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys][perm$R := exhaleMask#_172_$_0[this,SortedTreeSnapshot.keys][perm$R] - Fractions(50)]];
	assume IsGoodMask(Mask_$_8);
	assume wf(Heap_$_13,Mask_$_8);
	assume wf(Heap_$_13,exhaleMask#_172_$_1);
	if ($_$_condition_$35) { goto anon91_Then; } else { goto anon91_Else; }
anon91_Then:
	assume $_$_condition_$35;
	assume $_$_condition_$35 <==> (!(treeRoot#10 == null));
	assume !(treeRoot#10 == null);
	goto $branchMerge_15;
anon91_Else:
	assume !$_$_condition_$35;
...
anon92_Then:
	...
	assume $_$_condition_$36 <==> (treeRoot#10 == null);
	assume treeRoot#10 == null;
	goto anon69;
anon92_Else:
	assume !$_$_condition_$36;
...
anon69:
	assume wf(Heap_$_13,exhaleMask#_172_$_1);
	assert { :msg "  124.2: Method might lock/unlock more than allowed." } (forall  lk#_175 : ref :: {Heap_$_13[lk#_175,held]} {Heap_$_13[lk#_175,rdheld]} ( (((0 < Heap_$_13[lk#_175,held]) <==> (0 < Heap[lk#_175,held])) && (Heap_$_13[lk#_175,rdheld] <==> Heap[lk#_175,rdheld])) || false ));
	assert { :msg "  124.2: Method body is not allowed to leave any debt." } (forall  ch : ref :: ( (ch == null) || (0 <= ZeroCredits[ch]) ));
	goto $exit;
$branchMerge_0:
	if ($_$_condition_$0) { goto anon71_Then; } else { goto anon71_Else; }
$branchMerge_1:
	if ($_$_condition_$5) { goto anon74_Then; } else { goto anon74_Else; }
$branchMerge_2:
	if ($_$_condition_$7) { goto anon82_Then; } else { goto anon82_Else; }
$branchMerge_3:
	if ($_$_condition_$9) { goto anon75_Then; } else { goto anon75_Else; }
$branchMerge_4:
	if ($_$_condition_$11) { goto anon83_Then; } else { goto anon83_Else; }
$branchMerge_5:
	if ($_$_condition_$13) { goto anon76_Then; } else { goto anon76_Else; }
$branchMerge_6:
	if ($_$_condition_$15) { goto anon84_Then; } else { goto anon84_Else; }
$branchMerge_7:
	if ($_$_condition_$19) { goto anon78_Then; } else { goto anon78_Else; }
$branchMerge_8:
	if ($_$_condition_$21) { goto anon86_Then; } else { goto anon86_Else; }
$branchMerge_9:
	if ($_$_condition_$23) { goto anon79_Then; } else { goto anon79_Else; }
$branchMerge_10:
	if ($_$_condition_$25) { goto anon87_Then; } else { goto anon87_Else; }
$branchMerge_11:
	if ($_$_condition_$27) { goto anon80_Then; } else { goto anon80_Else; }
$branchMerge_12:
	if ($_$_condition_$29) { goto anon88_Then; } else { goto anon88_Else; }
$branchMerge_13:
	if ($_$_condition_$31) { goto anon89_Then; } else { goto anon89_Else; }
$branchMerge_14:
	if ($_$_condition_$33) { goto anon90_Then; } else { goto anon90_Else; }
$branchMerge_15:
