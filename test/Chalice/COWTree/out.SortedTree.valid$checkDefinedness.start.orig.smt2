...
(declare-fun anon14_Then@2_assertion ( ) Bool)
(declare-fun anon14_Then@3 ( ) Bool)
(declare-fun anon14_Then@3_assertion ( ) Bool)
(declare-fun anon14_Then@4 ( ) Bool)
(declare-fun anon14_Then_assertion ( ) Bool)
(declare-fun anon15_Else ( ) Bool)
(declare-fun anon15_Then ( ) Bool)
(declare-fun anon15_Then@1 ( ) Bool)
(declare-fun anon15_Then@1_assertion ( ) Bool)
(declare-fun anon15_Then@2 ( ) Bool)
(declare-fun anon15_Then@2_assertion ( ) Bool)
(declare-fun anon15_Then@3 ( ) Bool)
(declare-fun anon15_Then@3_assertion ( ) Bool)
(declare-fun anon15_Then@4 ( ) Bool)
(declare-fun anon15_Then@4_assertion ( ) Bool)
(declare-fun anon15_Then@5 ( ) Bool)
(declare-fun anon15_Then@5_assertion ( ) Bool)
(declare-fun anon15_Then@6 ( ) Bool)
(declare-fun anon15_Then_assertion ( ) Bool)
(declare-fun anon16_Then ( ) Bool)
(declare-fun anon16_Then@1 ( ) Bool)
(declare-fun anon16_Then@1_assertion ( ) Bool)
(declare-fun anon16_Then_assertion ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (< 0 monitorK)
      (< 0 predicateK)
      (= (= true $@bf_19) (ite$Bool$ true true true))
      (= (= true $@bf_20) (ite$Bool$ true true false))
      (= (= true $@bf_21) (ite$Bool$ true false true))
      (= (= true $@bf_22) (ite$Bool$ true false false))
      (= (= true $@bf_23) (ite$Bool$ false true true))
      (= (= true $@bf_24) (ite$Bool$ false true false))
      (= (= true $@bf_25) (ite$Bool$ false false true))
      (= (= true $@bf_26) (ite$Bool$ false false false))
...
(assert (! (=> anon0 (and true 
   (and true
      (< (* 1000 predicateK@_8) (Fractions 1))
      (< 0 predicateK@_8)
      (= Heap@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this SortedTree.root (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ inhaleHeap@_9@0 this SortedTree.root)))
      (= Heap@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@0 this SortedTree.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_9@0 this SortedTree.keys)))
      (= Heap@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@1 this SortedTree.numClones (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ inhaleHeap@_9@0 this SortedTree.numClones)))
      ...
      (IsGoodMask Mask@1)
      (IsGoodMask Mask@2)
      (IsGoodState$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ inhaleHeap@_9@0 this SortedTree.numClones))
      (IsGoodState$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ inhaleHeap@_9@0 this SortedTree.root))
      (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_9@0 this SortedTree.keys))
      (not (= this null))
      ...
      (wf inhaleHeap@_9@0 Mask@1)
      (wf inhaleHeap@_9@0 Mask@2)
   )
...
(assert (! (=> anon0@1_assertion (not (and true
   (and true
      (=> true (CanRead$Int$ Mask@2 this SortedTree.numClones))
   )
))) :named ax_anon0@1_assertion))
(assert (! (=> anon0@2 (and true 
   (and true
      (=> true (CanRead$Int$ Mask@2 this SortedTree.numClones))
      (>= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@2 this SortedTree.numClones) 0)
   )
...
(assert (! (=> anon0@4 (and true 
   (and true
      (< (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@2 this SortedTree.numClones) 50)
      (=> true (CanRead$Int$ Mask@2 this SortedTree.numClones))
   )
...
(assert (! (=> anon0@5_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@2 this SortedTree.root))
   )
...
(assert (! (=> anon13_Else (and true 
   (and true
      (= $@condition (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) null)))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) null)
      (= Heap@4 Heap@2)
      (= Mask@4 Mask@2)
      (not $@condition)
   )
...
(assert (! (=> anon13_Then (and true 
   (and true
      $@condition
      (= $@condition (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) null)))
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) null))
   )
...
(assert (! (=> anon13_Then@4 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_9@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid) Heap@3)
      (= Heap@3 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) SortedTreeNode.valid (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_9@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) SortedTreeNode.valid)))
      (= Heap@4 Heap@3)
      (= Mask@3 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid) perm$R) (- (Fractions 100) (Fractions (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@3 this SortedTree.numClones)))))))
      (= Mask@4 Mask@3)
      (=> true (CanRead$Int$ Mask@2 this SortedTree.numClones))
      (> (- (Fractions 100) (Fractions (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@3 this SortedTree.numClones))) 0)
      (IsGoodMask Mask@3)
      (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_9@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@3 this SortedTree.root) SortedTreeNode.valid))
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@2 this SortedTree.root) null))
      (wf Heap@3 Mask@2)
      (wf Heap@3 Mask@3)
      (wf inhaleHeap@_9@0 Mask@3)
   )
anon3
...
(assert (! (=> anon3@1_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@4 this SortedTree.root))
   )
...
(assert (! (=> anon14_Else (and true 
   (and true
      (= $@condition_$0 (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@4 this SortedTree.root) null)))
...
(or anon14_Then@2_assertion anon14_Then@3)
)) :named ax_anon14_Then@2))
(assert (! (=> anon14_Then@2_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon14_Then@2_assertion))
(assert (! (=> anon14_Then@3 (and true 
   (and true
      (=> true (not (= this null)))
   )
(or anon14_Then@3_assertion anon14_Then@4)
)) :named ax_anon14_Then@3))
(assert (! (=> anon14_Then@3_assertion (not (and true
   (and true
      (=> true (CanRead$Int$ Mask@4 this SortedTree.numClones))
   )
))) :named ax_anon14_Then@3_assertion))
(assert (! (=> anon14_Then@4 (and true 
   (and true
      (= Heap@5 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@4 this SortedTree.root) SortedTreeNode.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_9@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@4 this SortedTree.root) SortedTreeNode.keys)))
      (= Heap@6 Heap@5)
      ...
      (IsGoodMask Mask@5)
      (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_9@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@5 this SortedTree.root) SortedTreeNode.keys))
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@4 this SortedTree.root) null))
      (wf Heap@5 Mask@4)
      (wf Heap@5 Mask@5)
      (wf inhaleHeap@_9@0 Mask@5)
   )
anon6
)) :named ax_anon14_Then@4))
...
(assert (! (=> anon6@1_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@6 this SortedTree.root))
   )
...
(assert (! (=> anon15_Else (and true 
   (and true
      (= $@condition_$1 (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) null)))
...
(or anon15_Then@1 anon15_Then_assertion)
)) :named ax_anon15_Then))
(assert (! (=> anon15_Then@1 (and true 
   (and true
      (=> true (not (= this null)))
   )
(or anon15_Then@1_assertion anon15_Then@2)
)) :named ax_anon15_Then@1))
(assert (! (=> anon15_Then_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon15_Then_assertion))
(assert (! (=> anon15_Then@1_assertion (not (and true
   (and true
      (=> true (CanRead$Seq$Int$$ Mask@6 this SortedTree.keys))
   )
))) :named ax_anon15_Then@1_assertion))
(assert (! (=> anon15_Then@2 (and true 
   (and true
      (=> true (CanRead$Seq$Int$$ Mask@6 this SortedTree.keys))
   )
(or anon15_Then@2_assertion anon15_Then@3)
)) :named ax_anon15_Then@2))
(assert (! (=> anon15_Then@2_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon15_Then@2_assertion))
(assert (! (=> anon15_Then@3 (and true 
   (and true
      (=> true (not (= this null)))
   )
(or anon15_Then@3_assertion anon15_Then@4)
)) :named ax_anon15_Then@3))
(assert (! (=> anon15_Then@3_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@6 this SortedTree.root))
   )
))) :named ax_anon15_Then@3_assertion))
(assert (! (=> anon15_Then@4 (and true 
   (and true
      (=> true (CanRead$ref$ Mask@6 this SortedTree.root))
   )
(or anon15_Then@4_assertion anon15_Then@5)
)) :named ax_anon15_Then@4))
(assert (! (=> anon15_Then@4_assertion (not (and true
   (and true
      (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) null)))
   )
))) :named ax_anon15_Then@4_assertion))
(assert (! (=> anon15_Then@5 (and true 
   (and true
      (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) null)))
   )
(or anon15_Then@5_assertion anon15_Then@6)
)) :named ax_anon15_Then@5))
(assert (! (=> anon15_Then@5_assertion (not (and true
   (and true
      (=> true (CanRead$Seq$Int$$ Mask@6 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) SortedTreeNode.keys))
   )
))) :named ax_anon15_Then@5_assertion))
(assert (! (=> anon15_Then@6 (and true 
   (and true
      (=> true (CanRead$Seq$Int$$ Mask@6 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) SortedTreeNode.keys))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@6 this SortedTree.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@6 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) SortedTreeNode.keys))
   )
anon9
)) :named ax_anon15_Then@6))
...
(assert (! (=> anon16_Then (and true 
   (and true
      $@condition_$2
      (= $@condition_$2 (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) null))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTree.root) null)
   )
(or anon16_Then@1 anon16_Then_assertion)
)) :named ax_anon16_Then))
(assert (! (=> anon16_Then@1 (and true 
   (and true
      (=> true (not (= this null)))
   )
anon16_Then@1_assertion
)) :named ax_anon16_Then@1))
(assert (! (=> anon16_Then_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon16_Then_assertion))
...
(assert (=> false (not (and
   ...
   anon14_Then@2_assertion
   anon14_Then@3_assertion
   anon14_Then_assertion
   anon15_Then@1_assertion
   anon15_Then@2_assertion
   anon15_Then@3_assertion
   anon15_Then@4_assertion
   anon15_Then@5_assertion
