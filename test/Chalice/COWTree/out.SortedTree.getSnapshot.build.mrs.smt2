...
;Functions
(declare-fun $@bf_12 ( $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@ ref Field$Int$ ) Bool)
...
(declare-fun $@bf_6 ( $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@ ref Field$Int$ ) Bool)
...
;Axioms
   ...
   (assert (! (= false $@bf_31) :named ax_26))
   (assert (! (= false $@bf_33) :named ax_27))
   (assert (! (= Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_29@0 this SortedTree.valid)) :named ax_28))
   (assert (! (= Heap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap this SortedTree.valid Heap)) :named ax_29))
   (assert (! (= Heap Heap@0) :named ax_30))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ZeroMask this SortedTree.valid) perm$R) Permission$FullFraction)))) :named ax_31))
   (assert (! (= Mask Mask@0) :named ax_32))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_289))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_290))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_291))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_292))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_293))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_294))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_295))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_296))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_297))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_298))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_299))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_300))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_301))
   (assert (! (IsGoodInhaleState inhaleHeap@_29@0 Heap ZeroMask) :named ax_302))
   (assert (! (IsGoodMask Mask) :named ax_303))
   (assert (! (IsGoodMask ZeroMask) :named ax_304))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap) :named ax_305))
   (assert (! (ite$Bool$ false false true) :named ax_306))
   (assert (! (ite$Bool$ false true true) :named ax_307))
   (assert (! (ite$Bool$ true true false) :named ax_308))
   (assert (! (ite$Bool$ true true true) :named ax_309))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_310))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_311))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_312))
   (assert (! (NonPredicateField$Int$ held) :named ax_313))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_314))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_315))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_316))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_317))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_318))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_319))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_320))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_321))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_322))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_323))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_324))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_325))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_26))) :named ax_326))
   (assert (! (not (= 0 channelK)) :named ax_327))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_328))
   (assert (! (not (= forkK joinable)) :named ax_329))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_330))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_331))
   (assert (! (not (= held forkK)) :named ax_332))
   (assert (! (not (= held joinable)) :named ax_333))
   (assert (! (not (= held SortedTree.numClones)) :named ax_334))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_335))
   (assert (! (not (= joinable forkK)) :named ax_336))
   (assert (! (not (= joinable held)) :named ax_337))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_338))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_339))
   (assert (! (not (= methodK@_26 (* 1000 unfoldK@_30))) :named ax_340))
   (assert (! (not (= methodK@_26 0)) :named ax_341))
   (assert (! (not (= perm$R perm$N)) :named ax_342))
   (assert (! (not (= Permission$denominator 0)) :named ax_343))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_344))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_345))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_346))
   (assert (! (not (= SortedTree.numClones held)) :named ax_347))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_348))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_349))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_350))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_351))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_352))
   (assert (! (not (= SortedTree@t SortedTreeSnapshot@t)) :named ax_353))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_354))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_355))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_356))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_357))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_358))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_359))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_360))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_361))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_362))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_363))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_364))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_365))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_366))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_367))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_368))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_369))
   (assert (! (not (= SortedTreeNode@t SortedTreeSnapshot@t)) :named ax_370))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_371))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_372))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_373))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_374))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_375))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_376))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_377))
   (assert (! (not (= SortedTreeSnapshot@t SortedTree@t)) :named ax_378))
   (assert (! (not (= SortedTreeSnapshot@t SortedTreeNode@t)) :named ax_379))
   (assert (! (not (= this null)) :named ax_380))
   (assert (! (not (= unfoldK@_30 (Fractions 1))) :named ax_381))
   (assert (! (not (= unfoldK@_30 0)) :named ax_382))
   (assert (! (not (ite$Bool$ false false false)) :named ax_383))
   (assert (! (not (ite$Bool$ false true false)) :named ax_384))
   (assert (! (not (ite$Bool$ true false false)) :named ax_385))
   (assert (! (not (ite$Bool$ true false true)) :named ax_386))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_387))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_388))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_389))
   (assert (! (wf Heap Mask) :named ax_390))
   (assert (! (wf Heap ZeroMask) :named ax_391))
   (assert (! (wf inhaleHeap@_29@0 Mask) :named ax_392))
   (assert (! CanAssumeFunctionDefs :named ax_393))
   (assert (! true :named ax_394))
...
(assert (! (=> anon0@3 (and true 
   (and true
      ...
      (= Heap@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this SortedTree.root (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ inhaleHeap@_33@0 this SortedTree.root)))
      ...
      (= inhaleHeap@_33@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap this SortedTree.valid))
      ...
      (IsGoodInhaleState inhaleHeap@_33@0 Heap exhaleMask@_31@0)
      (IsGoodMask Mask@0)
      (IsGoodMask Mask@1)
      (IsGoodMask Mask@2)
      (IsGoodMask Mask@3)
      ...
      (not (= 0 (Fractions 100)))
      (not (= 0 (Fractions 50)))
      (not (= 50 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@3 this SortedTree.numClones)))
      (or (= SortedTreeNode@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@1 this SortedTree.root))) (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@1 this SortedTree.root)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@0 this SortedTree.valid) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@0 this SortedTree.valid) perm$R))))
      (wf Heap exhaleMask@_31@0)
      (wf Heap Mask@0)
...
(assert (! (=> anon58_Then (and true 
   (and true
      ...
      (= Heap@4 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_33@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@4 this SortedTree.root) SortedTreeNode.valid))
...
(assert (! (=> anon59_Then (and true 
   (and true
      $@condition_$0
      (< 0 (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@6 this SortedTree.numClones)))))
      ...
      (not (= 0 (Fractions (+ 50 (* (- 1) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@6 this SortedTree.numClones))))))
...
(assert (! (=> anon12@2 (and true 
   (and true
      ...
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@7 this SortedTree.numClones) 49))
...
(assert (! (=> anon19@4 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@0 nw@_34@0 SortedTreeSnapshot.keys) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@0 nw@_34@0 SortedTreeSnapshot.keys) perm$R))))
...
(assert (! (=> anon65_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_39@1 treeRoot@35@0 SortedTreeNode.valid) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_39@1 treeRoot@35@0 SortedTreeNode.valid) perm$R))))
...
(assert (! (=> anon66_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@3 treeRoot@35@0 SortedTreeNode.keys) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_39@3 treeRoot@35@0 SortedTreeNode.keys) perm$R))))
...
(assert (! (=> anon67_Then (and true 
   (and true
      $@condition_$13
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 treeRoot@35@0 SortedTreeNode.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@9 nw@_34@0 SortedTreeSnapshot.keys))
      (not (= null treeRoot@35@0))
      (Seq@Equal$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 treeRoot@35@0 SortedTreeNode.keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@7 treeRoot@35@0 SortedTreeNode.keys))
   )
$branchMerge_5
...
(assert (! (=> anon43@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@12 this SortedTree.root) perm$R))))
...
(assert (! (=> anon43@4 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_48@0 this SortedTree.keys) perm$R))))
