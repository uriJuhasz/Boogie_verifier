...
procedure SortedTreeSnapshot$monitorinvariant$checkDefinedness (this : ref)
{
	var methodK#_151 : int;
	var h0#_144 : HeapType;
	var m0#_145 : MaskType;
...
anon0:
	...
	assert { :msg "  108.1: Monitor invariant is not allowed to contain debt." } (forall  ch : ref :: ( (ch == null) || (0 <= ZeroCredits[ch]) ));
	goto $exit;
}
