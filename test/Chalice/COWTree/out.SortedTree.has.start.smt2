...
(let ((anon68_Else@3_assertion (and
    (> (Fractions 1) 0)
)))
(let ((anon68_Else@5_assertion (and
    (> (Fractions 1) 0)
)))
...
(let ((anon50@4_assertion (and
    (> (Fractions 100) 0)
)))
(let ((anon50_assertion (and
    (> (Fractions 100) 0)
)))
(let ((anon63@1_assertion (and
    (> (Fractions 100) 0)
)))
(let ((anon25@2_assertion (and
    (> (Fractions 50) 0)
)))
(let ((anon50@2_assertion (and
    (> (Fractions 50) 0)
)))
(let ((anon63@3_assertion (and
    (> methodK@_106 0)
)))
(let ((anon68_Else@9_assertion (and
    (< (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones) 50)
)))
(let ((anon68_Then@2_assertion (and
...
(let ((anon68_Else@4_assertion (and
...
(let ((anon68_Else@6_assertion (and
...
(let ((anon68_Else_assertion (and
    (=> true (not (= this null)))
)))
(let ((anon68_Else@2_assertion (and
    (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTree.root) null))
)))
(let ((anon68_Else@7_assertion (and
    (not (= this null))
)))
(let ((anon68_Then_assertion (and
    (not (= this null))
)))
(let ((anon63@6 (=> (and true
    (forall( (|lk#_143| ref))(!(or (and (= (< 0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@15 |lk#_143| held)) (< 0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap |lk#_143| held))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap@15 |lk#_143| rdheld) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap |lk#_143| rdheld))) false)  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@15 |lk#_143| held)) :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap@15 |lk#_143| rdheld))))
  )
    anon63@6_assertion
)))
(let ((anon63@5 (=> (and true
    (<= methodK@_106 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_140@0 this SortedTree.keys) perm$R))
...
(let ((anon63@4 (=> (and true
    (> methodK@_106 0)
  )(and 
    anon63@4_assertion
    anon63@5
))))
(let ((anon63@3 (=> (and true
    (<= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@13 this SortedTree.valid) perm$R))
...
(let ((anon63@2 (=> (and true
    (> (Fractions 100) 0)
  )(and 
    anon63@2_assertion
    anon63@3
))))
(let ((anon63@1 (=> (and true
    (= b@7@0 (Seq@Contains$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@15 this SortedTree.keys) k@6))
  )(and 
    anon63@1_assertion
    anon63@2
...
(let ((anon68_Then@3 (=> (and true
    (< (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@8 this SortedTree.numClones) 50)
  )
    (and anon69_Else anon69_Then)
)))
(let ((anon68_Else@10 (=> (and true
    (< (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones) 50)
  )
    (and anon77_Else anon77_Then)
)))
(let ((anon68_Then@2 (=> (and true
    (>= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@8 this SortedTree.numClones) 0)
  )(and 
    anon68_Then@2_assertion
    anon68_Then@3
))))
(let ((anon68_Else@9 (=> (and true
    (>= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@10 this SortedTree.numClones) 0)
  )(and 
    anon68_Else@9_assertion
    anon68_Else@10
))))
(let ((anon68_Then@1 (=> (and true
    (not (= this null))
  )(and 
    anon68_Then@1_assertion
    anon68_Then@2
))))
(let ((anon68_Else@8 (=> (and true
    (not (= this null))
  )(and 
...
(let ((anon68_Else@6 (=> (and true
    (> (Fractions 1) 0)
  )(and 
    anon68_Else@6_assertion
    anon68_Else@7
))))
(let ((anon68_Else@5 (=> (and true
    (<= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this@52@0 SortedTreeNode.valid) perm$R))
...
(let ((anon68_Else@4 (=> (and true
    (> (Fractions 1) 0)
  )(and 
    anon68_Else@4_assertion
    anon68_Else@5
))))
(let ((anon68_Else@3 (=> (and true
...
(let ((anon68_Else@2 (=> (and true
    (=> true (CanRead$ref$ Mask@8 this SortedTree.root))
  )(and 
    anon68_Else@2_assertion
    anon68_Else@3
))))
(let ((anon68_Else@1 (=> (and true
    (=> true (not (= this null)))
  )(and 
