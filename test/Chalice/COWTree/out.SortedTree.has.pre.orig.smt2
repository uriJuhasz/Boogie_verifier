...
;Axioms
   ...
   (assert (! (< (* 1000 unfoldK@_110) methodK@_106) :named ax_4))
   (assert (! (< 0 channelK) :named ax_5))
   (assert (! (< 0 methodK@_106) :named ax_6))
   (assert (! (< 0 monitorK) :named ax_7))
   (assert (! (< 0 predicateK) :named ax_8))
   (assert (! (< 0 unfoldK@_110) :named ax_9))
   (assert (! (< unfoldK@_110 (Fractions 1)) :named ax_10))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_109@0 this SortedTree.valid) Heap@0) :named ax_11))
   ...
   (assert (! (= Heap@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Heap this SortedTree.valid (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_109@0 this SortedTree.valid))) :named ax_20))
   (assert (! (= Heap@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap@0 this SortedTree.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_109@0 this SortedTree.keys))) :named ax_21))
   ...
   (assert (! (> methodK@_106 0) :named ax_31))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_270))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_271))
   (assert (! (forall( (|t_$0_$0| Int))(!(= (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0) |t_$0_$0|)  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_272))
   (assert (! (forall( (|t_$0_$1| ref))(!(= (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0) |t_$0_$1|)  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_273))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_274))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_275))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_276))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_277))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_278))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_279))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|) (= |x_$9_$0| |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_280))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|) (= |x_$9_$1| |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_281))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= 0 |x|) (<= |x| |y|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_282))
   (assert (! (IsGoodInhaleState inhaleHeap@_109@0 Heap ZeroMask) :named ax_283))
   (assert (! (IsGoodMask Mask) :named ax_284))
   (assert (! (IsGoodMask Mask@0) :named ax_285))
   (assert (! (IsGoodMask Mask@1) :named ax_286))
   (assert (! (IsGoodMask Mask@1) :named ax_287))
   (assert (! (IsGoodMask ZeroMask) :named ax_288))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ inhaleHeap@_109@0 this SortedTree.valid)) :named ax_289))
   (assert (! (IsGoodState$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ nostate) :named ax_290))
   (assert (! (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_109@0 this SortedTree.keys)) :named ax_291))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_292))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_293))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_294))
   (assert (! (NonPredicateField$Int$ held) :named ax_295))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_296))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_297))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_298))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_299))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_300))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_301))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_302))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_303))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_304))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_305))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_306))
   (assert (! (not (= forkK held)) :named ax_307))
   (assert (! (not (= forkK SortedTree.numClones)) :named ax_308))
   (assert (! (not (= forkK SortedTreeNode.key)) :named ax_309))
   (assert (! (not (= held forkK)) :named ax_310))
   (assert (! (not (= held SortedTree.numClones)) :named ax_311))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_312))
   (assert (! (not (= joinable forkK)) :named ax_313))
   (assert (! (not (= joinable forkK)) :named ax_314))
   (assert (! (not (= joinable held)) :named ax_315))
   (assert (! (not (= joinable held)) :named ax_316))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_317))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_318))
   (assert (! (not (= perm$R perm$N)) :named ax_319))
   (assert (! (not (= perm$R perm$N)) :named ax_320))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_321))
   (assert (! (not (= SortedTree.keys SortedTreeNode.keys)) :named ax_322))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_323))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_324))
   (assert (! (not (= SortedTree.numClones held)) :named ax_325))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_326))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_327))
   (assert (! (not (= SortedTree.root SortedTreeNode.left)) :named ax_328))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_329))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_330))
   (assert (! (not (= SortedTree.valid SortedTreeNode.valid)) :named ax_331))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_332))
   (assert (! (not (= SortedTree@t SortedTreeNode@t)) :named ax_333))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_334))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_335))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_336))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_337))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_338))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_339))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_340))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_341))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_342))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_343))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_344))
   (assert (! (not (= SortedTreeNode@t SortedTree@t)) :named ax_345))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_346))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_347))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_348))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_349))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_350))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_351))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_352))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_353))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_354))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_355))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_356))
   (assert (! (not (= this null)) :named ax_357))
   (assert (! (not (= this null)) :named ax_358))
   (assert (! (not (= this null)) :named ax_359))
   (assert (! (not (= this null)) :named ax_360))
   (assert (! (or (= this null) (= (dtype this) SortedTree@t)) :named ax_361))
   (assert (! (or (= this@52 null) (= (dtype this@52) SortedTreeNode@t)) :named ax_362))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_363))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_364))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_365))
   (assert (! (wf Heap Mask) :named ax_366))
   (assert (! (wf Heap@0 Mask@0) :named ax_367))
   (assert (! (wf Heap@0 ZeroMask) :named ax_368))
   (assert (! (wf Heap@1 Mask@0) :named ax_369))
   (assert (! (wf Heap@1 Mask@1) :named ax_370))
   (assert (! (wf Heap@1 Mask@1) :named ax_371))
   (assert (! (wf inhaleHeap@_109@0 Mask@0) :named ax_372))
   (assert (! (wf inhaleHeap@_109@0 Mask@1) :named ax_373))
