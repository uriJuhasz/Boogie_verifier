...
;Axioms
   ...
   (assert (! (= Permission$FullFraction (Fractions 100)) :named ax_29))
   (assert (! (= Permission$FullFraction (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$R)) :named ax_30))
   (assert (! (= true $@bf_26) :named ax_31))
   (assert (! (= true $@bf_27) :named ax_32))
   (assert (! (= true $@bf_30) :named ax_33))
   ...
   (assert (! (forall ((|v_9| $@Map@@PermissionComponent@To@Int@@)(|i_19| Field$ref$)(|i_18| ref)(|j_15| Field$Bool$)(|j_14| ref)(|m_10| $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ m_10 j_14 j_15) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ m_10 i_18 i_19 v_9) j_14 j_15)):pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ m_10 i_18 i_19 v_9) j_14 j_15)) :qid map_3_$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@__Bool__ref :weight 0 )) :named ax_78))
   (assert (! (forall( (|a_$2| Int) (|b_$2| Int) (|d| Int))(!(=> (and (< |a_$2| |b_$2|) (and (<= 2 |d|) (= (mod |b_$2| |d|) (mod |a_$2| |d|)))) (<= (+ |a_$2| |d|) |b_$2|))  :pattern ( (mod |a_$2| |d|) (mod |b_$2| |d|)))) :named ax_79))
   (assert (! (forall( (|a_$3_$0| Seq$Int$) (|b_$3_$0| Seq$Int$))(!(=> (Seq@Equal$Int$ |a_$3_$0| |b_$3_$0|) (= |b_$3_$0| |a_$3_$0|))  :pattern ( (Seq@Equal$Int$ |a_$3_$0| |b_$3_$0|)))) :named ax_80))
   (assert (! (forall( (|a_$3_$1| Seq$ref$) (|b_$3_$1| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$3_$1| |b_$3_$1|) (= |b_$3_$1| |a_$3_$1|))  :pattern ( (Seq@Equal$ref$ |a_$3_$1| |b_$3_$1|)))) :named ax_81))
   ...
   (assert (! (forall( (|con_$0_$11| Bool) (|a_$1_$11| $@Map@@ref@To@Int@@) (|b_$1_$11| $@Map@@ref@To@Int@@))(!(=> (not |con_$0_$11|) (= (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|) |b_$1_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$0_$11| |a_$1_$11| |b_$1_$11|)))) :named ax_85))
   (assert (! (forall( (|con_$0_$12| Bool) (|a_$1_$12| Seq$ref$) (|b_$1_$12| Seq$ref$))(!(=> (not |con_$0_$12|) (= (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|) |b_$1_$12|))  :pattern ( (ite$Seq$ref$$ |con_$0_$12| |a_$1_$12| |b_$1_$12|)))) :named ax_86))
   (assert (! (forall( (|con_$0_$13| Bool) (|a_$1_$13| Seq$Int$) (|b_$1_$13| Seq$Int$))(!(=> (not |con_$0_$13|) (= (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|) |b_$1_$13|))  :pattern ( (ite$Seq$Int$$ |con_$0_$13| |a_$1_$13| |b_$1_$13|)))) :named ax_87))
   (assert (! (forall( (|con_$0_$14| Bool) (|a_$1_$14| Field$ref$) (|b_$1_$14| Field$ref$))(!(=> (not |con_$0_$14|) (= (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|) |b_$1_$14|))  :pattern ( (ite$Field$ref$$ |con_$0_$14| |a_$1_$14| |b_$1_$14|)))) :named ax_88))
   (assert (! (forall( (|con_$0_$15| Bool) (|a_$1_$15| Field$Seq$Int$$) (|b_$1_$15| Field$Seq$Int$$))(!(=> (not |con_$0_$15|) (= (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|) |b_$1_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$0_$15| |a_$1_$15| |b_$1_$15|)))) :named ax_89))
   (assert (! (forall( (|con_$0_$16| Bool) (|a_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$1_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> (not |con_$0_$16|) (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|) |b_$1_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$0_$16| |a_$1_$16| |b_$1_$16|)))) :named ax_90))
   ...
   (assert (! (forall( (|con_$0_$7| Bool) (|a_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$1_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (not |con_$0_$7|) (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|) |b_$1_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$0_$7| |a_$1_$7| |b_$1_$7|)))) :named ax_98))
   ...
   (assert (! (forall( (|con_$12| Bool) (|a_$0_$11| $@Map@@ref@To@Int@@) (|b_$0_$11| $@Map@@ref@To@Int@@))(!(=> |con_$12| (= (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|) |a_$0_$11|))  :pattern ( (ite$$@Map@@ref@To@Int@@$ |con_$12| |a_$0_$11| |b_$0_$11|)))) :named ax_104))
   (assert (! (forall( (|con_$13| Bool) (|a_$0_$12| Seq$ref$) (|b_$0_$12| Seq$ref$))(!(=> |con_$13| (= (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|) |a_$0_$12|))  :pattern ( (ite$Seq$ref$$ |con_$13| |a_$0_$12| |b_$0_$12|)))) :named ax_105))
   (assert (! (forall( (|con_$14| Bool) (|a_$0_$13| Seq$Int$) (|b_$0_$13| Seq$Int$))(!(=> |con_$14| (= (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|) |a_$0_$13|))  :pattern ( (ite$Seq$Int$$ |con_$14| |a_$0_$13| |b_$0_$13|)))) :named ax_106))
   (assert (! (forall( (|con_$15| Bool) (|a_$0_$14| Field$ref$) (|b_$0_$14| Field$ref$))(!(=> |con_$15| (= (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|) |a_$0_$14|))  :pattern ( (ite$Field$ref$$ |con_$15| |a_$0_$14| |b_$0_$14|)))) :named ax_107))
   (assert (! (forall( (|con_$16| Bool) (|a_$0_$15| Field$Seq$Int$$) (|b_$0_$15| Field$Seq$Int$$))(!(=> |con_$16| (= (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|) |a_$0_$15|))  :pattern ( (ite$Field$Seq$Int$$$ |con_$16| |a_$0_$15| |b_$0_$15|)))) :named ax_108))
   (assert (! (forall( (|con_$17| Bool) (|a_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$) (|b_$0_$16| Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$))(!(=> |con_$17| (= (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|) |a_$0_$16|))  :pattern ( (ite$Field$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$ |con_$17| |a_$0_$16| |b_$0_$16|)))) :named ax_109))
   ...
   (assert (! (forall( (|con_$8| Bool) (|a_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$0_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> |con_$8| (= (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|) |a_$0_$7|))  :pattern ( (ite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |con_$8| |a_$0_$7| |b_$0_$7|)))) :named ax_118))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_264))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_265))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_266))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_267))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_268))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_269))
   (assert (! (forall( (|x_$0| Int) (|y_$0| Int))(!(= (mod |x_$0| |y_$0|) (- |x_$0| (* (div |x_$0| |y_$0|) |y_$0|)))  :pattern ( (mod |x_$0| |y_$0|)) :pattern ( (div |x_$0| |y_$0|)))) :named ax_270))
   (assert (! (forall( (|x_$1| Int) (|y_$1| Int))(!(=> (< 0 |y_$1|) (and (<= 0 (mod |x_$1| |y_$1|)) (< (mod |x_$1| |y_$1|) |y_$1|)))  :pattern ( (mod |x_$1| |y_$1|)))) :named ax_271))
   (assert (! (forall( (|x_$2| Int) (|y_$2| Int))(!(=> (< |y_$2| 0) (and (< |y_$2| (mod |x_$2| |y_$2|)) (<= (mod |x_$2| |y_$2|) 0)))  :pattern ( (mod |x_$2| |y_$2|)))) :named ax_272))
   (assert (! (forall( (|x_$4| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$4|)))) :named ax_273))
   (assert (! (forall( (|x_$9_$0| Int) (|y_$3_$0| Int))(!(= (= |y_$3_$0| |x_$9_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$9_$0|) |y_$3_$0|)))) :named ax_274))
   (assert (! (forall( (|x_$9_$1| ref) (|y_$3_$1| ref))(!(= (= |y_$3_$1| |x_$9_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$9_$1|) |y_$3_$1|)))) :named ax_275))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_276))
   (assert (! (IsGoodInhaleState inhaleHeap@_157@0 Heap ZeroMask) :named ax_277))
   (assert (! (IsGoodMask Mask) :named ax_278))
   (assert (! (IsGoodMask Mask@0) :named ax_279))
   (assert (! (IsGoodMask Mask@1) :named ax_280))
   (assert (! (IsGoodMask ZeroMask) :named ax_281))
   (assert (! (IsGoodState$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ inhaleHeap@_157@0 this SortedTreeSnapshot.root)) :named ax_282))
   (assert (! (IsGoodState$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ inhaleHeap@_157@0 this SortedTreeSnapshot.keys)) :named ax_283))
   (assert (! (ite$Bool$ false false true) :named ax_284))
   (assert (! (ite$Bool$ false true true) :named ax_285))
   (assert (! (ite$Bool$ true true false) :named ax_286))
   (assert (! (ite$Bool$ true true true) :named ax_287))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_288))
   (assert (! (NonPredicateField$Bool$ SortedTreeNode.shared) :named ax_289))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_290))
   (assert (! (NonPredicateField$Int$ held) :named ax_291))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_292))
   (assert (! (NonPredicateField$Int$ SortedTree.numClones) :named ax_293))
   (assert (! (NonPredicateField$Int$ SortedTreeNode.key) :named ax_294))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_295))
   (assert (! (NonPredicateField$ref$ SortedTree.root) :named ax_296))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.left) :named ax_297))
   (assert (! (NonPredicateField$ref$ SortedTreeNode.right) :named ax_298))
   (assert (! (NonPredicateField$ref$ SortedTreeSnapshot.root) :named ax_299))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTree.keys) :named ax_300))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeNode.keys) :named ax_301))
   (assert (! (NonPredicateField$Seq$Int$$ SortedTreeSnapshot.keys) :named ax_302))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_303))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_154))) :named ax_304))
   (assert (! (not (= 0 channelK)) :named ax_305))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_306))
   (assert (! (not (= forkK joinable)) :named ax_307))
   ...
   (assert (! (not (= held joinable)) :named ax_311))
   (assert (! (not (= held SortedTree.numClones)) :named ax_312))
   (assert (! (not (= held SortedTreeNode.key)) :named ax_313))
   (assert (! (not (= joinable forkK)) :named ax_314))
   (assert (! (not (= joinable held)) :named ax_315))
   (assert (! (not (= joinable SortedTree.numClones)) :named ax_316))
   (assert (! (not (= joinable SortedTreeNode.key)) :named ax_317))
   (assert (! (not (= methodK@_154 0)) :named ax_318))
   (assert (! (not (= perm$R perm$N)) :named ax_319))
   (assert (! (not (= Permission$denominator 0)) :named ax_320))
   (assert (! (not (= rdheld SortedTreeNode.shared)) :named ax_321))
   (assert (! (not (= SortedTree.keys SortedTreeSnapshot.keys)) :named ax_322))
   (assert (! (not (= SortedTree.numClones forkK)) :named ax_323))
   (assert (! (not (= SortedTree.numClones held)) :named ax_324))
   (assert (! (not (= SortedTree.numClones joinable)) :named ax_325))
   (assert (! (not (= SortedTree.numClones SortedTreeNode.key)) :named ax_326))
   (assert (! (not (= SortedTree.root SortedTreeNode.right)) :named ax_327))
   (assert (! (not (= SortedTree.root SortedTreeSnapshot.root)) :named ax_328))
   (assert (! (not (= SortedTree.valid SortedTreeSnapshot.valid)) :named ax_329))
   (assert (! (not (= SortedTreeNode.key forkK)) :named ax_330))
   (assert (! (not (= SortedTreeNode.key held)) :named ax_331))
   (assert (! (not (= SortedTreeNode.key joinable)) :named ax_332))
   (assert (! (not (= SortedTreeNode.key SortedTree.numClones)) :named ax_333))
   (assert (! (not (= SortedTreeNode.keys SortedTree.keys)) :named ax_334))
   (assert (! (not (= SortedTreeNode.keys SortedTreeSnapshot.keys)) :named ax_335))
   (assert (! (not (= SortedTreeNode.left SortedTree.root)) :named ax_336))
   (assert (! (not (= SortedTreeNode.left SortedTreeNode.right)) :named ax_337))
   (assert (! (not (= SortedTreeNode.left SortedTreeSnapshot.root)) :named ax_338))
   (assert (! (not (= SortedTreeNode.right SortedTree.root)) :named ax_339))
   (assert (! (not (= SortedTreeNode.right SortedTreeNode.left)) :named ax_340))
   (assert (! (not (= SortedTreeNode.right SortedTreeSnapshot.root)) :named ax_341))
   (assert (! (not (= SortedTreeNode.shared rdheld)) :named ax_342))
   (assert (! (not (= SortedTreeNode.valid SortedTree.valid)) :named ax_343))
   (assert (! (not (= SortedTreeNode.valid SortedTreeSnapshot.valid)) :named ax_344))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTree.keys)) :named ax_345))
   (assert (! (not (= SortedTreeSnapshot.keys SortedTreeNode.keys)) :named ax_346))
   (assert (! (not (= SortedTreeSnapshot.root SortedTree.root)) :named ax_347))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.left)) :named ax_348))
   (assert (! (not (= SortedTreeSnapshot.root SortedTreeNode.right)) :named ax_349))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTree.valid)) :named ax_350))
   (assert (! (not (= SortedTreeSnapshot.valid SortedTreeNode.valid)) :named ax_351))
   (assert (! (not (= SortedTreeSnapshot@t SortedTreeNode@t)) :named ax_352))
   ...
   (assert (! (or (= SortedTreeNode@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@0 this SortedTreeSnapshot.root))) (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@0 this SortedTreeSnapshot.root))) :named ax_358))
   (assert (! (or (= SortedTreeNode@t (dtype treeRoot@10)) (= null treeRoot@10)) :named ax_359))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTree.valid) :named ax_360))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeNode.valid) :named ax_361))
   (assert (! (PredicateField$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ SortedTreeSnapshot.valid) :named ax_362))
   (assert (! (wf Heap Mask) :named ax_363))
   (assert (! (wf Heap@0 Mask@0) :named ax_364))
   (assert (! (wf Heap@0 ZeroMask) :named ax_365))
   (assert (! (wf Heap@1 Mask@0) :named ax_366))
   (assert (! (wf Heap@1 Mask@1) :named ax_367))
   (assert (! (wf inhaleHeap@_157@0 Mask@0) :named ax_368))
   (assert (! (wf inhaleHeap@_157@0 Mask@1) :named ax_369))
...
(assert (! (=> anon44@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@5 this SortedTreeSnapshot.root) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@5 this SortedTreeSnapshot.root) perm$R))))
...
(assert (! (=> anon44@4 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_166@0 this SortedTreeSnapshot.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_166@0 this SortedTreeSnapshot.keys) perm$R))))
...
(assert (! (=> anon19@4 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_159@0 this SortedTreeSnapshot.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_159@0 this SortedTreeSnapshot.keys) perm$R))))
...
(assert (! (=> anon85_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_166@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTreeSnapshot.root) SortedTreeNode.valid) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_166@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTreeSnapshot.root) SortedTreeNode.valid) perm$R))))
...
(assert (! (=> anon86_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_166@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTreeSnapshot.root) SortedTreeNode.keys) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_166@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@8 this SortedTreeSnapshot.root) SortedTreeNode.keys) perm$R))))
...
(assert (! (=> anon77_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_159@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTreeSnapshot.root) SortedTreeNode.valid) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ exhaleMask@_159@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTreeSnapshot.root) SortedTreeNode.valid) perm$R))))
...
(assert (! (=> anon78_Then@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_159@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTreeSnapshot.root) SortedTreeNode.keys) perm$N) 0)) (not (= (Fractions 1) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_159@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@7 this SortedTreeSnapshot.root) SortedTreeNode.keys) perm$R))))
...
(assert (! (=> anon63@2 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this SortedTreeSnapshot.valid) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ Mask@8 this SortedTreeSnapshot.valid) perm$R))))
...
(assert (! (=> anon63@4 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_172@0 this SortedTreeSnapshot.keys) perm$N) 0)) (not (= (Fractions 50) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_172@0 this SortedTreeSnapshot.keys) perm$R))))
