...
(let ((anon77_Then_assertion (and
    (> (Fractions 1) 0)
)))
(let ((anon78_Then_assertion (and
    (> (Fractions 1) 0)
)))
(let ((anon85_Then_assertion (and
    (> (Fractions 1) 0)
)))
...
(let ((anon72_Else_assertion (and
    (CanWrite$Seq$Int$$ Mask@5 this SortedTreeSnapshot.keys)
)))
(let ((anon72_Then@2_assertion (and
    (=> true (CanRead$ref$ Mask@5 this SortedTreeSnapshot.root))
)))
(let ((anon72_Then@4_assertion (and
...
(let ((anon77_Then@1_assertion (and
...
(let ((anon85_Then@1_assertion (and
...
(let ((anon72_Else@1_assertion (and
    (not (= this null))
)))
(let ((anon72_Then@1_assertion (and
    (=> true (not (= this null)))
)))
(let ((anon72_Then@3_assertion (and
    (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@6 this SortedTreeSnapshot.root) null)))
)))
(let ((anon72_Then@5_assertion (and
    (not (= this null))
)))
...
(let ((anon77_Then@1 (=> (and true
    (> (Fractions 1) 0)
  )(and 
    anon77_Then@1_assertion
    anon77_Then@2
))))
(let ((anon85_Then@1 (=> (and true
    (> (Fractions 1) 0)
  )(and 
...
(let ((anon72_Then@6 (=> (and true
    (not (= this null))
  )
    (and anon73_Else anon73_Then)
)))
(let ((anon72_Else@2 (=> (and true
    (not (= this null))
  )
    (and anon81_Else anon81_Then)
)))
(let ((anon72_Then@5 (=> (and true
...
(let ((anon72_Then@3 (=> (and true
    (=> true (CanRead$ref$ Mask@5 this SortedTreeSnapshot.root))
  )(and 
    anon72_Then@3_assertion
    anon72_Then@4
))))
(let ((anon72_Then@2 (=> (and true
    (=> true (not (= this null)))
  )(and 
