...
;Program
(assert (not
(let ((anon53_Then@8_assertion (and
    (> (Fractions 100) 0)
)))
...
(let ((anon53_Then@1_assertion (and
    (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
)))
(let ((anon53_Then@4_assertion (and
    (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
)))
...
(let ((anon53_Then@2_assertion (and
    (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null))
)))
(let ((anon53_Then@3_assertion (and
    (=> true (not (= this null)))
)))
(let ((anon53_Then@5_assertion (and
    (=> true (not (= this null)))
)))
(let ((anon53_Then@7_assertion (and
...
(let ((anon53_Then@9 (=> (and true
    (> (Fractions 100) 0)
  )(and 
    anon53_Then@9_assertion
    anon53_Then@10
))))
(let ((anon53_Then@8 (=> (and true
    (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null)))
    (wf Heap Mask@3 ZeroMask)
  )(and 
...
(let ((anon53_Then@6 (=> (and true
    (=> true (not (= this null)))
  )(and 
    anon53_Then@6_assertion
    anon53_Then@7
))))
(let ((anon53_Then@5 (=> (and true
...
(let ((anon53_Then@4 (=> (and true
    (=> true (not (= this null)))
  )(and 
    anon53_Then@4_assertion
    anon53_Then@5
))))
(let ((anon53_Then@3 (=> (and true
    (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null))
  )(and 
    anon53_Then@3_assertion
    anon53_Then@4
))))
(let ((anon53_Then@2 (=> (and true
    (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
  )(and 
