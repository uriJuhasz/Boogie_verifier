...
anon61_Then:
	...
	assume $_$_condition_$1 <==> (!CanRead(unfoldingMask#_103_$_0,ZeroMask,Heap[this,Node.prev],Node.invLeft));
...
anon62_Then:
	...
	assume $_$_condition_$2 <==> (!(unfoldingHeap#_102_$_1[unfoldingHeap#_102_$_1[this,Node.prev],Node.prev] == null));
...
anon70_Then:
	...
	assume $_$_condition_$4 <==> (!(unfoldingHeap#_102_$_1[predRec#_119_$_0,Node.prev] == null));
