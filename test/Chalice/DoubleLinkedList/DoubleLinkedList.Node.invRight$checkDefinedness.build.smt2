...
;Axioms
   ...
   (assert (! (not (= (Fractions 1) (* 1000 predicateK@_134))) :named ax_167))
   ...
   (assert (! (not (= predicateK@_134 0)) :named ax_202))
...
(let ((anon62_Then (=> (and true
    ...
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_138@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.next) Node.next) Node.invRight) predVer@_156@0)
    ...
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 predRec@_155@0 Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 predRec@_155@0 Node.next) null))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 predRec@_155@0 Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 predRec@_155@0 Node.prev) null))
...
(let ((anon17 (=> (and true
    ...
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 this Node.next) Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 this Node.next) Node.next) null))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 this Node.next) Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_138@1 this Node.next) Node.prev) null))
