...
;Axioms
   ...
   (assert (! (not (= (Fractions 1) (* 1000 predicateK@_98))) :named ax_165))
   ...
   (assert (! (not (= predicateK@_98 0)) :named ax_200))
...
(assert (! (=> anon53_Then@10 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$R))))
   )
