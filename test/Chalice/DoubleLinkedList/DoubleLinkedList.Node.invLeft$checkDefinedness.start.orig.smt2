...
(declare-fun anon53_Then@1_assertion ( ) Bool)
(declare-fun anon53_Then@10 ( ) Bool)
(declare-fun anon53_Then@2 ( ) Bool)
(declare-fun anon53_Then@2_assertion ( ) Bool)
(declare-fun anon53_Then@3 ( ) Bool)
(declare-fun anon53_Then@3_assertion ( ) Bool)
(declare-fun anon53_Then@4 ( ) Bool)
(declare-fun anon53_Then@4_assertion ( ) Bool)
(declare-fun anon53_Then@5 ( ) Bool)
(declare-fun anon53_Then@5_assertion ( ) Bool)
(declare-fun anon53_Then@6 ( ) Bool)
(declare-fun anon53_Then@6_assertion ( ) Bool)
(declare-fun anon53_Then@7 ( ) Bool)
(declare-fun anon53_Then@7_assertion ( ) Bool)
(declare-fun anon53_Then@8 ( ) Bool)
(declare-fun anon53_Then@8_assertion ( ) Bool)
(declare-fun anon53_Then@9 ( ) Bool)
...
(assert (! (=> anon0 (and true 
   (and true
      (< (* 1000 predicateK@_98) (Fractions 1))
      (< 0 predicateK@_98)
...
(or anon53_Then@1_assertion anon53_Then@2)
...
(assert (! (=> anon53_Then@1_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
   )
))) :named ax_anon53_Then@1_assertion))
(assert (! (=> anon53_Then@2 (and true 
   (and true
      (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
   )
(or anon53_Then@2_assertion anon53_Then@3)
)) :named ax_anon53_Then@2))
(assert (! (=> anon53_Then@2_assertion (not (and true
   (and true
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null))
   )
))) :named ax_anon53_Then@2_assertion))
(assert (! (=> anon53_Then@3 (and true 
   (and true
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null))
   )
(or anon53_Then@3_assertion anon53_Then@4)
)) :named ax_anon53_Then@3))
(assert (! (=> anon53_Then@3_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon53_Then@3_assertion))
(assert (! (=> anon53_Then@4 (and true 
   (and true
      (=> true (not (= this null)))
   )
(or anon53_Then@4_assertion anon53_Then@5)
)) :named ax_anon53_Then@4))
(assert (! (=> anon53_Then@4_assertion (not (and true
   (and true
      (=> true (CanRead$ref$ Mask@2 ZeroMask this Node.prev))
   )
))) :named ax_anon53_Then@4_assertion))
(assert (! (=> anon53_Then@5 (and true 
   (and true
...
(or anon53_Then@5_assertion anon53_Then@6)
)) :named ax_anon53_Then@5))
(assert (! (=> anon53_Then@5_assertion (not (and true
   (and true
      (=> true (not (= this null)))
   )
))) :named ax_anon53_Then@5_assertion))
(assert (! (=> anon53_Then@6 (and true 
   (and true
      (=> true (not (= this null)))
   )
(or anon53_Then@6_assertion anon53_Then@7)
)) :named ax_anon53_Then@6))
...
(or anon53_Then@7_assertion anon53_Then@8)
)) :named ax_anon53_Then@7))
(assert (! (=> anon53_Then@7_assertion (not (and true
   (and true
      (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null)))
   )
))) :named ax_anon53_Then@7_assertion))
(assert (! (=> anon53_Then@8 (and true 
   (and true
      (=> true (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null)))
      (wf Heap Mask@3 ZeroMask)
   )
(or anon53_Then@8_assertion anon53_Then@9)
)) :named ax_anon53_Then@8))
(assert (! (=> anon53_Then@8_assertion (not (and true
   (and true
      (> (Fractions 100) 0)
   )
))) :named ax_anon53_Then@8_assertion))
(assert (! (=> anon53_Then@9 (and true 
   (and true
      (> (Fractions 100) 0)
   )
(or anon53_Then@10 anon53_Then@9_assertion)
)) :named ax_anon53_Then@9))
...
(assert (=> false (not (and
   ...
   anon51@5_assertion
   anon51_assertion
   anon53_Then@1_assertion
   anon53_Then@2_assertion
   anon53_Then@3_assertion
   anon53_Then@4_assertion
   anon53_Then@5_assertion
   anon53_Then@6_assertion
   anon53_Then@7_assertion
   anon53_Then@8_assertion
