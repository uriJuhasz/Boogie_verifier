...
var predRec#_135_$_0 : ref;
var predVer#_136_$_0 : int;
var unfoldingK#_143 : int;
var unfoldingMask#_139_$_0 : MaskType;
var unfoldingHeap#_138_$_1 : HeapType;
var unfoldingMask#_139_$_1 : MaskType;
var unfoldingMask#_139_$_2 : MaskType;
var unfoldingMask#_139_$_3 : MaskType;
var unfoldingMask#_139_$_5 : MaskType;
var unfoldingSecMask#_140_$_5 : MaskType;
var SecMask_$_0 : MaskType;
var SecMask_$_1 : MaskType;
var SecMask_$_2 : MaskType;
var SecMask_$_4 : MaskType;
var SecMask_$_3 : MaskType;
var unfoldingMask#_139_$_4 : MaskType;
var predRec#_155_$_0 : ref;
var predVer#_156_$_0 : int;
var unfoldingSecMask#_140_$_0 : MaskType;
var unfoldingSecMask#_140_$_1 : MaskType;
var unfoldingSecMask#_140_$_2 : MaskType;
var unfoldingSecMask#_140_$_4 : MaskType;
var unfoldingSecMask#_140_$_3 : MaskType;
var oldVers#_153_$_0 : int;
var unfoldingHeap#_138_$_0 : HeapType;
var newVers#_154_$_0 : int;
...
procedure Node.invRight$checkDefinedness (this : ref)
{
	var predicateK#_134 : int;
	var unfoldingK#_143 : int;
	var Mask_$_0 : MaskType;
...
anon0:
	...
	assert { :msg "  27.10: Location might not be readable." } true ==> CanRead(Mask_$_2,ZeroMask,this,Node.next);
	if ($_$_condition) { goto anon53_Then; } else { goto anon53_Else; }
anon53_Then:
	assume $_$_condition;
	assume $_$_condition <==> (!(Heap[this,Node.next] == null));
	assume !(Heap[this,Node.next] == null);
	assert { :msg "  27.25: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  27.25: Location might not be readable." } true ==> CanRead(Mask_$_2,ZeroMask,this,Node.next);
	...
	assume Mask_$_3 == Mask_$_2[Heap[this,Node.next],Node.invRight := Mask_$_2[Heap[this,Node.next],Node.invRight][perm$R := Mask_$_2[Heap[this,Node.next],Node.invRight][perm$R] + Fractions(100)]];
	...
	assume wf(Heap,Mask_$_3,ZeroMask);
	assume predRec#_135_$_0 == Heap[this,Node.next];
	assume #Node.invRight#trigger(Heap[this,Node.next]);
	assume predVer#_136_$_0 == Heap[Heap[this,Node.next],Node.invRight];
	assume (0 < unfoldingK#_143) && ((1000 * unfoldingK#_143) < Fractions(1));
	assert { :msg "  27.52: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  27.52: Location might not be readable." } true ==> CanRead(Mask_$_3,ZeroMask,this,Node.next);
	...
	assert { :msg "  27.42: Unfolding might fail. Insufficient fraction at 27.52 for Node.invRight." } (Fractions(100) <= Mask_$_3[Heap[this,Node.next],Node.invRight][perm$R]) && ((Fractions(100) == Mask_$_3[Heap[this,Node.next],Node.invRight][perm$R]) ==> (0 <= Mask_$_3[Heap[this,Node.next],Node.invRight][perm$N]));
	assume unfoldingMask#_139_$_0 == Mask_$_3[Heap[this,Node.next],Node.invRight := Mask_$_3[Heap[this,Node.next],Node.invRight][perm$R := Mask_$_3[Heap[this,Node.next],Node.invRight][perm$R] - Fractions(100)]];
...
anon52:
	...
	assert { :msg "  25.5: SMOKE-TEST-53. (Predicate Node.invRight is equivalent to false.)" } !(1 == 1);
	goto $exit;
anon61_Then:
	assume $_$_condition_$1;
	assume $_$_condition_$1 <==> (!CanRead(unfoldingMask#_139_$_0,ZeroMask,Heap[this,Node.next],Node.invRight));
	assume !CanRead(unfoldingMask#_139_$_0,ZeroMask,Heap[this,Node.next],Node.invRight);
	assume oldVers#_153_$_0 == Heap[Heap[this,Node.next],Node.invRight];
	assume unfoldingHeap#_138_$_0 == Heap[Heap[this,Node.next],Node.invRight := newVers#_154_$_0];
	assume oldVers#_153_$_0 < unfoldingHeap#_138_$_0[unfoldingHeap#_138_$_0[this,Node.next],Node.invRight];
	assume unfoldingHeap#_138_$_1 == unfoldingHeap#_138_$_0;
	goto anon17;
anon61_Else:
	assume !$_$_condition_$1;
	assume $_$_condition_$1 <==> (!CanRead(unfoldingMask#_139_$_0,ZeroMask,Heap[this,Node.next],Node.invRight));
	assume CanRead(unfoldingMask#_139_$_0,ZeroMask,Heap[this,Node.next],Node.invRight);
	assume unfoldingHeap#_138_$_1 == Heap;
	goto anon17;
anon17:
	assume IsGoodMask(unfoldingMask#_139_$_0);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_0,ZeroMask);
	assume IsGoodMask(unfoldingMask#_139_$_0);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_0,ZeroMask);
	assume !(unfoldingHeap#_138_$_1[this,Node.next] == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_0,ZeroMask);
	assume (unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.prev] == null) || (dtype(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.prev]) == Node#t);
	assume 1 > 0;
	assume unfoldingMask#_139_$_1 == unfoldingMask#_139_$_0[unfoldingHeap#_138_$_1[this,Node.next],Node.prev := unfoldingMask#_139_$_0[unfoldingHeap#_138_$_1[this,Node.next],Node.prev][perm$N := unfoldingMask#_139_$_0[unfoldingHeap#_138_$_1[this,Node.next],Node.prev][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_1,ZeroMask);
	assume IsGoodMask(unfoldingMask#_139_$_1);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.prev]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_1,ZeroMask);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_1,ZeroMask);
	assume !(unfoldingHeap#_138_$_1[this,Node.next] == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_1,ZeroMask);
	assume (unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null) || (dtype(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next]) == Node#t);
	assume 1 > 0;
	assume unfoldingMask#_139_$_2 == unfoldingMask#_139_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next := unfoldingMask#_139_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next][perm$N := unfoldingMask#_139_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_2,ZeroMask);
	assume IsGoodMask(unfoldingMask#_139_$_2);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_2,ZeroMask);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_2,ZeroMask);
	assume !(unfoldingHeap#_138_$_1[this,Node.next] == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_2,ZeroMask);
	assume true;
	assume 1 > 0;
	assume unfoldingMask#_139_$_3 == unfoldingMask#_139_$_2[unfoldingHeap#_138_$_1[this,Node.next],mu := unfoldingMask#_139_$_2[unfoldingHeap#_138_$_1[this,Node.next],mu][perm$N := unfoldingMask#_139_$_2[unfoldingHeap#_138_$_1[this,Node.next],mu][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_3,ZeroMask);
	assume IsGoodMask(unfoldingMask#_139_$_3);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],mu]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_3,ZeroMask);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_3,ZeroMask);
	if ($_$_condition_$2) { goto anon62_Then; } else { goto anon62_Else; }
anon62_Then:
	assume $_$_condition_$2;
	assume $_$_condition_$2 <==> (!(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null));
	assume !(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null);
	assume !(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_3,ZeroMask);
	assume Fractions(100) > 0;
	assume unfoldingMask#_139_$_4 == unfoldingMask#_139_$_3[unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next],Node.invRight := unfoldingMask#_139_$_3[unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next],Node.invRight][perm$R := unfoldingMask#_139_$_3[unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next],Node.invRight][perm$R] + Fractions(100)]];
	assume IsGoodMask(unfoldingMask#_139_$_4);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next],Node.invRight]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,ZeroMask);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,ZeroMask);
	assume predRec#_155_$_0 == Heap[Heap[this,Node.next],Node.next];
	assume #Node.invRight#trigger(Heap[Heap[this,Node.next],Node.next]);
	assume predVer#_156_$_0 == unfoldingHeap#_138_$_1[Heap[Heap[this,Node.next],Node.next],Node.invRight];
	if ($_$_condition_$3) { goto anon63_Then; } else { goto anon63_Else; }
anon62_Else:
	assume !$_$_condition_$2;
	assume $_$_condition_$2 <==> (!(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null));
	assume unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next] == null;
	assume unfoldingMask#_139_$_5 == unfoldingMask#_139_$_3;
	assume unfoldingSecMask#_140_$_5 == ZeroMask;
	goto anon35;
anon63_Then:
...
anon63_Else:
	...
	assume $_$_condition_$3 <==> false;
	assume !false;
	assume !(predRec#_155_$_0 == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,ZeroMask);
	assume (unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.prev] == null) || (dtype(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.prev]) == Node#t);
	assume 1 > 0;
	assume unfoldingSecMask#_140_$_0 == ZeroMask[predRec#_155_$_0,Node.prev := ZeroMask[predRec#_155_$_0,Node.prev][perm$N := ZeroMask[predRec#_155_$_0,Node.prev][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingSecMask#_140_$_0,unfoldingSecMask#_140_$_0);
	assume IsGoodMask(unfoldingMask#_139_$_4);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.prev]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_0);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_0);
	assume !(predRec#_155_$_0 == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_0);
	assume (unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null) || (dtype(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next]) == Node#t);
	assume 1 > 0;
	assume unfoldingSecMask#_140_$_1 == unfoldingSecMask#_140_$_0[predRec#_155_$_0,Node.next := unfoldingSecMask#_140_$_0[predRec#_155_$_0,Node.next][perm$N := unfoldingSecMask#_140_$_0[predRec#_155_$_0,Node.next][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingSecMask#_140_$_1,unfoldingSecMask#_140_$_1);
	assume IsGoodMask(unfoldingMask#_139_$_4);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_1);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_1);
	assume !(predRec#_155_$_0 == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_1);
	assume true;
	assume 1 > 0;
	assume unfoldingSecMask#_140_$_2 == unfoldingSecMask#_140_$_1[predRec#_155_$_0,mu := unfoldingSecMask#_140_$_1[predRec#_155_$_0,mu][perm$N := unfoldingSecMask#_140_$_1[predRec#_155_$_0,mu][perm$N] + 1]];
	assume wf(unfoldingHeap#_138_$_1,unfoldingSecMask#_140_$_2,unfoldingSecMask#_140_$_2);
	assume IsGoodMask(unfoldingMask#_139_$_4);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[predRec#_155_$_0,mu]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_2);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_2);
	if ($_$_condition_$4) { goto anon70_Then; } else { goto anon70_Else; }
anon35:
	assume IsGoodMask(unfoldingMask#_139_$_5);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_5,unfoldingSecMask#_140_$_5);
	if ($_$_condition_$5) { goto anon71_Then; } else { goto anon71_Else; }
anon70_Then:
	assume $_$_condition_$4;
	assume $_$_condition_$4 <==> (!(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null));
	assume !(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null);
	assume !(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_2);
	assume Fractions(100) > 0;
	assume unfoldingSecMask#_140_$_3 == unfoldingSecMask#_140_$_2[unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next],Node.invRight := unfoldingSecMask#_140_$_2[unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next],Node.invRight][perm$R := unfoldingSecMask#_140_$_2[unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next],Node.invRight][perm$R] + Fractions(100)]];
	assume IsGoodMask(unfoldingMask#_139_$_4);
	assume IsGoodState(heapFragment(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next],Node.invRight]));
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_3);
	assume wf(unfoldingHeap#_138_$_1,unfoldingMask#_139_$_4,unfoldingSecMask#_140_$_3);
	assume unfoldingSecMask#_140_$_4 == unfoldingSecMask#_140_$_3;
	goto anon34;
anon70_Else:
	assume !$_$_condition_$4;
	assume $_$_condition_$4 <==> (!(unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null));
	assume unfoldingHeap#_138_$_1[predRec#_155_$_0,Node.next] == null;
	assume unfoldingSecMask#_140_$_4 == unfoldingSecMask#_140_$_2;
	goto anon34;
anon34:
	assume MuBelow(unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],mu],unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[unfoldingHeap#_138_$_1[this,Node.next],Node.next],mu]);
	assume unfoldingMask#_139_$_5 == unfoldingMask#_139_$_4;
	assume unfoldingSecMask#_140_$_5 == unfoldingSecMask#_140_$_4;
	goto anon35;
anon71_Then:
...
anon71_Else:
	...
	assume 1 > 0;
	assume SecMask_$_0 == ZeroMask[Heap[this,Node.next],Node.prev := ZeroMask[Heap[this,Node.next],Node.prev][perm$N := ZeroMask[Heap[this,Node.next],Node.prev][perm$N] + 1]];
	...
	assume 1 > 0;
	assume SecMask_$_1 == SecMask_$_0[Heap[this,Node.next],Node.next := SecMask_$_0[Heap[this,Node.next],Node.next][perm$N := SecMask_$_0[Heap[this,Node.next],Node.next][perm$N] + 1]];
	...
	assume true;
	assume 1 > 0;
	assume SecMask_$_2 == SecMask_$_1[Heap[this,Node.next],mu := SecMask_$_1[Heap[this,Node.next],mu][perm$N := SecMask_$_1[Heap[this,Node.next],mu][perm$N] + 1]];
...
anon78_Then:
	...
	assume $_$_condition_$6 <==> (!(Heap[Heap[this,Node.next],Node.next] == null));
	assume !(Heap[Heap[this,Node.next],Node.next] == null);
	assume !(Heap[Heap[this,Node.next],Node.next] == null);
	assume wf(Heap,Mask_$_3,SecMask_$_2);
	assume Fractions(100) > 0;
	assume SecMask_$_3 == SecMask_$_2[Heap[Heap[this,Node.next],Node.next],Node.invRight := SecMask_$_2[Heap[Heap[this,Node.next],Node.next],Node.invRight][perm$R := SecMask_$_2[Heap[Heap[this,Node.next],Node.next],Node.invRight][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_3);
...
anon51:
	...
	assert { :msg "  27.69: Location might not be readable." } true ==> CanRead(unfoldingMask#_139_$_5,unfoldingSecMask#_140_$_5,this,mu);
	assert { :msg "  27.80: Receiver might be null." } true ==> (!(this == null));
	assert { :msg "  27.80: Location might not be readable." } true ==> CanRead(unfoldingMask#_139_$_5,unfoldingSecMask#_140_$_5,this,Node.next);
	assert { :msg "  27.80: Receiver might be null." } true ==> (!(unfoldingHeap#_138_$_1[this,Node.next] == null));
	assert { :msg "  27.80: Location might not be readable." } true ==> CanRead(unfoldingMask#_139_$_5,unfoldingSecMask#_140_$_5,unfoldingHeap#_138_$_1[this,Node.next],mu);
