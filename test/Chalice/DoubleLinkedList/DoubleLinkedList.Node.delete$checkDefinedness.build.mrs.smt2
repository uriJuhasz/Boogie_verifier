...
;Axioms
   ...
   (assert (! (= predVer@_172@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this Node.inv)) :named ax_29))
   (assert (! (= true $@bf_12) :named ax_30))
   (assert (! (= true $@bf_13) :named ax_31))
   (assert (! (= true $@bf_16) :named ax_32))
   (assert (! (= true $@bf_18) :named ax_33))
   ...
   (assert (! (not (= this null)) :named ax_200))
   (assert (! (not (= unfoldingK@_179 0)) :named ax_201))
   ...
   (assert (! (wf Heap ZeroMask ZeroMask) :named ax_211))
   (assert (! CanAssumeFunctionDefs :named ax_212))
...
(assert (! (=> anon0@4 (and true 
   (and true
      ...
      (not (= 0 (Fractions 100)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this Node.inv) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this Node.inv) perm$R))))
   )
...
(assert (! (=> anon292_Then@5 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_175@7 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_174@1 this Node.prev) Node.invLeft) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_175@7 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_174@1 this Node.prev) Node.invLeft) perm$R))))
   )
...
(assert (! (=> anon318_Then@7 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_218@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_217@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_217@1 this Node.prev) Node.prev) Node.invLeft) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_218@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_217@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_217@1 this Node.prev) Node.prev) Node.invLeft) perm$R))))
   )
...
(assert (! (=> anon187 (and true 
   (and true
      ...
      (or (< 0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap $@sk_10 held)) (< (MapRead$$@Map@@ref@To@Int@@$ Credits $@sk_10) 0) (= true $@bf_25) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap $@sk_10 rdheld))
      (or (< 0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap $@sk_8 held)) (< (MapRead$$@Map@@ref@To@Int@@$ Credits $@sk_8) 0) (= true $@bf_23) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap $@sk_8 rdheld))
      (or (< 0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap $@sk_9 held)) (< (MapRead$$@Map@@ref@To@Int@@$ Credits $@sk_9) 0) (= true $@bf_24) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ Heap $@sk_9 rdheld))
      (or (= true $@bf_20) (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev)))
      (or (= true $@bf_22) (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev)))
      (or (not (= true $@bf_20)) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev))))
      (or (not (= true $@bf_21)) (ite$Bool$ $@bf_22 $@bf_23 $@bf_24))
      (or (not (= true $@bf_22)) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev))))
      (or (not (ite$Bool$ $@bf_22 $@bf_23 $@bf_24)) (= true $@bf_21))
      (or (not (MuBelow (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap $@sk_10 mu) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap this mu))) (= true $@bf_25))
      (or (not (MuBelow (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap $@sk_8 mu) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev) mu))) (= true $@bf_23))
      (or (not (MuBelow (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap $@sk_9 mu) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) mu))) (= true $@bf_24))
...
(assert (! (=> anon189@3 (and true 
   (and true
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask this Node.inv) perm$N) 0)) (not (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask this Node.inv) perm$R))))
   )
