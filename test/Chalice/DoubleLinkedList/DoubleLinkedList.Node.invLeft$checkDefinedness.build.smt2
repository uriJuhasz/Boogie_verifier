...
(declare-fun newVers@_118@0 ( ) Int)
...
(declare-fun oldVers@_117@0 ( ) Int)
...
(declare-fun predicateK@_98 ( ) Int)
(declare-fun predRec@_119@0 ( ) ref)
(declare-fun predRec@_99@0 ( ) ref)
(declare-fun predVer@_100@0 ( ) Int)
(declare-fun predVer@_120@0 ( ) Int)
...
(declare-fun unfoldingHeap@_102@0 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$T0@@)
(declare-fun unfoldingHeap@_102@1 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$T0@@)
(declare-fun unfoldingK@_107 ( ) Int)
(declare-fun unfoldingMask@_103@0 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingMask@_103@1 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingMask@_103@2 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingMask@_103@3 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingMask@_103@4 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingMask@_103@5 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@0 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@1 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@2 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@3 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@4 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
(declare-fun unfoldingSecMask@_104@5 ( ) $@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@)
...
;Axioms
   ...
   (assert (! (= Node@t (dtype this)) :named ax_26))
   ...
   (assert (! (= true $@bf_12) :named ax_29))
   (assert (! (= true $@bf_13) :named ax_30))
   (assert (! (= true $@bf_16) :named ax_31))
   (assert (! (= true $@bf_18) :named ax_32))
   ...
   (assert (! (not (= predicateK@_98 0)) :named ax_202))
   (assert (! (not (= this null)) :named ax_203))
   ...
   (assert (! (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.next) null)) :named ax_208))
   (assert (! (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) null)) :named ax_209))
   (assert (! (PredicateField$Int$ Node.inv) :named ax_210))
   (assert (! (PredicateField$Int$ Node.invLeft) :named ax_211))
   (assert (! (PredicateField$Int$ Node.invRight) :named ax_212))
   (assert (! (wf Heap Mask SecMask) :named ax_213))
   (assert (! (wf Heap Mask@0 ZeroMask) :named ax_214))
   (assert (! (wf Heap Mask@1 ZeroMask) :named ax_215))
   (assert (! (wf Heap Mask@2 ZeroMask) :named ax_216))
   (assert (! (wf Heap ZeroMask ZeroMask) :named ax_217))
   (assert (! true :named ax_218))
...
(let ((anon51@1_assertion (and
    (=> true (CanRead$ref$ unfoldingMask@_103@5 unfoldingSecMask@_104@5 this Node.prev))
)))
(let ((anon51@3_assertion (and
    (=> true (CanRead$Mu$ unfoldingMask@_103@5 unfoldingSecMask@_104@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu))
)))
(let ((anon51@5_assertion (and
    (=> true (CanRead$Mu$ unfoldingMask@_103@5 unfoldingSecMask@_104@5 this mu))
)))
(let ((anon53_Then@6_assertion (and
    (=> true (CanRead$ref$ Mask@3 ZeroMask this Node.prev))
)))
(let ((anon53_Then@9_assertion (and
...
(let ((anon51@4 (=> (and true
    (CanRead$Mu$ unfoldingMask@_103@5 unfoldingSecMask@_104@5 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu)
  )
    anon51@5_assertion
)))
(let ((anon51@2 (=> (and true
    (CanRead$ref$ unfoldingMask@_103@5 unfoldingSecMask@_104@5 this Node.prev)
  )(and 
    anon51@3_assertion
    anon51@4
))))
...
(let ((anon78_Else (=> (and true
    (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev))
    (= SecMask@2 SecMask@4)
    (not $@condition_$6)
...
(let ((anon78_Then (=> (and true
    ...
    (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev)))
...
(let ((anon35 (=> (and true
    ...
    (IsGoodMask unfoldingMask@_103@5)
    ...
    (not $@condition_$5)
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.next) null))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev) null))
    ...
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@5 unfoldingSecMask@_104@5)
  )
    (and anon78_Else anon78_Then)
)))
(let ((anon34 (=> (and true
    (= unfoldingMask@_103@4 unfoldingMask@_103@5)
    (= unfoldingSecMask@_104@4 unfoldingSecMask@_104@5)
    (MuBelow (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) mu) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu))
  )
    anon35
)))
(let ((anon62_Else (=> (and true
    (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev))
    (= unfoldingMask@_103@3 unfoldingMask@_103@5)
    (= unfoldingSecMask@_104@5 ZeroMask)
    (not $@condition_$2)
    (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) null))
  )
    anon35
)))
(let ((anon70_Else (=> (and true
    (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev))
    (= unfoldingSecMask@_104@2 unfoldingSecMask@_104@4)
    (not $@condition_$4)
    (not (= predRec@_119@0 null))
  )
    anon34
)))
(let ((anon70_Then (=> (and true
    $@condition_$4
    (= unfoldingSecMask@_104@3 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingSecMask@_104@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev) Node.invLeft (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingSecMask@_104@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev) Node.invLeft) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingSecMask@_104@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev) Node.invLeft) perm$R) (Fractions 100)))))
    (= unfoldingSecMask@_104@3 unfoldingSecMask@_104@4)
    (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev) Node.invLeft)))
    (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev)))
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@4 unfoldingSecMask@_104@3)
  )
    anon34
)))
(let ((anon62_Then (=> (and true
    $@condition_$2
    ($@Node.invLeft@trigger predRec@_119@0)
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev) Node.invLeft) predVer@_120@0)
    (= predRec@_119@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.prev))
    (= unfoldingMask@_103@4 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_103@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) Node.invLeft (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_103@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) Node.invLeft) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ unfoldingMask@_103@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) Node.invLeft) perm$R) (Fractions 100)))))
    (= unfoldingSecMask@_104@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask predRec@_119@0 Node.prev (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask predRec@_119@0 Node.prev) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask predRec@_119@0 Node.prev) perm$N) 1))))
    (= unfoldingSecMask@_104@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingSecMask@_104@0 predRec@_119@0 Node.next (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingSecMask@_104@0 predRec@_119@0 Node.next) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingSecMask@_104@0 predRec@_119@0 Node.next) perm$N) 1))))
    (= unfoldingSecMask@_104@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingSecMask@_104@1 predRec@_119@0 mu (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingSecMask@_104@1 predRec@_119@0 mu) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingSecMask@_104@1 predRec@_119@0 mu) perm$N) 1))))
    (IsGoodMask unfoldingMask@_103@4)
    (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) Node.invLeft)))
    (IsGoodState (heapFragment$Mu$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ unfoldingHeap@_102@1 predRec@_119@0 mu)))
    (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.next)))
    (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev)))
    (not $@condition_$3)
    (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev)))
    (not (= null predRec@_119@0))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.next) null))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 predRec@_119@0 Node.prev) null))
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@4 unfoldingSecMask@_104@0)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@4 unfoldingSecMask@_104@1)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@4 unfoldingSecMask@_104@2)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@4 ZeroMask)
    (wf unfoldingHeap@_102@1 unfoldingSecMask@_104@0 unfoldingSecMask@_104@0)
    (wf unfoldingHeap@_102@1 unfoldingSecMask@_104@1 unfoldingSecMask@_104@1)
    (wf unfoldingHeap@_102@1 unfoldingSecMask@_104@2 unfoldingSecMask@_104@2)
  )
    (and anon70_Else anon70_Then)
)))
(let ((anon17 (=> (and true
    (= unfoldingMask@_103@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) perm$N) 1))))
    (= unfoldingMask@_103@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ unfoldingMask@_103@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next) perm$N) 1))))
    (= unfoldingMask@_103@3 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingMask@_103@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingMask@_103@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu) perm$N (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ unfoldingMask@_103@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu) perm$N) 1))))
    (IsGoodMask unfoldingMask@_103@0)
    (IsGoodMask unfoldingMask@_103@1)
    (IsGoodMask unfoldingMask@_103@2)
    (IsGoodMask unfoldingMask@_103@3)
    (IsGoodState (heapFragment$Mu$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Mu$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) mu)))
    (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next)))
    (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev)))
    (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev)))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.next) null))
    (or (= Node@t (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@1 this Node.prev) Node.prev) null))
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@0 ZeroMask)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@1 ZeroMask)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@2 ZeroMask)
    (wf unfoldingHeap@_102@1 unfoldingMask@_103@3 ZeroMask)
  )
    (and anon62_Else anon62_Then)
)))
(let ((anon61_Else (=> (and true
    (= Heap unfoldingHeap@_102@1)
    (CanRead$Int$ unfoldingMask@_103@0 ZeroMask (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft)
    (not $@condition_$1)
  )
    anon17
)))
(let ((anon61_Then (=> (and true
    $@condition_$1
    (< oldVers@_117@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_102@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@0 this Node.prev) Node.invLeft))
    (= oldVers@_117@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft))
    (= unfoldingHeap@_102@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft newVers@_118@0))
    (= unfoldingHeap@_102@0 unfoldingHeap@_102@1)
    (not (= oldVers@_117@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ unfoldingHeap@_102@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ unfoldingHeap@_102@0 this Node.prev) Node.invLeft)))
    (not (CanRead$Int$ unfoldingMask@_103@0 ZeroMask (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft))
  )
    anon17
)))
(let ((anon53_Then@10 (=> (and true
    (= unfoldingMask@_103@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$R) (* (- 1) (Fractions 100))))))
    (=> (= (Fractions 100) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$N)))
    (not $@condition_$0)
    (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft) perm$R) (Fractions 100)))
  )
    (and anon61_Else anon61_Then)
)))
(let ((anon53_Then@7 (=> (and true
    (CanRead$ref$ Mask@3 ZeroMask this Node.prev)
  )(and 
...
(let ((anon0@2 (=> (and true
    ...
    (< (* 1000 unfoldingK@_107) (Fractions 1))
    (< 0 (Fractions 100))
    (< 0 unfoldingK@_107)
    ...
    (= predRec@_99@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev))
    (= predVer@_100@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this Node.prev) Node.invLeft))
    (CanRead$ref$ Mask@2 ZeroMask this Node.prev)
    (IsGoodMask Mask@3)
    ...
    (not (= (Fractions 1) (* 1000 unfoldingK@_107)))
    (not (= 0 (Fractions 100)))
    (not (= 0 unfoldingK@_107))
