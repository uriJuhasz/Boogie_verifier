...
;Axioms
   ...
   (assert (! (< (* 1000 unfoldingK@_179) (Fractions 1)) :named ax_5))
   (assert (! (< 0 channelK) :named ax_6))
   (assert (! (< 0 methodK@_170) :named ax_7))
   (assert (! (< 0 monitorK) :named ax_8))
   (assert (! (< 0 predicateK) :named ax_9))
   (assert (! (< 0 unfoldingK@_179) :named ax_10))
   (assert (! (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$N) 0) :named ax_11))
   (assert (! (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$R) Permission$FullFraction) :named ax_12))
   ...
   (assert (! (= channelK monitorK) :named ax_15))
   (assert (! (= Mask@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask this Node.inv (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask this Node.inv) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask this Node.inv) perm$R) (Fractions 100))))) :named ax_16))
   (assert (! (= Permission$FullFraction (Fractions 100)) :named ax_17))
   (assert (! (= predicateK channelK) :named ax_18))
   (assert (! (= predVer@_172@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this Node.inv)) :named ax_19))
   (assert (! (=> true (not (= this null))) :named ax_20))
   (assert (! (> (Fractions 100) 0) :named ax_21))
   (assert (! (> (Fractions 100) 0) :named ax_22))
   (assert (! (> Permission$denominator 0) :named ax_23))
