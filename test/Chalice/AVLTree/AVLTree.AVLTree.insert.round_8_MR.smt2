...
;Axioms
   ...
   (assert (! (forall( (|o_$25| ref) (|f_$17| Field$Bool$) (|pc_$0| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ ZeroMask |o_$25| |f_$17|) |pc_$0|) 0)) :named ax_213))
   (assert (! (forall( (|o_$26| ref) (|f_$18| Field$Int$) (|pc_$1| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask |o_$26| |f_$18|) |pc_$1|) 0)) :named ax_214))
   (assert (! (forall( (|o_$27| ref) (|f_$19| Field$ref$) (|pc_$2| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask |o_$27| |f_$19|) |pc_$2|) 0)) :named ax_215))
   (assert (! (forall( (|o_$28| ref) (|f_$20| Field$Mu$) (|pc_$3| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ ZeroMask |o_$28| |f_$20|) |pc_$3|) 0)) :named ax_216))
   (assert (! (forall( (|o_$29| ref) (|f_$21| Field$Seq$Int$$) (|pc_$4| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ ZeroMask |o_$29| |f_$21|) |pc_$4|) 0)) :named ax_217))
   ...
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTree.valid))) :named ax_263))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTree.keys))) :named ax_264))
   (assert (! (IsGoodState emptyPartialHeap) :named ax_265))
   ...
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_37))) :named ax_285))
   ...
   (assert (! (not (= methodK@_37 (* 1000 unfoldK@_38))) :named ax_349))
   (assert (! (not (= methodK@_37 0)) :named ax_350))
   ...
   (assert (! (not (= unfoldK@_38 (Fractions 1))) :named ax_356))
   (assert (! (not (= unfoldK@_38 0)) :named ax_357))
   ...
   (assert (! (or (= null n@2) (= (dtype n@2) AVLTreeNode@t)) :named ax_362))
   (assert (! (or (= r@122 null) (= (dtype r@122) AVLTreeNode@t)) :named ax_363))
   (assert (! (or (= r@75 null) (= (dtype r@75) AVLTreeNode@t)) :named ax_364))
   (assert (! (or (= this@118 null) (= (dtype this@118) AVLTreeNode@t)) :named ax_365))
   (assert (! (or (= this@120 null) (= (dtype this@120) AVLTreeNode@t)) :named ax_366))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_367))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_368))
   (assert (! (wf Heap Mask SecMask) :named ax_369))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_370))
   (assert (! (wf Heap SecMask SecMask) :named ax_371))
   (assert (! CanAssumeFunctionDefs :named ax_372))
...
(let ((anon114_Else@5 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@12 this@120@0 AVLTreeNode.valid) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_75@0 this@120@0 AVLTreeNode.valid) perm$N)))
