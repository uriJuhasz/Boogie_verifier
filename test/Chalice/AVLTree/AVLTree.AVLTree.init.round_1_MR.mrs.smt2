...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@0 this AVLTree.root) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ SecMask this AVLTree.root) perm$R (+ 0 Permission$FullFraction))) :named ax_23))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys) perm$R (+ 0 Permission$FullFraction))) :named ax_24))
   ...
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ SecMask this AVLTree.root) perm$R)) :named ax_28))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys) perm$R)) :named ax_29))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$N)) :named ax_30))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$N)) :named ax_31))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$R)) :named ax_32))
   (assert (! (= 0 (Seq@Length$Int$ Seq@Empty$Int$)) :named ax_33))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_34))
   (assert (! (= channelK monitorK) :named ax_35))
   (assert (! (= channelK predicateK) :named ax_36))
   (assert (! (= false $@bf_26) :named ax_37))
   (assert (! (= false $@bf_27) :named ax_38))
   (assert (! (= false $@bf_29) :named ax_39))
   (assert (! (= false $@bf_31) :named ax_40))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask this AVLTree.keys))) :named ax_41))
   (assert (! (= Mask Mask@1) :named ax_42))
   (assert (! (= Mask@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ SecMask this AVLTree.root (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@0 this AVLTree.root))) :named ax_43))
   (assert (! (= Permission$FullFraction (Fractions 100)) :named ax_44))
   (assert (! (= Permission$FullFraction (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$R)) :named ax_45))
   (assert (! (= SecMask ZeroMask) :named ax_46))
   (assert (! (= true $@bf_24) :named ax_47))
   (assert (! (= true $@bf_25) :named ax_48))
   (assert (! (= true $@bf_28) :named ax_49))
   ...
   (assert (! (forall( (|o_$25| ref) (|f_$16| Field$Bool$) (|pc_$0| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ ZeroMask |o_$25| |f_$16|) |pc_$0|) 0)) :named ax_203))
   (assert (! (forall( (|o_$26| ref) (|f_$17| Field$Int$) (|pc_$1| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask |o_$26| |f_$17|) |pc_$1|) 0)) :named ax_204))
   (assert (! (forall( (|o_$27| ref) (|f_$18| Field$ref$) (|pc_$2| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask |o_$27| |f_$18|) |pc_$2|) 0)) :named ax_205))
   (assert (! (forall( (|o_$28| ref) (|f_$19| Field$Mu$) (|pc_$3| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ ZeroMask |o_$28| |f_$19|) |pc_$3|) 0)) :named ax_206))
   (assert (! (forall( (|o_$29| ref) (|f_$20| Field$Seq$Int$$) (|pc_$4| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ ZeroMask |o_$29| |f_$20|) |pc_$4|) 0)) :named ax_207))
   ...
   (assert (! (IsGoodMask SecMask) :named ax_252))
   (assert (! (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root))) :named ax_253))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTree.keys))) :named ax_254))
   (assert (! (ite$Bool$ false false true) :named ax_255))
   (assert (! (ite$Bool$ false true true) :named ax_256))
   (assert (! (ite$Bool$ true true false) :named ax_257))
   (assert (! (ite$Bool$ true true true) :named ax_258))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_259))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.balanceFactor) :named ax_260))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.height) :named ax_261))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.key) :named ax_262))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_263))
   (assert (! (NonPredicateField$Int$ held) :named ax_264))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_265))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_266))
   (assert (! (NonPredicateField$ref$ AVLTree.root) :named ax_267))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.left) :named ax_268))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.right) :named ax_269))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTree.keys) :named ax_270))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTreeNode.keys) :named ax_271))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_272))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_11))) :named ax_273))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_274))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_275))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_276))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_277))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_278))
   (assert (! (not (= AVLTree.valid held)) :named ax_279))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_280))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_281))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_282))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_283))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_284))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_285))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_286))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_287))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_288))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_289))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_290))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_291))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_292))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_293))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_294))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_295))
   ...
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_298))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_299))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_300))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_301))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_302))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_303))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_304))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_305))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_306))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_307))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_308))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_309))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_310))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_311))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_312))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_313))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_314))
   (assert (! (not (= channelK 0)) :named ax_315))
   ...
   (assert (! (not (= methodK@_11 0)) :named ax_337))
   (assert (! (not (= perm$N perm$R)) :named ax_338))
   (assert (! (not (= perm$R perm$N)) :named ax_339))
   (assert (! (not (= Permission$denominator 0)) :named ax_340))
   (assert (! (not (= Permission$FullFraction 0)) :named ax_341))
   (assert (! (not (= this null)) :named ax_342))
   (assert (! (not (ite$Bool$ false false false)) :named ax_343))
   (assert (! (not (ite$Bool$ false true false)) :named ax_344))
   (assert (! (not (ite$Bool$ true false false)) :named ax_345))
   (assert (! (not (ite$Bool$ true false true)) :named ax_346))
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root)) AVLTreeNode@t)) :named ax_347))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_348))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_349))
   (assert (! (wf Heap Mask SecMask) :named ax_350))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_351))
   (assert (! (wf Heap SecMask SecMask) :named ax_352))
...
(assert (! (=> anon4@2 (and true 
   (and true
      ...
      (= (+ 0 (* 100 Permission$denominator)) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root) perm$R))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ SecMask this AVLTree.root) perm$R (+ 0 (* 100 Permission$denominator))))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ SecMask@0 this AVLTree.keys) perm$R (+ 0 (* 100 Permission$denominator))))
      (= exhaleMask@_17@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root) perm$R (+ (+ 0 (* 100 Permission$denominator)) (* (- 100) Permission$denominator)))))
      ...
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root) perm$N) 0)) (not (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator)))))
...
(assert (! (=> anon4@4 (and true 
   (and true
      ...
      (= (+ 0 (* 100 Permission$denominator)) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$R))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@1 this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$R) (* (- 50) Permission$denominator))))
      ...
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$R) (Fractions 50)))
      (not (= 0 (* 50 Permission$denominator)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$N) 0)) (not (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$R) (Fractions 50))))
...
(assert (! (=> anon14@3 (and true 
   (and true
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ SecMask this AVLTree.keys) perm$R (+ 0 (* 100 Permission$denominator))) perm$R (+ (+ 0 (* 100 Permission$denominator)) (* (- 50) Permission$denominator))))
      ...
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTree.valid) perm$R) (* 100 Permission$denominator)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTree.valid) perm$N) 0)) (not (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTree.valid) perm$R))))
   )
...
(assert (! (=> anon21 (and true 
   (and true
      (= (* 50 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ SecMask@12 this AVLTree.keys) perm$R))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ SecMask@13 this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ SecMask@12 this AVLTree.keys) perm$R (+ (Fractions 50) (* (- 50) Permission$denominator))))
...
(assert (! (=> anon42@2 (and true 
   (and true
      (= (* (- 50) Permission$denominator) (* (- 1) (* 50 Permission$denominator)))
      (= exhaleMask@_25@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) perm$R) (* (- 50) Permission$denominator)))))
      (IsGoodExhaleState exhaleHeap@_24@0 exhaleHeap@_16@0 exhaleMask@_25@1 SecMask@32)
      (IsGoodMask exhaleMask@_25@1)
      (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) perm$R) (* 50 Permission$denominator)))
      (or (not (< (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) perm$N) 0)) (not (= (* 50 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_25@0 this AVLTree.keys) perm$R))))
