...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask this AVLTreeNode.balanceFactor) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@4 this AVLTreeNode.balanceFactor) perm$R Permission$FullFraction)) :named ax_15))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTreeNode.key) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTreeNode.key) perm$R Permission$FullFraction)) :named ax_16))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@1 this AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTreeNode.height) perm$R Permission$FullFraction)) :named ax_17))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@2 this AVLTreeNode.left) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTreeNode.left) perm$R Permission$FullFraction)) :named ax_18))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@3 this AVLTreeNode.right) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@2 this AVLTreeNode.right) perm$R Permission$FullFraction)) :named ax_19))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@4 this AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@3 this AVLTreeNode.keys) perm$R Permission$FullFraction)) :named ax_20))
   ...
   (assert (! (= true $@bf_26) :named ax_50))
   (assert (! (= true $@bf_27) :named ax_51))
   (assert (! (= true $@bf_30) :named ax_52))
   (assert (! (= true $@bf_32) :named ax_53))
   ...
   (assert (! (IsGoodMask Mask@1) :named ax_256))
   (assert (! (IsGoodMask Mask@2) :named ax_257))
   (assert (! (IsGoodMask Mask@3) :named ax_258))
   (assert (! (IsGoodMask Mask@4) :named ax_259))
   ...
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_285))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_224))) :named ax_286))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_287))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_288))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_289))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_290))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_291))
   (assert (! (not (= AVLTree.valid held)) :named ax_292))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_293))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_294))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_295))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_296))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_297))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_298))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_299))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_300))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_301))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_302))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_303))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_304))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_305))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_306))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_307))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_308))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_309))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_310))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_311))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_312))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_313))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_314))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_315))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_316))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_317))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_318))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_319))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_320))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_321))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_322))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_323))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_324))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_325))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_326))
   ...
   (assert (! (not (= methodK@_224 0)) :named ax_349))
   (assert (! (not (= perm$N perm$R)) :named ax_350))
   (assert (! (not (= perm$R perm$N)) :named ax_351))
   (assert (! (not (= Permission$denominator 0)) :named ax_352))
   (assert (! (not (= Permission$FullFraction 0)) :named ax_353))
   ...
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.left) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.left)) AVLTreeNode@t)) :named ax_359))
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.right) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.right)) AVLTreeNode@t)) :named ax_360))
   (assert (! (or (= this@150 null) (= (dtype this@150) AVLTreeNode@t)) :named ax_361))
   ...
   (assert (! (wf Heap Mask@1 SecMask) :named ax_366))
   (assert (! (wf Heap Mask@2 SecMask) :named ax_367))
   (assert (! (wf Heap Mask@3 SecMask) :named ax_368))
   (assert (! (wf Heap Mask@4 SecMask) :named ax_369))
   (assert (! (wf Heap SecMask SecMask) :named ax_370))
   (assert (! CanAssumeFunctionDefs :named ax_371))
