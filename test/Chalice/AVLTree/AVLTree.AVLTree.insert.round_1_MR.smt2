...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTree.valid) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTree.valid) perm$R (+ 0 Permission$FullFraction))) :named ax_20))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys) perm$R (+ 0 (Fractions 50)))) :named ax_21))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTree.valid) perm$R)) :named ax_22))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys) perm$R)) :named ax_23))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$N)) :named ax_24))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$N)) :named ax_25))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$R)) :named ax_26))
   (assert (! (= 0 (Seq@Length$Int$ Seq@Empty$Int$)) :named ax_27))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_28))
   (assert (! (= channelK monitorK) :named ax_29))
   (assert (! (= channelK predicateK) :named ax_30))
   (assert (! (= false $@bf_26) :named ax_31))
   (assert (! (= false $@bf_27) :named ax_32))
   (assert (! (= false $@bf_29) :named ax_33))
   (assert (! (= false $@bf_31) :named ax_34))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask this AVLTree.keys))) :named ax_35))
   (assert (! (= Mask Mask@1) :named ax_36))
   (assert (! (= Mask@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTree.valid (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTree.valid))) :named ax_37))
   ...
   (assert (! (= SecMask ZeroMask) :named ax_41))
   (assert (! (= true $@bf_24) :named ax_42))
   (assert (! (= true $@bf_25) :named ax_43))
   (assert (! (= true $@bf_28) :named ax_44))
   (assert (! (= true $@bf_30) :named ax_45))
   (assert (! (= ZeroCredits Credits) :named ax_46))
   ...
   (assert (! (forall( (|o_$25| ref) (|f_$17| Field$Bool$) (|pc_$0| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ ZeroMask |o_$25| |f_$17|) |pc_$0|) 0)) :named ax_211))
   (assert (! (forall( (|o_$26| ref) (|f_$18| Field$Int$) (|pc_$1| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask |o_$26| |f_$18|) |pc_$1|) 0)) :named ax_212))
   (assert (! (forall( (|o_$27| ref) (|f_$19| Field$ref$) (|pc_$2| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask |o_$27| |f_$19|) |pc_$2|) 0)) :named ax_213))
   (assert (! (forall( (|o_$28| ref) (|f_$20| Field$Mu$) (|pc_$3| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ ZeroMask |o_$28| |f_$20|) |pc_$3|) 0)) :named ax_214))
   (assert (! (forall( (|o_$29| ref) (|f_$21| Field$Seq$Int$$) (|pc_$4| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ ZeroMask |o_$29| |f_$21|) |pc_$4|) 0)) :named ax_215))
   ...
   (assert (! (IsGoodMask SecMask) :named ax_260))
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTree.valid))) :named ax_261))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTree.keys))) :named ax_262))
   (assert (! (IsGoodState emptyPartialHeap) :named ax_263))
   (assert (! (ite$Bool$ false false true) :named ax_264))
   (assert (! (ite$Bool$ false true true) :named ax_265))
   (assert (! (ite$Bool$ true true false) :named ax_266))
   (assert (! (ite$Bool$ true true true) :named ax_267))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_268))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.balanceFactor) :named ax_269))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.height) :named ax_270))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.key) :named ax_271))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_272))
   (assert (! (NonPredicateField$Int$ held) :named ax_273))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_274))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_275))
   (assert (! (NonPredicateField$ref$ AVLTree.root) :named ax_276))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.left) :named ax_277))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.right) :named ax_278))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTree.keys) :named ax_279))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTreeNode.keys) :named ax_280))
   (assert (! (not (= (* 50 Permission$denominator) 0)) :named ax_281))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_282))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_37))) :named ax_283))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_284))
   ...
   (assert (! (not (= AVLTree.valid forkK)) :named ax_288))
   (assert (! (not (= AVLTree.valid held)) :named ax_289))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_290))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_291))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_292))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_293))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_294))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_295))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_296))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_297))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_298))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_299))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_300))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_301))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_302))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_303))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_304))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_305))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_306))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_307))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_308))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_309))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_310))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_311))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_312))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_313))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_314))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_315))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_316))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_317))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_318))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_319))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_320))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_321))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_322))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_323))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_324))
   (assert (! (not (= channelK 0)) :named ax_325))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_326))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_327))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_328))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_329))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_330))
   (assert (! (not (= forkK held)) :named ax_331))
   (assert (! (not (= forkK joinable)) :named ax_332))
   (assert (! (not (= held AVLTree.valid)) :named ax_333))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_334))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_335))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_336))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_337))
   (assert (! (not (= held forkK)) :named ax_338))
   (assert (! (not (= held joinable)) :named ax_339))
   (assert (! (not (= joinable AVLTree.valid)) :named ax_340))
   (assert (! (not (= joinable AVLTreeNode.balanceFactor)) :named ax_341))
   (assert (! (not (= joinable AVLTreeNode.height)) :named ax_342))
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_343))
   (assert (! (not (= joinable AVLTreeNode.valid)) :named ax_344))
   (assert (! (not (= joinable forkK)) :named ax_345))
   (assert (! (not (= joinable held)) :named ax_346))
   (assert (! (not (= methodK@_37 (* 1000 unfoldK@_38))) :named ax_347))
   (assert (! (not (= methodK@_37 0)) :named ax_348))
   ...
   (assert (! (not (= unfoldK@_38 (Fractions 1))) :named ax_354))
   (assert (! (not (= unfoldK@_38 0)) :named ax_355))
   (assert (! (not (ite$Bool$ false false false)) :named ax_356))
   (assert (! (not (ite$Bool$ false true false)) :named ax_357))
   (assert (! (not (ite$Bool$ true false false)) :named ax_358))
   (assert (! (not (ite$Bool$ true false true)) :named ax_359))
   (assert (! (or (= null n@2) (= (dtype n@2) AVLTreeNode@t)) :named ax_360))
   (assert (! (or (= r@122 null) (= (dtype r@122) AVLTreeNode@t)) :named ax_361))
   (assert (! (or (= r@75 null) (= (dtype r@75) AVLTreeNode@t)) :named ax_362))
   (assert (! (or (= this@118 null) (= (dtype this@118) AVLTreeNode@t)) :named ax_363))
   (assert (! (or (= this@120 null) (= (dtype this@120) AVLTreeNode@t)) :named ax_364))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_365))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_366))
   (assert (! (wf Heap Mask SecMask) :named ax_367))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_368))
...
(let ((anon65@5 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@29 this AVLTree.valid) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@29 this AVLTree.valid) perm$N)))
...
(let ((anon55@2 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@28 this AVLTree.root) perm$N)))
...
(let ((anon40 (=> (and true
    (= (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap@1 this AVLTree.root) null) cond@_52@0)
    (IsGoodMask Mask@12)
...
(let ((anon0@3 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@1 this AVLTree.valid) perm$N)))
    (not $@condition)
