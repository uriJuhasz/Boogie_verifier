...
(let ((anon749_Else (=> (and true
    ...
    (not (or false (and (and (and (= predVer@_2983@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.right) AVLTreeNode.valid)) (= predRec@_2982@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.right))) true) true)))
  )
    $branchMerge_15
)))
...
(let ((anon766_Else (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTreeNode.right) AVLTreeNode.left) null)
...
(let ((anon0 (=> (and true
    (< (* 1000 methodK@_2935) (Fractions 1))
    (< 0 methodK@_2935)
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (IsGoodMask SecMask)
    (not (= this null))
    (or (= r@71 null) (= (dtype r@71) AVLTreeNode@t))
    (or (= this null) (= (dtype this) AVLTreeNode@t))
    (or (= this@881 null) (= (dtype this@881) AVLTreeNode@t))
    (or (= this@897 null) (= (dtype this@897) AVLTreeNode@t))
    (or (= this@910 null) (= (dtype this@910) AVLTreeNode@t))
