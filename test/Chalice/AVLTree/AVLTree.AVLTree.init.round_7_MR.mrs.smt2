...
(assert (! (=> anon56_Then (and true 
   (and true
      ...
      (not (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ exhaleHeap@_16@0 this AVLTree.root) AVLTreeNode.valid) perm$R)))
   )
anon26
...
(assert (! (=> anon58_Then (and true 
   (and true
      ...
      (not (= 0 (* 50 Permission$denominator)))
      (not (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ exhaleHeap@_16@0 this AVLTree.root) AVLTreeNode.height) perm$R)))
   )
anon30
