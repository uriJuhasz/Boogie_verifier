...
;Axioms
   ...
   (assert (! (= true $@bf_24) :named ax_38))
   (assert (! (= true $@bf_25) :named ax_39))
   (assert (! (= true $@bf_28) :named ax_40))
   ...
   (assert (! (forall( (|o_$25| ref) (|f_$17| Field$Bool$) (|pc_$0| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Bool$ ZeroMask |o_$25| |f_$17|) |pc_$0|) 0)) :named ax_207))
   (assert (! (forall( (|o_$26| ref) (|f_$18| Field$Int$) (|pc_$1| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask |o_$26| |f_$18|) |pc_$1|) 0)) :named ax_208))
   (assert (! (forall( (|o_$27| ref) (|f_$19| Field$ref$) (|pc_$2| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ ZeroMask |o_$27| |f_$19|) |pc_$2|) 0)) :named ax_209))
   (assert (! (forall( (|o_$28| ref) (|f_$20| Field$Mu$) (|pc_$3| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ ZeroMask |o_$28| |f_$20|) |pc_$3|) 0)) :named ax_210))
   (assert (! (forall( (|o_$29| ref) (|f_$21| Field$Seq$Int$$) (|pc_$4| PermissionComponent))(= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ ZeroMask |o_$29| |f_$21|) |pc_$4|) 0)) :named ax_211))
   ...
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_37))) :named ax_278))
   ...
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_322))
   ...
   (assert (! (not (= methodK@_37 (* 1000 unfoldK@_38))) :named ax_344))
   (assert (! (not (= methodK@_37 0)) :named ax_345))
   (assert (! (not (= perm$N perm$R)) :named ax_346))
   (assert (! (not (= perm$R perm$N)) :named ax_347))
   (assert (! (not (= Permission$denominator 0)) :named ax_348))
   (assert (! (not (= this null)) :named ax_349))
   (assert (! (not (= unfoldK@_38 (Fractions 1))) :named ax_350))
   (assert (! (not (= unfoldK@_38 0)) :named ax_351))
   ...
   (assert (! (or (= null n@2) (= (dtype n@2) AVLTreeNode@t)) :named ax_356))
   (assert (! (or (= r@122 null) (= (dtype r@122) AVLTreeNode@t)) :named ax_357))
   (assert (! (or (= r@75 null) (= (dtype r@75) AVLTreeNode@t)) :named ax_358))
   (assert (! (or (= this@118 null) (= (dtype this@118) AVLTreeNode@t)) :named ax_359))
   (assert (! (or (= this@120 null) (= (dtype this@120) AVLTreeNode@t)) :named ax_360))
   ...
   (assert (! (wf Heap SecMask SecMask) :named ax_365))
   (assert (! CanAssumeFunctionDefs :named ax_366))
