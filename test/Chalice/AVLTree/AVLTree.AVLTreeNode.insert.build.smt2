...
;Axioms
   ...
   (assert (! (= false $@bf_33) :named ax_28))
   (assert (! (= false $@bf_35) :named ax_29))
   (assert (! (= false $@bf_37) :named ax_30))
   ...
   (assert (! (= true $@bf_30) :named ax_40))
   (assert (! (= true $@bf_31) :named ax_41))
   (assert (! (= true $@bf_34) :named ax_42))
   (assert (! (= true $@bf_36) :named ax_43))
   ...
   (assert (! (forall( (|s_$5_$0| Seq$Int$) (|n_$5_$0| Int) (|x_$4_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Take$Int$ |s_$5_$0| |n_$5_$0|) |x_$4_$0|) (exists( (|i_$3_$1| Int))(!(and (= |x_$4_$0| (Seq@Index$Int$ |s_$5_$0| |i_$3_$1|)) (and (< |i_$3_$1| (Seq@Length$Int$ |s_$5_$0|)) (and (< |i_$3_$1| |n_$5_$0|) (<= 0 |i_$3_$1|))))  :pattern ( (Seq@Index$Int$ |s_$5_$0| |i_$3_$1|)))))  :pattern ( (Seq@Contains$Int$ (Seq@Take$Int$ |s_$5_$0| |n_$5_$0|) |x_$4_$0|)))) :named ax_224))
   (assert (! (forall( (|s_$5_$1| Seq$ref$) (|n_$5_$1| Int) (|x_$4_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Take$ref$ |s_$5_$1| |n_$5_$1|) |x_$4_$1|) (exists( (|i_$3_$3| Int))(!(and (= |x_$4_$1| (Seq@Index$ref$ |s_$5_$1| |i_$3_$3|)) (and (< |i_$3_$3| (Seq@Length$ref$ |s_$5_$1|)) (and (< |i_$3_$3| |n_$5_$1|) (<= 0 |i_$3_$3|))))  :pattern ( (Seq@Index$ref$ |s_$5_$1| |i_$3_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Take$ref$ |s_$5_$1| |n_$5_$1|) |x_$4_$1|)))) :named ax_225))
   (assert (! (forall( (|s_$6_$0| Seq$Int$) (|n_$6_$0| Int) (|x_$5_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Drop$Int$ |s_$6_$0| |n_$6_$0|) |x_$5_$0|) (exists( (|i_$4_$1| Int))(!(and (= |x_$5_$0| (Seq@Index$Int$ |s_$6_$0| |i_$4_$1|)) (and (< |i_$4_$1| (Seq@Length$Int$ |s_$6_$0|)) (and (<= |n_$6_$0| |i_$4_$1|) (<= 0 |n_$6_$0|))))  :pattern ( (Seq@Index$Int$ |s_$6_$0| |i_$4_$1|)))))  :pattern ( (Seq@Contains$Int$ (Seq@Drop$Int$ |s_$6_$0| |n_$6_$0|) |x_$5_$0|)))) :named ax_226))
   (assert (! (forall( (|s_$6_$1| Seq$ref$) (|n_$6_$1| Int) (|x_$5_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$6_$1| |n_$6_$1|) |x_$5_$1|) (exists( (|i_$4_$3| Int))(!(and (= |x_$5_$1| (Seq@Index$ref$ |s_$6_$1| |i_$4_$3|)) (and (< |i_$4_$3| (Seq@Length$ref$ |s_$6_$1|)) (and (<= |n_$6_$1| |i_$4_$3|) (<= 0 |n_$6_$1|))))  :pattern ( (Seq@Index$ref$ |s_$6_$1| |i_$4_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$6_$1| |n_$6_$1|) |x_$5_$1|)))) :named ax_227))
   (assert (! (forall( (|s_$7_$0| Seq$Int$) (|n_$8_$0| Int))(!(=> (<= 0 |n_$8_$0|) (and (=> (< (Seq@Length$Int$ |s_$7_$0|) |n_$8_$0|) (= (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|)) (Seq@Length$Int$ |s_$7_$0|))) (=> (<= |n_$8_$0| (Seq@Length$Int$ |s_$7_$0|)) (= (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|)) |n_$8_$0|))))  :pattern ( (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|))))) :named ax_228))
   (assert (! (forall( (|s_$7_$1| Seq$ref$) (|n_$8_$1| Int))(!(=> (<= 0 |n_$8_$1|) (and (=> (< (Seq@Length$ref$ |s_$7_$1|) |n_$8_$1|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|)) (Seq@Length$ref$ |s_$7_$1|))) (=> (<= |n_$8_$1| (Seq@Length$ref$ |s_$7_$1|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|)) |n_$8_$1|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|))))) :named ax_229))
   (assert (! (forall( (|s_$8_$0| Seq$Int$) (|n_$9_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (Seq@Length$Int$ |s_$8_$0|)) (and (< |j_$2_$0| |n_$9_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$Int$ (Seq@Take$Int$ |s_$8_$0| |n_$9_$0|) |j_$2_$0|) (Seq@Index$Int$ |s_$8_$0| |j_$2_$0|)))  :weight  25 :pattern ( (Seq@Index$Int$ (Seq@Take$Int$ |s_$8_$0| |n_$9_$0|) |j_$2_$0|)))) :named ax_230))
   (assert (! (forall( (|s_$8_$1| Seq$ref$) (|n_$9_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (Seq@Length$ref$ |s_$8_$1|)) (and (< |j_$2_$1| |n_$9_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$8_$1| |n_$9_$1|) |j_$2_$1|) (Seq@Index$ref$ |s_$8_$1| |j_$2_$1|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$8_$1| |n_$9_$1|) |j_$2_$1|)))) :named ax_231))
   (assert (! (forall( (|s_$9_$0| Seq$Int$) (|n_$10_$0| Int))(!(=> (<= 0 |n_$10_$0|) (and (=> (< (Seq@Length$Int$ |s_$9_$0|) |n_$10_$0|) (= (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|)) 0)) (=> (<= |n_$10_$0| (Seq@Length$Int$ |s_$9_$0|)) (= (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|)) (- (Seq@Length$Int$ |s_$9_$0|) |n_$10_$0|)))))  :pattern ( (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|))))) :named ax_232))
   (assert (! (forall( (|s_$9_$1| Seq$ref$) (|n_$10_$1| Int))(!(=> (<= 0 |n_$10_$1|) (and (=> (< (Seq@Length$ref$ |s_$9_$1|) |n_$10_$1|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|)) 0)) (=> (<= |n_$10_$1| (Seq@Length$ref$ |s_$9_$1|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|)) (- (Seq@Length$ref$ |s_$9_$1|) |n_$10_$1|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|))))) :named ax_233))
   (assert (! (forall( (|s0_$0_$0| Seq$Int$) (|s1_$0_$0| Seq$Int$) (|n_$3_$0| Int))(!(and (=> (<= (Seq@Length$Int$ |s0_$0_$0|) |n_$3_$0|) (= (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|) (Seq@Index$Int$ |s1_$0_$0| (- |n_$3_$0| (Seq@Length$Int$ |s0_$0_$0|))))) (=> (< |n_$3_$0| (Seq@Length$Int$ |s0_$0_$0|)) (= (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|) (Seq@Index$Int$ |s0_$0_$0| |n_$3_$0|))))  :pattern ( (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|)))) :named ax_234))
   (assert (! (forall( (|s0_$0_$1| Seq$ref$) (|s1_$0_$1| Seq$ref$) (|n_$3_$1| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$1|) |n_$3_$1|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|) (Seq@Index$ref$ |s1_$0_$1| (- |n_$3_$1| (Seq@Length$ref$ |s0_$0_$1|))))) (=> (< |n_$3_$1| (Seq@Length$ref$ |s0_$0_$1|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|) (Seq@Index$ref$ |s0_$0_$1| |n_$3_$1|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|)))) :named ax_235))
   (assert (! (forall( (|s0_$1_$0| Seq$Int$) (|s1_$1_$0| Seq$Int$) (|x_$2_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Append$Int$ |s0_$1_$0| |s1_$1_$0|) |x_$2_$0|) (or (Seq@Contains$Int$ |s1_$1_$0| |x_$2_$0|) (Seq@Contains$Int$ |s0_$1_$0| |x_$2_$0|)))  :pattern ( (Seq@Contains$Int$ (Seq@Append$Int$ |s0_$1_$0| |s1_$1_$0|) |x_$2_$0|)))) :named ax_236))
   (assert (! (forall( (|s0_$1_$1| Seq$ref$) (|s1_$1_$1| Seq$ref$) (|x_$2_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$2_$1|) (or (Seq@Contains$ref$ |s1_$1_$1| |x_$2_$1|) (Seq@Contains$ref$ |s0_$1_$1| |x_$2_$1|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$2_$1|)))) :named ax_237))
   (assert (! (forall( (|s0_$2_$0| Seq$Int$) (|s1_$2_$0| Seq$Int$))(!(= (Seq@Equal$Int$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$Int$ |s1_$2_$0|) (Seq@Length$Int$ |s0_$2_$0|)) (forall( (|j_$0_$1| Int))(!(=> (and (< |j_$0_$1| (Seq@Length$Int$ |s0_$2_$0|)) (<= 0 |j_$0_$1|)) (= (Seq@Index$Int$ |s1_$2_$0| |j_$0_$1|) (Seq@Index$Int$ |s0_$2_$0| |j_$0_$1|)))  :pattern ( (Seq@Index$Int$ |s0_$2_$0| |j_$0_$1|)) :pattern ( (Seq@Index$Int$ |s1_$2_$0| |j_$0_$1|))))))  :pattern ( (Seq@Equal$Int$ |s0_$2_$0| |s1_$2_$0|)))) :named ax_238))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_240))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_241))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_242))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_243))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_244))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_245))
   (assert (! (forall( (|x_$1| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$1|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$1|)))) :named ax_246))
   (assert (! (forall( (|x_$6_$0| Int) (|y_$0_$0| Int))(!(= (= |y_$0_$0| |x_$6_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$6_$0|) |y_$0_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$6_$0|) |y_$0_$0|)))) :named ax_247))
   (assert (! (forall( (|x_$6_$1| ref) (|y_$0_$1| ref))(!(= (= |y_$0_$1| |x_$6_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$6_$1|) |y_$0_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$6_$1|) |y_$0_$1|)))) :named ax_248))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_249))
   (assert (! (IsGoodMask Mask) :named ax_250))
   (assert (! (IsGoodMask Mask@0) :named ax_251))
   (assert (! (IsGoodMask Mask@1) :named ax_252))
   (assert (! (IsGoodMask Mask@2) :named ax_253))
   (assert (! (IsGoodMask SecMask) :named ax_254))
   ...
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTreeNode.valid))) :named ax_257))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTreeNode.keys))) :named ax_258))
   (assert (! (IsGoodState emptyPartialHeap) :named ax_259))
   (assert (! (ite$Bool$ false false true) :named ax_260))
   (assert (! (ite$Bool$ false true true) :named ax_261))
   (assert (! (ite$Bool$ true true false) :named ax_262))
   (assert (! (ite$Bool$ true true true) :named ax_263))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_264))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.balanceFactor) :named ax_265))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.height) :named ax_266))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.key) :named ax_267))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_268))
   (assert (! (NonPredicateField$Int$ held) :named ax_269))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_270))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_271))
   (assert (! (NonPredicateField$ref$ AVLTree.root) :named ax_272))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.left) :named ax_273))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.right) :named ax_274))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTree.keys) :named ax_275))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTreeNode.keys) :named ax_276))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_277))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_261))) :named ax_278))
   (assert (! (not (= (Fractions 50) 0)) :named ax_279))
   (assert (! (not (= 0 channelK)) :named ax_280))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_281))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_282))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_283))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_284))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_285))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_286))
   (assert (! (not (= AVLTree.valid held)) :named ax_287))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_288))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_289))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_290))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_291))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_292))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_293))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_294))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_295))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_296))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_297))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_298))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_299))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_300))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_301))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_302))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_303))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_304))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_305))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_306))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_307))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_308))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_309))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_310))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_311))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_312))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_313))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_314))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_315))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_316))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_317))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_318))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_319))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_320))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_321))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_322))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_323))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_324))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_325))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_326))
   (assert (! (not (= forkK held)) :named ax_327))
   (assert (! (not (= forkK joinable)) :named ax_328))
   (assert (! (not (= held AVLTree.valid)) :named ax_329))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_330))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_331))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_332))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_333))
   (assert (! (not (= held forkK)) :named ax_334))
   (assert (! (not (= held joinable)) :named ax_335))
   (assert (! (not (= joinable AVLTree.valid)) :named ax_336))
   (assert (! (not (= joinable AVLTreeNode.balanceFactor)) :named ax_337))
   (assert (! (not (= joinable AVLTreeNode.height)) :named ax_338))
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_339))
   ...
   (assert (! (not (= methodK@_261 (* 1000 unfoldK@_262))) :named ax_343))
   (assert (! (not (= methodK@_261 0)) :named ax_344))
   (assert (! (not (= perm$N perm$R)) :named ax_345))
   (assert (! (not (= perm$R perm$N)) :named ax_346))
   (assert (! (not (= Permission$denominator 0)) :named ax_347))
   (assert (! (not (= this null)) :named ax_348))
   (assert (! (not (= unfoldK@_262 (Fractions 1))) :named ax_349))
   (assert (! (not (= unfoldK@_262 0)) :named ax_350))
   (assert (! (not (ite$Bool$ false false false)) :named ax_351))
   (assert (! (not (ite$Bool$ false true false)) :named ax_352))
   (assert (! (not (ite$Bool$ true false false)) :named ax_353))
   (assert (! (not (ite$Bool$ true false true)) :named ax_354))
   (assert (! (or (= null nl@12) (= (dtype nl@12) AVLTreeNode@t)) :named ax_355))
   (assert (! (or (= null nr@16) (= (dtype nr@16) AVLTreeNode@t)) :named ax_356))
   (assert (! (or (= r@10 null) (= (dtype r@10) AVLTreeNode@t)) :named ax_357))
   (assert (! (or (= r@174 null) (= (dtype r@174) AVLTreeNode@t)) :named ax_358))
   (assert (! (or (= r@180 null) (= (dtype r@180) AVLTreeNode@t)) :named ax_359))
   (assert (! (or (= r@194 null) (= (dtype r@194) AVLTreeNode@t)) :named ax_360))
   (assert (! (or (= r@200 null) (= (dtype r@200) AVLTreeNode@t)) :named ax_361))
   (assert (! (or (= this@165 null) (= (dtype this@165) AVLTreeNode@t)) :named ax_362))
   (assert (! (or (= this@170 null) (= (dtype this@170) AVLTreeNode@t)) :named ax_363))
   (assert (! (or (= this@172 null) (= (dtype this@172) AVLTreeNode@t)) :named ax_364))
   (assert (! (or (= this@177 null) (= (dtype this@177) AVLTreeNode@t)) :named ax_365))
   (assert (! (or (= this@179 null) (= (dtype this@179) AVLTreeNode@t)) :named ax_366))
   (assert (! (or (= this@185 null) (= (dtype this@185) AVLTreeNode@t)) :named ax_367))
   (assert (! (or (= this@190 null) (= (dtype this@190) AVLTreeNode@t)) :named ax_368))
   (assert (! (or (= this@192 null) (= (dtype this@192) AVLTreeNode@t)) :named ax_369))
   (assert (! (or (= this@197 null) (= (dtype this@197) AVLTreeNode@t)) :named ax_370))
   (assert (! (or (= this@199 null) (= (dtype this@199) AVLTreeNode@t)) :named ax_371))
   (assert (! (or (= this@205 null) (= (dtype this@205) AVLTreeNode@t)) :named ax_372))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_373))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_374))
   (assert (! (wf Heap Mask SecMask) :named ax_375))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_376))
   (assert (! (wf Heap Mask@1 SecMask) :named ax_377))
   (assert (! (wf Heap Mask@2 SecMask) :named ax_378))
   (assert (! (wf Heap SecMask SecMask) :named ax_379))
   (assert (! CanAssumeFunctionDefs :named ax_380))
...
(let ((anon308_Then@4_assertion (and
