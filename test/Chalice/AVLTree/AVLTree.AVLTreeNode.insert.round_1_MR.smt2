...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask this AVLTreeNode.balanceFactor) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTreeNode.balanceFactor) perm$R (+ 0 (Fractions 50)))) :named ax_20))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTreeNode.valid) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTreeNode.valid) perm$R (+ 0 Permission$FullFraction))) :named ax_21))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@1 this AVLTreeNode.height) perm$R (+ 0 (Fractions 50)))) :named ax_22))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@1 this AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTreeNode.keys) perm$R (+ 0 (Fractions 50)))) :named ax_23))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@1 this AVLTreeNode.height) perm$R)) :named ax_24))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTreeNode.balanceFactor) perm$R)) :named ax_25))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTreeNode.valid) perm$R)) :named ax_26))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTreeNode.keys) perm$R)) :named ax_27))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$N)) :named ax_28))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$N)) :named ax_29))
   (assert (! (= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Zero perm$R)) :named ax_30))
   (assert (! (= 0 (Seq@Length$Int$ Seq@Empty$Int$)) :named ax_31))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_32))
   (assert (! (= channelK monitorK) :named ax_33))
   (assert (! (= channelK predicateK) :named ax_34))
   (assert (! (= false $@bf_32) :named ax_35))
   (assert (! (= false $@bf_33) :named ax_36))
   (assert (! (= false $@bf_35) :named ax_37))
   (assert (! (= false $@bf_37) :named ax_38))
   (assert (! (= Mask (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTreeNode.balanceFactor (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask this AVLTreeNode.balanceFactor))) :named ax_39))
   (assert (! (= Mask Mask@3) :named ax_40))
   (assert (! (= Mask@0 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ SecMask this AVLTreeNode.valid (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@0 this AVLTreeNode.valid))) :named ax_41))
   (assert (! (= Mask@1 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTreeNode.keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@1 this AVLTreeNode.keys))) :named ax_42))
   (assert (! (= Mask@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@1 this AVLTreeNode.height (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@2 this AVLTreeNode.height))) :named ax_43))
   (assert (! (= module@default CurrentModule) :named ax_44))
   (assert (! (= Permission$FullFraction (Fractions 100)) :named ax_45))
   (assert (! (= Permission$FullFraction (MapRead$$@Map@@PermissionComponent@To@Int@@$ Permission$Full perm$R)) :named ax_46))
   (assert (! (= SecMask ZeroMask) :named ax_47))
   (assert (! (= true $@bf_30) :named ax_48))
   (assert (! (= true $@bf_31) :named ax_49))
   (assert (! (= true $@bf_34) :named ax_50))
   (assert (! (= true $@bf_36) :named ax_51))
   (assert (! (= ZeroCredits Credits) :named ax_52))
   ...
   (assert (! (forall( (|s_$5_$0| Seq$Int$) (|n_$5_$0| Int) (|x_$4_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Take$Int$ |s_$5_$0| |n_$5_$0|) |x_$4_$0|) (exists( (|i_$3_$1| Int))(!(and (= |x_$4_$0| (Seq@Index$Int$ |s_$5_$0| |i_$3_$1|)) (and (< |i_$3_$1| (Seq@Length$Int$ |s_$5_$0|)) (and (< |i_$3_$1| |n_$5_$0|) (<= 0 |i_$3_$1|))))  :pattern ( (Seq@Index$Int$ |s_$5_$0| |i_$3_$1|)))))  :pattern ( (Seq@Contains$Int$ (Seq@Take$Int$ |s_$5_$0| |n_$5_$0|) |x_$4_$0|)))) :named ax_232))
   (assert (! (forall( (|s_$5_$1| Seq$ref$) (|n_$5_$1| Int) (|x_$4_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Take$ref$ |s_$5_$1| |n_$5_$1|) |x_$4_$1|) (exists( (|i_$3_$3| Int))(!(and (= |x_$4_$1| (Seq@Index$ref$ |s_$5_$1| |i_$3_$3|)) (and (< |i_$3_$3| (Seq@Length$ref$ |s_$5_$1|)) (and (< |i_$3_$3| |n_$5_$1|) (<= 0 |i_$3_$3|))))  :pattern ( (Seq@Index$ref$ |s_$5_$1| |i_$3_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Take$ref$ |s_$5_$1| |n_$5_$1|) |x_$4_$1|)))) :named ax_233))
   (assert (! (forall( (|s_$6_$0| Seq$Int$) (|n_$6_$0| Int) (|x_$5_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Drop$Int$ |s_$6_$0| |n_$6_$0|) |x_$5_$0|) (exists( (|i_$4_$1| Int))(!(and (= |x_$5_$0| (Seq@Index$Int$ |s_$6_$0| |i_$4_$1|)) (and (< |i_$4_$1| (Seq@Length$Int$ |s_$6_$0|)) (and (<= |n_$6_$0| |i_$4_$1|) (<= 0 |n_$6_$0|))))  :pattern ( (Seq@Index$Int$ |s_$6_$0| |i_$4_$1|)))))  :pattern ( (Seq@Contains$Int$ (Seq@Drop$Int$ |s_$6_$0| |n_$6_$0|) |x_$5_$0|)))) :named ax_234))
   (assert (! (forall( (|s_$6_$1| Seq$ref$) (|n_$6_$1| Int) (|x_$5_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$6_$1| |n_$6_$1|) |x_$5_$1|) (exists( (|i_$4_$3| Int))(!(and (= |x_$5_$1| (Seq@Index$ref$ |s_$6_$1| |i_$4_$3|)) (and (< |i_$4_$3| (Seq@Length$ref$ |s_$6_$1|)) (and (<= |n_$6_$1| |i_$4_$3|) (<= 0 |n_$6_$1|))))  :pattern ( (Seq@Index$ref$ |s_$6_$1| |i_$4_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$6_$1| |n_$6_$1|) |x_$5_$1|)))) :named ax_235))
   (assert (! (forall( (|s_$7_$0| Seq$Int$) (|n_$8_$0| Int))(!(=> (<= 0 |n_$8_$0|) (and (=> (< (Seq@Length$Int$ |s_$7_$0|) |n_$8_$0|) (= (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|)) (Seq@Length$Int$ |s_$7_$0|))) (=> (<= |n_$8_$0| (Seq@Length$Int$ |s_$7_$0|)) (= (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|)) |n_$8_$0|))))  :pattern ( (Seq@Length$Int$ (Seq@Take$Int$ |s_$7_$0| |n_$8_$0|))))) :named ax_236))
   (assert (! (forall( (|s_$7_$1| Seq$ref$) (|n_$8_$1| Int))(!(=> (<= 0 |n_$8_$1|) (and (=> (< (Seq@Length$ref$ |s_$7_$1|) |n_$8_$1|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|)) (Seq@Length$ref$ |s_$7_$1|))) (=> (<= |n_$8_$1| (Seq@Length$ref$ |s_$7_$1|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|)) |n_$8_$1|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$7_$1| |n_$8_$1|))))) :named ax_237))
   (assert (! (forall( (|s_$8_$0| Seq$Int$) (|n_$9_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (Seq@Length$Int$ |s_$8_$0|)) (and (< |j_$2_$0| |n_$9_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$Int$ (Seq@Take$Int$ |s_$8_$0| |n_$9_$0|) |j_$2_$0|) (Seq@Index$Int$ |s_$8_$0| |j_$2_$0|)))  :weight  25 :pattern ( (Seq@Index$Int$ (Seq@Take$Int$ |s_$8_$0| |n_$9_$0|) |j_$2_$0|)))) :named ax_238))
   (assert (! (forall( (|s_$8_$1| Seq$ref$) (|n_$9_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (Seq@Length$ref$ |s_$8_$1|)) (and (< |j_$2_$1| |n_$9_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$8_$1| |n_$9_$1|) |j_$2_$1|) (Seq@Index$ref$ |s_$8_$1| |j_$2_$1|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$8_$1| |n_$9_$1|) |j_$2_$1|)))) :named ax_239))
   (assert (! (forall( (|s_$9_$0| Seq$Int$) (|n_$10_$0| Int))(!(=> (<= 0 |n_$10_$0|) (and (=> (< (Seq@Length$Int$ |s_$9_$0|) |n_$10_$0|) (= (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|)) 0)) (=> (<= |n_$10_$0| (Seq@Length$Int$ |s_$9_$0|)) (= (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|)) (- (Seq@Length$Int$ |s_$9_$0|) |n_$10_$0|)))))  :pattern ( (Seq@Length$Int$ (Seq@Drop$Int$ |s_$9_$0| |n_$10_$0|))))) :named ax_240))
   (assert (! (forall( (|s_$9_$1| Seq$ref$) (|n_$10_$1| Int))(!(=> (<= 0 |n_$10_$1|) (and (=> (< (Seq@Length$ref$ |s_$9_$1|) |n_$10_$1|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|)) 0)) (=> (<= |n_$10_$1| (Seq@Length$ref$ |s_$9_$1|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|)) (- (Seq@Length$ref$ |s_$9_$1|) |n_$10_$1|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$9_$1| |n_$10_$1|))))) :named ax_241))
   (assert (! (forall( (|s0_$0_$0| Seq$Int$) (|s1_$0_$0| Seq$Int$) (|n_$3_$0| Int))(!(and (=> (<= (Seq@Length$Int$ |s0_$0_$0|) |n_$3_$0|) (= (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|) (Seq@Index$Int$ |s1_$0_$0| (- |n_$3_$0| (Seq@Length$Int$ |s0_$0_$0|))))) (=> (< |n_$3_$0| (Seq@Length$Int$ |s0_$0_$0|)) (= (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|) (Seq@Index$Int$ |s0_$0_$0| |n_$3_$0|))))  :pattern ( (Seq@Index$Int$ (Seq@Append$Int$ |s0_$0_$0| |s1_$0_$0|) |n_$3_$0|)))) :named ax_242))
   (assert (! (forall( (|s0_$0_$1| Seq$ref$) (|s1_$0_$1| Seq$ref$) (|n_$3_$1| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$1|) |n_$3_$1|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|) (Seq@Index$ref$ |s1_$0_$1| (- |n_$3_$1| (Seq@Length$ref$ |s0_$0_$1|))))) (=> (< |n_$3_$1| (Seq@Length$ref$ |s0_$0_$1|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|) (Seq@Index$ref$ |s0_$0_$1| |n_$3_$1|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$3_$1|)))) :named ax_243))
   (assert (! (forall( (|s0_$1_$0| Seq$Int$) (|s1_$1_$0| Seq$Int$) (|x_$2_$0| Int))(!(= (Seq@Contains$Int$ (Seq@Append$Int$ |s0_$1_$0| |s1_$1_$0|) |x_$2_$0|) (or (Seq@Contains$Int$ |s1_$1_$0| |x_$2_$0|) (Seq@Contains$Int$ |s0_$1_$0| |x_$2_$0|)))  :pattern ( (Seq@Contains$Int$ (Seq@Append$Int$ |s0_$1_$0| |s1_$1_$0|) |x_$2_$0|)))) :named ax_244))
   (assert (! (forall( (|s0_$1_$1| Seq$ref$) (|s1_$1_$1| Seq$ref$) (|x_$2_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$2_$1|) (or (Seq@Contains$ref$ |s1_$1_$1| |x_$2_$1|) (Seq@Contains$ref$ |s0_$1_$1| |x_$2_$1|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$2_$1|)))) :named ax_245))
   (assert (! (forall( (|s0_$2_$0| Seq$Int$) (|s1_$2_$0| Seq$Int$))(!(= (Seq@Equal$Int$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$Int$ |s1_$2_$0|) (Seq@Length$Int$ |s0_$2_$0|)) (forall( (|j_$0_$1| Int))(!(=> (and (< |j_$0_$1| (Seq@Length$Int$ |s0_$2_$0|)) (<= 0 |j_$0_$1|)) (= (Seq@Index$Int$ |s1_$2_$0| |j_$0_$1|) (Seq@Index$Int$ |s0_$2_$0| |j_$0_$1|)))  :pattern ( (Seq@Index$Int$ |s0_$2_$0| |j_$0_$1|)) :pattern ( (Seq@Index$Int$ |s1_$2_$0| |j_$0_$1|))))))  :pattern ( (Seq@Equal$Int$ |s0_$2_$0| |s1_$2_$0|)))) :named ax_246))
   ...
   (assert (! (forall( (|s0_$4| Seq$Int$) (|s1_$4| Seq$Int$))(!(= (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|)) (+ (Seq@Length$Int$ |s0_$4|) (Seq@Length$Int$ |s1_$4|)))  :pattern ( (Seq@Length$Int$ (Seq@Append$Int$ |s0_$4| |s1_$4|))))) :named ax_248))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_249))
   (assert (! (forall( (|t_$0_$0| Int))(!(= |t_$0_$0| (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$Int$ (Seq@Singleton$Int$ |t_$0_$0|) 0)))) :named ax_250))
   (assert (! (forall( (|t_$0_$1| ref))(!(= |t_$0_$1| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$1|) 0)))) :named ax_251))
   (assert (! (forall( (|t_$2| Int))(!(= (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|)) 1)  :pattern ( (Seq@Length$Int$ (Seq@Singleton$Int$ |t_$2|))))) :named ax_252))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_253))
   (assert (! (forall( (|x_$1| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$1|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$1|)))) :named ax_254))
   (assert (! (forall( (|x_$6_$0| Int) (|y_$0_$0| Int))(!(= (= |y_$0_$0| |x_$6_$0|) (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$6_$0|) |y_$0_$0|))  :pattern ( (Seq@Contains$Int$ (Seq@Singleton$Int$ |x_$6_$0|) |y_$0_$0|)))) :named ax_255))
   (assert (! (forall( (|x_$6_$1| ref) (|y_$0_$1| ref))(!(= (= |y_$0_$1| |x_$6_$1|) (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$6_$1|) |y_$0_$1|))  :pattern ( (Seq@Contains$ref$ (Seq@Singleton$ref$ |x_$6_$1|) |y_$0_$1|)))) :named ax_256))
   (assert (! (forall( (|x| Int) (|y| Int))(=> (and (<= |x| |y|) (<= 0 |x|)) (<= (Fractions |x|) (Fractions |y|)))) :named ax_257))
   (assert (! (IsGoodMask Mask) :named ax_258))
   (assert (! (IsGoodMask Mask@0) :named ax_259))
   (assert (! (IsGoodMask Mask@1) :named ax_260))
   (assert (! (IsGoodMask Mask@2) :named ax_261))
   (assert (! (IsGoodMask SecMask) :named ax_262))
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTreeNode.balanceFactor))) :named ax_263))
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTreeNode.height))) :named ax_264))
   (assert (! (IsGoodState (heapFragment$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap this AVLTreeNode.valid))) :named ax_265))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTreeNode.keys))) :named ax_266))
   (assert (! (IsGoodState emptyPartialHeap) :named ax_267))
   (assert (! (ite$Bool$ false false true) :named ax_268))
   (assert (! (ite$Bool$ false true true) :named ax_269))
   (assert (! (ite$Bool$ true true false) :named ax_270))
   (assert (! (ite$Bool$ true true true) :named ax_271))
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_272))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.balanceFactor) :named ax_273))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.height) :named ax_274))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.key) :named ax_275))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_276))
   (assert (! (NonPredicateField$Int$ held) :named ax_277))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_278))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_279))
   (assert (! (NonPredicateField$ref$ AVLTree.root) :named ax_280))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.left) :named ax_281))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.right) :named ax_282))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTree.keys) :named ax_283))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTreeNode.keys) :named ax_284))
   (assert (! (not (= (* 50 Permission$denominator) 0)) :named ax_285))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_286))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_261))) :named ax_287))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_288))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_289))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_290))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_291))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_292))
   (assert (! (not (= AVLTree.valid held)) :named ax_293))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_294))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_295))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_296))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_297))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_298))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_299))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_300))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_301))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_302))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_303))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_304))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_305))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_306))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_307))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_308))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_309))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_310))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_311))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_312))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_313))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_314))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_315))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_316))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_317))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_318))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_319))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_320))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_321))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_322))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_323))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_324))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_325))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_326))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_327))
   (assert (! (not (= channelK 0)) :named ax_328))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_329))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_330))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_331))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_332))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_333))
   (assert (! (not (= forkK held)) :named ax_334))
   (assert (! (not (= forkK joinable)) :named ax_335))
   (assert (! (not (= held AVLTree.valid)) :named ax_336))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_337))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_338))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_339))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_340))
   (assert (! (not (= held forkK)) :named ax_341))
   (assert (! (not (= held joinable)) :named ax_342))
   (assert (! (not (= joinable AVLTree.valid)) :named ax_343))
   (assert (! (not (= joinable AVLTreeNode.balanceFactor)) :named ax_344))
   (assert (! (not (= joinable AVLTreeNode.height)) :named ax_345))
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_346))
   (assert (! (not (= joinable AVLTreeNode.valid)) :named ax_347))
   (assert (! (not (= joinable forkK)) :named ax_348))
   (assert (! (not (= joinable held)) :named ax_349))
   (assert (! (not (= methodK@_261 (* 1000 unfoldK@_262))) :named ax_350))
   (assert (! (not (= methodK@_261 0)) :named ax_351))
   (assert (! (not (= perm$N perm$R)) :named ax_352))
   (assert (! (not (= perm$R perm$N)) :named ax_353))
   (assert (! (not (= Permission$denominator 0)) :named ax_354))
   (assert (! (not (= Permission$FullFraction 0)) :named ax_355))
   (assert (! (not (= this null)) :named ax_356))
   (assert (! (not (= unfoldK@_262 (Fractions 1))) :named ax_357))
   (assert (! (not (= unfoldK@_262 0)) :named ax_358))
   ...
   (assert (! (or (= null nl@12) (= (dtype nl@12) AVLTreeNode@t)) :named ax_363))
   (assert (! (or (= null nr@16) (= (dtype nr@16) AVLTreeNode@t)) :named ax_364))
   (assert (! (or (= r@10 null) (= (dtype r@10) AVLTreeNode@t)) :named ax_365))
   (assert (! (or (= r@174 null) (= (dtype r@174) AVLTreeNode@t)) :named ax_366))
   (assert (! (or (= r@180 null) (= (dtype r@180) AVLTreeNode@t)) :named ax_367))
   (assert (! (or (= r@194 null) (= (dtype r@194) AVLTreeNode@t)) :named ax_368))
   (assert (! (or (= r@200 null) (= (dtype r@200) AVLTreeNode@t)) :named ax_369))
   (assert (! (or (= this@165 null) (= (dtype this@165) AVLTreeNode@t)) :named ax_370))
   (assert (! (or (= this@170 null) (= (dtype this@170) AVLTreeNode@t)) :named ax_371))
   (assert (! (or (= this@172 null) (= (dtype this@172) AVLTreeNode@t)) :named ax_372))
   (assert (! (or (= this@177 null) (= (dtype this@177) AVLTreeNode@t)) :named ax_373))
   (assert (! (or (= this@179 null) (= (dtype this@179) AVLTreeNode@t)) :named ax_374))
   (assert (! (or (= this@185 null) (= (dtype this@185) AVLTreeNode@t)) :named ax_375))
   (assert (! (or (= this@190 null) (= (dtype this@190) AVLTreeNode@t)) :named ax_376))
   (assert (! (or (= this@192 null) (= (dtype this@192) AVLTreeNode@t)) :named ax_377))
   (assert (! (or (= this@197 null) (= (dtype this@197) AVLTreeNode@t)) :named ax_378))
   (assert (! (or (= this@199 null) (= (dtype this@199) AVLTreeNode@t)) :named ax_379))
   (assert (! (or (= this@205 null) (= (dtype this@205) AVLTreeNode@t)) :named ax_380))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_381))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_382))
   (assert (! (wf Heap Mask SecMask) :named ax_383))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_384))
   (assert (! (wf Heap Mask@1 SecMask) :named ax_385))
   (assert (! (wf Heap Mask@2 SecMask) :named ax_386))
   (assert (! (wf Heap SecMask SecMask) :named ax_387))
   (assert (! CanAssumeFunctionDefs :named ax_388))
...
(let ((anon321_Else@1_assertion (and
    (=> true (CanRead$ref$ Mask@26 ZeroMask this AVLTreeNode.right))
)))
(let ((anon321_Then@1_assertion (and
...
(let ((anon322_Then@4_assertion (and
...
(let ((anon322_Then@12_assertion (and
...
(let ((anon359_Then@4_assertion (and
...
(let ((anon359_Then@12_assertion (and
...
(let ((anon359_Then@2_assertion (and
...
(let ((anon322_Then@2_assertion (and
...
(let ((anon322_Then@6_assertion (and
...
(let ((anon322_Then@8_assertion (and
...
(let ((anon359_Then@6_assertion (and
...
(let ((anon359_Then@8_assertion (and
...
(let ((anon322_Then@10_assertion (and
...
(let ((anon359_Then@10_assertion (and
...
(let ((anon85@10 (=> (and true
    (= exhaleMask@_297@3 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@2 this AVLTreeNode.right (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@2 this AVLTreeNode.right) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@2 this AVLTreeNode.right) perm$R) (* (- 100) Permission$denominator)))))
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@2 this AVLTreeNode.right) perm$N)))
...
(let ((anon85@8 (=> (and true
    (= exhaleMask@_297@2 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@1 this AVLTreeNode.left (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@1 this AVLTreeNode.left) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@1 this AVLTreeNode.left) perm$R) (* (- 100) Permission$denominator)))))
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ exhaleMask@_297@1 this AVLTreeNode.left) perm$N)))
...
(let ((anon221@5 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@52 this AVLTreeNode.key) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@52 this AVLTreeNode.key) perm$N)))
...
(let ((anon145@3 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@86 this AVLTreeNode.key) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@86 this AVLTreeNode.key) perm$N)))
...
(let ((anon308_Then (=> (and true
    $@condition_$24
    (< 0 (Seq@Length$Int$ (Seq@Singleton$Int$ k@9)))
    (= k@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@1 this AVLTreeNode.key))
    (not (< 0 0))
    (not (= 0 (Seq@Length$Int$ (Seq@Singleton$Int$ k@9))))
    cond@_284@0
  )
    anon308_Then@5
)))
...
(let ((anon359_Then@13 (=> (and true
    ...
    (= Mask@37 Mask@42)
    (= nr@16@0 nw@_408@0)
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_415@4 nr@16@0 AVLTreeNode.balanceFactor) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_415@4 nr@16@0 AVLTreeNode.balanceFactor) perm$N)))
...
(let ((anon322_Then@13 (=> (and true
    ...
    (= Mask@71 Mask@76)
    (= nl@12@0 nw@_316@0)
    (=> (= (* 100 Permission$denominator) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_323@4 nl@12@0 AVLTreeNode.balanceFactor) perm$R)) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_323@4 nl@12@0 AVLTreeNode.balanceFactor) perm$N)))
...
(let ((anon359_Then@11 (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_415@4 nw@_408@0 AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_415@3 nw@_408@0 AVLTreeNode.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_415@3 nw@_408@0 AVLTreeNode.keys) perm$R) (* (- 100) Permission$denominator))))
...
(let ((anon322_Then@11 (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_323@4 nw@_316@0 AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_323@3 nw@_316@0 AVLTreeNode.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_323@3 nw@_316@0 AVLTreeNode.keys) perm$R) (* (- 100) Permission$denominator))))
...
(let ((anon359_Then@5 (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_415@1 nw@_408@0 AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_415@0 nw@_408@0 AVLTreeNode.height) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_415@0 nw@_408@0 AVLTreeNode.height) perm$R) (* (- 100) Permission$denominator))))
...
(let ((anon322_Then@5 (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_323@1 nw@_316@0 AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_323@0 nw@_316@0 AVLTreeNode.height) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_323@0 nw@_316@0 AVLTreeNode.height) perm$R) (* (- 100) Permission$denominator))))
...
(let ((anon359_Then (=> (and true
    ...
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@27 nw@_408@0 AVLTreeNode.key) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@26 nw@_408@0 AVLTreeNode.key) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@28 nw@_408@0 AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@27 nw@_408@0 AVLTreeNode.height) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@32 nw@_408@0 AVLTreeNode.balanceFactor) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@31 nw@_408@0 AVLTreeNode.balanceFactor) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@29 nw@_408@0 AVLTreeNode.left) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@28 nw@_408@0 AVLTreeNode.left) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@30 nw@_408@0 AVLTreeNode.right) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@29 nw@_408@0 AVLTreeNode.right) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@31 nw@_408@0 AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@30 nw@_408@0 AVLTreeNode.keys) perm$R (+ 0 (Fractions 100))))
    ...
    (= Mask@33 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ Mask@32 nw@_408@0 mu (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ Mask@32 nw@_408@0 mu) perm$R (+ 0 (Fractions 100)))))
...
(let ((anon322_Then (=> (and true
    ...
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@61 nw@_316@0 AVLTreeNode.key) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@26 nw@_316@0 AVLTreeNode.key) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@62 nw@_316@0 AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@61 nw@_316@0 AVLTreeNode.height) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@66 nw@_316@0 AVLTreeNode.balanceFactor) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@65 nw@_316@0 AVLTreeNode.balanceFactor) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@63 nw@_316@0 AVLTreeNode.left) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@62 nw@_316@0 AVLTreeNode.left) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@64 nw@_316@0 AVLTreeNode.right) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@63 nw@_316@0 AVLTreeNode.right) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@65 nw@_316@0 AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@64 nw@_316@0 AVLTreeNode.keys) perm$R (+ 0 (Fractions 100))))
    ...
    (= Mask@67 (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ Mask@66 nw@_316@0 mu (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Mu$ Mask@66 nw@_316@0 mu) perm$R (+ 0 (Fractions 100)))))
...
(let ((anon56 (=> (and true
    (< 0 (Fractions 100))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@10 this AVLTreeNode.balanceFactor) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R) (Fractions 50))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@10 this AVLTreeNode.height) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@5 this AVLTreeNode.height) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R) (Fractions 50))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@10 this AVLTreeNode.key) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@4 this AVLTreeNode.key) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this AVLTreeNode.left) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@6 this AVLTreeNode.left) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@10 this AVLTreeNode.right) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@7 this AVLTreeNode.right) perm$R (+ 0 (Fractions 100))))
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@10 this AVLTreeNode.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@8 this AVLTreeNode.keys) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R) (Fractions 50))))
    (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@5 this AVLTreeNode.height) perm$R))
    (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@9 this AVLTreeNode.balanceFactor) perm$R) (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@8 this AVLTreeNode.keys) perm$R))
...
(let ((anon0@3 (=> (and true
    ...
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@4 this AVLTreeNode.valid) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 this AVLTreeNode.valid) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 this AVLTreeNode.valid) perm$R) (* (- 100) Permission$denominator))))
    ...
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@3 this AVLTreeNode.valid) perm$N)))
    (not $@condition)
