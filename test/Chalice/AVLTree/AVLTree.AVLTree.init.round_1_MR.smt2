...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@0 this AVLTree.root) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ SecMask this AVLTree.root) perm$R (+ 0 Permission$FullFraction))) :named ax_15))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask this AVLTree.keys) (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@0 this AVLTree.keys) perm$R (+ 0 Permission$FullFraction))) :named ax_16))
   ...
   (assert (! (= true $@bf_24) :named ax_37))
   (assert (! (= true $@bf_25) :named ax_38))
   ...
   (assert (! (IsGoodState (heapFragment$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root))) :named ax_244))
   (assert (! (IsGoodState (heapFragment$Seq$Int$$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$Int$$ Heap this AVLTree.keys))) :named ax_245))
   (assert (! (IsGoodState emptyPartialHeap) :named ax_246))
   (assert (! (ite$Bool$ false false true) :named ax_247))
   (assert (! (ite$Bool$ false true true) :named ax_248))
   (assert (! (ite$Bool$ true true false) :named ax_249))
   (assert (! (ite$Bool$ true true true) :named ax_250))
   ...
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_264))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_11))) :named ax_265))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_266))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_267))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_268))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_269))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_270))
   (assert (! (not (= AVLTree.valid held)) :named ax_271))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_272))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_273))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_274))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_275))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_276))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_277))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_278))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_279))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_280))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_281))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_282))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_283))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_284))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_285))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_286))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_287))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_288))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_289))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_290))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_291))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_292))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_293))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_294))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_295))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_296))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_297))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_298))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_299))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_300))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_301))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_302))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_303))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_304))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_305))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_306))
   (assert (! (not (= channelK 0)) :named ax_307))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_308))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_309))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_310))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_311))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_312))
   (assert (! (not (= forkK held)) :named ax_313))
   (assert (! (not (= forkK joinable)) :named ax_314))
   (assert (! (not (= held AVLTree.valid)) :named ax_315))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_316))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_317))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_318))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_319))
   (assert (! (not (= held forkK)) :named ax_320))
   (assert (! (not (= held joinable)) :named ax_321))
   (assert (! (not (= joinable AVLTree.valid)) :named ax_322))
   (assert (! (not (= joinable AVLTreeNode.balanceFactor)) :named ax_323))
   (assert (! (not (= joinable AVLTreeNode.height)) :named ax_324))
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_325))
   ...
   (assert (! (not (= methodK@_11 0)) :named ax_329))
   (assert (! (not (= perm$N perm$R)) :named ax_330))
   (assert (! (not (= perm$R perm$N)) :named ax_331))
   (assert (! (not (= Permission$denominator 0)) :named ax_332))
   (assert (! (not (= Permission$FullFraction 0)) :named ax_333))
   (assert (! (not (= this null)) :named ax_334))
   (assert (! (not (ite$Bool$ false false false)) :named ax_335))
   (assert (! (not (ite$Bool$ false true false)) :named ax_336))
   (assert (! (not (ite$Bool$ true false false)) :named ax_337))
   (assert (! (not (ite$Bool$ true false true)) :named ax_338))
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root)) AVLTreeNode@t)) :named ax_339))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_340))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_341))
   (assert (! (wf Heap Mask SecMask) :named ax_342))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_343))
   (assert (! (wf Heap SecMask SecMask) :named ax_344))
...
(let ((anon4@4 (=> (and true
    ...
    (=> (= (* 50 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ exhaleMask@_17@0 this AVLTree.keys) perm$N)))
...
(let ((anon4@2 (=> (and true
    ...
    (=> (= (* 100 Permission$denominator) (+ 0 (* 100 Permission$denominator))) (<= 0 (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$ref$ Mask@1 this AVLTree.root) perm$N)))
