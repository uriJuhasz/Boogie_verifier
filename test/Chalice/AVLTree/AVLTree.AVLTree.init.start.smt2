...
;Axioms
   ...
   (assert (! (not (= AVLTree@t AVLTreeNode@t)) :named ax_39))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_40))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_41))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_42))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_43))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_44))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_45))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_46))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_47))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_48))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_49))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_50))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_51))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_52))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_53))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_54))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_55))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_56))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_57))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_58))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_59))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_60))
   ...
   (assert (! (not (= forkK held)) :named ax_72))
   (assert (! (not (= held AVLTree.valid)) :named ax_73))
   (assert (! (not (= held AVLTree.valid)) :named ax_74))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_75))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_76))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_77))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_78))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_79))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_80))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_81))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_82))
