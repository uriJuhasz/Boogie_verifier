...
(let ((anon258 (=> (and true
    ...
    (not (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@53 r@10@0 AVLTreeNode.height) perm$R) (* 100 Permission$denominator)))
    (not (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@54 r@10@0 AVLTreeNode.keys) perm$R) (* 100 Permission$denominator)))
    (not (= null r@10@0))
...
(let ((anon182 (=> (and true
    ...
    (not (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ Mask@87 r@10@0 AVLTreeNode.height) perm$R) (* 100 Permission$denominator)))
    (not (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Seq$Int$$ Mask@88 r@10@0 AVLTreeNode.keys) perm$R) (* 100 Permission$denominator)))
    (not (= null r@10@0))
...
(let ((anon187@6 (=> (and true
    ...
    (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_430@3 this@192@0 AVLTreeNode.balanceFactor) perm$R) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_430@2 this@192@0 AVLTreeNode.balanceFactor) perm$R) (* (- 50) Permission$denominator)))
...
(let ((anon111@6 (=> (and true
    ...
    (= (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_338@3 this@172@0 AVLTreeNode.balanceFactor) perm$R) (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ exhaleMask@_338@2 this@172@0 AVLTreeNode.balanceFactor) perm$R) (* (- 50) Permission$denominator)))
