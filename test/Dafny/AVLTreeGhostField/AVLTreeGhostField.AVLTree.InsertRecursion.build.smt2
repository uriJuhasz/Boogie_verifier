...
;Axioms
   ...
   (assert (! ($Unbox$Bool$ ($Box$Bool$ true)) :named ax_5))
   (assert (! (= $_Frame@0 (lambda@8 Node.Repr null $Heap alloc t@6)) :named ax_6))
   (assert (! (= ($Box$Bool$ false) ($Box$Bool$ ($@bf_52 ($Box$Bool$ false)))) :named ax_7))
   (assert (! (= ($Box$Bool$ true) ($Box$Bool$ ($@bf_52 ($Box$Bool$ true)))) :named ax_8))
   (assert (! (= (= true $@bf_50) ($Unbox$Bool$ ($Box$Bool$ true))) :named ax_9))
   (assert (! (= (= true $@bf_51) ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_10))
   (assert (! (= (= true $@bf_82) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@6 Node.left)))) :named ax_11))
   (assert (! (= (= true $@bf_83) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@6 Node.right)))) :named ax_12))
   (assert (! (= 0 $ModuleContextHeight) :named ax_13))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ AVLTree.Contents)) :named ax_14))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ AVLTree.Repr)) :named ax_15))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ Node.Contents)) :named ax_16))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ Node.Repr)) :named ax_17))
   (assert (! (= 0 (FDim$Bool$ alloc)) :named ax_18))
   (assert (! (= 0 (FDim$Int$ Node.balance)) :named ax_19))
   (assert (! (= 0 (FDim$Int$ Node.height)) :named ax_20))
   (assert (! (= 0 (FDim$Int$ Node.value)) :named ax_21))
   (assert (! (= 0 (FDim$ref$ AVLTree.root)) :named ax_22))
   (assert (! (= 0 (FDim$ref$ Node.left)) :named ax_23))
   (assert (! (= 0 (FDim$ref$ Node.right)) :named ax_24))
   (assert (! (= 0 (Seq@Length$BoxType$ Seq@Empty$BoxType$)) :named ax_25))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_26))
   (assert (! (= class.AVLTree (DeclType$$@Map@@BoxType@To@Bool@@$ AVLTree.Contents)) :named ax_27))
   (assert (! (= class.AVLTree (DeclType$$@Map@@BoxType@To@Bool@@$ AVLTree.Repr)) :named ax_28))
   (assert (! (= class.AVLTree (DeclType$ref$ AVLTree.root)) :named ax_29))
   (assert (! (= class.AVLTree (dtype this)) :named ax_30))
   (assert (! (= class.Node (DeclType$$@Map@@BoxType@To@Bool@@$ Node.Contents)) :named ax_31))
   (assert (! (= class.Node (DeclType$$@Map@@BoxType@To@Bool@@$ Node.Repr)) :named ax_32))
   (assert (! (= class.Node (DeclType$Int$ Node.balance)) :named ax_33))
   (assert (! (= class.Node (DeclType$Int$ Node.height)) :named ax_34))
   (assert (! (= class.Node (DeclType$Int$ Node.value)) :named ax_35))
   (assert (! (= class.Node (DeclType$ref$ Node.left)) :named ax_36))
   (assert (! (= class.Node (DeclType$ref$ Node.right)) :named ax_37))
   (assert (! (= false $@bf_51) :named ax_38))
   (assert (! (= true $@bf_50) :named ax_39))
   ...
   (assert (! (forall( (|x_$16| Int) (|y_$8| Int))(!(= (mod |x_$16| |y_$8|) (- |x_$16| (* (div |x_$16| |y_$8|) |y_$8|)))  :pattern ( (mod |x_$16| |y_$8|)) :pattern ( (div |x_$16| |y_$8|)))) :named ax_241))
   (assert (! (forall( (|x_$17| Int) (|y_$9| Int))(!(=> (< 0 |y_$9|) (and (<= 0 (mod |x_$17| |y_$9|)) (< (mod |x_$17| |y_$9|) |y_$9|)))  :pattern ( (mod |x_$17| |y_$9|)))) :named ax_242))
   (assert (! (forall( (|x_$18| Int) (|y_$10| Int))(!(=> (< |y_$10| 0) (and (<= 0 (mod |x_$18| |y_$10|)) (< (mod |x_$18| |y_$10|) (- 0 |y_$10|))))  :pattern ( (mod |x_$18| |y_$10|)))) :named ax_243))
   (assert (! (forall( (|x_$7| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$7|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$7|)))) :named ax_244))
   (assert (! (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc) :named ax_245))
   (assert (! (Node.Balanced $Heap t@6) :named ax_246))
   (assert (! (Node.Balanced@canCall $Heap t@6) :named ax_247))
   (assert (! (Node.BalanceValid $Heap t@6) :named ax_248))
   (assert (! (Node.BalanceValid@canCall $Heap t@6) :named ax_249))
   (assert (! (Node.Valid $Heap t@6) :named ax_250))
   (assert (! (Node.Valid@canCall $Heap t@6) :named ax_251))
   (assert (! (not $NP@749) :named ax_252))
   (assert (! (not $NP@750) :named ax_253))
   (assert (! (not ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_254))
   (assert (! (not (= ($@bf_70 null) true)) :named ax_255))
   (assert (! (not (= AVLTree.Contents Node.Contents)) :named ax_256))
   (assert (! (not (= AVLTree.Contents Node.Repr)) :named ax_257))
   (assert (! (not (= AVLTree.Repr AVLTree.Contents)) :named ax_258))
   (assert (! (not (= AVLTree.Repr Node.Contents)) :named ax_259))
   (assert (! (not (= AVLTree.Repr Node.Repr)) :named ax_260))
   (assert (! (not (= AVLTree.root Node.left)) :named ax_261))
   (assert (! (not (= AVLTree.root Node.right)) :named ax_262))
   (assert (! (not (= class.AVLTree class.Node)) :named ax_263))
   (assert (! (not (= class.Node class.AVLTree)) :named ax_264))
   (assert (! (not (= Node.balance Node.height)) :named ax_265))
   (assert (! (not (= Node.balance Node.value)) :named ax_266))
   (assert (! (not (= Node.Contents AVLTree.Contents)) :named ax_267))
   (assert (! (not (= Node.Contents AVLTree.Repr)) :named ax_268))
   (assert (! (not (= Node.Contents Node.Repr)) :named ax_269))
   (assert (! (not (= Node.height Node.balance)) :named ax_270))
   (assert (! (not (= Node.left AVLTree.root)) :named ax_271))
   (assert (! (not (= Node.Repr AVLTree.Contents)) :named ax_272))
   (assert (! (not (= Node.Repr AVLTree.Repr)) :named ax_273))
   (assert (! (not (= Node.Repr Node.Contents)) :named ax_274))
   (assert (! (not (= Node.right AVLTree.root)) :named ax_275))
   (assert (! (not (= Node.right Node.left)) :named ax_276))
   (assert (! (not (= Node.value Node.balance)) :named ax_277))
   (assert (! (not (= Node.value Node.height)) :named ax_278))
   (assert (! (not (= null this)) :named ax_279))
   (assert (! (or (= r@8 null) (and (= (dtype r@8) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap r@8 alloc))) :named ax_280))
   (assert (! (or (= t@6 null) (and (= (dtype t@6) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap t@6 alloc))) :named ax_281))
   (assert (! (or (and (= (dtype $rhs@10) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@10 alloc)) (= $rhs@10 null)) :named ax_282))
   (assert (! (or (and (= (dtype $rhs@11) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@11 alloc)) (= $rhs@11 null)) :named ax_283))
   (assert (! (or (and (= (dtype $rhs@12) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@12 alloc)) (= $rhs@12 null)) :named ax_284))
   (assert (! (or (and (= (dtype $rhs@2) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) (= $rhs@2 null)) :named ax_285))
   (assert (! (or (and (= (dtype $rhs@20) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@20 alloc)) (= $rhs@20 null)) :named ax_286))
   (assert (! (or (and (= (dtype $rhs@21) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@21 alloc)) (= $rhs@21 null)) :named ax_287))
   (assert (! true :named ax_288))
...
(let ((GeneratedUnifiedExit@28 (=> (and true
    (=> (Node.Balanced@canCall $Heap@22 r@8@0) (or (Node.Balanced $Heap@22 r@8@0) (Node.Balanced $Heap@22 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.left))))
  )(and 
    GeneratedUnifiedExit@28_assertion
    GeneratedUnifiedExit@29
))))
(let ((GeneratedUnifiedExit@27 (=> (and true
    (=> (Node.Balanced@canCall $Heap@22 r@8@0) (or (Node.Balanced $Heap@22 r@8@0) (Node.Balanced $Heap@22 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.right))))
  )(and 
    GeneratedUnifiedExit@27_assertion
    GeneratedUnifiedExit@28
))))
(let ((GeneratedUnifiedExit@26 (=> (and true
    (=> (Node.Balanced@canCall $Heap@22 r@8@0) (or (Node.Balanced $Heap@22 r@8@0) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@22 r@8@0 Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@22 r@8@0 Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@22 r@8@0 Node.balance) 0)))))
  )(and 
    GeneratedUnifiedExit@26_assertion
    GeneratedUnifiedExit@27
))))
(let ((GeneratedUnifiedExit@25 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@22 r@8@0) (or (Node.BalanceValid $Heap@22 r@8@0) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.right) null)) (Node.BalanceValid $Heap@22 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.right)))))
  )(and 
    GeneratedUnifiedExit@25_assertion
    GeneratedUnifiedExit@26
))))
(let ((GeneratedUnifiedExit@24 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@22 r@8@0) (or (Node.BalanceValid $Heap@22 r@8@0) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.left) null)) (Node.BalanceValid $Heap@22 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@22 r@8@0 Node.left)))))
  )(and 
...
(let ((anon16@34 (=> (and true
    (=> (Node.Balanced@canCall $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right)) (or (Node.Balanced $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.balance) 0))))))
  )(and 
    anon16@34_assertion
    anon16@35
))))
(let ((anon32@34 (=> (and true
    (=> (Node.Balanced@canCall $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left)) (or (Node.Balanced $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) Node.balance) 0))))))
  )(and 
    anon32@34_assertion
    anon32@35
))))
...
(let ((anon16@31 (=> (and true
    (=> (Node.Balanced@canCall $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left)) (or (Node.Balanced $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.left) Node.balance) 0))))))
  )(and 
    anon16@31_assertion
    anon16@32
))))
(let ((anon32@31 (=> (and true
    (=> (Node.Balanced@canCall $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left)) (or (Node.Balanced $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.left) Node.balance) 0))))))
  )(and 
    anon32@31_assertion
    anon32@32
))))
...
(let ((anon16@28 (=> (and true
    (=> (Node.Balanced@canCall $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right)) (or (Node.Balanced $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.right) Node.balance) 0))))))
  )(and 
    anon16@28_assertion
    anon16@29
))))
(let ((anon32@28 (=> (and true
    (=> (Node.Balanced@canCall $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right)) (or (Node.Balanced $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.right) Node.balance) 0))))))
  )(and 
    anon32@28_assertion
    anon32@29
))))
...
(let ((anon16@24 (=> (and true
    (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.balance) (- 2)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.balance) (- 1)))
  )(and 
    anon16@24_assertion
    anon16@25
))))
(let ((anon32@24 (=> (and true
    (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.balance) 2) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.balance) 1))
  )(and 
    anon32@24_assertion
    anon32@25
))))
...
(let ((anon16@22 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@20 t@6) (or (Node.BalanceValid $Heap@20 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (Node.BalanceValid $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right)))))
  )(and 
    anon16@22_assertion
    anon16@23
))))
(let ((anon32@22 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@12 t@6) (or (Node.BalanceValid $Heap@12 t@6) (Node.BalanceValid $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right))))
  )(and 
    anon32@22_assertion
    anon32@23
))))
(let ((anon16@21 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@20 t@6) (or (Node.BalanceValid $Heap@20 t@6) (Node.BalanceValid $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left))))
  )(and 
    anon16@21_assertion
    anon16@22
))))
(let ((anon32@21 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@12 t@6) (or (Node.BalanceValid $Heap@12 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) null)) (Node.BalanceValid $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left)))))
  )(and 
    anon32@21_assertion
    anon32@22
))))
(let ((anon16@20 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@20 t@6) (or (Node.BalanceValid $Heap@20 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 t@6 Node.balance) (- (Node.Height $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right)) (Node.Height $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left))))))
  )(and 
    anon16@20_assertion
    anon16@21
))))
(let ((anon32@20 (=> (and true
    (=> (Node.BalanceValid@canCall $Heap@12 t@6) (or (Node.BalanceValid $Heap@12 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 t@6 Node.balance) (- (Node.Height $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right)) (Node.Height $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left))))))
  )(and 
    anon32@20_assertion
    anon32@21
))))
(let ((anon16@19 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 t@6 Node.height) (+ 1 (Math.max $Heap@20 (Node.Height $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left)) (Node.Height $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right)))))))
  )(and 
    anon16@19_assertion
    anon16@20
))))
(let ((anon32@19 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 t@6 Node.height) (+ 1 (Math.max $Heap@12 (Node.Height $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left)) (Node.Height $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right)))))))
  )(and 
    anon32@19_assertion
    anon32@20
))))
...
(let ((anon16@16 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Contents) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@20 t@6 Node.value))) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.Contents) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.Contents) Set@Empty$BoxType$))) (Node.Valid $Heap@20 t@6)))
  )(and 
    anon16@16_assertion
    anon16@17
))))
(let ((anon32@16 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Contents) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@12 t@6 Node.value))) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) Node.Contents) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.Contents) Set@Empty$BoxType$))) (Node.Valid $Heap@12 t@6)))
  )(and 
    anon32@16_assertion
    anon32@17
))))
(let ((anon16@15 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ t@6)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.Repr) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.Repr) Set@Empty$BoxType$))) (Node.Valid $Heap@20 t@6)))
  )(and 
    anon16@15_assertion
    anon16@16
))))
(let ((anon32@15 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ t@6)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) Node.Repr) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.Repr) Set@Empty$BoxType$))) (Node.Valid $Heap@12 t@6)))
  )(and 
    anon32@15_assertion
    anon32@16
))))
(let ((anon16@14 (=> (and true
    ...
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (Set@Disjoint$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) Node.Repr)))))
  )(and 
    anon16@14_assertion
    anon16@15
))))
...
(let ((anon16@13 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (Node.Valid $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right))))
  )(and 
    anon16@13_assertion
    anon16@14
))))
(let ((anon32@13 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (Node.Valid $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right))))
  )(and 
    anon32@13_assertion
    anon32@14
))))
(let ((anon16@12 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (Node.Valid $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left))))
  )(and 
    anon16@12_assertion
    anon16@13
))))
(let ((anon32@12 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (Node.Valid $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left))))
  )(and 
    anon32@12_assertion
    anon32@13
))))
...
(let ((anon32@11 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Set@Subset$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr)) (Node.Valid $Heap@12 t@6)))
  )(and 
    anon32@11_assertion
    anon32@12
))))
...
(let ((anon32@10 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon32@10_assertion
    anon32@11
))))
(let ((anon16@9 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.right))))))
  )(and 
    anon16@9_assertion
    anon16@10
))))
(let ((anon32@9 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.right)))))
  )(and 
    anon32@9_assertion
    anon32@10
))))
(let ((anon16@8 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Set@Subset$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr)) (Node.Valid $Heap@20 t@6)))
  )(and 
    anon16@8_assertion
    anon16@9
))))
...
(let ((anon16@7 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon16@7_assertion
    anon16@8
))))
...
(let ((anon16@6 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@20 t@6 Node.left)))))
  )(and 
    anon16@6_assertion
    anon16@7
))))
(let ((anon32@6 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@12 t@6 Node.left))))))
  )(and 
    anon32@6_assertion
    anon32@7
))))
(let ((anon16@5 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr) ($Box$ref$ null)))))
  )(and 
    anon16@5_assertion
    anon16@6
))))
(let ((anon32@5 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr) ($Box$ref$ null)))))
  )(and 
    anon32@5_assertion
    anon32@6
))))
(let ((anon16@4 (=> (and true
    (=> (Node.Valid@canCall $Heap@20 t@6) (or (Node.Valid $Heap@20 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@20 t@6 Node.Repr) ($Box$ref$ t@6))))
  )(and 
    anon16@4_assertion
    anon16@5
))))
(let ((anon32@4 (=> (and true
    (=> (Node.Valid@canCall $Heap@12 t@6) (or (Node.Valid $Heap@12 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@12 t@6 Node.Repr) ($Box$ref$ t@6))))
  )(and 
    anon32@4_assertion
    anon32@5
))))
...
(let ((anon16@1 (=> (and true
    ...
    (or (= call3formal@r@29 null) (and (= (dtype call3formal@r@29) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call3formal@r@29 alloc)))
  )(and 
    anon16@2_assertion
    anon16@3
))))
(let ((anon32@1 (=> (and true
    ...
    (or (= call3formal@r@34 null) (and (= (dtype call3formal@r@34) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call3formal@r@34 alloc)))
  )(and 
    anon32@2_assertion
    anon32@3
))))
...
(let ((anon41_Then@6 (=> (and true
    ...
    (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) null)) (and (and (Node.Balanced $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) Node.right)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) Node.balance) 0)))) (Node.Balanced $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.left) Node.left))))
    (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) null)) (and (and (Node.Balanced $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) Node.right)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) Node.balance) 0)))) (Node.Balanced $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@18 call3formal@r@24@0 Node.right) Node.left))))
    ...
    (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 call3formal@r@24@0 Node.balance) (- 2)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@18 call3formal@r@24@0 Node.balance) (- 1)))
...
(let ((anon47_Then@6 (=> (and true
    ...
    (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) null)) (and (and (Node.Balanced $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) Node.right)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) Node.balance) 0)))) (Node.Balanced $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.left) Node.left))))
    (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) null)) (and (and (Node.Balanced $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) Node.right)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) Node.balance) 0)))) (Node.Balanced $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@10 call3formal@r@19@0 Node.right) Node.left))))
    ...
    (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 call3formal@r@19@0 Node.balance) 2) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@10 call3formal@r@19@0 Node.balance) 1))
...
(let ((anon41_Then@4 (=> (and true
    ...
    (not (= n@76@0 null))
    (or (= call3formal@r@24 null) (and (= (dtype call3formal@r@24) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call3formal@r@24 alloc)))
  )(and 
...
(let ((anon47_Then@4 (=> (and true
    ...
    (not (= n@88@0 null))
    (or (= call3formal@r@19 null) (and (= (dtype call3formal@r@19) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call3formal@r@19 alloc)))
  )(and 
...
(let ((anon40_Then@4 (=> (and true
    (or (Node.Balanced $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) null)) (Node.Balanced $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) Node.right))))
  )(and 
    anon40_Then@4_assertion
    anon40_Then@5
))))
(let ((anon46_Then@4 (=> (and true
    (or (Node.Balanced $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) null)) (Node.Balanced $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) Node.right))))
  )(and 
    anon46_Then@4_assertion
    anon46_Then@5
))))
(let ((anon40_Then@3 (=> (and true
    (or (Node.Balanced $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) Node.balance) 0)))))
  )(and 
    anon40_Then@3_assertion
    anon40_Then@4
))))
(let ((anon46_Then@3 (=> (and true
    (or (Node.Balanced $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right) Node.balance) 0)))))
  )(and 
...
(let ((anon12@6 (=> (and true
    (or (Node.BalanceValid $Heap@17 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left) null)) (Node.BalanceValid $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left))))
  )(and 
    anon12@6_assertion
    anon12@7
))))
(let ((anon28@6 (=> (and true
    (or (Node.BalanceValid $Heap@9 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.left) null)) (Node.BalanceValid $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.left))))
  )(and 
    anon28@6_assertion
    anon28@7
))))
(let ((anon12@5 (=> (and true
    (or (Node.BalanceValid $Heap@17 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@17 t@6 Node.balance) (- (Node.Height $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.right)) (Node.Height $Heap@17 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@17 t@6 Node.left)))))
  )(and 
    anon12@5_assertion
    anon12@6
))))
(let ((anon28@5 (=> (and true
    (or (Node.BalanceValid $Heap@9 t@6) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@9 t@6 Node.balance) (- (Node.Height $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.right)) (Node.Height $Heap@9 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@9 t@6 Node.left)))))
  )(and 
    anon28@5_assertion
    anon28@6
))))
...
(let ((anon12 (=> (and true
    ...
    (= (ite (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@16 t@6 Node.balance) 0) 1 0) deltaH@9@1)
...
(let ((anon28 (=> (and true
    ...
    (= (ite (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@8 t@6 Node.balance) 0) 1 0) deltaH@9@0)
...
(let ((anon6@23 (=> (and true
    (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Contents) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@16 t@6 Node.value))) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) Node.Contents) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) Node.Contents) Set@Empty$BoxType$))) (Node.Valid $Heap@16 t@6))
  )(and 
    anon6@23_assertion
    anon6@24
))))
(let ((anon22@23 (=> (and true
    (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Contents) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@8 t@6 Node.value))) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) Node.Contents) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) Node.Contents) Set@Empty$BoxType$))) (Node.Valid $Heap@8 t@6))
  )(and 
    anon22@23_assertion
    anon22@24
))))
(let ((anon6@22 (=> (and true
    (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Repr) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ t@6)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) Node.Repr) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) Node.Repr) Set@Empty$BoxType$))) (Node.Valid $Heap@16 t@6))
  )(and 
    anon6@22_assertion
    anon6@23
))))
(let ((anon22@22 (=> (and true
    (or (Set@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Repr) (Set@Union$BoxType$ (Set@Union$BoxType$ (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ t@6)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) Node.Repr) Set@Empty$BoxType$)) (ite (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) Node.Repr) Set@Empty$BoxType$))) (Node.Valid $Heap@8 t@6))
  )(and 
    anon22@22_assertion
    anon22@23
))))
(let ((anon6@21 (=> (and true
    ...
    (or (Node.Valid $Heap@16 t@6) (=> (and (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) null)) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) null))) (Set@Disjoint$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) Node.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) Node.Repr))))
  )(and 
    anon6@21_assertion
    anon6@22
))))
(let ((anon22@21 (=> (and true
    ...
    (or (Node.Valid $Heap@8 t@6) (=> (and (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) null)) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) null))) (Set@Disjoint$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) Node.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) Node.Repr))))
  )(and 
    anon22@21_assertion
    anon22@22
))))
(let ((anon6@20 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (Node.Valid $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right)))
  )(and 
    anon6@20_assertion
    anon6@21
))))
(let ((anon22@20 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (Node.Valid $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right)))
  )(and 
    anon22@20_assertion
    anon22@21
))))
(let ((anon6@19 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (Node.Valid $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left)))
  )(and 
    anon6@19_assertion
    anon6@20
))))
(let ((anon22@19 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (Node.Valid $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left)))
  )(and 
    anon22@19_assertion
    anon22@20
))))
...
(let ((anon6@17 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) null)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon6@17_assertion
    anon6@18
))))
(let ((anon22@17 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) null)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon22@17_assertion
    anon22@18
))))
(let ((anon6@16 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.right)))))
  )(and 
    anon6@16_assertion
    anon6@17
))))
(let ((anon22@16 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.right)))))
  )(and 
    anon22@16_assertion
    anon22@17
))))
...
(let ((anon6@14 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) null)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon6@14_assertion
    anon6@15
))))
(let ((anon22@14 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) null)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) Node.Repr) ($Box$ref$ t@6)))))
  )(and 
    anon22@14_assertion
    anon22@15
))))
(let ((anon6@13 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@16 t@6 Node.left)))))
  )(and 
    anon6@13_assertion
    anon6@14
))))
(let ((anon22@13 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left) null)) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Repr) ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@8 t@6 Node.left)))))
  )(and 
    anon22@13_assertion
    anon22@14
))))
(let ((anon6@12 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Repr) ($Box$ref$ null))))
  )(and 
    anon6@12_assertion
    anon6@13
))))
(let ((anon22@12 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Repr) ($Box$ref$ null))))
  )(and 
    anon22@12_assertion
    anon22@13
))))
(let ((anon6@11 (=> (and true
    (or (Node.Valid $Heap@16 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@16 t@6 Node.Repr) ($Box$ref$ t@6)))
  )(and 
    anon6@11_assertion
    anon6@12
))))
(let ((anon22@11 (=> (and true
    (or (Node.Valid $Heap@8 t@6) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@8 t@6 Node.Repr) ($Box$ref$ t@6)))
  )(and 
    anon22@11_assertion
    anon22@12
))))
...
(let ((anon22@9 (=> (and true
    (= (Node.Height $Heap@7 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@7 t@6 Node.right)) b@84@0)
...
(let ((anon6@6 (=> (and true
    (= (Node.Height $Heap@14 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@14 t@6 Node.right)) b@72@0)
...
(let ((anon22@8 (=> (and true
    (= (Node.Height $Heap@7 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@7 t@6 Node.left)) a@83@0)
...
(let ((anon6@5 (=> (and true
    (= (Node.Height $Heap@14 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@14 t@6 Node.left)) a@71@0)
...
(let ((anon36_Then@47 (=> (and true
    ...
    (=> (and (= call6formal@deltaH@9@0_$1 1) (not (= t@67@0 null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@2 call5formal@r@8@0_$1 Node.balance) 0)))
    ...
    (=> (Node.Balanced@canCall $Heap t@67@0) (or (Node.Balanced $Heap t@67@0) (=> (not (= t@67@0 null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@67@0 Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@67@0 Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@67@0 Node.balance) 0))))))
    (=> (Node.BalanceValid@canCall $Heap t@67@0) (or (Node.BalanceValid $Heap t@67@0) (=> (not (= t@67@0 null)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@67@0 Node.right) null)) (Node.BalanceValid $Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@67@0 Node.right))))))
    ...
    (and (= (dtype call5formal@r@8@0_$1) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@2 call5formal@r@8@0_$1 alloc))
    (and (and (= (- (Node.Height $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.right)) (Node.Height $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.left))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@2 call5formal@r@8@0_$1 Node.balance)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.left) null)) (Node.BalanceValid $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.left)))) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.right) null)) (Node.BalanceValid $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.right))))
    (and (and (Node.Balanced $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.right)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@2 call5formal@r@8@0_$1 Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@2 call5formal@r@8@0_$1 Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@2 call5formal@r@8@0_$1 Node.balance) 0)))) (Node.Balanced $Heap@2 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call5formal@r@8@0_$1 Node.left)))
    ...
    (or (= call6formal@deltaH@9@0_$1 1) (= call6formal@deltaH@9@0_$1 0))
    (or (and (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@67@0 Node.Repr) ($Box$ref$ call5formal@r@8@0_$1)) (not (= t@67@0 null))) (not (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call5formal@r@8@0_$1 alloc)))
  )(and 
...
(let ((anon42_Then@41 (=> (and true
    ...
    (=> (and (= call6formal@deltaH@9@0 1) (not (= t@79@0 null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap@4 call5formal@r@8@0 Node.balance) 0)))
    ...
    (=> (Node.Balanced@canCall $Heap t@79@0) (or (Node.Balanced $Heap t@79@0) (=> (not (= t@79@0 null)) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@79@0 Node.balance) 1) (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@79@0 Node.balance) (- 1)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ $Heap t@79@0 Node.balance) 0))))))
    (=> (Node.BalanceValid@canCall $Heap t@79@0) (or (Node.BalanceValid $Heap t@79@0) (=> (not (= t@79@0 null)) (=> (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@79@0 Node.right) null)) (Node.BalanceValid $Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@79@0 Node.right))))))
    ...
    (or (and (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@79@0 Node.Repr) ($Box$ref$ call5formal@r@8@0)) (not (= t@79@0 null))) (not (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call5formal@r@8@0 alloc)))
  )(and 
...
(let ((anon36_Then@28 (=> (and true
    ...
    (not (Set@Subset$BoxType$ (ite (not (= t@6 null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@6 Node.Repr) Set@Empty$BoxType$) (ite (not (= t@67@0 null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@67@0 Node.Repr) Set@Empty$BoxType$)))
    (or (= call5formal@r@8_$1 null) (and (= (dtype call5formal@r@8_$1) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call5formal@r@8_$1 alloc)))
...
(let ((anon42_Then@22 (=> (and true
    ...
    (not (Set@Subset$BoxType$ (ite (not (= t@6 null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@6 Node.Repr) Set@Empty$BoxType$) (ite (not (= t@79@0 null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap t@79@0 Node.Repr) Set@Empty$BoxType$)))
    (or (= call5formal@r@8 null) (and (= (dtype call5formal@r@8) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call5formal@r@8 alloc)))
...
(let ((anon36_Then@22 (=> (and true
    (= (Node.Height $Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@6 Node.right)) b@66@0)
...
(let ((anon36_Then@21 (=> (and true
    (= (Node.Height $Heap (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap t@6 Node.left)) a@65@0)
