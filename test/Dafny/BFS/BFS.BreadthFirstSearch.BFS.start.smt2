...
(let ((anon70_Then@1_assertion (and
...
(let ((anon70_Then@2_assertion (and
    (MapRead$$@Map@@BoxType@To@Bool@@$ AllVertices@8 source@6)
)))
...
(let ((anon50_LoopBody (=> (and true
  )
    (and anon51_Else anon51_Then)
)))
(let ((anon50_LoopHead (=> (and true
