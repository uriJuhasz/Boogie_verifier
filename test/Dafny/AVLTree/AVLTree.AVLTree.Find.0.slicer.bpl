...
var $Heap : HeapType;
var $Tick : TickType;
procedure AVLTree.Find (this : ref,key#1 : int) returns (b#2 : bool)
{
...
PreconditionGeneratedEntry:
	...
	assume (t#3 == null) || (read($Heap,t#3,alloc) && (dtype(t#3) == class.Node));
	assume (0 == $ModuleContextHeight) && $InMethodContext;
	assume (((((((AVLTree.Valid#canCall($Heap,this) && AVLTree.Valid($Heap,this)) && (!(read($Heap,this,AVLTree.root) == null))) && read($Heap,this,AVLTree.Repr)[$Box(read($Heap,this,AVLTree.root))]) && Set#Equal(read($Heap,this,AVLTree.Repr),read($Heap,read($Heap,this,AVLTree.root),Node.Repr))) && Set#Equal(read($Heap,this,AVLTree.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents))) && Node.Valid($Heap,read($Heap,this,AVLTree.root))) && Node.BalanceValid($Heap,read($Heap,this,AVLTree.root))) && Node.Balanced($Heap,read($Heap,this,AVLTree.root));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || (!(read($Heap,this,AVLTree.root) == null)));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || read($Heap,this,AVLTree.Repr)[$Box(read($Heap,this,AVLTree.root))]);
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || Set#Equal(read($Heap,this,AVLTree.Repr),read($Heap,read($Heap,this,AVLTree.root),Node.Repr)));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || Set#Equal(read($Heap,this,AVLTree.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents)));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || Node.Valid($Heap,read($Heap,this,AVLTree.root)));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || Node.BalanceValid($Heap,read($Heap,this,AVLTree.root)));
	assume AVLTree.Valid#canCall($Heap,this) ==> (AVLTree.Valid($Heap,this) || Node.Balanced($Heap,read($Heap,this,AVLTree.root)));
	goto anon0;
anon0:
	assume $_Frame_$_0 == lambda#4(alloc,null,$Heap);
	assume true;
	assume true;
	assume t#3_$_0 == read($Heap,this,AVLTree.root);
	assume true;
	assume $decr0$init$0_$_0 == read($Heap,t#3_$_0,Node.Repr);
	assert  $w0_$_0 ==> (!(t#3_$_0 == null));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> read($Heap,t#3_$_0,Node.Repr)[$Box(t#3_$_0)])));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> (!read($Heap,t#3_$_0,Node.Repr)[$Box(null)]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.left) == null)) ==> read($Heap,t#3_$_0,Node.Repr)[$Box(read($Heap,t#3_$_0,Node.left))]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.left) == null)) ==> (!read($Heap,read($Heap,t#3_$_0,Node.left),Node.Repr)[$Box(t#3_$_0)])))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.left) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_0,Node.left),Node.Repr),read($Heap,t#3_$_0,Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.right) == null)) ==> read($Heap,t#3_$_0,Node.Repr)[$Box(read($Heap,t#3_$_0,Node.right))]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.right) == null)) ==> (!read($Heap,read($Heap,t#3_$_0,Node.right),Node.Repr)[$Box(t#3_$_0)])))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.right) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_0,Node.right),Node.Repr),read($Heap,t#3_$_0,Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_0,Node.left)))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_0,Node.right)))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> (((!(read($Heap,t#3_$_0,Node.right) == null)) && (!(read($Heap,t#3_$_0,Node.left) == null))) ==> Set#Disjoint(read($Heap,read($Heap,t#3_$_0,Node.left),Node.Repr),read($Heap,read($Heap,t#3_$_0,Node.right),Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> Set#Equal(read($Heap,t#3_$_0,Node.Repr),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(t#3_$_0)),if (!(read($Heap,t#3_$_0,Node.left) == null)) then read($Heap,read($Heap,t#3_$_0,Node.left),Node.Repr) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_0,Node.right) == null)) then read($Heap,read($Heap,t#3_$_0,Node.right),Node.Repr) else (Set#Empty() : Set (BoxType) ))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> Set#Equal(read($Heap,t#3_$_0,Node.Contents),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(read($Heap,t#3_$_0,Node.value))),if (!(read($Heap,t#3_$_0,Node.left) == null)) then read($Heap,read($Heap,t#3_$_0,Node.left),Node.Contents) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_0,Node.right) == null)) then read($Heap,read($Heap,t#3_$_0,Node.right),Node.Contents) else (Set#Empty() : Set (BoxType) ))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.left) == null)) ==> ((forall  i#16_$3 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_0,Node.left),Node.Contents)[$Box(i#16_$3)] ==> (i#16_$3 < read($Heap,t#3_$_0,Node.value))) )))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_0) ==> (Node.Valid($Heap,t#3_$_0) || ((!(t#3_$_0 == null)) ==> ((!(read($Heap,t#3_$_0,Node.right) == null)) ==> ((forall  i#17_$2 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_0,Node.right),Node.Contents)[$Box(i#17_$2)] ==> (read($Heap,t#3_$_0,Node.value) < i#17_$2)) )))))));
	assert  $w0_$_0 ==> (!(read($Heap,this,AVLTree.Contents)[$Box(key#1)] && (!read($Heap,t#3_$_0,Node.Contents)[$Box(key#1)])));
	assert  $w0_$_0 ==> Set#Subset(read($Heap,t#3_$_0,Node.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents));
	goto anon17_LoopHead;
anon17_LoopHead:
	assume (t#3_$_1 == null) || (read($Heap,t#3_$_1,alloc) && (dtype(t#3_$_1) == class.Node));
	assume true;
	assume $w0_$_0 ==> ((!(t#3_$_1 == null)) ==> Node.Valid#canCall($Heap,t#3_$_1));
	assume $w0_$_0 ==> (!(t#3_$_1 == null));
	assume $w0_$_0 ==> ((Node.Valid#canCall($Heap,t#3_$_1) && Node.Valid($Heap,t#3_$_1)) && ((!(t#3_$_1 == null)) ==> ((((((((((read($Heap,t#3_$_1,Node.Repr)[$Box(t#3_$_1)] && (!read($Heap,t#3_$_1,Node.Repr)[$Box(null)])) && ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> ((read($Heap,t#3_$_1,Node.Repr)[$Box(read($Heap,t#3_$_1,Node.left))] && (!read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr)[$Box(t#3_$_1)])) && Set#Subset(read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr),read($Heap,t#3_$_1,Node.Repr))))) && ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> ((read($Heap,t#3_$_1,Node.Repr)[$Box(read($Heap,t#3_$_1,Node.right))] && (!read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr)[$Box(t#3_$_1)])) && Set#Subset(read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr),read($Heap,t#3_$_1,Node.Repr))))) && Node.Valid($Heap,read($Heap,t#3_$_1,Node.left))) && Node.Valid($Heap,read($Heap,t#3_$_1,Node.right))) && (((!(read($Heap,t#3_$_1,Node.right) == null)) && (!(read($Heap,t#3_$_1,Node.left) == null))) ==> Set#Disjoint(read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr),read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr)))) && Set#Equal(read($Heap,t#3_$_1,Node.Repr),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(t#3_$_1)),if (!(read($Heap,t#3_$_1,Node.left) == null)) then read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_1,Node.right) == null)) then read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr) else (Set#Empty() : Set (BoxType) )))) && Set#Equal(read($Heap,t#3_$_1,Node.Contents),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(read($Heap,t#3_$_1,Node.value))),if (!(read($Heap,t#3_$_1,Node.left) == null)) then read($Heap,read($Heap,t#3_$_1,Node.left),Node.Contents) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_1,Node.right) == null)) then read($Heap,read($Heap,t#3_$_1,Node.right),Node.Contents) else (Set#Empty() : Set (BoxType) )))) && ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> ((forall  i#16_$4 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_1,Node.left),Node.Contents)[$Box(i#16_$4)] ==> (i#16_$4 < read($Heap,t#3_$_1,Node.value))) ))))) && ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> ((forall  i#17_$3 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_1,Node.right),Node.Contents)[$Box(i#17_$3)] ==> (read($Heap,t#3_$_1,Node.value) < i#17_$3)) )))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> read($Heap,t#3_$_1,Node.Repr)[$Box(t#3_$_1)])));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> (!read($Heap,t#3_$_1,Node.Repr)[$Box(null)]))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> read($Heap,t#3_$_1,Node.Repr)[$Box(read($Heap,t#3_$_1,Node.left))]))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> (!read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr)[$Box(t#3_$_1)])))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr),read($Heap,t#3_$_1,Node.Repr))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> read($Heap,t#3_$_1,Node.Repr)[$Box(read($Heap,t#3_$_1,Node.right))]))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> (!read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr)[$Box(t#3_$_1)])))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr),read($Heap,t#3_$_1,Node.Repr))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_1,Node.left)))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_1,Node.right)))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> (((!(read($Heap,t#3_$_1,Node.right) == null)) && (!(read($Heap,t#3_$_1,Node.left) == null))) ==> Set#Disjoint(read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr),read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> Set#Equal(read($Heap,t#3_$_1,Node.Repr),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(t#3_$_1)),if (!(read($Heap,t#3_$_1,Node.left) == null)) then read($Heap,read($Heap,t#3_$_1,Node.left),Node.Repr) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_1,Node.right) == null)) then read($Heap,read($Heap,t#3_$_1,Node.right),Node.Repr) else (Set#Empty() : Set (BoxType) ))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> Set#Equal(read($Heap,t#3_$_1,Node.Contents),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(read($Heap,t#3_$_1,Node.value))),if (!(read($Heap,t#3_$_1,Node.left) == null)) then read($Heap,read($Heap,t#3_$_1,Node.left),Node.Contents) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_1,Node.right) == null)) then read($Heap,read($Heap,t#3_$_1,Node.right),Node.Contents) else (Set#Empty() : Set (BoxType) ))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.left) == null)) ==> ((forall  i#16_$5 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_1,Node.left),Node.Contents)[$Box(i#16_$5)] ==> (i#16_$5 < read($Heap,t#3_$_1,Node.value))) )))))));
	assume $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_1) ==> (Node.Valid($Heap,t#3_$_1) || ((!(t#3_$_1 == null)) ==> ((!(read($Heap,t#3_$_1,Node.right) == null)) ==> ((forall  i#17_$4 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_1,Node.right),Node.Contents)[$Box(i#17_$4)] ==> (read($Heap,t#3_$_1,Node.value) < i#17_$4)) )))))));
	assume $w0_$_0 ==> true;
	assume $w0_$_0 ==> (!(read($Heap,this,AVLTree.Contents)[$Box(key#1)] && (!read($Heap,t#3_$_1,Node.Contents)[$Box(key#1)])));
	assume $w0_$_0 ==> true;
	assume $w0_$_0 ==> Set#Subset(read($Heap,t#3_$_1,Node.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents));
	assume (forall<alpha> $o_$41 : ref, $f_$36 : Field (alpha)  :: {read($Heap,$o_$41,$f_$36)} ( ((!($o_$41 == null)) && read($Heap,$o_$41,alloc)) ==> (read($Heap,$o_$41,$f_$36) == read($Heap,$o_$41,$f_$36)) ));
	assume $HeapSucc($Heap,$Heap);
	assume (forall<alpha> $o_$42 : ref, $f_$37 : Field (alpha)  :: {read($Heap,$o_$42,$f_$37)} ( ((!($o_$42 == null)) && read($Heap,$o_$42,alloc)) ==> ((read($Heap,$o_$42,$f_$37) == read($Heap,$o_$42,$f_$37)) || $_Frame_$_0[$o_$42,$f_$37]) ));
	assume Set#Subset(read($Heap,t#3_$_1,Node.Repr),$decr0$init$0_$_0) && (Set#Equal(read($Heap,t#3_$_1,Node.Repr),$decr0$init$0_$_0) ==> true);
	if ($_$_condition) { goto anon17_LoopDone; } else { goto anon17_LoopBody; }
anon17_LoopDone:
	assume !true;
	goto anon16;
anon17_LoopBody:
	assume true;
	if ($_$_condition_$0) { goto anon18_Then; } else { goto anon18_Else; }
anon16:
	assume true;
	assume b#2_$_0 <==> b#2;
...
anon18_Then:
	assume !$w0_$_0;
	if ($_$_condition_$1) { goto anon19_Then; } else { goto anon19_Else; }
anon18_Else:
	assume $w0_$_0;
	assume true;
	if ($_$_condition_$2) { goto anon20_Then; } else { goto anon20_Else; }
anon19_Then:
	assume !(t#3_$_1 == null);
	assume Node.Valid#canCall($Heap,t#3_$_1);
	goto anon4;
anon19_Else:
	assume t#3_$_1 == null;
	goto anon4;
...
anon20_Else:
	assume true;
	assume true;
	assume $decr0$0_$_1 == read($Heap,t#3_$_1,Node.Repr);
	assert  !(t#3_$_1 == null);
	assume true;
	if ($_$_condition_$3) { goto anon21_Then; } else { goto anon21_Else; }
anon4:
	assume (!(t#3_$_1 == null)) ==> Node.Valid#canCall($Heap,t#3_$_1);
	assume (!(t#3_$_1 == null)) && Node.Valid($Heap,t#3_$_1);
	assert  !(t#3_$_1 == null);
	assume true;
	assume !(read($Heap,this,AVLTree.Contents)[$Box(key#1)] && (!read($Heap,t#3_$_1,Node.Contents)[$Box(key#1)]));
	assert  !(t#3_$_1 == null);
	assert  !(read($Heap,this,AVLTree.root) == null);
	assume true;
	assume Set#Subset(read($Heap,t#3_$_1,Node.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents));
	assert  !(t#3_$_1 == null);
	assume true;
	assume false;
	assume b#2_$_0 <==> b#2;
	goto $exit;
anon21_Then:
	assume read($Heap,t#3_$_1,Node.value) == key#1;
	assert  !(t#3_$_1 == null);
	assert  !(t#3_$_1 == null);
	assume true;
	assert  read($Heap,t#3_$_1,Node.Contents)[$Box(read($Heap,t#3_$_1,Node.value))];
	assume true;
	assume true;
	assume true;
	assume b#2_$_0 <==> true;
...
anon21_Else:
	...
	assert  !(t#3_$_1 == null);
	assume true;
	if ($_$_condition_$4) { goto anon22_Then; } else { goto anon22_Else; }
GeneratedUnifiedExit:
	assert  read($Heap,this,AVLTree.Contents)[$Box(key#1)] <==> b#2_$_0;
	goto $exit;
anon22_Then:
	assume read($Heap,t#3_$_1,Node.value) < key#1;
	assume true;
	assert  !(t#3_$_1 == null);
	assume true;
	assume t#3_$_2 == read($Heap,t#3_$_1,Node.right);
	assume true;
	assume t#3_$_4 == t#3_$_2;
	goto anon12;
anon22_Else:
	assume key#1 <= read($Heap,t#3_$_1,Node.value);
	assume true;
	assert  !(t#3_$_1 == null);
	assume true;
	assume t#3_$_3 == read($Heap,t#3_$_1,Node.left);
	assume true;
	assume t#3_$_4 == t#3_$_3;
	goto anon12;
anon12:
	assume true;
	if ($_$_condition_$5) { goto anon23_Then; } else { goto anon23_Else; }
anon23_Then:
	assume t#3_$_4 == null;
	assume true;
	assume true;
	assume true;
	assume b#2_$_0 <==> false;
	goto GeneratedUnifiedExit;
anon23_Else:
	assume !(t#3_$_4 == null);
	assert  Set#Subset(read($Heap,t#3_$_4,Node.Repr),$decr0$0_$_1) && (!Set#Subset($decr0$0_$_1,read($Heap,t#3_$_4,Node.Repr)));
	assume (!(t#3_$_4 == null)) ==> Node.Valid#canCall($Heap,t#3_$_4);
	assume true;
	assume true;
	assert  $w0_$_0 ==> (!(t#3_$_4 == null));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> read($Heap,t#3_$_4,Node.Repr)[$Box(t#3_$_4)])));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> (!read($Heap,t#3_$_4,Node.Repr)[$Box(null)]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.left) == null)) ==> read($Heap,t#3_$_4,Node.Repr)[$Box(read($Heap,t#3_$_4,Node.left))]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.left) == null)) ==> (!read($Heap,read($Heap,t#3_$_4,Node.left),Node.Repr)[$Box(t#3_$_4)])))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.left) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_4,Node.left),Node.Repr),read($Heap,t#3_$_4,Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.right) == null)) ==> read($Heap,t#3_$_4,Node.Repr)[$Box(read($Heap,t#3_$_4,Node.right))]))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.right) == null)) ==> (!read($Heap,read($Heap,t#3_$_4,Node.right),Node.Repr)[$Box(t#3_$_4)])))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.right) == null)) ==> Set#Subset(read($Heap,read($Heap,t#3_$_4,Node.right),Node.Repr),read($Heap,t#3_$_4,Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_4,Node.left)))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> Node.Valid($Heap,read($Heap,t#3_$_4,Node.right)))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> (((!(read($Heap,t#3_$_4,Node.right) == null)) && (!(read($Heap,t#3_$_4,Node.left) == null))) ==> Set#Disjoint(read($Heap,read($Heap,t#3_$_4,Node.left),Node.Repr),read($Heap,read($Heap,t#3_$_4,Node.right),Node.Repr))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> Set#Equal(read($Heap,t#3_$_4,Node.Repr),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(t#3_$_4)),if (!(read($Heap,t#3_$_4,Node.left) == null)) then read($Heap,read($Heap,t#3_$_4,Node.left),Node.Repr) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_4,Node.right) == null)) then read($Heap,read($Heap,t#3_$_4,Node.right),Node.Repr) else (Set#Empty() : Set (BoxType) ))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> Set#Equal(read($Heap,t#3_$_4,Node.Contents),Set#Union(Set#Union(Set#UnionOne((Set#Empty() : Set (BoxType) ),$Box(read($Heap,t#3_$_4,Node.value))),if (!(read($Heap,t#3_$_4,Node.left) == null)) then read($Heap,read($Heap,t#3_$_4,Node.left),Node.Contents) else (Set#Empty() : Set (BoxType) )),if (!(read($Heap,t#3_$_4,Node.right) == null)) then read($Heap,read($Heap,t#3_$_4,Node.right),Node.Contents) else (Set#Empty() : Set (BoxType) ))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.left) == null)) ==> ((forall  i#16_$6 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_4,Node.left),Node.Contents)[$Box(i#16_$6)] ==> (i#16_$6 < read($Heap,t#3_$_4,Node.value))) )))))));
	assert  $w0_$_0 ==> (Node.Valid#canCall($Heap,t#3_$_4) ==> (Node.Valid($Heap,t#3_$_4) || ((!(t#3_$_4 == null)) ==> ((!(read($Heap,t#3_$_4,Node.right) == null)) ==> ((forall  i#17_$5 : Integer :: ( true ==> (read($Heap,read($Heap,t#3_$_4,Node.right),Node.Contents)[$Box(i#17_$5)] ==> (read($Heap,t#3_$_4,Node.value) < i#17_$5)) )))))));
	assert  $w0_$_0 ==> (!(read($Heap,this,AVLTree.Contents)[$Box(key#1)] && (!read($Heap,t#3_$_4,Node.Contents)[$Box(key#1)])));
	assert  $w0_$_0 ==> Set#Subset(read($Heap,t#3_$_4,Node.Contents),read($Heap,read($Heap,this,AVLTree.root),Node.Contents));
	assume false;
	assume b#2_$_0 <==> b#2;
	goto $exit;
}
