...
;Axioms
   ...
   (assert (! (or $NP@78 $NP@79 (= call4formal@p@24@0 null)) :named ax_230))
   (assert (! (or (< call5formal@n@25@0 (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys))) (= call4formal@p@24@0 null)) :named ax_231))
   (assert (! (or (= $rhs@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)) :named ax_232))
   (assert (! (or (= $rhs@2 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) :named ax_233))
   (assert (! (or (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0)) call4formal@p@24@0) (= call4formal@p@24@0 null)) :named ax_234))
   (assert (! (or (= (dtype $rhs@0) class.Node) (= $rhs@0 null)) :named ax_235))
   (assert (! (or (= (dtype $rhs@2) class.Node) (= $rhs@2 null)) :named ax_236))
   (assert (! (or (= (dtype call4formal@p@24@0) class.Node) (= call4formal@p@24@0 null)) :named ax_237))
   (assert (! (or (= (dtype call6formal@prev@26@0) class.Node) (= null call6formal@prev@26@0)) :named ax_238))
   (assert (! (or (= (dtype p@20) class.Node) (= p@20 null)) :named ax_239))
   (assert (! (or (= (dtype prev@22) class.Node) (= prev@22 null)) :named ax_240))
   (assert (! (or (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16) (= call4formal@p@24@0 null)) :named ax_241))
   (assert (! (or (= call4formal@p@24@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)) :named ax_242))
   (assert (! (or (= call4formal@p@24@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)) :named ax_243))
   ...
   (assert (! (or (= p@20 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)) :named ax_246))
   (assert (! (or (= prev@22 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap prev@22 alloc)) :named ax_247))
   ...
   (assert (! (or (not (< call5formal@n@25@0 0)) (= call4formal@p@24@0 null)) :named ax_253))
   (assert (! (or (not (= 0 call5formal@n@25@0)) (not (= null call6formal@prev@26@0)) $NP@78) :named ax_254))
   (assert (! (or (not (= call4formal@p@24@0 null)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16))) :named ax_255))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) (+ call5formal@n@25@0 1)) key@16)) (= call4formal@p@24@0 null)) :named ax_256))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Take$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)) (= call4formal@p@24@0 null)) :named ax_257))
