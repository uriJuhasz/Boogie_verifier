...
;Axioms
   ...
   (assert (! (or (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0)) call4formal@p@24@0) (= null call4formal@p@24@0)) :named ax_231))
   (assert (! (or (= (dtype $rhs@0) class.Node) (= null $rhs@0)) :named ax_232))
   (assert (! (or (= (dtype $rhs@2) class.Node) (= null $rhs@2)) :named ax_233))
   (assert (! (or (= (dtype call4formal@p@24@0) class.Node) (= null call4formal@p@24@0)) :named ax_234))
   (assert (! (or (= (dtype call6formal@prev@26@0) class.Node) (= null call6formal@prev@26@0)) :named ax_235))
   (assert (! (or (= (dtype p@20) class.Node) (= null p@20)) :named ax_236))
   (assert (! (or (= (dtype prev@22) class.Node) (= null prev@22)) :named ax_237))
   (assert (! (or (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16) (= null call4formal@p@24@0)) :named ax_238))
   (assert (! (or (= null $rhs@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)) :named ax_239))
   (assert (! (or (= null $rhs@2) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) :named ax_240))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)) :named ax_241))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)) :named ax_242))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call6formal@prev@26@0 alloc)) :named ax_243))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call6formal@prev@26@0 alloc)) :named ax_244))
   (assert (! (or (= null p@20) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)) :named ax_245))
   ...
   (assert (! (or (not $NP@79) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))) call6formal@prev@26@0)) :named ax_250))
   (assert (! (or (not (< 0 call5formal@n@25@0)) (not (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))) call6formal@prev@26@0)) $NP@79) :named ax_251))
   (assert (! (or (not (< call5formal@n@25@0 0)) (= null call4formal@p@24@0)) :named ax_252))
   (assert (! (or (not (= 0 call5formal@n@25@0)) (not (= null call6formal@prev@26@0)) $NP@78) :named ax_253))
   (assert (! (or (not (= null call4formal@p@24@0)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16))) :named ax_254))
