...
;Axioms
   ...
   (assert (! (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) (- 1))) :named ax_11))
   (assert (! (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Values))) :named ax_12))
   (assert (! (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) 1)) :named ax_13))
   (assert (! (= 0 $ModuleContextHeight) :named ax_14))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ Map.Repr)) :named ax_15))
   (assert (! (= 0 (FDim$Bool$ alloc)) :named ax_16))
   (assert (! (= 0 (FDim$BoxType$ Node.key)) :named ax_17))
   (assert (! (= 0 (FDim$BoxType$ Node.val)) :named ax_18))
   (assert (! (= 0 (FDim$ref$ Map.head)) :named ax_19))
   (assert (! (= 0 (FDim$ref$ Node.next)) :named ax_20))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.Keys)) :named ax_21))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.nodes)) :named ax_22))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.Values)) :named ax_23))
   (assert (! (= 0 (Seq@Length$BoxType$ Seq@Empty$BoxType$)) :named ax_24))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_25))
   (assert (! (= class.Map (DeclType$$@Map@@BoxType@To@Bool@@$ Map.Repr)) :named ax_26))
   (assert (! (= class.Map (DeclType$ref$ Map.head)) :named ax_27))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.Keys)) :named ax_28))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.nodes)) :named ax_29))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.Values)) :named ax_30))
   (assert (! (= class.Map (dtype this)) :named ax_31))
   (assert (! (= class.Node (DeclType$BoxType$ Node.key)) :named ax_32))
   (assert (! (= class.Node (DeclType$BoxType$ Node.val)) :named ax_33))
   (assert (! (= class.Node (DeclType$ref$ Node.next)) :named ax_34))
   (assert (! (= false $@bf_23) :named ax_35))
   (assert (! (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys))))) :named ax_36))
   (assert (! (= true $@bf_22) :named ax_37))
   ...
   (assert (! (forall( (|r_$3| ref) (|h_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and (or (= |r_$3| null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$7| |r_$3| alloc)) ($IsGoodHeap |h_$7|)) (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|))  :pattern ( (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|)))) :named ax_143))
   (assert (! (forall( (|s_$0_$0| Seq$ref$))(!(=> (= (Seq@Length$ref$ |s_$0_$0|) 0) (= |s_$0_$0| Seq@Empty$ref$))  :pattern ( (Seq@Length$ref$ |s_$0_$0|)))) :named ax_144))
   (assert (! (forall( (|s_$0_$1| Seq$BoxType$))(!(=> (= (Seq@Length$BoxType$ |s_$0_$1|) 0) (= |s_$0_$1| Seq@Empty$BoxType$))  :pattern ( (Seq@Length$BoxType$ |s_$0_$1|)))) :named ax_145))
   (assert (! (forall( (|s_$1_$0| Seq$ref$) (|i_$12| Int) (|v_$0_$0| ref) (|len_$2| Int))(!(=> (<= 0 |len_$2|) (= (Seq@Length$ref$ (Seq@Build$ref$ |s_$1_$0| |i_$12| |v_$0_$0| |len_$2|)) |len_$2|))  :pattern ( (Seq@Length$ref$ (Seq@Build$ref$ |s_$1_$0| |i_$12| |v_$0_$0| |len_$2|))))) :named ax_146))
   (assert (! (forall( (|s_$1_$1| Seq$BoxType$) (|i_$13| Int) (|v_$0_$1| BoxType) (|len_$3| Int))(!(=> (<= 0 |len_$3|) (= (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$1_$1| |i_$13| |v_$0_$1| |len_$3|)) |len_$3|))  :pattern ( (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$1_$1| |i_$13| |v_$0_$1| |len_$3|))))) :named ax_147))
   (assert (! (forall( (|s_$10_$0| Seq$ref$) (|n_$6_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (Seq@Length$ref$ |s_$10_$0|)) (and (< |j_$2_$0| |n_$6_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|) (Seq@Index$ref$ |s_$10_$0| |j_$2_$0|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|)))) :named ax_148))
   (assert (! (forall( (|s_$10_$1| Seq$BoxType$) (|n_$6_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (Seq@Length$BoxType$ |s_$10_$1|)) (and (< |j_$2_$1| |n_$6_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|) (Seq@Index$BoxType$ |s_$10_$1| |j_$2_$1|)))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|)))) :named ax_149))
   (assert (! (forall( (|s_$11_$0| Seq$ref$) (|n_$7_$0| Int))(!(=> (<= 0 |n_$7_$0|) (and (=> (< (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) 0)) (=> (<= |n_$7_$0| (Seq@Length$ref$ |s_$11_$0|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) (- (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|))))) :named ax_150))
   (assert (! (forall( (|s_$11_$1| Seq$BoxType$) (|n_$7_$1| Int))(!(=> (<= 0 |n_$7_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) 0)) (=> (<= |n_$7_$1| (Seq@Length$BoxType$ |s_$11_$1|)) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) (- (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|)))))  :pattern ( (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|))))) :named ax_151))
   (assert (! (forall( (|s_$12_$0| Seq$ref$) (|n_$8_$0| Int) (|j_$3_$0| Int))(!(=> (and (< |j_$3_$0| (- (Seq@Length$ref$ |s_$12_$0|) |n_$8_$0|)) (and (<= 0 |n_$8_$0|) (<= 0 |j_$3_$0|))) (= (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|) (Seq@Index$ref$ |s_$12_$0| (+ |j_$3_$0| |n_$8_$0|))))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|)))) :named ax_152))
   (assert (! (forall( (|s_$12_$1| Seq$BoxType$) (|n_$8_$1| Int) (|j_$3_$1| Int))(!(=> (and (< |j_$3_$1| (- (Seq@Length$BoxType$ |s_$12_$1|) |n_$8_$1|)) (and (<= 0 |n_$8_$1|) (<= 0 |j_$3_$1|))) (= (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|) (Seq@Index$BoxType$ |s_$12_$1| (+ |j_$3_$1| |n_$8_$1|))))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|)))) :named ax_153))
   (assert (! (forall( (|s_$13_$0| Seq$ref$) (|t_$1_$0| Seq$ref$))(!(and (= |t_$1_$0| (Seq@Drop$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|))) (= (Seq@Take$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|)) |s_$13_$0|))  :pattern ( (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|)))) :named ax_154))
   (assert (! (forall( (|s_$13_$1| Seq$BoxType$) (|t_$1_$1| Seq$BoxType$))(!(and (= |t_$1_$1| (Seq@Drop$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|))) (= (Seq@Take$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|)) |s_$13_$1|))  :pattern ( (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|)))) :named ax_155))
   (assert (! (forall( (|s_$14| Seq$ref$))(!(<= 0 (Seq@Length$ref$ |s_$14|))  :pattern ( (Seq@Length$ref$ |s_$14|)))) :named ax_156))
   (assert (! (forall( (|s_$15| Seq$BoxType$))(!(<= 0 (Seq@Length$BoxType$ |s_$15|))  :pattern ( (Seq@Length$BoxType$ |s_$15|)))) :named ax_157))
   (assert (! (forall( (|s_$2_$0| Seq$ref$) (|i_$0_$0| Int) (|v_$1_$0| ref) (|len_$0_$0| Int) (|n_$0_$0| Int))(!(=> (and (< |n_$0_$0| |len_$0_$0|) (<= 0 |n_$0_$0|)) (and (=> (= |n_$0_$0| |i_$0_$0|) (= |v_$1_$0| (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|))) (=> (not (= |n_$0_$0| |i_$0_$0|)) (= (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|) (Seq@Index$ref$ |s_$2_$0| |n_$0_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|)))) :named ax_158))
   (assert (! (forall( (|s_$2_$1| Seq$BoxType$) (|i_$0_$1| Int) (|v_$1_$1| BoxType) (|len_$0_$1| Int) (|n_$0_$1| Int))(!(=> (and (< |n_$0_$1| |len_$0_$1|) (<= 0 |n_$0_$1|)) (and (=> (= |n_$0_$1| |i_$0_$1|) (= |v_$1_$1| (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|))) (=> (not (= |n_$0_$1| |i_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|) (Seq@Index$BoxType$ |s_$2_$1| |n_$0_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|)))) :named ax_159))
   (assert (! (forall( (|s_$3_$0| Seq$ref$) (|i_$1_$0| Int) (|v_$2_$0| ref))(!(=> (and (< |i_$1_$0| (Seq@Length$ref$ |s_$3_$0|)) (<= 0 |i_$1_$0|)) (= (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|)) (Seq@Length$ref$ |s_$3_$0|)))  :pattern ( (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|))))) :named ax_160))
   (assert (! (forall( (|s_$3_$1| Seq$BoxType$) (|i_$1_$1| Int) (|v_$2_$1| BoxType))(!(=> (and (< |i_$1_$1| (Seq@Length$BoxType$ |s_$3_$1|)) (<= 0 |i_$1_$1|)) (= (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|)) (Seq@Length$BoxType$ |s_$3_$1|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|))))) :named ax_161))
   (assert (! (forall( (|s_$4_$0| Seq$ref$) (|i_$2_$0| Int) (|v_$3_$0| ref) (|n_$1_$0| Int))(!(=> (and (< |n_$1_$0| (Seq@Length$ref$ |s_$4_$0|)) (<= 0 |n_$1_$0|)) (and (=> (= |n_$1_$0| |i_$2_$0|) (= |v_$3_$0| (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|))) (=> (not (= |n_$1_$0| |i_$2_$0|)) (= (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|) (Seq@Index$ref$ |s_$4_$0| |n_$1_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|)))) :named ax_162))
   (assert (! (forall( (|s_$4_$1| Seq$BoxType$) (|i_$2_$1| Int) (|v_$3_$1| BoxType) (|n_$1_$1| Int))(!(=> (and (< |n_$1_$1| (Seq@Length$BoxType$ |s_$4_$1|)) (<= 0 |n_$1_$1|)) (and (=> (= |n_$1_$1| |i_$2_$1|) (= |v_$3_$1| (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|))) (=> (not (= |n_$1_$1| |i_$2_$1|)) (= (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|) (Seq@Index$BoxType$ |s_$4_$1| |n_$1_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|)))) :named ax_163))
   (assert (! (forall( (|s_$5_$0| Seq$ref$) (|x_$2_$0| ref))(!(= (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|) (exists( (|i_$3_$1| Int))(!(and (= |x_$2_$0| (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)) (and (< |i_$3_$1| (Seq@Length$ref$ |s_$5_$0|)) (<= 0 |i_$3_$1|)))  :pattern ( (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)))))  :pattern ( (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|)))) :named ax_164))
   (assert (! (forall( (|s_$5_$1| Seq$BoxType$) (|x_$2_$1| BoxType))(!(= (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|) (exists( (|i_$3_$3| Int))(!(and (= |x_$2_$1| (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)) (and (< |i_$3_$3| (Seq@Length$BoxType$ |s_$5_$1|)) (<= 0 |i_$3_$3|)))  :pattern ( (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)))))  :pattern ( (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|)))) :named ax_165))
   (assert (! (forall( (|s_$6_$0| Seq$ref$) (|i_$4_$0| Int) (|v_$4_$0| ref) (|len_$1_$0| Int) (|x_$5_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Build$ref$ |s_$6_$0| |i_$4_$0| |v_$4_$0| |len_$1_$0|) |x_$5_$0|) (or (and (= |x_$5_$0| |v_$4_$0|) (and (< |i_$4_$0| |len_$1_$0|) (<= 0 |i_$4_$0|))) (exists( (|j_$5| Int))(!(and (= |x_$5_$0| (Seq@Index$ref$ |s_$6_$0| |j_$5|)) (and (and (< |j_$5| |len_$1_$0|) (and (< |j_$5| (Seq@Length$ref$ |s_$6_$0|)) (<= 0 |j_$5|))) (not (= |j_$5| |i_$4_$0|))))  :pattern ( (Seq@Index$ref$ |s_$6_$0| |j_$5|))))))  :pattern ( (Seq@Contains$ref$ (Seq@Build$ref$ |s_$6_$0| |i_$4_$0| |v_$4_$0| |len_$1_$0|) |x_$5_$0|)))) :named ax_166))
   (assert (! (forall( (|s_$6_$1| Seq$BoxType$) (|i_$4_$1| Int) (|v_$4_$1| BoxType) (|len_$1_$1| Int) (|x_$5_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$6_$1| |i_$4_$1| |v_$4_$1| |len_$1_$1|) |x_$5_$1|) (or (and (= |x_$5_$1| |v_$4_$1|) (and (< |i_$4_$1| |len_$1_$1|) (<= 0 |i_$4_$1|))) (exists( (|j_$7| Int))(!(and (= |x_$5_$1| (Seq@Index$BoxType$ |s_$6_$1| |j_$7|)) (and (and (< |j_$7| |len_$1_$1|) (and (< |j_$7| (Seq@Length$BoxType$ |s_$6_$1|)) (<= 0 |j_$7|))) (not (= |j_$7| |i_$4_$1|))))  :pattern ( (Seq@Index$BoxType$ |s_$6_$1| |j_$7|))))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$6_$1| |i_$4_$1| |v_$4_$1| |len_$1_$1|) |x_$5_$1|)))) :named ax_167))
   (assert (! (forall( (|s_$7_$0| Seq$ref$) (|n_$2_$0| Int) (|x_$6_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Take$ref$ |s_$7_$0| |n_$2_$0|) |x_$6_$0|) (exists( (|i_$5_$1| Int))(!(and (= |x_$6_$0| (Seq@Index$ref$ |s_$7_$0| |i_$5_$1|)) (and (< |i_$5_$1| (Seq@Length$ref$ |s_$7_$0|)) (and (< |i_$5_$1| |n_$2_$0|) (<= 0 |i_$5_$1|))))  :pattern ( (Seq@Index$ref$ |s_$7_$0| |i_$5_$1|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Take$ref$ |s_$7_$0| |n_$2_$0|) |x_$6_$0|)))) :named ax_168))
   (assert (! (forall( (|s_$7_$1| Seq$BoxType$) (|n_$2_$1| Int) (|x_$6_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$7_$1| |n_$2_$1|) |x_$6_$1|) (exists( (|i_$5_$3| Int))(!(and (= |x_$6_$1| (Seq@Index$BoxType$ |s_$7_$1| |i_$5_$3|)) (and (< |i_$5_$3| (Seq@Length$BoxType$ |s_$7_$1|)) (and (< |i_$5_$3| |n_$2_$1|) (<= 0 |i_$5_$3|))))  :pattern ( (Seq@Index$BoxType$ |s_$7_$1| |i_$5_$3|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$7_$1| |n_$2_$1|) |x_$6_$1|)))) :named ax_169))
   (assert (! (forall( (|s_$8_$0| Seq$ref$) (|n_$3_$0| Int) (|x_$7_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$8_$0| |n_$3_$0|) |x_$7_$0|) (exists( (|i_$6_$1| Int))(!(and (= |x_$7_$0| (Seq@Index$ref$ |s_$8_$0| |i_$6_$1|)) (and (< |i_$6_$1| (Seq@Length$ref$ |s_$8_$0|)) (and (<= |n_$3_$0| |i_$6_$1|) (<= 0 |n_$3_$0|))))  :pattern ( (Seq@Index$ref$ |s_$8_$0| |i_$6_$1|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$8_$0| |n_$3_$0|) |x_$7_$0|)))) :named ax_170))
   (assert (! (forall( (|s_$8_$1| Seq$BoxType$) (|n_$3_$1| Int) (|x_$7_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$8_$1| |n_$3_$1|) |x_$7_$1|) (exists( (|i_$6_$3| Int))(!(and (= |x_$7_$1| (Seq@Index$BoxType$ |s_$8_$1| |i_$6_$3|)) (and (< |i_$6_$3| (Seq@Length$BoxType$ |s_$8_$1|)) (and (<= |n_$3_$1| |i_$6_$3|) (<= 0 |n_$3_$1|))))  :pattern ( (Seq@Index$BoxType$ |s_$8_$1| |i_$6_$3|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$8_$1| |n_$3_$1|) |x_$7_$1|)))) :named ax_171))
   (assert (! (forall( (|s_$9_$0| Seq$ref$) (|n_$5_$0| Int))(!(=> (<= 0 |n_$5_$0|) (and (=> (< (Seq@Length$ref$ |s_$9_$0|) |n_$5_$0|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) (Seq@Length$ref$ |s_$9_$0|))) (=> (<= |n_$5_$0| (Seq@Length$ref$ |s_$9_$0|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) |n_$5_$0|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|))))) :named ax_172))
   (assert (! (forall( (|s_$9_$1| Seq$BoxType$) (|n_$5_$1| Int))(!(=> (<= 0 |n_$5_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$9_$1|) |n_$5_$1|) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) (Seq@Length$BoxType$ |s_$9_$1|))) (=> (<= |n_$5_$1| (Seq@Length$BoxType$ |s_$9_$1|)) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) |n_$5_$1|))))  :pattern ( (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|))))) :named ax_173))
   (assert (! (forall( (|s0_$0_$0| Seq$ref$) (|s1_$0_$0| Seq$ref$) (|n_$9| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$0|) |n_$9|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s1_$0_$0| (- |n_$9| (Seq@Length$ref$ |s0_$0_$0|))))) (=> (< |n_$9| (Seq@Length$ref$ |s0_$0_$0|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s0_$0_$0| |n_$9|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|)))) :named ax_174))
   (assert (! (forall( (|s0_$0_$1| Seq$BoxType$) (|s1_$0_$1| Seq$BoxType$) (|n_$10| Int))(!(and (=> (<= (Seq@Length$BoxType$ |s0_$0_$1|) |n_$10|) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s1_$0_$1| (- |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|))))) (=> (< |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s0_$0_$1| |n_$10|))))  :pattern ( (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|)))) :named ax_175))
   (assert (! (forall( (|s0_$1_$0| Seq$ref$) (|s1_$1_$0| Seq$ref$) (|x_$4_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|) (or (Seq@Contains$ref$ |s1_$1_$0| |x_$4_$0|) (Seq@Contains$ref$ |s0_$1_$0| |x_$4_$0|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|)))) :named ax_176))
   (assert (! (forall( (|s0_$1_$1| Seq$BoxType$) (|s1_$1_$1| Seq$BoxType$) (|x_$4_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|) (or (Seq@Contains$BoxType$ |s1_$1_$1| |x_$4_$1|) (Seq@Contains$BoxType$ |s0_$1_$1| |x_$4_$1|)))  :pattern ( (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|)))) :named ax_177))
   (assert (! (forall( (|s0_$2_$0| Seq$ref$) (|s1_$2_$0| Seq$ref$))(!(= (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$ref$ |s1_$2_$0|) (Seq@Length$ref$ |s0_$2_$0|)) (forall( (|j_$0_$1| Int))(!(=> (and (< |j_$0_$1| (Seq@Length$ref$ |s0_$2_$0|)) (<= 0 |j_$0_$1|)) (= (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|) (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)))  :pattern ( (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)) :pattern ( (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|))))))  :pattern ( (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|)))) :named ax_178))
   ...
   (assert (! (forall( (|s0_$4| Seq$ref$) (|s1_$4| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$4| |s1_$4|)) (+ (Seq@Length$ref$ |s0_$4|) (Seq@Length$ref$ |s1_$4|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$4| |s1_$4|))))) :named ax_180))
   (assert (! (forall( (|s0_$5| Seq$BoxType$) (|s1_$5| Seq$BoxType$))(!(= (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$5| |s1_$5|)) (+ (Seq@Length$BoxType$ |s0_$5|) (Seq@Length$BoxType$ |s1_$5|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$5| |s1_$5|))))) :named ax_181))
   (assert (! (forall( (|t_$0_$0| ref))(!(= |t_$0_$0| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0)))) :named ax_182))
   (assert (! (forall( (|t_$0_$1| BoxType))(!(= |t_$0_$1| (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0)))) :named ax_183))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_184))
   (assert (! (forall( (|t_$4| BoxType))(!(= (Seq@Length$BoxType$ (Seq@Singleton$BoxType$ |t_$4|)) 1)  :pattern ( (Seq@Length$BoxType$ (Seq@Singleton$BoxType$ |t_$4|))))) :named ax_185))
   (assert (! (forall( (|v_$5| Bool) (|f_$0_$0| Field$Bool$) (|r_$0_$0| ref) (|H_$0_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$5|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$5|))) :named ax_186))
   (assert (! (forall( (|v_$6| ref) (|f_$0_$1| Field$ref$) (|r_$0_$1| ref) (|H_$0_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$6|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$6|))) :named ax_187))
   (assert (! (forall( (|v_$7| BoxType) (|f_$0_$2| Field$BoxType$) (|r_$0_$2| ref) (|H_$0_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$7|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$7|))) :named ax_188))
   (assert (! (forall( (|v_$8| $@Map@@BoxType@To@Bool@@) (|f_$0_$3| Field$$@Map@@BoxType@To@Bool@@$) (|r_$0_$3| ref) (|H_$0_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$0_$3| |r_$0_$3| |f_$0_$3| |v_$8|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$0_$3| |r_$0_$3| |f_$0_$3| |v_$8|))) :named ax_189))
   (assert (! (forall( (|v_$9| Seq$BoxType$) (|f_$0_$4| Field$Seq$BoxType$$) (|r_$0_$4| ref) (|H_$0_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$0_$4| |r_$0_$4| |f_$0_$4| |v_$9|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$0_$4| |r_$0_$4| |f_$0_$4| |v_$9|))) :named ax_190))
   (assert (! (forall( (|x_$11| Int) (|y_$3| Int))(!(= (mod |x_$11| |y_$3|) (- |x_$11| (* (div |x_$11| |y_$3|) |y_$3|)))  :pattern ( (mod |x_$11| |y_$3|)) :pattern ( (div |x_$11| |y_$3|)))) :named ax_191))
   (assert (! (forall( (|x_$12| Int) (|y_$4| Int))(!(=> (< 0 |y_$4|) (and (<= 0 (mod |x_$12| |y_$4|)) (< (mod |x_$12| |y_$4|) |y_$4|)))  :pattern ( (mod |x_$12| |y_$4|)))) :named ax_192))
   (assert (! (forall( (|x_$13| Int) (|y_$5| Int))(!(=> (< |y_$5| 0) (and (< |y_$5| (mod |x_$13| |y_$5|)) (<= (mod |x_$13| |y_$5|) 0)))  :pattern ( (mod |x_$13| |y_$5|)))) :named ax_193))
   (assert (! (forall( (|x_$3| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$3|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$3|)))) :named ax_194))
   (assert (! (forall( (|x_$8_$0| Bool))(!(= |x_$8_$0| ($Unbox$Bool$ ($Box$Bool$ |x_$8_$0|)))  :pattern ( ($Box$Bool$ |x_$8_$0|)))) :named ax_195))
   (assert (! (forall( (|x_$8_$1| TickType))(!(= |x_$8_$1| ($Unbox$TickType$ ($Box$TickType$ |x_$8_$1|)))  :pattern ( ($Box$TickType$ |x_$8_$1|)))) :named ax_196))
   (assert (! (forall( (|x_$8_$10| Field$BoxType$))(!(= |x_$8_$10| ($Unbox$Field$BoxType$$ ($Box$Field$BoxType$$ |x_$8_$10|)))  :pattern ( ($Box$Field$BoxType$$ |x_$8_$10|)))) :named ax_197))
   (assert (! (forall( (|x_$8_$11| Field$Bool$))(!(= |x_$8_$11| ($Unbox$Field$Bool$$ ($Box$Field$Bool$$ |x_$8_$11|)))  :pattern ( ($Box$Field$Bool$$ |x_$8_$11|)))) :named ax_198))
   (assert (! (forall( (|x_$8_$12| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= |x_$8_$12| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|)))) :named ax_199))
   (assert (! (forall( (|x_$8_$13| Field$Seq$BoxType$$))(!(= |x_$8_$13| ($Unbox$Field$Seq$BoxType$$$ ($Box$Field$Seq$BoxType$$$ |x_$8_$13|)))  :pattern ( ($Box$Field$Seq$BoxType$$$ |x_$8_$13|)))) :named ax_200))
   (assert (! (forall( (|x_$8_$14| Field$$@Map@@BoxType@To@Bool@@$))(!(= |x_$8_$14| ($Unbox$Field$$@Map@@BoxType@To@Bool@@$$ ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|)))  :pattern ( ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|)))) :named ax_201))
   (assert (! (forall( (|x_$8_$15| Field$ref$))(!(= |x_$8_$15| ($Unbox$Field$ref$$ ($Box$Field$ref$$ |x_$8_$15|)))  :pattern ( ($Box$Field$ref$$ |x_$8_$15|)))) :named ax_202))
   (assert (! (forall( (|x_$8_$16| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= |x_$8_$16| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|)))) :named ax_203))
   (assert (! (forall( (|x_$8_$2| Int))(!(= |x_$8_$2| ($Unbox$Int$ ($Box$Int$ |x_$8_$2|)))  :pattern ( ($Box$Int$ |x_$8_$2|)))) :named ax_204))
   (assert (! (forall( (|x_$8_$3| Seq$ref$))(!(= |x_$8_$3| ($Unbox$Seq$ref$$ ($Box$Seq$ref$$ |x_$8_$3|)))  :pattern ( ($Box$Seq$ref$$ |x_$8_$3|)))) :named ax_205))
   (assert (! (forall( (|x_$8_$4| ref))(!(= |x_$8_$4| ($Unbox$ref$ ($Box$ref$ |x_$8_$4|)))  :pattern ( ($Box$ref$ |x_$8_$4|)))) :named ax_206))
   (assert (! (forall( (|x_$8_$5| BoxType))(!(= |x_$8_$5| ($Unbox$BoxType$ ($Box$BoxType$ |x_$8_$5|)))  :pattern ( ($Box$BoxType$ |x_$8_$5|)))) :named ax_207))
   (assert (! (forall( (|x_$8_$6| $@Map@@BoxType@To@Bool@@))(!(= |x_$8_$6| ($Unbox$$@Map@@BoxType@To@Bool@@$ ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|)))  :pattern ( ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|)))) :named ax_208))
   (assert (! (forall( (|x_$8_$7| Seq$BoxType$))(!(= |x_$8_$7| ($Unbox$Seq$BoxType$$ ($Box$Seq$BoxType$$ |x_$8_$7|)))  :pattern ( ($Box$Seq$BoxType$$ |x_$8_$7|)))) :named ax_209))
   (assert (! (forall( (|x_$8_$8| DatatypeType))(!(= |x_$8_$8| ($Unbox$DatatypeType$ ($Box$DatatypeType$ |x_$8_$8|)))  :pattern ( ($Box$DatatypeType$ |x_$8_$8|)))) :named ax_210))
   (assert (! (forall( (|x_$8_$9| ClassName))(!(= |x_$8_$9| ($Unbox$ClassName$ ($Box$ClassName$ |x_$8_$9|)))  :pattern ( ($Box$ClassName$ |x_$8_$9|)))) :named ax_211))
   (assert (! (forall( (|x_$9| Int) (|h_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$6|) (GenericAlloc ($Box$Int$ |x_$9|) |h_$6|))) :named ax_212))
   (assert (! (GenericAlloc key@16 $Heap) :named ax_213))
   (assert (! (Map.Valid $Heap this) :named ax_214))
   (assert (! (Map.Valid@canCall $Heap this) :named ax_215))
   (assert (! (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc) :named ax_216))
   (assert (! (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap this Map.Repr) ($Box$ref$ this)) :named ax_217))
   (assert (! (not ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_218))
   (assert (! (not (= class.Map class.Node)) :named ax_219))
   (assert (! (not (= class.Node class.Map)) :named ax_220))
   (assert (! (not (= Map.Keys Map.nodes)) :named ax_221))
   (assert (! (not (= Map.Keys Map.Values)) :named ax_222))
   (assert (! (not (= Map.nodes Map.Keys)) :named ax_223))
   (assert (! (not (= Map.nodes Map.Values)) :named ax_224))
   (assert (! (not (= Map.Values Map.Keys)) :named ax_225))
   (assert (! (not (= Map.Values Map.nodes)) :named ax_226))
   (assert (! (not (= Node.next Map.head)) :named ax_227))
   (assert (! (not (= Node.val Node.key)) :named ax_228))
   (assert (! (not (= this null)) :named ax_229))
   (assert (! (or $NP@78 $NP@79 (= null call4formal@p@24@0)) :named ax_230))
   (assert (! (or (< call5formal@n@25@0 (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys))) (= null call4formal@p@24@0)) :named ax_231))
   (assert (! (or (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0)) call4formal@p@24@0) (= null call4formal@p@24@0)) :named ax_232))
   (assert (! (or (= (dtype $rhs@0) class.Node) (= null $rhs@0)) :named ax_233))
   (assert (! (or (= (dtype $rhs@2) class.Node) (= null $rhs@2)) :named ax_234))
   (assert (! (or (= (dtype call4formal@p@24@0) class.Node) (= null call4formal@p@24@0)) :named ax_235))
   (assert (! (or (= (dtype call6formal@prev@26@0) class.Node) (= null call6formal@prev@26@0)) :named ax_236))
   (assert (! (or (= (dtype p@20) class.Node) (= null p@20)) :named ax_237))
   (assert (! (or (= (dtype prev@22) class.Node) (= null prev@22)) :named ax_238))
   (assert (! (or (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16) (= null call4formal@p@24@0)) :named ax_239))
   (assert (! (or (= null $rhs@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)) :named ax_240))
   (assert (! (or (= null $rhs@2) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) :named ax_241))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)) :named ax_242))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)) :named ax_243))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call6formal@prev@26@0 alloc)) :named ax_244))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call6formal@prev@26@0 alloc)) :named ax_245))
   (assert (! (or (= null p@20) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)) :named ax_246))
   (assert (! (or (= null prev@22) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap prev@22 alloc)) :named ax_247))
   (assert (! (or (not $NP@78) (= 0 call5formal@n@25@0)) :named ax_248))
   (assert (! (or (not $NP@78) (= null call6formal@prev@26@0)) :named ax_249))
   (assert (! (or (not $NP@79) (< 0 call5formal@n@25@0)) :named ax_250))
   (assert (! (or (not $NP@79) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))) call6formal@prev@26@0)) :named ax_251))
   (assert (! (or (not (< 0 call5formal@n@25@0)) (not (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))) call6formal@prev@26@0)) $NP@79) :named ax_252))
   (assert (! (or (not (< call5formal@n@25@0 0)) (= null call4formal@p@24@0)) :named ax_253))
   (assert (! (or (not (= 0 call5formal@n@25@0)) (not (= null call6formal@prev@26@0)) $NP@78) :named ax_254))
   (assert (! (or (not (= null call4formal@p@24@0)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16))) :named ax_255))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) (+ call5formal@n@25@0 1)) key@16)) (= null call4formal@p@24@0)) :named ax_256))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Take$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)) (= null call4formal@p@24@0)) :named ax_257))
