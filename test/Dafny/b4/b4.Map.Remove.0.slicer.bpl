...
anon0:
	...
	assume (call4formal_$_p#24 == null) || (read($Heap,call4formal_$_p#24,alloc) && (dtype(call4formal_$_p#24) == class.Node));
	assume (call6formal_$_prev#26 == null) || (read($Heap,call6formal_$_prev#26,alloc) && (dtype(call6formal_$_prev#26) == class.Node));
