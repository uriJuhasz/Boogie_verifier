...
(assert (! (=> $start (and true 
   (and true
      ...
      (=> (< 0 $ModuleContextHeight) (forall( (|$ly_$3| LayerType) (|$Heap_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$8| ref) (|k#0_$3| Int) (|S#1_$4| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$6| |this_$8| |k#0_$3| |S#1_$4|) (and (and (and (and (and (and ($IsGoodHeap |$Heap_$6|) (not (= |this_$8| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$6| |this_$8| alloc)) (= (dtype |this_$8|) class._module.Node)) (forall( (|$t#10| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$4| |$t#10|) (or (= ($Unbox$ref$ |$t#10|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$6| ($Unbox$ref$ |$t#10|) alloc) (= (dtype ($Unbox$ref$ |$t#10|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$4| |$t#10|))))) (_module.Node.IsClosed |$Heap_$6| |this_$8| |S#1_$4|)) (<= 0 |k#0_$3|))) true)  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$3|) |$Heap_$6| |this_$8| |k#0_$3| |S#1_$4|)))))
      (=> (< 0 $ModuleContextHeight) (forall( (|$ly_$8| LayerType) (|$Heap_$10| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$13| ref) (|sink#0_$4| ref) (|S#1_$9| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$10| |this_$13| |sink#0_$4| |S#1_$9|) (and (and (and (and (and (and ($IsGoodHeap |$Heap_$10|) (not (= |this_$13| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| |this_$13| alloc)) (= (dtype |this_$13|) class._module.Node)) (or (= |sink#0_$4| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| |sink#0_$4| alloc) (= (dtype |sink#0_$4|) class._module.Node)))) (forall( (|$t#16| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$9| |$t#16|) (or (= ($Unbox$ref$ |$t#16|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| ($Unbox$ref$ |$t#16|) alloc) (= (dtype ($Unbox$ref$ |$t#16|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$9| |$t#16|))))) (_module.Node.IsClosed |$Heap_$10| |this_$13| |S#1_$9|))) true)  :pattern ( (_module.Node.Reaches ($LS |$ly_$8|) |$Heap_$10| |this_$13| |sink#0_$4| |S#1_$9|)))))
      ...
      (=> (and (= 0 $ModuleContextHeight) (<= 1 $FunctionContextHeight)) (forall( (|$ly_$2| LayerType) (|$Heap_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$7| ref) (|k#0_$2| Int) (|S#1_$3| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| |k#0_$2| |S#1_$3|) (and (and (and (and (and (and (and (not (= 1 $FunctionContextHeight)) ($IsGoodHeap |$Heap_$5|)) (not (= |this_$7| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$5| |this_$7| alloc)) (= (dtype |this_$7|) class._module.Node)) (forall( (|$t#9| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$3| |$t#9|) (or (= ($Unbox$ref$ |$t#9|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$5| ($Unbox$ref$ |$t#9|) alloc) (= (dtype ($Unbox$ref$ |$t#9|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$3| |$t#9|))))) (_module.Node.IsClosed |$Heap_$5| |this_$7| |S#1_$3|)) (<= 0 |k#0_$2|))) (and (and (=> (= |k#0_$2| 0) true) (=> (not (= |k#0_$2| 0)) (and (and (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|) (=> (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|) null) true)) (=> (not (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|) null)) (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|))))) (= (_module.Node.Nexxxt ($LS |$ly_$2|) |$Heap_$5| |this_$7| |k#0_$2| |S#1_$3|) (ite (= |k#0_$2| 0) |this_$7| (ite (= (_module.Node.Nexxxt |$ly_$2| |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|) null) null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$5| (_module.Node.Nexxxt |$ly_$2| |$Heap_$5| |this_$7| (- |k#0_$2| 1) |S#1_$3|) _module.Node.next))))))  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$2|) |$Heap_$5| |this_$7| |k#0_$2| |S#1_$3|)))))
      (=> (and (= 0 $ModuleContextHeight) (<= 2 $FunctionContextHeight)) (forall( (|$ly_$7| LayerType) (|$Heap_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$12| ref) (|sink#0_$3| ref) (|S#1_$8| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|) (and (and (and (and (and (and (and (not (= 2 $FunctionContextHeight)) ($IsGoodHeap |$Heap_$9|)) (not (= |this_$12| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |this_$12| alloc)) (= (dtype |this_$12|) class._module.Node)) (or (= |sink#0_$3| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |sink#0_$3| alloc) (= (dtype |sink#0_$3|) class._module.Node)))) (forall( (|$t#15| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|) (or (= ($Unbox$ref$ |$t#15|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| ($Unbox$ref$ |$t#15|) alloc) (= (dtype ($Unbox$ref$ |$t#15|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|))))) (_module.Node.IsClosed |$Heap_$9| |this_$12| |S#1_$8|))) (and (forall( (|k#2| Int))(=> true (=> (<= 0 |k#2|) (_module.Node.Nexxxt@canCall |$Heap_$9| |this_$12| |k#2| |S#1_$8|)))) (= (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|) (exists( (|k#2_$0| Int))(and (<= 0 |k#2_$0|) (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$9| |this_$12| |k#2_$0| |S#1_$8|) |sink#0_$3|))))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|)))))
      ...
      (=> (or (< 0 $ModuleContextHeight) (and (= 0 $ModuleContextHeight) (<= 1 $FunctionContextHeight))) (forall( (|$ly_$1| LayerType) (|$Heap_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$6| ref) (|k#0_$1| Int) (|S#1_$2| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|) (and (and (and (and (and (and (and (or (not (= 0 $ModuleContextHeight)) (not (= 1 $FunctionContextHeight))) ($IsGoodHeap |$Heap_$4|)) (not (= |this_$6| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| |this_$6| alloc)) (= (dtype |this_$6|) class._module.Node)) (forall( (|$t#8| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| |$t#8|) (or (= ($Unbox$ref$ |$t#8|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| ($Unbox$ref$ |$t#8|) alloc) (= (dtype ($Unbox$ref$ |$t#8|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| |$t#8|))))) (_module.Node.IsClosed |$Heap_$4| |this_$6| |S#1_$2|)) (<= 0 |k#0_$1|))) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| ($Box$ref$ (_module.Node.Nexxxt ($LS $LZ) |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|))) (or (= (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|) alloc) (= (dtype (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|)) class._module.Node)))))  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$1| |S#1_$2|)))))
      (=> (or (< 0 $ModuleContextHeight) (and (= 0 $ModuleContextHeight) (<= 2 $FunctionContextHeight))) (forall( (|$ly_$6| LayerType) (|$Heap_$8| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$11| ref) (|sink#0_$2| ref) (|S#1_$7| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|) (and (and (and (and (and (and (and (or (not (= 0 $ModuleContextHeight)) (not (= 2 $FunctionContextHeight))) ($IsGoodHeap |$Heap_$8|)) (not (= |this_$11| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |this_$11| alloc)) (= (dtype |this_$11|) class._module.Node)) (or (= |sink#0_$2| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |sink#0_$2| alloc) (= (dtype |sink#0_$2|) class._module.Node)))) (forall( (|$t#14| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|) (or (= ($Unbox$ref$ |$t#14|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| ($Unbox$ref$ |$t#14|) alloc) (= (dtype ($Unbox$ref$ |$t#14|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|))))) (_module.Node.IsClosed |$Heap_$8| |this_$11| |S#1_$7|))) (=> (_module.Node.Reaches ($LS $LZ) |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| ($Box$ref$ |sink#0_$2|))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$6|) |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|)))))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (forall( (|$t#17| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#17|) (or (= ($Unbox$ref$ |$t#17|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#17|) alloc) (= (dtype ($Unbox$ref$ |$t#17|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#17|))))
      (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc)
      (not (= this null))
      (or (= sink@0 null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap sink@0 alloc) (= (dtype sink@0) class._module.Node)))
   )
anon0
...
(assert (! (=> anon7_Else (and true 
   (and true
      (= $_Frame@0 (lambda@2 S@1 null $Heap alloc))
      (not $@condition)
   )
...
(or anon9_Then@1 anon9_Then_assertion)
)) :named ax_anon9_Then))
...
(assert (! (=> anon9_Then@1 (and true 
   (and true
      (_module.Node.IsClosed $Heap this S@1)
      (<= 0 k@6@0)
   )
(or anon9_Then@1_assertion anon9_Then@2)
)) :named ax_anon9_Then@1))
(assert (! (=> anon9_Then_assertion (not (and true
   (and true
      (_module.Node.IsClosed $Heap this S@1)
      (<= 0 k@6@0)
   )
))) :named ax_anon9_Then_assertion))
...
(assert (! (=> anon6 (and true 
   (and true
      (= (_module.Node.Reaches ($LS $LZ) $Heap this sink@0 S@1) (exists( (|k#9| Int))(and (<= 0 |k#9|) (= (_module.Node.Nexxxt ($LS $LZ) $Heap this |k#9| S@1) sink@0))))
      (forall( (|k#9_$0| Int))(=> true (=> (<= 0 |k#9_$0|) (_module.Node.Nexxxt@canCall $Heap this |k#9_$0| S@1))))
   )
