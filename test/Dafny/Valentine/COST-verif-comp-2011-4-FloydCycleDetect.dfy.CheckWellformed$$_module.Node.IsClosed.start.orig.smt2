...
(declare-fun anon17_Then@1 ( ) Bool)
(declare-fun anon17_Then@1_assertion ( ) Bool)
(declare-fun anon17_Then_assertion ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (forall( (|$o_$3_$0| ref) (|$f_$2_$0| Field$Bool$) (|S#0_$4_$0| $@Map@@BoxType@To@Bool@@) (|null_$0_$0| ref) (|$Heap_$11_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$0_$0| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@0 |S#0_$4_$0| |null_$0_$0| |$Heap_$11_$0| |alloc_$0_$0|) |$o_$3_$0| |$f_$2_$0|) (=> (and (not (= |$o_$3_$0| |null_$0_$0|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$11_$0| |$o_$3_$0| |alloc_$0_$0|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$4_$0| ($Box$ref$ |$o_$3_$0|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@0 |S#0_$4_$0| |null_$0_$0| |$Heap_$11_$0| |alloc_$0_$0|) |$o_$3_$0| |$f_$2_$0|))))
      (forall( (|$o_$3_$1| ref) (|$f_$2_$1| Field$BoxType$) (|S#0_$4_$1| $@Map@@BoxType@To@Bool@@) (|null_$0_$1| ref) (|$Heap_$11_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$0_$1| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@0 |S#0_$4_$1| |null_$0_$1| |$Heap_$11_$1| |alloc_$0_$1|) |$o_$3_$1| |$f_$2_$1|) (=> (and (not (= |$o_$3_$1| |null_$0_$1|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$11_$1| |$o_$3_$1| |alloc_$0_$1|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$4_$1| ($Box$ref$ |$o_$3_$1|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@0 |S#0_$4_$1| |null_$0_$1| |$Heap_$11_$1| |alloc_$0_$1|) |$o_$3_$1| |$f_$2_$1|))))
      (forall( (|$o_$3_$2| ref) (|$f_$2_$2| Field$ref$) (|S#0_$4_$2| $@Map@@BoxType@To@Bool@@) (|null_$0_$2| ref) (|$Heap_$11_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$0_$2| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@0 |S#0_$4_$2| |null_$0_$2| |$Heap_$11_$2| |alloc_$0_$2|) |$o_$3_$2| |$f_$2_$2|) (=> (and (not (= |$o_$3_$2| |null_$0_$2|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$11_$2| |$o_$3_$2| |alloc_$0_$2|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$4_$2| ($Box$ref$ |$o_$3_$2|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@0 |S#0_$4_$2| |null_$0_$2| |$Heap_$11_$2| |alloc_$0_$2|) |$o_$3_$2| |$f_$2_$2|))))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (= 0 $ModuleContextHeight)
      (forall( (|$t#5| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#5|) (or (= ($Unbox$ref$ |$t#5|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#5|) alloc) (= (dtype ($Unbox$ref$ |$t#5|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#5|))))
...
(assert (! (=> anon12_Else (and true 
   (and true
      (= $_Frame@0 (lambda@0 S@0 null $Heap alloc))
      (not $@condition)
   )
...
(or anon17_Then@1 anon17_Then_assertion)
)) :named ax_anon17_Then))
(assert (! (=> anon17_Then@1 (and true 
   (and true
      (not (= n@2@0 null))
   )
anon17_Then@1_assertion
)) :named ax_anon17_Then@1))
(assert (! (=> anon17_Then_assertion (not (and true
   (and true
      (not (= n@2@0 null))
   )
))) :named ax_anon17_Then_assertion))
