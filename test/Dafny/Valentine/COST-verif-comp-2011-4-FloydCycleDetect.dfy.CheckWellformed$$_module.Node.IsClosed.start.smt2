...
(let ((anon17_Then_assertion (and
    (not (= null n@2@0))
)))
(let ((anon17_Then@1 (=> (and true
    (not (= null n@2@0))
  )
...
(let ((anon12_Else (=> (and true
    (= (lambda@0 S@0 null $Heap alloc) $_Frame@0)
  )
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (forall( (|$t#5| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#5|) (or (= null ($Unbox$ref$ |$t#5|)) (and (= (dtype ($Unbox$ref$ |$t#5|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#5|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#5|))))
