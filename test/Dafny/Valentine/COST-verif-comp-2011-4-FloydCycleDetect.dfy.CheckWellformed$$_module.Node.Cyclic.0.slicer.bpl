...
var $Heap : HeapType;
var $Tick : TickType;
procedure CheckWellformed$$_module.Node.Cyclic (this : ref,S#0 : Set (BoxType) ) returns (reachesCycle#1 : bool)
{
...
PreconditionGeneratedEntry:
	...
	assume ((forall  $t#18 : BoxType :: {S#0[$t#18]} ( S#0[$t#18] ==> ((($Unbox($t#18) : ref) == null) || (read($Heap,($Unbox($t#18) : ref),alloc) && (dtype(($Unbox($t#18) : ref)) == class._module.Node))) ))) && $IsGoodSet_Extended(S#0,null);
...
anon0:
	...
	assume (forall<alpha> $o_$26 : ref, $f_$25 : Field (alpha)  :: {read($Heap_$_0,$o_$26,$f_$25)} ( ((!($o_$26 == null)) && read($Heap,$o_$26,alloc)) ==> (read($Heap_$_0,$o_$26,$f_$25) == read($Heap,$o_$26,$f_$25)) ));
	assume $HeapSucc($Heap,$Heap_$_0);
	assume true;
	assume (n#3_$_0 == null) || (read($Heap_$_0,n#3_$_0,alloc) && (dtype(n#3_$_0) == class._module.Node));
	if ($_$_condition) { goto anon7_Then; } else { goto anon7_Else; }
anon7_Then:
	assume !(n#3_$_0 == null);
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0);
	assume _module.Node.Reaches#canCall($Heap_$_0,this,n#3_$_0,S#0);
	if ($_$_condition_$0) { goto anon8_Then; } else { goto anon8_Else; }
anon7_Else:
	assume n#3_$_0 == null;
	if ($_$_condition_$1) { goto anon8_Then; } else { goto anon8_Else; }
anon8_Then:
	assume (!(n#3_$_0 == null)) && _module.Node.Reaches($LS($LZ),$Heap_$_0,this,n#3_$_0,S#0);
	assert  !(n#3_$_0 == null);
	if ($_$_condition_$2) { goto anon9_Then; } else { goto anon9_Else; }
anon8_Else:
	assume !((!(n#3_$_0 == null)) && _module.Node.Reaches($LS($LZ),$Heap_$_0,this,n#3_$_0,S#0));
	if ($_$_condition_$3) { goto anon9_Then; } else { goto anon9_Else; }
anon9_Then:
	assume ((!(n#3_$_0 == null)) && _module.Node.Reaches($LS($LZ),$Heap_$_0,this,n#3_$_0,S#0)) && (!(read($Heap_$_0,n#3_$_0,_module.Node.next) == null));
	assert  !(n#3_$_0 == null);
	assert  !(read($Heap_$_0,n#3_$_0,_module.Node.next) == null);
	assert  _module.Node.IsClosed($Heap_$_0,read($Heap_$_0,n#3_$_0,_module.Node.next),S#0);
	assume _module.Node.Reaches#canCall($Heap_$_0,read($Heap_$_0,n#3_$_0,_module.Node.next),n#3_$_0,S#0);
	goto anon6;
anon9_Else:
	assume !(((!(n#3_$_0 == null)) && _module.Node.Reaches($LS($LZ),$Heap_$_0,this,n#3_$_0,S#0)) && (!(read($Heap_$_0,n#3_$_0,_module.Node.next) == null)));
	goto anon6;
anon6:
	assume reachesCycle#1_$_0 <==> ((exists  n#8 : ref :: ( (((((n#8 == null) || (read($Heap_$_0,n#8,alloc) && (dtype(n#8) == class._module.Node))) && (!(n#8 == null))) && _module.Node.Reaches($LS($LZ),$Heap_$_0,this,n#8,S#0)) && (!(read($Heap_$_0,n#8,_module.Node.next) == null))) && _module.Node.Reaches($LS($LZ),$Heap_$_0,read($Heap_$_0,n#8,_module.Node.next),n#8,S#0) )));
	goto $exit;
}
