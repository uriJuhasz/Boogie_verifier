...
(declare-fun $@bf_56 ( ref $@Map@@$T0@@ref@Field$$T0$@To@$T0@@ ) Bool)
...
;Axioms
   ...
   (assert (! (= $decr0$init$0@0 (Set@Difference$BoxType$ S@0 $rhs@12@0)) :named ax_7))
   (assert (! (= $rhs@12@0 (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ null))) :named ax_8))
   (assert (! (= (- 1) (* (- 1) 1)) :named ax_9))
   (assert (! (= (- 1) (+ 0 (- 1))) :named ax_10))
   (assert (! (= ($Box$Bool$ false) ($Box$Bool$ ($@bf_30 ($Box$Bool$ false)))) :named ax_11))
   (assert (! (= ($Box$Bool$ true) ($Box$Bool$ ($@bf_30 ($Box$Bool$ true)))) :named ax_12))
   (assert (! (= (= true $@bf) (Lit$Bool$ true)) :named ax_13))
   (assert (! (= (= true $@bf_1) (Lit$Bool$ false)) :named ax_14))
   (assert (! (= (= true $@bf_28) ($Unbox$Bool$ ($Box$Bool$ true))) :named ax_15))
   (assert (! (= (= true $@bf_29) ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_16))
   (assert (! (= (lambda@6 alloc null $Heap) $_Frame@0) :named ax_17))
   (assert (! (= (Lit$Int$ 0) $rhs@11@0) :named ax_18))
   (assert (! (= _module.Node.next (FieldOfDecl$ref$ class._module.Node field$next)) :named ax_19))
   (assert (! (= 0 $ModuleContextHeight) :named ax_20))
   (assert (! (= 0 $rhs@11@0) :named ax_21))
   (assert (! (= 0 (FDim$Bool$ alloc)) :named ax_22))
   (assert (! (= 0 (FDim$ref$ _module.Node.next)) :named ax_23))
   (assert (! (= 0 (Map@Card$BoxType$BoxType$ Map@Empty$BoxType$BoxType$)) :named ax_24))
   (assert (! (= 0 (Seq@Length$BoxType$ Seq@Empty$BoxType$)) :named ax_25))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_26))
   (assert (! (= 0 (Set@Card$BoxType$ Set@Empty$BoxType$)) :named ax_27))
   (assert (! (= 4 $FunctionContextHeight) :named ax_28))
   ...
   (assert (! (= true $@bf_28) :named ax_35))
   (assert (! (= true ($@bf_61 0)) :named ax_36))
   ...
   (assert (! (forall( (|$o_$9_$0| ref) (|$f_$8_$0| Field$Bool$) (|alloc_$6_$0| Field$Bool$) (|null_$6_$0| ref) (|$Heap_$17_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@6 |alloc_$6_$0| |null_$6_$0| |$Heap_$17_$0|) |$o_$9_$0| |$f_$8_$0|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$17_$0| |$o_$9_$0| |alloc_$6_$0|) (not (= |null_$6_$0| |$o_$9_$0|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@6 |alloc_$6_$0| |null_$6_$0| |$Heap_$17_$0|) |$o_$9_$0| |$f_$8_$0|)))) :named ax_60))
   (assert (! (forall( (|$o_$9_$1| ref) (|$f_$8_$1| Field$BoxType$) (|alloc_$6_$1| Field$Bool$) (|null_$6_$1| ref) (|$Heap_$17_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@6 |alloc_$6_$1| |null_$6_$1| |$Heap_$17_$1|) |$o_$9_$1| |$f_$8_$1|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$17_$1| |$o_$9_$1| |alloc_$6_$1|) (not (= |null_$6_$1| |$o_$9_$1|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@6 |alloc_$6_$1| |null_$6_$1| |$Heap_$17_$1|) |$o_$9_$1| |$f_$8_$1|)))) :named ax_61))
   (assert (! (forall( (|$o_$9_$2| ref) (|$f_$8_$2| Field$ref$) (|alloc_$6_$2| Field$Bool$) (|null_$6_$2| ref) (|$Heap_$17_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@6 |alloc_$6_$2| |null_$6_$2| |$Heap_$17_$2|) |$o_$9_$2| |$f_$8_$2|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$17_$2| |$o_$9_$2| |alloc_$6_$2|) (not (= |null_$6_$2| |$o_$9_$2|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@6 |alloc_$6_$2| |null_$6_$2| |$Heap_$17_$2|) |$o_$9_$2| |$f_$8_$2|)))) :named ax_62))
   (assert (! (forall( (|$t#6_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#6_$0|) (or (= null ($Unbox$ref$ |$t#6_$0|)) (and (= (dtype ($Unbox$ref$ |$t#6_$0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#6_$0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#6_$0|)))) :named ax_63))
   (assert (! (forall( (|$t#9_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ Visited@32 |$t#9_$0|) (or (= null ($Unbox$ref$ |$t#9_$0|)) (and (= (dtype ($Unbox$ref$ |$t#9_$0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#9_$0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ Visited@32 |$t#9_$0|)))) :named ax_64))
   (assert (! (forall( (|a_$0_$0| $@Map@@BoxType@To@Bool@@) (|x_$3_$0| BoxType))(!(MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$0_$0| |x_$3_$0|) |x_$3_$0|)  :pattern ( (Set@UnionOne$BoxType$ |a_$0_$0| |x_$3_$0|)))) :named ax_65))
   (assert (! (forall( (|a_$1_$0| $@Map@@BoxType@To@Bool@@) (|x_$4_$0| BoxType) (|y_$6| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$1_$0| |x_$4_$0|) |y_$6|))  :pattern ( (Set@UnionOne$BoxType$ |a_$1_$0| |x_$4_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|)))) :named ax_66))
   (assert (! (forall( (|a_$10_$0| $@Map@@BoxType@To@Bool@@) (|b_$5_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ |a_$10_$0| (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|)) (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|))  :pattern ( (Set@Union$BoxType$ |a_$10_$0| (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|))))) :named ax_67))
   (assert (! (forall( (|a_$11_$0| $@Map@@BoxType@To@Bool@@) (|b_$6_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|) |b_$6_$0|) (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|))  :pattern ( (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|) |b_$6_$0|)))) :named ax_68))
   (assert (! (forall( (|a_$12_$0| $@Map@@BoxType@To@Bool@@) (|b_$7_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ |a_$12_$0| (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|)) (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|))  :pattern ( (Set@Intersection$BoxType$ |a_$12_$0| (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|))))) :named ax_69))
   (assert (! (forall( (|a_$13_$0| $@Map@@BoxType@To@Bool@@) (|b_$8_$0| $@Map@@BoxType@To@Bool@@))(!(= (+ (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$13_$0| |b_$8_$0|)) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$13_$0| |b_$8_$0|))) (+ (Set@Card$BoxType$ |a_$13_$0|) (Set@Card$BoxType$ |b_$8_$0|)))  :pattern ( (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$13_$0| |b_$8_$0|))) :pattern ( (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$13_$0| |b_$8_$0|))))) :named ax_70))
   (assert (! (forall( (|a_$14_$0| $@Map@@BoxType@To@Bool@@) (|b_$9_$0| $@Map@@BoxType@To@Bool@@) (|o_$4_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$14_$0| |b_$9_$0|) |o_$4_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$4_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$9_$0| |o_$4_$0|))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$14_$0| |b_$9_$0|) |o_$4_$0|)))) :named ax_71))
   (assert (! (forall( (|a_$15_$0| $@Map@@BoxType@To@Bool@@) (|b_$10_$0| $@Map@@BoxType@To@Bool@@) (|y_$2_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$10_$0| |y_$2_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$15_$0| |b_$10_$0|) |y_$2_$0|)))  :pattern ( (Set@Difference$BoxType$ |a_$15_$0| |b_$10_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$10_$0| |y_$2_$0|)))) :named ax_72))
   (assert (! (forall( (|a_$16_$0| $@Map@@BoxType@To@Bool@@) (|b_$11_$0| $@Map@@BoxType@To@Bool@@))(!(and (= (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$16_$0| |b_$11_$0|)) (+ (+ (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|)) (Set@Card$BoxType$ (Set@Difference$BoxType$ |b_$11_$0| |a_$16_$0|))) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$16_$0| |b_$11_$0|)))) (= (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|)) (- (Set@Card$BoxType$ |a_$16_$0|) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$16_$0| |b_$11_$0|)))))  :pattern ( (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|))))) :named ax_73))
   (assert (! (forall( (|a_$17_$0| $@Map@@BoxType@To@Bool@@) (|b_$12_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Subset$BoxType$ |a_$17_$0| |b_$12_$0|) (forall( (|o_$5_$1| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$17_$0| |o_$5_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$12_$0| |o_$5_$1|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$17_$0| |o_$5_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$12_$0| |o_$5_$1|)))))  :pattern ( (Set@Subset$BoxType$ |a_$17_$0| |b_$12_$0|)))) :named ax_74))
   (assert (! (forall( (|a_$18_$0| $@Map@@BoxType@To@Bool@@) (|b_$13_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Equal$BoxType$ |a_$18_$0| |b_$13_$0|) (forall( (|o_$6_$1| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$6_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$18_$0| |o_$6_$1|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$18_$0| |o_$6_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$6_$1|)))))  :pattern ( (Set@Equal$BoxType$ |a_$18_$0| |b_$13_$0|)))) :named ax_75))
   (assert (! (forall( (|a_$19_$0| $@Map@@BoxType@To@Bool@@) (|b_$14_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Equal$BoxType$ |a_$19_$0| |b_$14_$0|) (= |b_$14_$0| |a_$19_$0|))  :pattern ( (Set@Equal$BoxType$ |a_$19_$0| |b_$14_$0|)))) :named ax_76))
   (assert (! (forall( (|a_$2_$0| $@Map@@BoxType@To@Bool@@) (|x_$5_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$2_$0| |x_$5_$0|) (= (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$2_$0| |x_$5_$0|)) (Set@Card$BoxType$ |a_$2_$0|)))  :pattern ( (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$2_$0| |x_$5_$0|))))) :named ax_77))
   (assert (! (forall( (|a_$20_$0| $@Map@@BoxType@To@Bool@@) (|b_$15_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Disjoint$BoxType$ |a_$20_$0| |b_$15_$0|) (forall( (|o_$7_$1| BoxType))(!(or (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$15_$0| |o_$7_$1|)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$20_$0| |o_$7_$1|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$20_$0| |o_$7_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$15_$0| |o_$7_$1|)))))  :pattern ( (Set@Disjoint$BoxType$ |a_$20_$0| |b_$15_$0|)))) :named ax_78))
   (assert (! (forall( (|a_$21| Int) (|b_$16| Int))(!(= (= (Math@min |a_$21| |b_$16|) |a_$21|) (<= |a_$21| |b_$16|))  :pattern ( (Math@min |a_$21| |b_$16|)))) :named ax_79))
   (assert (! (forall( (|a_$22| Int) (|b_$17| Int))(!(= (= (Math@min |a_$22| |b_$17|) |b_$17|) (<= |b_$17| |a_$22|))  :pattern ( (Math@min |a_$22| |b_$17|)))) :named ax_80))
   (assert (! (forall( (|a_$23| Int) (|b_$18| Int))(!(or (= (Math@min |a_$23| |b_$18|) |b_$18|) (= (Math@min |a_$23| |b_$18|) |a_$23|))  :pattern ( (Math@min |a_$23| |b_$18|)))) :named ax_81))
   (assert (! (forall( (|a_$24| Int))(!(=> (<= 0 |a_$24|) (= (Math@clip |a_$24|) |a_$24|))  :pattern ( (Math@clip |a_$24|)))) :named ax_82))
   (assert (! (forall( (|a_$25| Int))(!(=> (< |a_$25| 0) (= (Math@clip |a_$25|) 0))  :pattern ( (Math@clip |a_$25|)))) :named ax_83))
   (assert (! (forall( (|a_$3_$0| $@Map@@BoxType@To@Bool@@) (|x_$6_$0| BoxType))(!(=> (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$3_$0| |x_$6_$0|)) (= (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$3_$0| |x_$6_$0|)) (+ (Set@Card$BoxType$ |a_$3_$0|) 1)))  :pattern ( (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$3_$0| |x_$6_$0|))))) :named ax_84))
   (assert (! (forall( (|a_$4_$0| $@Map@@BoxType@To@Bool@@) (|b_$51| $@Map@@BoxType@To@Bool@@) (|o_$2_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$4_$0| |b_$51|) |o_$2_$0|) (or (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$51| |o_$2_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$4_$0| |o_$2_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$4_$0| |b_$51|) |o_$2_$0|)))) :named ax_85))
   (assert (! (forall( (|a_$45_$0| Seq$BoxType$) (|b_$32_$0| Seq$BoxType$))(!(=> (Seq@Equal$BoxType$ |a_$45_$0| |b_$32_$0|) (= |b_$32_$0| |a_$45_$0|))  :pattern ( (Seq@Equal$BoxType$ |a_$45_$0| |b_$32_$0|)))) :named ax_86))
   (assert (! (forall( (|a_$45_$1| Seq$ref$) (|b_$32_$1| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$45_$1| |b_$32_$1|) (= |b_$32_$1| |a_$45_$1|))  :pattern ( (Seq@Equal$ref$ |a_$45_$1| |b_$32_$1|)))) :named ax_87))
   (assert (! (forall( (|a_$5_$0| $@Map@@BoxType@To@Bool@@) (|b_$0_$0| $@Map@@BoxType@To@Bool@@) (|y_$0_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$5_$0| |y_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$5_$0| |b_$0_$0|) |y_$0_$0|))  :pattern ( (Set@Union$BoxType$ |a_$5_$0| |b_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$5_$0| |y_$0_$0|)))) :named ax_88))
   (assert (! (forall( (|a_$51_$0| $@Map@@BoxType@To@Bool@@) (|b_$33_$0| $@Map@@BoxType@To@BoxType@@))(!(= (Map@Domain$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$51_$0| |b_$33_$0|)) |a_$51_$0|)  :pattern ( (Map@Domain$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$51_$0| |b_$33_$0|))))) :named ax_89))
   (assert (! (forall( (|a_$52_$0| $@Map@@BoxType@To@Bool@@) (|b_$34_$0| $@Map@@BoxType@To@BoxType@@))(!(= (Map@Elements$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$52_$0| |b_$34_$0|)) |b_$34_$0|)  :pattern ( (Map@Elements$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$52_$0| |b_$34_$0|))))) :named ax_90))
   (assert (! (forall( (|a_$53| ClassName) (|b_$42| ClassName))(!(and (= (TypeTupleCdr (TypeTuple |a_$53| |b_$42|)) |b_$42|) (= (TypeTupleCar (TypeTuple |a_$53| |b_$42|)) |a_$53|))  :pattern ( (TypeTuple |a_$53| |b_$42|)))) :named ax_91))
   (assert (! (forall( (|a_$54| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$50| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|c| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and ($HeapSucc |b_$50| |c|) ($HeapSucc |a_$54| |b_$50|)) ($HeapSucc |a_$54| |c|))  :pattern ( ($HeapSucc |a_$54| |b_$50|) ($HeapSucc |b_$50| |c|)))) :named ax_92))
   (assert (! (forall( (|a_$55| $@Map@@BoxType@To@Bool@@) (|x_$2_$0| BoxType) (|o_$1_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$55| |x_$2_$0|) |o_$1_$0|) (or (= |x_$2_$0| |o_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$55| |o_$1_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$55| |x_$2_$0|) |o_$1_$0|)))) :named ax_93))
   (assert (! (forall( (|a_$6_$0| $@Map@@BoxType@To@Bool@@) (|b_$1_$0| $@Map@@BoxType@To@Bool@@) (|y_$1_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$6_$0| |b_$1_$0|) |y_$1_$0|))  :pattern ( (Set@Union$BoxType$ |a_$6_$0| |b_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|)))) :named ax_94))
   (assert (! (forall( (|a_$7_$0| $@Map@@BoxType@To@Bool@@) (|b_$2_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Disjoint$BoxType$ |a_$7_$0| |b_$2_$0|) (and (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|) |b_$2_$0|) |a_$7_$0|) (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|) |a_$7_$0|) |b_$2_$0|)))  :pattern ( (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|)))) :named ax_95))
   (assert (! (forall( (|a_$8_$0| $@Map@@BoxType@To@Bool@@) (|b_$3_$0| $@Map@@BoxType@To@Bool@@) (|o_$3_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$8_$0| |b_$3_$0|) |o_$3_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$3_$0| |o_$3_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$8_$0| |o_$3_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$8_$0| |b_$3_$0|) |o_$3_$0|)))) :named ax_96))
   (assert (! (forall( (|a_$9_$0| $@Map@@BoxType@To@Bool@@) (|b_$4_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|) |b_$4_$0|) (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|))  :pattern ( (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|) |b_$4_$0|)))) :named ax_97))
   (assert (! (forall( (|b_$35| BoxType))(!(= |b_$35| ($Box$Int$ ($Unbox$Int$ |b_$35|)))  :pattern ( ($Unbox$Int$ |b_$35|)))) :named ax_98))
   (assert (! (forall( (|b_$36| BoxType))(!(= |b_$36| ($Box$ref$ ($Unbox$ref$ |b_$36|)))  :pattern ( ($Unbox$ref$ |b_$36|)))) :named ax_99))
   (assert (! (forall( (|b_$37| BoxType))(!(= |b_$37| ($Box$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$37|)))  :pattern ( ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$37|)))) :named ax_100))
   (assert (! (forall( (|b_$38| BoxType))(!(= |b_$38| ($Box$Seq$BoxType$$ ($Unbox$Seq$BoxType$$ |b_$38|)))  :pattern ( ($Unbox$Seq$BoxType$$ |b_$38|)))) :named ax_101))
   (assert (! (forall( (|b_$39| BoxType))(!(= |b_$39| ($Box$Map$BoxType$BoxType$$ ($Unbox$Map$BoxType$BoxType$$ |b_$39|)))  :pattern ( ($Unbox$Map$BoxType$BoxType$$ |b_$39|)))) :named ax_102))
   (assert (! (forall( (|b_$40| BoxType))(!(= |b_$40| ($Box$DatatypeType$ ($Unbox$DatatypeType$ |b_$40|)))  :pattern ( ($Unbox$DatatypeType$ |b_$40|)))) :named ax_103))
   (assert (! (forall( (|b_$41| BoxType))(!(=> ($IsCanonicalBoolBox |b_$41|) (= |b_$41| ($Box$Bool$ ($Unbox$Bool$ |b_$41|))))  :pattern ( ($Unbox$Bool$ |b_$41|)))) :named ax_104))
   (assert (! (forall( (|b_$43| BoxType) (|h_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$43| |h_$6|) (or (= null ($Unbox$ref$ |b_$43|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$6| ($Unbox$ref$ |b_$43|) alloc)))  :pattern ( (GenericAlloc |b_$43| |h_$6|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$6| ($Unbox$ref$ |b_$43|) alloc)))) :named ax_105))
   (assert (! (forall( (|b_$44| BoxType) (|h_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$21| Int))(!(=> (and (< |i_$21| (Seq@Length$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|))) (and (GenericAlloc |b_$44| |h_$7|) (<= 0 |i_$21|))) (GenericAlloc (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|) |i_$21|) |h_$7|))  :pattern ( (GenericAlloc |b_$44| |h_$7|) (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|) |i_$21|)))) :named ax_106))
   (assert (! (forall( (|b_$45| BoxType) (|h_$8| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$22| BoxType))(!(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|) (GenericAlloc |b_$45| |h_$8|)) (GenericAlloc (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|) |h_$8|))  :pattern ( (GenericAlloc |b_$45| |h_$8|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|)))) :named ax_107))
   (assert (! (forall( (|b_$46| BoxType) (|h_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|t_$2| BoxType))(!(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$46|)) |t_$2|) (GenericAlloc |b_$46| |h_$9|)) (GenericAlloc |t_$2| |h_$9|))  :pattern ( (GenericAlloc |b_$46| |h_$9|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$46|)) |t_$2|)))) :named ax_108))
   (assert (! (forall( (|b_$47| BoxType) (|h_$10| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|t_$3| BoxType))(!(=> (and (GenericAlloc |b_$47| |h_$10|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$47|) |t_$3|)) (GenericAlloc |t_$3| |h_$10|))  :pattern ( (GenericAlloc |b_$47| |h_$10|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$47|) |t_$3|)))) :named ax_109))
   (assert (! (forall( (|b_$48| BoxType) (|h_$11| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$48| |h_$11|) (DtAlloc ($Unbox$DatatypeType$ |b_$48|) |h_$11|))  :pattern ( (GenericAlloc |b_$48| |h_$11|) (DtType ($Unbox$DatatypeType$ |b_$48|))))) :named ax_110))
   (assert (! (forall( (|b_$49| Bool) (|h_$12| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$12|) (GenericAlloc ($Box$Bool$ |b_$49|) |h_$12|))) :named ax_111))
   (assert (! (forall( (|cl_$0| ClassName) (|nm_$0| NameFamily))(!(and (= |nm_$0| (DeclName$Bool$ (FieldOfDecl$Bool$ |cl_$0| |nm_$0|))) (= (DeclType$Bool$ (FieldOfDecl$Bool$ |cl_$0| |nm_$0|)) |cl_$0|))  :pattern ( (FieldOfDecl$Bool$ |cl_$0| |nm_$0|)))) :named ax_112))
   (assert (! (forall( (|cl_$1| ClassName) (|nm_$1| NameFamily))(!(and (= |nm_$1| (DeclName$BoxType$ (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|))) (= (DeclType$BoxType$ (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|)) |cl_$1|))  :pattern ( (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|)))) :named ax_113))
   (assert (! (forall( (|cl_$2| ClassName) (|nm_$2| NameFamily))(!(and (= |nm_$2| (DeclName$ref$ (FieldOfDecl$ref$ |cl_$2| |nm_$2|))) (= (DeclType$ref$ (FieldOfDecl$ref$ |cl_$2| |nm_$2|)) |cl_$2|))  :pattern ( (FieldOfDecl$ref$ |cl_$2| |nm_$2|)))) :named ax_114))
   (assert (! (forall( (|f_$2| Field$BoxType$) (|i_$19| Int))(!(= (FDim$BoxType$ (MultiIndexField |f_$2| |i_$19|)) (+ (FDim$BoxType$ |f_$2|) 1))  :pattern ( (MultiIndexField |f_$2| |i_$19|)))) :named ax_115))
   (assert (! (forall( (|f_$3| Field$BoxType$) (|i_$20| Int))(!(and (= (MultiIndexField_Inverse1$BoxType$ (MultiIndexField |f_$3| |i_$20|)) |i_$20|) (= (MultiIndexField_Inverse0$BoxType$ (MultiIndexField |f_$3| |i_$20|)) |f_$3|))  :pattern ( (MultiIndexField |f_$3| |i_$20|)))) :named ax_116))
   (assert (! (forall( (|f_$7| Field$Bool$) (|r_$9| ref) (|H_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$9| |f_$7|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$9| |f_$7|))) :named ax_117))
   (assert (! (forall( (|f_$8| Field$BoxType$) (|r_$10| ref) (|H_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$2| |r_$10| |f_$8|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$2| |r_$10| |f_$8|))) :named ax_118))
   (assert (! (forall( (|f_$9| Field$ref$) (|r_$11| ref) (|H_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$3| |r_$11| |f_$9|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$3| |r_$11| |f_$9|))) :named ax_119))
   (assert (! (forall( (|h_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$47| ref) (|i_$7| Int))(=> (and (< |i_$7| (Seq@Length$BoxType$ (Seq@FromArray |h_$0| |a_$47|))) (<= 0 |i_$7|)) (= (Seq@Index$BoxType$ (Seq@FromArray |h_$0| |a_$47|) |i_$7|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$0| |a_$47| (IndexField |i_$7|))))) :named ax_120))
   (assert (! (forall( (|h_$1_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$0| ref) (|f_$1_$0| Field$Bool$) (|v_$7_$0| Bool) (|a_$48_$0| ref))(!(=> (not (= |o_$17_$0| |a_$48_$0|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1_$0| |o_$17_$0| |f_$1_$0| |v_$7_$0|) |a_$48_$0|) (Seq@FromArray |h_$1_$0| |a_$48_$0|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1_$0| |o_$17_$0| |f_$1_$0| |v_$7_$0|) |a_$48_$0|)))) :named ax_121))
   (assert (! (forall( (|h_$1_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$1| ref) (|f_$1_$1| Field$BoxType$) (|v_$7_$1| BoxType) (|a_$48_$1| ref))(!(=> (not (= |o_$17_$1| |a_$48_$1|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$1_$1| |o_$17_$1| |f_$1_$1| |v_$7_$1|) |a_$48_$1|) (Seq@FromArray |h_$1_$1| |a_$48_$1|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$1_$1| |o_$17_$1| |f_$1_$1| |v_$7_$1|) |a_$48_$1|)))) :named ax_122))
   (assert (! (forall( (|h_$1_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$2| ref) (|f_$1_$2| Field$ref$) (|v_$7_$2| ref) (|a_$48_$2| ref))(!(=> (not (= |o_$17_$2| |a_$48_$2|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$1_$2| |o_$17_$2| |f_$1_$2| |v_$7_$2|) |a_$48_$2|) (Seq@FromArray |h_$1_$2| |a_$48_$2|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$1_$2| |o_$17_$2| |f_$1_$2| |v_$7_$2|) |a_$48_$2|)))) :named ax_123))
   (assert (! (forall( (|h_$16_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$0| ref) (|f_$5_$0| Field$Bool$) (|x_$24_$0| Bool))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)) ($HeapSucc |h_$16_$0| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)))) :named ax_124))
   (assert (! (forall( (|h_$16_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$1| ref) (|f_$5_$1| Field$BoxType$) (|x_$24_$1| BoxType))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)) ($HeapSucc |h_$16_$1| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)))) :named ax_125))
   (assert (! (forall( (|h_$16_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$2| ref) (|f_$5_$2| Field$ref$) (|x_$24_$2| ref))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)) ($HeapSucc |h_$16_$2| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)))) :named ax_126))
   (assert (! (forall( (|h_$17| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> ($HeapSucc |h_$17| |k_$1|) (forall( (|o_$20| ref))(!(=> (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$17| |o_$20| alloc) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$20| alloc))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$20| alloc)))))  :pattern ( ($HeapSucc |h_$17| |k_$1|)))) :named ax_127))
   (assert (! (forall( (|h_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$8| Int) (|v_$8| BoxType) (|a_$49| ref))(!(=> (and (< |i_$8| (_System.array.Length |a_$49|)) (<= 0 |i_$8|)) (= (Seq@Update$BoxType$ (Seq@FromArray |h_$2| |a_$49|) |i_$8| |v_$8|) (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$2| |a_$49| (IndexField |i_$8|) |v_$8|) |a_$49|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$2| |a_$49| (IndexField |i_$8|) |v_$8|) |a_$49|)))) :named ax_128))
   (assert (! (forall( (|h_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$50| ref) (|n0| Int) (|n1| Int))(!(=> (and (<= |n1| (_System.array.Length |a_$50|)) (and (= |n1| (+ |n0| 1)) (<= 0 |n0|))) (= (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n1|) (Seq@Build$BoxType$ (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$3| |a_$50| (IndexField |n0|)))))  :pattern ( (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n0|) (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n1|)))) :named ax_129))
   (assert (! (forall( (|h_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d| DatatypeType))(!(=> ($HeapSucc |h_$4| |k|) (=> (DtAlloc |d| |h_$4|) (DtAlloc |d| |k|)))  :pattern ( ($HeapSucc |h_$4| |k|) (DtAlloc |d| |h_$4|)) :pattern ( ($HeapSucc |h_$4| |k|) (DtAlloc |d| |k|)))) :named ax_130))
   (assert (! (forall( (|h_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d_$0| BoxType))(!(=> ($HeapSucc |h_$5| |k_$0|) (=> (GenericAlloc |d_$0| |h_$5|) (GenericAlloc |d_$0| |k_$0|)))  :pattern ( ($HeapSucc |h_$5| |k_$0|) (GenericAlloc |d_$0| |h_$5|)) :pattern ( ($HeapSucc |h_$5| |k_$0|) (GenericAlloc |d_$0| |k_$0|)))) :named ax_131))
   (assert (! (forall( (|h| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$46| ref))(!(= (Seq@Length$BoxType$ (Seq@FromArray |h| |a_$46|)) (_System.array.Length |a_$46|))  :pattern ( (Seq@Length$BoxType$ (Seq@FromArray |h| |a_$46|))))) :named ax_132))
   (assert (! (forall( (|i_$17| Int))(!(= (FDim$BoxType$ (IndexField |i_$17|)) 1)  :pattern ( (IndexField |i_$17|)))) :named ax_133))
   ...
   (assert (! (not $NP@184) :named ax_291))
   (assert (! (not ($IsGhostField$Bool$ alloc)) :named ax_292))
   (assert (! (not ($IsGhostField$ref$ _module.Node.next)) :named ax_293))
   (assert (! (not ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_294))
   (assert (! (not (= 1 4)) :named ax_295))
   (assert (! (not (= 2 4)) :named ax_296))
   (assert (! (not (= 4 0)) :named ax_297))
   (assert (! (not (= null this)) :named ax_298))
   (assert (! (or (= p@30 null) (and (= (dtype p@30) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@30 alloc))) :named ax_299))
...
(let ((anon61_Else@7 (=> (and true
    (Set@Subset$BoxType$ $rhs@18@1 S@0)
  )(and 
...
(let ((anon61_Else@6 (=> (and true
    (MapRead$$@Map@@BoxType@To@Bool@@$ $rhs@18@1 ($Box$ref$ null))
  )(and 
...
(let ((anon46@8 (=> (and true
    ...
    (= $Heap@0 $Heap)
    (= $Heap@0 $Heap@1)
    (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this (+ A@1@1 B@2@0) S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this A@1@1 S@0) B@2@0 S@0))
    (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this (+ A@1@1 B@2@0) S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this (+ A@1@1 B@2@0) S@0))
    (= A@1@1 A@1@3)
    (= B@2@0 B@2@1)
...
(let ((anon61_Else@5 (=> (and true
    (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ $rhs@16@1))
  )(and 
...
(let ((anon61_Else@4 (=> (and true
    (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap this $rhs@17@1 S@0) $rhs@16@1)
  )(and 
...
(let ((anon51_Else (=> (and true
    (not $@condition_$5)
    (not (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ p@30@0)) (= p@30@0 (_module.Node.Nexxxt ($LS $LZ) $Heap this steps@31@0 S@0))))
  )
    anon8
)))
...
(let ((anon50_Else (=> (and true
    (not $@condition_$3)
    (not (= p@30@0 (_module.Node.Nexxxt ($LS $LZ) $Heap this steps@31@0 S@0)))
  )
    $branchMerge_1
)))
...
(let ((anon0@8 (=> (and true
    ...
    ($NP@221 null)
    ($NP@222 null)
    (=> $w0@0 (_module.Node.Nexxxt@canCall $Heap this steps@31@0 S@0))
...
(let ((anon0@2 (=> (and true
    (=> $w0@0 (= this (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap this 0 S@0)))
