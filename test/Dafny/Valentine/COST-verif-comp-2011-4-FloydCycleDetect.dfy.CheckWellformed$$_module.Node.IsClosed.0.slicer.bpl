...
PreconditionGeneratedEntry:
	...
	assume (forall  $t#5 : BoxType :: {S#0[$t#5]} ( S#0[$t#5] ==> ((($Unbox($t#5) : ref) == null) || (read($Heap,($Unbox($t#5) : ref),alloc) && (dtype(($Unbox($t#5) : ref)) == class._module.Node))) ));
...
anon13_Else:
	assume !S#0[$Box(this)];
	if ($_$_condition_$2) { goto anon14_Then; } else { goto anon14_Else; }
anon14_Then:
	assume S#0[$Box(this)] && S#0[$Box(null)];
	assume (n#2_$_0 == null) || (read($Heap,n#2_$_0,alloc) && (dtype(n#2_$_0) == class._module.Node));
...
anon15_Else:
	assume !S#0[$Box(n#2_$_0)];
	if ($_$_condition_$5) { goto anon16_Then; } else { goto anon16_Else; }
anon11:
	...
	assume (S#0[$Box(this)] ==> true) && ((S#0[$Box(this)] && S#0[$Box(null)]) ==> ((forall  n#3_$0 : ref :: ( ((n#3_$0 == null) || (read($Heap,n#3_$0,alloc) && (dtype(n#3_$0) == class._module.Node))) ==> (((S#0[$Box(n#3_$0)] ==> true) && ((S#0[$Box(n#3_$0)] && (!(n#3_$0 == null))) ==> true)) && (((S#0[$Box(n#3_$0)] && (!(n#3_$0 == null))) && (!(read($Heap,n#3_$0,_module.Node.next) == null))) ==> true)) ))));
	goto $exit;
anon16_Then:
...
anon16_Else:
	assume !(S#0[$Box(n#2_$_0)] && (!(n#2_$_0 == null)));
	if ($_$_condition_$7) { goto anon17_Then; } else { goto anon17_Else; }
anon17_Then:
	assume (S#0[$Box(n#2_$_0)] && (!(n#2_$_0 == null))) && (!(read($Heap,n#2_$_0,_module.Node.next) == null));
	assert  !(n#2_$_0 == null);
	assert  $_Frame_$_0[n#2_$_0,_module.Node.next];
	goto anon11;
anon17_Else:
