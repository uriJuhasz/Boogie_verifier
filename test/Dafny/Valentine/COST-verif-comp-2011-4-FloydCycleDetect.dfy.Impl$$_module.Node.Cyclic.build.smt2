...
;Axioms
   ...
   (assert (! (forall( (|$h| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o| ref))(!(=> (and (and ($IsGoodHeap |$h|) (not (= null |$o|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h| |$o| alloc)) (or (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h| |$o| _module.Node.next)) (and (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h| |$o| _module.Node.next)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h| (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h| |$o| _module.Node.next) alloc))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h| |$o| _module.Node.next)))) :named ax_58))
   (assert (! (forall( (|$h0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$0| ref) (|S#0_$0| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (or (_module.Node.IsClosed@canCall |$h1| |this_$0| |S#0_$0|) (forall( (|$t#1| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#1|) (or (= null ($Unbox$ref$ |$t#1|)) (and (= (dtype ($Unbox$ref$ |$t#1|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| ($Unbox$ref$ |$t#1|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#1|))))) (and (or (_module.Node.IsClosed@canCall |$h0| |this_$0| |S#0_$0|) (forall( (|$t#0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#0|) (or (= null ($Unbox$ref$ |$t#0|)) (and (= (dtype ($Unbox$ref$ |$t#0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| ($Unbox$ref$ |$t#0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#0|))))) (and (= (dtype |this_$0|) class._module.Node) (and (and (= (dtype |this_$0|) class._module.Node) (and (and (and ($IsGoodHeap |$h1|) ($IsGoodHeap |$h0|)) (not (= |this_$0| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |this_$0| alloc))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |this_$0| alloc))))) ($HeapSucc |$h0| |$h1|)) (=> (and (forall( (|$o_$0_$2| ref) (|$f_$35| Field$ref$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| ($Box$ref$ |$o_$0_$2|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$2| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$2| alloc) (not (= null |$o_$0_$2|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1| |$o_$0_$2| |$f_$35|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0| |$o_$0_$2| |$f_$35|)))) (and (forall( (|$o_$0_$1| ref) (|$f_$34| Field$BoxType$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| ($Box$ref$ |$o_$0_$1|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$1| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$1| alloc) (not (= null |$o_$0_$1|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1| |$o_$0_$1| |$f_$34|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0| |$o_$0_$1| |$f_$34|)))) (forall( (|$o_$0_$0| ref) (|$f_$33| Field$Bool$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| ($Box$ref$ |$o_$0_$0|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$0| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$0| alloc) (not (= null |$o_$0_$0|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$0| |$f_$33|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$0| |$f_$33|)))))) (= (_module.Node.IsClosed |$h1| |this_$0| |S#0_$0|) (_module.Node.IsClosed |$h0| |this_$0| |S#0_$0|))))  :pattern ( ($HeapSucc |$h0| |$h1|) (_module.Node.IsClosed |$h1| |this_$0| |S#0_$0|)))) :named ax_59))
   (assert (! (forall( (|$ly_$0| LayerType) (|$h0_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$5| ref) (|k#0_$0| Int) (|S#1_$0| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (or (_module.Node.Nexxxt@canCall |$h1_$0| |this_$5| |k#0_$0| |S#1_$0|) (forall( (|$t#7| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| |$t#7|) (or (= null ($Unbox$ref$ |$t#7|)) (and (= (dtype ($Unbox$ref$ |$t#7|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| ($Unbox$ref$ |$t#7|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| |$t#7|))))) (and (or (_module.Node.Nexxxt@canCall |$h0_$0| |this_$5| |k#0_$0| |S#1_$0|) (forall( (|$t#6| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| |$t#6|) (or (= null ($Unbox$ref$ |$t#6|)) (and (= (dtype ($Unbox$ref$ |$t#6|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| ($Unbox$ref$ |$t#6|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| |$t#6|))))) (and (= (dtype |this_$5|) class._module.Node) (and (and (= (dtype |this_$5|) class._module.Node) (and (and (and ($IsGoodHeap |$h1_$0|) ($IsGoodHeap |$h0_$0|)) (not (= |this_$5| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |this_$5| alloc))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |this_$5| alloc))))) ($HeapSucc |$h0_$0| |$h1_$0|)) (=> (and (forall( (|$o_$1_$2| ref) (|$f_$0_$2| Field$ref$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| ($Box$ref$ |$o_$1_$2|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$2| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$2| alloc) (not (= null |$o_$1_$2|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1_$0| |$o_$1_$2| |$f_$0_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0_$0| |$o_$1_$2| |$f_$0_$2|)))) (and (forall( (|$o_$1_$1| ref) (|$f_$0_$1| Field$BoxType$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| ($Box$ref$ |$o_$1_$1|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$1| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$1| alloc) (not (= null |$o_$1_$1|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1_$0| |$o_$1_$1| |$f_$0_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0_$0| |$o_$1_$1| |$f_$0_$1|)))) (forall( (|$o_$1_$0| ref) (|$f_$0_$0| Field$Bool$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$0| ($Box$ref$ |$o_$1_$0|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$0| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$0| alloc) (not (= null |$o_$1_$0|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$0| |$f_$0_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$0| |$f_$0_$0|)))))) (= (_module.Node.Nexxxt |$ly_$0| |$h1_$0| |this_$5| |k#0_$0| |S#1_$0|) (_module.Node.Nexxxt |$ly_$0| |$h0_$0| |this_$5| |k#0_$0| |S#1_$0|))))  :pattern ( ($HeapSucc |$h0_$0| |$h1_$0|) (_module.Node.Nexxxt |$ly_$0| |$h1_$0| |this_$5| |k#0_$0| |S#1_$0|)))) :named ax_60))
   (assert (! (forall( (|$ly_$4| LayerType) (|$Heap_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$9| ref) (|sink#0| ref) (|S#1_$4| $@Map@@BoxType@To@Bool@@))(!(= (_module.Node.Reaches |$ly_$4| |$Heap_$7| |this_$9| |sink#0| |S#1_$4|) (_module.Node.Reaches ($LS |$ly_$4|) |$Heap_$7| |this_$9| |sink#0| |S#1_$4|))  :pattern ( (_module.Node.Reaches ($LS |$ly_$4|) |$Heap_$7| |this_$9| |sink#0| |S#1_$4|)))) :named ax_61))
   (assert (! (forall( (|$ly_$5| LayerType) (|$h0_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$10| ref) (|sink#0_$0| ref) (|S#1_$5| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (or (_module.Node.Reaches@canCall |$h1_$1| |this_$10| |sink#0_$0| |S#1_$5|) (and (or (= |sink#0_$0| null) (and (= (dtype |sink#0_$0|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |sink#0_$0| alloc))) (forall( (|$t#13| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| |$t#13|) (or (= null ($Unbox$ref$ |$t#13|)) (and (= (dtype ($Unbox$ref$ |$t#13|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| ($Unbox$ref$ |$t#13|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| |$t#13|)))))) (and (or (_module.Node.Reaches@canCall |$h0_$1| |this_$10| |sink#0_$0| |S#1_$5|) (and (or (= |sink#0_$0| null) (and (= (dtype |sink#0_$0|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |sink#0_$0| alloc))) (forall( (|$t#12| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| |$t#12|) (or (= null ($Unbox$ref$ |$t#12|)) (and (= (dtype ($Unbox$ref$ |$t#12|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| ($Unbox$ref$ |$t#12|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| |$t#12|)))))) (and (= (dtype |this_$10|) class._module.Node) (and (and (= (dtype |this_$10|) class._module.Node) (and (and (and ($IsGoodHeap |$h1_$1|) ($IsGoodHeap |$h0_$1|)) (not (= |this_$10| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |this_$10| alloc))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |this_$10| alloc))))) ($HeapSucc |$h0_$1| |$h1_$1|)) (=> (and (forall( (|$o_$2_$2| ref) (|$f_$1_$2| Field$ref$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| ($Box$ref$ |$o_$2_$2|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$2| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$2| alloc) (not (= null |$o_$2_$2|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1_$1| |$o_$2_$2| |$f_$1_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0_$1| |$o_$2_$2| |$f_$1_$2|)))) (and (forall( (|$o_$2_$1| ref) (|$f_$1_$1| Field$BoxType$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| ($Box$ref$ |$o_$2_$1|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$1| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$1| alloc) (not (= null |$o_$2_$1|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1_$1| |$o_$2_$1| |$f_$1_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0_$1| |$o_$2_$1| |$f_$1_$1|)))) (forall( (|$o_$2_$0| ref) (|$f_$1_$0| Field$Bool$))(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$5| ($Box$ref$ |$o_$2_$0|)) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$0| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$0| alloc) (not (= null |$o_$2_$0|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$0| |$f_$1_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$0| |$f_$1_$0|)))))) (= (_module.Node.Reaches |$ly_$5| |$h1_$1| |this_$10| |sink#0_$0| |S#1_$5|) (_module.Node.Reaches |$ly_$5| |$h0_$1| |this_$10| |sink#0_$0| |S#1_$5|))))  :pattern ( ($HeapSucc |$h0_$1| |$h1_$1|) (_module.Node.Reaches |$ly_$5| |$h1_$1| |this_$10| |sink#0_$0| |S#1_$5|)))) :named ax_62))
   (assert (! (forall( (|$ly| LayerType) (|$Heap_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$4| ref) (|k#0| Int) (|S#1| $@Map@@BoxType@To@Bool@@))(!(= (_module.Node.Nexxxt |$ly| |$Heap_$3| |this_$4| |k#0| |S#1|) (_module.Node.Nexxxt ($LS |$ly|) |$Heap_$3| |this_$4| |k#0| |S#1|))  :pattern ( (_module.Node.Nexxxt ($LS |$ly|) |$Heap_$3| |this_$4| |k#0| |S#1|)))) :named ax_63))
   (assert (! (forall( (|$o_$7_$0| ref) (|$f_$6_$0| Field$Bool$) (|alloc_$4_$0| Field$Bool$) (|null_$4_$0| ref) (|$Heap_$15_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@4 |alloc_$4_$0| |null_$4_$0| |$Heap_$15_$0|) |$o_$7_$0| |$f_$6_$0|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$15_$0| |$o_$7_$0| |alloc_$4_$0|) (not (= |null_$4_$0| |$o_$7_$0|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@4 |alloc_$4_$0| |null_$4_$0| |$Heap_$15_$0|) |$o_$7_$0| |$f_$6_$0|)))) :named ax_64))
   (assert (! (forall( (|$o_$7_$1| ref) (|$f_$6_$1| Field$BoxType$) (|alloc_$4_$1| Field$Bool$) (|null_$4_$1| ref) (|$Heap_$15_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@4 |alloc_$4_$1| |null_$4_$1| |$Heap_$15_$1|) |$o_$7_$1| |$f_$6_$1|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$15_$1| |$o_$7_$1| |alloc_$4_$1|) (not (= |null_$4_$1| |$o_$7_$1|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@4 |alloc_$4_$1| |null_$4_$1| |$Heap_$15_$1|) |$o_$7_$1| |$f_$6_$1|)))) :named ax_65))
   (assert (! (forall( (|$o_$7_$2| ref) (|$f_$6_$2| Field$ref$) (|alloc_$4_$2| Field$Bool$) (|null_$4_$2| ref) (|$Heap_$15_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@4 |alloc_$4_$2| |null_$4_$2| |$Heap_$15_$2|) |$o_$7_$2| |$f_$6_$2|) (not (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$15_$2| |$o_$7_$2| |alloc_$4_$2|) (not (= |null_$4_$2| |$o_$7_$2|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@4 |alloc_$4_$2| |null_$4_$2| |$Heap_$15_$2|) |$o_$7_$2| |$f_$6_$2|)))) :named ax_66))
   (assert (! (forall( (|$t#2_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#2_$0|) (or (= null ($Unbox$ref$ |$t#2_$0|)) (and (= (dtype ($Unbox$ref$ |$t#2_$0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#2_$0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#2_$0|)))) :named ax_67))
   (assert (! (forall( (|a_$0_$0| $@Map@@BoxType@To@Bool@@) (|x_$3_$0| BoxType))(!(MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$0_$0| |x_$3_$0|) |x_$3_$0|)  :pattern ( (Set@UnionOne$BoxType$ |a_$0_$0| |x_$3_$0|)))) :named ax_68))
   (assert (! (forall( (|a_$1_$0| $@Map@@BoxType@To@Bool@@) (|x_$4_$0| BoxType) (|y_$6| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$1_$0| |x_$4_$0|) |y_$6|))  :pattern ( (Set@UnionOne$BoxType$ |a_$1_$0| |x_$4_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|)))) :named ax_69))
   (assert (! (forall( (|a_$10_$0| $@Map@@BoxType@To@Bool@@) (|b_$5_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ |a_$10_$0| (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|)) (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|))  :pattern ( (Set@Union$BoxType$ |a_$10_$0| (Set@Union$BoxType$ |a_$10_$0| |b_$5_$0|))))) :named ax_70))
   (assert (! (forall( (|a_$11_$0| $@Map@@BoxType@To@Bool@@) (|b_$6_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|) |b_$6_$0|) (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|))  :pattern ( (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$11_$0| |b_$6_$0|) |b_$6_$0|)))) :named ax_71))
   (assert (! (forall( (|a_$12_$0| $@Map@@BoxType@To@Bool@@) (|b_$7_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ |a_$12_$0| (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|)) (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|))  :pattern ( (Set@Intersection$BoxType$ |a_$12_$0| (Set@Intersection$BoxType$ |a_$12_$0| |b_$7_$0|))))) :named ax_72))
   (assert (! (forall( (|a_$13_$0| $@Map@@BoxType@To@Bool@@) (|b_$8_$0| $@Map@@BoxType@To@Bool@@))(!(= (+ (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$13_$0| |b_$8_$0|)) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$13_$0| |b_$8_$0|))) (+ (Set@Card$BoxType$ |a_$13_$0|) (Set@Card$BoxType$ |b_$8_$0|)))  :pattern ( (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$13_$0| |b_$8_$0|))) :pattern ( (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$13_$0| |b_$8_$0|))))) :named ax_73))
   (assert (! (forall( (|a_$14_$0| $@Map@@BoxType@To@Bool@@) (|b_$9_$0| $@Map@@BoxType@To@Bool@@) (|o_$4_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$14_$0| |b_$9_$0|) |o_$4_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$4_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$9_$0| |o_$4_$0|))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$14_$0| |b_$9_$0|) |o_$4_$0|)))) :named ax_74))
   (assert (! (forall( (|a_$15_$0| $@Map@@BoxType@To@Bool@@) (|b_$10_$0| $@Map@@BoxType@To@Bool@@) (|y_$2_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$10_$0| |y_$2_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$15_$0| |b_$10_$0|) |y_$2_$0|)))  :pattern ( (Set@Difference$BoxType$ |a_$15_$0| |b_$10_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$10_$0| |y_$2_$0|)))) :named ax_75))
   (assert (! (forall( (|a_$16_$0| $@Map@@BoxType@To@Bool@@) (|b_$11_$0| $@Map@@BoxType@To@Bool@@))(!(and (= (Set@Card$BoxType$ (Set@Union$BoxType$ |a_$16_$0| |b_$11_$0|)) (+ (+ (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|)) (Set@Card$BoxType$ (Set@Difference$BoxType$ |b_$11_$0| |a_$16_$0|))) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$16_$0| |b_$11_$0|)))) (= (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|)) (- (Set@Card$BoxType$ |a_$16_$0|) (Set@Card$BoxType$ (Set@Intersection$BoxType$ |a_$16_$0| |b_$11_$0|)))))  :pattern ( (Set@Card$BoxType$ (Set@Difference$BoxType$ |a_$16_$0| |b_$11_$0|))))) :named ax_76))
   (assert (! (forall( (|a_$18_$0| $@Map@@BoxType@To@Bool@@) (|b_$13_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Equal$BoxType$ |a_$18_$0| |b_$13_$0|) (forall( (|o_$6_$1| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$6_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$18_$0| |o_$6_$1|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$18_$0| |o_$6_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$6_$1|)))))  :pattern ( (Set@Equal$BoxType$ |a_$18_$0| |b_$13_$0|)))) :named ax_77))
   (assert (! (forall( (|a_$19_$0| $@Map@@BoxType@To@Bool@@) (|b_$14_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Equal$BoxType$ |a_$19_$0| |b_$14_$0|) (= |b_$14_$0| |a_$19_$0|))  :pattern ( (Set@Equal$BoxType$ |a_$19_$0| |b_$14_$0|)))) :named ax_78))
   (assert (! (forall( (|a_$2_$0| $@Map@@BoxType@To@Bool@@) (|x_$5_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$2_$0| |x_$5_$0|) (= (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$2_$0| |x_$5_$0|)) (Set@Card$BoxType$ |a_$2_$0|)))  :pattern ( (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$2_$0| |x_$5_$0|))))) :named ax_79))
   (assert (! (forall( (|a_$20_$0| $@Map@@BoxType@To@Bool@@) (|b_$15_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Disjoint$BoxType$ |a_$20_$0| |b_$15_$0|) (forall( (|o_$7_$1| BoxType))(!(or (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$15_$0| |o_$7_$1|)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$20_$0| |o_$7_$1|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$20_$0| |o_$7_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$15_$0| |o_$7_$1|)))))  :pattern ( (Set@Disjoint$BoxType$ |a_$20_$0| |b_$15_$0|)))) :named ax_80))
   (assert (! (forall( (|a_$21| Int) (|b_$16| Int))(!(= (= (Math@min |a_$21| |b_$16|) |a_$21|) (<= |a_$21| |b_$16|))  :pattern ( (Math@min |a_$21| |b_$16|)))) :named ax_81))
   (assert (! (forall( (|a_$22| Int) (|b_$17| Int))(!(= (= (Math@min |a_$22| |b_$17|) |b_$17|) (<= |b_$17| |a_$22|))  :pattern ( (Math@min |a_$22| |b_$17|)))) :named ax_82))
   (assert (! (forall( (|a_$23| Int) (|b_$18| Int))(!(or (= (Math@min |a_$23| |b_$18|) |b_$18|) (= (Math@min |a_$23| |b_$18|) |a_$23|))  :pattern ( (Math@min |a_$23| |b_$18|)))) :named ax_83))
   (assert (! (forall( (|a_$24| Int))(!(=> (<= 0 |a_$24|) (= (Math@clip |a_$24|) |a_$24|))  :pattern ( (Math@clip |a_$24|)))) :named ax_84))
   (assert (! (forall( (|a_$25| Int))(!(=> (< |a_$25| 0) (= (Math@clip |a_$25|) 0))  :pattern ( (Math@clip |a_$25|)))) :named ax_85))
   (assert (! (forall( (|a_$3_$0| $@Map@@BoxType@To@Bool@@) (|x_$6_$0| BoxType))(!(=> (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$3_$0| |x_$6_$0|)) (= (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$3_$0| |x_$6_$0|)) (+ (Set@Card$BoxType$ |a_$3_$0|) 1)))  :pattern ( (Set@Card$BoxType$ (Set@UnionOne$BoxType$ |a_$3_$0| |x_$6_$0|))))) :named ax_86))
   (assert (! (forall( (|a_$4_$0| $@Map@@BoxType@To@Bool@@) (|b_$51| $@Map@@BoxType@To@Bool@@) (|o_$2_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$4_$0| |b_$51|) |o_$2_$0|) (or (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$51| |o_$2_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$4_$0| |o_$2_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$4_$0| |b_$51|) |o_$2_$0|)))) :named ax_87))
   (assert (! (forall( (|a_$45_$0| Seq$BoxType$) (|b_$32_$0| Seq$BoxType$))(!(=> (Seq@Equal$BoxType$ |a_$45_$0| |b_$32_$0|) (= |b_$32_$0| |a_$45_$0|))  :pattern ( (Seq@Equal$BoxType$ |a_$45_$0| |b_$32_$0|)))) :named ax_88))
   (assert (! (forall( (|a_$45_$1| Seq$ref$) (|b_$32_$1| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$45_$1| |b_$32_$1|) (= |b_$32_$1| |a_$45_$1|))  :pattern ( (Seq@Equal$ref$ |a_$45_$1| |b_$32_$1|)))) :named ax_89))
   (assert (! (forall( (|a_$5_$0| $@Map@@BoxType@To@Bool@@) (|b_$0_$0| $@Map@@BoxType@To@Bool@@) (|y_$0_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$5_$0| |y_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$5_$0| |b_$0_$0|) |y_$0_$0|))  :pattern ( (Set@Union$BoxType$ |a_$5_$0| |b_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$5_$0| |y_$0_$0|)))) :named ax_90))
   (assert (! (forall( (|a_$51_$0| $@Map@@BoxType@To@Bool@@) (|b_$33_$0| $@Map@@BoxType@To@BoxType@@))(!(= (Map@Domain$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$51_$0| |b_$33_$0|)) |a_$51_$0|)  :pattern ( (Map@Domain$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$51_$0| |b_$33_$0|))))) :named ax_91))
   (assert (! (forall( (|a_$52_$0| $@Map@@BoxType@To@Bool@@) (|b_$34_$0| $@Map@@BoxType@To@BoxType@@))(!(= (Map@Elements$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$52_$0| |b_$34_$0|)) |b_$34_$0|)  :pattern ( (Map@Elements$BoxType$BoxType$ (Map@Glue$BoxType$BoxType$ |a_$52_$0| |b_$34_$0|))))) :named ax_92))
   (assert (! (forall( (|a_$53| ClassName) (|b_$42| ClassName))(!(and (= (TypeTupleCdr (TypeTuple |a_$53| |b_$42|)) |b_$42|) (= (TypeTupleCar (TypeTuple |a_$53| |b_$42|)) |a_$53|))  :pattern ( (TypeTuple |a_$53| |b_$42|)))) :named ax_93))
   (assert (! (forall( (|a_$54| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$50| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|c| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and ($HeapSucc |b_$50| |c|) ($HeapSucc |a_$54| |b_$50|)) ($HeapSucc |a_$54| |c|))  :pattern ( ($HeapSucc |a_$54| |b_$50|) ($HeapSucc |b_$50| |c|)))) :named ax_94))
   (assert (! (forall( (|a_$55| $@Map@@BoxType@To@Bool@@) (|x_$2_$0| BoxType) (|o_$1_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$55| |x_$2_$0|) |o_$1_$0|) (or (= |x_$2_$0| |o_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$55| |o_$1_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$55| |x_$2_$0|) |o_$1_$0|)))) :named ax_95))
   (assert (! (forall( (|a_$6_$0| $@Map@@BoxType@To@Bool@@) (|b_$1_$0| $@Map@@BoxType@To@Bool@@) (|y_$1_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$6_$0| |b_$1_$0|) |y_$1_$0|))  :pattern ( (Set@Union$BoxType$ |a_$6_$0| |b_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|)))) :named ax_96))
   (assert (! (forall( (|a_$7_$0| $@Map@@BoxType@To@Bool@@) (|b_$2_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Disjoint$BoxType$ |a_$7_$0| |b_$2_$0|) (and (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|) |b_$2_$0|) |a_$7_$0|) (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|) |a_$7_$0|) |b_$2_$0|)))  :pattern ( (Set@Union$BoxType$ |a_$7_$0| |b_$2_$0|)))) :named ax_97))
   (assert (! (forall( (|a_$8_$0| $@Map@@BoxType@To@Bool@@) (|b_$3_$0| $@Map@@BoxType@To@Bool@@) (|o_$3_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$8_$0| |b_$3_$0|) |o_$3_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$3_$0| |o_$3_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$8_$0| |o_$3_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$8_$0| |b_$3_$0|) |o_$3_$0|)))) :named ax_98))
   (assert (! (forall( (|a_$9_$0| $@Map@@BoxType@To@Bool@@) (|b_$4_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|) |b_$4_$0|) (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|))  :pattern ( (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$9_$0| |b_$4_$0|) |b_$4_$0|)))) :named ax_99))
   (assert (! (forall( (|b_$35| BoxType))(!(= |b_$35| ($Box$Int$ ($Unbox$Int$ |b_$35|)))  :pattern ( ($Unbox$Int$ |b_$35|)))) :named ax_100))
   (assert (! (forall( (|b_$36| BoxType))(!(= |b_$36| ($Box$ref$ ($Unbox$ref$ |b_$36|)))  :pattern ( ($Unbox$ref$ |b_$36|)))) :named ax_101))
   (assert (! (forall( (|b_$37| BoxType))(!(= |b_$37| ($Box$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$37|)))  :pattern ( ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$37|)))) :named ax_102))
   (assert (! (forall( (|b_$38| BoxType))(!(= |b_$38| ($Box$Seq$BoxType$$ ($Unbox$Seq$BoxType$$ |b_$38|)))  :pattern ( ($Unbox$Seq$BoxType$$ |b_$38|)))) :named ax_103))
   (assert (! (forall( (|b_$39| BoxType))(!(= |b_$39| ($Box$Map$BoxType$BoxType$$ ($Unbox$Map$BoxType$BoxType$$ |b_$39|)))  :pattern ( ($Unbox$Map$BoxType$BoxType$$ |b_$39|)))) :named ax_104))
   (assert (! (forall( (|b_$40| BoxType))(!(= |b_$40| ($Box$DatatypeType$ ($Unbox$DatatypeType$ |b_$40|)))  :pattern ( ($Unbox$DatatypeType$ |b_$40|)))) :named ax_105))
   (assert (! (forall( (|b_$41| BoxType))(!(=> ($IsCanonicalBoolBox |b_$41|) (= |b_$41| ($Box$Bool$ ($Unbox$Bool$ |b_$41|))))  :pattern ( ($Unbox$Bool$ |b_$41|)))) :named ax_106))
   (assert (! (forall( (|b_$43| BoxType) (|h_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$43| |h_$6|) (or (= null ($Unbox$ref$ |b_$43|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$6| ($Unbox$ref$ |b_$43|) alloc)))  :pattern ( (GenericAlloc |b_$43| |h_$6|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$6| ($Unbox$ref$ |b_$43|) alloc)))) :named ax_107))
   (assert (! (forall( (|b_$44| BoxType) (|h_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$21| Int))(!(=> (and (< |i_$21| (Seq@Length$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|))) (and (GenericAlloc |b_$44| |h_$7|) (<= 0 |i_$21|))) (GenericAlloc (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|) |i_$21|) |h_$7|))  :pattern ( (GenericAlloc |b_$44| |h_$7|) (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$44|) |i_$21|)))) :named ax_108))
   (assert (! (forall( (|b_$45| BoxType) (|h_$8| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$22| BoxType))(!(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|) (GenericAlloc |b_$45| |h_$8|)) (GenericAlloc (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|) |h_$8|))  :pattern ( (GenericAlloc |b_$45| |h_$8|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$45|)) |i_$22|)))) :named ax_109))
   (assert (! (forall( (|b_$46| BoxType) (|h_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|t_$2| BoxType))(!(=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$46|)) |t_$2|) (GenericAlloc |b_$46| |h_$9|)) (GenericAlloc |t_$2| |h_$9|))  :pattern ( (GenericAlloc |b_$46| |h_$9|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ ($Unbox$Map$BoxType$BoxType$$ |b_$46|)) |t_$2|)))) :named ax_110))
   (assert (! (forall( (|b_$47| BoxType) (|h_$10| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|t_$3| BoxType))(!(=> (and (GenericAlloc |b_$47| |h_$10|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$47|) |t_$3|)) (GenericAlloc |t_$3| |h_$10|))  :pattern ( (GenericAlloc |b_$47| |h_$10|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$47|) |t_$3|)))) :named ax_111))
   (assert (! (forall( (|b_$48| BoxType) (|h_$11| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$48| |h_$11|) (DtAlloc ($Unbox$DatatypeType$ |b_$48|) |h_$11|))  :pattern ( (GenericAlloc |b_$48| |h_$11|) (DtType ($Unbox$DatatypeType$ |b_$48|))))) :named ax_112))
   (assert (! (forall( (|b_$49| Bool) (|h_$12| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$12|) (GenericAlloc ($Box$Bool$ |b_$49|) |h_$12|))) :named ax_113))
   (assert (! (forall( (|cl_$0| ClassName) (|nm_$0| NameFamily))(!(and (= |nm_$0| (DeclName$Bool$ (FieldOfDecl$Bool$ |cl_$0| |nm_$0|))) (= (DeclType$Bool$ (FieldOfDecl$Bool$ |cl_$0| |nm_$0|)) |cl_$0|))  :pattern ( (FieldOfDecl$Bool$ |cl_$0| |nm_$0|)))) :named ax_114))
   (assert (! (forall( (|cl_$1| ClassName) (|nm_$1| NameFamily))(!(and (= |nm_$1| (DeclName$BoxType$ (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|))) (= (DeclType$BoxType$ (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|)) |cl_$1|))  :pattern ( (FieldOfDecl$BoxType$ |cl_$1| |nm_$1|)))) :named ax_115))
   (assert (! (forall( (|cl_$2| ClassName) (|nm_$2| NameFamily))(!(and (= |nm_$2| (DeclName$ref$ (FieldOfDecl$ref$ |cl_$2| |nm_$2|))) (= (DeclType$ref$ (FieldOfDecl$ref$ |cl_$2| |nm_$2|)) |cl_$2|))  :pattern ( (FieldOfDecl$ref$ |cl_$2| |nm_$2|)))) :named ax_116))
   (assert (! (forall( (|f_$2| Field$BoxType$) (|i_$19| Int))(!(= (FDim$BoxType$ (MultiIndexField |f_$2| |i_$19|)) (+ (FDim$BoxType$ |f_$2|) 1))  :pattern ( (MultiIndexField |f_$2| |i_$19|)))) :named ax_117))
   (assert (! (forall( (|f_$3| Field$BoxType$) (|i_$20| Int))(!(and (= (MultiIndexField_Inverse1$BoxType$ (MultiIndexField |f_$3| |i_$20|)) |i_$20|) (= (MultiIndexField_Inverse0$BoxType$ (MultiIndexField |f_$3| |i_$20|)) |f_$3|))  :pattern ( (MultiIndexField |f_$3| |i_$20|)))) :named ax_118))
   (assert (! (forall( (|f_$7| Field$Bool$) (|r_$9| ref) (|H_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$9| |f_$7|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$9| |f_$7|))) :named ax_119))
   (assert (! (forall( (|f_$8| Field$BoxType$) (|r_$10| ref) (|H_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$2| |r_$10| |f_$8|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$2| |r_$10| |f_$8|))) :named ax_120))
   (assert (! (forall( (|f_$9| Field$ref$) (|r_$11| ref) (|H_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$3| |r_$11| |f_$9|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$3| |r_$11| |f_$9|))) :named ax_121))
   (assert (! (forall( (|h_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$47| ref) (|i_$7| Int))(=> (and (< |i_$7| (Seq@Length$BoxType$ (Seq@FromArray |h_$0| |a_$47|))) (<= 0 |i_$7|)) (= (Seq@Index$BoxType$ (Seq@FromArray |h_$0| |a_$47|) |i_$7|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$0| |a_$47| (IndexField |i_$7|))))) :named ax_122))
   (assert (! (forall( (|h_$1_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$0| ref) (|f_$1_$0| Field$Bool$) (|v_$7_$0| Bool) (|a_$48_$0| ref))(!(=> (not (= |o_$17_$0| |a_$48_$0|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1_$0| |o_$17_$0| |f_$1_$0| |v_$7_$0|) |a_$48_$0|) (Seq@FromArray |h_$1_$0| |a_$48_$0|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1_$0| |o_$17_$0| |f_$1_$0| |v_$7_$0|) |a_$48_$0|)))) :named ax_123))
   (assert (! (forall( (|h_$1_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$1| ref) (|f_$1_$1| Field$BoxType$) (|v_$7_$1| BoxType) (|a_$48_$1| ref))(!(=> (not (= |o_$17_$1| |a_$48_$1|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$1_$1| |o_$17_$1| |f_$1_$1| |v_$7_$1|) |a_$48_$1|) (Seq@FromArray |h_$1_$1| |a_$48_$1|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$1_$1| |o_$17_$1| |f_$1_$1| |v_$7_$1|) |a_$48_$1|)))) :named ax_124))
   (assert (! (forall( (|h_$1_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|o_$17_$2| ref) (|f_$1_$2| Field$ref$) (|v_$7_$2| ref) (|a_$48_$2| ref))(!(=> (not (= |o_$17_$2| |a_$48_$2|)) (= (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$1_$2| |o_$17_$2| |f_$1_$2| |v_$7_$2|) |a_$48_$2|) (Seq@FromArray |h_$1_$2| |a_$48_$2|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$1_$2| |o_$17_$2| |f_$1_$2| |v_$7_$2|) |a_$48_$2|)))) :named ax_125))
   (assert (! (forall( (|h_$16_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$0| ref) (|f_$5_$0| Field$Bool$) (|x_$24_$0| Bool))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)) ($HeapSucc |h_$16_$0| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$16_$0| |r_$8_$0| |f_$5_$0| |x_$24_$0|)))) :named ax_126))
   (assert (! (forall( (|h_$16_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$1| ref) (|f_$5_$1| Field$BoxType$) (|x_$24_$1| BoxType))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)) ($HeapSucc |h_$16_$1| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$16_$1| |r_$8_$1| |f_$5_$1| |x_$24_$1|)))) :named ax_127))
   (assert (! (forall( (|h_$16_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$8_$2| ref) (|f_$5_$2| Field$ref$) (|x_$24_$2| ref))(!(=> ($IsGoodHeap (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)) ($HeapSucc |h_$16_$2| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$16_$2| |r_$8_$2| |f_$5_$2| |x_$24_$2|)))) :named ax_128))
   (assert (! (forall( (|h_$17| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> ($HeapSucc |h_$17| |k_$1|) (forall( (|o_$20| ref))(!(=> (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$17| |o_$20| alloc) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$20| alloc))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$20| alloc)))))  :pattern ( ($HeapSucc |h_$17| |k_$1|)))) :named ax_129))
   (assert (! (forall( (|h_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$8| Int) (|v_$8| BoxType) (|a_$49| ref))(!(=> (and (< |i_$8| (_System.array.Length |a_$49|)) (<= 0 |i_$8|)) (= (Seq@Update$BoxType$ (Seq@FromArray |h_$2| |a_$49|) |i_$8| |v_$8|) (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$2| |a_$49| (IndexField |i_$8|) |v_$8|) |a_$49|)))  :pattern ( (Seq@FromArray (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$2| |a_$49| (IndexField |i_$8|) |v_$8|) |a_$49|)))) :named ax_130))
   (assert (! (forall( (|h_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$50| ref) (|n0| Int) (|n1| Int))(!(=> (and (<= |n1| (_System.array.Length |a_$50|)) (and (= |n1| (+ |n0| 1)) (<= 0 |n0|))) (= (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n1|) (Seq@Build$BoxType$ (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$3| |a_$50| (IndexField |n0|)))))  :pattern ( (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n0|) (Seq@Take$BoxType$ (Seq@FromArray |h_$3| |a_$50|) |n1|)))) :named ax_131))
   (assert (! (forall( (|h_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d| DatatypeType))(!(=> ($HeapSucc |h_$4| |k|) (=> (DtAlloc |d| |h_$4|) (DtAlloc |d| |k|)))  :pattern ( ($HeapSucc |h_$4| |k|) (DtAlloc |d| |h_$4|)) :pattern ( ($HeapSucc |h_$4| |k|) (DtAlloc |d| |k|)))) :named ax_132))
   (assert (! (forall( (|h_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d_$0| BoxType))(!(=> ($HeapSucc |h_$5| |k_$0|) (=> (GenericAlloc |d_$0| |h_$5|) (GenericAlloc |d_$0| |k_$0|)))  :pattern ( ($HeapSucc |h_$5| |k_$0|) (GenericAlloc |d_$0| |h_$5|)) :pattern ( ($HeapSucc |h_$5| |k_$0|) (GenericAlloc |d_$0| |k_$0|)))) :named ax_133))
   (assert (! (forall( (|h| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|a_$46| ref))(!(= (Seq@Length$BoxType$ (Seq@FromArray |h| |a_$46|)) (_System.array.Length |a_$46|))  :pattern ( (Seq@Length$BoxType$ (Seq@FromArray |h| |a_$46|))))) :named ax_134))
   (assert (! (forall( (|i_$17| Int))(!(= (FDim$BoxType$ (IndexField |i_$17|)) 1)  :pattern ( (IndexField |i_$17|)))) :named ax_135))
   (assert (! (forall( (|k#10_$0| Int) (|l#11_$0| Int))(=> (and (< |l#11_$0| call4formal@A@1@0) (and (< |k#10_$0| |l#11_$0|) (<= 0 |k#10_$0|))) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |l#11_$0| S@0) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |k#10_$0| S@0))))) :named ax_136))
   (assert (! (forall( (|k#10| Int) (|l#11| Int))(=> (forall( (|k$ih#4#24| Int) (|l$ih#5#25| Int))(=> (or (and (< |l$ih#5#25| |l#11|) (and (= |k$ih#4#24| |k#10|) (<= 0 |l$ih#5#25|))) (and (< |k$ih#4#24| |k#10|) (<= 0 |k$ih#4#24|))) (=> (and (< |l$ih#5#25| call4formal@A@1@0) (and (< |k$ih#4#24| |l$ih#5#25|) (<= 0 |k$ih#4#24|))) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |l$ih#5#25| S@0) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |k$ih#4#24| S@0)))))) (=> (and (< |l#11| call4formal@A@1@0) (and (< |k#10| |l#11|) (<= 0 |k#10|))) (not (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this |l#11| S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this |k#10| S@0)))))) :named ax_137))
   (assert (! (forall( (|m_$0_$0| Map$BoxType$BoxType$))(!(= (= (Map@Card$BoxType$BoxType$ |m_$0_$0|) 0) (= |m_$0_$0| Map@Empty$BoxType$BoxType$))  :pattern ( (Map@Card$BoxType$BoxType$ |m_$0_$0|)))) :named ax_138))
   (assert (! (forall( (|m_$1_$0| Map$BoxType$BoxType$) (|u_$0_$0| BoxType) (|u'_$0| BoxType) (|v_$14_$0| BoxType))(!(and (=> (= |u_$0_$0| |u'_$0|) (and (= |v_$14_$0| (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|)) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|))) (=> (not (= |u_$0_$0| |u'_$0|)) (and (= (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|) (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ |m_$1_$0|) |u'_$0|)) (= (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ |m_$1_$0|) |u'_$0|)))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|)) :pattern ( (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$1_$0| |u_$0_$0| |v_$14_$0|)) |u'_$0|)))) :named ax_139))
   ...
   (assert (! (forall( (|m_$3_$0| Map$BoxType$BoxType$) (|u_$2_$0| BoxType) (|v_$16_$0| BoxType))(!(=> (not (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ |m_$3_$0|) |u_$2_$0|)) (= (Map@Card$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$3_$0| |u_$2_$0| |v_$16_$0|)) (+ (Map@Card$BoxType$BoxType$ |m_$3_$0|) 1)))  :pattern ( (Map@Card$BoxType$BoxType$ (Map@Build$BoxType$BoxType$ |m_$3_$0| |u_$2_$0| |v_$16_$0|))))) :named ax_141))
   (assert (! (forall( (|m_$4_$0| Map$BoxType$BoxType$) (|m'_$2| Map$BoxType$BoxType$))(!(= (Map@Equal$BoxType$BoxType$ |m_$4_$0| |m'_$2|) (and (forall( (|u_$4_$1| BoxType))(=> (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ |m_$4_$0|) |u_$4_$1|) (= (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ |m_$4_$0|) |u_$4_$1|) (MapRead$$@Map@@BoxType@To@BoxType@@$ (Map@Elements$BoxType$BoxType$ |m'_$2|) |u_$4_$1|)))) (forall( (|u_$3_$1| BoxType))(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ |m_$4_$0|) |u_$3_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ |m'_$2|) |u_$3_$1|)))))  :pattern ( (Map@Equal$BoxType$BoxType$ |m_$4_$0| |m'_$2|)))) :named ax_142))
   (assert (! (forall( (|m_$5_$0| Map$BoxType$BoxType$) (|m'_$0_$0| Map$BoxType$BoxType$))(!(=> (Map@Equal$BoxType$BoxType$ |m_$5_$0| |m'_$0_$0|) (= |m_$5_$0| |m'_$0_$0|))  :pattern ( (Map@Equal$BoxType$BoxType$ |m_$5_$0| |m'_$0_$0|)))) :named ax_143))
   (assert (! (forall( (|m_$7| Map$BoxType$BoxType$))(!(<= 0 (Map@Card$BoxType$BoxType$ |m_$7|))  :pattern ( (Map@Card$BoxType$BoxType$ |m_$7|)))) :named ax_144))
   (assert (! (forall( (|n#12| ref))(=> (or (= null |n#12|) (and (= (dtype |n#12|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |n#12| alloc))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ |n#12|)) (not (= null |n#12|))) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#12| _module.Node.next)))) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#12| _module.Node.next)))))) :named ax_145))
   (assert (! (forall( (|o_$19| ref))(<= 0 (_System.array.Length |o_$19|))) :named ax_146))
   (assert (! (forall( (|o_$22| BoxType))(!(not (MapRead$$@Map@@BoxType@To@Bool@@$ Set@Empty$BoxType$ |o_$22|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ Set@Empty$BoxType$ |o_$22|)))) :named ax_147))
   (assert (! (forall( (|r_$1_$0| BoxType))(!(MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$1_$0|) |r_$1_$0|)  :pattern ( (Set@Singleton$BoxType$ |r_$1_$0|)))) :named ax_148))
   (assert (! (forall( (|r_$2_$0| BoxType) (|o_$0_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$2_$0|) |o_$0_$0|) (= |r_$2_$0| |o_$0_$0|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$2_$0|) |o_$0_$0|)))) :named ax_149))
   (assert (! (forall( (|r_$3_$0| BoxType))(!(= (Set@Card$BoxType$ (Set@Singleton$BoxType$ |r_$3_$0|)) 1)  :pattern ( (Set@Card$BoxType$ (Set@Singleton$BoxType$ |r_$3_$0|))))) :named ax_150))
   (assert (! (forall( (|r_$6| ref) (|h_$14| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and (or (= |r_$6| null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$14| |r_$6| alloc)) ($IsGoodHeap |h_$14|)) (GenericAlloc ($Box$ref$ |r_$6|) |h_$14|))  :pattern ( (GenericAlloc ($Box$ref$ |r_$6|) |h_$14|)))) :named ax_151))
   (assert (! (forall( (|r_$7| ref) (|f_$4| Field$BoxType$) (|h_$15| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$15| |r_$7| alloc) (and ($IsGoodHeap |h_$15|) (not (= |r_$7| null)))) (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$15| |r_$7| |f_$4|) |h_$15|))  :pattern ( (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$15| |r_$7| |f_$4|) |h_$15|)))) :named ax_152))
   (assert (! (forall( (|s_$0_$0| $@Map@@BoxType@To@Bool@@))(!(and (= (= (Set@Card$BoxType$ |s_$0_$0|) 0) (= |s_$0_$0| Set@Empty$BoxType$)) (=> (not (= (Set@Card$BoxType$ |s_$0_$0|) 0)) (exists( (|x_$1_$1| BoxType))(MapRead$$@Map@@BoxType@To@Bool@@$ |s_$0_$0| |x_$1_$1|))))  :pattern ( (Set@Card$BoxType$ |s_$0_$0|)))) :named ax_153))
   (assert (! (forall( (|s_$10_$0| Seq$BoxType$))(!(<= 0 (Seq@Length$BoxType$ |s_$10_$0|))  :pattern ( (Seq@Length$BoxType$ |s_$10_$0|)))) :named ax_154))
   (assert (! (forall( (|s_$10_$1| Seq$ref$))(!(<= 0 (Seq@Length$ref$ |s_$10_$1|))  :pattern ( (Seq@Length$ref$ |s_$10_$1|)))) :named ax_155))
   (assert (! (forall( (|s_$11_$0| Seq$BoxType$))(!(=> (= (Seq@Length$BoxType$ |s_$11_$0|) 0) (= |s_$11_$0| Seq@Empty$BoxType$))  :pattern ( (Seq@Length$BoxType$ |s_$11_$0|)))) :named ax_156))
   (assert (! (forall( (|s_$11_$1| Seq$ref$))(!(=> (= (Seq@Length$ref$ |s_$11_$1|) 0) (= |s_$11_$1| Seq@Empty$ref$))  :pattern ( (Seq@Length$ref$ |s_$11_$1|)))) :named ax_157))
   (assert (! (forall( (|s_$12_$0| Seq$BoxType$) (|v_$2_$0| BoxType))(!(= (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$12_$0| |v_$2_$0|)) (+ 1 (Seq@Length$BoxType$ |s_$12_$0|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$12_$0| |v_$2_$0|))))) :named ax_158))
   (assert (! (forall( (|s_$12_$1| Seq$ref$) (|v_$2_$1| ref))(!(= (Seq@Length$ref$ (Seq@Build$ref$ |s_$12_$1| |v_$2_$1|)) (+ 1 (Seq@Length$ref$ |s_$12_$1|)))  :pattern ( (Seq@Length$ref$ (Seq@Build$ref$ |s_$12_$1| |v_$2_$1|))))) :named ax_159))
   (assert (! (forall( (|s_$13_$0| Seq$BoxType$) (|i_$1_$0| Int) (|v_$3_$0| BoxType))(!(and (=> (= (Seq@Length$BoxType$ |s_$13_$0|) |i_$1_$0|) (= |v_$3_$0| (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$13_$0| |v_$3_$0|) |i_$1_$0|))) (=> (not (= (Seq@Length$BoxType$ |s_$13_$0|) |i_$1_$0|)) (= (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$13_$0| |v_$3_$0|) |i_$1_$0|) (Seq@Index$BoxType$ |s_$13_$0| |i_$1_$0|))))  :pattern ( (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$13_$0| |v_$3_$0|) |i_$1_$0|)))) :named ax_160))
   (assert (! (forall( (|s_$13_$1| Seq$ref$) (|i_$1_$1| Int) (|v_$3_$1| ref))(!(and (=> (= (Seq@Length$ref$ |s_$13_$1|) |i_$1_$1|) (= |v_$3_$1| (Seq@Index$ref$ (Seq@Build$ref$ |s_$13_$1| |v_$3_$1|) |i_$1_$1|))) (=> (not (= (Seq@Length$ref$ |s_$13_$1|) |i_$1_$1|)) (= (Seq@Index$ref$ (Seq@Build$ref$ |s_$13_$1| |v_$3_$1|) |i_$1_$1|) (Seq@Index$ref$ |s_$13_$1| |i_$1_$1|))))  :pattern ( (Seq@Index$ref$ (Seq@Build$ref$ |s_$13_$1| |v_$3_$1|) |i_$1_$1|)))) :named ax_161))
   (assert (! (forall( (|s_$14_$0| Seq$BoxType$) (|i_$2_$0| Int) (|v_$4_$0| BoxType))(!(=> (and (< |i_$2_$0| (Seq@Length$BoxType$ |s_$14_$0|)) (<= 0 |i_$2_$0|)) (= (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$14_$0| |i_$2_$0| |v_$4_$0|)) (Seq@Length$BoxType$ |s_$14_$0|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$14_$0| |i_$2_$0| |v_$4_$0|))))) :named ax_162))
   (assert (! (forall( (|s_$14_$1| Seq$ref$) (|i_$2_$1| Int) (|v_$4_$1| ref))(!(=> (and (< |i_$2_$1| (Seq@Length$ref$ |s_$14_$1|)) (<= 0 |i_$2_$1|)) (= (Seq@Length$ref$ (Seq@Update$ref$ |s_$14_$1| |i_$2_$1| |v_$4_$1|)) (Seq@Length$ref$ |s_$14_$1|)))  :pattern ( (Seq@Length$ref$ (Seq@Update$ref$ |s_$14_$1| |i_$2_$1| |v_$4_$1|))))) :named ax_163))
   (assert (! (forall( (|s_$15_$0| Seq$BoxType$) (|i_$3_$0| Int) (|v_$5_$0| BoxType) (|n_$1_$0| Int))(!(=> (and (< |n_$1_$0| (Seq@Length$BoxType$ |s_$15_$0|)) (<= 0 |n_$1_$0|)) (and (=> (= |n_$1_$0| |i_$3_$0|) (= |v_$5_$0| (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$15_$0| |i_$3_$0| |v_$5_$0|) |n_$1_$0|))) (=> (not (= |n_$1_$0| |i_$3_$0|)) (= (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$15_$0| |i_$3_$0| |v_$5_$0|) |n_$1_$0|) (Seq@Index$BoxType$ |s_$15_$0| |n_$1_$0|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$15_$0| |i_$3_$0| |v_$5_$0|) |n_$1_$0|)))) :named ax_164))
   (assert (! (forall( (|s_$15_$1| Seq$ref$) (|i_$3_$1| Int) (|v_$5_$1| ref) (|n_$1_$1| Int))(!(=> (and (< |n_$1_$1| (Seq@Length$ref$ |s_$15_$1|)) (<= 0 |n_$1_$1|)) (and (=> (= |n_$1_$1| |i_$3_$1|) (= |v_$5_$1| (Seq@Index$ref$ (Seq@Update$ref$ |s_$15_$1| |i_$3_$1| |v_$5_$1|) |n_$1_$1|))) (=> (not (= |n_$1_$1| |i_$3_$1|)) (= (Seq@Index$ref$ (Seq@Update$ref$ |s_$15_$1| |i_$3_$1| |v_$5_$1|) |n_$1_$1|) (Seq@Index$ref$ |s_$15_$1| |n_$1_$1|)))))  :pattern ( (Seq@Index$ref$ (Seq@Update$ref$ |s_$15_$1| |i_$3_$1| |v_$5_$1|) |n_$1_$1|)))) :named ax_165))
   (assert (! (forall( (|s_$16_$0| Seq$BoxType$) (|x_$16_$0| BoxType))(!(= (Seq@Contains$BoxType$ |s_$16_$0| |x_$16_$0|) (exists( (|i_$4_$1| Int))(!(and (= |x_$16_$0| (Seq@Index$BoxType$ |s_$16_$0| |i_$4_$1|)) (and (< |i_$4_$1| (Seq@Length$BoxType$ |s_$16_$0|)) (<= 0 |i_$4_$1|)))  :pattern ( (Seq@Index$BoxType$ |s_$16_$0| |i_$4_$1|)))))  :pattern ( (Seq@Contains$BoxType$ |s_$16_$0| |x_$16_$0|)))) :named ax_166))
   (assert (! (forall( (|s_$16_$1| Seq$ref$) (|x_$16_$1| ref))(!(= (Seq@Contains$ref$ |s_$16_$1| |x_$16_$1|) (exists( (|i_$4_$3| Int))(!(and (= |x_$16_$1| (Seq@Index$ref$ |s_$16_$1| |i_$4_$3|)) (and (< |i_$4_$3| (Seq@Length$ref$ |s_$16_$1|)) (<= 0 |i_$4_$3|)))  :pattern ( (Seq@Index$ref$ |s_$16_$1| |i_$4_$3|)))))  :pattern ( (Seq@Contains$ref$ |s_$16_$1| |x_$16_$1|)))) :named ax_167))
   (assert (! (forall( (|s_$17_$0| Seq$BoxType$) (|v_$6_$0| BoxType) (|x_$19_$0| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$17_$0| |v_$6_$0|) |x_$19_$0|) (or (= |x_$19_$0| |v_$6_$0|) (Seq@Contains$BoxType$ |s_$17_$0| |x_$19_$0|)))  :pattern ( (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$17_$0| |v_$6_$0|) |x_$19_$0|)))) :named ax_168))
   (assert (! (forall( (|s_$17_$1| Seq$ref$) (|v_$6_$1| ref) (|x_$19_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Build$ref$ |s_$17_$1| |v_$6_$1|) |x_$19_$1|) (or (= |x_$19_$1| |v_$6_$1|) (Seq@Contains$ref$ |s_$17_$1| |x_$19_$1|)))  :pattern ( (Seq@Contains$ref$ (Seq@Build$ref$ |s_$17_$1| |v_$6_$1|) |x_$19_$1|)))) :named ax_169))
   (assert (! (forall( (|s_$18_$0| Seq$BoxType$) (|n_$2_$0| Int) (|x_$20_$0| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$18_$0| |n_$2_$0|) |x_$20_$0|) (exists( (|i_$5_$1| Int))(!(and (= |x_$20_$0| (Seq@Index$BoxType$ |s_$18_$0| |i_$5_$1|)) (and (< |i_$5_$1| (Seq@Length$BoxType$ |s_$18_$0|)) (and (< |i_$5_$1| |n_$2_$0|) (<= 0 |i_$5_$1|))))  :pattern ( (Seq@Index$BoxType$ |s_$18_$0| |i_$5_$1|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$18_$0| |n_$2_$0|) |x_$20_$0|)))) :named ax_170))
   (assert (! (forall( (|s_$18_$1| Seq$ref$) (|n_$2_$1| Int) (|x_$20_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Take$ref$ |s_$18_$1| |n_$2_$1|) |x_$20_$1|) (exists( (|i_$5_$3| Int))(!(and (= |x_$20_$1| (Seq@Index$ref$ |s_$18_$1| |i_$5_$3|)) (and (< |i_$5_$3| (Seq@Length$ref$ |s_$18_$1|)) (and (< |i_$5_$3| |n_$2_$1|) (<= 0 |i_$5_$3|))))  :pattern ( (Seq@Index$ref$ |s_$18_$1| |i_$5_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Take$ref$ |s_$18_$1| |n_$2_$1|) |x_$20_$1|)))) :named ax_171))
   (assert (! (forall( (|s_$19_$0| Seq$BoxType$) (|n_$3_$0| Int) (|x_$21_$0| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$19_$0| |n_$3_$0|) |x_$21_$0|) (exists( (|i_$6_$1| Int))(!(and (= |x_$21_$0| (Seq@Index$BoxType$ |s_$19_$0| |i_$6_$1|)) (and (< |i_$6_$1| (Seq@Length$BoxType$ |s_$19_$0|)) (and (<= |n_$3_$0| |i_$6_$1|) (<= 0 |n_$3_$0|))))  :pattern ( (Seq@Index$BoxType$ |s_$19_$0| |i_$6_$1|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$19_$0| |n_$3_$0|) |x_$21_$0|)))) :named ax_172))
   (assert (! (forall( (|s_$19_$1| Seq$ref$) (|n_$3_$1| Int) (|x_$21_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$19_$1| |n_$3_$1|) |x_$21_$1|) (exists( (|i_$6_$3| Int))(!(and (= |x_$21_$1| (Seq@Index$ref$ |s_$19_$1| |i_$6_$3|)) (and (< |i_$6_$3| (Seq@Length$ref$ |s_$19_$1|)) (and (<= |n_$3_$1| |i_$6_$3|) (<= 0 |n_$3_$1|))))  :pattern ( (Seq@Index$ref$ |s_$19_$1| |i_$6_$3|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$19_$1| |n_$3_$1|) |x_$21_$1|)))) :named ax_173))
   (assert (! (forall( (|s_$20_$0| Seq$BoxType$) (|n_$5_$0| Int))(!(=> (<= 0 |n_$5_$0|) (and (=> (< (Seq@Length$BoxType$ |s_$20_$0|) |n_$5_$0|) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$20_$0| |n_$5_$0|)) (Seq@Length$BoxType$ |s_$20_$0|))) (=> (<= |n_$5_$0| (Seq@Length$BoxType$ |s_$20_$0|)) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$20_$0| |n_$5_$0|)) |n_$5_$0|))))  :pattern ( (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$20_$0| |n_$5_$0|))))) :named ax_174))
   (assert (! (forall( (|s_$20_$1| Seq$ref$) (|n_$5_$1| Int))(!(=> (<= 0 |n_$5_$1|) (and (=> (< (Seq@Length$ref$ |s_$20_$1|) |n_$5_$1|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$20_$1| |n_$5_$1|)) (Seq@Length$ref$ |s_$20_$1|))) (=> (<= |n_$5_$1| (Seq@Length$ref$ |s_$20_$1|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$20_$1| |n_$5_$1|)) |n_$5_$1|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$20_$1| |n_$5_$1|))))) :named ax_175))
   (assert (! (forall( (|s_$21_$0| Seq$BoxType$) (|n_$6_$0| Int) (|j_$1_$0| Int))(!(=> (and (< |j_$1_$0| (Seq@Length$BoxType$ |s_$21_$0|)) (and (< |j_$1_$0| |n_$6_$0|) (<= 0 |j_$1_$0|))) (= (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$21_$0| |n_$6_$0|) |j_$1_$0|) (Seq@Index$BoxType$ |s_$21_$0| |j_$1_$0|)))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$21_$0| |n_$6_$0|) |j_$1_$0|)))) :named ax_176))
   (assert (! (forall( (|s_$21_$1| Seq$ref$) (|n_$6_$1| Int) (|j_$1_$1| Int))(!(=> (and (< |j_$1_$1| (Seq@Length$ref$ |s_$21_$1|)) (and (< |j_$1_$1| |n_$6_$1|) (<= 0 |j_$1_$1|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$21_$1| |n_$6_$1|) |j_$1_$1|) (Seq@Index$ref$ |s_$21_$1| |j_$1_$1|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$21_$1| |n_$6_$1|) |j_$1_$1|)))) :named ax_177))
   (assert (! (forall( (|s_$22_$0| Seq$BoxType$) (|n_$7_$0| Int))(!(=> (<= 0 |n_$7_$0|) (and (=> (< (Seq@Length$BoxType$ |s_$22_$0|) |n_$7_$0|) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$22_$0| |n_$7_$0|)) 0)) (=> (<= |n_$7_$0| (Seq@Length$BoxType$ |s_$22_$0|)) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$22_$0| |n_$7_$0|)) (- (Seq@Length$BoxType$ |s_$22_$0|) |n_$7_$0|)))))  :pattern ( (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$22_$0| |n_$7_$0|))))) :named ax_178))
   (assert (! (forall( (|s_$22_$1| Seq$ref$) (|n_$7_$1| Int))(!(=> (<= 0 |n_$7_$1|) (and (=> (< (Seq@Length$ref$ |s_$22_$1|) |n_$7_$1|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$22_$1| |n_$7_$1|)) 0)) (=> (<= |n_$7_$1| (Seq@Length$ref$ |s_$22_$1|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$22_$1| |n_$7_$1|)) (- (Seq@Length$ref$ |s_$22_$1|) |n_$7_$1|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$22_$1| |n_$7_$1|))))) :named ax_179))
   (assert (! (forall( (|s_$23_$0| Seq$BoxType$) (|n_$8_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (- (Seq@Length$BoxType$ |s_$23_$0|) |n_$8_$0|)) (and (<= 0 |n_$8_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$23_$0| |n_$8_$0|) |j_$2_$0|) (Seq@Index$BoxType$ |s_$23_$0| (+ |j_$2_$0| |n_$8_$0|))))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$23_$0| |n_$8_$0|) |j_$2_$0|)))) :named ax_180))
   (assert (! (forall( (|s_$23_$1| Seq$ref$) (|n_$8_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (- (Seq@Length$ref$ |s_$23_$1|) |n_$8_$1|)) (and (<= 0 |n_$8_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$ref$ (Seq@Drop$ref$ |s_$23_$1| |n_$8_$1|) |j_$2_$1|) (Seq@Index$ref$ |s_$23_$1| (+ |j_$2_$1| |n_$8_$1|))))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Drop$ref$ |s_$23_$1| |n_$8_$1|) |j_$2_$1|)))) :named ax_181))
   (assert (! (forall( (|s_$24_$0| Seq$BoxType$) (|t_$1_$0| Seq$BoxType$))(!(and (= |t_$1_$0| (Seq@Drop$BoxType$ (Seq@Append$BoxType$ |s_$24_$0| |t_$1_$0|) (Seq@Length$BoxType$ |s_$24_$0|))) (= (Seq@Take$BoxType$ (Seq@Append$BoxType$ |s_$24_$0| |t_$1_$0|) (Seq@Length$BoxType$ |s_$24_$0|)) |s_$24_$0|))  :pattern ( (Seq@Append$BoxType$ |s_$24_$0| |t_$1_$0|)))) :named ax_182))
   (assert (! (forall( (|s_$24_$1| Seq$ref$) (|t_$1_$1| Seq$ref$))(!(and (= |t_$1_$1| (Seq@Drop$ref$ (Seq@Append$ref$ |s_$24_$1| |t_$1_$1|) (Seq@Length$ref$ |s_$24_$1|))) (= (Seq@Take$ref$ (Seq@Append$ref$ |s_$24_$1| |t_$1_$1|) (Seq@Length$ref$ |s_$24_$1|)) |s_$24_$1|))  :pattern ( (Seq@Append$ref$ |s_$24_$1| |t_$1_$1|)))) :named ax_183))
   (assert (! (forall( (|s_$25_$0| Seq$BoxType$) (|i_$9_$0| Int) (|v_$9_$0| BoxType) (|n_$9_$0| Int))(!(=> (and (<= |n_$9_$0| (Seq@Length$BoxType$ |s_$25_$0|)) (and (< |i_$9_$0| |n_$9_$0|) (<= 0 |i_$9_$0|))) (= (Seq@Update$BoxType$ (Seq@Take$BoxType$ |s_$25_$0| |n_$9_$0|) |i_$9_$0| |v_$9_$0|) (Seq@Take$BoxType$ (Seq@Update$BoxType$ |s_$25_$0| |i_$9_$0| |v_$9_$0|) |n_$9_$0|)))  :pattern ( (Seq@Take$BoxType$ (Seq@Update$BoxType$ |s_$25_$0| |i_$9_$0| |v_$9_$0|) |n_$9_$0|)))) :named ax_184))
   (assert (! (forall( (|s_$25_$1| Seq$ref$) (|i_$9_$1| Int) (|v_$9_$1| ref) (|n_$9_$1| Int))(!(=> (and (<= |n_$9_$1| (Seq@Length$ref$ |s_$25_$1|)) (and (< |i_$9_$1| |n_$9_$1|) (<= 0 |i_$9_$1|))) (= (Seq@Update$ref$ (Seq@Take$ref$ |s_$25_$1| |n_$9_$1|) |i_$9_$1| |v_$9_$1|) (Seq@Take$ref$ (Seq@Update$ref$ |s_$25_$1| |i_$9_$1| |v_$9_$1|) |n_$9_$1|)))  :pattern ( (Seq@Take$ref$ (Seq@Update$ref$ |s_$25_$1| |i_$9_$1| |v_$9_$1|) |n_$9_$1|)))) :named ax_185))
   (assert (! (forall( (|s_$26_$0| Seq$BoxType$) (|i_$10_$0| Int) (|v_$10_$0| BoxType) (|n_$10_$0| Int))(!(=> (and (<= |n_$10_$0| |i_$10_$0|) (< |i_$10_$0| (Seq@Length$BoxType$ |s_$26_$0|))) (= (Seq@Take$BoxType$ (Seq@Update$BoxType$ |s_$26_$0| |i_$10_$0| |v_$10_$0|) |n_$10_$0|) (Seq@Take$BoxType$ |s_$26_$0| |n_$10_$0|)))  :pattern ( (Seq@Take$BoxType$ (Seq@Update$BoxType$ |s_$26_$0| |i_$10_$0| |v_$10_$0|) |n_$10_$0|)))) :named ax_186))
   (assert (! (forall( (|s_$26_$1| Seq$ref$) (|i_$10_$1| Int) (|v_$10_$1| ref) (|n_$10_$1| Int))(!(=> (and (<= |n_$10_$1| |i_$10_$1|) (< |i_$10_$1| (Seq@Length$ref$ |s_$26_$1|))) (= (Seq@Take$ref$ (Seq@Update$ref$ |s_$26_$1| |i_$10_$1| |v_$10_$1|) |n_$10_$1|) (Seq@Take$ref$ |s_$26_$1| |n_$10_$1|)))  :pattern ( (Seq@Take$ref$ (Seq@Update$ref$ |s_$26_$1| |i_$10_$1| |v_$10_$1|) |n_$10_$1|)))) :named ax_187))
   (assert (! (forall( (|s_$27_$0| Seq$BoxType$) (|i_$11_$0| Int) (|v_$11_$0| BoxType) (|n_$11_$0| Int))(!(=> (and (< |i_$11_$0| (Seq@Length$BoxType$ |s_$27_$0|)) (and (<= |n_$11_$0| |i_$11_$0|) (<= 0 |n_$11_$0|))) (= (Seq@Update$BoxType$ (Seq@Drop$BoxType$ |s_$27_$0| |n_$11_$0|) (- |i_$11_$0| |n_$11_$0|) |v_$11_$0|) (Seq@Drop$BoxType$ (Seq@Update$BoxType$ |s_$27_$0| |i_$11_$0| |v_$11_$0|) |n_$11_$0|)))  :pattern ( (Seq@Drop$BoxType$ (Seq@Update$BoxType$ |s_$27_$0| |i_$11_$0| |v_$11_$0|) |n_$11_$0|)))) :named ax_188))
   (assert (! (forall( (|s_$27_$1| Seq$ref$) (|i_$11_$1| Int) (|v_$11_$1| ref) (|n_$11_$1| Int))(!(=> (and (< |i_$11_$1| (Seq@Length$ref$ |s_$27_$1|)) (and (<= |n_$11_$1| |i_$11_$1|) (<= 0 |n_$11_$1|))) (= (Seq@Update$ref$ (Seq@Drop$ref$ |s_$27_$1| |n_$11_$1|) (- |i_$11_$1| |n_$11_$1|) |v_$11_$1|) (Seq@Drop$ref$ (Seq@Update$ref$ |s_$27_$1| |i_$11_$1| |v_$11_$1|) |n_$11_$1|)))  :pattern ( (Seq@Drop$ref$ (Seq@Update$ref$ |s_$27_$1| |i_$11_$1| |v_$11_$1|) |n_$11_$1|)))) :named ax_189))
   (assert (! (forall( (|s_$28_$0| Seq$BoxType$) (|i_$12_$0| Int) (|v_$12_$0| BoxType) (|n_$12_$0| Int))(!(=> (and (< |n_$12_$0| (Seq@Length$BoxType$ |s_$28_$0|)) (and (< |i_$12_$0| |n_$12_$0|) (<= 0 |i_$12_$0|))) (= (Seq@Drop$BoxType$ (Seq@Update$BoxType$ |s_$28_$0| |i_$12_$0| |v_$12_$0|) |n_$12_$0|) (Seq@Drop$BoxType$ |s_$28_$0| |n_$12_$0|)))  :pattern ( (Seq@Drop$BoxType$ (Seq@Update$BoxType$ |s_$28_$0| |i_$12_$0| |v_$12_$0|) |n_$12_$0|)))) :named ax_190))
   (assert (! (forall( (|s_$28_$1| Seq$ref$) (|i_$12_$1| Int) (|v_$12_$1| ref) (|n_$12_$1| Int))(!(=> (and (< |n_$12_$1| (Seq@Length$ref$ |s_$28_$1|)) (and (< |i_$12_$1| |n_$12_$1|) (<= 0 |i_$12_$1|))) (= (Seq@Drop$ref$ (Seq@Update$ref$ |s_$28_$1| |i_$12_$1| |v_$12_$1|) |n_$12_$1|) (Seq@Drop$ref$ |s_$28_$1| |n_$12_$1|)))  :pattern ( (Seq@Drop$ref$ (Seq@Update$ref$ |s_$28_$1| |i_$12_$1| |v_$12_$1|) |n_$12_$1|)))) :named ax_191))
   (assert (! (forall( (|s_$29_$0| Seq$BoxType$) (|v_$13_$0| BoxType) (|n_$13_$0| Int))(!(=> (and (<= |n_$13_$0| (Seq@Length$BoxType$ |s_$29_$0|)) (<= 0 |n_$13_$0|)) (= (Seq@Drop$BoxType$ (Seq@Build$BoxType$ |s_$29_$0| |v_$13_$0|) |n_$13_$0|) (Seq@Build$BoxType$ (Seq@Drop$BoxType$ |s_$29_$0| |n_$13_$0|) |v_$13_$0|)))  :pattern ( (Seq@Drop$BoxType$ (Seq@Build$BoxType$ |s_$29_$0| |v_$13_$0|) |n_$13_$0|)))) :named ax_192))
   (assert (! (forall( (|s_$29_$1| Seq$ref$) (|v_$13_$1| ref) (|n_$13_$1| Int))(!(=> (and (<= |n_$13_$1| (Seq@Length$ref$ |s_$29_$1|)) (<= 0 |n_$13_$1|)) (= (Seq@Drop$ref$ (Seq@Build$ref$ |s_$29_$1| |v_$13_$1|) |n_$13_$1|) (Seq@Build$ref$ (Seq@Drop$ref$ |s_$29_$1| |n_$13_$1|) |v_$13_$1|)))  :pattern ( (Seq@Drop$ref$ (Seq@Build$ref$ |s_$29_$1| |v_$13_$1|) |n_$13_$1|)))) :named ax_193))
   (assert (! (forall( (|s_$30| Seq$BoxType$) (|i_$13| Int))(!(=> (and (< |i_$13| (Seq@Length$BoxType$ |s_$30|)) (<= 0 |i_$13|)) (< (DtRank ($Unbox$DatatypeType$ (Seq@Index$BoxType$ |s_$30| |i_$13|))) (Seq@Rank$BoxType$ |s_$30|)))  :pattern ( (DtRank ($Unbox$DatatypeType$ (Seq@Index$BoxType$ |s_$30| |i_$13|)))))) :named ax_194))
   (assert (! (forall( (|s_$31_$0| Seq$BoxType$) (|i_$14_$0| Int))(!(=> (and (<= |i_$14_$0| (Seq@Length$BoxType$ |s_$31_$0|)) (< 0 |i_$14_$0|)) (< (Seq@Rank$BoxType$ (Seq@Drop$BoxType$ |s_$31_$0| |i_$14_$0|)) (Seq@Rank$BoxType$ |s_$31_$0|)))  :pattern ( (Seq@Rank$BoxType$ (Seq@Drop$BoxType$ |s_$31_$0| |i_$14_$0|))))) :named ax_195))
   (assert (! (forall( (|s_$31_$1| Seq$ref$) (|i_$14_$1| Int))(!(=> (and (<= |i_$14_$1| (Seq@Length$ref$ |s_$31_$1|)) (< 0 |i_$14_$1|)) (< (Seq@Rank$ref$ (Seq@Drop$ref$ |s_$31_$1| |i_$14_$1|)) (Seq@Rank$ref$ |s_$31_$1|)))  :pattern ( (Seq@Rank$ref$ (Seq@Drop$ref$ |s_$31_$1| |i_$14_$1|))))) :named ax_196))
   (assert (! (forall( (|s_$32_$0| Seq$BoxType$) (|i_$15_$0| Int))(!(=> (and (< |i_$15_$0| (Seq@Length$BoxType$ |s_$32_$0|)) (<= 0 |i_$15_$0|)) (< (Seq@Rank$BoxType$ (Seq@Take$BoxType$ |s_$32_$0| |i_$15_$0|)) (Seq@Rank$BoxType$ |s_$32_$0|)))  :pattern ( (Seq@Rank$BoxType$ (Seq@Take$BoxType$ |s_$32_$0| |i_$15_$0|))))) :named ax_197))
   (assert (! (forall( (|s_$32_$1| Seq$ref$) (|i_$15_$1| Int))(!(=> (and (< |i_$15_$1| (Seq@Length$ref$ |s_$32_$1|)) (<= 0 |i_$15_$1|)) (< (Seq@Rank$ref$ (Seq@Take$ref$ |s_$32_$1| |i_$15_$1|)) (Seq@Rank$ref$ |s_$32_$1|)))  :pattern ( (Seq@Rank$ref$ (Seq@Take$ref$ |s_$32_$1| |i_$15_$1|))))) :named ax_198))
   (assert (! (forall( (|s_$33_$0| Seq$BoxType$) (|i_$16_$0| Int) (|j_$3_$0| Int))(!(=> (and (<= |j_$3_$0| (Seq@Length$BoxType$ |s_$33_$0|)) (and (< |i_$16_$0| |j_$3_$0|) (<= 0 |i_$16_$0|))) (< (Seq@Rank$BoxType$ (Seq@Append$BoxType$ (Seq@Take$BoxType$ |s_$33_$0| |i_$16_$0|) (Seq@Drop$BoxType$ |s_$33_$0| |j_$3_$0|))) (Seq@Rank$BoxType$ |s_$33_$0|)))  :pattern ( (Seq@Rank$BoxType$ (Seq@Append$BoxType$ (Seq@Take$BoxType$ |s_$33_$0| |i_$16_$0|) (Seq@Drop$BoxType$ |s_$33_$0| |j_$3_$0|)))))) :named ax_199))
   (assert (! (forall( (|s_$33_$1| Seq$ref$) (|i_$16_$1| Int) (|j_$3_$1| Int))(!(=> (and (<= |j_$3_$1| (Seq@Length$ref$ |s_$33_$1|)) (and (< |i_$16_$1| |j_$3_$1|) (<= 0 |i_$16_$1|))) (< (Seq@Rank$ref$ (Seq@Append$ref$ (Seq@Take$ref$ |s_$33_$1| |i_$16_$1|) (Seq@Drop$ref$ |s_$33_$1| |j_$3_$1|))) (Seq@Rank$ref$ |s_$33_$1|)))  :pattern ( (Seq@Rank$ref$ (Seq@Append$ref$ (Seq@Take$ref$ |s_$33_$1| |i_$16_$1|) (Seq@Drop$ref$ |s_$33_$1| |j_$3_$1|)))))) :named ax_200))
   (assert (! (forall( (|s_$34| $@Map@@BoxType@To@Bool@@))(!(<= 0 (Set@Card$BoxType$ |s_$34|))  :pattern ( (Set@Card$BoxType$ |s_$34|)))) :named ax_201))
   (assert (! (forall( (|s0_$0_$0| Seq$BoxType$) (|s1_$0_$0| Seq$BoxType$) (|n_$0_$0| Int))(!(and (=> (<= (Seq@Length$BoxType$ |s0_$0_$0|) |n_$0_$0|) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$0| |s1_$0_$0|) |n_$0_$0|) (Seq@Index$BoxType$ |s1_$0_$0| (- |n_$0_$0| (Seq@Length$BoxType$ |s0_$0_$0|))))) (=> (< |n_$0_$0| (Seq@Length$BoxType$ |s0_$0_$0|)) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$0| |s1_$0_$0|) |n_$0_$0|) (Seq@Index$BoxType$ |s0_$0_$0| |n_$0_$0|))))  :pattern ( (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$0| |s1_$0_$0|) |n_$0_$0|)))) :named ax_202))
   (assert (! (forall( (|s0_$0_$1| Seq$ref$) (|s1_$0_$1| Seq$ref$) (|n_$0_$1| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$1|) |n_$0_$1|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$0_$1|) (Seq@Index$ref$ |s1_$0_$1| (- |n_$0_$1| (Seq@Length$ref$ |s0_$0_$1|))))) (=> (< |n_$0_$1| (Seq@Length$ref$ |s0_$0_$1|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$0_$1|) (Seq@Index$ref$ |s0_$0_$1| |n_$0_$1|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$1| |s1_$0_$1|) |n_$0_$1|)))) :named ax_203))
   (assert (! (forall( (|s0_$1_$0| Seq$BoxType$) (|s1_$1_$0| Seq$BoxType$) (|x_$18_$0| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$0| |s1_$1_$0|) |x_$18_$0|) (or (Seq@Contains$BoxType$ |s1_$1_$0| |x_$18_$0|) (Seq@Contains$BoxType$ |s0_$1_$0| |x_$18_$0|)))  :pattern ( (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$0| |s1_$1_$0|) |x_$18_$0|)))) :named ax_204))
   (assert (! (forall( (|s0_$1_$1| Seq$ref$) (|s1_$1_$1| Seq$ref$) (|x_$18_$1| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$18_$1|) (or (Seq@Contains$ref$ |s1_$1_$1| |x_$18_$1|) (Seq@Contains$ref$ |s0_$1_$1| |x_$18_$1|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$1| |s1_$1_$1|) |x_$18_$1|)))) :named ax_205))
   (assert (! (forall( (|s0_$2_$0| Seq$BoxType$) (|s1_$2_$0| Seq$BoxType$))(!(= (Seq@Equal$BoxType$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$BoxType$ |s1_$2_$0|) (Seq@Length$BoxType$ |s0_$2_$0|)) (forall( (|j_$5| Int))(!(=> (and (< |j_$5| (Seq@Length$BoxType$ |s0_$2_$0|)) (<= 0 |j_$5|)) (= (Seq@Index$BoxType$ |s1_$2_$0| |j_$5|) (Seq@Index$BoxType$ |s0_$2_$0| |j_$5|)))  :pattern ( (Seq@Index$BoxType$ |s0_$2_$0| |j_$5|)) :pattern ( (Seq@Index$BoxType$ |s1_$2_$0| |j_$5|))))))  :pattern ( (Seq@Equal$BoxType$ |s0_$2_$0| |s1_$2_$0|)))) :named ax_206))
   ...
   (assert (! (forall( (|s0_$4| Seq$BoxType$) (|s1_$4| Seq$BoxType$))(!(= (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$4| |s1_$4|)) (+ (Seq@Length$BoxType$ |s0_$4|) (Seq@Length$BoxType$ |s1_$4|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$4| |s1_$4|))))) :named ax_208))
   (assert (! (forall( (|s0_$5| Seq$ref$) (|s1_$5| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|)) (+ (Seq@Length$ref$ |s0_$5|) (Seq@Length$ref$ |s1_$5|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$5| |s1_$5|))))) :named ax_209))
   (assert (! (forall( (|ss_$0| $@Map@@BoxType@To@Bool@@) (|dummy_$1| Bool) (|bx_$0_$0| BoxType))(!(=> ($IsGoodSet_Extended$Bool$ |ss_$0| |dummy_$1|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$0| |bx_$0_$0|) (= |bx_$0_$0| ($Box$Bool$ ($Unbox$Bool$ |bx_$0_$0|)))))  :pattern ( ($IsGoodSet_Extended$Bool$ |ss_$0| |dummy_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$0| |bx_$0_$0|)))) :named ax_210))
   (assert (! (forall( (|ss_$1| $@Map@@BoxType@To@Bool@@) (|dummy_$2| BoxType) (|bx_$0_$1| BoxType))(!(=> ($IsGoodSet_Extended$BoxType$ |ss_$1| |dummy_$2|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$1| |bx_$0_$1|) (= |bx_$0_$1| ($Box$BoxType$ ($Unbox$BoxType$ |bx_$0_$1|)))))  :pattern ( ($IsGoodSet_Extended$BoxType$ |ss_$1| |dummy_$2|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$1| |bx_$0_$1|)))) :named ax_211))
   (assert (! (forall( (|ss_$10| $@Map@@BoxType@To@Bool@@) (|dummy_$11| Map$BoxType$BoxType$) (|bx_$0_$10| BoxType))(!(=> ($IsGoodSet_Extended$Map$BoxType$BoxType$$ |ss_$10| |dummy_$11|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$10| |bx_$0_$10|) (= |bx_$0_$10| ($Box$Map$BoxType$BoxType$$ ($Unbox$Map$BoxType$BoxType$$ |bx_$0_$10|)))))  :pattern ( ($IsGoodSet_Extended$Map$BoxType$BoxType$$ |ss_$10| |dummy_$11|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$10| |bx_$0_$10|)))) :named ax_212))
   (assert (! (forall( (|ss_$11| $@Map@@BoxType@To@Bool@@) (|dummy_$12| ClassName) (|bx_$0_$11| BoxType))(!(=> ($IsGoodSet_Extended$ClassName$ |ss_$11| |dummy_$12|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$11| |bx_$0_$11|) (= |bx_$0_$11| ($Box$ClassName$ ($Unbox$ClassName$ |bx_$0_$11|)))))  :pattern ( ($IsGoodSet_Extended$ClassName$ |ss_$11| |dummy_$12|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$11| |bx_$0_$11|)))) :named ax_213))
   (assert (! (forall( (|ss_$12| $@Map@@BoxType@To@Bool@@) (|dummy_$13| NameFamily) (|bx_$0_$12| BoxType))(!(=> ($IsGoodSet_Extended$NameFamily$ |ss_$12| |dummy_$13|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$12| |bx_$0_$12|) (= |bx_$0_$12| ($Box$NameFamily$ ($Unbox$NameFamily$ |bx_$0_$12|)))))  :pattern ( ($IsGoodSet_Extended$NameFamily$ |ss_$12| |dummy_$13|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$12| |bx_$0_$12|)))) :named ax_214))
   (assert (! (forall( (|ss_$13| $@Map@@BoxType@To@Bool@@) (|dummy_$14| Field$Bool$) (|bx_$0_$13| BoxType))(!(=> ($IsGoodSet_Extended$Field$Bool$$ |ss_$13| |dummy_$14|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$13| |bx_$0_$13|) (= |bx_$0_$13| ($Box$Field$Bool$$ ($Unbox$Field$Bool$$ |bx_$0_$13|)))))  :pattern ( ($IsGoodSet_Extended$Field$Bool$$ |ss_$13| |dummy_$14|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$13| |bx_$0_$13|)))) :named ax_215))
   (assert (! (forall( (|ss_$14| $@Map@@BoxType@To@Bool@@) (|dummy_$15| $@Map@@BoxType@To@BoxType@@) (|bx_$0_$14| BoxType))(!(=> ($IsGoodSet_Extended$$@Map@@BoxType@To@BoxType@@$ |ss_$14| |dummy_$15|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$14| |bx_$0_$14|) (= |bx_$0_$14| ($Box$$@Map@@BoxType@To@BoxType@@$ ($Unbox$$@Map@@BoxType@To@BoxType@@$ |bx_$0_$14|)))))  :pattern ( ($IsGoodSet_Extended$$@Map@@BoxType@To@BoxType@@$ |ss_$14| |dummy_$15|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$14| |bx_$0_$14|)))) :named ax_216))
   ...
   (assert (! (forall( (|ss_$16| $@Map@@BoxType@To@Bool@@) (|dummy_$17| LayerType) (|bx_$0_$16| BoxType))(!(=> ($IsGoodSet_Extended$LayerType$ |ss_$16| |dummy_$17|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$16| |bx_$0_$16|) (= |bx_$0_$16| ($Box$LayerType$ ($Unbox$LayerType$ |bx_$0_$16|)))))  :pattern ( ($IsGoodSet_Extended$LayerType$ |ss_$16| |dummy_$17|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$16| |bx_$0_$16|)))) :named ax_218))
   (assert (! (forall( (|ss_$17| $@Map@@BoxType@To@Bool@@) (|dummy_$18| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@) (|bx_$0_$17| BoxType))(!(=> ($IsGoodSet_Extended$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |ss_$17| |dummy_$18|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$17| |bx_$0_$17|) (= |bx_$0_$17| ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |bx_$0_$17|)))))  :pattern ( ($IsGoodSet_Extended$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |ss_$17| |dummy_$18|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$17| |bx_$0_$17|)))) :named ax_219))
   (assert (! (forall( (|ss_$2| $@Map@@BoxType@To@Bool@@) (|dummy_$3| Int) (|bx_$0_$2| BoxType))(!(=> ($IsGoodSet_Extended$Int$ |ss_$2| |dummy_$3|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$2| |bx_$0_$2|) (= |bx_$0_$2| ($Box$Int$ ($Unbox$Int$ |bx_$0_$2|)))))  :pattern ( ($IsGoodSet_Extended$Int$ |ss_$2| |dummy_$3|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$2| |bx_$0_$2|)))) :named ax_220))
   (assert (! (forall( (|ss_$3| $@Map@@BoxType@To@Bool@@) (|dummy_$4| Seq$ref$) (|bx_$0_$3| BoxType))(!(=> ($IsGoodSet_Extended$Seq$ref$$ |ss_$3| |dummy_$4|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$3| |bx_$0_$3|) (= |bx_$0_$3| ($Box$Seq$ref$$ ($Unbox$Seq$ref$$ |bx_$0_$3|)))))  :pattern ( ($IsGoodSet_Extended$Seq$ref$$ |ss_$3| |dummy_$4|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$3| |bx_$0_$3|)))) :named ax_221))
   (assert (! (forall( (|ss_$4| $@Map@@BoxType@To@Bool@@) (|dummy_$5| ref) (|bx_$0_$4| BoxType))(!(=> ($IsGoodSet_Extended$ref$ |ss_$4| |dummy_$5|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$4| |bx_$0_$4|) (= |bx_$0_$4| ($Box$ref$ ($Unbox$ref$ |bx_$0_$4|)))))  :pattern ( ($IsGoodSet_Extended$ref$ |ss_$4| |dummy_$5|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$4| |bx_$0_$4|)))) :named ax_222))
   (assert (! (forall( (|ss_$5| $@Map@@BoxType@To@Bool@@) (|dummy_$6| Seq$BoxType$) (|bx_$0_$5| BoxType))(!(=> ($IsGoodSet_Extended$Seq$BoxType$$ |ss_$5| |dummy_$6|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$5| |bx_$0_$5|) (= |bx_$0_$5| ($Box$Seq$BoxType$$ ($Unbox$Seq$BoxType$$ |bx_$0_$5|)))))  :pattern ( ($IsGoodSet_Extended$Seq$BoxType$$ |ss_$5| |dummy_$6|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$5| |bx_$0_$5|)))) :named ax_223))
   (assert (! (forall( (|ss_$6| $@Map@@BoxType@To@Bool@@) (|dummy_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|bx_$0_$6| BoxType))(!(=> ($IsGoodSet_Extended$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |ss_$6| |dummy_$7|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$6| |bx_$0_$6|) (= |bx_$0_$6| ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |bx_$0_$6|)))))  :pattern ( ($IsGoodSet_Extended$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |ss_$6| |dummy_$7|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$6| |bx_$0_$6|)))) :named ax_224))
   (assert (! (forall( (|ss_$7| $@Map@@BoxType@To@Bool@@) (|dummy_$8| Field$BoxType$) (|bx_$0_$7| BoxType))(!(=> ($IsGoodSet_Extended$Field$BoxType$$ |ss_$7| |dummy_$8|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$7| |bx_$0_$7|) (= |bx_$0_$7| ($Box$Field$BoxType$$ ($Unbox$Field$BoxType$$ |bx_$0_$7|)))))  :pattern ( ($IsGoodSet_Extended$Field$BoxType$$ |ss_$7| |dummy_$8|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$7| |bx_$0_$7|)))) :named ax_225))
   ...
   (assert (! (forall( (|ss_$9| $@Map@@BoxType@To@Bool@@) (|dummy_$10| $@Map@@BoxType@To@Bool@@) (|bx_$0_$9| BoxType))(!(=> ($IsGoodSet_Extended$$@Map@@BoxType@To@Bool@@$ |ss_$9| |dummy_$10|) (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$9| |bx_$0_$9|) (= |bx_$0_$9| ($Box$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |bx_$0_$9|)))))  :pattern ( ($IsGoodSet_Extended$$@Map@@BoxType@To@Bool@@$ |ss_$9| |dummy_$10|) (MapRead$$@Map@@BoxType@To@Bool@@$ |ss_$9| |bx_$0_$9|)))) :named ax_227))
   (assert (! (forall( (|t_$0_$0| BoxType))(!(= |t_$0_$0| (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$0|) 0)))) :named ax_228))
   ...
   (assert (! (forall( (|t_$5| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$5|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$5|))))) :named ax_231))
   (assert (! (forall( (|u_$5| BoxType))(!(not (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ Map@Empty$BoxType$BoxType$) |u_$5|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Map@Domain$BoxType$BoxType$ Map@Empty$BoxType$BoxType$) |u_$5|)))) :named ax_232))
   (assert (! (forall( (|v_$17| Bool) (|f_$0_$0| Field$Bool$) (|r_$0_$0| ref) (|H_$0_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$17|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$17|))) :named ax_233))
   (assert (! (forall( (|v_$18| BoxType) (|f_$0_$1| Field$BoxType$) (|r_$0_$1| ref) (|H_$0_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$18|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$18|))) :named ax_234))
   (assert (! (forall( (|v_$19| ref) (|f_$0_$2| Field$ref$) (|r_$0_$2| ref) (|H_$0_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$19|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$19|))) :named ax_235))
   (assert (! (forall( (|x_$0_$0| Bool))(!(= (Lit$BoxType$ ($Box$Bool$ |x_$0_$0|)) ($Box$Bool$ (Lit$Bool$ |x_$0_$0|)))  :pattern ( ($Box$Bool$ (Lit$Bool$ |x_$0_$0|))))) :named ax_236))
   (assert (! (forall( (|x_$0_$1| BoxType))(!(= (Lit$BoxType$ ($Box$BoxType$ |x_$0_$1|)) ($Box$BoxType$ (Lit$BoxType$ |x_$0_$1|)))  :pattern ( ($Box$BoxType$ (Lit$BoxType$ |x_$0_$1|))))) :named ax_237))
   (assert (! (forall( (|x_$0_$10| Map$BoxType$BoxType$))(!(= (Lit$BoxType$ ($Box$Map$BoxType$BoxType$$ |x_$0_$10|)) ($Box$Map$BoxType$BoxType$$ (Lit$Map$BoxType$BoxType$$ |x_$0_$10|)))  :pattern ( ($Box$Map$BoxType$BoxType$$ (Lit$Map$BoxType$BoxType$$ |x_$0_$10|))))) :named ax_238))
   (assert (! (forall( (|x_$0_$11| ClassName))(!(= (Lit$BoxType$ ($Box$ClassName$ |x_$0_$11|)) ($Box$ClassName$ (Lit$ClassName$ |x_$0_$11|)))  :pattern ( ($Box$ClassName$ (Lit$ClassName$ |x_$0_$11|))))) :named ax_239))
   (assert (! (forall( (|x_$0_$12| NameFamily))(!(= (Lit$BoxType$ ($Box$NameFamily$ |x_$0_$12|)) ($Box$NameFamily$ (Lit$NameFamily$ |x_$0_$12|)))  :pattern ( ($Box$NameFamily$ (Lit$NameFamily$ |x_$0_$12|))))) :named ax_240))
   (assert (! (forall( (|x_$0_$13| Field$Bool$))(!(= (Lit$BoxType$ ($Box$Field$Bool$$ |x_$0_$13|)) ($Box$Field$Bool$$ (Lit$Field$Bool$$ |x_$0_$13|)))  :pattern ( ($Box$Field$Bool$$ (Lit$Field$Bool$$ |x_$0_$13|))))) :named ax_241))
   (assert (! (forall( (|x_$0_$14| $@Map@@BoxType@To@BoxType@@))(!(= (Lit$BoxType$ ($Box$$@Map@@BoxType@To@BoxType@@$ |x_$0_$14|)) ($Box$$@Map@@BoxType@To@BoxType@@$ (Lit$$@Map@@BoxType@To@BoxType@@$ |x_$0_$14|)))  :pattern ( ($Box$$@Map@@BoxType@To@BoxType@@$ (Lit$$@Map@@BoxType@To@BoxType@@$ |x_$0_$14|))))) :named ax_242))
   (assert (! (forall( (|x_$0_$15| Field$ref$))(!(= (Lit$BoxType$ ($Box$Field$ref$$ |x_$0_$15|)) ($Box$Field$ref$$ (Lit$Field$ref$$ |x_$0_$15|)))  :pattern ( ($Box$Field$ref$$ (Lit$Field$ref$$ |x_$0_$15|))))) :named ax_243))
   (assert (! (forall( (|x_$0_$16| LayerType))(!(= (Lit$BoxType$ ($Box$LayerType$ |x_$0_$16|)) ($Box$LayerType$ (Lit$LayerType$ |x_$0_$16|)))  :pattern ( ($Box$LayerType$ (Lit$LayerType$ |x_$0_$16|))))) :named ax_244))
   (assert (! (forall( (|x_$0_$17| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= (Lit$BoxType$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$0_$17|)) ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ (Lit$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$0_$17|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ (Lit$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$0_$17|))))) :named ax_245))
   (assert (! (forall( (|x_$0_$2| Int))(!(= (Lit$BoxType$ ($Box$Int$ |x_$0_$2|)) ($Box$Int$ (Lit$Int$ |x_$0_$2|)))  :pattern ( ($Box$Int$ (Lit$Int$ |x_$0_$2|))))) :named ax_246))
   (assert (! (forall( (|x_$0_$3| Seq$ref$))(!(= (Lit$BoxType$ ($Box$Seq$ref$$ |x_$0_$3|)) ($Box$Seq$ref$$ (Lit$Seq$ref$$ |x_$0_$3|)))  :pattern ( ($Box$Seq$ref$$ (Lit$Seq$ref$$ |x_$0_$3|))))) :named ax_247))
   (assert (! (forall( (|x_$0_$4| ref))(!(= (Lit$BoxType$ ($Box$ref$ |x_$0_$4|)) ($Box$ref$ (Lit$ref$ |x_$0_$4|)))  :pattern ( ($Box$ref$ (Lit$ref$ |x_$0_$4|))))) :named ax_248))
   (assert (! (forall( (|x_$0_$5| Seq$BoxType$))(!(= (Lit$BoxType$ ($Box$Seq$BoxType$$ |x_$0_$5|)) ($Box$Seq$BoxType$$ (Lit$Seq$BoxType$$ |x_$0_$5|)))  :pattern ( ($Box$Seq$BoxType$$ (Lit$Seq$BoxType$$ |x_$0_$5|))))) :named ax_249))
   (assert (! (forall( (|x_$0_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (Lit$BoxType$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$0_$6|)) ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ (Lit$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$0_$6|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ (Lit$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$0_$6|))))) :named ax_250))
   (assert (! (forall( (|x_$0_$7| Field$BoxType$))(!(= (Lit$BoxType$ ($Box$Field$BoxType$$ |x_$0_$7|)) ($Box$Field$BoxType$$ (Lit$Field$BoxType$$ |x_$0_$7|)))  :pattern ( ($Box$Field$BoxType$$ (Lit$Field$BoxType$$ |x_$0_$7|))))) :named ax_251))
   (assert (! (forall( (|x_$0_$8| DatatypeType))(!(= (Lit$BoxType$ ($Box$DatatypeType$ |x_$0_$8|)) ($Box$DatatypeType$ (Lit$DatatypeType$ |x_$0_$8|)))  :pattern ( ($Box$DatatypeType$ (Lit$DatatypeType$ |x_$0_$8|))))) :named ax_252))
   (assert (! (forall( (|x_$0_$9| $@Map@@BoxType@To@Bool@@))(!(= (Lit$BoxType$ ($Box$$@Map@@BoxType@To@Bool@@$ |x_$0_$9|)) ($Box$$@Map@@BoxType@To@Bool@@$ (Lit$$@Map@@BoxType@To@Bool@@$ |x_$0_$9|)))  :pattern ( ($Box$$@Map@@BoxType@To@Bool@@$ (Lit$$@Map@@BoxType@To@Bool@@$ |x_$0_$9|))))) :named ax_253))
   (assert (! (forall( (|x_$17| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$17|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$17|)))) :named ax_254))
   (assert (! (forall( (|x_$22_$0| Bool))(!(= |x_$22_$0| ($Unbox$Bool$ ($Box$Bool$ |x_$22_$0|)))  :pattern ( ($Box$Bool$ |x_$22_$0|)))) :named ax_255))
   (assert (! (forall( (|x_$22_$1| BoxType))(!(= |x_$22_$1| ($Unbox$BoxType$ ($Box$BoxType$ |x_$22_$1|)))  :pattern ( ($Box$BoxType$ |x_$22_$1|)))) :named ax_256))
   (assert (! (forall( (|x_$22_$10| Map$BoxType$BoxType$))(!(= |x_$22_$10| ($Unbox$Map$BoxType$BoxType$$ ($Box$Map$BoxType$BoxType$$ |x_$22_$10|)))  :pattern ( ($Box$Map$BoxType$BoxType$$ |x_$22_$10|)))) :named ax_257))
   (assert (! (forall( (|x_$22_$11| ClassName))(!(= |x_$22_$11| ($Unbox$ClassName$ ($Box$ClassName$ |x_$22_$11|)))  :pattern ( ($Box$ClassName$ |x_$22_$11|)))) :named ax_258))
   (assert (! (forall( (|x_$22_$12| NameFamily))(!(= |x_$22_$12| ($Unbox$NameFamily$ ($Box$NameFamily$ |x_$22_$12|)))  :pattern ( ($Box$NameFamily$ |x_$22_$12|)))) :named ax_259))
   (assert (! (forall( (|x_$22_$13| Field$Bool$))(!(= |x_$22_$13| ($Unbox$Field$Bool$$ ($Box$Field$Bool$$ |x_$22_$13|)))  :pattern ( ($Box$Field$Bool$$ |x_$22_$13|)))) :named ax_260))
   (assert (! (forall( (|x_$22_$14| $@Map@@BoxType@To@BoxType@@))(!(= |x_$22_$14| ($Unbox$$@Map@@BoxType@To@BoxType@@$ ($Box$$@Map@@BoxType@To@BoxType@@$ |x_$22_$14|)))  :pattern ( ($Box$$@Map@@BoxType@To@BoxType@@$ |x_$22_$14|)))) :named ax_261))
   (assert (! (forall( (|x_$22_$15| Field$ref$))(!(= |x_$22_$15| ($Unbox$Field$ref$$ ($Box$Field$ref$$ |x_$22_$15|)))  :pattern ( ($Box$Field$ref$$ |x_$22_$15|)))) :named ax_262))
   (assert (! (forall( (|x_$22_$16| LayerType))(!(= |x_$22_$16| ($Unbox$LayerType$ ($Box$LayerType$ |x_$22_$16|)))  :pattern ( ($Box$LayerType$ |x_$22_$16|)))) :named ax_263))
   (assert (! (forall( (|x_$22_$17| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= |x_$22_$17| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$22_$17|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$22_$17|)))) :named ax_264))
   (assert (! (forall( (|x_$22_$2| Int))(!(= |x_$22_$2| ($Unbox$Int$ ($Box$Int$ |x_$22_$2|)))  :pattern ( ($Box$Int$ |x_$22_$2|)))) :named ax_265))
   (assert (! (forall( (|x_$22_$3| Seq$ref$))(!(= |x_$22_$3| ($Unbox$Seq$ref$$ ($Box$Seq$ref$$ |x_$22_$3|)))  :pattern ( ($Box$Seq$ref$$ |x_$22_$3|)))) :named ax_266))
   (assert (! (forall( (|x_$22_$4| ref))(!(= |x_$22_$4| ($Unbox$ref$ ($Box$ref$ |x_$22_$4|)))  :pattern ( ($Box$ref$ |x_$22_$4|)))) :named ax_267))
   (assert (! (forall( (|x_$22_$5| Seq$BoxType$))(!(= |x_$22_$5| ($Unbox$Seq$BoxType$$ ($Box$Seq$BoxType$$ |x_$22_$5|)))  :pattern ( ($Box$Seq$BoxType$$ |x_$22_$5|)))) :named ax_268))
   (assert (! (forall( (|x_$22_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= |x_$22_$6| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$22_$6|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$22_$6|)))) :named ax_269))
   (assert (! (forall( (|x_$22_$7| Field$BoxType$))(!(= |x_$22_$7| ($Unbox$Field$BoxType$$ ($Box$Field$BoxType$$ |x_$22_$7|)))  :pattern ( ($Box$Field$BoxType$$ |x_$22_$7|)))) :named ax_270))
   (assert (! (forall( (|x_$22_$8| DatatypeType))(!(= |x_$22_$8| ($Unbox$DatatypeType$ ($Box$DatatypeType$ |x_$22_$8|)))  :pattern ( ($Box$DatatypeType$ |x_$22_$8|)))) :named ax_271))
   (assert (! (forall( (|x_$22_$9| $@Map@@BoxType@To@Bool@@))(!(= |x_$22_$9| ($Unbox$$@Map@@BoxType@To@Bool@@$ ($Box$$@Map@@BoxType@To@Bool@@$ |x_$22_$9|)))  :pattern ( ($Box$$@Map@@BoxType@To@Bool@@$ |x_$22_$9|)))) :named ax_272))
   (assert (! (forall( (|x_$23| Int) (|h_$13| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$13|) (GenericAlloc ($Box$Int$ |x_$23|) |h_$13|))) :named ax_273))
   (assert (! (forall( (|x_$25| Bool))(!(= |x_$25| (Lit$Bool$ |x_$25|))  :identity  :pattern ( (Lit$Bool$ |x_$25|)))) :named ax_274))
   (assert (! (forall( (|x_$26| BoxType))(!(= |x_$26| (Lit$BoxType$ |x_$26|))  :identity  :pattern ( (Lit$BoxType$ |x_$26|)))) :named ax_275))
   (assert (! (forall( (|x_$27| Int))(!(= |x_$27| (Lit$Int$ |x_$27|))  :identity  :pattern ( (Lit$Int$ |x_$27|)))) :named ax_276))
   (assert (! (forall( (|x_$28| Seq$ref$))(!(= |x_$28| (Lit$Seq$ref$$ |x_$28|))  :identity  :pattern ( (Lit$Seq$ref$$ |x_$28|)))) :named ax_277))
   (assert (! (forall( (|x_$29| ref))(!(= |x_$29| (Lit$ref$ |x_$29|))  :identity  :pattern ( (Lit$ref$ |x_$29|)))) :named ax_278))
   (assert (! (forall( (|x_$30| Seq$BoxType$))(!(= |x_$30| (Lit$Seq$BoxType$$ |x_$30|))  :identity  :pattern ( (Lit$Seq$BoxType$$ |x_$30|)))) :named ax_279))
   (assert (! (forall( (|x_$31| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= |x_$31| (Lit$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$31|))  :identity  :pattern ( (Lit$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$31|)))) :named ax_280))
   (assert (! (forall( (|x_$32| Field$BoxType$))(!(= |x_$32| (Lit$Field$BoxType$$ |x_$32|))  :identity  :pattern ( (Lit$Field$BoxType$$ |x_$32|)))) :named ax_281))
   (assert (! (forall( (|x_$33| DatatypeType))(!(= |x_$33| (Lit$DatatypeType$ |x_$33|))  :identity  :pattern ( (Lit$DatatypeType$ |x_$33|)))) :named ax_282))
   (assert (! (forall( (|x_$34| $@Map@@BoxType@To@Bool@@))(!(= |x_$34| (Lit$$@Map@@BoxType@To@Bool@@$ |x_$34|))  :identity  :pattern ( (Lit$$@Map@@BoxType@To@Bool@@$ |x_$34|)))) :named ax_283))
   (assert (! (forall( (|x_$35| Map$BoxType$BoxType$))(!(= |x_$35| (Lit$Map$BoxType$BoxType$$ |x_$35|))  :identity  :pattern ( (Lit$Map$BoxType$BoxType$$ |x_$35|)))) :named ax_284))
   (assert (! (forall( (|x_$36| ClassName))(!(= |x_$36| (Lit$ClassName$ |x_$36|))  :identity  :pattern ( (Lit$ClassName$ |x_$36|)))) :named ax_285))
   (assert (! (forall( (|x_$37| NameFamily))(!(= |x_$37| (Lit$NameFamily$ |x_$37|))  :identity  :pattern ( (Lit$NameFamily$ |x_$37|)))) :named ax_286))
   (assert (! (forall( (|x_$38| Field$Bool$))(!(= |x_$38| (Lit$Field$Bool$$ |x_$38|))  :identity  :pattern ( (Lit$Field$Bool$$ |x_$38|)))) :named ax_287))
   (assert (! (forall( (|x_$39| $@Map@@BoxType@To@BoxType@@))(!(= |x_$39| (Lit$$@Map@@BoxType@To@BoxType@@$ |x_$39|))  :identity  :pattern ( (Lit$$@Map@@BoxType@To@BoxType@@$ |x_$39|)))) :named ax_288))
   (assert (! (forall( (|x_$40| Field$ref$))(!(= |x_$40| (Lit$Field$ref$$ |x_$40|))  :identity  :pattern ( (Lit$Field$ref$$ |x_$40|)))) :named ax_289))
   (assert (! (forall( (|x_$41| LayerType))(!(= |x_$41| (Lit$LayerType$ |x_$41|))  :identity  :pattern ( (Lit$LayerType$ |x_$41|)))) :named ax_290))
   (assert (! (forall( (|x_$42| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= |x_$42| (Lit$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$42|))  :identity  :pattern ( (Lit$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$42|)))) :named ax_291))
   (assert (! (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc) :named ax_292))
   (assert (! (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) :named ax_293))
   (assert (! (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) :named ax_294))
   (assert (! (not $NP@162) :named ax_295))
   (assert (! (not ($IsGhostField$Bool$ alloc)) :named ax_296))
   (assert (! (not ($IsGhostField$ref$ _module.Node.next)) :named ax_297))
   (assert (! (not ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_298))
   (assert (! (not (< call4formal@A@1@0 0)) :named ax_299))
   (assert (! (not (< call5formal@B@2@0 1)) :named ax_300))
   (assert (! (not (= 12 0)) :named ax_301))
   (assert (! (not (= 12 1)) :named ax_302))
   (assert (! (not (= 2 12)) :named ax_303))
   (assert (! (not (= null this)) :named ax_304))
   (assert (! (or (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap this call4formal@A@1@0 S@0) null) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap this call4formal@A@1@0 S@0) call5formal@B@2@0 S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap this call4formal@A@1@0 S@0))) :named ax_305))
   (assert (! (or (= hare@17 null) (and (= (dtype hare@17) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap hare@17 alloc))) :named ax_306))
   (assert (! (or (= tortoise@16 null) (and (= (dtype tortoise@16) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap tortoise@16 alloc))) :named ax_307))
   (assert (! true :named ax_308))
...
(let ((anon56_Else (=> (and true
    (not $@condition_$20)
    (not (and (and (and (<= 0 l@35@0) (<= 0 k@34@0)) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) _module.Node.next) null))))
  )
    anon35
)))
(let ((anon56_Then@4 (=> (and true
    (_module.Node.IsClosed $Heap@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) _module.Node.next) S@0)
    (_module.Node.Nexxxt@canCall $Heap@1 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) _module.Node.next) l@35@0 S@0)
  )
    anon35
)))
...
(let ((anon56_Then (=> (and true
    ...
    (not (< k@34@0 0))
    (not (< l@35@0 0))
    (not (= null (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0)))
    (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) _module.Node.next)))
  )(and 
...
(let ((anon55_Else (=> (and true
    (not $@condition_$17)
    (not (and (and (<= 0 l@35@0) (<= 0 k@34@0)) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this k@34@0 S@0) null))))
  )
    $branchMerge_5
)))
...
(let ((anon51_Else@20 (=> (and true
    ...
    (= $Heap@1 $Heap@3)
    (=> (and (= (_module.Node.Nexxxt ($LS $LZ) $Heap@1 this $rhs@13@1 S@0) $rhs@12@1) (< $rhs@13@1 $rhs@15@1)) (_module.Node.Nexxxt@canCall $Heap@1 this $rhs@15@1 S@0))
    ...
    (not (= $decr0$0@1 (+ (+ call4formal@A@1@0 call5formal@B@2@0) (* (- 1) $rhs@13@1))))
  )(and 
...
(let ((anon51_Else@7 (=> (and true
    ...
    (not (= null (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@1 this (+ t@18@0 1) S@0)))
  )(and 
...
(let ((anon0@13 (=> (and true
    ...
    ($IsGoodHeap $Heap@1)
    (=> $w0@0 (< t@18@0 h@19@0))
    (=> $w0@0 (<= 0 (+ call4formal@A@1@0 call5formal@B@2@0)))
