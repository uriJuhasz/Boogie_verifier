...
var $Heap : HeapType;
procedure CheckWellformed$$_module.Node.AnalyzeList (this : ref,S#0 : Set (BoxType) ) returns (A#1 : int,B#2 : int)
{
...
$start:
	...
	assume (((forall  $o_$8_$0 : ref, $f_$7_$0 : Field (Boolean) , alloc_$5_$0 : Field (Boolean) , null_$5_$0 : ref, $Heap_$16_$0 : HeapType :: {lambda#5(alloc_$5_$0,null_$5_$0,$Heap_$16_$0)[$o_$8_$0,$f_$7_$0]} ( lambda#5(alloc_$5_$0,null_$5_$0,$Heap_$16_$0)[$o_$8_$0,$f_$7_$0] <==> (((!($o_$8_$0 == null_$5_$0)) && $Heap_$16_$0[$o_$8_$0,alloc_$5_$0]) ==> false) ))) && ((forall  $o_$8_$1 : ref, $f_$7_$1 : Field (BoxType) , alloc_$5_$1 : Field (Boolean) , null_$5_$1 : ref, $Heap_$16_$1 : HeapType :: {lambda#5(alloc_$5_$1,null_$5_$1,$Heap_$16_$1)[$o_$8_$1,$f_$7_$1]} ( lambda#5(alloc_$5_$1,null_$5_$1,$Heap_$16_$1)[$o_$8_$1,$f_$7_$1] <==> (((!($o_$8_$1 == null_$5_$1)) && $Heap_$16_$1[$o_$8_$1,alloc_$5_$1]) ==> false) )))) && ((forall  $o_$8_$2 : ref, $f_$7_$2 : Field (ref) , alloc_$5_$2 : Field (Boolean) , null_$5_$2 : ref, $Heap_$16_$2 : HeapType :: {lambda#5(alloc_$5_$2,null_$5_$2,$Heap_$16_$2)[$o_$8_$2,$f_$7_$2]} ( lambda#5(alloc_$5_$2,null_$5_$2,$Heap_$16_$2)[$o_$8_$2,$f_$7_$2] <==> (((!($o_$8_$2 == null_$5_$2)) && $Heap_$16_$2[$o_$8_$2,alloc_$5_$2]) ==> false) )));
...
PreconditionGeneratedEntry:
	...
	assume ((forall  $t#0_$0 : BoxType :: {S#0[$t#0_$0]} ( S#0[$t#0_$0] ==> ((($Unbox($t#0_$0) : ref) == null) || ($Heap[($Unbox($t#0_$0) : ref),alloc] && (dtype(($Unbox($t#0_$0) : ref)) == class._module.Node))) ))) && $IsGoodSet_Extended(S#0,null);
	assume (0 == $ModuleContextHeight) && (4 == $FunctionContextHeight);
	goto anon0;
anon0:
	assume $_Frame_$_0 == lambda#5(alloc,null,$Heap);
	assume true;
	...
	assume true;
	if ($_$_condition) { goto anon11_Then; } else { goto anon11_Else; }
anon11_Then:
	assume $_$_condition;
	assume 0 <= A#1_$_0;
	goto anon2;
anon11_Else:
	...
	goto anon2;
anon2:
	assume (0 <= A#1_$_0) && (1 <= B#2_$_0);
	if ($_$_condition_$0) { goto anon12_Then; } else { goto anon12_Else; }
anon12_Then:
...
anon13_Then:
	...
	assume $_$_condition_$1 <==> ((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0));
	assume (0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0);
	goto $branchMerge_1;
anon13_Else:
	assume !$_$_condition_$1;
	assume $_$_condition_$1 <==> ((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0));
...
anon14_Then:
	...
	assume $_$_condition_$3 <==> (((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0)) && (l#5_$_0 < A#1_$_0));
	assume ((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0)) && (l#5_$_0 < A#1_$_0);
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0) && (0 <= k#4_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,this,k#4_$_0,S#0);
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0) && (0 <= l#5_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,this,l#5_$_0,S#0);
	goto anon8;
anon14_Else:
	assume !$_$_condition_$3;
	assume $_$_condition_$3 <==> (((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0)) && (l#5_$_0 < A#1_$_0));
	...
	goto anon8;
anon8:
	assume (forall  k#10 : Integer, l#11 : Integer :: ( true ==> ((((0 <= k#10) && (k#10 < l#11)) && (l#11 < A#1_$_0)) ==> (!(_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,k#10,S#0) == _module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,l#11,S#0)))) ));
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0) && (0 <= A#1_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,this,A#1_$_0,S#0);
	if ($_$_condition_$5) { goto anon15_Then; } else { goto anon15_Else; }
anon15_Then:
	assume $_$_condition_$5;
	assume $_$_condition_$5 <==> (!(_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0) == null));
	assume !(_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0) == null);
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0) && (0 <= A#1_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,this,A#1_$_0,S#0);
	assert  !(_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0) == null);
	assert  _module.Node.IsClosed($Heap_$_0,_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0),S#0) && (0 <= B#2_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0),B#2_$_0,S#0);
	assert  _module.Node.IsClosed($Heap_$_0,this,S#0) && (0 <= A#1_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_0,this,A#1_$_0,S#0);
	goto anon10;
anon15_Else:
	...
	goto anon10;
anon10:
	assume (_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0) == null) || (_module.Node.Nexxxt($LS($LZ),$Heap_$_0,_module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0),B#2_$_0,S#0) == _module.Node.Nexxxt($LS($LZ),$Heap_$_0,this,A#1_$_0,S#0));
	goto $exit;
$branchMerge_0:
	if ($_$_condition_$1) { goto anon13_Then; } else { goto anon13_Else; }
$branchMerge_1:
	if ($_$_condition_$3) { goto anon14_Then; } else { goto anon14_Else; }
}
