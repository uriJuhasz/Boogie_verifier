...
(assert (! (=> $start (and true 
   (and true
      ...
      (forall( (|$o_$8_$0| ref) (|$f_$7_$0| Field$Bool$) (|alloc_$5_$0| Field$Bool$) (|null_$5_$0| ref) (|$Heap_$16_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@5 |alloc_$5_$0| |null_$5_$0| |$Heap_$16_$0|) |$o_$8_$0| |$f_$7_$0|) (=> (and (not (= |$o_$8_$0| |null_$5_$0|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$16_$0| |$o_$8_$0| |alloc_$5_$0|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@5 |alloc_$5_$0| |null_$5_$0| |$Heap_$16_$0|) |$o_$8_$0| |$f_$7_$0|))))
      (forall( (|$o_$8_$1| ref) (|$f_$7_$1| Field$BoxType$) (|alloc_$5_$1| Field$Bool$) (|null_$5_$1| ref) (|$Heap_$16_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@5 |alloc_$5_$1| |null_$5_$1| |$Heap_$16_$1|) |$o_$8_$1| |$f_$7_$1|) (=> (and (not (= |$o_$8_$1| |null_$5_$1|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$16_$1| |$o_$8_$1| |alloc_$5_$1|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@5 |alloc_$5_$1| |null_$5_$1| |$Heap_$16_$1|) |$o_$8_$1| |$f_$7_$1|))))
      (forall( (|$o_$8_$2| ref) (|$f_$7_$2| Field$ref$) (|alloc_$5_$2| Field$Bool$) (|null_$5_$2| ref) (|$Heap_$16_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@5 |alloc_$5_$2| |null_$5_$2| |$Heap_$16_$2|) |$o_$8_$2| |$f_$7_$2|) (=> (and (not (= |$o_$8_$2| |null_$5_$2|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$16_$2| |$o_$8_$2| |alloc_$5_$2|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@5 |alloc_$5_$2| |null_$5_$2| |$Heap_$16_$2|) |$o_$8_$2| |$f_$7_$2|))))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (forall( (|$t#0_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#0_$0|) (or (= ($Unbox$ref$ |$t#0_$0|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#0_$0|) alloc) (= (dtype ($Unbox$ref$ |$t#0_$0|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#0_$0|))))
...
(assert (! (=> anon0 (and true 
   (and true
      ...
      (= $_Frame@0 (lambda@5 alloc null $Heap))
      (= $Heap $Heap@0)
   )
...
(assert (! (=> anon15_Then@3 (and true 
   (and true
      (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this A@1@0 S@0) S@0)
      (_module.Node.Nexxxt@canCall $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this A@1@0 S@0) B@2@0 S@0)
      (<= 0 B@2@0)
   )
