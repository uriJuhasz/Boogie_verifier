...
procedure Impl$$_module.Node.Cyclic (this : ref,S#0 : Set (BoxType) ) returns (reachesCycle#1 : bool,$_reverifyPost : bool)
{
	...
	var $w0_$_0 : bool;
	var d##50_$_0 : int;
	var S##51_$_0 : Set (BoxType) ;
	var $Heap_$_1 : HeapType;
	var $Tick_$_1 : TickType;
	var k#52_$_0 : int;
	var S#53_$_0 : Set (BoxType) ;
	var $rhs#12_$_0 : ref;
	var $rhs#13_$_0 : int;
	var $rhs#14_$_0 : ref;
	var $rhs#15_$_0 : int;
...
PreconditionGeneratedEntry:
	...
	assume ((forall  $t#2_$0 : BoxType :: {S#0[$t#2_$0]} ( S#0[$t#2_$0] ==> ((($Unbox($t#2_$0) : ref) == null) || (read($Heap,($Unbox($t#2_$0) : ref),alloc) && (dtype(($Unbox($t#2_$0) : ref)) == class._module.Node))) ))) && $IsGoodSet_Extended(S#0,null);
	assume (tortoise#16 == null) || (read($Heap,tortoise#16,alloc) && (dtype(tortoise#16) == class._module.Node));
	assume (hare#17 == null) || (read($Heap,hare#17,alloc) && (dtype(hare#17) == class._module.Node));
	...
	assume _module.Node.IsClosed#canCall($Heap,this,S#0) ==> (_module.Node.IsClosed($Heap,this,S#0) || ((forall  n#11 : ref :: ( ((n#11 == null) || (read($Heap,n#11,alloc) && (dtype(n#11) == class._module.Node))) ==> (((S#0[$Box(n#11)] && (!(n#11 == null))) && (!(read($Heap,n#11,_module.Node.next) == null))) ==> S#0[$Box(read($Heap,n#11,_module.Node.next))]) ))));
	assume (((_module.Node.IsClosed#canCall($Heap,this,S#0) && _module.Node.IsClosed($Heap,this,S#0)) && S#0[$Box(this)]) && S#0[$Box(null)]) && ((forall  n#12 : ref :: ( ((n#12 == null) || (read($Heap,n#12,alloc) && (dtype(n#12) == class._module.Node))) ==> (((S#0[$Box(n#12)] && (!(n#12 == null))) && (!(read($Heap,n#12,_module.Node.next) == null))) ==> S#0[$Box(read($Heap,n#12,_module.Node.next))]) )));
	goto anon0;
anon0:
	...
	assume true;
	assume true;
	assert  (forall<alpha> $o_$26 : ref, $f_$25 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$26,$f_$25] ));
	...
	assert  _module.Node.IsClosed#canCall($Heap,this,S#0) ==> (_module.Node.IsClosed($Heap,this,S#0) || ((forall  n#22 : ref :: ( ((n#22 == null) || (read($Heap,n#22,alloc) && (dtype(n#22) == class._module.Node))) ==> (((S#0[$Box(n#22)] && (!(n#22 == null))) && (!(read($Heap,n#22,_module.Node.next) == null))) ==> S#0[$Box(read($Heap,n#22,_module.Node.next))]) ))));
	...
	assume true;
	assume true;
	assume $rhs#6_$_0 == read($Heap_$_0,this,_module.Node.next);
	assume true;
	assume true;
	assume true;
	assume true;
...
anon39_LoopHead:
	...
	assume (tortoise#16_$_0 == null) || (read($Heap_$_1,tortoise#16_$_0,alloc) && (dtype(tortoise#16_$_0) == class._module.Node));
	assume (hare#17_$_0 == null) || (read($Heap_$_1,hare#17_$_0,alloc) && (dtype(hare#17_$_0) == class._module.Node));
	...
	assume (forall<alpha> $o_$27 : ref, $f_$26 : Field (alpha)  :: {read($Heap_$_1,$o_$27,$f_$26)} ( ((!($o_$27 == null)) && read($Heap,$o_$27,alloc)) ==> (read($Heap_$_1,$o_$27,$f_$26) == read($Heap_$_0,$o_$27,$f_$26)) ));
	assume $HeapSucc($Heap_$_0,$Heap_$_1);
	assume (forall<alpha> $o_$28 : ref, $f_$27 : Field (alpha)  :: {read($Heap_$_1,$o_$28,$f_$27)} ( ((!($o_$28 == null)) && read($Heap_$_0,$o_$28,alloc)) ==> ((read($Heap_$_1,$o_$28,$f_$27) == read($Heap_$_0,$o_$28,$f_$27)) || $_Frame_$_0[$o_$28,$f_$27]) ));
...
anon38:
	assume true;
	assume true;
	assert  (forall<alpha> $o_$29 : ref, $f_$28 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$29,$f_$28] ));
	...
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || ((forall  n#10 : ref :: ( ((n#10 == null) || (read($Heap_$_1,n#10,alloc) && (dtype(n#10) == class._module.Node))) ==> (((S#0[$Box(n#10)] && (!(n#10 == null))) && (!(read($Heap_$_1,n#10,_module.Node.next) == null))) ==> S#0[$Box(read($Heap_$_1,n#10,_module.Node.next))]) ))));
	assert  0 <= h#19_$_0;
	...
	assume true;
	assert  (forall<alpha> $o_$30 : ref, $f_$29 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$30,$f_$29] ));
	...
	assert  _module.Node.IsClosed#canCall($Heap_$_5,this,S#0) ==> (_module.Node.IsClosed($Heap_$_5,this,S#0) || ((forall  n#12_$0 : ref :: ( ((n#12_$0 == null) || (read($Heap_$_5,n#12_$0,alloc) && (dtype(n#12_$0) == class._module.Node))) ==> (((S#0[$Box(n#12_$0)] && (!(n#12_$0 == null))) && (!(read($Heap_$_5,n#12_$0,_module.Node.next) == null))) ==> S#0[$Box(read($Heap_$_5,n#12_$0,_module.Node.next))]) ))));
	assert  0 <= x##59_$_0;
	assert  0 <= y##60_$_0;
	...
	assert  !(read($Heap_$_6,tortoise#16_$_0,_module.Node.next) == null);
	assert  _module.Node.IsClosed($Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),S#0);
	assume _module.Node.Reaches#canCall($Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),tortoise#16_$_0,S#0);
	assume _module.Node.Reaches#canCall($Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),tortoise#16_$_0,S#0);
	assert  _module.Node.Reaches#canCall($Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),tortoise#16_$_0,S#0) ==> (_module.Node.Reaches($LS($LZ),$Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),tortoise#16_$_0,S#0) || ((exists  k#64 : Integer :: ( (0 <= k#64) && (_module.Node.Nexxxt($LS($LZ),$Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),k#64,S#0) == tortoise#16_$_0) ))));
	assume _module.Node.Reaches($LS($LZ),$Heap_$_6,read($Heap_$_6,tortoise#16_$_0,_module.Node.next),tortoise#16_$_0,S#0);
	assume true;
	assume true;
...
anon41_Else:
	assume tortoise#16_$_0 == null;
	if ($_$_condition_$4) { goto anon42_Then; } else { goto anon42_Else; }
anon49_Then:
...
GeneratedUnifiedExit:
	assert  reachesCycle#1_$_2 <==> ((exists  n#8 : ref :: ( (((((n#8 == null) || (read($Heap_$_7,n#8,alloc) && (dtype(n#8) == class._module.Node))) && (!(n#8 == null))) && _module.Node.Reaches($LS($LS($LZ)),$Heap_$_7,this,n#8,S#0)) && (!(read($Heap_$_7,n#8,_module.Node.next) == null))) && _module.Node.Reaches($LS($LS($LZ)),$Heap_$_7,read($Heap_$_7,n#8,_module.Node.next),n#8,S#0) )));
	goto $exit;
anon23:
...
anon43_Else:
	assume t#18_$_0 < 0;
	if ($_$_condition_$9) { goto anon44_Then; } else { goto anon44_Else; }
anon51_Then:
	assume (hare#17_$_0 == null) || (read($Heap_$_1,hare#17_$_0,_module.Node.next) == null);
	assume true;
...
anon51_Else:
	...
	assume true;
	assert  (forall<alpha> $o_$31 : ref, $f_$30 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$31,$f_$30] ));
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || S#0[$Box(this)]);
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || S#0[$Box(null)]);
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || ((forall  n#10_$0 : ref :: ( ((n#10_$0 == null) || (read($Heap_$_1,n#10_$0,alloc) && (dtype(n#10_$0) == class._module.Node))) ==> (((S#0[$Box(n#10_$0)] && (!(n#10_$0 == null))) && (!(read($Heap_$_1,n#10_$0,_module.Node.next) == null))) ==> S#0[$Box(read($Heap_$_1,n#10_$0,_module.Node.next))]) ))));
	assert  0 <= d##50_$_1;
	...
	assert  !(tortoise#16_$_0 == null);
	assume true;
	assume $rhs#12_$_1 == read($Heap_$_2,tortoise#16_$_0,_module.Node.next);
	assume true;
	assume $rhs#13_$_1 == (t#18_$_0 + 1);
	assert  !(hare#17_$_0 == null);
	assert  !(read($Heap_$_2,hare#17_$_0,_module.Node.next) == null);
	assume true;
	assume $rhs#14_$_1 == read($Heap_$_2,read($Heap_$_2,hare#17_$_0,_module.Node.next),_module.Node.next);
	assume true;
	...
	assume true;
	assume true;
	assert  (forall<alpha> $o_$32 : ref, $f_$31 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$32,$f_$31] ));
	...
	assert  _module.Node.IsClosed#canCall($Heap_$_2,this,S#0) ==> (_module.Node.IsClosed($Heap_$_2,this,S#0) || ((forall  n#28 : ref :: ( ((n#28 == null) || (read($Heap_$_2,n#28,alloc) && (dtype(n#28) == class._module.Node))) ==> (((S#0[$Box(n#28)] && (!(n#28 == null))) && (!(read($Heap_$_2,n#28,_module.Node.next) == null))) ==> S#0[$Box(read($Heap_$_2,n#28,_module.Node.next))]) ))));
...
anon44_Else:
	assume !((0 <= t#18_$_0) && (t#18_$_0 < h#19_$_0));
	if ($_$_condition_$12) { goto anon45_Then; } else { goto anon45_Else; }
anon52_Then:
	assume hare#17_$_0 == null;
	goto anon27;
anon52_Else:
...
anon27:
	...
	assume true;
	assume true;
	assert  (forall<alpha> $o_$33 : ref, $f_$32 : Field (alpha)  :: ( false ==> $_Frame_$_0[$o_$33,$f_$32] ));
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || S#0[$Box(this)]);
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || S#0[$Box(null)]);
	assert  _module.Node.IsClosed#canCall($Heap_$_1,this,S#0) ==> (_module.Node.IsClosed($Heap_$_1,this,S#0) || ((forall  n#21 : ref :: ( ((n#21 == null) || (read($Heap_$_1,n#21,alloc) && (dtype(n#21) == class._module.Node))) ==> (((S#0[$Box(n#21)] && (!(n#21 == null))) && (!(read($Heap_$_1,n#21,_module.Node.next) == null))) ==> S#0[$Box(read($Heap_$_1,n#21,_module.Node.next))]) ))));
...
anon54_Else:
	assume !((0 <= k#34_$_0) && (0 <= l#35_$_0));
	if ($_$_condition_$18) { goto anon55_Then; } else { goto anon55_Else; }
anon14:
...
anon55_Else:
	assume !(((0 <= k#34_$_0) && (0 <= l#35_$_0)) && (!(_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0) == null)));
	if ($_$_condition_$21) { goto anon56_Then; } else { goto anon56_Else; }
anon47_Then:
	assume 0 <= k#24_$_0;
	if ($_$_condition_$22) { goto anon48_Then; } else { goto anon48_Else; }
anon47_Else:
	assume k#24_$_0 < 0;
	if ($_$_condition_$23) { goto anon48_Then; } else { goto anon48_Else; }
anon56_Then:
	assume (((0 <= k#34_$_0) && (0 <= l#35_$_0)) && (!(_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0) == null))) && (!(read($Heap_$_4,_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0),_module.Node.next) == null));
	assert  _module.Node.IsClosed($Heap_$_4,this,S#0) && (0 <= k#34_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_4,this,k#34_$_0,S#0);
	assert  !(_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0) == null);
	assert  !(read($Heap_$_4,_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0),_module.Node.next) == null);
	assert  _module.Node.IsClosed($Heap_$_4,read($Heap_$_4,_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0),_module.Node.next),S#0) && (0 <= l#35_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_4,read($Heap_$_4,_module.Node.Nexxxt($LS($LZ),$Heap_$_4,this,k#34_$_0,S#0),_module.Node.next),l#35_$_0,S#0);
	assert  _module.Node.IsClosed($Heap_$_4,this,S#0) && (0 <= k#34_$_0);
	assume _module.Node.Nexxxt#canCall($Heap_$_4,this,k#34_$_0,S#0);
	goto anon35;
anon56_Else:
