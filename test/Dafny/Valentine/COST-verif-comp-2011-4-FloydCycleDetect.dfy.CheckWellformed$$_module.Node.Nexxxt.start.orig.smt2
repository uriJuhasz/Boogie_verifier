...
(declare-fun anon11_Else@2_assertion ( ) Bool)
(declare-fun anon11_Else@3 ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (=> (< 0 $ModuleContextHeight) (forall( (|$Heap_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$3| ref) (|S#0_$2| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.IsClosed@canCall |$Heap_$2| |this_$3| |S#0_$2|) (and (and (and (and ($IsGoodHeap |$Heap_$2|) (not (= |this_$3| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$2| |this_$3| alloc)) (= (dtype |this_$3|) class._module.Node)) (forall( (|$t#4| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$2| |$t#4|) (or (= ($Unbox$ref$ |$t#4|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$2| ($Unbox$ref$ |$t#4|) alloc) (= (dtype ($Unbox$ref$ |$t#4|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$2| |$t#4|)))))) true)  :pattern ( (_module.Node.IsClosed |$Heap_$2| |this_$3| |S#0_$2|)))))
      (=> (< 0 $ModuleContextHeight) (forall( (|$ly_$3| LayerType) (|$Heap_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$8| ref) (|k#0_$4| Int) (|S#1_$4| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$6| |this_$8| |k#0_$4| |S#1_$4|) (and (and (and (and (and (and ($IsGoodHeap |$Heap_$6|) (not (= |this_$8| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$6| |this_$8| alloc)) (= (dtype |this_$8|) class._module.Node)) (forall( (|$t#10| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$4| |$t#10|) (or (= ($Unbox$ref$ |$t#10|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$6| ($Unbox$ref$ |$t#10|) alloc) (= (dtype ($Unbox$ref$ |$t#10|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$4| |$t#10|))))) (_module.Node.IsClosed |$Heap_$6| |this_$8| |S#1_$4|)) (<= 0 |k#0_$4|))) true)  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$3|) |$Heap_$6| |this_$8| |k#0_$4| |S#1_$4|)))))
      (=> (< 0 $ModuleContextHeight) (forall( (|$ly_$8| LayerType) (|$Heap_$10| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$13| ref) (|sink#0_$3| ref) (|S#1_$9| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$10| |this_$13| |sink#0_$3| |S#1_$9|) (and (and (and (and (and (and ($IsGoodHeap |$Heap_$10|) (not (= |this_$13| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| |this_$13| alloc)) (= (dtype |this_$13|) class._module.Node)) (or (= |sink#0_$3| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| |sink#0_$3| alloc) (= (dtype |sink#0_$3|) class._module.Node)))) (forall( (|$t#16| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$9| |$t#16|) (or (= ($Unbox$ref$ |$t#16|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$10| ($Unbox$ref$ |$t#16|) alloc) (= (dtype ($Unbox$ref$ |$t#16|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$9| |$t#16|))))) (_module.Node.IsClosed |$Heap_$10| |this_$13| |S#1_$9|))) true)  :pattern ( (_module.Node.Reaches ($LS |$ly_$8|) |$Heap_$10| |this_$13| |sink#0_$3| |S#1_$9|)))))
      (=> (and (= 0 $ModuleContextHeight) (<= 0 $FunctionContextHeight)) (forall( (|$Heap_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$2| ref) (|S#0_$1| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.IsClosed@canCall |$Heap_$1| |this_$2| |S#0_$1|) (and (and (and (and (and (not (= 0 $FunctionContextHeight)) ($IsGoodHeap |$Heap_$1|)) (not (= |this_$2| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$1| |this_$2| alloc)) (= (dtype |this_$2|) class._module.Node)) (forall( (|$t#3| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| |$t#3|) (or (= ($Unbox$ref$ |$t#3|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$1| ($Unbox$ref$ |$t#3|) alloc) (= (dtype ($Unbox$ref$ |$t#3|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| |$t#3|)))))) (and (and (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |this_$2|)) true) (=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |this_$2|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ null))) (forall( (|n#1| ref))(=> (or (= |n#1| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$1| |n#1| alloc) (= (dtype |n#1|) class._module.Node))) (and (and (=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |n#1|)) true) (=> (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |n#1|)) (not (= |n#1| null))) true)) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |n#1|)) (not (= |n#1| null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$1| |n#1| _module.Node.next) null))) true)))))) (= (_module.Node.IsClosed |$Heap_$1| |this_$2| |S#0_$1|) (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |this_$2|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ null))) (forall( (|n#1_$0| ref))(=> (or (= |n#1_$0| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$1| |n#1_$0| alloc) (= (dtype |n#1_$0|) class._module.Node))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ |n#1_$0|)) (not (= |n#1_$0| null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$1| |n#1_$0| _module.Node.next) null))) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$1| ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$1| |n#1_$0| _module.Node.next))))))))))  :pattern ( (_module.Node.IsClosed |$Heap_$1| |this_$2| |S#0_$1|)))))
      (=> (and (= 0 $ModuleContextHeight) (<= 1 $FunctionContextHeight)) (forall( (|$ly_$2| LayerType) (|$Heap_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$7| ref) (|k#0_$3| Int) (|S#1_$3| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| |k#0_$3| |S#1_$3|) (and (and (and (and (and (and (and (not (= 1 $FunctionContextHeight)) ($IsGoodHeap |$Heap_$5|)) (not (= |this_$7| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$5| |this_$7| alloc)) (= (dtype |this_$7|) class._module.Node)) (forall( (|$t#9| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$3| |$t#9|) (or (= ($Unbox$ref$ |$t#9|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$5| ($Unbox$ref$ |$t#9|) alloc) (= (dtype ($Unbox$ref$ |$t#9|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$3| |$t#9|))))) (_module.Node.IsClosed |$Heap_$5| |this_$7| |S#1_$3|)) (<= 0 |k#0_$3|))) (and (and (=> (= |k#0_$3| 0) true) (=> (not (= |k#0_$3| 0)) (and (and (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|) (=> (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|) null) true)) (=> (not (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|) null)) (_module.Node.Nexxxt@canCall |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|))))) (= (_module.Node.Nexxxt ($LS |$ly_$2|) |$Heap_$5| |this_$7| |k#0_$3| |S#1_$3|) (ite (= |k#0_$3| 0) |this_$7| (ite (= (_module.Node.Nexxxt |$ly_$2| |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|) null) null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$5| (_module.Node.Nexxxt |$ly_$2| |$Heap_$5| |this_$7| (- |k#0_$3| 1) |S#1_$3|) _module.Node.next))))))  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$2|) |$Heap_$5| |this_$7| |k#0_$3| |S#1_$3|)))))
      (=> (and (= 0 $ModuleContextHeight) (<= 2 $FunctionContextHeight)) (forall( (|$ly_$7| LayerType) (|$Heap_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$12| ref) (|sink#0_$2| ref) (|S#1_$8| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$9| |this_$12| |sink#0_$2| |S#1_$8|) (and (and (and (and (and (and (and (not (= 2 $FunctionContextHeight)) ($IsGoodHeap |$Heap_$9|)) (not (= |this_$12| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |this_$12| alloc)) (= (dtype |this_$12|) class._module.Node)) (or (= |sink#0_$2| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |sink#0_$2| alloc) (= (dtype |sink#0_$2|) class._module.Node)))) (forall( (|$t#15| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|) (or (= ($Unbox$ref$ |$t#15|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| ($Unbox$ref$ |$t#15|) alloc) (= (dtype ($Unbox$ref$ |$t#15|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|))))) (_module.Node.IsClosed |$Heap_$9| |this_$12| |S#1_$8|))) (and (forall( (|k#2| Int))(=> true (=> (<= 0 |k#2|) (_module.Node.Nexxxt@canCall |$Heap_$9| |this_$12| |k#2| |S#1_$8|)))) (= (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$2| |S#1_$8|) (exists( (|k#2_$0| Int))(and (<= 0 |k#2_$0|) (= (_module.Node.Nexxxt ($LS $LZ) |$Heap_$9| |this_$12| |k#2_$0| |S#1_$8|) |sink#0_$2|))))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$2| |S#1_$8|)))))
      (=> (or (< 0 $ModuleContextHeight) (and (= 0 $ModuleContextHeight) (<= 0 $FunctionContextHeight))) (forall( (|$Heap_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$1| ref) (|S#0_$0| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.IsClosed@canCall |$Heap_$0| |this_$1| |S#0_$0|) (and (and (and (and (and (or (not (= 0 $ModuleContextHeight)) (not (= 0 $FunctionContextHeight))) ($IsGoodHeap |$Heap_$0|)) (not (= |this_$1| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$0| |this_$1| alloc)) (= (dtype |this_$1|) class._module.Node)) (forall( (|$t#2| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#2|) (or (= ($Unbox$ref$ |$t#2|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$0| ($Unbox$ref$ |$t#2|) alloc) (= (dtype ($Unbox$ref$ |$t#2|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0_$0| |$t#2|)))))) true)  :pattern ( (_module.Node.IsClosed |$Heap_$0| |this_$1| |S#0_$0|)))))
      (=> (or (< 0 $ModuleContextHeight) (and (= 0 $ModuleContextHeight) (<= 1 $FunctionContextHeight))) (forall( (|$ly_$1| LayerType) (|$Heap_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$6| ref) (|k#0_$2| Int) (|S#1_$2| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Nexxxt@canCall |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|) (and (and (and (and (and (and (and (or (not (= 0 $ModuleContextHeight)) (not (= 1 $FunctionContextHeight))) ($IsGoodHeap |$Heap_$4|)) (not (= |this_$6| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| |this_$6| alloc)) (= (dtype |this_$6|) class._module.Node)) (forall( (|$t#8| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| |$t#8|) (or (= ($Unbox$ref$ |$t#8|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| ($Unbox$ref$ |$t#8|) alloc) (= (dtype ($Unbox$ref$ |$t#8|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| |$t#8|))))) (_module.Node.IsClosed |$Heap_$4| |this_$6| |S#1_$2|)) (<= 0 |k#0_$2|))) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$2| ($Box$ref$ (_module.Node.Nexxxt ($LS $LZ) |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|))) (or (= (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$4| (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|) alloc) (= (dtype (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|)) class._module.Node)))))  :pattern ( (_module.Node.Nexxxt ($LS |$ly_$1|) |$Heap_$4| |this_$6| |k#0_$2| |S#1_$2|)))))
      (=> (or (< 0 $ModuleContextHeight) (and (= 0 $ModuleContextHeight) (<= 2 $FunctionContextHeight))) (forall( (|$ly_$6| LayerType) (|$Heap_$8| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$11| ref) (|sink#0_$1| ref) (|S#1_$7| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$8| |this_$11| |sink#0_$1| |S#1_$7|) (and (and (and (and (and (and (and (or (not (= 0 $ModuleContextHeight)) (not (= 2 $FunctionContextHeight))) ($IsGoodHeap |$Heap_$8|)) (not (= |this_$11| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |this_$11| alloc)) (= (dtype |this_$11|) class._module.Node)) (or (= |sink#0_$1| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |sink#0_$1| alloc) (= (dtype |sink#0_$1|) class._module.Node)))) (forall( (|$t#14| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|) (or (= ($Unbox$ref$ |$t#14|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| ($Unbox$ref$ |$t#14|) alloc) (= (dtype ($Unbox$ref$ |$t#14|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|))))) (_module.Node.IsClosed |$Heap_$8| |this_$11| |S#1_$7|))) (=> (_module.Node.Reaches ($LS $LZ) |$Heap_$8| |this_$11| |sink#0_$1| |S#1_$7|) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| ($Box$ref$ |sink#0_$1|))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$6|) |$Heap_$8| |this_$11| |sink#0_$1| |S#1_$7|)))))
      ...
      (forall( (|$h0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$0| ref) (|S#0| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (and (and (and (and (and (and (and ($IsGoodHeap |$h0|) ($IsGoodHeap |$h1|)) (not (= |this_$0| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |this_$0| alloc)) (= (dtype |this_$0|) class._module.Node)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |this_$0| alloc)) (= (dtype |this_$0|) class._module.Node)) (or (_module.Node.IsClosed@canCall |$h0| |this_$0| |S#0|) (forall( (|$t#0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| |$t#0|) (or (= ($Unbox$ref$ |$t#0|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| ($Unbox$ref$ |$t#0|) alloc) (= (dtype ($Unbox$ref$ |$t#0|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| |$t#0|)))))) (or (_module.Node.IsClosed@canCall |$h1| |this_$0| |S#0|) (forall( (|$t#1| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| |$t#1|) (or (= ($Unbox$ref$ |$t#1|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| ($Unbox$ref$ |$t#1|) alloc) (= (dtype ($Unbox$ref$ |$t#1|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| |$t#1|)))))) ($HeapSucc |$h0| |$h1|)) (=> (and (and (forall( (|$o_$0_$0| ref) (|$f_$27| Field$Bool$))(=> (and (and (and (not (= |$o_$0_$0| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$0| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$0| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| ($Box$ref$ |$o_$0_$0|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$0| |$f_$27|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$0| |$f_$27|)))) (forall( (|$o_$0_$1| ref) (|$f_$28| Field$BoxType$))(=> (and (and (and (not (= |$o_$0_$1| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$1| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$1| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| ($Box$ref$ |$o_$0_$1|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0| |$o_$0_$1| |$f_$28|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1| |$o_$0_$1| |$f_$28|))))) (forall( (|$o_$0_$2| ref) (|$f_$29| Field$ref$))(=> (and (and (and (not (= |$o_$0_$2| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$0_$2| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$0_$2| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#0| ($Box$ref$ |$o_$0_$2|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0| |$o_$0_$2| |$f_$29|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1| |$o_$0_$2| |$f_$29|))))) (= (_module.Node.IsClosed |$h0| |this_$0| |S#0|) (_module.Node.IsClosed |$h1| |this_$0| |S#0|))))  :pattern ( ($HeapSucc |$h0| |$h1|) (_module.Node.IsClosed |$h1| |this_$0| |S#0|))))
      (forall( (|$ly_$0| LayerType) (|$h0_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$5| ref) (|k#0_$1| Int) (|S#1_$1| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (and (and (and (and (and (and (and ($IsGoodHeap |$h0_$0|) ($IsGoodHeap |$h1_$0|)) (not (= |this_$5| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |this_$5| alloc)) (= (dtype |this_$5|) class._module.Node)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |this_$5| alloc)) (= (dtype |this_$5|) class._module.Node)) (or (_module.Node.Nexxxt@canCall |$h0_$0| |this_$5| |k#0_$1| |S#1_$1|) (forall( (|$t#6| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| |$t#6|) (or (= ($Unbox$ref$ |$t#6|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| ($Unbox$ref$ |$t#6|) alloc) (= (dtype ($Unbox$ref$ |$t#6|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| |$t#6|)))))) (or (_module.Node.Nexxxt@canCall |$h1_$0| |this_$5| |k#0_$1| |S#1_$1|) (forall( (|$t#7| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| |$t#7|) (or (= ($Unbox$ref$ |$t#7|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| ($Unbox$ref$ |$t#7|) alloc) (= (dtype ($Unbox$ref$ |$t#7|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| |$t#7|)))))) ($HeapSucc |$h0_$0| |$h1_$0|)) (=> (and (and (forall( (|$o_$1_$0| ref) (|$f_$0_$0| Field$Bool$))(=> (and (and (and (not (= |$o_$1_$0| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$0| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$0| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| ($Box$ref$ |$o_$1_$0|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$0| |$f_$0_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$0| |$f_$0_$0|)))) (forall( (|$o_$1_$1| ref) (|$f_$0_$1| Field$BoxType$))(=> (and (and (and (not (= |$o_$1_$1| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$1| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$1| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| ($Box$ref$ |$o_$1_$1|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0_$0| |$o_$1_$1| |$f_$0_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1_$0| |$o_$1_$1| |$f_$0_$1|))))) (forall( (|$o_$1_$2| ref) (|$f_$0_$2| Field$ref$))(=> (and (and (and (not (= |$o_$1_$2| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$0| |$o_$1_$2| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$0| |$o_$1_$2| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$1| ($Box$ref$ |$o_$1_$2|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0_$0| |$o_$1_$2| |$f_$0_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1_$0| |$o_$1_$2| |$f_$0_$2|))))) (= (_module.Node.Nexxxt |$ly_$0| |$h0_$0| |this_$5| |k#0_$1| |S#1_$1|) (_module.Node.Nexxxt |$ly_$0| |$h1_$0| |this_$5| |k#0_$1| |S#1_$1|))))  :pattern ( ($HeapSucc |$h0_$0| |$h1_$0|) (_module.Node.Nexxxt |$ly_$0| |$h1_$0| |this_$5| |k#0_$1| |S#1_$1|))))
      (forall( (|$ly_$4| LayerType) (|$Heap_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$9| ref) (|sink#0| ref) (|S#1_$5| $@Map@@BoxType@To@Bool@@))(!(= (_module.Node.Reaches ($LS |$ly_$4|) |$Heap_$7| |this_$9| |sink#0| |S#1_$5|) (_module.Node.Reaches |$ly_$4| |$Heap_$7| |this_$9| |sink#0| |S#1_$5|))  :pattern ( (_module.Node.Reaches ($LS |$ly_$4|) |$Heap_$7| |this_$9| |sink#0| |S#1_$5|))))
      (forall( (|$ly_$5| LayerType) (|$h0_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$10| ref) (|sink#0_$0| ref) (|S#1_$6| $@Map@@BoxType@To@Bool@@))(!(=> (and (and (and (and (and (and (and (and (and ($IsGoodHeap |$h0_$1|) ($IsGoodHeap |$h1_$1|)) (not (= |this_$10| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |this_$10| alloc)) (= (dtype |this_$10|) class._module.Node)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |this_$10| alloc)) (= (dtype |this_$10|) class._module.Node)) (or (_module.Node.Reaches@canCall |$h0_$1| |this_$10| |sink#0_$0| |S#1_$6|) (and (or (= |sink#0_$0| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |sink#0_$0| alloc) (= (dtype |sink#0_$0|) class._module.Node))) (forall( (|$t#12| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| |$t#12|) (or (= ($Unbox$ref$ |$t#12|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| ($Unbox$ref$ |$t#12|) alloc) (= (dtype ($Unbox$ref$ |$t#12|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| |$t#12|))))))) (or (_module.Node.Reaches@canCall |$h1_$1| |this_$10| |sink#0_$0| |S#1_$6|) (and (or (= |sink#0_$0| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |sink#0_$0| alloc) (= (dtype |sink#0_$0|) class._module.Node))) (forall( (|$t#13| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| |$t#13|) (or (= ($Unbox$ref$ |$t#13|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| ($Unbox$ref$ |$t#13|) alloc) (= (dtype ($Unbox$ref$ |$t#13|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| |$t#13|))))))) ($HeapSucc |$h0_$1| |$h1_$1|)) (=> (and (and (forall( (|$o_$2_$0| ref) (|$f_$1_$0| Field$Bool$))(=> (and (and (and (not (= |$o_$2_$0| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$0| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$0| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| ($Box$ref$ |$o_$2_$0|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$0| |$f_$1_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$0| |$f_$1_$0|)))) (forall( (|$o_$2_$1| ref) (|$f_$1_$1| Field$BoxType$))(=> (and (and (and (not (= |$o_$2_$1| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$1| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$1| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| ($Box$ref$ |$o_$2_$1|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0_$1| |$o_$2_$1| |$f_$1_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1_$1| |$o_$2_$1| |$f_$1_$1|))))) (forall( (|$o_$2_$2| ref) (|$f_$1_$2| Field$ref$))(=> (and (and (and (not (= |$o_$2_$2| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0_$1| |$o_$2_$2| alloc)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1_$1| |$o_$2_$2| alloc)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$6| ($Box$ref$ |$o_$2_$2|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0_$1| |$o_$2_$2| |$f_$1_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1_$1| |$o_$2_$2| |$f_$1_$2|))))) (= (_module.Node.Reaches |$ly_$5| |$h0_$1| |this_$10| |sink#0_$0| |S#1_$6|) (_module.Node.Reaches |$ly_$5| |$h1_$1| |this_$10| |sink#0_$0| |S#1_$6|))))  :pattern ( ($HeapSucc |$h0_$1| |$h1_$1|) (_module.Node.Reaches |$ly_$5| |$h1_$1| |this_$10| |sink#0_$0| |S#1_$6|))))
      (forall( (|$ly| LayerType) (|$Heap_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$4| ref) (|k#0_$0| Int) (|S#1_$0| $@Map@@BoxType@To@Bool@@))(!(= (_module.Node.Nexxxt ($LS |$ly|) |$Heap_$3| |this_$4| |k#0_$0| |S#1_$0|) (_module.Node.Nexxxt |$ly| |$Heap_$3| |this_$4| |k#0_$0| |S#1_$0|))  :pattern ( (_module.Node.Nexxxt ($LS |$ly|) |$Heap_$3| |this_$4| |k#0_$0| |S#1_$0|))))
      (forall( (|$o_$4_$0| ref) (|$f_$3_$0| Field$Bool$) (|S#1_$10_$0| $@Map@@BoxType@To@Bool@@) (|null_$1_$0| ref) (|$Heap_$12_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$1_$0| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@1 |S#1_$10_$0| |null_$1_$0| |$Heap_$12_$0| |alloc_$1_$0|) |$o_$4_$0| |$f_$3_$0|) (=> (and (not (= |$o_$4_$0| |null_$1_$0|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$12_$0| |$o_$4_$0| |alloc_$1_$0|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$10_$0| ($Box$ref$ |$o_$4_$0|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@1 |S#1_$10_$0| |null_$1_$0| |$Heap_$12_$0| |alloc_$1_$0|) |$o_$4_$0| |$f_$3_$0|))))
      (forall( (|$o_$4_$1| ref) (|$f_$3_$1| Field$BoxType$) (|S#1_$10_$1| $@Map@@BoxType@To@Bool@@) (|null_$1_$1| ref) (|$Heap_$12_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$1_$1| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@1 |S#1_$10_$1| |null_$1_$1| |$Heap_$12_$1| |alloc_$1_$1|) |$o_$4_$1| |$f_$3_$1|) (=> (and (not (= |$o_$4_$1| |null_$1_$1|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$12_$1| |$o_$4_$1| |alloc_$1_$1|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$10_$1| ($Box$ref$ |$o_$4_$1|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@1 |S#1_$10_$1| |null_$1_$1| |$Heap_$12_$1| |alloc_$1_$1|) |$o_$4_$1| |$f_$3_$1|))))
      (forall( (|$o_$4_$2| ref) (|$f_$3_$2| Field$ref$) (|S#1_$10_$2| $@Map@@BoxType@To@Bool@@) (|null_$1_$2| ref) (|$Heap_$12_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$1_$2| Field$Bool$))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@1 |S#1_$10_$2| |null_$1_$2| |$Heap_$12_$2| |alloc_$1_$2|) |$o_$4_$2| |$f_$3_$2|) (=> (and (not (= |$o_$4_$2| |null_$1_$2|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$12_$2| |$o_$4_$2| |alloc_$1_$2|)) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$10_$2| ($Box$ref$ |$o_$4_$2|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@1 |S#1_$10_$2| |null_$1_$2| |$Heap_$12_$2| |alloc_$1_$2|) |$o_$4_$2| |$f_$3_$2|))))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (forall( (|$t#11| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#11|) (or (= ($Unbox$ref$ |$t#11|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#11|) alloc) (= (dtype ($Unbox$ref$ |$t#11|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#11|))))
...
(assert (! (=> anon0 (and true 
   (and true
      (_module.Node.IsClosed@canCall $Heap this S@1)
   )
...
(assert (! (=> anon10_Then (and true 
   (and true
      $@condition_$0
      (or (= (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1) alloc) (= (dtype (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1)) class._module.Node)))
   )
...
(or anon11_Else@2_assertion anon11_Else@3)
)) :named ax_anon11_Else@2))
(assert (! (=> anon11_Else@2_assertion (not (and true
   (and true
      (or (<= 0 k@0) (= k@5@0 k@0))
   )
))) :named ax_anon11_Else@2_assertion))
(assert (! (=> anon11_Else@3 (and true 
   (and true
      (or (<= 0 k@0) (= k@5@0 k@0))
   )
(or anon11_Else@3_assertion anon11_Else@4)
)) :named ax_anon11_Else@3))
