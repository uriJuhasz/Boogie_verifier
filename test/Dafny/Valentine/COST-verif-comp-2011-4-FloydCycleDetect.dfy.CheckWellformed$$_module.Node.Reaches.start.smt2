...
;Program
(assert (not
(let ((anon9_Then@1_assertion (and
...
(let ((anon7_Else (=> (and true
    (= (lambda@2 S@1 null $Heap alloc) $_Frame@0)
  )
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (forall( (|$t#17| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#17|) (or (= null ($Unbox$ref$ |$t#17|)) (and (= (dtype ($Unbox$ref$ |$t#17|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#17|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#17|))))
    (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc)
    (not (= this null))
    (or (= sink@0 null) (and (= (dtype sink@0) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap sink@0 alloc)))
  )
    anon0
)))
(let (($start (=> (and true
    ...
    (=> (and (<= 2 $FunctionContextHeight) (= 0 $ModuleContextHeight)) (forall( (|$ly_$7| LayerType) (|$Heap_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$12| ref) (|sink#0_$3| ref) (|S#1_$8| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|) (and (_module.Node.IsClosed |$Heap_$9| |this_$12| |S#1_$8|) (and (forall( (|$t#15| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|) (or (= null ($Unbox$ref$ |$t#15|)) (and (= (dtype ($Unbox$ref$ |$t#15|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| ($Unbox$ref$ |$t#15|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$8| |$t#15|)))) (and (or (= |sink#0_$3| null) (and (= (dtype |sink#0_$3|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |sink#0_$3| alloc))) (and (= (dtype |this_$12|) class._module.Node) (and (and (and ($IsGoodHeap |$Heap_$9|) (not (= 2 $FunctionContextHeight))) (not (= |this_$12| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9| |this_$12| alloc))))))) (and (= (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|) (exists( (|k#2_$0| Int))(and (= |sink#0_$3| (_module.Node.Nexxxt ($LS $LZ) |$Heap_$9| |this_$12| |k#2_$0| |S#1_$8|)) (<= 0 |k#2_$0|)))) (forall( (|k#2| Int))(=> (<= 0 |k#2|) (_module.Node.Nexxxt@canCall |$Heap_$9| |this_$12| |k#2| |S#1_$8|)))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$7|) |$Heap_$9| |this_$12| |sink#0_$3| |S#1_$8|)))))
    ...
    (=> (or (< 0 $ModuleContextHeight) (and (<= 2 $FunctionContextHeight) (= 0 $ModuleContextHeight))) (forall( (|$Heap_$8| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$11| ref) (|sink#0_$2| ref) (|S#1_$7| $@Map@@BoxType@To@Bool@@))(!(=> (or (_module.Node.Reaches@canCall |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|) (and (_module.Node.IsClosed |$Heap_$8| |this_$11| |S#1_$7|) (and (forall( (|$t#14| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|) (or (= null ($Unbox$ref$ |$t#14|)) (and (= (dtype ($Unbox$ref$ |$t#14|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| ($Unbox$ref$ |$t#14|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| |$t#14|)))) (and (or (= |sink#0_$2| null) (and (= (dtype |sink#0_$2|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |sink#0_$2| alloc))) (and (= (dtype |this_$11|) class._module.Node) (and (and (and (or (not (= 2 $FunctionContextHeight)) (not (= 0 $ModuleContextHeight))) ($IsGoodHeap |$Heap_$8|)) (not (= |this_$11| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$8| |this_$11| alloc))))))) (=> (_module.Node.Reaches ($LS $LZ) |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|) (MapRead$$@Map@@BoxType@To@Bool@@$ |S#1_$7| ($Box$ref$ |sink#0_$2|))))  :pattern ( (_module.Node.Reaches ($LS |$ly_$6|) |$Heap_$8| |this_$11| |sink#0_$2| |S#1_$7|)))))
