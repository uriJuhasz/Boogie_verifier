...
(declare-fun anon46 ( ) Bool)
(declare-fun anon46@1 ( ) Bool)
(declare-fun anon46@1_assertion ( ) Bool)
(declare-fun anon46@2 ( ) Bool)
(declare-fun anon46@3 ( ) Bool)
(declare-fun anon46@3_assertion ( ) Bool)
(declare-fun anon46@4 ( ) Bool)
(declare-fun anon46@4_assertion ( ) Bool)
(declare-fun anon46@5 ( ) Bool)
...
(declare-fun anon47_LoopBody ( ) Bool)
(declare-fun anon47_LoopHead ( ) Bool)
...
(declare-fun anon53_Then@1 ( ) Bool)
(declare-fun anon53_Then_assertion ( ) Bool)
...
(declare-fun anon57_Then@1 ( ) Bool)
...
(declare-fun anon65_LoopBody ( ) Bool)
(declare-fun anon65_LoopHead ( ) Bool)
(declare-fun anon66_Else ( ) Bool)
(declare-fun anon66_Else@1 ( ) Bool)
(declare-fun anon66_Else_assertion ( ) Bool)
...
(declare-fun anon69_Then_assertion ( ) Bool)
...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_28) ($Unbox$Bool$ ($Box$Bool$ true)))
      (= (= true $@bf_29) ($Unbox$Bool$ ($Box$Bool$ false)))
      (= (FDim$Bool$ alloc) 0)
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (forall( (|n#26| ref))(=> (or (= |n#26| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |n#26| alloc) (= (dtype |n#26|) class._module.Node))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ |n#26|)) (not (= |n#26| null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#26| _module.Node.next) null))) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#26| _module.Node.next))))))))
      ...
      (forall( (|$t#6_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#6_$0|) (or (= ($Unbox$ref$ |$t#6_$0|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#6_$0|) alloc) (= (dtype ($Unbox$ref$ |$t#6_$0|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#6_$0|))))
      (forall( (|$t#9_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ Visited@32 |$t#9_$0|) (or (= ($Unbox$ref$ |$t#9_$0|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#9_$0|) alloc) (= (dtype ($Unbox$ref$ |$t#9_$0|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ Visited@32 |$t#9_$0|))))
      (forall( (|n#27| ref))(=> (or (= |n#27| null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |n#27| alloc) (= (dtype |n#27|) class._module.Node))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ |n#27|)) (not (= |n#27| null))) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#27| _module.Node.next) null))) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#27| _module.Node.next))))))
      ...
      (not (= this null))
      (or (= p@30 null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@30 alloc) (= (dtype p@30) class._module.Node)))
   )
anon0
)) :named ax_PreconditionGeneratedEntry))
(assert (! (=> anon0 (and true 
   (and true
      (= $_Frame@0 (lambda@6 alloc null $Heap))
      (= $decr0$init$0@0 (Set@Difference$BoxType$ S@0 $rhs@12@0))
      (= $rhs@11@0 (Lit$Int$ 0))
      (= $rhs@12@0 (Set@UnionOne$BoxType$ Set@Empty$BoxType$ ($Box$ref$ null)))
   )
...
(assert (! (=> anon47_LoopHead (and true 
   (and true
      (<= 0 steps@31@0)
      (= $Heap $Heap)
      (= $rhs@11@0 0)
...
anon47_LoopBody
)) :named ax_anon47_LoopHead))
(assert (! (=> anon47_LoopBody (and true 
   (and true
      (= $@condition (not true))
      (not $@condition)
   )
(or anon48_Else anon48_Then)
)) :named ax_anon47_LoopBody))
...
(or anon53_Then@1 anon53_Then_assertion)
...
anon12
)) :named ax_anon53_Then@1))
(assert (! (=> anon53_Then_assertion (not (and true
   (and true
      (_module.Node.IsClosed $Heap this S@0)
      (<= 0 t@35@0)
   )
))) :named ax_anon53_Then_assertion))
...
(assert (! (=> anon65_LoopHead (and true 
   (and true
...
(assert (! (=> anon65_LoopBody (and true 
   (and true
      (= $@condition_$15 (not true))
      (not $@condition_$15)
   )
(or anon66_Else anon66_Then)
)) :named ax_anon65_LoopBody))
...
(or anon66_Else@1 anon66_Else_assertion)
...
)) :named ax_anon66_Else@1))
(assert (! (=> anon66_Else_assertion (not (and true
   (and true
      (_module.Node.IsClosed $Heap this S@0)
      (<= 0 A@1@1)
   )
))) :named ax_anon66_Else_assertion))
...
(or anon57_Then@1 anon57_Then_assertion)
...
(assert (! (=> anon69_Then (and true 
   (and true
      ...
      (< k@60@0 A@1@1)
      (<= 0 k@60@0)
      (= $@condition_$25 (and (<= 0 k@60@0) (< k@60@0 A@1@1)))
   )
...
(or anon46@3_assertion anon46@4)
)) :named ax_anon46@3))
(assert (! (=> anon69_Then_assertion (not (and true
   (and true
      (_module.Node.IsClosed $Heap this S@0)
      (<= 0 k@60@0)
   )
))) :named ax_anon69_Then_assertion))
...
(assert (! (=> anon46@3_assertion (not (and true
   (and true
      (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this))))
   )
))) :named ax_anon46@3_assertion))
(assert (! (=> anon46@4 (and true 
   (and true
      (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this))))
   )
(or anon46@4_assertion anon46@5)
)) :named ax_anon46@4))
...
(assert (! (=> anon46@4_assertion (not (and true
   (and true
      (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null))))
   )
))) :named ax_anon46@4_assertion))
(assert (! (=> anon46@5 (and true 
   (and true
      (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null))))
   )
