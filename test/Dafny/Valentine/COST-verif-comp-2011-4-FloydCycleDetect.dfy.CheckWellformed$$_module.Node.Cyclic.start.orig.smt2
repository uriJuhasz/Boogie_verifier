...
(assert (! (=> $start (and true 
   (and true
      ...
      (forall( (|$o_$6_$0| ref) (|$f_$5_$0| Field$Bool$) (|alloc_$3_$0| Field$Bool$) (|null_$3_$0| ref) (|$Heap_$14_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@3 |alloc_$3_$0| |null_$3_$0| |$Heap_$14_$0|) |$o_$6_$0| |$f_$5_$0|) (=> (and (not (= |$o_$6_$0| |null_$3_$0|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$14_$0| |$o_$6_$0| |alloc_$3_$0|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@3 |alloc_$3_$0| |null_$3_$0| |$Heap_$14_$0|) |$o_$6_$0| |$f_$5_$0|))))
      (forall( (|$o_$6_$1| ref) (|$f_$5_$1| Field$BoxType$) (|alloc_$3_$1| Field$Bool$) (|null_$3_$1| ref) (|$Heap_$14_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@3 |alloc_$3_$1| |null_$3_$1| |$Heap_$14_$1|) |$o_$6_$1| |$f_$5_$1|) (=> (and (not (= |$o_$6_$1| |null_$3_$1|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$14_$1| |$o_$6_$1| |alloc_$3_$1|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@3 |alloc_$3_$1| |null_$3_$1| |$Heap_$14_$1|) |$o_$6_$1| |$f_$5_$1|))))
      (forall( (|$o_$6_$2| ref) (|$f_$5_$2| Field$ref$) (|alloc_$3_$2| Field$Bool$) (|null_$3_$2| ref) (|$Heap_$14_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@3 |alloc_$3_$2| |null_$3_$2| |$Heap_$14_$2|) |$o_$6_$2| |$f_$5_$2|) (=> (and (not (= |$o_$6_$2| |null_$3_$2|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$14_$2| |$o_$6_$2| |alloc_$3_$2|)) false))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@3 |alloc_$3_$2| |null_$3_$2| |$Heap_$14_$2|) |$o_$6_$2| |$f_$5_$2|))))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      ...
      (forall( (|$t#18| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#18|) (or (= ($Unbox$ref$ |$t#18|) null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#18|) alloc) (= (dtype ($Unbox$ref$ |$t#18|)) class._module.Node))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#18|))))
...
(assert (! (=> anon0 (and true 
   (and true
      ...
      (forall( (|$o_$26_$0| ref) (|$f_$25_$0| Field$Bool$))(!(=> (and (not (= |$o_$26_$0| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$26_$0| alloc)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$26_$0| |$f_$25_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$26_$0| |$f_$25_$0|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$26_$0| |$f_$25_$0|))))
      (forall( (|$o_$26_$1| ref) (|$f_$25_$1| Field$BoxType$))(!(=> (and (not (= |$o_$26_$1| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$26_$1| alloc)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$26_$1| |$f_$25_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap |$o_$26_$1| |$f_$25_$1|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$26_$1| |$f_$25_$1|))))
      (forall( (|$o_$26_$2| ref) (|$f_$25_$2| Field$ref$))(!(=> (and (not (= |$o_$26_$2| null)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$26_$2| alloc)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$26_$2| |$f_$25_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |$o_$26_$2| |$f_$25_$2|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$26_$2| |$f_$25_$2|))))
      (or (= n@3@0 null) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 n@3@0 alloc) (= (dtype n@3@0) class._module.Node)))
   )
(or anon7_Else anon7_Then)
)) :named ax_anon0))
(assert (! (=> anon7_Else (and true 
   (and true
      (= $@condition (not (= n@3@0 null)))
      (= n@3@0 null)
      (not $@condition)
   )
$branchMerge_0
...
(assert (! (=> anon8_Else (and true 
   (and true
      (= $@condition_$0 (and (not (= n@3@0 null)) (_module.Node.Reaches ($LS $LZ) $Heap@0 this n@3@0 S@0)))
      (not $@condition_$0)
      (not (and (not (= n@3@0 null)) (_module.Node.Reaches ($LS $LZ) $Heap@0 this n@3@0 S@0)))
   )
$branchMerge_1
)) :named ax_anon8_Else))
...
(assert (! (=> anon9_Then (and true 
   (and true
      $@condition_$2
      (_module.Node.Reaches ($LS $LZ) $Heap@0 this n@3@0 S@0)
      (= $@condition_$2 (and (and (not (= n@3@0 null)) (_module.Node.Reaches ($LS $LZ) $Heap@0 this n@3@0 S@0)) (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 n@3@0 _module.Node.next) null))))
      (not (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 n@3@0 _module.Node.next) null))
      (not (= n@3@0 null))
   )
