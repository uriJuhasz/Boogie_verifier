...
;Program
(assert (not
(let ((anon15_Then@3_assertion (and
...
(let ((anon15_Then@1_assertion (and
    (not (= null (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this A@1@0 S@0)))
)))
(let ((anon15_Then@3 (=> (and true
    (_module.Node.IsClosed $Heap@0 (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this A@1@0 S@0) S@0)
...
(let ((anon0 (=> (and true
    ...
    (= $Heap@0 $Heap)
    (= (lambda@5 alloc null $Heap) $_Frame@0)
  )
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (forall( (|$t#0_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#0_$0|) (or (= null ($Unbox$ref$ |$t#0_$0|)) (and (= (dtype ($Unbox$ref$ |$t#0_$0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#0_$0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#0_$0|))))
