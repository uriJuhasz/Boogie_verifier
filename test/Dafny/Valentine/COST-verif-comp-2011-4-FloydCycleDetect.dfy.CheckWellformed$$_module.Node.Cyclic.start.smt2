...
;Program
(assert (not
(let ((anon9_Then@2_assertion (and
...
(let ((anon8_Else (=> (and true
    (not (and (_module.Node.Reaches ($LS $LZ) $Heap@0 this n@3@0 S@0) (not (= null n@3@0))))
  )
    $branchMerge_1
)))
...
(let ((anon0 (=> (and true
    ...
    (= (lambda@3 alloc null $Heap) $_Frame@0)
    ...
    (or (= null n@3@0) (and (= (dtype n@3@0) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 n@3@0 alloc)))
  )
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (forall( (|$t#18| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#18|) (or (= null ($Unbox$ref$ |$t#18|)) (and (= (dtype ($Unbox$ref$ |$t#18|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#18|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#18|))))
