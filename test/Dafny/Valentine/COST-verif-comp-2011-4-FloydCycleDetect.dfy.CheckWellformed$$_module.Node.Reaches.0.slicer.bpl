...
var $Heap : HeapType;
var $Tick : TickType;
procedure CheckWellformed$$_module.Node.Reaches (this : ref,sink#0 : ref,S#1 : Set (BoxType) )
{
	var S#3 : Set (BoxType) ;
	var sink#4 : ref;
	var S#5 : Set (BoxType) ;
...
$start:
	...
	assume (forall  $ly : LayerType, $Heap_$3 : HeapType, this_$4 : ref, k#0 : Integer, S#1_$0 : Set (BoxType)  :: {_module.Node.Nexxxt($LS($ly),$Heap_$3,this_$4,k#0,S#1_$0)} ( _module.Node.Nexxxt($LS($ly),$Heap_$3,this_$4,k#0,S#1_$0) == _module.Node.Nexxxt($ly,$Heap_$3,this_$4,k#0,S#1_$0) ));
	assume (forall  $ly_$0 : LayerType, $h0_$0 : HeapType, $h1_$0 : HeapType, this_$5 : ref, k#0_$0 : Integer, S#1_$1 : Set (BoxType)  :: {$HeapSucc($h0_$0,$h1_$0),_module.Node.Nexxxt($ly_$0,$h1_$0,this_$5,k#0_$0,S#1_$1)} ( ((((((((($IsGoodHeap($h0_$0) && $IsGoodHeap($h1_$0)) && (!(this_$5 == null))) && read($h0_$0,this_$5,alloc)) && (dtype(this_$5) == class._module.Node)) && read($h1_$0,this_$5,alloc)) && (dtype(this_$5) == class._module.Node)) && (_module.Node.Nexxxt#canCall($h0_$0,this_$5,k#0_$0,S#1_$1) || ((forall  $t#6 : BoxType :: {S#1_$1[$t#6]} ( S#1_$1[$t#6] ==> ((($Unbox($t#6) : ref) == null) || (read($h0_$0,($Unbox($t#6) : ref),alloc) && (dtype(($Unbox($t#6) : ref)) == class._module.Node))) ))))) && (_module.Node.Nexxxt#canCall($h1_$0,this_$5,k#0_$0,S#1_$1) || ((forall  $t#7 : BoxType :: {S#1_$1[$t#7]} ( S#1_$1[$t#7] ==> ((($Unbox($t#7) : ref) == null) || (read($h1_$0,($Unbox($t#7) : ref),alloc) && (dtype(($Unbox($t#7) : ref)) == class._module.Node))) ))))) && $HeapSucc($h0_$0,$h1_$0)) ==> (((forall<alpha> $o_$1 : ref, $f_$0 : Field (alpha)  :: ( ((((!($o_$1 == null)) && read($h0_$0,$o_$1,alloc)) && read($h1_$0,$o_$1,alloc)) && S#1_$1[$Box($o_$1)]) ==> (read($h0_$0,$o_$1,$f_$0) == read($h1_$0,$o_$1,$f_$0)) ))) ==> (_module.Node.Nexxxt($ly_$0,$h0_$0,this_$5,k#0_$0,S#1_$1) == _module.Node.Nexxxt($ly_$0,$h1_$0,this_$5,k#0_$0,S#1_$1))) ));
	assume ((0 < $ModuleContextHeight) || ((0 == $ModuleContextHeight) && (1 <= $FunctionContextHeight))) ==> ((forall  $ly_$1 : LayerType, $Heap_$4 : HeapType, this_$6 : ref, k#0_$1 : Integer, S#1_$2 : Set (BoxType)  :: {_module.Node.Nexxxt($LS($ly_$1),$Heap_$4,this_$6,k#0_$1,S#1_$2)} ( (_module.Node.Nexxxt#canCall($Heap_$4,this_$6,k#0_$1,S#1_$2) || (((((((((!(0 == $ModuleContextHeight)) || (!(1 == $FunctionContextHeight))) && $IsGoodHeap($Heap_$4)) && (!(this_$6 == null))) && read($Heap_$4,this_$6,alloc)) && (dtype(this_$6) == class._module.Node)) && ((forall  $t#8 : BoxType :: {S#1_$2[$t#8]} ( S#1_$2[$t#8] ==> ((($Unbox($t#8) : ref) == null) || (read($Heap_$4,($Unbox($t#8) : ref),alloc) && (dtype(($Unbox($t#8) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$4,this_$6,S#1_$2)) && (0 <= k#0_$1))) ==> (S#1_$2[$Box(_module.Node.Nexxxt($LS($LZ),$Heap_$4,this_$6,k#0_$1,S#1_$2))] && ((_module.Node.Nexxxt($LS($ly_$1),$Heap_$4,this_$6,k#0_$1,S#1_$2) == null) || (read($Heap_$4,_module.Node.Nexxxt($LS($ly_$1),$Heap_$4,this_$6,k#0_$1,S#1_$2),alloc) && (dtype(_module.Node.Nexxxt($LS($ly_$1),$Heap_$4,this_$6,k#0_$1,S#1_$2)) == class._module.Node)))) )));
	assume ((0 == $ModuleContextHeight) && (1 <= $FunctionContextHeight)) ==> ((forall  $ly_$2 : LayerType, $Heap_$5 : HeapType, this_$7 : ref, k#0_$2 : Integer, S#1_$3 : Set (BoxType)  :: {_module.Node.Nexxxt($LS($ly_$2),$Heap_$5,this_$7,k#0_$2,S#1_$3)} ( (_module.Node.Nexxxt#canCall($Heap_$5,this_$7,k#0_$2,S#1_$3) || ((((((((!(1 == $FunctionContextHeight)) && $IsGoodHeap($Heap_$5)) && (!(this_$7 == null))) && read($Heap_$5,this_$7,alloc)) && (dtype(this_$7) == class._module.Node)) && ((forall  $t#9 : BoxType :: {S#1_$3[$t#9]} ( S#1_$3[$t#9] ==> ((($Unbox($t#9) : ref) == null) || (read($Heap_$5,($Unbox($t#9) : ref),alloc) && (dtype(($Unbox($t#9) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$5,this_$7,S#1_$3)) && (0 <= k#0_$2))) ==> ((((k#0_$2 == 0) ==> true) && ((!(k#0_$2 == 0)) ==> ((_module.Node.Nexxxt#canCall($Heap_$5,this_$7,k#0_$2 - 1,S#1_$3) && ((_module.Node.Nexxxt($LS($LZ),$Heap_$5,this_$7,k#0_$2 - 1,S#1_$3) == null) ==> true)) && ((!(_module.Node.Nexxxt($LS($LZ),$Heap_$5,this_$7,k#0_$2 - 1,S#1_$3) == null)) ==> _module.Node.Nexxxt#canCall($Heap_$5,this_$7,k#0_$2 - 1,S#1_$3))))) && (_module.Node.Nexxxt($LS($ly_$2),$Heap_$5,this_$7,k#0_$2,S#1_$3) == (if (k#0_$2 == 0) then this_$7 else (if (_module.Node.Nexxxt($ly_$2,$Heap_$5,this_$7,k#0_$2 - 1,S#1_$3) == null) then null else read($Heap_$5,_module.Node.Nexxxt($ly_$2,$Heap_$5,this_$7,k#0_$2 - 1,S#1_$3),_module.Node.next))))) )));
	assume (0 < $ModuleContextHeight) ==> ((forall  $ly_$3 : LayerType, $Heap_$6 : HeapType, this_$8 : ref, k#0_$3 : Integer, S#1_$4 : Set (BoxType)  :: {_module.Node.Nexxxt($LS($ly_$3),$Heap_$6,this_$8,k#0_$3,S#1_$4)} ( (_module.Node.Nexxxt#canCall($Heap_$6,this_$8,k#0_$3,S#1_$4) || (((((($IsGoodHeap($Heap_$6) && (!(this_$8 == null))) && read($Heap_$6,this_$8,alloc)) && (dtype(this_$8) == class._module.Node)) && ((forall  $t#10 : BoxType :: {S#1_$4[$t#10]} ( S#1_$4[$t#10] ==> ((($Unbox($t#10) : ref) == null) || (read($Heap_$6,($Unbox($t#10) : ref),alloc) && (dtype(($Unbox($t#10) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$6,this_$8,S#1_$4)) && (0 <= k#0_$3))) ==> true )));
	assume (forall  $ly_$4 : LayerType, $Heap_$7 : HeapType, this_$9 : ref, sink#0_$0 : ref, S#1_$5 : Set (BoxType)  :: {_module.Node.Reaches($LS($ly_$4),$Heap_$7,this_$9,sink#0_$0,S#1_$5)} ( _module.Node.Reaches($LS($ly_$4),$Heap_$7,this_$9,sink#0_$0,S#1_$5) <==> _module.Node.Reaches($ly_$4,$Heap_$7,this_$9,sink#0_$0,S#1_$5) ));
	assume (forall  $ly_$5 : LayerType, $h0_$1 : HeapType, $h1_$1 : HeapType, this_$10 : ref, sink#0_$1 : ref, S#1_$6 : Set (BoxType)  :: {$HeapSucc($h0_$1,$h1_$1),_module.Node.Reaches($ly_$5,$h1_$1,this_$10,sink#0_$1,S#1_$6)} ( ((((((((($IsGoodHeap($h0_$1) && $IsGoodHeap($h1_$1)) && (!(this_$10 == null))) && read($h0_$1,this_$10,alloc)) && (dtype(this_$10) == class._module.Node)) && read($h1_$1,this_$10,alloc)) && (dtype(this_$10) == class._module.Node)) && (_module.Node.Reaches#canCall($h0_$1,this_$10,sink#0_$1,S#1_$6) || (((sink#0_$1 == null) || (read($h0_$1,sink#0_$1,alloc) && (dtype(sink#0_$1) == class._module.Node))) && ((forall  $t#12 : BoxType :: {S#1_$6[$t#12]} ( S#1_$6[$t#12] ==> ((($Unbox($t#12) : ref) == null) || (read($h0_$1,($Unbox($t#12) : ref),alloc) && (dtype(($Unbox($t#12) : ref)) == class._module.Node))) )))))) && (_module.Node.Reaches#canCall($h1_$1,this_$10,sink#0_$1,S#1_$6) || (((sink#0_$1 == null) || (read($h1_$1,sink#0_$1,alloc) && (dtype(sink#0_$1) == class._module.Node))) && ((forall  $t#13 : BoxType :: {S#1_$6[$t#13]} ( S#1_$6[$t#13] ==> ((($Unbox($t#13) : ref) == null) || (read($h1_$1,($Unbox($t#13) : ref),alloc) && (dtype(($Unbox($t#13) : ref)) == class._module.Node))) )))))) && $HeapSucc($h0_$1,$h1_$1)) ==> (((forall<alpha> $o_$2 : ref, $f_$1 : Field (alpha)  :: ( ((((!($o_$2 == null)) && read($h0_$1,$o_$2,alloc)) && read($h1_$1,$o_$2,alloc)) && S#1_$6[$Box($o_$2)]) ==> (read($h0_$1,$o_$2,$f_$1) == read($h1_$1,$o_$2,$f_$1)) ))) ==> (_module.Node.Reaches($ly_$5,$h0_$1,this_$10,sink#0_$1,S#1_$6) <==> _module.Node.Reaches($ly_$5,$h1_$1,this_$10,sink#0_$1,S#1_$6))) ));
	assume ((0 < $ModuleContextHeight) || ((0 == $ModuleContextHeight) && (2 <= $FunctionContextHeight))) ==> ((forall  $ly_$6 : LayerType, $Heap_$8 : HeapType, this_$11 : ref, sink#0_$2 : ref, S#1_$7 : Set (BoxType)  :: {_module.Node.Reaches($LS($ly_$6),$Heap_$8,this_$11,sink#0_$2,S#1_$7)} ( (_module.Node.Reaches#canCall($Heap_$8,this_$11,sink#0_$2,S#1_$7) || (((((((((!(0 == $ModuleContextHeight)) || (!(2 == $FunctionContextHeight))) && $IsGoodHeap($Heap_$8)) && (!(this_$11 == null))) && read($Heap_$8,this_$11,alloc)) && (dtype(this_$11) == class._module.Node)) && ((sink#0_$2 == null) || (read($Heap_$8,sink#0_$2,alloc) && (dtype(sink#0_$2) == class._module.Node)))) && ((forall  $t#14 : BoxType :: {S#1_$7[$t#14]} ( S#1_$7[$t#14] ==> ((($Unbox($t#14) : ref) == null) || (read($Heap_$8,($Unbox($t#14) : ref),alloc) && (dtype(($Unbox($t#14) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$8,this_$11,S#1_$7))) ==> (_module.Node.Reaches($LS($LZ),$Heap_$8,this_$11,sink#0_$2,S#1_$7) ==> S#1_$7[$Box(sink#0_$2)]) )));
	assume ((0 == $ModuleContextHeight) && (2 <= $FunctionContextHeight)) ==> ((forall  $ly_$7 : LayerType, $Heap_$9 : HeapType, this_$12 : ref, sink#0_$3 : ref, S#1_$8 : Set (BoxType)  :: {_module.Node.Reaches($LS($ly_$7),$Heap_$9,this_$12,sink#0_$3,S#1_$8)} ( (_module.Node.Reaches#canCall($Heap_$9,this_$12,sink#0_$3,S#1_$8) || ((((((((!(2 == $FunctionContextHeight)) && $IsGoodHeap($Heap_$9)) && (!(this_$12 == null))) && read($Heap_$9,this_$12,alloc)) && (dtype(this_$12) == class._module.Node)) && ((sink#0_$3 == null) || (read($Heap_$9,sink#0_$3,alloc) && (dtype(sink#0_$3) == class._module.Node)))) && ((forall  $t#15 : BoxType :: {S#1_$8[$t#15]} ( S#1_$8[$t#15] ==> ((($Unbox($t#15) : ref) == null) || (read($Heap_$9,($Unbox($t#15) : ref),alloc) && (dtype(($Unbox($t#15) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$9,this_$12,S#1_$8))) ==> (((forall  k#2 : Integer :: ( true ==> ((0 <= k#2) ==> _module.Node.Nexxxt#canCall($Heap_$9,this_$12,k#2,S#1_$8)) ))) && (_module.Node.Reaches($LS($ly_$7),$Heap_$9,this_$12,sink#0_$3,S#1_$8) <==> ((exists  k#2_$0 : Integer :: ( (0 <= k#2_$0) && (_module.Node.Nexxxt($LS($LZ),$Heap_$9,this_$12,k#2_$0,S#1_$8) == sink#0_$3) ))))) )));
	assume (0 < $ModuleContextHeight) ==> ((forall  $ly_$8 : LayerType, $Heap_$10 : HeapType, this_$13 : ref, sink#0_$4 : ref, S#1_$9 : Set (BoxType)  :: {_module.Node.Reaches($LS($ly_$8),$Heap_$10,this_$13,sink#0_$4,S#1_$9)} ( (_module.Node.Reaches#canCall($Heap_$10,this_$13,sink#0_$4,S#1_$9) || (((((($IsGoodHeap($Heap_$10) && (!(this_$13 == null))) && read($Heap_$10,this_$13,alloc)) && (dtype(this_$13) == class._module.Node)) && ((sink#0_$4 == null) || (read($Heap_$10,sink#0_$4,alloc) && (dtype(sink#0_$4) == class._module.Node)))) && ((forall  $t#16 : BoxType :: {S#1_$9[$t#16]} ( S#1_$9[$t#16] ==> ((($Unbox($t#16) : ref) == null) || (read($Heap_$10,($Unbox($t#16) : ref),alloc) && (dtype(($Unbox($t#16) : ref)) == class._module.Node))) )))) && _module.Node.IsClosed($Heap_$10,this_$13,S#1_$9))) ==> true )));
...
PreconditionGeneratedEntry:
	...
	assume (sink#0 == null) || (read($Heap,sink#0,alloc) && (dtype(sink#0) == class._module.Node));
	assume (forall  $t#17 : BoxType :: {S#1[$t#17]} ( S#1[$t#17] ==> ((($Unbox($t#17) : ref) == null) || (read($Heap,($Unbox($t#17) : ref),alloc) && (dtype(($Unbox($t#17) : ref)) == class._module.Node))) ));
	assume (0 == $ModuleContextHeight) && (2 == $FunctionContextHeight);
	goto anon0;
anon0:
	assume true;
...
anon7_Then:
	assert  _module.Node.IsClosed($Heap,this,S#1);
	assert  ((((this == this) && (sink#0 == sink#0)) && (S#1 == S#1)) || (Set#Subset(S#1,S#1) && (!Set#Subset(S#1,S#1)))) || (Set#Equal(S#1,S#1) && (((sink#0 == null) && (!(sink#0 == null))) || ((((!(sink#0 == null)) <==> (!(sink#0 == null))) && Set#Subset(S#1,S#1)) && (!Set#Subset(S#1,S#1)))));
...
anon7_Else:
	assume $_Frame_$_0 == lambda#2(S#1,null,$Heap,alloc);
	if ($_$_condition_$1) { goto anon9_Then; } else { goto anon9_Else; }
anon8_Then:
	assume _module.Node.Reaches($LS($LZ),$Heap,this,sink#0,S#1);
	goto anon3;
anon8_Else:
	assume !_module.Node.Reaches($LS($LZ),$Heap,this,sink#0,S#1);
	goto anon3;
...
anon3:
	...
	goto $exit;
anon6:
	assume _module.Node.Reaches($LS($LZ),$Heap,this,sink#0,S#1) <==> ((exists  k#9 : Integer :: ( (0 <= k#9) && (_module.Node.Nexxxt($LS($LZ),$Heap,this,k#9,S#1) == sink#0) )));
	assume (forall  k#9_$0 : Integer :: ( true ==> ((0 <= k#9_$0) ==> _module.Node.Nexxxt#canCall($Heap,this,k#9_$0,S#1)) ));
	goto GeneratedUnifiedExit;
GeneratedUnifiedExit:
	assert  _module.Node.Reaches($LS($LZ),$Heap,this,sink#0,S#1) ==> S#1[$Box(sink#0)];
	goto $exit;
}
