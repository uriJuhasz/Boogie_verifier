...
(let ((anon11_Else@2_assertion (and
    (or (= k@5@0 k@0) (<= 0 k@0))
)))
...
(let ((anon10_Then (=> (and true
    (or (= null (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1)) (and (= (dtype (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap (_module.Node.Nexxxt ($LS $LZ) $Heap this k@0 S@1) alloc)))
  )
...
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (forall( (|$t#11| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#11|) (or (= null ($Unbox$ref$ |$t#11|)) (and (= (dtype ($Unbox$ref$ |$t#11|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#11|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@1 |$t#11|))))
