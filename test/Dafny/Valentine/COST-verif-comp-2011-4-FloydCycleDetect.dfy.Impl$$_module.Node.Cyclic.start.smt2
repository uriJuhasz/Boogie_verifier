...
(let ((anon38@1_assertion (and
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) (_module.Node.IsClosed $Heap@1 this S@0)))
)))
(let ((anon38@2_assertion (and
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap@1 this S@0)))
)))
...
(let ((anon51_Else@1_assertion (and
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) (_module.Node.IsClosed $Heap@1 this S@0)))
)))
(let ((anon51_Else@2_assertion (and
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap@1 this S@0)))
)))
...
(let ((anon51_Else@11_assertion (and
...
(let ((anon51_Else@12_assertion (and
...
(let ((anon51_Else@13_assertion (and
...
(let ((anon51_Else@14_assertion (and
    (<= 0 call4formal@A@1@0)
)))
(let ((anon51_Else@15_assertion (and
    (<= 1 call5formal@B@2@0)
)))
...
(let ((anon56_Then@4_assertion (and
    (_module.Node.IsClosed $Heap@4 this S@0)
    (<= 0 k@34@0)
)))
...
(let ((anon55_Then@2 (=> (and true
    (not (= null (_module.Node.Nexxxt ($LS $LZ) $Heap@4 this k@34@0 S@0)))
  )
    $branchMerge_5
)))
(let ((anon38@6 (=> (and true
    true
    true
    true
  )(and 
...
(let ((anon38@3 (=> (and true
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap@1 this S@0)))
  )(and 
    anon38@3_assertion
    anon38@4
))))
(let ((anon51_Else@16 (=> (and true
    (<= 1 call5formal@B@2@0)
  )(and 
...
(let ((anon38@2 (=> (and true
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) (_module.Node.IsClosed $Heap@1 this S@0)))
  )(and 
    anon38@2_assertion
    anon38@3
))))
(let ((anon51_Else@15 (=> (and true
    (<= 0 call4formal@A@1@0)
  )(and 
...
(let ((anon51_Else@9 (=> (and true
    (not (= null hare@17@0))
  )(and 
    anon51_Else@9_assertion
    anon51_Else@10
))))
(let ((anon27@3 (=> (and true
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap@1 this S@0)))
  )(and 
    anon27@3_assertion
    anon27@4
...
(let ((anon51_Else@3 (=> (and true
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap@1 this S@0)))
  )(and 
    anon51_Else@3_assertion
    anon51_Else@4
))))
(let ((anon51_Else@2 (=> (and true
    (=> (_module.Node.IsClosed@canCall $Heap@1 this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) (_module.Node.IsClosed $Heap@1 this S@0)))
  )(and 
    anon51_Else@2_assertion
    anon51_Else@3
))))
(let ((anon51_Else@1 (=> (and true
    true
    true
    true
  )(and 
...
(let ((anon39_LoopBody (=> (and true
  )
    (and anon40_Else anon40_Then)
)))
(let ((anon39_LoopHead (=> (and true
...
(let ((anon0@4 (=> (and true
    ...
    (= (- (+ call4formal@A@1@0 call5formal@B@2@0) $rhs@7@0) $decr0$init$0@0)
    (= (Lit$Int$ 0) $rhs@7@0)
    (= (Lit$Int$ 1) $rhs@8@0)
    (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (_module.Node.IsClosed $Heap this S@0) (forall( (|n#22| ref))(=> (or (= null |n#22|) (and (= (dtype |n#22|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |n#22| alloc))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ |n#22|)) (not (= null |n#22|))) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#22| _module.Node.next)))) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#22| _module.Node.next))))))))
    (forall( (|k#10_$0| Int) (|l#11_$0| Int))(=> (and (< |l#11_$0| call4formal@A@1@0) (and (< |k#10_$0| |l#11_$0|) (<= 0 |k#10_$0|))) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |l#11_$0| S@0) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |k#10_$0| S@0)))))
    (forall( (|k#10| Int) (|l#11| Int))(=> (forall( (|k$ih#4#24| Int) (|l$ih#5#25| Int))(=> (or (and (< |l$ih#5#25| |l#11|) (and (= |k$ih#4#24| |k#10|) (<= 0 |l$ih#5#25|))) (and (< |k$ih#4#24| |k#10|) (<= 0 |k$ih#4#24|))) (=> (and (< |l$ih#5#25| call4formal@A@1@0) (and (< |k$ih#4#24| |l$ih#5#25|) (<= 0 |k$ih#4#24|))) (not (= (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |l$ih#5#25| S@0) (_module.Node.Nexxxt ($LS $LZ) $Heap@0 this |k$ih#4#24| S@0)))))) (=> (and (< |l#11| call4formal@A@1@0) (and (< |k#10| |l#11|) (<= 0 |k#10|))) (not (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this |l#11| S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this |k#10| S@0))))))
    (or (= null (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this call4formal@A@1@0 S@0)) (= (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this call4formal@A@1@0 S@0) (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 (_module.Node.Nexxxt ($LS ($LS $LZ)) $Heap@0 this call4formal@A@1@0 S@0) call5formal@B@2@0 S@0)))
  )(and 
    anon0@4_assertion
    anon0@5
))))
...
(let ((anon0 (=> (and true
    (= (lambda@4 alloc null $Heap) $_Frame@0)
  )
    anon0@1
)))
(let ((PreconditionGeneratedEntry (=> (and true
    ...
    (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ null)) (_module.Node.IsClosed $Heap this S@0)))
    (=> (_module.Node.IsClosed@canCall $Heap this S@0) (or (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ this)) (_module.Node.IsClosed $Heap this S@0)))
    (forall( (|$t#2_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#2_$0|) (or (= null ($Unbox$ref$ |$t#2_$0|)) (and (= (dtype ($Unbox$ref$ |$t#2_$0|)) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap ($Unbox$ref$ |$t#2_$0|) alloc))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 |$t#2_$0|))))
    (forall( (|n#12| ref))(=> (or (= null |n#12|) (and (= (dtype |n#12|) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |n#12| alloc))) (=> (and (and (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ |n#12|)) (not (= null |n#12|))) (not (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#12| _module.Node.next)))) (MapRead$$@Map@@BoxType@To@Bool@@$ S@0 ($Box$ref$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |n#12| _module.Node.next))))))
    ...
    (not (= this null))
    (or (= null hare@17) (and (= (dtype hare@17) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap hare@17 alloc)))
    (or (= tortoise@16 null) (and (= (dtype tortoise@16) class._module.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap tortoise@16 alloc)))
  )
    anon0
)))
(let (($start (=> (and true
