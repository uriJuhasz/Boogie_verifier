...
PreconditionGeneratedEntry:
	...
	assume ((forall  $t#0_$0 : BoxType :: {S#0[$t#0_$0]} ( S#0[$t#0_$0] ==> ((($Unbox($t#0_$0) : ref) == null) || (read($Heap,($Unbox($t#0_$0) : ref),alloc) && (dtype(($Unbox($t#0_$0) : ref)) == class._module.Node))) ))) && $IsGoodSet_Extended(S#0,null);
...
anon13_Else:
	assume !((0 <= k#4_$_0) && (k#4_$_0 < l#5_$_0));
	if ($_$_condition_$4) { goto anon14_Then; } else { goto anon14_Else; }
anon14_Then:
