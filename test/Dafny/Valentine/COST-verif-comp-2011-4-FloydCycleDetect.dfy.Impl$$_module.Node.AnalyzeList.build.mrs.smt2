...
(declare-fun $@bf_9 ( $@Map@@BoxType@To@Bool@@ $@Map@@BoxType@To@Bool@@ ) Bool)
...
;Axioms
   ...
   (assert (! (not (= 0 4)) :named ax_288))
   (assert (! (not (= 1 4)) :named ax_289))
   (assert (! (not (= 2 4)) :named ax_290))
   (assert (! (not (= null this)) :named ax_291))
   (assert (! (or (= null p@30) (= (dtype p@30) class._module.Node)) :named ax_292))
...
(assert (! (=> anon0@8 (and true 
   (and true
      ...
      (not ($NP@223 null))
      (not (< steps@31@0 0))
      (or (= null p@30@0) (= class._module.Node (dtype p@30@0)))
...
(assert (! (=> anon12 (and true 
   (and true
      ...
      (or (= null q@40@0) (= class._module.Node (dtype q@40@0)))
...
(assert (! (=> anon70_Else@1 (and true 
   (and true
      (not (= 0 steps@31@0))
      (or (not (< $decr1$0@1 0)) (= $decr1$0@1 (+ steps@31@0 (* (- 1) A@1@2))))
   )
...
(assert (! (=> anon70_Else@2 (and true 
   (and true
      ...
      (not (= $decr1$0@1 (+ steps@31@0 (* (- 1) A@1@2))))
   )
