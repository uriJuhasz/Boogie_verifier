...
;Functions
(declare-fun $@bf_11 ( $@Map@@ref@To@Bool@@ ref ) Bool)
(declare-fun $@bf_12 ( $@Map@@ref@To@Bool@@ $@Map@@ref@To@Bool@@ ) Bool)
...
(declare-fun $@sk_4 ( $@Map@@ref@To@Bool@@ $@Map@@ref@To@Bool@@ ) ref)
...
;Axioms
   ...
   (assert (! (not (= Lb Np)) :named ax_110))
   (assert (! (not (= Lb Nt)) :named ax_111))
   (assert (! (not (= Le Lb)) :named ax_112))
   (assert (! (not (= Le Np)) :named ax_113))
   (assert (! (not (= Le Nt)) :named ax_114))
   (assert (! (not (= LL NA)) :named ax_115))
   (assert (! (not (= LL NC)) :named ax_116))
   (assert (! (not (= LL ND)) :named ax_117))
   (assert (! (not (= Ln Lb)) :named ax_118))
   (assert (! (not (= Ln Le)) :named ax_119))
   (assert (! (not (= Ln Lp)) :named ax_120))
   (assert (! (not (= Ln Nbb)) :named ax_121))
   (assert (! (not (= Ln Np)) :named ax_122))
   (assert (! (not (= Ln Nt)) :named ax_123))
   (assert (! (not (= Lp Lb)) :named ax_124))
   (assert (! (not (= Lp Le)) :named ax_125))
   (assert (! (not (= Lp Ln)) :named ax_126))
   (assert (! (not (= Lp Nbb)) :named ax_127))
   (assert (! (not (= Lp Np)) :named ax_128))
   (assert (! (not (= Lp Nt)) :named ax_129))
   (assert (! (not (= NA LL)) :named ax_130))
   (assert (! (not (= NA NC)) :named ax_131))
   (assert (! (not (= NA ND)) :named ax_132))
   (assert (! (not (= Nbb Lb)) :named ax_133))
   (assert (! (not (= Nbb Le)) :named ax_134))
   (assert (! (not (= Nbb Ln)) :named ax_135))
   (assert (! (not (= Nbb Lp)) :named ax_136))
   (assert (! (not (= Nbb Np)) :named ax_137))
   (assert (! (not (= Nbb Nt)) :named ax_138))
   (assert (! (not (= NC LL)) :named ax_139))
   (assert (! (not (= NC NA)) :named ax_140))
   (assert (! (not (= NC ND)) :named ax_141))
   (assert (! (not (= Ncpr Ndpr)) :named ax_142))
   (assert (! (not (= ND LL)) :named ax_143))
   (assert (! (not (= ND NA)) :named ax_144))
   (assert (! (not (= ND NC)) :named ax_145))
   (assert (! (not (= Ndpr Ncpr)) :named ax_146))
   (assert (! (not (= Np Lb)) :named ax_147))
   (assert (! (not (= Np Le)) :named ax_148))
   (assert (! (not (= Np Ln)) :named ax_149))
   (assert (! (not (= Np Lp)) :named ax_150))
   (assert (! (not (= Np Nbb)) :named ax_151))
   (assert (! (not (= Np Nt)) :named ax_152))
   (assert (! (not (= Nt Lb)) :named ax_153))
   (assert (! (not (= Nt Le)) :named ax_154))
   (assert (! (not (= Nt Ln)) :named ax_155))
   (assert (! (not (= Nt Lp)) :named ax_156))
   (assert (! (not (= Nt Nbb)) :named ax_157))
   (assert (! (not (= Nt Np)) :named ax_158))
   (assert (! (not (= null r)) :named ax_159))
   (assert (! (not (= null this)) :named ax_160))
   (assert (! (not (= r null)) :named ax_161))
   (assert (! (not (= r this)) :named ax_162))
   (assert (! (not (= StD StF)) :named ax_163))
   (assert (! (not (= StF StD)) :named ax_164))
   (assert (! (not (= StL StD)) :named ax_165))
   (assert (! (not (= StL StF)) :named ax_166))
   (assert (! (not (= this null)) :named ax_167))
   (assert (! (not (= true false)) :named ax_168))
   (assert (! true :named ax_169))
...
(assert (! (=> GeneratedUnifiedExit@4 (and true 
   (and true
      (or (not (= StF (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap r NSt))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@12 this NSt) StF))
   )
...
(assert (! (=> GeneratedUnifiedExit@14 (and true 
   (and true
      (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@12 r NSt) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap r NSt)) (= StF (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap r NSt)) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this ND) r))
   )
...
(assert (! (=> GeneratedUnifiedExit@21 (and true 
   (and true
      (or (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this ND) r)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@12 this Ln) null) (= StF (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap r NSt)))
   )
