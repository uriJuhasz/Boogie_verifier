...
;Axioms
   (assert (! (= $Heap@0 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap oldEnd@0 Ln el)) :named ax_0))
   (assert (! (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 el Lp oldEnd@0)) :named ax_1))
   (assert (! (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 el Ln null)) :named ax_2))
   (assert (! (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 el Lb (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 list Lb))) :named ax_3))
   (assert (! (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 el Le el)) :named ax_4))
   (assert (! (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 el LPC oldList@0)) :named ax_5))
   (assert (! (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 el LNC Empty)) :named ax_6))
   (assert (! (= $Heap@7 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 el LL (AddEl oldList@0 el))) :named ax_7))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 list Lb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Lb)) :named ax_8))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 list Lb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 list Lb)) :named ax_9))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 list Lb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 list Lb)) :named ax_10))
   (assert (! (= call2formal@r2@0 (Singleton el)) :named ax_11))
   (assert (! (= oldEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) :named ax_12))
   (assert (! (= oldList@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL)) :named ax_13))
   ...
   (assert (! (forall( (|h_$48| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|list_$1| ref) (|el_$0| ref))(= (InList |h_$48| |list_$1| |el_$0|) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$48| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$48| |list_$1| List_head) LL) |el_$0|) (not (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$48| |list_$1| List_head)))))) :named ax_64))
   ...
   (assert (! (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$33|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL)))) :named ax_72))
   (assert (! (forall( (|o_$34_$0| ref) (|f_$3| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 |o_$34_$0| |f_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@7 |o_$34_$0| |f_$3|))) :named ax_73))
   (assert (! (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 |o_$34_$1| |f_$4|)))) :named ax_74))
   (assert (! (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$35|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC)))) :named ax_75))
   (assert (! (forall( (|o_$36_$0| ref) (|f_$0_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$36_$0| |f_$0_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 |o_$36_$0| |f_$0_$0|))) :named ax_76))
   (assert (! (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$36_$1|) (= LNC |f_$0_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$36_$1| |f_$0_$1|)))) :named ax_77))
   (assert (! (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$37|) (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$37| Le)))) :named ax_78))
   (assert (! (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$38_$0|) (= Le |f_$1_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|)))) :named ax_79))
   (assert (! (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|))) :named ax_80))
   ...
   (assert (! (not (= LL LPC)) :named ax_111))
   (assert (! (not (= Ln It_el)) :named ax_112))
   (assert (! (not (= Ln It_List)) :named ax_113))
   (assert (! (not (= Ln Lb)) :named ax_114))
   (assert (! (not (= Ln Le)) :named ax_115))
   (assert (! (not (= Ln List_head)) :named ax_116))
   (assert (! (not (= Ln Lp)) :named ax_117))
   (assert (! (not (= Ln Node_next)) :named ax_118))
   (assert (! (not (= LNC LL)) :named ax_119))
   (assert (! (not (= LNC LPC)) :named ax_120))
   (assert (! (not (= Lp It_el)) :named ax_121))
   (assert (! (not (= Lp It_List)) :named ax_122))
   (assert (! (not (= Lp Lb)) :named ax_123))
   (assert (! (not (= Lp Le)) :named ax_124))
   (assert (! (not (= Lp List_head)) :named ax_125))
   (assert (! (not (= Lp Ln)) :named ax_126))
   (assert (! (not (= Lp Node_next)) :named ax_127))
   (assert (! (not (= LPC LL)) :named ax_128))
   (assert (! (not (= LPC LNC)) :named ax_129))
   (assert (! (not (= Node_next It_el)) :named ax_130))
   (assert (! (not (= Node_next It_List)) :named ax_131))
   (assert (! (not (= Node_next Lb)) :named ax_132))
   (assert (! (not (= Node_next Le)) :named ax_133))
   (assert (! (not (= Node_next List_head)) :named ax_134))
   (assert (! (not (= Node_next Ln)) :named ax_135))
   (assert (! (not (= Node_next Lp)) :named ax_136))
   (assert (! (not (= null el)) :named ax_137))
   (assert (! (not (= null list)) :named ax_138))
   (assert (! (not (= true false)) :named ax_139))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 el)) :named ax_140))
   (assert (! true :named ax_141))
...
(assert (! (=> anon0@21_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le) Ln) el)
   )
))) :named ax_anon0@21_assertion))
(assert (! (=> anon0@22 (and true 
   (and true
      (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le) Ln))
   )
(or anon0@22_assertion anon0@23)
)) :named ax_anon0@22))
(assert (! (=> anon0@22_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Lp) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le))
   )
...
(assert (! (=> anon0@23_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Ln) null)
   )
))) :named ax_anon0@23_assertion))
(assert (! (=> anon0@24 (and true 
   (and true
      (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Ln))
      (not (= el null))
   )
...
(assert (! (=> anon0@24_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Lb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 list Lb))
   )
...
(assert (! (=> anon0@25_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Le) el)
   )
))) :named ax_anon0@25_assertion))
(assert (! (=> anon0@26 (and true 
   (and true
      (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 el Le))
   )
(or anon0@26_assertion anon0@27)
)) :named ax_anon0@26))
(assert (! (=> anon0@26_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LPC) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL))
   )
...
(assert (! (=> anon0@27_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LNC) Empty)
   )
))) :named ax_anon0@27_assertion))
(assert (! (=> anon0@28 (and true 
   (and true
      (= Empty (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LNC))
   )
(or anon0@28_assertion anon0@29)
)) :named ax_anon0@28))
(assert (! (=> anon0@28_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LL) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) el))
   )
))) :named ax_anon0@28_assertion))
(assert (! (=> anon0@29 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LL) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LPC) el))
   )
(or anon0@29_assertion anon0@30)
)) :named ax_anon0@29))
(assert (! (=> anon0@29_assertion (not (and true
   (and true
      (forall( (|o_$39| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$39|) (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$39| LL) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$39| LL) el))))
   )
...
(assert (! (=> anon0@30_assertion (not (and true
   (and true
      (forall( (|o_$40| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$40|) (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$40| LNC) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$40| LNC) el))))
   )
...
(assert (! (=> anon0@31_assertion (not (and true
   (and true
      (forall( (|o_$41| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$41|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$41| Le) el)))
   )
))) :named ax_anon0@31_assertion))
(assert (! (=> anon0@32 (and true 
   (and true
      (forall( (|o_$41| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$41|) (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$41| Le))))
   )
anon0@32_assertion
)) :named ax_anon0@32))
(assert (! (=> anon0@32_assertion (not (and true
   (and true
      (forall( (|o_$42_$0| ref) (|f_$2_$0| field$ref$))(or (or (or (or (or (or (or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$42_$0| |f_$2_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$42_$0| |f_$2_$0|)) (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= |f_$2_$0| Ln))) (and (= |o_$42_$0| el) (= |f_$2_$0| Lp))) (and (= |o_$42_$0| el) (= |f_$2_$0| Ln))) (and (= |o_$42_$0| el) (= |f_$2_$0| Lb))) (and (= |o_$42_$0| el) (= |f_$2_$0| Le))) (and (= |o_$42_$0| el) false)) (and (= |o_$42_$0| el) false)) (and (= |o_$42_$0| el) false)) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$0|) false)) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$0|) false)) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$0|) (= |f_$2_$0| Le))))
      (forall( (|o_$42_$1| ref) (|f_$2_$1| field$$@Map@@ref@To@Bool@@$))(or (or (or (or (or (or (or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$42_$1| |f_$2_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$42_$1| |f_$2_$1|)) (and (= |o_$42_$1| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) false)) (and (= |o_$42_$1| el) false)) (and (= |o_$42_$1| el) false)) (and (= |o_$42_$1| el) false)) (and (= |o_$42_$1| el) false)) (and (= |o_$42_$1| el) (= |f_$2_$1| LPC))) (and (= |o_$42_$1| el) (= |f_$2_$1| LNC))) (and (= |o_$42_$1| el) (= |f_$2_$1| LL))) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$1|) (= |f_$2_$1| LL))) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$1|) (= |f_$2_$1| LNC))) (and (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$42_$1|) false)))
   )
