...
(declare-fun MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ ( $@Map@@$T0@@ref@field$$T0$@To@$T0@@ ref field$$@Map@@Int@To@Int@@$ $@Map@@Int@To@Int@@ ) $@Map@@$T0@@ref@field$$T0$@To@$T0@@)
...
;Predicates
(declare-fun $NP@52 ( field$$@Map@@ref@To@Bool@@$ ref ) Bool)
(declare-fun $NP@58 ( field$ref$ ref ) Bool)
(declare-fun $NP@64 ( field$ref$ ref ) Bool)
(declare-fun $NP@70 ( field$ref$ ref ) Bool)
...
;Axioms
   ...
   (assert (! (>= priority 0) :named ax_2))
   (assert (! (forall ((|i_14| field$$@Map@@Int@To@Int@@$)(|i_13| ref)(|m_7| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_7| $@Map@@Int@To@Int@@))(!(= v_7 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_7 i_13 i_14 v_7) i_13 i_14)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_7 i_13 i_14 v_7) i_13 i_14)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_3))
   (assert (! (forall ((|i_2| field$Int$)(|i_1| ref)(|m_1| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_1| Int))(!(= v_1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_1 i_1 i_2 v_1) i_1 i_2)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_1 i_1 i_2 v_1) i_1 i_2)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_4))
   (assert (! (forall ((|i_26| field$ref$)(|i_25| ref)(|m_13| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_13| ref))(!(= v_13 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_13 i_25 i_26 v_13) i_25 i_26)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_13 i_25 i_26 v_13) i_25 i_26)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_5))
   (assert (! (forall ((|i_38| field$TNodeState$)(|i_37| ref)(|m_19| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_19| TNodeState))(!(= v_19 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_19 i_37 i_38 v_19) i_37 i_38)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_19 i_37 i_38 v_19) i_37 i_38)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_6))
   (assert (! (forall ((|v_10| $@Map@@Int@To@Int@@)(|i_20| field$$@Map@@Int@To@Int@@$)(|i_19| ref)(|j_16| field$$@Map@@ref@To@Bool@@$)(|j_15| ref)(|m_10| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_10 j_15 j_16) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_10 i_19 i_20 v_10) j_15 j_16)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_10 i_19 i_20 v_10) j_15 j_16)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_7))
   (assert (! (forall ((|v_11| $@Map@@Int@To@Int@@)(|i_22| field$$@Map@@Int@To@Int@@$)(|i_21| ref)(|j_18| field$Int$)(|j_17| ref)(|m_11| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_11 j_17 j_18) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_11 i_21 i_22 v_11) j_17 j_18)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_11 i_21 i_22 v_11) j_17 j_18)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__Int__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_8))
   (assert (! (forall ((|v_12| $@Map@@Int@To@Int@@)(|i_24| field$$@Map@@Int@To@Int@@$)(|i_23| ref)(|j_20| field$TNodeState$)(|j_19| ref)(|m_12| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_12 j_19 j_20) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_12 i_23 i_24 v_12) j_19 j_20)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_12 i_23 i_24 v_12) j_19 j_20)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__TNodeState__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_9))
   (assert (! (forall ((|v_14| ref)(|m_14| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_28| field$ref$)(|j_22| field$ref$)(|i_27| ref)(|j_21| ref))(!(=> (or (not (= j_22 i_28)) (not (= j_21 i_27))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_14 j_21 j_22) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_14 i_27 i_28 v_14) j_21 j_22))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_14 i_27 i_28 v_14) j_21 j_22)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_10))
   (assert (! (forall ((|v_15| ref)(|i_30| field$ref$)(|i_29| ref)(|j_24| field$$@Map@@ref@To@Bool@@$)(|j_23| ref)(|m_15| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_15 j_23 j_24) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_15 i_29 i_30 v_15) j_23 j_24)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_15 i_29 i_30 v_15) j_23 j_24)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__ref :weight 0 )) :named ax_11))
   (assert (! (forall ((|v_16| ref)(|i_32| field$ref$)(|i_31| ref)(|j_26| field$Int$)(|j_25| ref)(|m_16| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_16 j_25 j_26) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_16 i_31 i_32 v_16) j_25 j_26)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_16 i_31 i_32 v_16) j_25 j_26)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__Int__ref :weight 0 )) :named ax_12))
   (assert (! (forall ((|v_17| ref)(|i_34| field$ref$)(|i_33| ref)(|j_28| field$TNodeState$)(|j_27| ref)(|m_17| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_17 j_27 j_28) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_17 i_33 i_34 v_17) j_27 j_28)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_17 i_33 i_34 v_17) j_27 j_28)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__TNodeState__ref :weight 0 )) :named ax_13))
   (assert (! (forall ((|v_18| ref)(|i_36| field$ref$)(|i_35| ref)(|j_30| field$$@Map@@Int@To@Int@@$)(|j_29| ref)(|m_18| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_18 j_29 j_30) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_18 i_35 i_36 v_18) j_29 j_30)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_18 i_35 i_36 v_18) j_29 j_30)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@Int@To@Int@@__ref :weight 0 )) :named ax_14))
   (assert (! (forall ((|v_2| Int)(|m_2| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_4| field$Int$)(|j_2| field$Int$)(|i_3| ref)(|j_1| ref))(!(=> (or (not (= j_2 i_4)) (not (= j_1 i_3))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_2 j_1 j_2) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_2 i_3 i_4 v_2) j_1 j_2))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_2 i_3 i_4 v_2) j_1 j_2)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_15))
   (assert (! (forall ((|v_20| TNodeState)(|m_20| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_40| field$TNodeState$)(|j_32| field$TNodeState$)(|i_39| ref)(|j_31| ref))(!(=> (or (not (= j_32 i_40)) (not (= j_31 i_39))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_20 j_31 j_32) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_20 i_39 i_40 v_20) j_31 j_32))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_20 i_39 i_40 v_20) j_31 j_32)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_16))
   (assert (! (forall ((|v_21| TNodeState)(|i_42| field$TNodeState$)(|i_41| ref)(|j_34| field$ref$)(|j_33| ref)(|m_21| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_21 j_33 j_34) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_21 i_41 i_42 v_21) j_33 j_34)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_21 i_41 i_42 v_21) j_33 j_34)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__TNodeState :weight 0 )) :named ax_17))
   (assert (! (forall ((|v_22| TNodeState)(|i_44| field$TNodeState$)(|i_43| ref)(|j_36| field$$@Map@@ref@To@Bool@@$)(|j_35| ref)(|m_22| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_22 j_35 j_36) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_22 i_43 i_44 v_22) j_35 j_36)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_22 i_43 i_44 v_22) j_35 j_36)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__TNodeState :weight 0 )) :named ax_18))
   (assert (! (forall ((|v_23| TNodeState)(|i_46| field$TNodeState$)(|i_45| ref)(|j_38| field$Int$)(|j_37| ref)(|m_23| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_23 j_37 j_38) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_23 i_45 i_46 v_23) j_37 j_38)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_23 i_45 i_46 v_23) j_37 j_38)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__Int__TNodeState :weight 0 )) :named ax_19))
   (assert (! (forall ((|v_24| TNodeState)(|i_48| field$TNodeState$)(|i_47| ref)(|j_40| field$$@Map@@Int@To@Int@@$)(|j_39| ref)(|m_24| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_24 j_39 j_40) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_24 i_47 i_48 v_24) j_39 j_40)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_24 i_47 i_48 v_24) j_39 j_40)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@Int@To@Int@@__TNodeState :weight 0 )) :named ax_20))
   (assert (! (forall ((|v_3| Int)(|i_6| field$Int$)(|i_5| ref)(|j_4| field$ref$)(|j_3| ref)(|m_3| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_3 j_3 j_4) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_3 i_5 i_6 v_3) j_3 j_4)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_3 i_5 i_6 v_3) j_3 j_4)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__Int :weight 0 )) :named ax_21))
   (assert (! (forall ((|v_4| Int)(|i_8| field$Int$)(|i_7| ref)(|j_6| field$$@Map@@ref@To@Bool@@$)(|j_5| ref)(|m_4| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_4 j_5 j_6) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_4 i_7 i_8 v_4) j_5 j_6)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_4 i_7 i_8 v_4) j_5 j_6)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__Int :weight 0 )) :named ax_22))
   (assert (! (forall ((|v_5| Int)(|i_10| field$Int$)(|i_9| ref)(|j_8| field$TNodeState$)(|j_7| ref)(|m_5| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_5 j_7 j_8) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_5 i_9 i_10 v_5) j_7 j_8)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_5 i_9 i_10 v_5) j_7 j_8)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__TNodeState__Int :weight 0 )) :named ax_23))
   (assert (! (forall ((|v_6| Int)(|i_12| field$Int$)(|i_11| ref)(|j_10| field$$@Map@@Int@To@Int@@$)(|j_9| ref)(|m_6| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_6 j_9 j_10) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_6 i_11 i_12 v_6) j_9 j_10)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_6 i_11 i_12 v_6) j_9 j_10)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@Int@To@Int@@__Int :weight 0 )) :named ax_24))
   (assert (! (forall ((|v_8| $@Map@@Int@To@Int@@)(|m_8| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_16| field$$@Map@@Int@To@Int@@$)(|j_12| field$$@Map@@Int@To@Int@@$)(|i_15| ref)(|j_11| ref))(!(=> (or (not (= j_12 i_16)) (not (= j_11 i_15))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_8 j_11 j_12) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_8 i_15 i_16 v_8) j_11 j_12))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_8 i_15 i_16 v_8) j_11 j_12)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_25))
   (assert (! (forall ((|v_9| $@Map@@Int@To@Int@@)(|i_18| field$$@Map@@Int@To@Int@@$)(|i_17| ref)(|j_14| field$ref$)(|j_13| ref)(|m_9| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_9 j_13 j_14) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_9 i_17 i_18 v_9) j_13 j_14)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_9 i_17 i_18 v_9) j_13 j_14)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_26))
   ...
   (assert (! (forall( (|r_$0| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$2| ref))(!(= (or (MapRead$$@Map@@ref@To@Bool@@$ |r_$0| |o'_$2|) (= |o_$8| |o'_$2|)) (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|)))) :named ax_105))
   (assert (! (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$9| ref) (|o'_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|) (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$3|) (not (= |o_$9| |o'_$3|))))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|)))) :named ax_106))
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(!(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))  :pattern ( (IsGoodRegion |r_$3|)))) :named ax_107))
   (assert (! (forall( (|r| ref) (|o_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|) (= |r| |o_$3|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|)))) :named ax_108))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$10| ref))(!(= (and (MapRead$$@Map@@ref@To@Bool@@$ |s_$0| |o_$10|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$10|))) (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|)))) :named ax_109))
   (assert (! (forall( (|s_$1| $@Map@@ref@To@Bool@@) (|o_$11| ref))(=> (not (MapRead$$@Map@@ref@To@Bool@@$ |s_$1| |o_$11|)) (= (+ (Card |s_$1|) 1) (Card (AddEl |s_$1| |o_$11|))))) :named ax_110))
   (assert (! (forall( (|s_$2| $@Map@@ref@To@Bool@@) (|o_$12| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ |s_$2| |o_$12|) (= (- (Card |s_$2|) 1) (Card (RemEl |s_$2| |o_$12|))))) :named ax_111))
   (assert (! (forall( (|s_$3| $@Map@@ref@To@Bool@@) (|t_$0| $@Map@@ref@To@Bool@@))(=> (Equal |s_$3| |t_$0|) (= (Card |t_$0|) (Card |s_$3|)))) :named ax_112))
   (assert (! (forall( (|s_$4| $@Map@@ref@To@Bool@@) (|t_$1| $@Map@@ref@To@Bool@@))(=> (Equal |s_$4| |t_$1|) (= |t_$1| |s_$4|))) :named ax_113))
   (assert (! (forall( (|s| $@Map@@Int@To@Int@@) (|t| $@Map@@Int@To@Int@@))(!(=> (EqualMSet |s| |t|) (= (MaxMSet |t|) (MaxMSet |s|)))  :pattern ( (EqualMSet |s| |t|)))) :named ax_114))
   (assert (! (forall( (|St| TNodeState))(or (= StD |St|) (or (= StL |St|) (= StF |St|)))) :named ax_115))
   (assert (! (InvStructEx $Heap NotAllocated) :named ax_116))
   (assert (! (IsNotAllocated $Heap this) :named ax_117))
   (assert (! (MapRead$$@Map@@ref@To@Bool@@$ NotAllocated this) :named ax_118))
   (assert (! (MapRead$$@Map@@ref@To@Bool@@$ NotAllocated this) :named ax_119))
   (assert (! (not (= Le Lb)) :named ax_120))
   (assert (! (not (= Le Lb)) :named ax_121))
   (assert (! (not (= Ln Lb)) :named ax_122))
   (assert (! (not (= Ln Lb)) :named ax_123))
   (assert (! (not (= Ln Le)) :named ax_124))
   (assert (! (not (= Ln Le)) :named ax_125))
   ...
   (assert (! (not (= Lp Ln)) :named ax_131))
   (assert (! (not (= NA LL)) :named ax_132))
   (assert (! (not (= NA LL)) :named ax_133))
   (assert (! (not (= Nbb Lb)) :named ax_134))
   (assert (! (not (= Nbb Lb)) :named ax_135))
   (assert (! (not (= Nbb Le)) :named ax_136))
   (assert (! (not (= Nbb Le)) :named ax_137))
   (assert (! (not (= Nbb Ln)) :named ax_138))
   (assert (! (not (= Nbb Ln)) :named ax_139))
   (assert (! (not (= Nbb Lp)) :named ax_140))
   (assert (! (not (= Nbb Lp)) :named ax_141))
   (assert (! (not (= NC LL)) :named ax_142))
   (assert (! (not (= NC LL)) :named ax_143))
   (assert (! (not (= NC NA)) :named ax_144))
   (assert (! (not (= NC NA)) :named ax_145))
   (assert (! (not (= ND LL)) :named ax_146))
   (assert (! (not (= ND LL)) :named ax_147))
   (assert (! (not (= ND NA)) :named ax_148))
   (assert (! (not (= ND NA)) :named ax_149))
   (assert (! (not (= ND NC)) :named ax_150))
   (assert (! (not (= ND NC)) :named ax_151))
   (assert (! (not (= Ndpr Ncpr)) :named ax_152))
   (assert (! (not (= Ndpr Ncpr)) :named ax_153))
   (assert (! (not (= Np Lb)) :named ax_154))
   (assert (! (not (= Np Lb)) :named ax_155))
   (assert (! (not (= Np Le)) :named ax_156))
   (assert (! (not (= Np Le)) :named ax_157))
   (assert (! (not (= Np Ln)) :named ax_158))
   (assert (! (not (= Np Ln)) :named ax_159))
   (assert (! (not (= Np Lp)) :named ax_160))
   (assert (! (not (= Np Lp)) :named ax_161))
   (assert (! (not (= Np Nbb)) :named ax_162))
   (assert (! (not (= Np Nbb)) :named ax_163))
   (assert (! (not (= Nt Lb)) :named ax_164))
   (assert (! (not (= Nt Lb)) :named ax_165))
   (assert (! (not (= Nt Le)) :named ax_166))
   (assert (! (not (= Nt Le)) :named ax_167))
   (assert (! (not (= Nt Ln)) :named ax_168))
   (assert (! (not (= Nt Ln)) :named ax_169))
   (assert (! (not (= Nt Lp)) :named ax_170))
   (assert (! (not (= Nt Lp)) :named ax_171))
   (assert (! (not (= Nt Nbb)) :named ax_172))
   (assert (! (not (= Nt Nbb)) :named ax_173))
   (assert (! (not (= Nt Np)) :named ax_174))
   (assert (! (not (= Nt Np)) :named ax_175))
   (assert (! (not (= StF StD)) :named ax_176))
   (assert (! (not (= StF StD)) :named ax_177))
   (assert (! (not (= StL StD)) :named ax_178))
   (assert (! (not (= StL StD)) :named ax_179))
   (assert (! (not (= StL StF)) :named ax_180))
   (assert (! (not (= StL StF)) :named ax_181))
   (assert (! (not (= this null)) :named ax_182))
   (assert (! (not (= this null)) :named ax_183))
...
(assert (! (=> anon0@3_assertion (not (and true
   (and true
      (IsNotAllocatedTree $Heap this)
   )
))) :named ax_anon0@3_assertion))
(assert (! (=> anon0@4 (and true 
   (and true
      (forall( (|o'_$20_$0| ref) (|f_$3_$0| field$ref$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 |o'_$20_$0| |f_$3_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o'_$20_$0| |f_$3_$0|)) (and (= |o'_$20_$0| this) (= |f_$3_$0| Np))) (and (= |o'_$20_$0| this) (= |f_$3_$0| Nt))) (and (= |o'_$20_$0| this) false)) (and (= |o'_$20_$0| this) false)) (and (= |o'_$20_$0| this) false)))
      (forall( (|o'_$20_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o'_$20_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o'_$20_$1| |f_$3_$1|)) (and (= |o'_$20_$1| this) false)) (and (= |o'_$20_$1| this) false)) (and (= |o'_$20_$1| this) (= |f_$3_$1| NA))) (and (= |o'_$20_$1| this) (= |f_$3_$1| NC))) (and (= |o'_$20_$1| this) (= |f_$3_$1| ND))))
      (forall( (|o'_$20_$2| ref) (|f_$3_$2| field$$@Map@@Int@To@Int@@$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 |o'_$20_$2| |f_$3_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap |o'_$20_$2| |f_$3_$2|)) (and (= |o'_$20_$2| this) false)) (and (= |o'_$20_$2| this) false)) (and (= |o'_$20_$2| this) false)) (and (= |o'_$20_$2| this) false)) (and (= |o'_$20_$2| this) false)))
      (forall( (|o'_$20_$3| ref) (|f_$3_$3| field$Int$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 |o'_$20_$3| |f_$3_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap |o'_$20_$3| |f_$3_$3|)) (and (= |o'_$20_$3| this) false)) (and (= |o'_$20_$3| this) false)) (and (= |o'_$20_$3| this) false)) (and (= |o'_$20_$3| this) false)) (and (= |o'_$20_$3| this) false)))
      (forall( (|o'_$20_$4| ref) (|f_$3_$4| field$TNodeState$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@0 |o'_$20_$4| |f_$3_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap |o'_$20_$4| |f_$3_$4|)) (and (= |o'_$20_$4| this) false)) (and (= |o'_$20_$4| this) false)) (and (= |o'_$20_$4| this) false)) (and (= |o'_$20_$4| this) false)) (and (= |o'_$20_$4| this) false)))
      (InvTreeEx $Heap@0 (RemEl NotAllocated this))
      (IsEmptyTree $Heap@0 this)
      (IsNotAllocatedTree $Heap this)
      (MapRead$$@Map@@ref@To@Bool@@$ NotAllocated this)
      (not (= this null))
   )
...
(assert (! (=> anon0@7_assertion (not (and true
   (and true
      (IsNotAllocatedList $Heap@0 this)
   )
))) :named ax_anon0@7_assertion))
(assert (! (=> anon0@8 (and true 
   (and true
      (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 this Ndpr priority))
      (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 this Ncpr priority))
      (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 this Npr EmptyMSet))
      (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb null))
      (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@5 this NSt StF))
      (forall( (|o'_$21_$0| ref) (|f_$4_$0| field$ref$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 |o'_$21_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 |o'_$21_$0| |f_$4_$0|)) (and (= |o'_$21_$0| this) false)) (and (= |o'_$21_$0| this) (= |f_$4_$0| Ln))) (and (= |o'_$21_$0| this) (= |f_$4_$0| Le))) (and (= |o'_$21_$0| this) (= |f_$4_$0| Lp))) (and (= |o'_$21_$0| this) (= |f_$4_$0| Lb))))
      (forall( (|o'_$21_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o'_$21_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o'_$21_$1| |f_$4_$1|)) (and (= |o'_$21_$1| this) (= |f_$4_$1| LL))) (and (= |o'_$21_$1| this) false)) (and (= |o'_$21_$1| this) false)) (and (= |o'_$21_$1| this) false)) (and (= |o'_$21_$1| this) false)))
      (forall( (|o'_$21_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 |o'_$21_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 |o'_$21_$2| |f_$4_$2|)) (and (= |o'_$21_$2| this) false)) (and (= |o'_$21_$2| this) false)) (and (= |o'_$21_$2| this) false)) (and (= |o'_$21_$2| this) false)) (and (= |o'_$21_$2| this) false)))
      (forall( (|o'_$21_$3| ref) (|f_$4_$3| field$Int$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 |o'_$21_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 |o'_$21_$3| |f_$4_$3|)) (and (= |o'_$21_$3| this) false)) (and (= |o'_$21_$3| this) false)) (and (= |o'_$21_$3| this) false)) (and (= |o'_$21_$3| this) false)) (and (= |o'_$21_$3| this) false)))
      (forall( (|o'_$21_$4| ref) (|f_$4_$4| field$TNodeState$))(or (or (or (or (or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 |o'_$21_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@0 |o'_$21_$4| |f_$4_$4|)) (and (= |o'_$21_$4| this) false)) (and (= |o'_$21_$4| this) false)) (and (= |o'_$21_$4| this) false)) (and (= |o'_$21_$4| this) false)) (and (= |o'_$21_$4| this) false)))
      (InvListEx $Heap@1 (RemEl NotAllocated this))
      (IsEmptyList $Heap@1 this)
      (IsNotAllocatedList $Heap@0 this)
   )
...
(assert (! (=> anon0@8_assertion (not (and true
   (and true
      (forall( (|i_$10| Int))(=> (> |i_$10| 0) (Equal (FBP $Heap@6 (BBSet $Heap@6 this) |i_$10|) Empty)))
   )
...
(assert (! (=> anon0@10 (and true 
   (and true
      (InvStructEx $Heap@6 (Minus NotAllocated (Singleton this)))
   )
...
(assert (! (=> anon0@11_assertion (not (and true
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@6 this NSt) StF)
   )
...
(assert (! (=> anon0@13_assertion (not (and true
   (and true
      (forall( (|o_$74_$0| ref) (|f_$5_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@6 |o_$74_$0| |f_$5_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$74_$0| |f_$5_$0|)) (= |o_$74_$0| this)))
      (forall( (|o_$74_$1| ref) (|f_$5_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 |o_$74_$1| |f_$5_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$74_$1| |f_$5_$1|)) (= |o_$74_$1| this)))
      (forall( (|o_$74_$2| ref) (|f_$5_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@6 |o_$74_$2| |f_$5_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap |o_$74_$2| |f_$5_$2|)) (= |o_$74_$2| this)))
      (forall( (|o_$74_$3| ref) (|f_$5_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@6 |o_$74_$3| |f_$5_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap |o_$74_$3| |f_$5_$3|)) (= |o_$74_$3| this)))
      (forall( (|o_$74_$4| ref) (|f_$5_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@6 |o_$74_$4| |f_$5_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap |o_$74_$4| |f_$5_$4|)) (= |o_$74_$4| this)))
   )
