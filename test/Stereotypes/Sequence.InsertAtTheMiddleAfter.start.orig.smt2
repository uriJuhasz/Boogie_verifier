...
(assert (! (=> anon0 (and true 
   (and true
      (= $Heap@0 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln el))
      ...
      (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$33|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$33| LL) (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL) call2formal@r2@0))))
      (forall( (|o_$34_$0| ref) (|f_$3| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$34_$0| |f_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 |o_$34_$0| |f_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$34_$0|) false)))
      (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$34_$1|) (= |f_$4| LL))))
      (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$35|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$35| LNC) (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC) call2formal@r2@0))))
      (forall( (|o_$36_$0| ref) (|f_$0_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$36_$0| |f_$0_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$36_$0| |f_$0_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$36_$0|) false)))
      (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$36_$1|) (= |f_$0_$1| LNC))))
      (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$37|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$37| LPC) (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$37| LPC) call2formal@r2@0))))
      (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$38_$0|) false)))
      (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$38_$1|) (= |f_$1_$1| LPC))))
   )
