...
;Axioms
   ...
   (assert (! (= (Card Empty) 0) :named ax_4))
   (assert (! (= (MaxMSet EmptyMSet) 0) :named ax_5))
   (assert (! (= call2formal@r2@0 (Singleton el)) :named ax_6))
   (assert (! (= oldEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) :named ax_7))
   (assert (! (= oldList@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL)) :named ax_8))
   ...
   (assert (! (forall( (|a_$1| $@Map@@Int@To@Int@@) (|i_$3| Int) (|j| Int))(!(=> (not (= |i_$3| |j|)) (= (MapRead$$@Map@@Int@To@Int@@$ (AddMSet |a_$1| |i_$3|) |j|) (MapRead$$@Map@@Int@To@Int@@$ |a_$1| |j|)))  :pattern ( (MapRead$$@Map@@Int@To@Int@@$ (AddMSet |a_$1| |i_$3|) |j|)))) :named ax_23))
   ...
   (assert (! (forall( (|a_$3| $@Map@@Int@To@Int@@) (|i_$5| Int) (|j_$0| Int))(!(=> (not (= |i_$5| |j_$0|)) (= (MapRead$$@Map@@Int@To@Int@@$ (RemoveMSet |a_$3| |i_$5|) |j_$0|) (MapRead$$@Map@@Int@To@Int@@$ |a_$3| |j_$0|)))  :pattern ( (MapRead$$@Map@@Int@To@Int@@$ (RemoveMSet |a_$3| |i_$5|) |j_$0|)))) :named ax_25))
   (assert (! (forall( (|a_$4| $@Map@@ref@To@Bool@@) (|b_$0| $@Map@@ref@To@Bool@@) (|o_$4| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Union |a_$4| |b_$0|) |o_$4|) (or (MapRead$$@Map@@ref@To@Bool@@$ |a_$4| |o_$4|) (MapRead$$@Map@@ref@To@Bool@@$ |b_$0| |o_$4|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Union |a_$4| |b_$0|) |o_$4|)))) :named ax_26))
   ...
   (assert (! (forall( (|a_$6| $@Map@@ref@To@Bool@@) (|b_$2| $@Map@@ref@To@Bool@@))(!(= (Equal |a_$6| |b_$2|) (forall( (|o_$6| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ |a_$6| |o_$6|) (MapRead$$@Map@@ref@To@Bool@@$ |b_$2| |o_$6|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ |a_$6| |o_$6|)) :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ |b_$2| |o_$6|)))))  :pattern ( (Equal |a_$6| |b_$2|)))) :named ax_28))
   (assert (! (forall( (|a_$7| $@Map@@ref@To@Bool@@) (|b_$3| $@Map@@ref@To@Bool@@))(!(= (Disjoint |a_$7| |b_$3|) (forall( (|o_$7| ref))(!(or (not (MapRead$$@Map@@ref@To@Bool@@$ |a_$7| |o_$7|)) (not (MapRead$$@Map@@ref@To@Bool@@$ |b_$3| |o_$7|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ |a_$7| |o_$7|)) :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ |b_$3| |o_$7|)))))  :pattern ( (Disjoint |a_$7| |b_$3|)))) :named ax_29))
   (assert (! (forall( (|a| $@Map@@Int@To@Int@@) (|b| $@Map@@Int@To@Int@@))(!(= (EqualMSet |a| |b|) (forall( (|i_$1| Int))(!(=> (> |i_$1| 0) (= (MapRead$$@Map@@Int@To@Int@@$ |a| |i_$1|) (MapRead$$@Map@@Int@To@Int@@$ |b| |i_$1|)))  :pattern ( (MapRead$$@Map@@Int@To@Int@@$ |a| |i_$1|)) :pattern ( (MapRead$$@Map@@Int@To@Int@@$ |b| |i_$1|)))))  :pattern ( (EqualMSet |a| |b|)))) :named ax_30))
   ...
   (assert (! (forall( (|h_$16| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex1_$2| $@Map@@ref@To@Bool@@))(= (InvDEx |h_$16| |Ex1_$2|) (forall( (|o_$28| ref))(=> (and (not (= |o_$28| null)) (not (MapRead$$@Map@@ref@To@Bool@@$ |Ex1_$2| |o_$28|))) (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$16| |o_$28| ND) |o_$28|)))))) :named ax_44))
   (assert (! (forall( (|h_$17| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex1_$3| $@Map@@ref@To@Bool@@))(= (InvAEx |h_$17| |Ex1_$3|) (forall( (|o_$29| ref))(=> (and (not (= |o_$29| null)) (not (MapRead$$@Map@@ref@To@Bool@@$ |Ex1_$3| |o_$29|))) (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$17| |o_$29| NA) |o_$29|)))))) :named ax_45))
   ...
   (assert (! (forall( (|h_$4| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|r_$4| $@Map@@ref@To@Bool@@) (|i_$7| Int) (|o_$15| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (FBP |h_$4| |r_$4| |i_$7|) |o_$15|) (and (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$4| |o_$15|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$4| |o_$15| Ncpr) |i_$7|)) (not (= |o_$15| null))))) :named ax_59))
   (assert (! (forall( (|h_$49| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex| $@Map@@ref@To@Bool@@))(!(= (InvTreeEx |h_$49| |Ex|) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (InvIsGoodRegionsTreeEx |h_$49| |Ex|) (InvCpEx |h_$49| |Ex| |Ex|)) (InvCCEx |h_$49| |Ex| |Ex|)) (InvDEx |h_$49| |Ex|)) (InvAEx |h_$49| |Ex|)) (InvCD1Ex |h_$49| |Ex|)) (InvCD2Ex |h_$49| |Ex| |Ex|)) (InvAD1Ex |h_$49| |Ex| |Ex|)) (InvAD2Ex |h_$49| |Ex| |Ex|)) (InvAD3Ex |h_$49| |Ex| |Ex|)) (InvDD1Ex |h_$49| |Ex| |Ex|)) (InvDD2Ex |h_$49| |Ex| |Ex|)) (InvAAEx |h_$49| |Ex| |Ex|)) (InvAp1Ex |h_$49| |Ex|)) (InvAp2Ex |h_$49| |Ex|)) (InvAt1Ex |h_$49| |Ex|)) (InvAt2Ex |h_$49| |Ex|)) (InvAt3Ex |h_$49| |Ex| |Ex|)))  :pattern ( (InvTreeEx |h_$49| |Ex|)))) :named ax_60))
   (assert (! (forall( (|h_$5| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$16| ref))(=> (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$5| |o_$16| Ln) null) (= (CLn |h_$5| |o_$16|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$5| |o_$16| Lb)))) :named ax_61))
   (assert (! (forall( (|h_$50| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (InvTree |h_$50|) (InvTreeEx |h_$50| Empty))  :pattern ( (InvTree |h_$50|)))) :named ax_62))
   ...
   (assert (! (forall( (|h_$6| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$17| ref))(=> (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$6| |o_$17| Ln) null)) (= (CLn |h_$6| |o_$17|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$6| |o_$17| Ln)))) :named ax_72))
   ...
   (assert (! (forall( (|h_$7| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$18| ref))(=> (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$7| |o_$18| Lp) null) (= (CLp |h_$7| |o_$18|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$7| |o_$18| Le)))) :named ax_78))
   (assert (! (forall( (|h_$79| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex_$0| $@Map@@ref@To@Bool@@))(!(= (InvListEx |h_$79| |Ex_$0|) (and (and (and (and (and (and (and (and (and (and (and (and (and (InvIsGoodRegionsListEx |h_$79| |Ex_$0|) (InvLEx |h_$79| |Ex_$0|)) (Inve1Ex |h_$79| |Ex_$0|)) (Inve2Ex |h_$79| |Ex_$0|)) (Invb1Ex |h_$79| |Ex_$0|)) (Invb2Ex |h_$79| |Ex_$0|)) (InvnEx |h_$79| |Ex_$0|)) (InvpEx |h_$79| |Ex_$0|)) (InvpnEx |h_$79| |Ex_$0|)) (InvnpEx |h_$79| |Ex_$0|)) (InvLbEx |h_$79| |Ex_$0| |Ex_$0|)) (InvLeEx |h_$79| |Ex_$0| |Ex_$0|)) (InvLL1Ex |h_$79| |Ex_$0| |Ex_$0|)) (InvLL2Ex |h_$79| |Ex_$0| |Ex_$0|)))  :pattern ( (InvListEx |h_$79| |Ex_$0|)))) :named ax_79))
   (assert (! (forall( (|h_$8| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$19| ref))(=> (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$19| Lp) null)) (= (CLp |h_$8| |o_$19|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$19| Lp)))) :named ax_80))
   (assert (! (forall( (|h_$80| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (InvList |h_$80|) (InvListEx |h_$80| Empty))  :pattern ( (InvList |h_$80|)))) :named ax_81))
   ...
   (assert (! (forall( (|h_$93| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex_$1| $@Map@@ref@To@Bool@@))(= (InvStructEx |h_$93| |Ex_$1|) (and (and (and (and (and (and (and (InvTreeEx |h_$93| |Ex_$1|) (InvListEx |h_$93| |Ex_$1|)) (InvStFEx |h_$93| |Ex_$1|)) (InvStLEx |h_$93| |Ex_$1|)) (InvStDEx |h_$93| |Ex_$1|)) (InvStNDLEx |h_$93| |Ex_$1|)) (InvStDCCEx |h_$93| |Ex_$1| |Ex_$1|)) (InvStADEx |h_$93| |Ex_$1| |Ex_$1|)))) :named ax_88))
   ...
   (assert (! (forall( (|i_$6| Int) (|j_$1| Int))(!(and (and (>= (Max |i_$6| |j_$1|) |i_$6|) (>= (Max |i_$6| |j_$1|) |j_$1|)) (or (= (Max |i_$6| |j_$1|) |i_$6|) (= (Max |i_$6| |j_$1|) |j_$1|)))  :pattern ( (Max |i_$6| |j_$1|)))) :named ax_96))
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$74|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 |o_$74| LL) (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$74| LL) call2formal@r2@0)))) :named ax_99))
   (assert (! (forall( (|o_$75_$0| ref) (|f_$3_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$75_$0| |f_$3_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 |o_$75_$0| |f_$3_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$75_$0|) false))) :named ax_100))
   (assert (! (forall( (|o_$75_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 |o_$75_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$75_$1| |f_$3_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$75_$1|) (= |f_$3_$1| LL)))) :named ax_101))
   (assert (! (forall( (|o_$75_$2| ref) (|f_$3_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@4 |o_$75_$2| |f_$3_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 |o_$75_$2| |f_$3_$2|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$75_$2|) false))) :named ax_102))
   (assert (! (forall( (|o_$75_$3| ref) (|f_$3_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 |o_$75_$3| |f_$3_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 |o_$75_$3| |f_$3_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$75_$3|) false))) :named ax_103))
   (assert (! (forall( (|o_$75_$4| ref) (|f_$3_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@4 |o_$75_$4| |f_$3_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@3 |o_$75_$4| |f_$3_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$75_$4|) false))) :named ax_104))
   (assert (! (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$76|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 |o_$76| Le) el))) :named ax_105))
   (assert (! (forall( (|o_$77_$0| ref) (|f_$4_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 |o_$77_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$77_$0| |f_$4_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$77_$0|) (= |f_$4_$0| Le)))) :named ax_106))
   (assert (! (forall( (|o_$77_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 |o_$77_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 |o_$77_$1| |f_$4_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$77_$1|) false))) :named ax_107))
   (assert (! (forall( (|o_$77_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@5 |o_$77_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@4 |o_$77_$2| |f_$4_$2|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$77_$2|) false))) :named ax_108))
   (assert (! (forall( (|o_$77_$3| ref) (|f_$4_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@5 |o_$77_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 |o_$77_$3| |f_$4_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$77_$3|) false))) :named ax_109))
   (assert (! (forall( (|o_$77_$4| ref) (|f_$4_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@5 |o_$77_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@4 |o_$77_$4| |f_$4_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$77_$4|) false))) :named ax_110))
   (assert (! (forall( (|r_$0| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$2| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|) (or (= |o_$8| |o'_$2|) (MapRead$$@Map@@ref@To@Bool@@$ |r_$0| |o'_$2|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|)))) :named ax_111))
   (assert (! (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$9| ref) (|o'_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|) (and (not (= |o_$9| |o'_$3|)) (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$3|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|)))) :named ax_112))
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(!(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))  :pattern ( (IsGoodRegion |r_$3|)))) :named ax_113))
   (assert (! (forall( (|r| ref) (|o_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|) (= |r| |o_$3|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|)))) :named ax_114))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$10| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|) (and (MapRead$$@Map@@ref@To@Bool@@$ |s_$0| |o_$10|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$10|))))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|)))) :named ax_115))
   (assert (! (forall( (|s_$1| $@Map@@ref@To@Bool@@) (|o_$11| ref))(=> (not (MapRead$$@Map@@ref@To@Bool@@$ |s_$1| |o_$11|)) (= (Card (AddEl |s_$1| |o_$11|)) (+ (Card |s_$1|) 1)))) :named ax_116))
   (assert (! (forall( (|s_$2| $@Map@@ref@To@Bool@@) (|o_$12| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ |s_$2| |o_$12|) (= (Card (RemEl |s_$2| |o_$12|)) (- (Card |s_$2|) 1)))) :named ax_117))
   (assert (! (forall( (|s_$3| $@Map@@ref@To@Bool@@) (|t_$0| $@Map@@ref@To@Bool@@))(=> (Equal |s_$3| |t_$0|) (= (Card |s_$3|) (Card |t_$0|)))) :named ax_118))
   (assert (! (forall( (|s_$4| $@Map@@ref@To@Bool@@) (|t_$1| $@Map@@ref@To@Bool@@))(=> (Equal |s_$4| |t_$1|) (= |s_$4| |t_$1|))) :named ax_119))
   (assert (! (forall( (|s| $@Map@@Int@To@Int@@) (|t| $@Map@@Int@To@Int@@))(!(=> (EqualMSet |s| |t|) (= (MaxMSet |s|) (MaxMSet |t|)))  :pattern ( (EqualMSet |s| |t|)))) :named ax_120))
   (assert (! (forall( (|St| TNodeState))(or (or (= |St| StF) (= |St| StL)) (= |St| StD))) :named ax_121))
   (assert (! (InvList $Heap) :named ax_122))
   (assert (! (InvTree $Heap) :named ax_123))
   (assert (! (IsEmptyList $Heap el) :named ax_124))
   (assert (! (not (= el null)) :named ax_125))
   (assert (! (not (= Lb Nbb)) :named ax_126))
   (assert (! (not (= Le Lb)) :named ax_127))
   (assert (! (not (= Le Lb)) :named ax_128))
   (assert (! (not (= Le Lp)) :named ax_129))
   (assert (! (not (= Le Nbb)) :named ax_130))
   (assert (! (not (= list null)) :named ax_131))
   (assert (! (not (= Ln Lb)) :named ax_132))
   (assert (! (not (= Ln Lb)) :named ax_133))
   (assert (! (not (= Ln Le)) :named ax_134))
   ...
   (assert (! (not (= NC LL)) :named ax_149))
   (assert (! (not (= NC LL)) :named ax_150))
   (assert (! (not (= NC NA)) :named ax_151))
   (assert (! (not (= NC NA)) :named ax_152))
   (assert (! (not (= NC ND)) :named ax_153))
   (assert (! (not (= ND LL)) :named ax_154))
   (assert (! (not (= ND LL)) :named ax_155))
   (assert (! (not (= ND NA)) :named ax_156))
   (assert (! (not (= ND NA)) :named ax_157))
   (assert (! (not (= ND NC)) :named ax_158))
   (assert (! (not (= Ndpr Ncpr)) :named ax_159))
   (assert (! (not (= Ndpr Ncpr)) :named ax_160))
   (assert (! (not (= Np Lb)) :named ax_161))
   ...
   (assert (! (not (= Nt Le)) :named ax_175))
   (assert (! (not (= Nt Ln)) :named ax_176))
   (assert (! (not (= Nt Ln)) :named ax_177))
   (assert (! (not (= Nt Lp)) :named ax_178))
   (assert (! (not (= Nt Lp)) :named ax_179))
   (assert (! (not (= Nt Nbb)) :named ax_180))
   (assert (! (not (= Nt Nbb)) :named ax_181))
   (assert (! (not (= Nt Np)) :named ax_182))
   (assert (! (not (= StF StD)) :named ax_183))
   (assert (! (not (= StF StD)) :named ax_184))
   (assert (! (not (= StF StL)) :named ax_185))
   (assert (! (not (= StL StD)) :named ax_186))
   (assert (! (not (= StL StD)) :named ax_187))
   (assert (! (not (= StL StF)) :named ax_188))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) el)) :named ax_189))
