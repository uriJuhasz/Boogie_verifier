...
(declare-fun anon8_Then@2_assertion ( ) Bool)
(declare-fun anon8_Then@3 ( ) Bool)
(declare-fun anon8_Then@3_assertion ( ) Bool)
(declare-fun anon8_Then@4 ( ) Bool)
...
;Axioms
   ...
   (assert (! (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap this Ncpr)) :named ax_2))
   (assert (! (>= from 0) :named ax_3))
   (assert (! (>= to 0) :named ax_4))
   ...
   (assert (! (forall( (|h_$6| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$17| ref))(=> (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$6| |o_$17| Ln) null)) (= (CLn |h_$6| |o_$17|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$6| |o_$17| Ln)))) :named ax_67))
   ...
   (assert (! (forall( (|h_$7| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$18| ref))(=> (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$7| |o_$18| Lp) null) (= (CLp |h_$7| |o_$18|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$7| |o_$18| Le)))) :named ax_73))
   (assert (! (forall( (|h_$79| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex_$0| $@Map@@ref@To@Bool@@))(!(= (InvListEx |h_$79| |Ex_$0|) (and (and (and (and (and (and (and (and (and (and (and (and (and (InvIsGoodRegionsListEx |h_$79| |Ex_$0|) (InvLEx |h_$79| |Ex_$0|)) (Inve1Ex |h_$79| |Ex_$0|)) (Inve2Ex |h_$79| |Ex_$0|)) (Invb1Ex |h_$79| |Ex_$0|)) (Invb2Ex |h_$79| |Ex_$0|)) (InvnEx |h_$79| |Ex_$0|)) (InvpEx |h_$79| |Ex_$0|)) (InvpnEx |h_$79| |Ex_$0|)) (InvnpEx |h_$79| |Ex_$0|)) (InvLbEx |h_$79| |Ex_$0| |Ex_$0|)) (InvLeEx |h_$79| |Ex_$0| |Ex_$0|)) (InvLL1Ex |h_$79| |Ex_$0| |Ex_$0|)) (InvLL2Ex |h_$79| |Ex_$0| |Ex_$0|)))  :pattern ( (InvListEx |h_$79| |Ex_$0|)))) :named ax_74))
   (assert (! (forall( (|h_$8| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$19| ref))(=> (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$19| Lp) null)) (= (CLp |h_$8| |o_$19|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$19| Lp)))) :named ax_75))
   ...
   (assert (! (forall( (|h_$96| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$64| ref) (|from_$0| Int) (|to_$0| Int))(= (InvPrSt |h_$96| |o_$64| |from_$0| |to_$0|) (and (and (and (and (forall( (|i_$9| Int))(=> (and (and (> |i_$9| 0) (not (= |i_$9| |from_$0|))) (not (= |i_$9| |to_$0|))) (= (MapRead$$@Map@@Int@To@Int@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ |h_$96| |o_$64| Npr) |i_$9|) (Card (FBP |h_$96| (BBSet |h_$96| |o_$64|) |i_$9|))))) (=> (> |from_$0| 0) (= (MapRead$$@Map@@Int@To@Int@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ |h_$96| |o_$64| Npr) |from_$0|) (+ (Card (FBP |h_$96| (BBSet |h_$96| |o_$64|) |from_$0|)) 1)))) (=> (> |to_$0| 0) (= (MapRead$$@Map@@Int@To@Int@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ |h_$96| |o_$64| Npr) |to_$0|) (- (Card (FBP |h_$96| (BBSet |h_$96| |o_$64|) |to_$0|)) 1)))) (>= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$96| |o_$64| Ncpr) 0)) (>= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$96| |o_$64| Ndpr) 0)))) :named ax_85))
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCSet $Heap this) |o_$74|) (InvPr $Heap |o_$74|))) :named ax_94))
   (assert (! (forall( (|r_$0| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$2| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|) (or (= |o_$8| |o'_$2|) (MapRead$$@Map@@ref@To@Bool@@$ |r_$0| |o'_$2|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|)))) :named ax_95))
   (assert (! (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$9| ref) (|o'_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|) (and (not (= |o_$9| |o'_$3|)) (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$3|)))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|)))) :named ax_96))
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(!(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))  :pattern ( (IsGoodRegion |r_$3|)))) :named ax_97))
   (assert (! (forall( (|r| ref) (|o_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|) (= |r| |o_$3|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|)))) :named ax_98))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$10| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|) (and (MapRead$$@Map@@ref@To@Bool@@$ |s_$0| |o_$10|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$10|))))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|)))) :named ax_99))
   ...
   (assert (! (InvPrSt $Heap this from to) :named ax_106))
   (assert (! (InvStruct $Heap) :named ax_107))
   (assert (! (not (= from to)) :named ax_108))
   (assert (! (not (= Lb Nbb)) :named ax_109))
   (assert (! (not (= Le Lb)) :named ax_110))
   (assert (! (not (= Le Lb)) :named ax_111))
   (assert (! (not (= Le Lp)) :named ax_112))
   (assert (! (not (= Le Nbb)) :named ax_113))
   ...
   (assert (! (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap this Nbb))) :named ax_171))
   (assert (! (not (= this null)) :named ax_172))
...
(assert (! (=> anon6_Then (and true 
   (and true
      $@condition
      (= $Heap@0 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr (RemoveMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr) from)))
      (= $Heap@1 $Heap@0)
      (> from 0)
   )
anon2
...
(assert (! (=> anon7_Then (and true 
   (and true
      $@condition_$0
      (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 this Npr (AddMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 this Npr) to)))
      (= $Heap@3 $Heap@2)
      (> to 0)
   )
anon4
...
(assert (! (=> anon4@1 (and true 
   (and true
      (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 this Ncpr (Max (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 this Ndpr) (MaxMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 this Npr)))))
...
(assert (! (=> anon8_Else (and true 
   (and true
      (= $@condition_$1 (and (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb) null)) (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr) oldPriority@0))))
      (= $Heap@6 $Heap@4)
      (not $@condition_$1)
      (not (and (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb) null)) (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr) oldPriority@0))))
   )
...
(assert (! (=> anon8_Then (and true 
   (and true
      ...
      (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr) oldPriority@0))
      (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb) null))
   )
...
(or anon8_Then@2_assertion anon8_Then@3)
)) :named ax_anon8_Then@2))
(assert (! (=> anon8_Then@2_assertion (not (and true
   (and true
      (not (= oldPriority@0 call2formal@to@0))
   )
))) :named ax_anon8_Then@2_assertion))
(assert (! (=> anon8_Then@3 (and true 
   (and true
      (not (= oldPriority@0 call2formal@to@0))
   )
(or anon8_Then@3_assertion anon8_Then@4)
)) :named ax_anon8_Then@3))
(assert (! (=> anon8_Then@3_assertion (not (and true
   (and true
      (not (= call0formal@this@0 null))
   )
))) :named ax_anon8_Then@3_assertion))
(assert (! (=> anon8_Then@4 (and true 
   (and true
      (not (= call0formal@this@0 null))
   )
(or anon8_Then@4_assertion anon8_Then@5)
)) :named ax_anon8_Then@4))
...
(assert (! (=> anon8_Then@7 (and true 
   (and true
      ...
      (forall( (|o_$77_$0| ref) (|f_$3_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 |o_$77_$0| |f_$3_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$77_$0| |f_$3_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$0|) (or false false))))
      (forall( (|o_$77_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 |o_$77_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 |o_$77_$1| |f_$3_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$1|) (or false false))))
      (forall( (|o_$77_$2| ref) (|f_$3_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@5 |o_$77_$2| |f_$3_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@4 |o_$77_$2| |f_$3_$2|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$2|) (or (= |f_$3_$2| Npr) false))))
      (forall( (|o_$77_$3| ref) (|f_$3_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@5 |o_$77_$3| |f_$3_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 |o_$77_$3| |f_$3_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$3|) (or false (= |f_$3_$3| Ncpr)))))
      (forall( (|o_$77_$4| ref) (|f_$3_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@5 |o_$77_$4| |f_$3_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@4 |o_$77_$4| |f_$3_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$4|) (or false false))))
      (InvStruct $Heap@5)
   )
GeneratedUnifiedExit
...
(assert (=> false (not (and
   ...
   anon8_Then@2_assertion
   anon8_Then@3_assertion
