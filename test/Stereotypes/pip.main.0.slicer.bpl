...
PreconditionGeneratedEntry:
	assume !(r1 == null);
	assume IsNotAllocated($Heap,r1);
	assume !(r2 == null);
	assume IsNotAllocated($Heap,r2);
	assume !(p1 == null);
	assume IsNotAllocated($Heap,p1);
	assume !(p2 == null);
	assume IsNotAllocated($Heap,p2);
	assume InvStructEx($Heap,AddEl(AddEl(AddEl(Singleton(r1),r2),p1),p2));
	goto anon0;
anon0:
	assert  !(r1 == null);
	assert  IsNotAllocated($Heap,r1);
	assert  !(r2 == null);
	assert  IsNotAllocated($Heap,r2);
	assert  !(p1 == null);
	assert  IsNotAllocated($Heap,p1);
	assert  !(p2 == null);
	assert  IsNotAllocated($Heap,p2);
	assert  InvStructEx($Heap,AddEl(AddEl(AddEl(Singleton(r1),r2),p1),p2));
	assume InvStruct($Heap_$_0);
	assume InvPr($Heap_$_0,r1);
	assume InvPr($Heap_$_0,r2);
	assume InvPr($Heap_$_0,p1);
	assume InvPr($Heap_$_0,p2);
	assume $Heap_$_0[r1,NSt] == StF;
	assume $Heap_$_0[r2,NSt] == StF;
	assume $Heap_$_0[p1,NSt] == StF;
	assume $Heap_$_0[p2,NSt] == StF;
	assert  !(p1 == r2);
	assert  !(p1 == null);
	assert  !(r2 == null);
	assert  $Heap_$_0[p1,NSt] == StF;
	assert  InvStruct($Heap_$_0);
	assert  InvPr($Heap_$_0,p1);
	assert  (forall  o_$74 : ref :: ( NACCoSet($Heap_$_0,r2)[o_$74] ==> InvPr($Heap_$_0,o_$74) ));
	assume InvStruct($Heap_$_1);
	assume InvPr($Heap_$_1,p1);
	assume (forall  o_$75 : ref :: ( NACCoSet($Heap_$_1,r2)[o_$75] ==> InvPr($Heap_$_1,o_$75) ));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ($Heap_$_1[p1,NSt] == StF);
	assume ($Heap_$_0[r2,NSt] == StF) ==> ($Heap_$_1[r2,NSt] == StL);
	assume ($Heap_$_0[r2,NSt] == StF) ==> ((forall<a> o_$76 : ref, f_$3 : field (a)  :: ( (((((((($Heap_$_1[o_$76,f_$3] == $Heap_$_0[o_$76,f_$3]) || (NACCoSet($Heap_$_0,p1)[o_$76] && ((f_$3 == Npr) || (f_$3 == Ncpr)))) || ((o_$76 == r2) && (f_$3 == Np))) || (AddEl($Heap_$_0[r2,ND],r2)[o_$76] && (f_$3 == Nt))) || ((o_$76 == p1) && (f_$3 == NC))) || (AddEl($Heap_$_0[p1,NA],p1)[o_$76] && (f_$3 == ND))) || (AddEl($Heap_$_0[r2,ND],r2)[o_$76] && (f_$3 == NA))) || ((o_$76 == r2) && (f_$3 == Nbb))) || ((o_$76 == r2) && (f_$3 == NSt)) )));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ((forall  o_$77 : ref :: ( (!(o_$77 == p1)) ==> Equal(BBSet($Heap_$_1,o_$77),BBSet($Heap_$_0,o_$77)) )));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ($Heap_$_1[r2,Np] == p1);
	assume ($Heap_$_0[r2,NSt] == StF) ==> ((forall  o_$78 : ref :: ( AddEl($Heap_$_1[r2,ND],r2)[o_$78] ==> ($Heap_$_1[o_$78,Nt] == $Heap_$_0[p1,Nt]) )));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ($Heap_$_1[p1,NC] == AddEl($Heap_$_0[p1,NC],r2));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ((forall  o_$79 : ref :: ( AddEl($Heap_$_1[p1,NA],p1)[o_$79] ==> ($Heap_$_1[o_$79,ND] == Union($Heap_$_0[o_$79,ND],AddEl($Heap_$_1[r2,ND],r2))) )));
	assume ($Heap_$_0[r2,NSt] == StF) ==> ((forall  o_$80 : ref :: ( AddEl($Heap_$_0[r2,ND],r2)[o_$80] ==> ($Heap_$_1[o_$80,NA] == Union($Heap_$_0[o_$80,NA],AddEl($Heap_$_1[p1,NA],p1))) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && (!$Heap_$_0[p1,ND][r2])) ==> ($Heap_$_1[p1,NSt] == StL);
	assume ((!($Heap_$_0[r2,NSt] == StF)) && (!$Heap_$_0[p1,ND][r2])) ==> ($Heap_$_1[r2,NSt] == $Heap_$_0[r2,NSt]);
	assume ((!($Heap_$_0[r2,NSt] == StF)) && (!$Heap_$_0[p1,ND][r2])) ==> ((forall<a> o_$81 : ref, f_$4 : field (a)  :: ( (((((((($Heap_$_1[o_$81,f_$4] == $Heap_$_0[o_$81,f_$4]) || (NACCoSet($Heap_$_0,r2)[o_$81] && ((f_$4 == Npr) || (f_$4 == Ncpr)))) || ((o_$81 == p1) && (f_$4 == Np))) || (AddEl($Heap_$_0[p1,ND],p1)[o_$81] && (f_$4 == Nt))) || ((o_$81 == r2) && (f_$4 == NC))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$81] && (f_$4 == ND))) || (AddEl($Heap_$_0[p1,ND],p1)[o_$81] && (f_$4 == NA))) || ((o_$81 == p1) && (f_$4 == Nbb))) || ((o_$81 == p1) && (f_$4 == NSt)) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && (!$Heap_$_0[p1,ND][r2])) ==> ((forall  o_$82 : ref :: ( (!(o_$82 == r2)) ==> Equal(BBSet($Heap_$_1,o_$82),BBSet($Heap_$_0,o_$82)) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> InvStruct($Heap_$_1);
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$83 : ref :: {AddEl($Heap_$_1[r2,NA],r2)[o_$83]} ( AddEl($Heap_$_1[r2,NA],r2)[o_$83] ==> ($Heap_$_1[o_$83,NSt] == StD) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall<a> o_$84 : ref, f_$5 : field (a)  :: ( ((((((((((((($Heap_$_1[o_$84,f_$5] == $Heap_$_0[o_$84,f_$5]) || (NACCoSet($Heap_$_0,r2)[o_$84] && ((f_$5 == Npr) || (f_$5 == Ncpr)))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == LL))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == Lb))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == Le))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == Lp))) || (AddEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == Ln))) || (RemEl(AddEl($Heap_$_0[r2,NA],r2),p1)[o_$84] && (f_$5 == Np))) || (AddEl($Heap_$_0[$Heap_$_1[p1,Lp],ND],$Heap_$_1[p1,Lp])[o_$84] && (f_$5 == Nt))) || (RemEl(AddEl($Heap_$_0[r2,NA],p1),r2)[o_$84] && (f_$5 == NC))) || (RemEl($Heap_$_0[r2,NA],r2)[o_$84] && (f_$5 == ND))) || (AddEl($Heap_$_0[$Heap_$_1[p1,Lp],ND],$Heap_$_1[p1,Lp])[o_$84] && (f_$5 == NA))) || ((o_$84 == p1) && (f_$5 == Nbb))) || ($Heap_$_1[p1,LL][o_$84] && (f_$5 == NSt)) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$85 : ref :: ( (!(o_$85 == r2)) ==> Equal(BBSet($Heap_$_1,o_$85),BBSet($Heap_$_0,o_$85)) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ($Heap_$_1[p1,Ln] == null);
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$86 : ref :: ( AddEl($Heap_$_0[r2,NA],r2)[o_$86] ==> Equal($Heap_$_1[o_$86,LL],AddEl($Heap_$_0[r2,NA],r2)) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$87 : ref :: ( AddEl($Heap_$_0[r2,NA],r2)[o_$87] ==> ($Heap_$_1[o_$87,Lb] == r2) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$88 : ref :: ( AddEl($Heap_$_0[r2,NA],r2)[o_$88] ==> ($Heap_$_1[o_$88,Le] == p1) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$89 : ref :: ( RemEl(AddEl($Heap_$_0[r2,NA],r2),p1)[o_$89] ==> ($Heap_$_0[o_$89,Np] == $Heap_$_1[o_$89,Ln]) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$90 : ref :: ( AddEl($Heap_$_0[r2,NA],r2)[o_$90] ==> ($Heap_$_1[o_$90,Np] == null) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$91 : ref :: ( RemEl(AddEl($Heap_$_0[r2,NA],p1),r2)[o_$91] ==> ($Heap_$_1[o_$91,NC] == RemEl($Heap_$_0[o_$91,NC],$Heap_$_1[o_$91,Lp])) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$92 : ref :: ( RemEl(AddEl($Heap_$_0[r2,NA],p1),r2)[o_$92] ==> ($Heap_$_1[o_$92,ND] == Minus($Heap_$_0[o_$92,ND],AddEl($Heap_$_0[$Heap_$_1[o_$92,Lp],ND],$Heap_$_1[o_$92,Lp]))) )));
	assume ((!($Heap_$_0[r2,NSt] == StF)) && $Heap_$_0[p1,ND][r2]) ==> ((forall  o_$93 : ref :: ( AddEl($Heap_$_0[r2,NA],r2)[o_$93] ==> Equal($Heap_$_1[o_$93,NA],Empty) )));
	assert  $Heap_$_1[p1,NC][r2];
	assert  !(p1 == r1);
	assert  !(p1 == null);
	assert  !(r1 == null);
	assert  $Heap_$_1[p1,NSt] == StF;
	assert  InvStruct($Heap_$_1);
	assert  InvPr($Heap_$_1,p1);
	assert  (forall  o_$94 : ref :: ( NACCoSet($Heap_$_1,r1)[o_$94] ==> InvPr($Heap_$_1,o_$94) ));
	assume InvStruct($Heap_$_2);
	assume InvPr($Heap_$_2,p1);
	assume (forall  o_$95 : ref :: ( NACCoSet($Heap_$_2,r1)[o_$95] ==> InvPr($Heap_$_2,o_$95) ));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ($Heap_$_2[p1,NSt] == StF);
	assume ($Heap_$_1[r1,NSt] == StF) ==> ($Heap_$_2[r1,NSt] == StL);
	assume ($Heap_$_1[r1,NSt] == StF) ==> ((forall<a> o_$96 : ref, f_$6 : field (a)  :: ( (((((((($Heap_$_2[o_$96,f_$6] == $Heap_$_1[o_$96,f_$6]) || (NACCoSet($Heap_$_1,p1)[o_$96] && ((f_$6 == Npr) || (f_$6 == Ncpr)))) || ((o_$96 == r1) && (f_$6 == Np))) || (AddEl($Heap_$_1[r1,ND],r1)[o_$96] && (f_$6 == Nt))) || ((o_$96 == p1) && (f_$6 == NC))) || (AddEl($Heap_$_1[p1,NA],p1)[o_$96] && (f_$6 == ND))) || (AddEl($Heap_$_1[r1,ND],r1)[o_$96] && (f_$6 == NA))) || ((o_$96 == r1) && (f_$6 == Nbb))) || ((o_$96 == r1) && (f_$6 == NSt)) )));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ((forall  o_$97 : ref :: ( (!(o_$97 == p1)) ==> Equal(BBSet($Heap_$_2,o_$97),BBSet($Heap_$_1,o_$97)) )));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ($Heap_$_2[r1,Np] == p1);
	assume ($Heap_$_1[r1,NSt] == StF) ==> ((forall  o_$98 : ref :: ( AddEl($Heap_$_2[r1,ND],r1)[o_$98] ==> ($Heap_$_2[o_$98,Nt] == $Heap_$_1[p1,Nt]) )));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ($Heap_$_2[p1,NC] == AddEl($Heap_$_1[p1,NC],r1));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ((forall  o_$99 : ref :: ( AddEl($Heap_$_2[p1,NA],p1)[o_$99] ==> ($Heap_$_2[o_$99,ND] == Union($Heap_$_1[o_$99,ND],AddEl($Heap_$_2[r1,ND],r1))) )));
	assume ($Heap_$_1[r1,NSt] == StF) ==> ((forall  o_$100 : ref :: ( AddEl($Heap_$_1[r1,ND],r1)[o_$100] ==> ($Heap_$_2[o_$100,NA] == Union($Heap_$_1[o_$100,NA],AddEl($Heap_$_2[p1,NA],p1))) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && (!$Heap_$_1[p1,ND][r1])) ==> ($Heap_$_2[p1,NSt] == StL);
	assume ((!($Heap_$_1[r1,NSt] == StF)) && (!$Heap_$_1[p1,ND][r1])) ==> ($Heap_$_2[r1,NSt] == $Heap_$_1[r1,NSt]);
	assume ((!($Heap_$_1[r1,NSt] == StF)) && (!$Heap_$_1[p1,ND][r1])) ==> ((forall<a> o_$101 : ref, f_$7 : field (a)  :: ( (((((((($Heap_$_2[o_$101,f_$7] == $Heap_$_1[o_$101,f_$7]) || (NACCoSet($Heap_$_1,r1)[o_$101] && ((f_$7 == Npr) || (f_$7 == Ncpr)))) || ((o_$101 == p1) && (f_$7 == Np))) || (AddEl($Heap_$_1[p1,ND],p1)[o_$101] && (f_$7 == Nt))) || ((o_$101 == r1) && (f_$7 == NC))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$101] && (f_$7 == ND))) || (AddEl($Heap_$_1[p1,ND],p1)[o_$101] && (f_$7 == NA))) || ((o_$101 == p1) && (f_$7 == Nbb))) || ((o_$101 == p1) && (f_$7 == NSt)) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && (!$Heap_$_1[p1,ND][r1])) ==> ((forall  o_$102 : ref :: ( (!(o_$102 == r1)) ==> Equal(BBSet($Heap_$_2,o_$102),BBSet($Heap_$_1,o_$102)) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> InvStruct($Heap_$_2);
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$103 : ref :: {AddEl($Heap_$_2[r1,NA],r1)[o_$103]} ( AddEl($Heap_$_2[r1,NA],r1)[o_$103] ==> ($Heap_$_2[o_$103,NSt] == StD) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall<a> o_$104 : ref, f_$8 : field (a)  :: ( ((((((((((((($Heap_$_2[o_$104,f_$8] == $Heap_$_1[o_$104,f_$8]) || (NACCoSet($Heap_$_1,r1)[o_$104] && ((f_$8 == Npr) || (f_$8 == Ncpr)))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == LL))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == Lb))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == Le))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == Lp))) || (AddEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == Ln))) || (RemEl(AddEl($Heap_$_1[r1,NA],r1),p1)[o_$104] && (f_$8 == Np))) || (AddEl($Heap_$_1[$Heap_$_2[p1,Lp],ND],$Heap_$_2[p1,Lp])[o_$104] && (f_$8 == Nt))) || (RemEl(AddEl($Heap_$_1[r1,NA],p1),r1)[o_$104] && (f_$8 == NC))) || (RemEl($Heap_$_1[r1,NA],r1)[o_$104] && (f_$8 == ND))) || (AddEl($Heap_$_1[$Heap_$_2[p1,Lp],ND],$Heap_$_2[p1,Lp])[o_$104] && (f_$8 == NA))) || ((o_$104 == p1) && (f_$8 == Nbb))) || ($Heap_$_2[p1,LL][o_$104] && (f_$8 == NSt)) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$105 : ref :: ( (!(o_$105 == r1)) ==> Equal(BBSet($Heap_$_2,o_$105),BBSet($Heap_$_1,o_$105)) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ($Heap_$_2[p1,Ln] == null);
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$106 : ref :: ( AddEl($Heap_$_1[r1,NA],r1)[o_$106] ==> Equal($Heap_$_2[o_$106,LL],AddEl($Heap_$_1[r1,NA],r1)) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$107 : ref :: ( AddEl($Heap_$_1[r1,NA],r1)[o_$107] ==> ($Heap_$_2[o_$107,Lb] == r1) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$108 : ref :: ( AddEl($Heap_$_1[r1,NA],r1)[o_$108] ==> ($Heap_$_2[o_$108,Le] == p1) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$109 : ref :: ( RemEl(AddEl($Heap_$_1[r1,NA],r1),p1)[o_$109] ==> ($Heap_$_1[o_$109,Np] == $Heap_$_2[o_$109,Ln]) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$110 : ref :: ( AddEl($Heap_$_1[r1,NA],r1)[o_$110] ==> ($Heap_$_2[o_$110,Np] == null) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$111 : ref :: ( RemEl(AddEl($Heap_$_1[r1,NA],p1),r1)[o_$111] ==> ($Heap_$_2[o_$111,NC] == RemEl($Heap_$_1[o_$111,NC],$Heap_$_2[o_$111,Lp])) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$112 : ref :: ( RemEl(AddEl($Heap_$_1[r1,NA],p1),r1)[o_$112] ==> ($Heap_$_2[o_$112,ND] == Minus($Heap_$_1[o_$112,ND],AddEl($Heap_$_1[$Heap_$_2[o_$112,Lp],ND],$Heap_$_2[o_$112,Lp]))) )));
	assume ((!($Heap_$_1[r1,NSt] == StF)) && $Heap_$_1[p1,ND][r1]) ==> ((forall  o_$113 : ref :: ( AddEl($Heap_$_1[r1,NA],r1)[o_$113] ==> Equal($Heap_$_2[o_$113,NA],Empty) )));
	assert  InvStruct($Heap_$_2);
	assert  InvPr($Heap_$_2,r1);
	assert  InvPr($Heap_$_2,r2);
	assert  InvPr($Heap_$_2,p1);
	assert  InvPr($Heap_$_2,p2);
	assert  $Heap_$_2[r1,NSt] == StL;
	assert  $Heap_$_2[r2,NSt] == StL;
	assert  $Heap_$_2[p1,NSt] == StF;
	assert  $Heap_$_2[p2,NSt] == StF;
	assert  $Heap_$_2[p1,NC][r1];
	assert  $Heap_$_2[p1,NC][r2];
	assert  !(p1 == r2);
	assert  !(p1 == null);
	assert  !(r2 == null);
	assert  $Heap_$_2[p1,NC][r2];
	...
	assert  InvStruct($Heap_$_2);
	assert  InvPr($Heap_$_2,r2);
	assert  (forall  o_$114 : ref :: ( NACCoSet($Heap_$_2,p1)[o_$114] ==> InvPr($Heap_$_2,o_$114) ));
	assume $Heap_$_3[r2,Np] == null;
	assume InvStruct($Heap_$_3);
	assume $Heap_$_3[p1,NSt] == StF;
	assume $Heap_$_3[r2,NSt] == StF;
	assume (forall  o_$115 : ref :: ( NACCoSet($Heap_$_2,p1)[o_$115] ==> InvPr($Heap_$_3,o_$115) ));
	assume InvPr($Heap_$_3,r2);
	assume (forall<a> o_$116 : ref, f_$9 : field (a)  :: ( (((((((($Heap_$_3[o_$116,f_$9] == $Heap_$_2[o_$116,f_$9]) || (NACCoSet($Heap_$_2,p1)[o_$116] && ((f_$9 == Npr) || (f_$9 == Ncpr)))) || ((o_$116 == r2) && (f_$9 == Np))) || (AddEl($Heap_$_2[r2,ND],r2)[o_$116] && (f_$9 == Nt))) || ((o_$116 == p1) && (f_$9 == NC))) || (AddEl($Heap_$_2[p1,NA],p1)[o_$116] && (f_$9 == ND))) || (AddEl($Heap_$_2[r2,ND],r2)[o_$116] && (f_$9 == NA))) || ((o_$116 == r2) && (f_$9 == Nbb))) || ((o_$116 == r2) && (f_$9 == NSt)) ));
	assume (forall  o_$117 : ref :: ( (!(o_$117 == p1)) ==> Equal(BBSet($Heap_$_3,o_$117),BBSet($Heap_$_2,o_$117)) ));
	assert  InvStruct($Heap_$_3);
	assert  InvPr($Heap_$_3,r1);
	assert  InvPr($Heap_$_3,r2);
	assert  InvPr($Heap_$_3,p1);
	assert  InvPr($Heap_$_3,p2);
	assert  $Heap_$_3[r1,NSt] == StL;
	assert  $Heap_$_3[r2,NSt] == StF;
	assert  $Heap_$_3[p1,NSt] == StF;
	assert  $Heap_$_3[p2,NSt] == StF;
	assert  $Heap_$_3[p1,NC][r1];
	assert  !$Heap_$_3[p1,NC][r2];
	assert  !(p2 == r2);
	assert  !(p2 == null);
	assert  !(r2 == null);
	assert  $Heap_$_3[p2,NSt] == StF;
	assert  InvStruct($Heap_$_3);
	assert  InvPr($Heap_$_3,p2);
	assert  (forall  o_$118 : ref :: ( NACCoSet($Heap_$_3,r2)[o_$118] ==> InvPr($Heap_$_3,o_$118) ));
	assume InvStruct($Heap_$_4);
	assume InvPr($Heap_$_4,p2);
	assume (forall  o_$119 : ref :: ( NACCoSet($Heap_$_4,r2)[o_$119] ==> InvPr($Heap_$_4,o_$119) ));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ($Heap_$_4[p2,NSt] == StF);
	assume ($Heap_$_3[r2,NSt] == StF) ==> ($Heap_$_4[r2,NSt] == StL);
	assume ($Heap_$_3[r2,NSt] == StF) ==> ((forall<a> o_$120 : ref, f_$10 : field (a)  :: ( (((((((($Heap_$_4[o_$120,f_$10] == $Heap_$_3[o_$120,f_$10]) || (NACCoSet($Heap_$_3,p2)[o_$120] && ((f_$10 == Npr) || (f_$10 == Ncpr)))) || ((o_$120 == r2) && (f_$10 == Np))) || (AddEl($Heap_$_3[r2,ND],r2)[o_$120] && (f_$10 == Nt))) || ((o_$120 == p2) && (f_$10 == NC))) || (AddEl($Heap_$_3[p2,NA],p2)[o_$120] && (f_$10 == ND))) || (AddEl($Heap_$_3[r2,ND],r2)[o_$120] && (f_$10 == NA))) || ((o_$120 == r2) && (f_$10 == Nbb))) || ((o_$120 == r2) && (f_$10 == NSt)) )));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ((forall  o_$121 : ref :: ( (!(o_$121 == p2)) ==> Equal(BBSet($Heap_$_4,o_$121),BBSet($Heap_$_3,o_$121)) )));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ($Heap_$_4[r2,Np] == p2);
	assume ($Heap_$_3[r2,NSt] == StF) ==> ((forall  o_$122 : ref :: ( AddEl($Heap_$_4[r2,ND],r2)[o_$122] ==> ($Heap_$_4[o_$122,Nt] == $Heap_$_3[p2,Nt]) )));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ($Heap_$_4[p2,NC] == AddEl($Heap_$_3[p2,NC],r2));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ((forall  o_$123 : ref :: ( AddEl($Heap_$_4[p2,NA],p2)[o_$123] ==> ($Heap_$_4[o_$123,ND] == Union($Heap_$_3[o_$123,ND],AddEl($Heap_$_4[r2,ND],r2))) )));
	assume ($Heap_$_3[r2,NSt] == StF) ==> ((forall  o_$124 : ref :: ( AddEl($Heap_$_3[r2,ND],r2)[o_$124] ==> ($Heap_$_4[o_$124,NA] == Union($Heap_$_3[o_$124,NA],AddEl($Heap_$_4[p2,NA],p2))) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && (!$Heap_$_3[p2,ND][r2])) ==> ($Heap_$_4[p2,NSt] == StL);
	assume ((!($Heap_$_3[r2,NSt] == StF)) && (!$Heap_$_3[p2,ND][r2])) ==> ($Heap_$_4[r2,NSt] == $Heap_$_3[r2,NSt]);
	assume ((!($Heap_$_3[r2,NSt] == StF)) && (!$Heap_$_3[p2,ND][r2])) ==> ((forall<a> o_$125 : ref, f_$11 : field (a)  :: ( (((((((($Heap_$_4[o_$125,f_$11] == $Heap_$_3[o_$125,f_$11]) || (NACCoSet($Heap_$_3,r2)[o_$125] && ((f_$11 == Npr) || (f_$11 == Ncpr)))) || ((o_$125 == p2) && (f_$11 == Np))) || (AddEl($Heap_$_3[p2,ND],p2)[o_$125] && (f_$11 == Nt))) || ((o_$125 == r2) && (f_$11 == NC))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$125] && (f_$11 == ND))) || (AddEl($Heap_$_3[p2,ND],p2)[o_$125] && (f_$11 == NA))) || ((o_$125 == p2) && (f_$11 == Nbb))) || ((o_$125 == p2) && (f_$11 == NSt)) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && (!$Heap_$_3[p2,ND][r2])) ==> ((forall  o_$126 : ref :: ( (!(o_$126 == r2)) ==> Equal(BBSet($Heap_$_4,o_$126),BBSet($Heap_$_3,o_$126)) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> InvStruct($Heap_$_4);
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$127 : ref :: {AddEl($Heap_$_4[r2,NA],r2)[o_$127]} ( AddEl($Heap_$_4[r2,NA],r2)[o_$127] ==> ($Heap_$_4[o_$127,NSt] == StD) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall<a> o_$128 : ref, f_$12 : field (a)  :: ( ((((((((((((($Heap_$_4[o_$128,f_$12] == $Heap_$_3[o_$128,f_$12]) || (NACCoSet($Heap_$_3,r2)[o_$128] && ((f_$12 == Npr) || (f_$12 == Ncpr)))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == LL))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == Lb))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == Le))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == Lp))) || (AddEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == Ln))) || (RemEl(AddEl($Heap_$_3[r2,NA],r2),p2)[o_$128] && (f_$12 == Np))) || (AddEl($Heap_$_3[$Heap_$_4[p2,Lp],ND],$Heap_$_4[p2,Lp])[o_$128] && (f_$12 == Nt))) || (RemEl(AddEl($Heap_$_3[r2,NA],p2),r2)[o_$128] && (f_$12 == NC))) || (RemEl($Heap_$_3[r2,NA],r2)[o_$128] && (f_$12 == ND))) || (AddEl($Heap_$_3[$Heap_$_4[p2,Lp],ND],$Heap_$_4[p2,Lp])[o_$128] && (f_$12 == NA))) || ((o_$128 == p2) && (f_$12 == Nbb))) || ($Heap_$_4[p2,LL][o_$128] && (f_$12 == NSt)) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$129 : ref :: ( (!(o_$129 == r2)) ==> Equal(BBSet($Heap_$_4,o_$129),BBSet($Heap_$_3,o_$129)) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ($Heap_$_4[p2,Ln] == null);
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$130 : ref :: ( AddEl($Heap_$_3[r2,NA],r2)[o_$130] ==> Equal($Heap_$_4[o_$130,LL],AddEl($Heap_$_3[r2,NA],r2)) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$131 : ref :: ( AddEl($Heap_$_3[r2,NA],r2)[o_$131] ==> ($Heap_$_4[o_$131,Lb] == r2) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$132 : ref :: ( AddEl($Heap_$_3[r2,NA],r2)[o_$132] ==> ($Heap_$_4[o_$132,Le] == p2) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$133 : ref :: ( RemEl(AddEl($Heap_$_3[r2,NA],r2),p2)[o_$133] ==> ($Heap_$_3[o_$133,Np] == $Heap_$_4[o_$133,Ln]) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$134 : ref :: ( AddEl($Heap_$_3[r2,NA],r2)[o_$134] ==> ($Heap_$_4[o_$134,Np] == null) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$135 : ref :: ( RemEl(AddEl($Heap_$_3[r2,NA],p2),r2)[o_$135] ==> ($Heap_$_4[o_$135,NC] == RemEl($Heap_$_3[o_$135,NC],$Heap_$_4[o_$135,Lp])) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$136 : ref :: ( RemEl(AddEl($Heap_$_3[r2,NA],p2),r2)[o_$136] ==> ($Heap_$_4[o_$136,ND] == Minus($Heap_$_3[o_$136,ND],AddEl($Heap_$_3[$Heap_$_4[o_$136,Lp],ND],$Heap_$_4[o_$136,Lp]))) )));
	assume ((!($Heap_$_3[r2,NSt] == StF)) && $Heap_$_3[p2,ND][r2]) ==> ((forall  o_$137 : ref :: ( AddEl($Heap_$_3[r2,NA],r2)[o_$137] ==> Equal($Heap_$_4[o_$137,NA],Empty) )));
	assert  InvStruct($Heap_$_4);
	assert  InvPr($Heap_$_4,r1);
	assert  InvPr($Heap_$_4,r2);
	assert  InvPr($Heap_$_4,p1);
	assert  InvPr($Heap_$_4,p2);
	assert  $Heap_$_4[r1,NSt] == StL;
	assert  $Heap_$_4[r2,NSt] == StL;
	assert  $Heap_$_4[p1,NSt] == StF;
	assert  $Heap_$_4[p2,NSt] == StF;
	assert  $Heap_$_4[p1,NC][r1];
	assert  $Heap_$_4[p2,NC][r2];
	assert  !(p1 == r2);
	assert  !(p1 == null);
	assert  !(r2 == null);
	assert  $Heap_$_4[p1,NSt] == StF;
	assert  InvStruct($Heap_$_4);
	assert  InvPr($Heap_$_4,p1);
	assert  (forall  o_$138 : ref :: ( NACCoSet($Heap_$_4,r2)[o_$138] ==> InvPr($Heap_$_4,o_$138) ));
	assume InvStruct($Heap_$_5);
	assume InvPr($Heap_$_5,p1);
	assume (forall  o_$139 : ref :: ( NACCoSet($Heap_$_5,r2)[o_$139] ==> InvPr($Heap_$_5,o_$139) ));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ($Heap_$_5[p1,NSt] == StF);
	assume ($Heap_$_4[r2,NSt] == StF) ==> ($Heap_$_5[r2,NSt] == StL);
	assume ($Heap_$_4[r2,NSt] == StF) ==> ((forall<a> o_$140 : ref, f_$13 : field (a)  :: ( (((((((($Heap_$_5[o_$140,f_$13] == $Heap_$_4[o_$140,f_$13]) || (NACCoSet($Heap_$_4,p1)[o_$140] && ((f_$13 == Npr) || (f_$13 == Ncpr)))) || ((o_$140 == r2) && (f_$13 == Np))) || (AddEl($Heap_$_4[r2,ND],r2)[o_$140] && (f_$13 == Nt))) || ((o_$140 == p1) && (f_$13 == NC))) || (AddEl($Heap_$_4[p1,NA],p1)[o_$140] && (f_$13 == ND))) || (AddEl($Heap_$_4[r2,ND],r2)[o_$140] && (f_$13 == NA))) || ((o_$140 == r2) && (f_$13 == Nbb))) || ((o_$140 == r2) && (f_$13 == NSt)) )));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ((forall  o_$141 : ref :: ( (!(o_$141 == p1)) ==> Equal(BBSet($Heap_$_5,o_$141),BBSet($Heap_$_4,o_$141)) )));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ($Heap_$_5[r2,Np] == p1);
	assume ($Heap_$_4[r2,NSt] == StF) ==> ((forall  o_$142 : ref :: ( AddEl($Heap_$_5[r2,ND],r2)[o_$142] ==> ($Heap_$_5[o_$142,Nt] == $Heap_$_4[p1,Nt]) )));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ($Heap_$_5[p1,NC] == AddEl($Heap_$_4[p1,NC],r2));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ((forall  o_$143 : ref :: ( AddEl($Heap_$_5[p1,NA],p1)[o_$143] ==> ($Heap_$_5[o_$143,ND] == Union($Heap_$_4[o_$143,ND],AddEl($Heap_$_5[r2,ND],r2))) )));
	assume ($Heap_$_4[r2,NSt] == StF) ==> ((forall  o_$144 : ref :: ( AddEl($Heap_$_4[r2,ND],r2)[o_$144] ==> ($Heap_$_5[o_$144,NA] == Union($Heap_$_4[o_$144,NA],AddEl($Heap_$_5[p1,NA],p1))) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && (!$Heap_$_4[p1,ND][r2])) ==> ($Heap_$_5[p1,NSt] == StL);
	assume ((!($Heap_$_4[r2,NSt] == StF)) && (!$Heap_$_4[p1,ND][r2])) ==> ($Heap_$_5[r2,NSt] == $Heap_$_4[r2,NSt]);
	assume ((!($Heap_$_4[r2,NSt] == StF)) && (!$Heap_$_4[p1,ND][r2])) ==> ((forall<a> o_$145 : ref, f_$14 : field (a)  :: ( (((((((($Heap_$_5[o_$145,f_$14] == $Heap_$_4[o_$145,f_$14]) || (NACCoSet($Heap_$_4,r2)[o_$145] && ((f_$14 == Npr) || (f_$14 == Ncpr)))) || ((o_$145 == p1) && (f_$14 == Np))) || (AddEl($Heap_$_4[p1,ND],p1)[o_$145] && (f_$14 == Nt))) || ((o_$145 == r2) && (f_$14 == NC))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$145] && (f_$14 == ND))) || (AddEl($Heap_$_4[p1,ND],p1)[o_$145] && (f_$14 == NA))) || ((o_$145 == p1) && (f_$14 == Nbb))) || ((o_$145 == p1) && (f_$14 == NSt)) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && (!$Heap_$_4[p1,ND][r2])) ==> ((forall  o_$146 : ref :: ( (!(o_$146 == r2)) ==> Equal(BBSet($Heap_$_5,o_$146),BBSet($Heap_$_4,o_$146)) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> InvStruct($Heap_$_5);
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$147 : ref :: {AddEl($Heap_$_5[r2,NA],r2)[o_$147]} ( AddEl($Heap_$_5[r2,NA],r2)[o_$147] ==> ($Heap_$_5[o_$147,NSt] == StD) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall<a> o_$148 : ref, f_$15 : field (a)  :: ( ((((((((((((($Heap_$_5[o_$148,f_$15] == $Heap_$_4[o_$148,f_$15]) || (NACCoSet($Heap_$_4,r2)[o_$148] && ((f_$15 == Npr) || (f_$15 == Ncpr)))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == LL))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == Lb))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == Le))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == Lp))) || (AddEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == Ln))) || (RemEl(AddEl($Heap_$_4[r2,NA],r2),p1)[o_$148] && (f_$15 == Np))) || (AddEl($Heap_$_4[$Heap_$_5[p1,Lp],ND],$Heap_$_5[p1,Lp])[o_$148] && (f_$15 == Nt))) || (RemEl(AddEl($Heap_$_4[r2,NA],p1),r2)[o_$148] && (f_$15 == NC))) || (RemEl($Heap_$_4[r2,NA],r2)[o_$148] && (f_$15 == ND))) || (AddEl($Heap_$_4[$Heap_$_5[p1,Lp],ND],$Heap_$_5[p1,Lp])[o_$148] && (f_$15 == NA))) || ((o_$148 == p1) && (f_$15 == Nbb))) || ($Heap_$_5[p1,LL][o_$148] && (f_$15 == NSt)) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$149 : ref :: ( (!(o_$149 == r2)) ==> Equal(BBSet($Heap_$_5,o_$149),BBSet($Heap_$_4,o_$149)) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ($Heap_$_5[p1,Ln] == null);
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$150 : ref :: ( AddEl($Heap_$_4[r2,NA],r2)[o_$150] ==> Equal($Heap_$_5[o_$150,LL],AddEl($Heap_$_4[r2,NA],r2)) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$151 : ref :: ( AddEl($Heap_$_4[r2,NA],r2)[o_$151] ==> ($Heap_$_5[o_$151,Lb] == r2) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$152 : ref :: ( AddEl($Heap_$_4[r2,NA],r2)[o_$152] ==> ($Heap_$_5[o_$152,Le] == p1) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$153 : ref :: ( RemEl(AddEl($Heap_$_4[r2,NA],r2),p1)[o_$153] ==> ($Heap_$_4[o_$153,Np] == $Heap_$_5[o_$153,Ln]) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$154 : ref :: ( AddEl($Heap_$_4[r2,NA],r2)[o_$154] ==> ($Heap_$_5[o_$154,Np] == null) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$155 : ref :: ( RemEl(AddEl($Heap_$_4[r2,NA],p1),r2)[o_$155] ==> ($Heap_$_5[o_$155,NC] == RemEl($Heap_$_4[o_$155,NC],$Heap_$_5[o_$155,Lp])) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$156 : ref :: ( RemEl(AddEl($Heap_$_4[r2,NA],p1),r2)[o_$156] ==> ($Heap_$_5[o_$156,ND] == Minus($Heap_$_4[o_$156,ND],AddEl($Heap_$_4[$Heap_$_5[o_$156,Lp],ND],$Heap_$_5[o_$156,Lp]))) )));
	assume ((!($Heap_$_4[r2,NSt] == StF)) && $Heap_$_4[p1,ND][r2]) ==> ((forall  o_$157 : ref :: ( AddEl($Heap_$_4[r2,NA],r2)[o_$157] ==> Equal($Heap_$_5[o_$157,NA],Empty) )));
	assert  InvStruct($Heap_$_5);
	assert  InvPr($Heap_$_5,r1);
	assert  InvPr($Heap_$_5,r2);
	assert  InvPr($Heap_$_5,p1);
	assert  InvPr($Heap_$_5,p2);
	assert  $Heap_$_5[r1,NSt] == StL;
	assert  $Heap_$_5[r2,NSt] == StL;
	assert  $Heap_$_5[p1,NSt] == StL;
	assert  $Heap_$_5[p2,NSt] == StF;
	assert  $Heap_$_5[r2,NC][p1];
	assert  $Heap_$_5[p1,NC][r1];
	assert  $Heap_$_5[p2,NC][r2];
	assert  !(p2 == r1);
	assert  !(p2 == null);
	assert  !(r1 == null);
	assert  $Heap_$_5[p2,NSt] == StF;
	assert  InvStruct($Heap_$_5);
	assert  InvPr($Heap_$_5,p2);
	assert  (forall  o_$158 : ref :: ( NACCoSet($Heap_$_5,r1)[o_$158] ==> InvPr($Heap_$_5,o_$158) ));
	assume InvStruct($Heap_$_6);
	assume InvPr($Heap_$_6,p2);
	assume (forall  o_$159 : ref :: ( NACCoSet($Heap_$_6,r1)[o_$159] ==> InvPr($Heap_$_6,o_$159) ));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ($Heap_$_6[p2,NSt] == StF);
	assume ($Heap_$_5[r1,NSt] == StF) ==> ($Heap_$_6[r1,NSt] == StL);
	assume ($Heap_$_5[r1,NSt] == StF) ==> ((forall<a> o_$160 : ref, f_$16 : field (a)  :: ( (((((((($Heap_$_6[o_$160,f_$16] == $Heap_$_5[o_$160,f_$16]) || (NACCoSet($Heap_$_5,p2)[o_$160] && ((f_$16 == Npr) || (f_$16 == Ncpr)))) || ((o_$160 == r1) && (f_$16 == Np))) || (AddEl($Heap_$_5[r1,ND],r1)[o_$160] && (f_$16 == Nt))) || ((o_$160 == p2) && (f_$16 == NC))) || (AddEl($Heap_$_5[p2,NA],p2)[o_$160] && (f_$16 == ND))) || (AddEl($Heap_$_5[r1,ND],r1)[o_$160] && (f_$16 == NA))) || ((o_$160 == r1) && (f_$16 == Nbb))) || ((o_$160 == r1) && (f_$16 == NSt)) )));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ((forall  o_$161 : ref :: ( (!(o_$161 == p2)) ==> Equal(BBSet($Heap_$_6,o_$161),BBSet($Heap_$_5,o_$161)) )));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ($Heap_$_6[r1,Np] == p2);
	assume ($Heap_$_5[r1,NSt] == StF) ==> ((forall  o_$162 : ref :: ( AddEl($Heap_$_6[r1,ND],r1)[o_$162] ==> ($Heap_$_6[o_$162,Nt] == $Heap_$_5[p2,Nt]) )));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ($Heap_$_6[p2,NC] == AddEl($Heap_$_5[p2,NC],r1));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ((forall  o_$163 : ref :: ( AddEl($Heap_$_6[p2,NA],p2)[o_$163] ==> ($Heap_$_6[o_$163,ND] == Union($Heap_$_5[o_$163,ND],AddEl($Heap_$_6[r1,ND],r1))) )));
	assume ($Heap_$_5[r1,NSt] == StF) ==> ((forall  o_$164 : ref :: ( AddEl($Heap_$_5[r1,ND],r1)[o_$164] ==> ($Heap_$_6[o_$164,NA] == Union($Heap_$_5[o_$164,NA],AddEl($Heap_$_6[p2,NA],p2))) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && (!$Heap_$_5[p2,ND][r1])) ==> ($Heap_$_6[p2,NSt] == StL);
	assume ((!($Heap_$_5[r1,NSt] == StF)) && (!$Heap_$_5[p2,ND][r1])) ==> ($Heap_$_6[r1,NSt] == $Heap_$_5[r1,NSt]);
	assume ((!($Heap_$_5[r1,NSt] == StF)) && (!$Heap_$_5[p2,ND][r1])) ==> ((forall<a> o_$165 : ref, f_$17 : field (a)  :: ( (((((((($Heap_$_6[o_$165,f_$17] == $Heap_$_5[o_$165,f_$17]) || (NACCoSet($Heap_$_5,r1)[o_$165] && ((f_$17 == Npr) || (f_$17 == Ncpr)))) || ((o_$165 == p2) && (f_$17 == Np))) || (AddEl($Heap_$_5[p2,ND],p2)[o_$165] && (f_$17 == Nt))) || ((o_$165 == r1) && (f_$17 == NC))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$165] && (f_$17 == ND))) || (AddEl($Heap_$_5[p2,ND],p2)[o_$165] && (f_$17 == NA))) || ((o_$165 == p2) && (f_$17 == Nbb))) || ((o_$165 == p2) && (f_$17 == NSt)) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && (!$Heap_$_5[p2,ND][r1])) ==> ((forall  o_$166 : ref :: ( (!(o_$166 == r1)) ==> Equal(BBSet($Heap_$_6,o_$166),BBSet($Heap_$_5,o_$166)) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> InvStruct($Heap_$_6);
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$167 : ref :: {AddEl($Heap_$_6[r1,NA],r1)[o_$167]} ( AddEl($Heap_$_6[r1,NA],r1)[o_$167] ==> ($Heap_$_6[o_$167,NSt] == StD) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall<a> o_$168 : ref, f_$18 : field (a)  :: ( ((((((((((((($Heap_$_6[o_$168,f_$18] == $Heap_$_5[o_$168,f_$18]) || (NACCoSet($Heap_$_5,r1)[o_$168] && ((f_$18 == Npr) || (f_$18 == Ncpr)))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == LL))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == Lb))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == Le))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == Lp))) || (AddEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == Ln))) || (RemEl(AddEl($Heap_$_5[r1,NA],r1),p2)[o_$168] && (f_$18 == Np))) || (AddEl($Heap_$_5[$Heap_$_6[p2,Lp],ND],$Heap_$_6[p2,Lp])[o_$168] && (f_$18 == Nt))) || (RemEl(AddEl($Heap_$_5[r1,NA],p2),r1)[o_$168] && (f_$18 == NC))) || (RemEl($Heap_$_5[r1,NA],r1)[o_$168] && (f_$18 == ND))) || (AddEl($Heap_$_5[$Heap_$_6[p2,Lp],ND],$Heap_$_6[p2,Lp])[o_$168] && (f_$18 == NA))) || ((o_$168 == p2) && (f_$18 == Nbb))) || ($Heap_$_6[p2,LL][o_$168] && (f_$18 == NSt)) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$169 : ref :: ( (!(o_$169 == r1)) ==> Equal(BBSet($Heap_$_6,o_$169),BBSet($Heap_$_5,o_$169)) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ($Heap_$_6[p2,Ln] == null);
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$170 : ref :: ( AddEl($Heap_$_5[r1,NA],r1)[o_$170] ==> Equal($Heap_$_6[o_$170,LL],AddEl($Heap_$_5[r1,NA],r1)) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$171 : ref :: ( AddEl($Heap_$_5[r1,NA],r1)[o_$171] ==> ($Heap_$_6[o_$171,Lb] == r1) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$172 : ref :: ( AddEl($Heap_$_5[r1,NA],r1)[o_$172] ==> ($Heap_$_6[o_$172,Le] == p2) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$173 : ref :: ( RemEl(AddEl($Heap_$_5[r1,NA],r1),p2)[o_$173] ==> ($Heap_$_5[o_$173,Np] == $Heap_$_6[o_$173,Ln]) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$174 : ref :: ( AddEl($Heap_$_5[r1,NA],r1)[o_$174] ==> ($Heap_$_6[o_$174,Np] == null) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$175 : ref :: ( RemEl(AddEl($Heap_$_5[r1,NA],p2),r1)[o_$175] ==> ($Heap_$_6[o_$175,NC] == RemEl($Heap_$_5[o_$175,NC],$Heap_$_6[o_$175,Lp])) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$176 : ref :: ( RemEl(AddEl($Heap_$_5[r1,NA],p2),r1)[o_$176] ==> ($Heap_$_6[o_$176,ND] == Minus($Heap_$_5[o_$176,ND],AddEl($Heap_$_5[$Heap_$_6[o_$176,Lp],ND],$Heap_$_6[o_$176,Lp]))) )));
	assume ((!($Heap_$_5[r1,NSt] == StF)) && $Heap_$_5[p2,ND][r1]) ==> ((forall  o_$177 : ref :: ( AddEl($Heap_$_5[r1,NA],r1)[o_$177] ==> Equal($Heap_$_6[o_$177,NA],Empty) )));
	assert  InvStruct($Heap_$_6);
	assert  InvPr($Heap_$_6,r1);
	assert  InvPr($Heap_$_6,r2);
	assert  InvPr($Heap_$_6,p1);
	assert  InvPr($Heap_$_6,p2);
	assert  $Heap_$_6[r1,NSt] == StD;
	assert  $Heap_$_6[r2,NSt] == StD;
	assert  $Heap_$_6[p1,NSt] == StD;
	assert  $Heap_$_6[p2,NSt] == StD;
	assert  CLp($Heap_$_6,r2) == p1;
	assert  CLp($Heap_$_6,p1) == r1;
	assert  CLp($Heap_$_6,r1) == p2;
	assert  CLp($Heap_$_6,p2) == r2;
	goto $exit;
}
