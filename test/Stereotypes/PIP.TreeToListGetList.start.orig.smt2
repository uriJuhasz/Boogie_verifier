...
(declare-fun anon4_LoopHead ( ) Bool)
(declare-fun anon5_Else ( ) Bool)
(declare-fun anon5_Then ( ) Bool)
(declare-fun anon5_Then@1 ( ) Bool)
(declare-fun anon5_Then@1_assertion ( ) Bool)
(declare-fun anon5_Then@2 ( ) Bool)
...
(declare-fun anon5_Then@4_assertion ( ) Bool)
(declare-fun anon5_Then@5 ( ) Bool)
(declare-fun anon5_Then@5_assertion ( ) Bool)
(declare-fun anon5_Then@6 ( ) Bool)
(declare-fun anon5_Then_assertion ( ) Bool)
...
(assert (! (=> anon0 (and true 
   (and true
      ...
      (= Rest@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA))
   )
...
(assert (! (=> anon4_LoopHead (and true 
   (and true
...
(or anon5_Then@1 anon5_Then_assertion)
)) :named ax_anon5_Then))
...
(assert (! (=> anon5_Then@1 (and true 
   (and true
      (not (= subTree null))
   )
(or anon5_Then@1_assertion anon5_Then@2)
)) :named ax_anon5_Then@1))
(assert (! (=> anon5_Then_assertion (not (and true
   (and true
      (not (= subTree null))
   )
))) :named ax_anon5_Then_assertion))
...
(assert (! (=> anon5_Then@1_assertion (not (and true
   (and true
      (not (= current@0 null))
   )
))) :named ax_anon5_Then@1_assertion))
(assert (! (=> anon5_Then@2 (and true 
   (and true
      (not (= current@0 null))
   )
(or anon5_Then@2_assertion anon5_Then@3)
)) :named ax_anon5_Then@2))
...
(or anon5_Then@4_assertion anon5_Then@5)
...
(assert (! (=> anon5_Then@4_assertion (not (and true
   (and true
      (InvList $Heap@0)
   )
))) :named ax_anon5_Then@4_assertion))
(assert (! (=> anon5_Then@5 (and true 
   (and true
      (InvList $Heap@0)
   )
(or anon5_Then@5_assertion anon5_Then@6)
)) :named ax_anon5_Then@5))
...
(assert (! (=> anon5_Then@5_assertion (not (and true
   (and true
      (InvTree $Heap@0)
   )
))) :named ax_anon5_Then@5_assertion))
(assert (! (=> anon5_Then@6 (and true 
   (and true
      (= $Heap@2 $Heap@1)
