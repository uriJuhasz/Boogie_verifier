...
;Axioms
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$74|) (InvPr $Heap |o_$74|))) :named ax_94))
   ...
   (assert (! (InvPr $Heap r) :named ax_106))
   (assert (! (InvStruct $Heap) :named ax_107))
   (assert (! (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this NC) r) :named ax_108))
   ...
   (assert (! (not (= Lp Lb)) :named ax_117))
   (assert (! (not (= Lp Le)) :named ax_118))
   (assert (! (not (= Lp Le)) :named ax_119))
   (assert (! (not (= Lp Ln)) :named ax_120))
   (assert (! (not (= Lp Ln)) :named ax_121))
   (assert (! (not (= NA LL)) :named ax_122))
   (assert (! (not (= NA LL)) :named ax_123))
   (assert (! (not (= Nbb Lb)) :named ax_124))
   (assert (! (not (= Nbb Lb)) :named ax_125))
   (assert (! (not (= Nbb Le)) :named ax_126))
   ...
   (assert (! (not (= Nt Np)) :named ax_165))
   (assert (! (not (= r null)) :named ax_166))
   (assert (! (not (= r null)) :named ax_167))
   (assert (! (not (= StF StD)) :named ax_168))
   (assert (! (not (= StF StD)) :named ax_169))
   (assert (! (not (= StL StD)) :named ax_170))
   (assert (! (not (= StL StD)) :named ax_171))
   (assert (! (not (= StL StF)) :named ax_172))
   (assert (! (not (= StL StF)) :named ax_173))
   (assert (! (not (= this null)) :named ax_174))
   (assert (! (not (= this null)) :named ax_175))
   (assert (! (not (= this r)) :named ax_176))
...
(assert (! (=> anon0@5 (and true 
   (and true
      ...
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 r Np) null)
      ...
      (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 r ND) r) |o_$76|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 |o_$76| Nt) r)))
      (forall( (|o_$77| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 r ND) r) |o_$77|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o_$77| NA) (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$77| NA) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 this NA) this)))))
      (forall( (|o_$78| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 this NA) this) |o_$78|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o_$78| ND) (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$78| ND) (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 r ND) r)))))
      (InvList $Heap)
      (InvList $Heap@0)
      (InvTree $Heap@0)
   )
...
(assert (! (=> anon2_Else (and true 
   (and true
      (= $@condition (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 r Ncpr) 0)))
      (= $Heap@4 $Heap@2)
...
(assert (! (=> anon2_Then@7 (and true 
   (and true
      ...
      (forall( (|o_$81_$0| ref) (|f_$4_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 |o_$81_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 |o_$81_$0| |f_$4_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@2 this) |o_$81_$0|) (or false false))))
      (forall( (|o_$81_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$81_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$81_$1| |f_$4_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@2 this) |o_$81_$1|) (or false false))))
      (forall( (|o_$81_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 |o_$81_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@2 |o_$81_$2| |f_$4_$2|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@2 this) |o_$81_$2|) (or (= |f_$4_$2| Npr) false))))
      (forall( (|o_$81_$3| ref) (|f_$4_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 |o_$81_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 |o_$81_$3| |f_$4_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@2 this) |o_$81_$3|) (or false (= |f_$4_$3| Ncpr)))))
      (forall( (|o_$81_$4| ref) (|f_$4_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@3 |o_$81_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@2 |o_$81_$4| |f_$4_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@2 this) |o_$81_$4|) (or false false))))
      (InvStruct $Heap@3)
   )
GeneratedUnifiedExit
