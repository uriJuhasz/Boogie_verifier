...
(let ((anon0 (=> (and true
    ...
    (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap before@0 Ln after@0) $Heap@0)
    (= (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LL) el) newel@0)
    ...
    (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newel@0 |o_$33|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$33| LL))))
    ...
    (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newel@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|))))
    (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ elLPC@0 |o_$35|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$35| LNC))))
    ...
    (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LNC |f_$0_$1|) (MapRead$$@Map@@ref@To@Bool@@$ elLPC@0 |o_$36_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$36_$1| |f_$0_$1|))))
    (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ elLNC@0 |o_$37|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$37| LPC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$37| LPC))))
    ...
    (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$1_$1|) (MapRead$$@Map@@ref@To@Bool@@$ elLNC@0 |o_$38_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|))))
  )(and 
    anon0_assertion
    anon0@1
))))
(let ((PreconditionGeneratedEntry (=> (and true
    (InvList $Heap)
    (not (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Lb)))
    (not (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Le)))
    (not (= null el))
