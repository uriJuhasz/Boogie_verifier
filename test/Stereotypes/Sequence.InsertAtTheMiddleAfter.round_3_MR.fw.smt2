...
;Axioms
   ...
   (assert (! (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Le) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 listEl Le)) :named ax_9))
   (assert (! (= after@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln)) :named ax_10))
   (assert (! (= call0formal@r1@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LNC)) :named ax_11))
   (assert (! (= call0formal@r1@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 el LPC)) :named ax_12))
   (assert (! (= call2formal@r2@0 (Singleton el)) :named ax_13))
   (assert (! (= oldList@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LL)) :named ax_14))
   ...
   (assert (! (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$33|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$33| LL)))) :named ax_73))
   ...
   (assert (! (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|)))) :named ax_75))
   (assert (! (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$35|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$35| LNC)))) :named ax_76))
   ...
   (assert (! (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LNC |f_$0_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$36_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$36_$1| |f_$0_$1|)))) :named ax_78))
   (assert (! (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$37|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$37| LPC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$37| LPC)))) :named ax_79))
   ...
   (assert (! (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$1_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$38_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|)))) :named ax_81))
   ...
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))) :named ax_83))
   (assert (! (forall( (|r| ref) (|o_$2| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$2|) (= |r| |o_$2|))) :named ax_84))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|t| $@Map@@ref@To@Bool@@))(=> (Equal |s_$0| |t|) (= |t| |s_$0|))) :named ax_85))
   (assert (! (InvList $Heap) :named ax_86))
   (assert (! (IsEmptyList $Heap el) :named ax_87))
   (assert (! (not (= It_el Lb)) :named ax_88))
   (assert (! (not (= It_el Le)) :named ax_89))
   (assert (! (not (= It_el List_head)) :named ax_90))
   (assert (! (not (= It_el Node_next)) :named ax_91))
   (assert (! (not (= It_List It_el)) :named ax_92))
   (assert (! (not (= It_List Lb)) :named ax_93))
   (assert (! (not (= It_List Le)) :named ax_94))
   (assert (! (not (= It_List List_head)) :named ax_95))
   (assert (! (not (= It_List Node_next)) :named ax_96))
   (assert (! (not (= Lb It_el)) :named ax_97))
   (assert (! (not (= Lb It_List)) :named ax_98))
   (assert (! (not (= Lb Le)) :named ax_99))
   (assert (! (not (= Lb List_head)) :named ax_100))
   (assert (! (not (= Lb Node_next)) :named ax_101))
   (assert (! (not (= Le It_el)) :named ax_102))
   (assert (! (not (= Le It_List)) :named ax_103))
   (assert (! (not (= Le Lb)) :named ax_104))
   (assert (! (not (= Le List_head)) :named ax_105))
   (assert (! (not (= Le Node_next)) :named ax_106))
   (assert (! (not (= List_head It_el)) :named ax_107))
   (assert (! (not (= List_head It_List)) :named ax_108))
   (assert (! (not (= List_head Lb)) :named ax_109))
   (assert (! (not (= List_head Le)) :named ax_110))
   (assert (! (not (= List_head Node_next)) :named ax_111))
   (assert (! (not (= listEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 listEl Le))) :named ax_112))
   (assert (! (not (= LL LPC)) :named ax_113))
   ...
   (assert (! (not (= Ln Lp)) :named ax_119))
   (assert (! (not (= Ln Node_next)) :named ax_120))
   (assert (! (not (= LNC LL)) :named ax_121))
   (assert (! (not (= LNC LPC)) :named ax_122))
   (assert (! (not (= Lp It_el)) :named ax_123))
   (assert (! (not (= Lp It_List)) :named ax_124))
   (assert (! (not (= Lp Lb)) :named ax_125))
   (assert (! (not (= Lp Le)) :named ax_126))
   (assert (! (not (= Lp List_head)) :named ax_127))
   (assert (! (not (= Lp Ln)) :named ax_128))
   (assert (! (not (= Lp Node_next)) :named ax_129))
   (assert (! (not (= LPC LL)) :named ax_130))
   (assert (! (not (= LPC LNC)) :named ax_131))
   (assert (! (not (= Node_next It_el)) :named ax_132))
   (assert (! (not (= Node_next It_List)) :named ax_133))
   (assert (! (not (= Node_next Lb)) :named ax_134))
   (assert (! (not (= Node_next Le)) :named ax_135))
   (assert (! (not (= Node_next List_head)) :named ax_136))
   (assert (! (not (= Node_next Ln)) :named ax_137))
   (assert (! (not (= Node_next Lp)) :named ax_138))
   (assert (! (not (= null el)) :named ax_139))
   (assert (! (not (= null listEl)) :named ax_140))
   (assert (! (not (= true false)) :named ax_141))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 el)) :named ax_142))
   (assert (! true :named ax_143))
