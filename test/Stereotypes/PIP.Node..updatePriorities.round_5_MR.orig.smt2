...
(let ((GeneratedUnifiedExit@2_assertion (and
    (forall( (|o_$79_$0| ref) (|f_$4_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$79_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@6 |o_$79_$0| |f_$4_$0|)))
    (forall( (|o_$79_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$79_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 |o_$79_$1| |f_$4_$1|)))
    (forall( (|o_$79_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (and (= Npr |f_$4_$2|) (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$2|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap |o_$79_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@6 |o_$79_$2| |f_$4_$2|))))
    (forall( (|o_$79_$3| ref) (|f_$4_$3| field$Int$))(or (and (= Ncpr |f_$4_$3|) (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$3|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap |o_$79_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@6 |o_$79_$3| |f_$4_$3|))))
    (forall( (|o_$79_$4| ref) (|f_$4_$4| field$TNodeState$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap |o_$79_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@6 |o_$79_$4| |f_$4_$4|)))
)))
...
(let ((anon8_Else (=> (and true
    (= $Heap@6 $Heap@4)
    (not (and (not (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr))) (not (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb)))))
  )
...
(let ((anon8_Then (=> (and true
    ...
    (not (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb)))
    (not (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr)))
  )(and 
...
(let ((anon6_Then (=> (and true
    (= $Heap@1 $Heap@0)
    (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr (RemoveMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr) from)) $Heap@0)
    (> from 0)
  )
    anon2
)))
