...
(declare-fun $@sk_100 ( ) field$Int$)
(declare-fun $@sk_101 ( ) ref)
(declare-fun $@sk_102 ( ) field$$@Map@@Int@To@Int@@$)
(declare-fun $@sk_103 ( ) ref)
(declare-fun $@sk_104 ( ) field$$@Map@@ref@To@Bool@@$)
(declare-fun $@sk_105 ( ) ref)
(declare-fun $@sk_106 ( ) field$ref$)
...
(declare-fun $@sk_98 ( ) field$TNodeState$)
...
;Axioms
   ...
   (assert (! (not (= StF StD)) :named ax_155))
   (assert (! (not (= StF StD)) :named ax_156))
   (assert (! (not (= StL StD)) :named ax_157))
   (assert (! (not (= StL StD)) :named ax_158))
   (assert (! (not (= StL StF)) :named ax_159))
   (assert (! (not (= StL StF)) :named ax_160))
   (assert (! (not (= subTree null)) :named ax_161))
   (assert (! (not (= tree null)) :named ax_162))
