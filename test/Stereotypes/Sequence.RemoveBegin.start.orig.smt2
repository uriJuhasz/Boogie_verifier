...
(assert (! (=> anon0 (and true 
   (and true
      (= $Heap@0 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap newBegin@0 Lp null))
      ...
      (= call2formal@r2@0 (Singleton oldBegin@0))
      (= newBegin@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap oldBegin@0 Ln))
      (= newList@0 (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) oldBegin@0))
      ...
      (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$35|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LPC) (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$35| LPC) call2formal@r2@0))))
      ...
      (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$36_$1| |f_$0_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$36_$1|) (= |f_$0_$1| LPC))))
      (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$37|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$37| Lb) newBegin@0)))
      (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$38_$0| |f_$1_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$38_$0|) (= |f_$1_$0| Lb))))
