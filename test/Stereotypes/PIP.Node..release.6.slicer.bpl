...
procedure Node..release (this : ref,r : ref)
{
	...
	var $Heap_$_1 : THeap;
	var $Heap_$_2 : THeap;
	var call1formal_$_from_$_0 : int;
	var $Heap_$_3 : THeap;
	var $Heap_$_4 : THeap;
...
PreconditionGeneratedEntry:
	...
	assume !(this == null);
	assume !(r == null);
	assume $Heap[this,NC][r];
	assume $Heap[this,NSt] == StF;
	assume InvStruct($Heap);
	assume InvPr($Heap,r);
	assume (forall  o_$74 : ref :: ( NACCoSet($Heap,this)[o_$74] ==> InvPr($Heap,o_$74) ));
	goto anon0;
anon0:
	assert  !(this == null);
	assert  !(r == null);
	assert  $Heap[this,NC][r];
	assert  InvTree($Heap);
	assert  InvList($Heap);
	...
	assume $Heap_$_0[r,Np] == null;
	assume (forall  o_$76 : ref :: ( AddEl($Heap_$_0[r,ND],r)[o_$76] ==> ($Heap_$_0[o_$76,Nt] == r) ));
	assume $Heap_$_0[this,NC] == RemEl($Heap[this,NC],r);
	assume (forall  o_$77 : ref :: ( AddEl($Heap_$_0[r,ND],r)[o_$77] ==> ($Heap_$_0[o_$77,NA] == Minus($Heap[o_$77,NA],AddEl($Heap_$_0[this,NA],this))) ));
	assume (forall  o_$78 : ref :: ( AddEl($Heap_$_0[this,NA],this)[o_$78] ==> ($Heap_$_0[o_$78,ND] == Minus($Heap[o_$78,ND],AddEl($Heap_$_0[r,ND],r))) ));
	assume $Heap_$_1 == $Heap_$_0[r,Nbb := null];
	assume $Heap_$_2 == $Heap_$_1[r,NSt := StF];
	if ($_$_condition) { goto anon2_Then; } else { goto anon2_Else; }
anon2_Then:
	assume $_$_condition;
	assume $_$_condition <==> (!($Heap_$_2[r,Ncpr] == 0));
	assume !($Heap_$_2[r,Ncpr] == 0);
	assume call1formal_$_from_$_0 == $Heap_$_2[r,Ncpr];
	assert  call1formal_$_from_$_0 >= 0;
	assert  0 >= 0;
	assert  !(call1formal_$_from_$_0 == 0);
	assert  !(this == null);
	assert  InvStruct($Heap_$_2);
	assert  InvPrSt($Heap_$_2,this,call1formal_$_from_$_0,0);
	assert  (forall  o_$79 : ref :: ( NACCSet($Heap_$_2,this)[o_$79] ==> InvPr($Heap_$_2,o_$79) ));
	assume InvStruct($Heap_$_3);
	assume (forall  o_$80 : ref :: ( NACCoSet($Heap_$_3,this)[o_$80] ==> InvPr($Heap_$_3,o_$80) ));
	assume (((((forall  o_$81_$0 : ref, f_$4_$0 : field (ref)  :: ( ($Heap_$_3[o_$81_$0,f_$4_$0] == $Heap_$_2[o_$81_$0,f_$4_$0]) || (NACCoSet($Heap_$_2,this)[o_$81_$0] && (false || false)) ))) && ((forall  o_$81_$1 : ref, f_$4_$1 : field (TRegion)  :: ( ($Heap_$_3[o_$81_$1,f_$4_$1] == $Heap_$_2[o_$81_$1,f_$4_$1]) || (NACCoSet($Heap_$_2,this)[o_$81_$1] && (false || false)) )))) && ((forall  o_$81_$2 : ref, f_$4_$2 : field ([Integer]Integer)  :: ( ($Heap_$_3[o_$81_$2,f_$4_$2] == $Heap_$_2[o_$81_$2,f_$4_$2]) || (NACCoSet($Heap_$_2,this)[o_$81_$2] && ((f_$4_$2 == Npr) || false)) )))) && ((forall  o_$81_$3 : ref, f_$4_$3 : field (Integer)  :: ( ($Heap_$_3[o_$81_$3,f_$4_$3] == $Heap_$_2[o_$81_$3,f_$4_$3]) || (NACCoSet($Heap_$_2,this)[o_$81_$3] && (false || (f_$4_$3 == Ncpr))) )))) && ((forall  o_$81_$4 : ref, f_$4_$4 : field (TNodeState)  :: ( ($Heap_$_3[o_$81_$4,f_$4_$4] == $Heap_$_2[o_$81_$4,f_$4_$4]) || (NACCoSet($Heap_$_2,this)[o_$81_$4] && (false || false)) )));
...
GeneratedUnifiedExit:
	assert  $Heap_$_4[r,Np] == null;
	assert  InvStruct($Heap_$_4);
	assert  $Heap_$_4[this,NSt] == StF;
	assert  $Heap_$_4[r,NSt] == StF;
	assert  (forall  o_$82 : ref :: ( NACCoSet($Heap,this)[o_$82] ==> InvPr($Heap_$_4,o_$82) ));
	assert  InvPr($Heap_$_4,r);
	assert  (((((forall  o_$83_$0 : ref, f_$5_$0 : field (ref)  :: ( (((((((($Heap_$_4[o_$83_$0,f_$5_$0] == $Heap[o_$83_$0,f_$5_$0]) || (NACCoSet($Heap,this)[o_$83_$0] && (false || false))) || ((o_$83_$0 == r) && (f_$5_$0 == Np))) || (AddEl($Heap[r,ND],r)[o_$83_$0] && (f_$5_$0 == Nt))) || ((o_$83_$0 == this) && false)) || (AddEl($Heap[this,NA],this)[o_$83_$0] && false)) || (AddEl($Heap[r,ND],r)[o_$83_$0] && false)) || ((o_$83_$0 == r) && (f_$5_$0 == Nbb))) || ((o_$83_$0 == r) && false) ))) && ((forall  o_$83_$1 : ref, f_$5_$1 : field (TRegion)  :: ( (((((((($Heap_$_4[o_$83_$1,f_$5_$1] == $Heap[o_$83_$1,f_$5_$1]) || (NACCoSet($Heap,this)[o_$83_$1] && (false || false))) || ((o_$83_$1 == r) && false)) || (AddEl($Heap[r,ND],r)[o_$83_$1] && false)) || ((o_$83_$1 == this) && (f_$5_$1 == NC))) || (AddEl($Heap[this,NA],this)[o_$83_$1] && (f_$5_$1 == ND))) || (AddEl($Heap[r,ND],r)[o_$83_$1] && (f_$5_$1 == NA))) || ((o_$83_$1 == r) && false)) || ((o_$83_$1 == r) && false) )))) && ((forall  o_$83_$2 : ref, f_$5_$2 : field ([Integer]Integer)  :: ( (((((((($Heap_$_4[o_$83_$2,f_$5_$2] == $Heap[o_$83_$2,f_$5_$2]) || (NACCoSet($Heap,this)[o_$83_$2] && ((f_$5_$2 == Npr) || false))) || ((o_$83_$2 == r) && false)) || (AddEl($Heap[r,ND],r)[o_$83_$2] && false)) || ((o_$83_$2 == this) && false)) || (AddEl($Heap[this,NA],this)[o_$83_$2] && false)) || (AddEl($Heap[r,ND],r)[o_$83_$2] && false)) || ((o_$83_$2 == r) && false)) || ((o_$83_$2 == r) && false) )))) && ((forall  o_$83_$3 : ref, f_$5_$3 : field (Integer)  :: ( (((((((($Heap_$_4[o_$83_$3,f_$5_$3] == $Heap[o_$83_$3,f_$5_$3]) || (NACCoSet($Heap,this)[o_$83_$3] && (false || (f_$5_$3 == Ncpr)))) || ((o_$83_$3 == r) && false)) || (AddEl($Heap[r,ND],r)[o_$83_$3] && false)) || ((o_$83_$3 == this) && false)) || (AddEl($Heap[this,NA],this)[o_$83_$3] && false)) || (AddEl($Heap[r,ND],r)[o_$83_$3] && false)) || ((o_$83_$3 == r) && false)) || ((o_$83_$3 == r) && false) )))) && ((forall  o_$83_$4 : ref, f_$5_$4 : field (TNodeState)  :: ( (((((((($Heap_$_4[o_$83_$4,f_$5_$4] == $Heap[o_$83_$4,f_$5_$4]) || (NACCoSet($Heap,this)[o_$83_$4] && (false || false))) || ((o_$83_$4 == r) && false)) || (AddEl($Heap[r,ND],r)[o_$83_$4] && false)) || ((o_$83_$4 == this) && false)) || (AddEl($Heap[this,NA],this)[o_$83_$4] && false)) || (AddEl($Heap[r,ND],r)[o_$83_$4] && false)) || ((o_$83_$4 == r) && false)) || ((o_$83_$4 == r) && (f_$5_$4 == NSt)) )));
	assert  (forall  o_$84 : ref :: ( (!(o_$84 == this)) ==> Equal(BBSet($Heap_$_4,o_$84),BBSet($Heap,o_$84)) ));
	goto $exit;
}
