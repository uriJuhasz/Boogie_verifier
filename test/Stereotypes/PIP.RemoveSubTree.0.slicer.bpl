...
anon0:
	...
	assume (forall<a> o_$75 : ref, f_$3 : field (a)  :: ( ($Heap_$_2[o_$75,f_$3] == $Heap_$_1[o_$75,f_$3]) || (call0formal_$_r1_$_0[o_$75] && (f_$3 == NA)) ));
	...
	assume (forall<a> o_$77 : ref, f_$4 : field (a)  :: ( ($Heap_$_3[o_$77,f_$4] == $Heap_$_2[o_$77,f_$4]) || (call0formal_$_r1_$_0[o_$77] && (f_$4 == ND)) ));
