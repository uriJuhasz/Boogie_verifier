...
;Axioms
   (assert (! (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 after@0 Lp before@0)) :named ax_0))
   (assert (! (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 el Lp null)) :named ax_1))
   (assert (! (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 el Ln null)) :named ax_2))
   (assert (! (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 el Lb el)) :named ax_3))
   (assert (! (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 el Le el)) :named ax_4))
   (assert (! (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 el LPC Empty)) :named ax_5))
   (assert (! (= $Heap@7 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 el LNC Empty)) :named ax_6))
   (assert (! (= $Heap@8 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 el LL (Singleton el))) :named ax_7))
   (assert (! (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap before@0 Ln after@0) $Heap@0) :named ax_8))
   (assert (! (= (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LL) el) newel@0) :named ax_9))
   (assert (! (= (Singleton el) call2formal@r2@0) :named ax_10))
   (assert (! (= (Singleton el) call2formal@r2@0) :named ax_11))
   (assert (! (= (Singleton el) call2formal@r2@0) :named ax_12))
   (assert (! (= after@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Ln)) :named ax_13))
   (assert (! (= before@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Lp)) :named ax_14))
   (assert (! (= elLNC@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LNC)) :named ax_15))
   (assert (! (= elLPC@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LPC)) :named ax_16))
   ...
   (assert (! (forall( (|h_$8| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|Ex1_$6| $@Map@@ref@To@Bool@@))(= (Inve2Ex |h_$8| |Ex1_$6|) (forall( (|o_$17| ref))(=> (and (not (MapRead$$@Map@@ref@To@Bool@@$ |Ex1_$6| |o_$17|)) (not (= |o_$17| null))) (= (= |o_$17| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$17| Le)) (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$8| |o_$17| Ln))))))) :named ax_71))
   ...
   (assert (! (forall( (|h| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o| ref))(= (IsEmptyList |h| |o|) (and (= |o| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o| Lb)) (and (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o| LPC) Empty) (and (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o| Lp)) (and (= |o| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o| Le)) (and (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o| LNC) Empty) (and (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o| Ln)) (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o| LL) (Singleton |o|)))))))))) :named ax_73))
   (assert (! (forall( (|o_$1| ref))(not (MapRead$$@Map@@ref@To@Bool@@$ Empty |o_$1|))) :named ax_74))
   (assert (! (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newel@0 |o_$33|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$33| LL)))) :named ax_75))
   (assert (! (forall( (|o_$34_$0| ref) (|f_$3| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$34_$0| |f_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 |o_$34_$0| |f_$3|))) :named ax_76))
   (assert (! (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newel@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|)))) :named ax_77))
   (assert (! (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ elLPC@0 |o_$35|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$35| LNC)))) :named ax_78))
   (assert (! (forall( (|o_$36_$0| ref) (|f_$0_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$36_$0| |f_$0_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$36_$0| |f_$0_$0|))) :named ax_79))
   (assert (! (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LNC |f_$0_$1|) (MapRead$$@Map@@ref@To@Bool@@$ elLPC@0 |o_$36_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$36_$1| |f_$0_$1|)))) :named ax_80))
   (assert (! (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ elLNC@0 |o_$37|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$37| LPC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$37| LPC)))) :named ax_81))
   (assert (! (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|))) :named ax_82))
   (assert (! (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$1_$1|) (MapRead$$@Map@@ref@To@Bool@@$ elLNC@0 |o_$38_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|)))) :named ax_83))
   (assert (! (forall( (|r_$0| $@Map@@ref@To@Bool@@) (|o_$7| ref) (|o'_$0| ref))(= (or (MapRead$$@Map@@ref@To@Bool@@$ |r_$0| |o'_$0|) (= |o_$7| |o'_$0|)) (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$7|) |o'_$0|))) :named ax_84))
   (assert (! (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$1| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$8|) |o'_$1|) (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$1|) (not (= |o_$8| |o'_$1|))))) :named ax_85))
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))) :named ax_86))
   (assert (! (forall( (|r| ref) (|o_$2| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$2|) (= |r| |o_$2|))) :named ax_87))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|t| $@Map@@ref@To@Bool@@))(=> (Equal |s_$0| |t|) (= |t| |s_$0|))) :named ax_88))
   (assert (! (forall( (|s| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$9| ref))(= (and (MapRead$$@Map@@ref@To@Bool@@$ |s| |o_$9|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$9|))) (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s| |r_$2|) |o_$9|))) :named ax_89))
   (assert (! (InvList $Heap) :named ax_90))
   (assert (! (not (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Lb))) :named ax_91))
   (assert (! (not (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Le))) :named ax_92))
   (assert (! (not (= It_List It_el)) :named ax_93))
   (assert (! (not (= It_List It_el)) :named ax_94))
   (assert (! (not (= Lb It_el)) :named ax_95))
   (assert (! (not (= Lb It_el)) :named ax_96))
   (assert (! (not (= Lb It_List)) :named ax_97))
   (assert (! (not (= Lb It_List)) :named ax_98))
   (assert (! (not (= Le It_el)) :named ax_99))
   ...
   (assert (! (not (= List_head It_List)) :named ax_108))
   (assert (! (not (= List_head Lb)) :named ax_109))
   (assert (! (not (= List_head Lb)) :named ax_110))
   (assert (! (not (= List_head Le)) :named ax_111))
   (assert (! (not (= List_head Le)) :named ax_112))
   (assert (! (not (= Ln It_el)) :named ax_113))
   (assert (! (not (= Ln It_el)) :named ax_114))
   (assert (! (not (= Ln It_List)) :named ax_115))
   (assert (! (not (= Ln It_List)) :named ax_116))
   (assert (! (not (= Ln Lb)) :named ax_117))
   (assert (! (not (= Ln Lb)) :named ax_118))
   (assert (! (not (= Ln Le)) :named ax_119))
   (assert (! (not (= Ln Le)) :named ax_120))
   (assert (! (not (= Ln List_head)) :named ax_121))
   (assert (! (not (= Ln List_head)) :named ax_122))
   (assert (! (not (= LNC LL)) :named ax_123))
   (assert (! (not (= LNC LL)) :named ax_124))
   (assert (! (not (= Lp It_el)) :named ax_125))
   (assert (! (not (= Lp It_el)) :named ax_126))
   (assert (! (not (= Lp It_List)) :named ax_127))
   (assert (! (not (= Lp It_List)) :named ax_128))
   (assert (! (not (= Lp Lb)) :named ax_129))
   (assert (! (not (= Lp Lb)) :named ax_130))
   (assert (! (not (= Lp Le)) :named ax_131))
   (assert (! (not (= Lp Le)) :named ax_132))
   (assert (! (not (= Lp List_head)) :named ax_133))
   (assert (! (not (= Lp List_head)) :named ax_134))
   (assert (! (not (= Lp Ln)) :named ax_135))
   (assert (! (not (= Lp Ln)) :named ax_136))
   (assert (! (not (= LPC LL)) :named ax_137))
   (assert (! (not (= LPC LL)) :named ax_138))
   (assert (! (not (= LPC LNC)) :named ax_139))
   (assert (! (not (= LPC LNC)) :named ax_140))
   (assert (! (not (= Node_next It_el)) :named ax_141))
   (assert (! (not (= Node_next It_el)) :named ax_142))
   (assert (! (not (= Node_next It_List)) :named ax_143))
   (assert (! (not (= Node_next It_List)) :named ax_144))
   (assert (! (not (= Node_next Lb)) :named ax_145))
   (assert (! (not (= Node_next Lb)) :named ax_146))
   (assert (! (not (= Node_next Le)) :named ax_147))
   (assert (! (not (= Node_next Le)) :named ax_148))
   (assert (! (not (= Node_next List_head)) :named ax_149))
   (assert (! (not (= Node_next List_head)) :named ax_150))
   (assert (! (not (= Node_next Ln)) :named ax_151))
   (assert (! (not (= Node_next Ln)) :named ax_152))
   (assert (! (not (= Node_next Lp)) :named ax_153))
   (assert (! (not (= Node_next Lp)) :named ax_154))
   (assert (! (not (= null el)) :named ax_155))
   (assert (! (not (IsEmptyList $Heap el)) :named ax_156))

;Program
(assert (not
(let ((anon0@27_assertion (and
    (forall( (|o_$42_$0| ref) (|f_$2_$0| field$ref$))(or (and (= |o_$42_$0| el) (= Le |f_$2_$0|)) (or (and (= |o_$42_$0| el) (= Lb |f_$2_$0|)) (or (and (= |o_$42_$0| el) (= Ln |f_$2_$0|)) (or (and (= |o_$42_$0| el) (= Lp |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Ln)) (= Lp |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap el Lp)) (= Ln |f_$2_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$42_$0| |f_$2_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 |o_$42_$0| |f_$2_$0|)))))))))
    (forall( (|o_$42_$1| ref) (|f_$2_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$2_$1|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LNC) |o_$42_$1|)) (or (or (and (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LL) el) |o_$42_$1|) (= LL |f_$2_$1|)) (or (and (= |o_$42_$1| el) (= LL |f_$2_$1|)) (or (and (= |o_$42_$1| el) (= LNC |f_$2_$1|)) (or (and (= |o_$42_$1| el) (= LPC |f_$2_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$42_$1| |f_$2_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$42_$1| |f_$2_$1|)))))) (and (= LNC |f_$2_$1|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap el LPC) |o_$42_$1|)))))
)))
