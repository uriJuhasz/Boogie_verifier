...
;Axioms
   ...
   (assert (! (= nextTree@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Lp)) :named ax_3))
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA) subTree) tree) |o_$74|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$74| Np) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$74| Ln)))) :named ax_83))
   (assert (! (forall( (|o_$75| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA) |o_$75|) (MapRead$$@Map@@ref@To@Bool@@$ (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA) subTree) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$75| Lp)))) :named ax_84))
   (assert (! (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA) |o_$76|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$76| NC) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$76| Lp)))) :named ax_85))
   ...
   (assert (! (InvList $Heap) :named ax_97))
   ...
   (assert (! (not (= Lb Le)) :named ax_100))
   (assert (! (not (= Lb Nt)) :named ax_101))
   (assert (! (not (= Le Lb)) :named ax_102))
   (assert (! (not (= Le Nt)) :named ax_103))
   (assert (! (not (= LL NC)) :named ax_104))
   (assert (! (not (= LL ND)) :named ax_105))
   (assert (! (not (= Ln Lb)) :named ax_106))
   (assert (! (not (= Ln Le)) :named ax_107))
   (assert (! (not (= Ln Lp)) :named ax_108))
   (assert (! (not (= Ln Nbb)) :named ax_109))
   (assert (! (not (= Ln Nt)) :named ax_110))
   (assert (! (not (= Lp Lb)) :named ax_111))
   (assert (! (not (= Lp Le)) :named ax_112))
   (assert (! (not (= Lp Ln)) :named ax_113))
   (assert (! (not (= Lp Nbb)) :named ax_114))
   (assert (! (not (= Lp Nt)) :named ax_115))
   (assert (! (not (= NA LL)) :named ax_116))
   (assert (! (not (= NA NC)) :named ax_117))
   (assert (! (not (= NA ND)) :named ax_118))
   (assert (! (not (= Nbb Lb)) :named ax_119))
   (assert (! (not (= Nbb Le)) :named ax_120))
   (assert (! (not (= Nbb Ln)) :named ax_121))
   (assert (! (not (= Nbb Lp)) :named ax_122))
   (assert (! (not (= Nbb Nt)) :named ax_123))
   (assert (! (not (= NC LL)) :named ax_124))
   (assert (! (not (= NC NA)) :named ax_125))
   (assert (! (not (= NC ND)) :named ax_126))
   (assert (! (not (= Ncpr Ndpr)) :named ax_127))
   (assert (! (not (= ND LL)) :named ax_128))
   (assert (! (not (= ND NA)) :named ax_129))
   (assert (! (not (= ND NC)) :named ax_130))
   (assert (! (not (= Ndpr Ncpr)) :named ax_131))
   (assert (! (not (= Np Lb)) :named ax_132))
   (assert (! (not (= Np Le)) :named ax_133))
   (assert (! (not (= Np Ln)) :named ax_134))
   (assert (! (not (= Np Lp)) :named ax_135))
   (assert (! (not (= Np Nbb)) :named ax_136))
   (assert (! (not (= Np Nt)) :named ax_137))
   (assert (! (not (= Nt Lb)) :named ax_138))
   (assert (! (not (= Nt Le)) :named ax_139))
   (assert (! (not (= Nt Ln)) :named ax_140))
   (assert (! (not (= Nt Lp)) :named ax_141))
   (assert (! (not (= Nt Nbb)) :named ax_142))
   (assert (! (not (= Nt Np)) :named ax_143))
   (assert (! (not (= StF StD)) :named ax_144))
   (assert (! (not (= StF StL)) :named ax_145))
   (assert (! (not (= StL StD)) :named ax_146))
   (assert (! (not (= StL StF)) :named ax_147))
   (assert (! (not (= subTree null)) :named ax_148))
   (assert (! (not (= tree null)) :named ax_149))
   (assert (! (not (= true false)) :named ax_150))
   (assert (! true :named ax_151))
...
(assert (! (=> GeneratedUnifiedExit (and true 
   (and true
      (InvList $Heap@2)
      (InvTree $Heap@2)
      (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Lp) null))
   )
...
(assert (! (=> GeneratedUnifiedExit@3 (and true 
   (and true
      (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 (CLp $Heap tree) Np))
      (forall( (|o_$90| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree NA) subTree) tree) |o_$90|) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$90| Np) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 |o_$90| Ln))))
   )
...
(assert (! (=> GeneratedUnifiedExit@5 (and true 
   (and true
      ...
      (not (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Lp) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Np)))
      (not (= subTree (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Np)))
      (not (= tree (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Np)))
   )
