...
(let ((anon0@4_assertion (and
    (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 el Lp))
)))
...
(let ((anon0@6_assertion (and
    (= (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) el) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 el LL))
)))
...
(let ((anon0@8_assertion (and
    (forall( (|o_$80| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) |o_$80|) (= el (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 |o_$80| Le))))
)))
