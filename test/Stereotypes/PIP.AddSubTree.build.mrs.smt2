...
;Axioms
   ...
   (assert (! (= 0 (Card Empty)) :named ax_3))
   (assert (! (= 0 (MaxMSet EmptyMSet)) :named ax_4))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 tree NA) tree)) :named ax_5))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 subTree ND) subTree)) :named ax_6))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 subTree ND) subTree)) :named ax_7))
   (assert (! (= call2formal@r2@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 subTree ND) subTree)) :named ax_8))
   (assert (! (= call2formal@r2@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 tree NA) tree)) :named ax_9))
   (assert (! (= call2formal@val@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 tree Nt)) :named ax_10))
   (assert (! (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap subTree Np)) :named ax_11))
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$74|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$74| ND) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$74| ND)))) :named ax_102))
   ...
   (assert (! (forall( (|o_$75_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= ND |f_$3_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$75_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$75_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$75_$1| |f_$3_$1|)))) :named ax_104))
   ...
   (assert (! (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$76|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$76| NA) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$76| NA)))) :named ax_108))
   ...
   (assert (! (forall( (|o_$77_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= NA |f_$4_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$77_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$77_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$77_$1| |f_$4_$1|)))) :named ax_110))
   ...
   (assert (! (forall( (|o_$78| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$78|) (= call2formal@val@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$78| Nt)))) :named ax_114))
   ...
   (assert (! (not (= StF StL)) :named ax_178))
   (assert (! (not (= StL StD)) :named ax_179))
   (assert (! (not (= StL StF)) :named ax_180))
   (assert (! (not (= subTree null)) :named ax_181))
   (assert (! (not (= subTree tree)) :named ax_182))
   (assert (! (not (= tree null)) :named ax_183))
   (assert (! (not (= true false)) :named ax_184))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree ND) tree)) :named ax_185))
   (assert (! true :named ax_186))
