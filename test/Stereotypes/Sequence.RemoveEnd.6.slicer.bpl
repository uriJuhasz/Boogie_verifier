...
anon0:
	...
	assume newEnd_$_0 == $Heap[oldEnd_$_0,Lp];
	assume newList_$_0 == RemEl($Heap[list,LL],oldEnd_$_0);
	assume $Heap_$_0 == $Heap[newEnd_$_0,Ln := null];
	assume $Heap_$_1 == $Heap_$_0[oldEnd_$_0,Lp := null];
	assume $Heap_$_2 == $Heap_$_1[oldEnd_$_0,Ln := null];
	assume $Heap_$_3 == $Heap_$_2[oldEnd_$_0,Lb := oldEnd_$_0];
	assume $Heap_$_4 == $Heap_$_3[oldEnd_$_0,Le := oldEnd_$_0];
	assume $Heap_$_5 == $Heap_$_4[oldEnd_$_0,LPC := Empty];
	assume $Heap_$_6 == $Heap_$_5[oldEnd_$_0,LNC := Empty];
	assume $Heap_$_7 == $Heap_$_6[oldEnd_$_0,LL := Singleton(oldEnd_$_0)];
	assume call2formal_$_r2_$_0 == Singleton(oldEnd_$_0);
	assume (forall  o_$33 : ref :: ( newList_$_0[o_$33] ==> ($Heap_$_8[o_$33,LL] == Minus($Heap_$_7[o_$33,LL],call2formal_$_r2_$_0)) ));
	assume ((forall  o_$34_$0 : ref, f_$3 : field (ref)  :: ( ($Heap_$_8[o_$34_$0,f_$3] == $Heap_$_7[o_$34_$0,f_$3]) || (newList_$_0[o_$34_$0] && false) ))) && ((forall  o_$34_$1 : ref, f_$4 : field ([ref]Boolean)  :: ( ($Heap_$_8[o_$34_$1,f_$4] == $Heap_$_7[o_$34_$1,f_$4]) || (newList_$_0[o_$34_$1] && (f_$4 == LL)) )));
	assume call2formal_$_r2_$_0 == Singleton(oldEnd_$_0);
	assume (forall  o_$35 : ref :: ( newList_$_0[o_$35] ==> ($Heap_$_9[o_$35,LNC] == Minus($Heap_$_8[o_$35,LNC],call2formal_$_r2_$_0)) ));
	assume ((forall  o_$36_$0 : ref, f_$0_$0 : field (ref)  :: ( ($Heap_$_9[o_$36_$0,f_$0_$0] == $Heap_$_8[o_$36_$0,f_$0_$0]) || (newList_$_0[o_$36_$0] && false) ))) && ((forall  o_$36_$1 : ref, f_$0_$1 : field ([ref]Boolean)  :: ( ($Heap_$_9[o_$36_$1,f_$0_$1] == $Heap_$_8[o_$36_$1,f_$0_$1]) || (newList_$_0[o_$36_$1] && (f_$0_$1 == LNC)) )));
	assume (forall  o_$37 : ref :: ( newList_$_0[o_$37] ==> ($Heap_$_10[o_$37,Le] == newEnd_$_0) ));
	assume ((forall  o_$38_$0 : ref, f_$1_$0 : field (ref)  :: ( ($Heap_$_10[o_$38_$0,f_$1_$0] == $Heap_$_9[o_$38_$0,f_$1_$0]) || (newList_$_0[o_$38_$0] && (f_$1_$0 == Le)) ))) && ((forall  o_$38_$1 : ref, f_$1_$1 : field ([ref]Boolean)  :: ( ($Heap_$_10[o_$38_$1,f_$1_$1] == $Heap_$_9[o_$38_$1,f_$1_$1]) || (newList_$_0[o_$38_$1] && false) )));
	...
	assert  IsEmptyList($Heap_$_10,$Heap[list,Le]);
	assert  $Heap_$_10[$Heap[$Heap[list,Le],Lp],Ln] == null;
	assert  (forall  o_$39 : ref :: ( RemEl($Heap[list,LL],$Heap[list,Le])[o_$39] ==> Equal($Heap_$_10[o_$39,LL],RemEl($Heap[o_$39,LL],$Heap[list,Le])) ));
	assert  (forall  o_$40 : ref :: ( RemEl($Heap[list,LL],$Heap[list,Le])[o_$40] ==> Equal($Heap_$_10[o_$40,LNC],RemEl($Heap[o_$40,LNC],$Heap[list,Le])) ));
	assert  (forall  o_$41 : ref :: ( RemEl($Heap[list,LL],$Heap[list,Le])[o_$41] ==> ($Heap_$_10[o_$41,Le] == $Heap[$Heap[list,Le],Lp]) ));
	assert  ((forall  o_$42_$0 : ref, f_$2_$0 : field (ref)  :: ( ((((((((((($Heap_$_10[o_$42_$0,f_$2_$0] == $Heap[o_$42_$0,f_$2_$0]) || ((o_$42_$0 == $Heap[$Heap[list,Le],Lp]) && (f_$2_$0 == Ln))) || ((o_$42_$0 == $Heap[list,Le]) && (f_$2_$0 == Lp))) || ((o_$42_$0 == $Heap[list,Le]) && (f_$2_$0 == Ln))) || ((o_$42_$0 == $Heap[list,Le]) && (f_$2_$0 == Lb))) || ((o_$42_$0 == $Heap[list,Le]) && (f_$2_$0 == Le))) || ((o_$42_$0 == $Heap[list,Le]) && false)) || ((o_$42_$0 == $Heap[list,Le]) && false)) || ((o_$42_$0 == $Heap[list,Le]) && false)) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$0] && false)) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$0] && false)) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$0] && (f_$2_$0 == Le)) ))) && ((forall  o_$42_$1 : ref, f_$2_$1 : field ([ref]Boolean)  :: ( ((((((((((($Heap_$_10[o_$42_$1,f_$2_$1] == $Heap[o_$42_$1,f_$2_$1]) || ((o_$42_$1 == $Heap[$Heap[list,Le],Lp]) && false)) || ((o_$42_$1 == $Heap[list,Le]) && false)) || ((o_$42_$1 == $Heap[list,Le]) && false)) || ((o_$42_$1 == $Heap[list,Le]) && false)) || ((o_$42_$1 == $Heap[list,Le]) && false)) || ((o_$42_$1 == $Heap[list,Le]) && (f_$2_$1 == LPC))) || ((o_$42_$1 == $Heap[list,Le]) && (f_$2_$1 == LNC))) || ((o_$42_$1 == $Heap[list,Le]) && (f_$2_$1 == LL))) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$1] && (f_$2_$1 == LL))) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$1] && (f_$2_$1 == LNC))) || (RemEl($Heap[list,LL],$Heap[list,Le])[o_$42_$1] && false) )));
	goto $exit;
}
