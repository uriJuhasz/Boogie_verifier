...
(declare-fun anon13_Else@2_assertion ( ) Bool)
...
(declare-fun anon13_Else_assertion ( ) Bool)
...
(or anon13_Else@1 anon13_Else_assertion)
...
(assert (! (=> anon13_Else_assertion (not (and true
   (and true
      (Equal (NACCSet $Heap@8 r) (RemEl (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 r NA) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 r Nt) LL)) r))
   )
))) :named ax_anon13_Else_assertion))
...
(or anon13_Else@2_assertion anon13_Else@3)
