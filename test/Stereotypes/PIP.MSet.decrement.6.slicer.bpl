...
$start:
	...
	assume (forall  m : TMSet, i_$0 : Integer :: {InMSet(m,i_$0)} ( InMSet(m,i_$0) <==> (!(m[i_$0] == 0)) ));
	assume (forall  i_$1 : Integer :: {EmptyMSet[i_$1]} ( !InMSet(EmptyMSet,i_$1) ));
	assume (forall  a : TMSet, b : TMSet :: {EqualMSet(a,b)} ( EqualMSet(a,b) <==> ((forall  i_$2 : Integer :: {a[i_$2]} {b[i_$2]} ( (i_$2 > 0) ==> (a[i_$2] == b[i_$2]) ))) ));
	assume (forall  a_$0 : TMSet, i_$3 : Integer :: {AddMSet(a_$0,i_$3)[i_$3]} ( AddMSet(a_$0,i_$3)[i_$3] == (a_$0[i_$3] + 1) ));
	assume (forall  a_$1 : TMSet, i_$4 : Integer, j : Integer :: {AddMSet(a_$1,i_$4)[j]} ( (!(i_$4 == j)) ==> (AddMSet(a_$1,i_$4)[j] == a_$1[j]) ));
	assume (forall  a_$2 : TMSet, i_$5 : Integer :: {RemoveMSet(a_$2,i_$5)[i_$5]} ( RemoveMSet(a_$2,i_$5)[i_$5] == (a_$2[i_$5] - 1) ));
	assume (forall  a_$3 : TMSet, i_$6 : Integer, j_$0 : Integer :: {RemoveMSet(a_$3,i_$6)[j_$0]} ( (!(i_$6 == j_$0)) ==> (RemoveMSet(a_$3,i_$6)[j_$0] == a_$3[j_$0]) ));
	...
	assume (forall  i_$7 : Integer, j_$1 : Integer :: {Max(i_$7,j_$1)} ( ((Max(i_$7,j_$1) >= i_$7) && (Max(i_$7,j_$1) >= j_$1)) && ((Max(i_$7,j_$1) == i_$7) || (Max(i_$7,j_$1) == j_$1)) ));
	assume (forall  h_$4 : THeap, r_$4 : TRegion, i_$8 : Integer, o_$15 : ref :: ( FBP(h_$4,r_$4,i_$8)[o_$15] <==> ((r_$4[o_$15] && (h_$4[o_$15,Ncpr] == i_$8)) && (!(o_$15 == null))) ));
	...
	assume (forall  h_$95 : THeap, o_$63 : ref :: ( InvPr(h_$95,o_$63) <==> ((((h_$95[o_$63,Ncpr] == Max(h_$95[o_$63,Ndpr],MaxMSet(h_$95[o_$63,Npr]))) && (h_$95[o_$63,Ncpr] >= 0)) && (h_$95[o_$63,Ndpr] >= 0)) && ((forall  i_$9 : Integer :: ( (i_$9 > 0) ==> (h_$95[o_$63,Npr][i_$9] == Card(FBP(h_$95,BBSet(h_$95,o_$63),i_$9))) )))) ));
	assume (forall  h_$96 : THeap, o_$64 : ref, from : Integer, to : Integer :: ( InvPrSt(h_$96,o_$64,from,to) <==> ((((((forall  i_$10 : Integer :: ( (((i_$10 > 0) && (!(i_$10 == from))) && (!(i_$10 == to))) ==> (h_$96[o_$64,Npr][i_$10] == Card(FBP(h_$96,BBSet(h_$96,o_$64),i_$10))) ))) && ((from > 0) ==> (h_$96[o_$64,Npr][from] == (Card(FBP(h_$96,BBSet(h_$96,o_$64),from)) + 1)))) && ((to > 0) ==> (h_$96[o_$64,Npr][to] == (Card(FBP(h_$96,BBSet(h_$96,o_$64),to)) - 1)))) && (h_$96[o_$64,Ncpr] >= 0)) && (h_$96[o_$64,Ndpr] >= 0)) ));
...
PreconditionGeneratedEntry:
	goto anon0;
anon0:
	assume $Heap_$_0 == $Heap[this,mset := RemoveMSet($Heap[this,mset],i)];
	assert  $Heap_$_0[this,mset] == RemoveMSet($Heap[this,mset],i);
	assert  (((((forall  o_$74_$0 : ref, f_$3_$0 : field (ref)  :: ( ($Heap_$_0[o_$74_$0,f_$3_$0] == $Heap[o_$74_$0,f_$3_$0]) || ((o_$74_$0 == this) && false) ))) && ((forall  o_$74_$1 : ref, f_$3_$1 : field (TRegion)  :: ( ($Heap_$_0[o_$74_$1,f_$3_$1] == $Heap[o_$74_$1,f_$3_$1]) || ((o_$74_$1 == this) && false) )))) && ((forall  o_$74_$2 : ref, f_$3_$2 : field ([Integer]Integer)  :: ( ($Heap_$_0[o_$74_$2,f_$3_$2] == $Heap[o_$74_$2,f_$3_$2]) || ((o_$74_$2 == this) && (f_$3_$2 == mset)) )))) && ((forall  o_$74_$3 : ref, f_$3_$3 : field (Integer)  :: ( ($Heap_$_0[o_$74_$3,f_$3_$3] == $Heap[o_$74_$3,f_$3_$3]) || ((o_$74_$3 == this) && false) )))) && ((forall  o_$74_$4 : ref, f_$3_$4 : field (TNodeState)  :: ( ($Heap_$_0[o_$74_$4,f_$3_$4] == $Heap[o_$74_$4,f_$3_$4]) || ((o_$74_$4 == this) && false) )));
	goto $exit;
}
