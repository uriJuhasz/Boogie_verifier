...
(assert (! (=> $start (and true 
   (and true
      ...
      (forall( (|h_$9| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o_$20| ref))(= (IsEmptyTree |h_$9| |o_$20|) (and (and (and (and (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$9| |o_$20| Np) null) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$9| |o_$20| Nt) |o_$20|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$9| |o_$20| NA) Empty)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$9| |o_$20| NC) Empty)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$9| |o_$20| ND) Empty))))
...
(assert (! (=> anon0 (and true 
   (and true
      (= Reg1@0 (AddEl Reg2@0 r1))
      (= Reg2@0 (AddEl Reg3@0 r2))
      (= Reg3@0 (AddEl Reg4@0 p1))
      (= Reg4@0 (Singleton p2))
   )
...
(assert (! (=> anon0@6 (and true 
   (and true
      ...
      (forall( (|o_$74_$0| ref) (|f_$3_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 |o_$74_$0| |f_$3_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$74_$0| |f_$3_$0|)) (= |o_$74_$0| r1)))
      (forall( (|o_$74_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o_$74_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$74_$1| |f_$3_$1|)) (= |o_$74_$1| r1)))
      (forall( (|o_$74_$2| ref) (|f_$3_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 |o_$74_$2| |f_$3_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap |o_$74_$2| |f_$3_$2|)) (= |o_$74_$2| r1)))
      (forall( (|o_$74_$3| ref) (|f_$3_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 |o_$74_$3| |f_$3_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap |o_$74_$3| |f_$3_$3|)) (= |o_$74_$3| r1)))
      (forall( (|o_$74_$4| ref) (|f_$3_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@0 |o_$74_$4| |f_$3_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap |o_$74_$4| |f_$3_$4|)) (= |o_$74_$4| r1)))
      (InvPr $Heap@0 r1)
...
(assert (! (=> anon0@13 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 r2 NSt) StF)
      (forall( (|o_$75_$0| ref) (|f_$4_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 |o_$75_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 |o_$75_$0| |f_$4_$0|)) (= |o_$75_$0| r2)))
      (forall( (|o_$75_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$75_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 |o_$75_$1| |f_$4_$1|)) (= |o_$75_$1| r2)))
      (forall( (|o_$75_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 |o_$75_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 |o_$75_$2| |f_$4_$2|)) (= |o_$75_$2| r2)))
      (forall( (|o_$75_$3| ref) (|f_$4_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 |o_$75_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 |o_$75_$3| |f_$4_$3|)) (= |o_$75_$3| r2)))
      (forall( (|o_$75_$4| ref) (|f_$4_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 |o_$75_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@0 |o_$75_$4| |f_$4_$4|)) (= |o_$75_$4| r2)))
      (InvPr $Heap@1 r2)
...
(assert (! (=> anon0@20 (and true 
   (and true
      ...
      (forall( (|o_$76_$0| ref) (|f_$5_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 |o_$76_$0| |f_$5_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 |o_$76_$0| |f_$5_$0|)) (= |o_$76_$0| p1)))
      (forall( (|o_$76_$1| ref) (|f_$5_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$76_$1| |f_$5_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$76_$1| |f_$5_$1|)) (= |o_$76_$1| p1)))
      (forall( (|o_$76_$2| ref) (|f_$5_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@2 |o_$76_$2| |f_$5_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 |o_$76_$2| |f_$5_$2|)) (= |o_$76_$2| p1)))
      (forall( (|o_$76_$3| ref) (|f_$5_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 |o_$76_$3| |f_$5_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 |o_$76_$3| |f_$5_$3|)) (= |o_$76_$3| p1)))
      (forall( (|o_$76_$4| ref) (|f_$5_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@2 |o_$76_$4| |f_$5_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 |o_$76_$4| |f_$5_$4|)) (= |o_$76_$4| p1)))
      (InvPr $Heap@2 p1)
...
(assert (! (=> anon0@27 (and true 
   (and true
      ...
      (forall( (|o_$77_$0| ref) (|f_$6_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 |o_$77_$0| |f_$6_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 |o_$77_$0| |f_$6_$0|)) (= |o_$77_$0| p2)))
      (forall( (|o_$77_$1| ref) (|f_$6_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$77_$1| |f_$6_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$77_$1| |f_$6_$1|)) (= |o_$77_$1| p2)))
      (forall( (|o_$77_$2| ref) (|f_$6_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 |o_$77_$2| |f_$6_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@2 |o_$77_$2| |f_$6_$2|)) (= |o_$77_$2| p2)))
      (forall( (|o_$77_$3| ref) (|f_$6_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 |o_$77_$3| |f_$6_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 |o_$77_$3| |f_$6_$3|)) (= |o_$77_$3| p2)))
      (forall( (|o_$77_$4| ref) (|f_$6_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@3 |o_$77_$4| |f_$6_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@2 |o_$77_$4| |f_$6_$4|)) (= |o_$77_$4| p2)))
      (InvPr $Heap@3 p2)
