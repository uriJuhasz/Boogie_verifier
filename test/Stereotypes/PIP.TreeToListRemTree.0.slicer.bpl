...
anon0:
	...
	assume (forall<a> o_$77 : ref, f_$3 : field (a)  :: ( ((((($Heap_$_0[o_$77,f_$3] == $Heap[o_$77,f_$3]) || ((o_$77 == nextTree_$_0) && (f_$3 == Np))) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77] && (f_$3 == Nt))) || ((o_$77 == tree) && (f_$3 == NC))) || (AddEl($Heap[tree,NA],tree)[o_$77] && (f_$3 == ND))) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77] && (f_$3 == NA)) ));
...
anon2_Then:
	...
	assume (forall<a> o_$89 : ref, f_$4 : field (a)  :: ( ((((($Heap_$_1[o_$89,f_$4] == $Heap_$_0[o_$89,f_$4]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89] && (f_$4 == Np))) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89] && (f_$4 == Nt))) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89] && (f_$4 == NC))) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89] && (f_$4 == ND))) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89] && (f_$4 == NA)) ));
...
GeneratedUnifiedExit:
	...
	assert  (forall<a> o_$95 : ref, f_$5 : field (a)  :: ( ((((($Heap_$_2[o_$95,f_$5] == $Heap[o_$95,f_$5]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95] && (f_$5 == Np))) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95] && (f_$5 == Nt))) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95] && (f_$5 == NC))) || (RemEl($Heap[subTree,NA],subTree)[o_$95] && (f_$5 == ND))) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95] && (f_$5 == NA)) ));
	goto $exit;
}
