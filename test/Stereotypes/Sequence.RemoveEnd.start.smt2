...
(let ((anon0@26_assertion (and
    (forall( (|o_$42_$0| ref) (|f_$2_$0| field$ref$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) |o_$42_$0|) (= Le |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= Le |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= Lb |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= Ln |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= Lp |f_$2_$0|)) (or (and (= |o_$42_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le) Lp)) (= Ln |f_$2_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$42_$0| |f_$2_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$42_$0| |f_$2_$0|)))))))))
    (forall( (|o_$42_$1| ref) (|f_$2_$1| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) |o_$42_$1|) (= LNC |f_$2_$1|)) (or (and (MapRead$$@Map@@ref@To@Bool@@$ (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) |o_$42_$1|) (= LL |f_$2_$1|)) (or (and (= |o_$42_$1| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= LL |f_$2_$1|)) (or (and (= |o_$42_$1| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= LNC |f_$2_$1|)) (or (and (= |o_$42_$1| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le)) (= LPC |f_$2_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$42_$1| |f_$2_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$42_$1| |f_$2_$1|))))))))
)))
...
(let ((anon0 (=> (and true
    (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 oldEnd@0 Lp null))
    (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 oldEnd@0 Ln null))
    (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 oldEnd@0 Lb oldEnd@0))
    (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 oldEnd@0 Le oldEnd@0))
    (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 oldEnd@0 LPC Empty))
    (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 oldEnd@0 LNC Empty))
    (= $Heap@7 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 oldEnd@0 LL (Singleton oldEnd@0)))
    (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap newEnd@0 Ln null) $Heap@0)
    (= (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) oldEnd@0) newList@0)
    (= (Singleton oldEnd@0) call2formal@r2@0)
    (= (Singleton oldEnd@0) call2formal@r2@0)
    (= newEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap oldEnd@0 Lp))
    (= oldEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap list Le))
    (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$33|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL))))
    ...
    (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 |o_$34_$1| |f_$4|))))
    (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$35|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC))))
    ...
    (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$36_$1|) (= LNC |f_$0_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$36_$1| |f_$0_$1|))))
    (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$37|) (= newEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$37| Le))))
    (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$38_$0|) (= Le |f_$1_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|))))
...
(let (($start (=> (and true
    ...
    (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$1| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$8|) |o'_$1|) (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$1|) (not (= |o_$8| |o'_$1|)))))
    ...
    (forall( (|s| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$9| ref))(= (and (MapRead$$@Map@@ref@To@Bool@@$ |s| |o_$9|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$9|))) (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s| |r_$2|) |o_$9|)))
  )
