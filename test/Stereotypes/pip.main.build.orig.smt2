...
;Axioms
   ...
   (assert (! (= StF (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@0 p1 NSt)) :named ax_2))
   ...
   (assert (! (InvPr $Heap@0 p1) :named ax_97))
   (assert (! (InvPr $Heap@0 p2) :named ax_98))
   (assert (! (InvPr $Heap@0 r1) :named ax_99))
   (assert (! (InvPr $Heap@0 r2) :named ax_100))
   (assert (! (InvStruct $Heap@0) :named ax_101))
   (assert (! (InvStruct $Heap@0) :named ax_102))
   (assert (! (InvStructEx $Heap (AddEl (AddEl (AddEl (Singleton r1) r2) p1) p2)) :named ax_103))
   (assert (! (InvStructEx $Heap (AddEl (AddEl (AddEl (Singleton r1) r2) p1) p2)) :named ax_104))
   (assert (! (IsNotAllocated $Heap p1) :named ax_105))
   (assert (! (IsNotAllocated $Heap p1) :named ax_106))
   (assert (! (IsNotAllocated $Heap p2) :named ax_107))
   (assert (! (IsNotAllocated $Heap p2) :named ax_108))
   (assert (! (IsNotAllocated $Heap r1) :named ax_109))
   (assert (! (IsNotAllocated $Heap r1) :named ax_110))
   (assert (! (IsNotAllocated $Heap r2) :named ax_111))
   (assert (! (IsNotAllocated $Heap r2) :named ax_112))
   (assert (! (not (= Le Lb)) :named ax_113))
   (assert (! (not (= Le Lb)) :named ax_114))
   (assert (! (not (= Ln Lb)) :named ax_115))
   (assert (! (not (= Ln Lb)) :named ax_116))
   (assert (! (not (= Ln Le)) :named ax_117))
   (assert (! (not (= Ln Le)) :named ax_118))
   ...
   (assert (! (not (= Lp Ln)) :named ax_124))
   (assert (! (not (= NA LL)) :named ax_125))
   (assert (! (not (= NA LL)) :named ax_126))
   (assert (! (not (= Nbb Lb)) :named ax_127))
   (assert (! (not (= Nbb Lb)) :named ax_128))
   (assert (! (not (= Nbb Le)) :named ax_129))
   (assert (! (not (= Nbb Le)) :named ax_130))
   (assert (! (not (= Nbb Ln)) :named ax_131))
   (assert (! (not (= Nbb Ln)) :named ax_132))
   (assert (! (not (= Nbb Lp)) :named ax_133))
   (assert (! (not (= Nbb Lp)) :named ax_134))
   (assert (! (not (= NC LL)) :named ax_135))
   (assert (! (not (= NC LL)) :named ax_136))
   (assert (! (not (= NC NA)) :named ax_137))
   (assert (! (not (= NC NA)) :named ax_138))
   (assert (! (not (= ND LL)) :named ax_139))
   (assert (! (not (= ND LL)) :named ax_140))
   (assert (! (not (= ND NA)) :named ax_141))
   (assert (! (not (= ND NA)) :named ax_142))
   (assert (! (not (= ND NC)) :named ax_143))
   (assert (! (not (= ND NC)) :named ax_144))
   (assert (! (not (= Ndpr Ncpr)) :named ax_145))
   (assert (! (not (= Ndpr Ncpr)) :named ax_146))
   (assert (! (not (= Np Lb)) :named ax_147))
   (assert (! (not (= Np Lb)) :named ax_148))
   (assert (! (not (= Np Le)) :named ax_149))
   (assert (! (not (= Np Le)) :named ax_150))
   (assert (! (not (= Np Ln)) :named ax_151))
   (assert (! (not (= Np Ln)) :named ax_152))
   (assert (! (not (= Np Lp)) :named ax_153))
   (assert (! (not (= Np Lp)) :named ax_154))
   (assert (! (not (= Np Nbb)) :named ax_155))
   (assert (! (not (= Np Nbb)) :named ax_156))
   (assert (! (not (= Nt Lb)) :named ax_157))
   (assert (! (not (= Nt Lb)) :named ax_158))
   (assert (! (not (= Nt Le)) :named ax_159))
   (assert (! (not (= Nt Le)) :named ax_160))
   (assert (! (not (= Nt Ln)) :named ax_161))
   (assert (! (not (= Nt Ln)) :named ax_162))
   (assert (! (not (= Nt Lp)) :named ax_163))
   (assert (! (not (= Nt Lp)) :named ax_164))
   (assert (! (not (= Nt Nbb)) :named ax_165))
   (assert (! (not (= Nt Nbb)) :named ax_166))
   (assert (! (not (= Nt Np)) :named ax_167))
   (assert (! (not (= Nt Np)) :named ax_168))
   (assert (! (not (= p1 null)) :named ax_169))
   (assert (! (not (= p1 null)) :named ax_170))
   (assert (! (not (= p1 null)) :named ax_171))
   (assert (! (not (= p1 null)) :named ax_172))
   (assert (! (not (= p1 null)) :named ax_173))
   (assert (! (not (= p2 null)) :named ax_174))
   (assert (! (not (= p2 null)) :named ax_175))
   (assert (! (not (= p2 null)) :named ax_176))
   (assert (! (not (= p2 null)) :named ax_177))
   (assert (! (not (= p2 p1)) :named ax_178))
   (assert (! (not (= p2 p1)) :named ax_179))
   (assert (! (not (= r1 null)) :named ax_180))
   (assert (! (not (= r1 null)) :named ax_181))
   (assert (! (not (= r1 null)) :named ax_182))
   (assert (! (not (= r1 null)) :named ax_183))
   (assert (! (not (= r1 p1)) :named ax_184))
   (assert (! (not (= r1 p1)) :named ax_185))
   (assert (! (not (= r1 p2)) :named ax_186))
   (assert (! (not (= r1 p2)) :named ax_187))
   (assert (! (not (= r2 null)) :named ax_188))
   (assert (! (not (= r2 null)) :named ax_189))
   (assert (! (not (= r2 null)) :named ax_190))
   (assert (! (not (= r2 null)) :named ax_191))
   (assert (! (not (= r2 null)) :named ax_192))
   (assert (! (not (= r2 p1)) :named ax_193))
   (assert (! (not (= r2 p1)) :named ax_194))
   (assert (! (not (= r2 p1)) :named ax_195))
   (assert (! (not (= r2 p2)) :named ax_196))
   (assert (! (not (= r2 p2)) :named ax_197))
   (assert (! (not (= r2 r1)) :named ax_198))
   (assert (! (not (= r2 r1)) :named ax_199))
   (assert (! (not (= StF StD)) :named ax_200))
   (assert (! (not (= StF StD)) :named ax_201))
   (assert (! (not (= StL StD)) :named ax_202))
   (assert (! (not (= StL StD)) :named ax_203))
   (assert (! (not (= StL StF)) :named ax_204))
   (assert (! (not (= StL StF)) :named ax_205))
