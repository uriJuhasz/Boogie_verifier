...
(let ((anon0@34_assertion (and
    (forall( (|o_$43_$0| ref) (|f_$2_$0| field$ref$))(or (and (= |o_$43_$0| el) (= Le |f_$2_$0|)) (or (and (= |o_$43_$0| el) (= Lb |f_$2_$0|)) (or (and (= |o_$43_$0| el) (= Ln |f_$2_$0|)) (or (and (= |o_$43_$0| el) (= Lp |f_$2_$0|)) (or (and (= |o_$43_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Le)) (= Ln |f_$2_$0|)) (or (and (= |o_$43_$0| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln)) (= Lp |f_$2_$0|)) (or (and (= |o_$43_$0| listEl) (= Ln |f_$2_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$43_$0| |f_$2_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 |o_$43_$0| |f_$2_$0|))))))))))
    (forall( (|o_$43_$1| ref) (|f_$2_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$2_$1|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LNC) |o_$43_$1|)) (or (and (= LNC |f_$2_$1|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln) LPC) |o_$43_$1|)) (or (and (= LL |f_$2_$1|) (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LL) |o_$43_$1|)) (or (and (= |o_$43_$1| el) (= LL |f_$2_$1|)) (or (and (= |o_$43_$1| el) (= LNC |f_$2_$1|)) (or (and (= |o_$43_$1| el) (= LPC |f_$2_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$43_$1| |f_$2_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$43_$1| |f_$2_$1|)))))))))
)))
...
(let ((anon0@25_assertion (and
    (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 el Ln))
)))
...
(let ((anon0@28_assertion (and
    (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln) LPC) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 el LPC))
)))
(let ((anon0@29_assertion (and
    (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LNC) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 el LNC))
)))
(let ((anon0@3_assertion (and
    (InvNCn1 $Heap@11)
)))
(let ((anon0@30_assertion (and
    (= (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LL) el) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 el LL))
)))
