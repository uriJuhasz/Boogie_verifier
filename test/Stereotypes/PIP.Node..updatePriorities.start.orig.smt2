...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      (>= from 0)
      (>= to 0)
      (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCSet $Heap this) |o_$74|) (InvPr $Heap |o_$74|)))
      (InvPrSt $Heap this from to)
      (InvStruct $Heap)
      (not (= from to))
      (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap this Nbb)))
      (not (= this null))
   )
anon0
...
(assert (! (=> anon0 (and true 
   (and true
      (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap this Ncpr))
   )
