...
;Axioms
   ...
   (assert (! (InvTree $Heap) :named ax_95))
   (assert (! (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap tree ND) subTree) :named ax_96))
   (assert (! (not (= Lb Le)) :named ax_97))
   (assert (! (not (= Lb Nt)) :named ax_98))
   (assert (! (not (= Le Lb)) :named ax_99))
   (assert (! (not (= Le Nt)) :named ax_100))
   (assert (! (not (= LL NC)) :named ax_101))
   (assert (! (not (= LL ND)) :named ax_102))
   (assert (! (not (= Ln Lb)) :named ax_103))
   (assert (! (not (= Ln Le)) :named ax_104))
   (assert (! (not (= Ln Lp)) :named ax_105))
   (assert (! (not (= Ln Nbb)) :named ax_106))
   (assert (! (not (= Ln Nt)) :named ax_107))
   (assert (! (not (= Lp Lb)) :named ax_108))
   (assert (! (not (= Lp Le)) :named ax_109))
   (assert (! (not (= Lp Ln)) :named ax_110))
   (assert (! (not (= Lp Nbb)) :named ax_111))
   (assert (! (not (= Lp Nt)) :named ax_112))
   (assert (! (not (= NA LL)) :named ax_113))
   (assert (! (not (= NA NC)) :named ax_114))
   (assert (! (not (= NA ND)) :named ax_115))
   (assert (! (not (= Nbb Lb)) :named ax_116))
   (assert (! (not (= Nbb Le)) :named ax_117))
   (assert (! (not (= Nbb Ln)) :named ax_118))
   (assert (! (not (= Nbb Lp)) :named ax_119))
   (assert (! (not (= Nbb Nt)) :named ax_120))
   (assert (! (not (= NC LL)) :named ax_121))
   (assert (! (not (= NC NA)) :named ax_122))
   (assert (! (not (= NC ND)) :named ax_123))
   (assert (! (not (= Ncpr Ndpr)) :named ax_124))
   (assert (! (not (= ND LL)) :named ax_125))
   (assert (! (not (= ND NA)) :named ax_126))
   (assert (! (not (= ND NC)) :named ax_127))
   (assert (! (not (= Ndpr Ncpr)) :named ax_128))
   (assert (! (not (= Np Lb)) :named ax_129))
   (assert (! (not (= Np Le)) :named ax_130))
   (assert (! (not (= Np Ln)) :named ax_131))
   (assert (! (not (= Np Lp)) :named ax_132))
   (assert (! (not (= Np Nbb)) :named ax_133))
   (assert (! (not (= Np Nt)) :named ax_134))
   (assert (! (not (= Nt Lb)) :named ax_135))
   (assert (! (not (= Nt Le)) :named ax_136))
   (assert (! (not (= Nt Ln)) :named ax_137))
   (assert (! (not (= Nt Lp)) :named ax_138))
   (assert (! (not (= Nt Nbb)) :named ax_139))
   (assert (! (not (= Nt Np)) :named ax_140))
   (assert (! (not (= StF StD)) :named ax_141))
   (assert (! (not (= StF StL)) :named ax_142))
   (assert (! (not (= StL StD)) :named ax_143))
   (assert (! (not (= StL StF)) :named ax_144))
   (assert (! (not (= subTree null)) :named ax_145))
   (assert (! (not (= tree null)) :named ax_146))
   (assert (! true :named ax_147))
...
(assert (! (=> anon0@7 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 tree Lb) (CLn $Heap@0 tree))
...
(assert (! (=> anon0@18 (and true 
   (and true
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 tree Lb) (CLn $Heap@1 tree))
...
(assert (! (=> anon0@25 (and true 
   (and true
      ...
      (not (= subTree (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 tree Ln)))
      (not (= tree (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 tree Ln)))
   )
