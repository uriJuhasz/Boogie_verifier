...
;Axioms
   ...
   (assert (! (= (Singleton p2) Reg4@0) :named ax_2))
   ...
   (assert (! (not (= Nt Lp)) :named ax_152))
   (assert (! (not (= Nt Nbb)) :named ax_153))
   (assert (! (not (= Nt Nbb)) :named ax_154))
   (assert (! (not (= Nt Np)) :named ax_155))
   (assert (! (not (= Nt Np)) :named ax_156))
   (assert (! (not (= p1 null)) :named ax_157))
   (assert (! (not (= p1 null)) :named ax_158))
   (assert (! (not (= p1 null)) :named ax_159))
   (assert (! (not (= p2 null)) :named ax_160))
   (assert (! (not (= p2 null)) :named ax_161))
   (assert (! (not (= p2 null)) :named ax_162))
   (assert (! (not (= p2 p1)) :named ax_163))
   (assert (! (not (= p2 p1)) :named ax_164))
   (assert (! (not (= r1 null)) :named ax_165))
   (assert (! (not (= r1 null)) :named ax_166))
   (assert (! (not (= r1 null)) :named ax_167))
   (assert (! (not (= r1 p1)) :named ax_168))
   (assert (! (not (= r1 p1)) :named ax_169))
   (assert (! (not (= r1 p2)) :named ax_170))
   (assert (! (not (= r1 p2)) :named ax_171))
   (assert (! (not (= r2 null)) :named ax_172))
   (assert (! (not (= r2 null)) :named ax_173))
   (assert (! (not (= r2 null)) :named ax_174))
   (assert (! (not (= r2 p1)) :named ax_175))
   (assert (! (not (= r2 p1)) :named ax_176))
   (assert (! (not (= r2 p2)) :named ax_177))
   (assert (! (not (= r2 p2)) :named ax_178))
   (assert (! (not (= r2 r1)) :named ax_179))
   (assert (! (not (= r2 r1)) :named ax_180))
   (assert (! (not (= StF StD)) :named ax_181))
   (assert (! (not (= StF StD)) :named ax_182))
   (assert (! (not (= StL StD)) :named ax_183))
   (assert (! (not (= StL StD)) :named ax_184))
   (assert (! (not (= StL StF)) :named ax_185))
   (assert (! (not (= StL StF)) :named ax_186))
...
(let ((anon0@27 (=> (and true
    ...
    (InvPr $Heap@3 p2)
    (InvStructEx $Heap@3 (Minus Reg4@0 (Singleton p2)))
