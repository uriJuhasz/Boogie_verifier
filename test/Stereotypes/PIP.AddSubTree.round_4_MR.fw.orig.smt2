...
;Axioms
   (assert (! (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 tree NC (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 tree NC) subTree))) :named ax_0))
   (assert (! (= (Card Empty) 0) :named ax_1))
   (assert (! (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap subTree Np tree) $Heap@0) :named ax_2))
   (assert (! (= (MaxMSet EmptyMSet) 0) :named ax_3))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 tree NA) tree)) :named ax_4))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 subTree ND) subTree)) :named ax_5))
   (assert (! (= call0formal@r1@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 subTree ND) subTree)) :named ax_6))
   (assert (! (= call2formal@r2@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 subTree ND) subTree)) :named ax_7))
   (assert (! (= call2formal@r2@0 (AddEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 tree NA) tree)) :named ax_8))
   (assert (! (= call2formal@val@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 tree Nt)) :named ax_9))
   (assert (! (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap subTree Np)) :named ax_10))
   ...
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$74|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$74| ND) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$74| ND)))) :named ax_101))
   ...
   (assert (! (forall( (|o_$75_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= ND |f_$3_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$75_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$75_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@1 |o_$75_$1| |f_$3_$1|)))) :named ax_103))
   ...
   (assert (! (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$76|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$76| NA) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$76| NA)))) :named ax_107))
   ...
   (assert (! (forall( (|o_$77_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= NA |f_$4_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$77_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@3 |o_$77_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 |o_$77_$1| |f_$4_$1|)))) :named ax_109))
   ...
   (assert (! (forall( (|o_$78| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$78|) (= call2formal@val@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$78| Nt)))) :named ax_113))
   ...
   (assert (! (not (= Le Lb)) :named ax_132))
   (assert (! (not (= Le Lb)) :named ax_133))
   (assert (! (not (= Ln Lb)) :named ax_134))
   (assert (! (not (= Ln Lb)) :named ax_135))
   (assert (! (not (= Ln Le)) :named ax_136))
   (assert (! (not (= Ln Le)) :named ax_137))
   (assert (! (not (= Lp Lb)) :named ax_138))
   (assert (! (not (= Lp Lb)) :named ax_139))
   (assert (! (not (= Lp Le)) :named ax_140))
   (assert (! (not (= Lp Le)) :named ax_141))
   (assert (! (not (= Lp Ln)) :named ax_142))
   (assert (! (not (= Lp Ln)) :named ax_143))
   (assert (! (not (= NA LL)) :named ax_144))
   (assert (! (not (= NA LL)) :named ax_145))
   (assert (! (not (= Nbb Lb)) :named ax_146))
   (assert (! (not (= Nbb Lb)) :named ax_147))
   (assert (! (not (= Nbb Le)) :named ax_148))
   (assert (! (not (= Nbb Le)) :named ax_149))
   (assert (! (not (= Nbb Ln)) :named ax_150))
   (assert (! (not (= Nbb Ln)) :named ax_151))
   (assert (! (not (= Nbb Lp)) :named ax_152))
   (assert (! (not (= Nbb Lp)) :named ax_153))
   (assert (! (not (= NC LL)) :named ax_154))
   (assert (! (not (= NC LL)) :named ax_155))
   (assert (! (not (= NC NA)) :named ax_156))
   (assert (! (not (= NC NA)) :named ax_157))
   (assert (! (not (= ND LL)) :named ax_158))
   ...
   (assert (! (not (= Np Le)) :named ax_169))
   (assert (! (not (= Np Ln)) :named ax_170))
   (assert (! (not (= Np Ln)) :named ax_171))
   (assert (! (not (= Np Lp)) :named ax_172))
   (assert (! (not (= Np Lp)) :named ax_173))
   (assert (! (not (= Np Nbb)) :named ax_174))
   (assert (! (not (= Np Nbb)) :named ax_175))
   (assert (! (not (= Nt Lb)) :named ax_176))
   (assert (! (not (= Nt Lb)) :named ax_177))
   (assert (! (not (= Nt Le)) :named ax_178))
   (assert (! (not (= Nt Le)) :named ax_179))
   (assert (! (not (= Nt Ln)) :named ax_180))
   (assert (! (not (= Nt Ln)) :named ax_181))
   (assert (! (not (= Nt Lp)) :named ax_182))
   (assert (! (not (= Nt Lp)) :named ax_183))
   (assert (! (not (= Nt Nbb)) :named ax_184))
   (assert (! (not (= Nt Nbb)) :named ax_185))
   (assert (! (not (= Nt Np)) :named ax_186))
   (assert (! (not (= Nt Np)) :named ax_187))
   (assert (! (not (= StF StD)) :named ax_188))
   (assert (! (not (= StF StD)) :named ax_189))
   (assert (! (not (= StL StD)) :named ax_190))
   (assert (! (not (= StL StD)) :named ax_191))
   (assert (! (not (= StL StF)) :named ax_192))
   (assert (! (not (= StL StF)) :named ax_193))
   (assert (! (not (= subTree null)) :named ax_194))
   (assert (! (not (= tree null)) :named ax_195))
   (assert (! (not (= tree subTree)) :named ax_196))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap subTree ND) tree)) :named ax_197))
