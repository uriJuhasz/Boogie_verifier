...
;Axioms
   ...
   (assert (! (forall ((|v_9| $@Map@@Int@To@Int@@)(|i_18| field$$@Map@@Int@To@Int@@$)(|i_17| ref)(|j_14| field$ref$)(|j_13| ref)(|m_9| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_9 j_13 j_14) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_9 i_17 i_18 v_9) j_13 j_14)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_9 i_17 i_18 v_9) j_13 j_14)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_23))
   (assert (! (not (= Le Lb)) :named ax_24))
   (assert (! (not (= Le Lb)) :named ax_25))
   (assert (! (not (= Ln Lb)) :named ax_26))
   (assert (! (not (= Ln Lb)) :named ax_27))
   (assert (! (not (= Ln Le)) :named ax_28))
   (assert (! (not (= Ln Le)) :named ax_29))
   (assert (! (not (= Lp Lb)) :named ax_30))
   (assert (! (not (= Lp Lb)) :named ax_31))
   (assert (! (not (= Lp Le)) :named ax_32))
   (assert (! (not (= Lp Le)) :named ax_33))
   (assert (! (not (= Lp Ln)) :named ax_34))
   (assert (! (not (= Lp Ln)) :named ax_35))
   (assert (! (not (= NA LL)) :named ax_36))
   (assert (! (not (= NA LL)) :named ax_37))
   (assert (! (not (= Nbb Lb)) :named ax_38))
   (assert (! (not (= Nbb Lb)) :named ax_39))
   (assert (! (not (= Nbb Le)) :named ax_40))
   (assert (! (not (= Nbb Le)) :named ax_41))
   (assert (! (not (= Nbb Ln)) :named ax_42))
   (assert (! (not (= Nbb Ln)) :named ax_43))
   (assert (! (not (= Nbb Lp)) :named ax_44))
   (assert (! (not (= Nbb Lp)) :named ax_45))
   (assert (! (not (= NC LL)) :named ax_46))
   (assert (! (not (= NC LL)) :named ax_47))
   (assert (! (not (= NC NA)) :named ax_48))
   (assert (! (not (= NC NA)) :named ax_49))
   (assert (! (not (= ND LL)) :named ax_50))
   (assert (! (not (= ND LL)) :named ax_51))
   (assert (! (not (= ND NA)) :named ax_52))
   (assert (! (not (= ND NA)) :named ax_53))
   (assert (! (not (= ND NC)) :named ax_54))
   (assert (! (not (= ND NC)) :named ax_55))
   (assert (! (not (= Ndpr Ncpr)) :named ax_56))
   (assert (! (not (= Ndpr Ncpr)) :named ax_57))
   (assert (! (not (= Np Lb)) :named ax_58))
   (assert (! (not (= Np Lb)) :named ax_59))
   (assert (! (not (= Np Le)) :named ax_60))
   (assert (! (not (= Np Le)) :named ax_61))
   (assert (! (not (= Np Ln)) :named ax_62))
   (assert (! (not (= Np Ln)) :named ax_63))
   (assert (! (not (= Np Lp)) :named ax_64))
   (assert (! (not (= Np Lp)) :named ax_65))
   (assert (! (not (= Np Nbb)) :named ax_66))
   (assert (! (not (= Np Nbb)) :named ax_67))
   (assert (! (not (= Nt Lb)) :named ax_68))
   (assert (! (not (= Nt Lb)) :named ax_69))
   (assert (! (not (= Nt Le)) :named ax_70))
   (assert (! (not (= Nt Le)) :named ax_71))
   (assert (! (not (= Nt Ln)) :named ax_72))
   (assert (! (not (= Nt Ln)) :named ax_73))
   (assert (! (not (= Nt Lp)) :named ax_74))
   (assert (! (not (= Nt Lp)) :named ax_75))
   (assert (! (not (= Nt Nbb)) :named ax_76))
   (assert (! (not (= Nt Nbb)) :named ax_77))
   (assert (! (not (= Nt Np)) :named ax_78))
   (assert (! (not (= Nt Np)) :named ax_79))
   (assert (! (not (= StF StD)) :named ax_80))
   (assert (! (not (= StF StD)) :named ax_81))
   (assert (! (not (= StL StD)) :named ax_82))
   (assert (! (not (= StL StD)) :named ax_83))
   (assert (! (not (= StL StF)) :named ax_84))
   (assert (! (not (= StL StF)) :named ax_85))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      (>= priority 0)
      (InvStructEx $Heap NotAllocated)
      (IsNotAllocated $Heap this)
