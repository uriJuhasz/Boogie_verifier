...
anon0:
	...
	assume (forall<a> o_$34 : ref, f : field (a)  :: ( ($Heap_$_9[o_$34,f] == $Heap_$_8[o_$34,f]) || (newel_$_0[o_$34] && (f == LL)) ));
	assume call2formal_$_r2_$_0 == Singleton(el);
	assume (forall  o_$35 : ref :: ( elLPC_$_0[o_$35] ==> ($Heap_$_10[o_$35,LNC] == Minus($Heap_$_9[o_$35,LNC],call2formal_$_r2_$_0)) ));
	assume (forall<a> o_$36 : ref, f_$0 : field (a)  :: ( ($Heap_$_10[o_$36,f_$0] == $Heap_$_9[o_$36,f_$0]) || (elLPC_$_0[o_$36] && (f_$0 == LNC)) ));
	assume call2formal_$_r2_$_0 == Singleton(el);
	assume (forall  o_$37 : ref :: ( elLNC_$_0[o_$37] ==> ($Heap_$_11[o_$37,LPC] == Minus($Heap_$_10[o_$37,LPC],call2formal_$_r2_$_0)) ));
	assume (forall<a> o_$38 : ref, f_$1 : field (a)  :: ( ($Heap_$_11[o_$38,f_$1] == $Heap_$_10[o_$38,f_$1]) || (elLNC_$_0[o_$38] && (f_$1 == LPC)) ));
	...
	assert  (forall<a> o_$42 : ref, f_$2 : field (a)  :: ( (((((((((((($Heap_$_11[o_$42,f_$2] == $Heap[o_$42,f_$2]) || ((o_$42 == $Heap[el,Lp]) && (f_$2 == Ln))) || ((o_$42 == $Heap[el,Ln]) && (f_$2 == Lp))) || ((o_$42 == el) && (f_$2 == Lp))) || ((o_$42 == el) && (f_$2 == Ln))) || ((o_$42 == el) && (f_$2 == Lb))) || ((o_$42 == el) && (f_$2 == Le))) || ((o_$42 == el) && (f_$2 == LPC))) || ((o_$42 == el) && (f_$2 == LNC))) || ((o_$42 == el) && (f_$2 == LL))) || (RemEl($Heap[el,LL],el)[o_$42] && (f_$2 == LL))) || ($Heap[el,LPC][o_$42] && (f_$2 == LNC))) || ($Heap[el,LNC][o_$42] && (f_$2 == LPC)) ));
	goto $exit;
}
