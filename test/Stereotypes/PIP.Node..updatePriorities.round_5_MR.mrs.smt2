...
(declare-fun call0formal@this@0 ( ) ref)
...
(declare-fun anon2@1 ( ) Bool)
(declare-fun anon2_assertion ( ) Bool)
...
(declare-fun anon8_Then@1 ( ) Bool)
(declare-fun anon8_Then@1_assertion ( ) Bool)
(declare-fun anon8_Then@2 ( ) Bool)
(declare-fun anon8_Then@4_assertion ( ) Bool)
(declare-fun anon8_Then@5 ( ) Bool)
(declare-fun anon8_Then@5_assertion ( ) Bool)
(declare-fun anon8_Then@6 ( ) Bool)
(declare-fun anon8_Then@6_assertion ( ) Bool)
(declare-fun anon8_Then@7 ( ) Bool)
(declare-fun anon8_Then_assertion ( ) Bool)
...
;Axioms
   ...
   (assert (! (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap this Ncpr)) :named ax_3))
   (assert (! (forall ((|i_14| field$Int$)(|i_13| ref)(|m_7| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_7| Int))(!(= v_7 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_7 i_13 i_14 v_7) i_13 i_14)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_7 i_13 i_14 v_7) i_13 i_14)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_4))
   (assert (! (forall ((|i_2| field$$@Map@@Int@To@Int@@$)(|i_1| ref)(|m_1| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|v_1| $@Map@@Int@To@Int@@))(!(= v_1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_1 i_1 i_2 v_1) i_1 i_2)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_1 i_1 i_2 v_1) i_1 i_2)) :qid map_1_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_5))
   (assert (! (forall ((|v_10| Int)(|i_20| field$Int$)(|i_19| ref)(|j_16| field$$@Map@@ref@To@Bool@@$)(|j_15| ref)(|m_10| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_10 j_15 j_16) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_10 i_19 i_20 v_10) j_15 j_16)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_10 i_19 i_20 v_10) j_15 j_16)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__Int :weight 0 )) :named ax_6))
   (assert (! (forall ((|v_11| Int)(|i_22| field$Int$)(|i_21| ref)(|j_18| field$TNodeState$)(|j_17| ref)(|m_11| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_11 j_17 j_18) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_11 i_21 i_22 v_11) j_17 j_18)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_11 i_21 i_22 v_11) j_17 j_18)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__TNodeState__Int :weight 0 )) :named ax_7))
   (assert (! (forall ((|v_12| Int)(|i_24| field$Int$)(|i_23| ref)(|j_20| field$$@Map@@Int@To@Int@@$)(|j_19| ref)(|m_12| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_12 j_19 j_20) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_12 i_23 i_24 v_12) j_19 j_20)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_12 i_23 i_24 v_12) j_19 j_20)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@Int@To@Int@@__Int :weight 0 )) :named ax_8))
   (assert (! (forall ((|v_2| $@Map@@Int@To@Int@@)(|m_2| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_4| field$$@Map@@Int@To@Int@@$)(|j_2| field$$@Map@@Int@To@Int@@$)(|i_3| ref)(|j_1| ref))(!(=> (or (not (= j_2 i_4)) (not (= j_1 i_3))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_2 j_1 j_2) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_2 i_3 i_4 v_2) j_1 j_2))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_2 i_3 i_4 v_2) j_1 j_2)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_9))
   (assert (! (forall ((|v_3| $@Map@@Int@To@Int@@)(|i_6| field$$@Map@@Int@To@Int@@$)(|i_5| ref)(|j_4| field$ref$)(|j_3| ref)(|m_3| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_3 j_3 j_4) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_3 i_5 i_6 v_3) j_3 j_4)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_3 i_5 i_6 v_3) j_3 j_4)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_10))
   (assert (! (forall ((|v_4| $@Map@@Int@To@Int@@)(|i_8| field$$@Map@@Int@To@Int@@$)(|i_7| ref)(|j_6| field$$@Map@@ref@To@Bool@@$)(|j_5| ref)(|m_4| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ m_4 j_5 j_6) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_4 i_7 i_8 v_4) j_5 j_6)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_4 i_7 i_8 v_4) j_5 j_6)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__$@Map@@ref@To@Bool@@__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_11))
   (assert (! (forall ((|v_5| $@Map@@Int@To@Int@@)(|i_10| field$$@Map@@Int@To@Int@@$)(|i_9| ref)(|j_8| field$Int$)(|j_7| ref)(|m_5| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_5 j_7 j_8) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_5 i_9 i_10 v_5) j_7 j_8)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_5 i_9 i_10 v_5) j_7 j_8)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__Int__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_12))
   (assert (! (forall ((|v_6| $@Map@@Int@To@Int@@)(|i_12| field$$@Map@@Int@To@Int@@$)(|i_11| ref)(|j_10| field$TNodeState$)(|j_9| ref)(|m_6| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ m_6 j_9 j_10) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_6 i_11 i_12 v_6) j_9 j_10)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ m_6 i_11 i_12 v_6) j_9 j_10)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__TNodeState__$@Map@@Int@To@Int@@ :weight 0 )) :named ax_13))
   (assert (! (forall ((|v_8| Int)(|m_8| $@Map@@$T0@@ref@field$$T0$@To@$T0@@)(|i_16| field$Int$)(|j_12| field$Int$)(|i_15| ref)(|j_11| ref))(!(=> (or (not (= j_12 i_16)) (not (= j_11 i_15))) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_8 j_11 j_12) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_8 i_15 i_16 v_8) j_11 j_12))):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_8 i_15 i_16 v_8) j_11 j_12)) :qid map_2_$@Map@@$T0@@ref@field$$T0$@To@$T0@@ :weight 0 )) :named ax_14))
   (assert (! (forall ((|v_9| Int)(|i_18| field$Int$)(|i_17| ref)(|j_14| field$ref$)(|j_13| ref)(|m_9| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(!(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ m_9 j_13 j_14) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_9 i_17 i_18 v_9) j_13 j_14)):pattern ( (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ m_9 i_17 i_18 v_9) j_13 j_14)) :qid map_3_$@Map@@$T0@@ref@field$$T0$@To@$T0@@__ref__Int :weight 0 )) :named ax_15))
   ...
   (assert (! (forall( (|h_$4| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|r_$4| $@Map@@ref@To@Bool@@) (|i_$7| Int) (|o_$15| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (FBP |h_$4| |r_$4| |i_$7|) |o_$15|) (and (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$4| |o_$15|) (= |i_$7| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$4| |o_$15| Ncpr))) (not (= |o_$15| null))))) :named ax_54))
   ...
   (assert (! (forall( (|h_$99| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|hOld_$1| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|this_$2| ref) (|child| ref) (|newNcpr| Int))(=> (and (and (= |newNcpr| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$99| |child| Ncpr)) (and (and (and (>= |newNcpr| 0) (and (InvPr |hOld_$1| |this_$2|) (MapRead$$@Map@@ref@To@Bool@@$ (BBSet |hOld_$1| |this_$2|) |child|))) (not (= null |child|))) (not (= |newNcpr| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |hOld_$1| |child| Ncpr))))) (and (forall( (|o_$67_$4| ref) (|f_$1_$4| field$TNodeState$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ |hOld_$1| |o_$67_$4| |f_$1_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ |h_$99| |o_$67_$4| |f_$1_$4|))) (and (forall( (|o_$67_$3| ref) (|f_$1_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |hOld_$1| |o_$67_$3| |f_$1_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$99| |o_$67_$3| |f_$1_$3|)) (and (= |o_$67_$3| |child|) (= Ncpr |f_$1_$3|)))) (and (forall( (|o_$67_$2| ref) (|f_$1_$2| field$$@Map@@Int@To@Int@@$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ |hOld_$1| |o_$67_$2| |f_$1_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ |h_$99| |o_$67_$2| |f_$1_$2|))) (and (forall( (|o_$67_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |hOld_$1| |o_$67_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h_$99| |o_$67_$1| |f_$1_$1|))) (forall( (|o_$67_$0| ref) (|f_$1_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |hOld_$1| |o_$67_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h_$99| |o_$67_$0| |f_$1_$0|)))))))) (InvPrSt |h_$99| |this_$2| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |hOld_$1| |child| Ncpr) |newNcpr|))) :named ax_87))
   (assert (! (forall( (|h| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|o| ref))(!(= (IsNotAllocatedTree |h| |o|) (forall( (|o'| ref))(and (and (and (and (not (= |o| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o'| Nt))) (not (= |o| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ |h| |o'| Np)))) (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o'| NA) |o|))) (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o'| NC) |o|))) (not (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ |h| |o'| ND) |o|)))))  :pattern ( (IsNotAllocatedTree |h| |o|)))) :named ax_88))
   (assert (! (forall( (|i_$0| Int))(!(not (InMSet EmptyMSet |i_$0|))  :pattern ( (MapRead$$@Map@@Int@To@Int@@$ EmptyMSet |i_$0|)))) :named ax_89))
   (assert (! (forall( (|i_$6| Int) (|j_$1| Int))(!(and (and (>= (Max |i_$6| |j_$1|) |j_$1|) (>= (Max |i_$6| |j_$1|) |i_$6|)) (or (= (Max |i_$6| |j_$1|) |j_$1|) (= (Max |i_$6| |j_$1|) |i_$6|)))  :pattern ( (Max |i_$6| |j_$1|)))) :named ax_90))
   (assert (! (forall( (|m| $@Map@@Int@To@Int@@) (|i| Int))(!(= (InMSet |m| |i|) (not (= (MapRead$$@Map@@Int@To@Int@@$ |m| |i|) 0)))  :pattern ( (InMSet |m| |i|)))) :named ax_91))
   (assert (! (forall( (|o_$2| ref))(!(not (MapRead$$@Map@@ref@To@Bool@@$ Empty |o_$2|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ Empty |o_$2|)))) :named ax_92))
   (assert (! (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCSet $Heap this) |o_$74|) (InvPr $Heap |o_$74|))) :named ax_93))
   (assert (! (forall( (|r_$0| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$2| ref))(!(= (or (MapRead$$@Map@@ref@To@Bool@@$ |r_$0| |o'_$2|) (= |o_$8| |o'_$2|)) (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$0| |o_$8|) |o'_$2|)))) :named ax_94))
   (assert (! (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$9| ref) (|o'_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|) (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$3|) (not (= |o_$9| |o'_$3|))))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$1| |o_$9|) |o'_$3|)))) :named ax_95))
   (assert (! (forall( (|r_$3| $@Map@@ref@To@Bool@@))(!(= (IsGoodRegion |r_$3|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| null)))  :pattern ( (IsGoodRegion |r_$3|)))) :named ax_96))
   (assert (! (forall( (|r| ref) (|o_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|) (= |r| |o_$3|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Singleton |r|) |o_$3|)))) :named ax_97))
   (assert (! (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|r_$2| $@Map@@ref@To@Bool@@) (|o_$10| ref))(!(= (and (MapRead$$@Map@@ref@To@Bool@@$ |s_$0| |o_$10|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o_$10|))) (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$2|) |o_$10|)))) :named ax_98))
   (assert (! (forall( (|s_$1| $@Map@@ref@To@Bool@@) (|o_$11| ref))(=> (not (MapRead$$@Map@@ref@To@Bool@@$ |s_$1| |o_$11|)) (= (+ (Card |s_$1|) 1) (Card (AddEl |s_$1| |o_$11|))))) :named ax_99))
   (assert (! (forall( (|s_$2| $@Map@@ref@To@Bool@@) (|o_$12| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ |s_$2| |o_$12|) (= (- (Card |s_$2|) 1) (Card (RemEl |s_$2| |o_$12|))))) :named ax_100))
   (assert (! (forall( (|s_$3| $@Map@@ref@To@Bool@@) (|t_$0| $@Map@@ref@To@Bool@@))(=> (Equal |s_$3| |t_$0|) (= (Card |t_$0|) (Card |s_$3|)))) :named ax_101))
   (assert (! (forall( (|s_$4| $@Map@@ref@To@Bool@@) (|t_$1| $@Map@@ref@To@Bool@@))(=> (Equal |s_$4| |t_$1|) (= |t_$1| |s_$4|))) :named ax_102))
   (assert (! (forall( (|s| $@Map@@Int@To@Int@@) (|t| $@Map@@Int@To@Int@@))(!(=> (EqualMSet |s| |t|) (= (MaxMSet |t|) (MaxMSet |s|)))  :pattern ( (EqualMSet |s| |t|)))) :named ax_103))
   (assert (! (forall( (|St| TNodeState))(or (= StD |St|) (or (= StL |St|) (= StF |St|)))) :named ax_104))
   (assert (! (InvPrSt $Heap this from to) :named ax_105))
   (assert (! (InvStruct $Heap) :named ax_106))
   (assert (! (not (< from 0)) :named ax_107))
   (assert (! (not (< to 0)) :named ax_108))
   (assert (! (not (= from to)) :named ax_109))
   ...
   (assert (! (not (= Lp Nt)) :named ax_123))
   (assert (! (not (= NA LL)) :named ax_124))
   (assert (! (not (= NA NC)) :named ax_125))
   (assert (! (not (= NA ND)) :named ax_126))
   (assert (! (not (= Nbb Lb)) :named ax_127))
   (assert (! (not (= Nbb Le)) :named ax_128))
   (assert (! (not (= Nbb Ln)) :named ax_129))
   (assert (! (not (= Nbb Lp)) :named ax_130))
   (assert (! (not (= Nbb Nt)) :named ax_131))
   (assert (! (not (= NC LL)) :named ax_132))
   (assert (! (not (= NC NA)) :named ax_133))
   (assert (! (not (= NC ND)) :named ax_134))
   (assert (! (not (= Ncpr Ndpr)) :named ax_135))
   (assert (! (not (= ND LL)) :named ax_136))
   (assert (! (not (= ND NA)) :named ax_137))
   (assert (! (not (= ND NC)) :named ax_138))
   (assert (! (not (= Ndpr Ncpr)) :named ax_139))
   (assert (! (not (= Np Lb)) :named ax_140))
   (assert (! (not (= Np Le)) :named ax_141))
   (assert (! (not (= Np Ln)) :named ax_142))
   (assert (! (not (= Np Lp)) :named ax_143))
   (assert (! (not (= Np Nbb)) :named ax_144))
   (assert (! (not (= Np Nt)) :named ax_145))
   (assert (! (not (= Nt Lb)) :named ax_146))
   (assert (! (not (= Nt Le)) :named ax_147))
   (assert (! (not (= Nt Ln)) :named ax_148))
   (assert (! (not (= Nt Lp)) :named ax_149))
   (assert (! (not (= Nt Nbb)) :named ax_150))
   (assert (! (not (= Nt Np)) :named ax_151))
   (assert (! (not (= null this)) :named ax_152))
   (assert (! (not (= StF StD)) :named ax_153))
   (assert (! (not (= StF StL)) :named ax_154))
   (assert (! (not (= StL StD)) :named ax_155))
   (assert (! (not (= StL StF)) :named ax_156))
   (assert (! (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap this Nbb))) :named ax_157))
   (assert (! (not (= true false)) :named ax_158))
   (assert (! true :named ax_159))
...
(assert (! (=> anon6_Then (and true 
   (and true
      ...
      (< 0 from)
      (= $Heap@0 $Heap@1)
      (= $Heap@0 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 this Npr)))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@0 this Npr) (RemoveMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap this Npr) from))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb) Ncpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb) Ncpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb) Ndpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb) Ndpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 this Ndpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap this Ndpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap this Nbb))
      (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@0 this Ncpr))
      (not (= from 0))
      (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 this Nbb)))
   )
anon2
)) :named ax_anon6_Then))
...
(or anon2@1 anon2_assertion)
)) :named ax_anon2))
(assert (! (=> anon2@1 (and true 
   (and true
      (InvPrSt $Heap@1 this 0 to)
      (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb)))
   )
(or anon7_Else anon7_Then)
)) :named ax_anon2@1))
(assert (! (=> anon2_assertion (not (and true
   (and true
      (InvPrSt $Heap@1 this 0 to)
   )
))) :named ax_anon2_assertion))
...
(assert (! (=> anon7_Then (and true 
   (and true
      ...
      (< 0 to)
      (= $Heap@2 $Heap@3)
      (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 this Npr (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@2 this Npr)))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@2 this Npr) (AddMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@1 this Npr) to))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb) Ncpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb) Ncpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb) Ndpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb) Ndpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@1 this Ndpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 this Ndpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 this Nbb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 this Nbb))
      (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@2 this Ncpr))
      (not (= to 0))
   )
anon4
)) :named ax_anon7_Then))
...
(assert (! (=> anon4@1 (and true 
   (and true
      (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 this Ncpr (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr)))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb) Ncpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb) Ncpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb) Ndpr) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb) Ndpr))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr) (Max (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@3 this Ndpr) (MaxMSet (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@3 this Npr))))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb))
      (InvPrSt $Heap@3 this 0 0)
      (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 this Nbb)))
   )
...
(assert (! (=> anon8_Else (and true 
   (and true
      (= $Heap@4 $Heap@6)
      (not $@condition_$1)
      (not (= this (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb)))
      (or (= null (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb)) (= oldPriority@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr)))
   )
...
(assert (! (=> anon8_Then (and true 
   (and true
      $@condition_$1
      (= call0formal@this@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap this Nbb))
      (= call0formal@this@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 this Nbb))
      (= call2formal@to@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 this Ncpr))
      (not (= null call0formal@this@0))
      (not (= oldPriority@0 call2formal@to@0))
      (not (= this call0formal@this@0))
   )
(or anon8_Then@1 anon8_Then_assertion)
)) :named ax_anon8_Then))
(assert (! (=> anon8_Then@1 (and true 
   (and true
      (not (< oldPriority@0 0))
   )
(or anon8_Then@1_assertion anon8_Then@2)
)) :named ax_anon8_Then@1))
(assert (! (=> anon8_Then_assertion (not (and true
   (and true
      (>= oldPriority@0 0)
   )
))) :named ax_anon8_Then_assertion))
(assert (! (=> anon8_Then@1_assertion (not (and true
   (and true
      (>= call2formal@to@0 0)
   )
))) :named ax_anon8_Then@1_assertion))
(assert (! (=> anon8_Then@2 (and true 
   (and true
      (not (< call2formal@to@0 0))
   )
(or anon8_Then@4_assertion anon8_Then@5)
)) :named ax_anon8_Then@2))
(assert (! (=> anon8_Then@4_assertion (not (and true
   (and true
      (InvStruct $Heap@4)
   )
))) :named ax_anon8_Then@4_assertion))
(assert (! (=> anon8_Then@5 (and true 
   (and true
      (InvStruct $Heap@4)
   )
(or anon8_Then@5_assertion anon8_Then@6)
)) :named ax_anon8_Then@5))
(assert (! (=> anon8_Then@5_assertion (not (and true
   (and true
      (InvPrSt $Heap@4 call0formal@this@0 oldPriority@0 call2formal@to@0)
   )
))) :named ax_anon8_Then@5_assertion))
(assert (! (=> anon8_Then@6 (and true 
   (and true
      (InvPrSt $Heap@4 call0formal@this@0 oldPriority@0 call2formal@to@0)
   )
(or anon8_Then@6_assertion anon8_Then@7)
)) :named ax_anon8_Then@6))
(assert (! (=> anon8_Then@6_assertion (not (and true
   (and true
      (forall( (|o_$75| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCSet $Heap@4 call0formal@this@0) |o_$75|) (InvPr $Heap@4 |o_$75|)))
   )
))) :named ax_anon8_Then@6_assertion))
(assert (! (=> anon8_Then@7 (and true 
   (and true
      (= $Heap@5 $Heap@6)
      (= call0formal@this@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 this Nbb))
      (forall( (|o_$75| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCSet $Heap@4 call0formal@this@0) |o_$75|) (InvPr $Heap@4 |o_$75|)))
      (forall( (|o_$76| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@5 call0formal@this@0) |o_$76|) (InvPr $Heap@5 |o_$76|)))
      (forall( (|o_$77_$0| ref) (|f_$3_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@5 |o_$77_$0| |f_$3_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 |o_$77_$0| |f_$3_$0|)))
      (forall( (|o_$77_$1| ref) (|f_$3_$1| field$$@Map@@ref@To@Bool@@$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 |o_$77_$1| |f_$3_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 |o_$77_$1| |f_$3_$1|)))
      (forall( (|o_$77_$2| ref) (|f_$3_$2| field$$@Map@@Int@To@Int@@$))(or (and (= Npr |f_$3_$2|) (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$2|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@5 |o_$77_$2| |f_$3_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@4 |o_$77_$2| |f_$3_$2|))))
      (forall( (|o_$77_$3| ref) (|f_$3_$3| field$Int$))(or (and (= Ncpr |f_$3_$3|) (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@4 call0formal@this@0) |o_$77_$3|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@5 |o_$77_$3| |f_$3_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@4 |o_$77_$3| |f_$3_$3|))))
      (forall( (|o_$77_$4| ref) (|f_$3_$4| field$TNodeState$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@5 |o_$77_$4| |f_$3_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@4 |o_$77_$4| |f_$3_$4|)))
      (InvStruct $Heap@5)
   )
GeneratedUnifiedExit
)) :named ax_anon8_Then@7))
...
(assert (! (=> GeneratedUnifiedExit@1_assertion (not (and true
   (and true
      (forall( (|o_$78| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap@6 this) |o_$78|) (InvPr $Heap@6 |o_$78|)))
   )
...
(assert (! (=> GeneratedUnifiedExit@2_assertion (not (and true
   (and true
      (forall( (|o_$79_$0| ref) (|f_$4_$0| field$ref$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@6 |o_$79_$0| |f_$4_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap |o_$79_$0| |f_$4_$0|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$0|) (or false false))))
      (forall( (|o_$79_$1| ref) (|f_$4_$1| field$$@Map@@ref@To@Bool@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 |o_$79_$1| |f_$4_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap |o_$79_$1| |f_$4_$1|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$1|) (or false false))))
      (forall( (|o_$79_$2| ref) (|f_$4_$2| field$$@Map@@Int@To@Int@@$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap@6 |o_$79_$2| |f_$4_$2|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@Int@To@Int@@$ $Heap |o_$79_$2| |f_$4_$2|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$2|) (or (= |f_$4_$2| Npr) false))))
      (forall( (|o_$79_$3| ref) (|f_$4_$3| field$Int$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap@6 |o_$79_$3| |f_$4_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ $Heap |o_$79_$3| |f_$4_$3|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$3|) (or false (= |f_$4_$3| Ncpr)))))
      (forall( (|o_$79_$4| ref) (|f_$4_$4| field$TNodeState$))(or (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@6 |o_$79_$4| |f_$4_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap |o_$79_$4| |f_$4_$4|)) (and (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$79_$4|) (or false false))))
   )
))) :named ax_GeneratedUnifiedExit@2_assertion))
(assert (=> false (not (and
   anon2_assertion
   anon4_assertion
   anon8_Then@1_assertion
   anon8_Then@4_assertion
   anon8_Then@5_assertion
   anon8_Then@6_assertion
   anon8_Then_assertion
