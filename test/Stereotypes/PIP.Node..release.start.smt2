...
;Axioms
   ...
   (assert (! (not (= Le Lb)) :named ax_12))
   (assert (! (not (= Le Lb)) :named ax_13))
   (assert (! (not (= Ln Lb)) :named ax_14))
   (assert (! (not (= Ln Lb)) :named ax_15))
   (assert (! (not (= Ln Le)) :named ax_16))
   (assert (! (not (= Ln Le)) :named ax_17))
   (assert (! (not (= Lp Lb)) :named ax_18))
   (assert (! (not (= Lp Lb)) :named ax_19))
   (assert (! (not (= Lp Le)) :named ax_20))
   (assert (! (not (= Lp Le)) :named ax_21))
   (assert (! (not (= Lp Ln)) :named ax_22))
   (assert (! (not (= Lp Ln)) :named ax_23))
   (assert (! (not (= NA LL)) :named ax_24))
   (assert (! (not (= NA LL)) :named ax_25))
   (assert (! (not (= Nbb Lb)) :named ax_26))
   (assert (! (not (= Nbb Lb)) :named ax_27))
   (assert (! (not (= Nbb Le)) :named ax_28))
   (assert (! (not (= Nbb Le)) :named ax_29))
   (assert (! (not (= Nbb Ln)) :named ax_30))
   (assert (! (not (= Nbb Ln)) :named ax_31))
   (assert (! (not (= Nbb Lp)) :named ax_32))
   ...
   (assert (! (not (= ND LL)) :named ax_38))
   (assert (! (not (= ND LL)) :named ax_39))
   (assert (! (not (= ND NA)) :named ax_40))
   (assert (! (not (= ND NA)) :named ax_41))
   (assert (! (not (= ND NC)) :named ax_42))
...
(let ((GeneratedUnifiedExit@7_assertion (and
    (forall( (|o_$84| ref))(=> (not (= this |o_$84|)) (Equal (BBSet $Heap@4 |o_$84|) (BBSet $Heap |o_$84|))))
)))
...
(let ((anon0@2_assertion (and
    (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this NC) r)
)))
...
(let ((anon0@5 (=> (and true
    ...
    (= (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this NC) r) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 this NC))
...
(let ((PreconditionGeneratedEntry (=> (and true
    (= StF (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap this NSt))
    (forall( (|o_$74| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ (NACCoSet $Heap this) |o_$74|) (InvPr $Heap |o_$74|)))
    (InvPr $Heap r)
    (InvStruct $Heap)
    (MapRead$$@Map@@ref@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap this NC) r)
    (not (= r null))
...
(let (($start (=> (and true
    ...
    (forall( (|h_$4| $@Map@@$T0@@ref@field$$T0$@To@$T0@@) (|r_$5| $@Map@@ref@To@Bool@@) (|i_$7| Int) (|o_$15| ref))(= (MapRead$$@Map@@ref@To@Bool@@$ (FBP |h_$4| |r_$5| |i_$7|) |o_$15|) (and (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$5| |o_$15|) (= |i_$7| (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$Int$ |h_$4| |o_$15| Ncpr))) (not (= |o_$15| null)))))
    ...
    (forall( (|r_$1| $@Map@@ref@To@Bool@@) (|o_$8| ref) (|o'_$2| ref))(!(= (or (MapRead$$@Map@@ref@To@Bool@@$ |r_$1| |o'_$2|) (= |o_$8| |o'_$2|)) (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$1| |o_$8|) |o'_$2|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (AddEl |r_$1| |o_$8|) |o'_$2|))))
    (forall( (|r_$2| $@Map@@ref@To@Bool@@) (|o_$9| ref) (|o'_$3| ref))(!(= (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$2| |o_$9|) |o'_$3|) (and (MapRead$$@Map@@ref@To@Bool@@$ |r_$2| |o'_$3|) (not (= |o_$9| |o'_$3|))))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (RemEl |r_$2| |o_$9|) |o'_$3|))))
    (forall( (|r_$4| $@Map@@ref@To@Bool@@))(!(= (IsGoodRegion |r_$4|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$4| null)))  :pattern ( (IsGoodRegion |r_$4|))))
    (forall( (|s_$0| $@Map@@ref@To@Bool@@) (|r_$3| $@Map@@ref@To@Bool@@) (|o_$10| ref))(!(= (and (MapRead$$@Map@@ref@To@Bool@@$ |s_$0| |o_$10|) (not (MapRead$$@Map@@ref@To@Bool@@$ |r_$3| |o_$10|))) (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$3|) |o_$10|))  :pattern ( (MapRead$$@Map@@ref@To@Bool@@$ (Minus |s_$0| |r_$3|) |o_$10|))))
