...
;Axioms
   ...
   (assert (! (not (= true false)) :named ax_149))
   (assert (! true :named ax_150))
...
(assert (! (=> anon0@15 (and true 
   (and true
      ...
      (InvList $Heap@0)
      (InvTree $Heap@0)
      (or (= current@0 null) (= current@0 subTree) (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 subTree Le) Np)))
      (or (= current@0 null) (Equal Done@0 (Minus All@0 (AddEl Rest@1 current@0))))
      (or (= current@0 null) (Equal Rest@1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 current@0 NA)))
      (or (= current@0 null) (MapRead$$@Map@@ref@To@Bool@@$ All@0 current@0))
      (or (= current@0 null) (Sub (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 current@0 NA) All@0))
      (or (= current@0 subTree) (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@0 subTree LL) Done@0))
      (or (not (= current@0 null)) (Equal Done@0 All@0))
      (or (not (= current@0 subTree)) (Equal Done@0 Empty))
   )
...
(assert (! (=> anon4_LoopDone (and true 
   (and true
      $@condition
      (= $Heap@0 $Heap@3)
      (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap tree Np))
      (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 tree Np))
      (= current@0 null)
...
(assert (! (=> anon5_Else (and true 
   (and true
      (= $Heap@0 $Heap@2)
      (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap current@0 Lb))
      (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 current@0 Lb))
      (= current@0 subTree)
      (not $@condition_$0)
   )
anon3
...
(assert (! (=> GeneratedUnifiedExit@4 (and true 
   (and true
      (= current@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 tree Ln))
...
(assert (! (=> anon3@3 (and true 
   (and true
      (or (= null newCurrent@1) (MapRead$$@Map@@ref@To@Bool@@$ All@0 newCurrent@1))
   )
...
(assert (! (=> anon3@4 (and true 
   (and true
      (or (= null newCurrent@1) (Sub (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 newCurrent@1 NA) All@0))
   )
...
(assert (! (=> anon3@5 (and true 
   (and true
      (or (= null newCurrent@1) (Equal Done@1 (Minus All@0 (AddEl Rest@2 newCurrent@1))))
   )
...
(assert (! (=> anon3@6 (and true 
   (and true
      (or (= null newCurrent@1) (Equal Rest@2 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 newCurrent@1 NA)))
   )
...
(assert (! (=> anon3@7 (and true 
   (and true
      (or (not (= subTree newCurrent@1)) (Equal Done@1 Empty))
   )
...
(assert (! (=> anon3@8 (and true 
   (and true
      (or (not (= null newCurrent@1)) (Equal Done@1 All@0))
   )
...
(assert (! (=> anon3@10 (and true 
   (and true
      (or (= subTree newCurrent@1) (Equal (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@2 subTree LL) Done@1))
   )
...
(assert (! (=> anon3@11 (and true 
   (and true
      (= subTree (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 current@0 Lb))
...
(assert (! (=> anon3@14 (and true 
   (and true
      (or (= newCurrent@1 subTree) (= newCurrent@1 null) (= newCurrent@1 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 subTree Le) Np)))
   )
