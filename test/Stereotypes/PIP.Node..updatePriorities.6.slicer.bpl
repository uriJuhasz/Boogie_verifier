...
$start:
	...
	assume (forall  h_$96 : THeap, o_$64 : ref, from_$0 : Integer, to_$0 : Integer :: ( InvPrSt(h_$96,o_$64,from_$0,to_$0) <==> ((((((forall  i_$9 : Integer :: ( (((i_$9 > 0) && (!(i_$9 == from_$0))) && (!(i_$9 == to_$0))) ==> (h_$96[o_$64,Npr][i_$9] == Card(FBP(h_$96,BBSet(h_$96,o_$64),i_$9))) ))) && ((from_$0 > 0) ==> (h_$96[o_$64,Npr][from_$0] == (Card(FBP(h_$96,BBSet(h_$96,o_$64),from_$0)) + 1)))) && ((to_$0 > 0) ==> (h_$96[o_$64,Npr][to_$0] == (Card(FBP(h_$96,BBSet(h_$96,o_$64),to_$0)) - 1)))) && (h_$96[o_$64,Ncpr] >= 0)) && (h_$96[o_$64,Ndpr] >= 0)) ));
	...
	assume (forall  h_$102 : THeap, hOld_$4 : THeap, from_$1 : Integer, to_$1 : Integer, this_$5 : ref :: ( (((((InvPrSt(hOld_$4,this_$5,from_$1,to_$1) && Equal(BBSet(h_$102,this_$5),BBSet(hOld_$4,this_$5))) && (h_$102[this_$5,Npr] == hOld_$4[this_$5,Npr])) && (h_$102[this_$5,Ndpr] == hOld_$4[this_$5,Ndpr])) && (h_$102[this_$5,Ncpr] == hOld_$4[this_$5,Ncpr])) && ((forall  o_$70 : ref :: ( BBSet(h_$102,this_$5)[o_$70] ==> (h_$102[o_$70,Ncpr] == hOld_$4[o_$70,Ncpr]) )))) ==> InvPrSt(h_$102,this_$5,from_$1,to_$1) ));
	assume (forall  h_$103 : THeap, hOld_$5 : THeap, from_$2 : Integer, to_$2 : Integer, this_$6 : ref :: ( ((((((InvPrSt(hOld_$5,this_$6,from_$2,to_$2) && Equal(BBSet(h_$103,this_$6),BBSet(hOld_$5,this_$6))) && ((from_$2 <= 0) ==> (h_$103[this_$6,Npr] == hOld_$5[this_$6,Npr]))) && ((from_$2 > 0) ==> (h_$103[this_$6,Npr] == RemoveMSet(hOld_$5[this_$6,Npr],from_$2)))) && (h_$103[this_$6,Ndpr] == hOld_$5[this_$6,Ndpr])) && (h_$103[this_$6,Ncpr] == hOld_$5[this_$6,Ncpr])) && ((forall  o_$71 : ref :: ( BBSet(h_$103,this_$6)[o_$71] ==> (h_$103[o_$71,Ncpr] == hOld_$5[o_$71,Ncpr]) )))) ==> InvPrSt(h_$103,this_$6,0,to_$2) ));
	assume (forall  h_$104 : THeap, hOld_$6 : THeap, from_$3 : Integer, to_$3 : Integer, this_$7 : ref :: ( ((((((InvPrSt(hOld_$6,this_$7,from_$3,to_$3) && Equal(BBSet(h_$104,this_$7),BBSet(hOld_$6,this_$7))) && ((to_$3 <= 0) ==> (h_$104[this_$7,Npr] == hOld_$6[this_$7,Npr]))) && ((to_$3 > 0) ==> (h_$104[this_$7,Npr] == AddMSet(hOld_$6[this_$7,Npr],to_$3)))) && (h_$104[this_$7,Ndpr] == hOld_$6[this_$7,Ndpr])) && (h_$104[this_$7,Ncpr] == hOld_$6[this_$7,Ncpr])) && ((forall  o_$72 : ref :: ( BBSet(h_$104,this_$7)[o_$72] ==> (h_$104[o_$72,Ncpr] == hOld_$6[o_$72,Ncpr]) )))) ==> InvPrSt(h_$104,this_$7,from_$3,0) ));
...
PreconditionGeneratedEntry:
	...
	assume !(from == to);
	assume !(this == null);
	assume !(this == $Heap[this,Nbb]);
	assume InvStruct($Heap);
	assume InvPrSt($Heap,this,from,to);
	assume (forall  o_$74 : ref :: ( NACCSet($Heap,this)[o_$74] ==> InvPr($Heap,o_$74) ));
	goto anon0;
anon0:
	assume oldPriority_$_0 == $Heap[this,Ncpr];
	if ($_$_condition) { goto anon6_Then; } else { goto anon6_Else; }
anon6_Then:
	assume $_$_condition;
	assume from > 0;
	assume $Heap_$_0 == $Heap[this,Npr := RemoveMSet($Heap[this,Npr],from)];
...
anon6_Else:
	...
	goto anon2;
anon2:
	assert  InvPrSt($Heap_$_1,this,0,to);
	if ($_$_condition_$0) { goto anon7_Then; } else { goto anon7_Else; }
anon7_Then:
	assume $_$_condition_$0;
	assume to > 0;
	assume $Heap_$_2 == $Heap_$_1[this,Npr := AddMSet($Heap_$_1[this,Npr],to)];
...
anon7_Else:
	...
	goto anon4;
anon4:
	assert  InvPrSt($Heap_$_3,this,0,0);
	assume $Heap_$_4 == $Heap_$_3[this,Ncpr := Max($Heap_$_3[this,Ndpr],MaxMSet($Heap_$_3[this,Npr]))];
	if ($_$_condition_$1) { goto anon8_Then; } else { goto anon8_Else; }
anon8_Then:
	assume $_$_condition_$1;
	assume $_$_condition_$1 <==> ((!($Heap_$_4[this,Nbb] == null)) && (!($Heap_$_4[this,Ncpr] == oldPriority_$_0)));
	assume (!($Heap_$_4[this,Nbb] == null)) && (!($Heap_$_4[this,Ncpr] == oldPriority_$_0));
	assume call0formal_$_this_$_0 == $Heap_$_4[this,Nbb];
	assume call2formal_$_to_$_0 == $Heap_$_4[this,Ncpr];
	assert  oldPriority_$_0 >= 0;
	assert  call2formal_$_to_$_0 >= 0;
	assert  !(oldPriority_$_0 == call2formal_$_to_$_0);
	assert  !(call0formal_$_this_$_0 == null);
	assert  InvStruct($Heap_$_4);
	assert  InvPrSt($Heap_$_4,call0formal_$_this_$_0,oldPriority_$_0,call2formal_$_to_$_0);
	assert  (forall  o_$75 : ref :: ( NACCSet($Heap_$_4,call0formal_$_this_$_0)[o_$75] ==> InvPr($Heap_$_4,o_$75) ));
	assume InvStruct($Heap_$_5);
	assume (forall  o_$76 : ref :: ( NACCoSet($Heap_$_5,call0formal_$_this_$_0)[o_$76] ==> InvPr($Heap_$_5,o_$76) ));
	assume (((((forall  o_$77_$0 : ref, f_$3_$0 : field (ref)  :: ( ($Heap_$_5[o_$77_$0,f_$3_$0] == $Heap_$_4[o_$77_$0,f_$3_$0]) || (NACCoSet($Heap_$_4,call0formal_$_this_$_0)[o_$77_$0] && (false || false)) ))) && ((forall  o_$77_$1 : ref, f_$3_$1 : field (TRegion)  :: ( ($Heap_$_5[o_$77_$1,f_$3_$1] == $Heap_$_4[o_$77_$1,f_$3_$1]) || (NACCoSet($Heap_$_4,call0formal_$_this_$_0)[o_$77_$1] && (false || false)) )))) && ((forall  o_$77_$2 : ref, f_$3_$2 : field ([Integer]Integer)  :: ( ($Heap_$_5[o_$77_$2,f_$3_$2] == $Heap_$_4[o_$77_$2,f_$3_$2]) || (NACCoSet($Heap_$_4,call0formal_$_this_$_0)[o_$77_$2] && ((f_$3_$2 == Npr) || false)) )))) && ((forall  o_$77_$3 : ref, f_$3_$3 : field (Integer)  :: ( ($Heap_$_5[o_$77_$3,f_$3_$3] == $Heap_$_4[o_$77_$3,f_$3_$3]) || (NACCoSet($Heap_$_4,call0formal_$_this_$_0)[o_$77_$3] && (false || (f_$3_$3 == Ncpr))) )))) && ((forall  o_$77_$4 : ref, f_$3_$4 : field (TNodeState)  :: ( ($Heap_$_5[o_$77_$4,f_$3_$4] == $Heap_$_4[o_$77_$4,f_$3_$4]) || (NACCoSet($Heap_$_4,call0formal_$_this_$_0)[o_$77_$4] && (false || false)) )));
...
GeneratedUnifiedExit:
	...
	assert  (forall  o_$78 : ref :: ( NACCoSet($Heap_$_6,this)[o_$78] ==> InvPr($Heap_$_6,o_$78) ));
	assert  (((((forall  o_$79_$0 : ref, f_$4_$0 : field (ref)  :: ( ($Heap_$_6[o_$79_$0,f_$4_$0] == $Heap[o_$79_$0,f_$4_$0]) || (NACCoSet($Heap,this)[o_$79_$0] && (false || false)) ))) && ((forall  o_$79_$1 : ref, f_$4_$1 : field (TRegion)  :: ( ($Heap_$_6[o_$79_$1,f_$4_$1] == $Heap[o_$79_$1,f_$4_$1]) || (NACCoSet($Heap,this)[o_$79_$1] && (false || false)) )))) && ((forall  o_$79_$2 : ref, f_$4_$2 : field ([Integer]Integer)  :: ( ($Heap_$_6[o_$79_$2,f_$4_$2] == $Heap[o_$79_$2,f_$4_$2]) || (NACCoSet($Heap,this)[o_$79_$2] && ((f_$4_$2 == Npr) || false)) )))) && ((forall  o_$79_$3 : ref, f_$4_$3 : field (Integer)  :: ( ($Heap_$_6[o_$79_$3,f_$4_$3] == $Heap[o_$79_$3,f_$4_$3]) || (NACCoSet($Heap,this)[o_$79_$3] && (false || (f_$4_$3 == Ncpr))) )))) && ((forall  o_$79_$4 : ref, f_$4_$4 : field (TNodeState)  :: ( ($Heap_$_6[o_$79_$4,f_$4_$4] == $Heap[o_$79_$4,f_$4_$4]) || (NACCoSet($Heap,this)[o_$79_$4] && (false || false)) )));
	goto $exit;
}
