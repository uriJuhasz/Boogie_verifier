...
{
	var All_$_0 : TRegion;
	var Rest_$_0 : TRegion;
	var Done_$_0 : TRegion;
	var Rest_$_1 : TRegion;
	var current_$_0 : ref;
	var $Heap_$_0 : THeap;
	var newCurrent_$_1 : ref;
	var $Heap_$_1 : THeap;
	var $Heap_$_2 : THeap;
	var Done_$_1 : TRegion;
	var Rest_$_2 : TRegion;
	var $Heap_$_3 : THeap;
...
$start:
	...
	assume (forall  h_$105 : THeap, hOld_$7 : THeap, this_$7 : ref :: ( (((InvPrSt(hOld_$7,this_$7,0,0) && (!BBSet(hOld_$7,this_$7)[this_$7])) && (h_$105[this_$7,Ncpr] == Max(hOld_$7[this_$7,Ndpr],MaxMSet(hOld_$7[this_$7,Npr])))) && ((((((forall  o_$73_$0 : ref, f_$2_$0 : field (ref)  :: ( (h_$105[o_$73_$0,f_$2_$0] == hOld_$7[o_$73_$0,f_$2_$0]) || ((o_$73_$0 == this_$7) && false) ))) && ((forall  o_$73_$1 : ref, f_$2_$1 : field (TRegion)  :: ( (h_$105[o_$73_$1,f_$2_$1] == hOld_$7[o_$73_$1,f_$2_$1]) || ((o_$73_$1 == this_$7) && false) )))) && ((forall  o_$73_$2 : ref, f_$2_$2 : field ([Integer]Integer)  :: ( (h_$105[o_$73_$2,f_$2_$2] == hOld_$7[o_$73_$2,f_$2_$2]) || ((o_$73_$2 == this_$7) && false) )))) && ((forall  o_$73_$3 : ref, f_$2_$3 : field (Integer)  :: ( (h_$105[o_$73_$3,f_$2_$3] == hOld_$7[o_$73_$3,f_$2_$3]) || ((o_$73_$3 == this_$7) && (f_$2_$3 == Ncpr)) )))) && ((forall  o_$73_$4 : ref, f_$2_$4 : field (TNodeState)  :: ( (h_$105[o_$73_$4,f_$2_$4] == hOld_$7[o_$73_$4,f_$2_$4]) || ((o_$73_$4 == this_$7) && false) ))))) ==> InvPr(h_$105,this_$7) ));
...
PreconditionGeneratedEntry:
	assume !(tree == null);
	assume !(subTree == null);
	assume $Heap[tree,Np] == null;
	assume $Heap[tree,ND][subTree];
	assume InvTree($Heap);
	assume InvList($Heap);
	assume (forall  o_$74 : ref :: {AddEl($Heap[subTree,NA],subTree)[o_$74],IsEmptyList($Heap,o_$74)} ( AddEl($Heap[subTree,NA],subTree)[o_$74] ==> IsEmptyList($Heap,o_$74) ));
	goto anon0;
anon0:
	assume All_$_0 == AddEl($Heap[subTree,NA],subTree);
	assume Rest_$_0 == $Heap[subTree,NA];
	assert  InvTree($Heap);
	assert  InvList($Heap);
	assert  (!(subTree == null)) ==> All_$_0[subTree];
	assert  (!(subTree == null)) ==> Sub($Heap[subTree,NA],All_$_0);
	assert  (!(subTree == null)) ==> Equal(Empty,Minus(All_$_0,AddEl(Rest_$_0,subTree)));
	assert  (!(subTree == null)) ==> Equal(Rest_$_0,$Heap[subTree,NA]);
	assert  (subTree == subTree) ==> Equal(Empty,Empty);
	assert  (subTree == null) ==> Equal(Empty,All_$_0);
	assert  (!(subTree == null)) ==> ((forall  o_$75 : ref :: ( AddEl($Heap[subTree,NA],subTree)[o_$75] ==> IsEmptyList($Heap,o_$75) )));
	assert  (!(subTree == subTree)) ==> Equal($Heap[subTree,LL],Empty);
	assert  $Heap[subTree,Lb] == subTree;
	assert  $Heap[tree,Np] == null;
	assert  (forall  o_$76 : ref :: ( RemEl(Empty,$Heap[subTree,Le])[o_$76] ==> ($Heap[o_$76,Np] == $Heap[o_$76,Ln]) ));
	assert  ((!(subTree == subTree)) && (!(subTree == null))) ==> ($Heap[$Heap[subTree,Le],Np] == subTree);
	assert  (forall  o_$77 : ref :: ( RemEl(Empty,subTree)[o_$77] ==> $Heap[o_$77,NC][$Heap[o_$77,Lp]] ));
	assert  (!(subTree == null)) ==> ((((((forall  o_$78_$0 : ref, f_$3_$0 : field (ref)  :: ( ((((($Heap[o_$78_$0,f_$3_$0] == $Heap[o_$78_$0,f_$3_$0]) || (AddEl(Empty,subTree)[o_$78_$0] && false)) || (AddEl(Empty,subTree)[o_$78_$0] && (f_$3_$0 == Lb))) || (AddEl(Empty,subTree)[o_$78_$0] && (f_$3_$0 == Le))) || (AddEl(Empty,subTree)[o_$78_$0] && (f_$3_$0 == Lp))) || (AddEl(Empty,subTree)[o_$78_$0] && (f_$3_$0 == Ln)) ))) && ((forall  o_$78_$1 : ref, f_$3_$1 : field (TRegion)  :: ( ((((($Heap[o_$78_$1,f_$3_$1] == $Heap[o_$78_$1,f_$3_$1]) || (AddEl(Empty,subTree)[o_$78_$1] && (f_$3_$1 == LL))) || (AddEl(Empty,subTree)[o_$78_$1] && false)) || (AddEl(Empty,subTree)[o_$78_$1] && false)) || (AddEl(Empty,subTree)[o_$78_$1] && false)) || (AddEl(Empty,subTree)[o_$78_$1] && false) )))) && ((forall  o_$78_$2 : ref, f_$3_$2 : field ([Integer]Integer)  :: ( ((((($Heap[o_$78_$2,f_$3_$2] == $Heap[o_$78_$2,f_$3_$2]) || (AddEl(Empty,subTree)[o_$78_$2] && false)) || (AddEl(Empty,subTree)[o_$78_$2] && false)) || (AddEl(Empty,subTree)[o_$78_$2] && false)) || (AddEl(Empty,subTree)[o_$78_$2] && false)) || (AddEl(Empty,subTree)[o_$78_$2] && false) )))) && ((forall  o_$78_$3 : ref, f_$3_$3 : field (Integer)  :: ( ((((($Heap[o_$78_$3,f_$3_$3] == $Heap[o_$78_$3,f_$3_$3]) || (AddEl(Empty,subTree)[o_$78_$3] && false)) || (AddEl(Empty,subTree)[o_$78_$3] && false)) || (AddEl(Empty,subTree)[o_$78_$3] && false)) || (AddEl(Empty,subTree)[o_$78_$3] && false)) || (AddEl(Empty,subTree)[o_$78_$3] && false) )))) && ((forall  o_$78_$4 : ref, f_$3_$4 : field (TNodeState)  :: ( ((((($Heap[o_$78_$4,f_$3_$4] == $Heap[o_$78_$4,f_$3_$4]) || (AddEl(Empty,subTree)[o_$78_$4] && false)) || (AddEl(Empty,subTree)[o_$78_$4] && false)) || (AddEl(Empty,subTree)[o_$78_$4] && false)) || (AddEl(Empty,subTree)[o_$78_$4] && false)) || (AddEl(Empty,subTree)[o_$78_$4] && false) ))));
	assert  (subTree == null) ==> ((((((forall  o_$79_$0 : ref, f_$4_$0 : field (ref)  :: ( ((((($Heap[o_$79_$0,f_$4_$0] == $Heap[o_$79_$0,f_$4_$0]) || (Empty[o_$79_$0] && false)) || (Empty[o_$79_$0] && (f_$4_$0 == Lb))) || (Empty[o_$79_$0] && (f_$4_$0 == Le))) || (Empty[o_$79_$0] && (f_$4_$0 == Lp))) || (Empty[o_$79_$0] && (f_$4_$0 == Ln)) ))) && ((forall  o_$79_$1 : ref, f_$4_$1 : field (TRegion)  :: ( ((((($Heap[o_$79_$1,f_$4_$1] == $Heap[o_$79_$1,f_$4_$1]) || (Empty[o_$79_$1] && (f_$4_$1 == LL))) || (Empty[o_$79_$1] && false)) || (Empty[o_$79_$1] && false)) || (Empty[o_$79_$1] && false)) || (Empty[o_$79_$1] && false) )))) && ((forall  o_$79_$2 : ref, f_$4_$2 : field ([Integer]Integer)  :: ( ((((($Heap[o_$79_$2,f_$4_$2] == $Heap[o_$79_$2,f_$4_$2]) || (Empty[o_$79_$2] && false)) || (Empty[o_$79_$2] && false)) || (Empty[o_$79_$2] && false)) || (Empty[o_$79_$2] && false)) || (Empty[o_$79_$2] && false) )))) && ((forall  o_$79_$3 : ref, f_$4_$3 : field (Integer)  :: ( ((((($Heap[o_$79_$3,f_$4_$3] == $Heap[o_$79_$3,f_$4_$3]) || (Empty[o_$79_$3] && false)) || (Empty[o_$79_$3] && false)) || (Empty[o_$79_$3] && false)) || (Empty[o_$79_$3] && false)) || (Empty[o_$79_$3] && false) )))) && ((forall  o_$79_$4 : ref, f_$4_$4 : field (TNodeState)  :: ( ((((($Heap[o_$79_$4,f_$4_$4] == $Heap[o_$79_$4,f_$4_$4]) || (Empty[o_$79_$4] && false)) || (Empty[o_$79_$4] && false)) || (Empty[o_$79_$4] && false)) || (Empty[o_$79_$4] && false)) || (Empty[o_$79_$4] && false) ))));
	goto anon4_LoopHead;
anon4_LoopHead:
	assume true;
	assume InvTree($Heap_$_0);
	assume InvList($Heap_$_0);
	assume (!(current_$_0 == null)) ==> All_$_0[current_$_0];
	assume (!(current_$_0 == null)) ==> Sub($Heap_$_0[current_$_0,NA],All_$_0);
	assume (!(current_$_0 == null)) ==> Equal(Done_$_0,Minus(All_$_0,AddEl(Rest_$_1,current_$_0)));
	assume (!(current_$_0 == null)) ==> Equal(Rest_$_1,$Heap_$_0[current_$_0,NA]);
	assume (current_$_0 == subTree) ==> Equal(Done_$_0,Empty);
	assume (current_$_0 == null) ==> Equal(Done_$_0,All_$_0);
	assume (!(current_$_0 == null)) ==> ((forall  o_$80 : ref :: ( AddEl($Heap_$_0[current_$_0,NA],current_$_0)[o_$80] ==> IsEmptyList($Heap_$_0,o_$80) )));
	assume (!(current_$_0 == subTree)) ==> Equal($Heap_$_0[subTree,LL],Done_$_0);
	assume $Heap_$_0[subTree,Lb] == subTree;
	assume $Heap_$_0[tree,Np] == null;
	assume (forall  o_$81 : ref :: ( RemEl(Done_$_0,$Heap_$_0[subTree,Le])[o_$81] ==> ($Heap_$_0[o_$81,Np] == $Heap_$_0[o_$81,Ln]) ));
	assume ((!(current_$_0 == subTree)) && (!(current_$_0 == null))) ==> ($Heap_$_0[$Heap_$_0[subTree,Le],Np] == current_$_0);
	assume (forall  o_$82 : ref :: ( RemEl(Done_$_0,subTree)[o_$82] ==> $Heap_$_0[o_$82,NC][$Heap_$_0[o_$82,Lp]] ));
	assume (!(current_$_0 == null)) ==> ((((((forall  o_$83_$0 : ref, f_$5_$0 : field (ref)  :: ( ((((($Heap_$_0[o_$83_$0,f_$5_$0] == $Heap[o_$83_$0,f_$5_$0]) || (AddEl(Done_$_0,current_$_0)[o_$83_$0] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$0] && (f_$5_$0 == Lb))) || (AddEl(Done_$_0,current_$_0)[o_$83_$0] && (f_$5_$0 == Le))) || (AddEl(Done_$_0,current_$_0)[o_$83_$0] && (f_$5_$0 == Lp))) || (AddEl(Done_$_0,current_$_0)[o_$83_$0] && (f_$5_$0 == Ln)) ))) && ((forall  o_$83_$1 : ref, f_$5_$1 : field (TRegion)  :: ( ((((($Heap_$_0[o_$83_$1,f_$5_$1] == $Heap[o_$83_$1,f_$5_$1]) || (AddEl(Done_$_0,current_$_0)[o_$83_$1] && (f_$5_$1 == LL))) || (AddEl(Done_$_0,current_$_0)[o_$83_$1] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$1] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$1] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$1] && false) )))) && ((forall  o_$83_$2 : ref, f_$5_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_0[o_$83_$2,f_$5_$2] == $Heap[o_$83_$2,f_$5_$2]) || (AddEl(Done_$_0,current_$_0)[o_$83_$2] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$2] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$2] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$2] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$2] && false) )))) && ((forall  o_$83_$3 : ref, f_$5_$3 : field (Integer)  :: ( ((((($Heap_$_0[o_$83_$3,f_$5_$3] == $Heap[o_$83_$3,f_$5_$3]) || (AddEl(Done_$_0,current_$_0)[o_$83_$3] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$3] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$3] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$3] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$3] && false) )))) && ((forall  o_$83_$4 : ref, f_$5_$4 : field (TNodeState)  :: ( ((((($Heap_$_0[o_$83_$4,f_$5_$4] == $Heap[o_$83_$4,f_$5_$4]) || (AddEl(Done_$_0,current_$_0)[o_$83_$4] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$4] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$4] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$4] && false)) || (AddEl(Done_$_0,current_$_0)[o_$83_$4] && false) ))));
	assume (current_$_0 == null) ==> ((((((forall  o_$84_$0 : ref, f_$6_$0 : field (ref)  :: ( ((((($Heap_$_0[o_$84_$0,f_$6_$0] == $Heap[o_$84_$0,f_$6_$0]) || (Done_$_0[o_$84_$0] && false)) || (Done_$_0[o_$84_$0] && (f_$6_$0 == Lb))) || (Done_$_0[o_$84_$0] && (f_$6_$0 == Le))) || (Done_$_0[o_$84_$0] && (f_$6_$0 == Lp))) || (Done_$_0[o_$84_$0] && (f_$6_$0 == Ln)) ))) && ((forall  o_$84_$1 : ref, f_$6_$1 : field (TRegion)  :: ( ((((($Heap_$_0[o_$84_$1,f_$6_$1] == $Heap[o_$84_$1,f_$6_$1]) || (Done_$_0[o_$84_$1] && (f_$6_$1 == LL))) || (Done_$_0[o_$84_$1] && false)) || (Done_$_0[o_$84_$1] && false)) || (Done_$_0[o_$84_$1] && false)) || (Done_$_0[o_$84_$1] && false) )))) && ((forall  o_$84_$2 : ref, f_$6_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_0[o_$84_$2,f_$6_$2] == $Heap[o_$84_$2,f_$6_$2]) || (Done_$_0[o_$84_$2] && false)) || (Done_$_0[o_$84_$2] && false)) || (Done_$_0[o_$84_$2] && false)) || (Done_$_0[o_$84_$2] && false)) || (Done_$_0[o_$84_$2] && false) )))) && ((forall  o_$84_$3 : ref, f_$6_$3 : field (Integer)  :: ( ((((($Heap_$_0[o_$84_$3,f_$6_$3] == $Heap[o_$84_$3,f_$6_$3]) || (Done_$_0[o_$84_$3] && false)) || (Done_$_0[o_$84_$3] && false)) || (Done_$_0[o_$84_$3] && false)) || (Done_$_0[o_$84_$3] && false)) || (Done_$_0[o_$84_$3] && false) )))) && ((forall  o_$84_$4 : ref, f_$6_$4 : field (TNodeState)  :: ( ((((($Heap_$_0[o_$84_$4,f_$6_$4] == $Heap[o_$84_$4,f_$6_$4]) || (Done_$_0[o_$84_$4] && false)) || (Done_$_0[o_$84_$4] && false)) || (Done_$_0[o_$84_$4] && false)) || (Done_$_0[o_$84_$4] && false)) || (Done_$_0[o_$84_$4] && false) ))));
	if ($_$_condition) { goto anon4_LoopDone; } else { goto anon4_LoopBody; }
anon4_LoopDone:
	assume $_$_condition;
	assume $_$_condition <==> (current_$_0 == null);
	assume current_$_0 == null;
	assume $Heap_$_3 == $Heap_$_0;
	goto GeneratedUnifiedExit;
anon4_LoopBody:
	assume !$_$_condition;
	assume $_$_condition <==> (current_$_0 == null);
	assume !(current_$_0 == null);
	assume newCurrent_$_1 == $Heap_$_0[current_$_0,Np];
	if ($_$_condition_$0) { goto anon5_Then; } else { goto anon5_Else; }
GeneratedUnifiedExit:
	assert  InvTree($Heap_$_3);
	assert  InvList($Heap_$_3);
	assert  (forall  o_$85 : ref :: ( RemEl(AddEl($Heap_$_3[subTree,NA],subTree),tree)[o_$85] ==> ($Heap_$_3[o_$85,Np] == $Heap_$_3[o_$85,Ln]) ));
	assert  $Heap_$_3[tree,Ln] == null;
	assert  (forall  o_$86 : ref :: ( AddEl($Heap_$_3[subTree,NA],subTree)[o_$86] ==> Equal($Heap_$_3[o_$86,LL],AddEl($Heap_$_3[subTree,NA],subTree)) ));
	assert  (forall  o_$87 : ref :: ( AddEl($Heap_$_3[subTree,NA],subTree)[o_$87] ==> ($Heap_$_3[o_$87,Lb] == subTree) ));
	assert  (forall  o_$88 : ref :: ( AddEl($Heap_$_3[subTree,NA],subTree)[o_$88] ==> ($Heap_$_3[o_$88,Le] == tree) ));
	assert  (forall  o_$89 : ref :: ( $Heap_$_3[subTree,NA][o_$89] ==> AddEl($Heap_$_3[subTree,NA],subTree)[$Heap_$_3[o_$89,Lp]] ));
	assert  (forall  o_$90 : ref :: ( $Heap_$_3[subTree,NA][o_$90] ==> $Heap_$_3[o_$90,NC][$Heap_$_3[o_$90,Lp]] ));
	assert  (((((forall  o_$91_$0 : ref, f_$7_$0 : field (ref)  :: ( ((((($Heap_$_3[o_$91_$0,f_$7_$0] == $Heap[o_$91_$0,f_$7_$0]) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$0] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$0] && (f_$7_$0 == Lb))) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$0] && (f_$7_$0 == Le))) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$0] && (f_$7_$0 == Lp))) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$0] && (f_$7_$0 == Ln)) ))) && ((forall  o_$91_$1 : ref, f_$7_$1 : field (TRegion)  :: ( ((((($Heap_$_3[o_$91_$1,f_$7_$1] == $Heap[o_$91_$1,f_$7_$1]) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$1] && (f_$7_$1 == LL))) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$1] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$1] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$1] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$1] && false) )))) && ((forall  o_$91_$2 : ref, f_$7_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_3[o_$91_$2,f_$7_$2] == $Heap[o_$91_$2,f_$7_$2]) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$2] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$2] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$2] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$2] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$2] && false) )))) && ((forall  o_$91_$3 : ref, f_$7_$3 : field (Integer)  :: ( ((((($Heap_$_3[o_$91_$3,f_$7_$3] == $Heap[o_$91_$3,f_$7_$3]) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$3] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$3] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$3] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$3] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$3] && false) )))) && ((forall  o_$91_$4 : ref, f_$7_$4 : field (TNodeState)  :: ( ((((($Heap_$_3[o_$91_$4,f_$7_$4] == $Heap[o_$91_$4,f_$7_$4]) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$4] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$4] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$4] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$4] && false)) || (AddEl($Heap_$_3[subTree,NA],subTree)[o_$91_$4] && false) )));
	goto $exit;
anon5_Then:
	assume $_$_condition_$0;
	assume $_$_condition_$0 <==> (!(current_$_0 == subTree));
	assume !(current_$_0 == subTree);
	assert  !(subTree == null);
	assert  !(current_$_0 == null);
	assert  IsEmptyList($Heap_$_0,current_$_0);
	assert  !$Heap_$_0[subTree,LL][current_$_0];
	assert  InvList($Heap_$_0);
	assert  InvTree($Heap_$_0);
	assume InvList($Heap_$_1);
	assume InvTree($Heap_$_1);
	assume (((((forall  o_$92_$0 : ref, f_$8_$0 : field (ref)  :: ( (((((($Heap_$_1[o_$92_$0,f_$8_$0] == $Heap_$_0[o_$92_$0,f_$8_$0]) || ((o_$92_$0 == $Heap_$_0[subTree,Le]) && (f_$8_$0 == Ln))) || ((o_$92_$0 == current_$_0) && (f_$8_$0 == Lp))) || ((o_$92_$0 == current_$_0) && (f_$8_$0 == Lb))) || ((o_$92_$0 == current_$_0) && false)) || ($Heap_$_0[subTree,LL][o_$92_$0] && false)) || ($Heap_$_0[subTree,LL][o_$92_$0] && (f_$8_$0 == Le)) ))) && ((forall  o_$92_$1 : ref, f_$8_$1 : field (TRegion)  :: ( (((((($Heap_$_1[o_$92_$1,f_$8_$1] == $Heap_$_0[o_$92_$1,f_$8_$1]) || ((o_$92_$1 == $Heap_$_0[subTree,Le]) && false)) || ((o_$92_$1 == current_$_0) && false)) || ((o_$92_$1 == current_$_0) && false)) || ((o_$92_$1 == current_$_0) && (f_$8_$1 == LL))) || ($Heap_$_0[subTree,LL][o_$92_$1] && (f_$8_$1 == LL))) || ($Heap_$_0[subTree,LL][o_$92_$1] && false) )))) && ((forall  o_$92_$2 : ref, f_$8_$2 : field ([Integer]Integer)  :: ( (((((($Heap_$_1[o_$92_$2,f_$8_$2] == $Heap_$_0[o_$92_$2,f_$8_$2]) || ((o_$92_$2 == $Heap_$_0[subTree,Le]) && false)) || ((o_$92_$2 == current_$_0) && false)) || ((o_$92_$2 == current_$_0) && false)) || ((o_$92_$2 == current_$_0) && false)) || ($Heap_$_0[subTree,LL][o_$92_$2] && false)) || ($Heap_$_0[subTree,LL][o_$92_$2] && false) )))) && ((forall  o_$92_$3 : ref, f_$8_$3 : field (Integer)  :: ( (((((($Heap_$_1[o_$92_$3,f_$8_$3] == $Heap_$_0[o_$92_$3,f_$8_$3]) || ((o_$92_$3 == $Heap_$_0[subTree,Le]) && false)) || ((o_$92_$3 == current_$_0) && false)) || ((o_$92_$3 == current_$_0) && false)) || ((o_$92_$3 == current_$_0) && false)) || ($Heap_$_0[subTree,LL][o_$92_$3] && false)) || ($Heap_$_0[subTree,LL][o_$92_$3] && false) )))) && ((forall  o_$92_$4 : ref, f_$8_$4 : field (TNodeState)  :: ( (((((($Heap_$_1[o_$92_$4,f_$8_$4] == $Heap_$_0[o_$92_$4,f_$8_$4]) || ((o_$92_$4 == $Heap_$_0[subTree,Le]) && false)) || ((o_$92_$4 == current_$_0) && false)) || ((o_$92_$4 == current_$_0) && false)) || ((o_$92_$4 == current_$_0) && false)) || ($Heap_$_0[subTree,LL][o_$92_$4] && false)) || ($Heap_$_0[subTree,LL][o_$92_$4] && false) )));
	assume $Heap_$_1[$Heap_$_0[subTree,Le],Ln] == current_$_0;
	assume $Heap_$_1[current_$_0,Lp] == $Heap_$_0[subTree,Le];
	assume $Heap_$_1[current_$_0,Lb] == $Heap_$_1[subTree,Lb];
	assume $Heap_$_1[current_$_0,LL] == AddEl($Heap_$_0[subTree,LL],current_$_0);
	assume (forall  o_$93 : ref :: ( $Heap_$_0[subTree,LL][o_$93] ==> ($Heap_$_1[o_$93,LL] == Union($Heap_$_0[o_$93,LL],Singleton(current_$_0))) ));
	assume (forall  o_$94 : ref :: ( $Heap_$_0[subTree,LL][o_$94] ==> ($Heap_$_1[o_$94,Le] == current_$_0) ));
...
anon5_Else:
	...
	goto anon3;
anon3:
	assume Done_$_1 == AddEl(Done_$_0,current_$_0);
	assume Rest_$_2 == RemEl(Rest_$_1,newCurrent_$_1);
	assert  InvTree($Heap_$_2);
	assert  InvList($Heap_$_2);
	assert  (!(newCurrent_$_1 == null)) ==> All_$_0[newCurrent_$_1];
	assert  (!(newCurrent_$_1 == null)) ==> Sub($Heap_$_2[newCurrent_$_1,NA],All_$_0);
	assert  (!(newCurrent_$_1 == null)) ==> Equal(Done_$_1,Minus(All_$_0,AddEl(Rest_$_2,newCurrent_$_1)));
	assert  (!(newCurrent_$_1 == null)) ==> Equal(Rest_$_2,$Heap_$_2[newCurrent_$_1,NA]);
	assert  (newCurrent_$_1 == subTree) ==> Equal(Done_$_1,Empty);
	assert  (newCurrent_$_1 == null) ==> Equal(Done_$_1,All_$_0);
	assert  (!(newCurrent_$_1 == null)) ==> ((forall  o_$95 : ref :: ( AddEl($Heap_$_2[newCurrent_$_1,NA],newCurrent_$_1)[o_$95] ==> IsEmptyList($Heap_$_2,o_$95) )));
	assert  (!(newCurrent_$_1 == subTree)) ==> Equal($Heap_$_2[subTree,LL],Done_$_1);
	assert  $Heap_$_2[subTree,Lb] == subTree;
	assert  $Heap_$_2[tree,Np] == null;
	assert  (forall  o_$96 : ref :: ( RemEl(Done_$_1,$Heap_$_2[subTree,Le])[o_$96] ==> ($Heap_$_2[o_$96,Np] == $Heap_$_2[o_$96,Ln]) ));
	assert  ((!(newCurrent_$_1 == subTree)) && (!(newCurrent_$_1 == null))) ==> ($Heap_$_2[$Heap_$_2[subTree,Le],Np] == newCurrent_$_1);
	assert  (forall  o_$97 : ref :: ( RemEl(Done_$_1,subTree)[o_$97] ==> $Heap_$_2[o_$97,NC][$Heap_$_2[o_$97,Lp]] ));
	assert  (!(newCurrent_$_1 == null)) ==> ((((((forall  o_$98_$0 : ref, f_$9_$0 : field (ref)  :: ( ((((($Heap_$_2[o_$98_$0,f_$9_$0] == $Heap[o_$98_$0,f_$9_$0]) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$0] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$0] && (f_$9_$0 == Lb))) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$0] && (f_$9_$0 == Le))) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$0] && (f_$9_$0 == Lp))) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$0] && (f_$9_$0 == Ln)) ))) && ((forall  o_$98_$1 : ref, f_$9_$1 : field (TRegion)  :: ( ((((($Heap_$_2[o_$98_$1,f_$9_$1] == $Heap[o_$98_$1,f_$9_$1]) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$1] && (f_$9_$1 == LL))) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$1] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$1] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$1] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$1] && false) )))) && ((forall  o_$98_$2 : ref, f_$9_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_2[o_$98_$2,f_$9_$2] == $Heap[o_$98_$2,f_$9_$2]) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$2] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$2] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$2] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$2] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$2] && false) )))) && ((forall  o_$98_$3 : ref, f_$9_$3 : field (Integer)  :: ( ((((($Heap_$_2[o_$98_$3,f_$9_$3] == $Heap[o_$98_$3,f_$9_$3]) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$3] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$3] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$3] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$3] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$3] && false) )))) && ((forall  o_$98_$4 : ref, f_$9_$4 : field (TNodeState)  :: ( ((((($Heap_$_2[o_$98_$4,f_$9_$4] == $Heap[o_$98_$4,f_$9_$4]) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$4] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$4] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$4] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$4] && false)) || (AddEl(Done_$_1,newCurrent_$_1)[o_$98_$4] && false) ))));
	assert  (newCurrent_$_1 == null) ==> ((((((forall  o_$99_$0 : ref, f_$10_$0 : field (ref)  :: ( ((((($Heap_$_2[o_$99_$0,f_$10_$0] == $Heap[o_$99_$0,f_$10_$0]) || (Done_$_1[o_$99_$0] && false)) || (Done_$_1[o_$99_$0] && (f_$10_$0 == Lb))) || (Done_$_1[o_$99_$0] && (f_$10_$0 == Le))) || (Done_$_1[o_$99_$0] && (f_$10_$0 == Lp))) || (Done_$_1[o_$99_$0] && (f_$10_$0 == Ln)) ))) && ((forall  o_$99_$1 : ref, f_$10_$1 : field (TRegion)  :: ( ((((($Heap_$_2[o_$99_$1,f_$10_$1] == $Heap[o_$99_$1,f_$10_$1]) || (Done_$_1[o_$99_$1] && (f_$10_$1 == LL))) || (Done_$_1[o_$99_$1] && false)) || (Done_$_1[o_$99_$1] && false)) || (Done_$_1[o_$99_$1] && false)) || (Done_$_1[o_$99_$1] && false) )))) && ((forall  o_$99_$2 : ref, f_$10_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_2[o_$99_$2,f_$10_$2] == $Heap[o_$99_$2,f_$10_$2]) || (Done_$_1[o_$99_$2] && false)) || (Done_$_1[o_$99_$2] && false)) || (Done_$_1[o_$99_$2] && false)) || (Done_$_1[o_$99_$2] && false)) || (Done_$_1[o_$99_$2] && false) )))) && ((forall  o_$99_$3 : ref, f_$10_$3 : field (Integer)  :: ( ((((($Heap_$_2[o_$99_$3,f_$10_$3] == $Heap[o_$99_$3,f_$10_$3]) || (Done_$_1[o_$99_$3] && false)) || (Done_$_1[o_$99_$3] && false)) || (Done_$_1[o_$99_$3] && false)) || (Done_$_1[o_$99_$3] && false)) || (Done_$_1[o_$99_$3] && false) )))) && ((forall  o_$99_$4 : ref, f_$10_$4 : field (TNodeState)  :: ( ((((($Heap_$_2[o_$99_$4,f_$10_$4] == $Heap[o_$99_$4,f_$10_$4]) || (Done_$_1[o_$99_$4] && false)) || (Done_$_1[o_$99_$4] && false)) || (Done_$_1[o_$99_$4] && false)) || (Done_$_1[o_$99_$4] && false)) || (Done_$_1[o_$99_$4] && false) ))));
	assume false;
