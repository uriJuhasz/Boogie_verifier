...
anon0:
	...
	assume (forall<a> o_$75 : ref, f_$3 : field (a)  :: ( ($Heap_$_4[o_$75,f_$3] == $Heap_$_3[o_$75,f_$3]) || (oldList_$_0[o_$75] && (f_$3 == LL)) ));
	assume (forall  o_$76 : ref :: ( oldList_$_0[o_$76] ==> ($Heap_$_5[o_$76,Le] == el) ));
	assume (forall<a> o_$77 : ref, f_$4 : field (a)  :: ( ($Heap_$_5[o_$77,f_$4] == $Heap_$_4[o_$77,f_$4]) || (oldList_$_0[o_$77] && (f_$4 == Le)) ));
	assert  InvList($Heap_$_5);
	assert  InvTree($Heap_$_5);
	assert  (forall<a> o_$78 : ref, f_$5 : field (a)  :: ( (((((($Heap_$_5[o_$78,f_$5] == $Heap[o_$78,f_$5]) || ((o_$78 == $Heap[list,Le]) && (f_$5 == Ln))) || ((o_$78 == el) && (f_$5 == Lp))) || ((o_$78 == el) && (f_$5 == Lb))) || ((o_$78 == el) && (f_$5 == LL))) || ($Heap[list,LL][o_$78] && (f_$5 == LL))) || ($Heap[list,LL][o_$78] && (f_$5 == Le)) ));
