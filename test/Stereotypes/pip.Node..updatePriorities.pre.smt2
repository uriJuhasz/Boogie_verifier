...
(let ((anon8_Then@1_assertion (and
    (>= call2formal@to@0 0)
)))
(let ((anon8_Then_assertion (and
    (>= oldPriority@0 0)
)))
(let ((anon8_Then@2_assertion (and
    (not (= oldPriority@0 call2formal@to@0))
)))
(let ((anon8_Then@3_assertion (and
...
(let ((anon8_Then@6 (=> (and true
    (InvPrSt $Heap@4 call0formal@this@0 oldPriority@0 call2formal@to@0)
  )(and 
    anon8_Then@6_assertion
    anon8_Then@7
))))
(let ((anon8_Then@5 (=> (and true
    (InvStruct $Heap@4)
  )(and 
    anon8_Then@5_assertion
    anon8_Then@6
))))
(let ((anon8_Then@4 (=> (and true
    (not (= call0formal@this@0 null))
  )(and 
    anon8_Then@4_assertion
    anon8_Then@5
))))
(let ((anon8_Then@3 (=> (and true
    (not (= oldPriority@0 call2formal@to@0))
  )(and 
    anon8_Then@3_assertion
    anon8_Then@4
))))
(let ((anon8_Then@2 (=> (and true
    (>= call2formal@to@0 0)
  )(and 
    anon8_Then@2_assertion
    anon8_Then@3
))))
(let ((anon8_Then@1 (=> (and true
    (>= oldPriority@0 0)
  )(and 
