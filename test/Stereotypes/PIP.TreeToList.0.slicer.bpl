...
anon0:
	...
	assume (forall<a> o_$82 : ref, f_$3 : field (a)  :: ( ((((($Heap_$_0[o_$82,f_$3] == $Heap[o_$82,f_$3]) || (AddEl($Heap_$_0[subTree,NA],subTree)[o_$82] && (f_$3 == LL))) || (AddEl($Heap_$_0[subTree,NA],subTree)[o_$82] && (f_$3 == Lb))) || (AddEl($Heap_$_0[subTree,NA],subTree)[o_$82] && (f_$3 == Le))) || (AddEl($Heap_$_0[subTree,NA],subTree)[o_$82] && (f_$3 == Lp))) || (AddEl($Heap_$_0[subTree,NA],subTree)[o_$82] && (f_$3 == Ln)) ));
	assert  !(tree == null);
	assert  !(subTree == null);
	...
	assume (forall<a> o_$91 : ref, f_$4 : field (a)  :: ( ((((($Heap_$_1[o_$91,f_$4] == $Heap_$_0[o_$91,f_$4]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),tree)[o_$91] && (f_$4 == Np))) || (AddEl($Heap_$_0[$Heap_$_1[tree,Lp],ND],$Heap_$_1[tree,Lp])[o_$91] && (f_$4 == Nt))) || (RemEl(AddEl($Heap_$_0[subTree,NA],tree),subTree)[o_$91] && (f_$4 == NC))) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$91] && (f_$4 == ND))) || (AddEl($Heap_$_0[$Heap_$_1[tree,Lp],ND],$Heap_$_1[tree,Lp])[o_$91] && (f_$4 == NA)) ));
	...
	assert  (forall<a> o_$100 : ref, f_$5 : field (a)  :: ( (((((((((($Heap_$_1[o_$100,f_$5] == $Heap[o_$100,f_$5]) || (AddEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == LL))) || (AddEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == Lb))) || (AddEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == Le))) || (AddEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == Lp))) || (AddEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == Ln))) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$100] && (f_$5 == Np))) || (AddEl($Heap[$Heap_$_1[tree,Lp],ND],$Heap_$_1[tree,Lp])[o_$100] && (f_$5 == Nt))) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$100] && (f_$5 == NC))) || (RemEl($Heap[subTree,NA],subTree)[o_$100] && (f_$5 == ND))) || (AddEl($Heap[$Heap_$_1[tree,Lp],ND],$Heap_$_1[tree,Lp])[o_$100] && (f_$5 == NA)) ));
	goto $exit;
}
