...
PreconditionGeneratedEntry:
	...
	goto anon0;
anon0:
	assume after_$_0 == $Heap[listEl,Ln];
	assume oldList_$_0 == $Heap[listEl,LL];
	assume $Heap_$_0 == $Heap[listEl,Ln := el];
	assume $Heap_$_1 == $Heap_$_0[after_$_0,Lp := el];
	assume $Heap_$_2 == $Heap_$_1[el,Lp := listEl];
	assume $Heap_$_3 == $Heap_$_2[el,Ln := after_$_0];
	assume $Heap_$_4 == $Heap_$_3[el,Lb := $Heap_$_3[listEl,Lb]];
	assume $Heap_$_5 == $Heap_$_4[el,Le := $Heap_$_4[listEl,Le]];
	assume $Heap_$_6 == $Heap_$_5[el,LPC := $Heap_$_5[after_$_0,LPC]];
	assume $Heap_$_7 == $Heap_$_6[el,LNC := $Heap_$_6[listEl,LNC]];
	assume $Heap_$_8 == $Heap_$_7[el,LL := AddEl(oldList_$_0,el)];
	assume call2formal_$_r2_$_0 == Singleton(el);
	assume (forall  o_$33 : ref :: ( oldList_$_0[o_$33] ==> ($Heap_$_9[o_$33,LL] == Union($Heap_$_8[o_$33,LL],call2formal_$_r2_$_0)) ));
	assume ((forall  o_$34_$0 : ref, f_$3 : field (ref)  :: ( ($Heap_$_9[o_$34_$0,f_$3] == $Heap_$_8[o_$34_$0,f_$3]) || (oldList_$_0[o_$34_$0] && false) ))) && ((forall  o_$34_$1 : ref, f_$4 : field ([ref]Boolean)  :: ( ($Heap_$_9[o_$34_$1,f_$4] == $Heap_$_8[o_$34_$1,f_$4]) || (oldList_$_0[o_$34_$1] && (f_$4 == LL)) )));
	assume call0formal_$_r1_$_0 == $Heap_$_9[el,LPC];
	assume call2formal_$_r2_$_0 == Singleton(el);
	assume (forall  o_$35 : ref :: ( call0formal_$_r1_$_0[o_$35] ==> ($Heap_$_10[o_$35,LNC] == Union($Heap_$_9[o_$35,LNC],call2formal_$_r2_$_0)) ));
	assume ((forall  o_$36_$0 : ref, f_$0_$0 : field (ref)  :: ( ($Heap_$_10[o_$36_$0,f_$0_$0] == $Heap_$_9[o_$36_$0,f_$0_$0]) || (call0formal_$_r1_$_0[o_$36_$0] && false) ))) && ((forall  o_$36_$1 : ref, f_$0_$1 : field ([ref]Boolean)  :: ( ($Heap_$_10[o_$36_$1,f_$0_$1] == $Heap_$_9[o_$36_$1,f_$0_$1]) || (call0formal_$_r1_$_0[o_$36_$1] && (f_$0_$1 == LNC)) )));
	assume call0formal_$_r1_$_0 == $Heap_$_10[el,LNC];
	assume call2formal_$_r2_$_0 == Singleton(el);
	assume (forall  o_$37 : ref :: ( call0formal_$_r1_$_0[o_$37] ==> ($Heap_$_11[o_$37,LPC] == Union($Heap_$_10[o_$37,LPC],call2formal_$_r2_$_0)) ));
	assume ((forall  o_$38_$0 : ref, f_$1_$0 : field (ref)  :: ( ($Heap_$_11[o_$38_$0,f_$1_$0] == $Heap_$_10[o_$38_$0,f_$1_$0]) || (call0formal_$_r1_$_0[o_$38_$0] && false) ))) && ((forall  o_$38_$1 : ref, f_$1_$1 : field ([ref]Boolean)  :: ( ($Heap_$_11[o_$38_$1,f_$1_$1] == $Heap_$_10[o_$38_$1,f_$1_$1]) || (call0formal_$_r1_$_0[o_$38_$1] && (f_$1_$1 == LPC)) )));
	...
	assert  (forall  o_$39 : ref, o'_$9 : ref :: ( ((!(o_$39 == null)) && (!(o'_$9 == null))) ==> ($Heap_$_11[o_$39,LNC][o'_$9] ==> Sub($Heap_$_11[o'_$9,LNC],$Heap_$_11[o_$39,LNC])) ));
	assert  InvNCNC($Heap_$_11);
	assert  InvList($Heap_$_11);
	assert  $Heap_$_11[listEl,Ln] == el;
	assert  $Heap_$_11[$Heap[listEl,Ln],Lp] == el;
	assert  $Heap_$_11[el,Lp] == listEl;
	assert  $Heap_$_11[el,Ln] == $Heap[listEl,Ln];
	assert  $Heap_$_11[el,Lb] == $Heap_$_11[listEl,Lb];
	assert  $Heap_$_11[el,Le] == $Heap_$_11[listEl,Le];
	assert  $Heap_$_11[el,LPC] == $Heap[$Heap[listEl,Ln],LPC];
	assert  $Heap_$_11[el,LNC] == $Heap[listEl,LNC];
	assert  $Heap_$_11[el,LL] == AddEl($Heap[listEl,LL],el);
	assert  (forall  o_$40 : ref :: ( $Heap[listEl,LL][o_$40] ==> Equal($Heap_$_11[o_$40,LL],AddEl($Heap[o_$40,LL],el)) ));
	assert  (forall  o_$41 : ref :: ( $Heap[$Heap[listEl,Ln],LPC][o_$41] ==> Equal($Heap_$_11[o_$41,LNC],AddEl($Heap[o_$41,LNC],el)) ));
	assert  (forall  o_$42 : ref :: ( $Heap[listEl,LNC][o_$42] ==> Equal($Heap_$_11[o_$42,LPC],AddEl($Heap[o_$42,LPC],el)) ));
	assert  ((forall  o_$43_$0 : ref, f_$2_$0 : field (ref)  :: ( ((((((((((((($Heap_$_11[o_$43_$0,f_$2_$0] == $Heap[o_$43_$0,f_$2_$0]) || ((o_$43_$0 == listEl) && (f_$2_$0 == Ln))) || ((o_$43_$0 == $Heap[listEl,Ln]) && (f_$2_$0 == Lp))) || ((o_$43_$0 == $Heap[listEl,Le]) && (f_$2_$0 == Ln))) || ((o_$43_$0 == el) && (f_$2_$0 == Lp))) || ((o_$43_$0 == el) && (f_$2_$0 == Ln))) || ((o_$43_$0 == el) && (f_$2_$0 == Lb))) || ((o_$43_$0 == el) && (f_$2_$0 == Le))) || ((o_$43_$0 == el) && false)) || ((o_$43_$0 == el) && false)) || ((o_$43_$0 == el) && false)) || ($Heap[listEl,LL][o_$43_$0] && false)) || ($Heap[$Heap[listEl,Ln],LPC][o_$43_$0] && false)) || ($Heap[listEl,LNC][o_$43_$0] && false) ))) && ((forall  o_$43_$1 : ref, f_$2_$1 : field ([ref]Boolean)  :: ( ((((((((((((($Heap_$_11[o_$43_$1,f_$2_$1] == $Heap[o_$43_$1,f_$2_$1]) || ((o_$43_$1 == listEl) && false)) || ((o_$43_$1 == $Heap[listEl,Ln]) && false)) || ((o_$43_$1 == $Heap[listEl,Le]) && false)) || ((o_$43_$1 == el) && false)) || ((o_$43_$1 == el) && false)) || ((o_$43_$1 == el) && false)) || ((o_$43_$1 == el) && false)) || ((o_$43_$1 == el) && (f_$2_$1 == LPC))) || ((o_$43_$1 == el) && (f_$2_$1 == LNC))) || ((o_$43_$1 == el) && (f_$2_$1 == LL))) || ($Heap[listEl,LL][o_$43_$1] && (f_$2_$1 == LL))) || ($Heap[$Heap[listEl,Ln],LPC][o_$43_$1] && (f_$2_$1 == LNC))) || ($Heap[listEl,LNC][o_$43_$1] && (f_$2_$1 == LPC)) )));
	goto $exit;
}
