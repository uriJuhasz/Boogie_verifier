...
;Axioms
   (assert (! (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 oldEnd@0 Lp null)) :named ax_0))
   (assert (! (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 oldEnd@0 Ln null)) :named ax_1))
   (assert (! (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 oldEnd@0 Lb oldEnd@0)) :named ax_2))
   (assert (! (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 oldEnd@0 Le oldEnd@0)) :named ax_3))
   (assert (! (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@4 oldEnd@0 LPC Empty)) :named ax_4))
   (assert (! (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 oldEnd@0 LNC Empty)) :named ax_5))
   (assert (! (= $Heap@7 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 oldEnd@0 LL (Singleton oldEnd@0))) :named ax_6))
   (assert (! (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap newEnd@0 Ln null) $Heap@0) :named ax_7))
   (assert (! (= (RemEl (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap list LL) oldEnd@0) newList@0) :named ax_8))
   (assert (! (= (Singleton oldEnd@0) call2formal@r2@0) :named ax_9))
   (assert (! (= (Singleton oldEnd@0) call2formal@r2@0) :named ax_10))
   (assert (! (= newEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap oldEnd@0 Lp)) :named ax_11))
   ...
   (assert (! (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$35|) (= (Minus (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC)))) :named ax_74))
   ...
   (assert (! (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$36_$1|) (= LNC |f_$0_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$36_$1| |f_$0_$1|)))) :named ax_76))
   (assert (! (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$37|) (= newEnd@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$37| Le)))) :named ax_77))
   (assert (! (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ newList@0 |o_$38_$0|) (= Le |f_$1_$0|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|)))) :named ax_78))
