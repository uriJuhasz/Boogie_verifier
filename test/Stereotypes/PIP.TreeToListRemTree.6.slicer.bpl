...
PreconditionGeneratedEntry:
	...
	assume InvTree($Heap);
	assume InvList($Heap);
	assume (forall  o_$74 : ref :: ( RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$74] ==> ($Heap[o_$74,Np] == $Heap[o_$74,Ln]) ));
	assume (forall  o_$75 : ref :: ( $Heap[subTree,NA][o_$75] ==> AddEl($Heap[subTree,NA],subTree)[$Heap[o_$75,Lp]] ));
	assume (forall  o_$76 : ref :: ( $Heap[subTree,NA][o_$76] ==> $Heap[o_$76,NC][$Heap[o_$76,Lp]] ));
	goto anon0;
anon0:
	assume nextTree_$_0 == $Heap[tree,Lp];
	assert  !(tree == null);
	assert  !(nextTree_$_0 == null);
	assert  $Heap[tree,NC][nextTree_$_0];
	assert  InvTree($Heap);
	assert  InvList($Heap);
	assume InvTree($Heap_$_0);
	assume InvList($Heap_$_0);
	assume (((((forall  o_$77_$0 : ref, f_$3_$0 : field (ref)  :: ( ((((($Heap_$_0[o_$77_$0,f_$3_$0] == $Heap[o_$77_$0,f_$3_$0]) || ((o_$77_$0 == nextTree_$_0) && (f_$3_$0 == Np))) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$0] && (f_$3_$0 == Nt))) || ((o_$77_$0 == tree) && false)) || (AddEl($Heap[tree,NA],tree)[o_$77_$0] && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$0] && false) ))) && ((forall  o_$77_$1 : ref, f_$3_$1 : field ([ref]Boolean)  :: ( ((((($Heap_$_0[o_$77_$1,f_$3_$1] == $Heap[o_$77_$1,f_$3_$1]) || ((o_$77_$1 == nextTree_$_0) && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$1] && false)) || ((o_$77_$1 == tree) && (f_$3_$1 == NC))) || (AddEl($Heap[tree,NA],tree)[o_$77_$1] && (f_$3_$1 == ND))) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$1] && (f_$3_$1 == NA)) )))) && ((forall  o_$77_$2 : ref, f_$3_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_0[o_$77_$2,f_$3_$2] == $Heap[o_$77_$2,f_$3_$2]) || ((o_$77_$2 == nextTree_$_0) && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$2] && false)) || ((o_$77_$2 == tree) && false)) || (AddEl($Heap[tree,NA],tree)[o_$77_$2] && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$2] && false) )))) && ((forall  o_$77_$3 : ref, f_$3_$3 : field (Integer)  :: ( ((((($Heap_$_0[o_$77_$3,f_$3_$3] == $Heap[o_$77_$3,f_$3_$3]) || ((o_$77_$3 == nextTree_$_0) && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$3] && false)) || ((o_$77_$3 == tree) && false)) || (AddEl($Heap[tree,NA],tree)[o_$77_$3] && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$3] && false) )))) && ((forall  o_$77_$4 : ref, f_$3_$4 : field (TNodeState)  :: ( ((((($Heap_$_0[o_$77_$4,f_$3_$4] == $Heap[o_$77_$4,f_$3_$4]) || ((o_$77_$4 == nextTree_$_0) && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$4] && false)) || ((o_$77_$4 == tree) && false)) || (AddEl($Heap[tree,NA],tree)[o_$77_$4] && false)) || (AddEl($Heap[nextTree_$_0,ND],nextTree_$_0)[o_$77_$4] && false) )));
	assume $Heap_$_0[nextTree_$_0,Np] == null;
	assume (forall  o_$78 : ref :: ( AddEl($Heap_$_0[nextTree_$_0,ND],nextTree_$_0)[o_$78] ==> ($Heap_$_0[o_$78,Nt] == nextTree_$_0) ));
	assume $Heap_$_0[tree,NC] == RemEl($Heap[tree,NC],nextTree_$_0);
	assume (forall  o_$79 : ref :: ( AddEl($Heap_$_0[nextTree_$_0,ND],nextTree_$_0)[o_$79] ==> ($Heap_$_0[o_$79,NA] == Minus($Heap[o_$79,NA],AddEl($Heap_$_0[tree,NA],tree))) ));
	assume (forall  o_$80 : ref :: ( AddEl($Heap_$_0[tree,NA],tree)[o_$80] ==> ($Heap_$_0[o_$80,ND] == Minus($Heap[o_$80,ND],AddEl($Heap_$_0[nextTree_$_0,ND],nextTree_$_0))) ));
	if ($_$_condition) { goto anon2_Then; } else { goto anon2_Else; }
anon2_Then:
	assume $_$_condition;
	assume $_$_condition <==> (!(nextTree_$_0 == subTree));
	assume !(nextTree_$_0 == subTree);
	assert  !(nextTree_$_0 == null);
	assert  !(subTree == null);
	assert  $Heap_$_0[nextTree_$_0,Np] == null;
	assert  $Heap_$_0[nextTree_$_0,ND][subTree];
	assert  InvTree($Heap_$_0);
	assert  InvList($Heap_$_0);
	assert  (forall  o_$81 : ref :: ( RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$81] ==> ($Heap_$_0[o_$81,Np] == $Heap_$_0[o_$81,Ln]) ));
	assert  (forall  o_$82 : ref :: ( $Heap_$_0[subTree,NA][o_$82] ==> AddEl($Heap_$_0[subTree,NA],subTree)[$Heap_$_0[o_$82,Lp]] ));
	assert  (forall  o_$83 : ref :: ( $Heap_$_0[subTree,NA][o_$83] ==> $Heap_$_0[o_$83,NC][$Heap_$_0[o_$83,Lp]] ));
	assume InvList($Heap_$_1);
	assume InvTree($Heap_$_1);
	assume (forall  o_$84 : ref :: ( RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$84] ==> ($Heap_$_0[o_$84,Np] == $Heap_$_1[o_$84,Ln]) ));
	assume (forall  o_$85 : ref :: ( AddEl($Heap_$_0[subTree,NA],subTree)[o_$85] ==> ($Heap_$_1[o_$85,Np] == null) ));
	assume (forall  o_$86 : ref :: ( RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$86] ==> ($Heap_$_1[o_$86,NC] == RemEl($Heap_$_0[o_$86,NC],$Heap_$_1[o_$86,Lp])) ));
	assume (forall  o_$87 : ref :: ( RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$87] ==> ($Heap_$_1[o_$87,ND] == Minus($Heap_$_0[o_$87,ND],AddEl($Heap_$_0[$Heap_$_1[o_$87,Lp],ND],$Heap_$_1[o_$87,Lp]))) ));
	assume (forall  o_$88 : ref :: ( AddEl($Heap_$_0[subTree,NA],subTree)[o_$88] ==> Equal($Heap_$_1[o_$88,NA],Empty) ));
	assume (((((forall  o_$89_$0 : ref, f_$4_$0 : field (ref)  :: ( ((((($Heap_$_1[o_$89_$0,f_$4_$0] == $Heap_$_0[o_$89_$0,f_$4_$0]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89_$0] && (f_$4_$0 == Np))) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$0] && (f_$4_$0 == Nt))) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89_$0] && false)) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89_$0] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$0] && false) ))) && ((forall  o_$89_$1 : ref, f_$4_$1 : field ([ref]Boolean)  :: ( ((((($Heap_$_1[o_$89_$1,f_$4_$1] == $Heap_$_0[o_$89_$1,f_$4_$1]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89_$1] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$1] && false)) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89_$1] && (f_$4_$1 == NC))) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89_$1] && (f_$4_$1 == ND))) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$1] && (f_$4_$1 == NA)) )))) && ((forall  o_$89_$2 : ref, f_$4_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_1[o_$89_$2,f_$4_$2] == $Heap_$_0[o_$89_$2,f_$4_$2]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89_$2] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$2] && false)) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89_$2] && false)) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89_$2] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$2] && false) )))) && ((forall  o_$89_$3 : ref, f_$4_$3 : field (Integer)  :: ( ((((($Heap_$_1[o_$89_$3,f_$4_$3] == $Heap_$_0[o_$89_$3,f_$4_$3]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89_$3] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$3] && false)) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89_$3] && false)) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89_$3] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$3] && false) )))) && ((forall  o_$89_$4 : ref, f_$4_$4 : field (TNodeState)  :: ( ((((($Heap_$_1[o_$89_$4,f_$4_$4] == $Heap_$_0[o_$89_$4,f_$4_$4]) || (RemEl(AddEl($Heap_$_0[subTree,NA],subTree),nextTree_$_0)[o_$89_$4] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$4] && false)) || (RemEl(AddEl($Heap_$_0[subTree,NA],nextTree_$_0),subTree)[o_$89_$4] && false)) || (RemEl($Heap_$_0[subTree,NA],subTree)[o_$89_$4] && false)) || (AddEl($Heap_$_0[$Heap_$_1[nextTree_$_0,Lp],ND],$Heap_$_1[nextTree_$_0,Lp])[o_$89_$4] && false) )));
...
GeneratedUnifiedExit:
	...
	assert  (forall  o_$90 : ref :: ( RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$90] ==> ($Heap[o_$90,Np] == $Heap_$_2[o_$90,Ln]) ));
	assert  (forall  o_$91 : ref :: ( AddEl($Heap[subTree,NA],subTree)[o_$91] ==> ($Heap_$_2[o_$91,Np] == null) ));
	assert  (forall  o_$92 : ref :: ( RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$92] ==> ($Heap_$_2[o_$92,NC] == RemEl($Heap[o_$92,NC],$Heap_$_2[o_$92,Lp])) ));
	assert  (forall  o_$93 : ref :: ( RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$93] ==> ($Heap_$_2[o_$93,ND] == Minus($Heap[o_$93,ND],AddEl($Heap[$Heap_$_2[o_$93,Lp],ND],$Heap_$_2[o_$93,Lp]))) ));
	assert  (forall  o_$94 : ref :: ( AddEl($Heap[subTree,NA],subTree)[o_$94] ==> Equal($Heap_$_2[o_$94,NA],Empty) ));
	assert  (((((forall  o_$95_$0 : ref, f_$5_$0 : field (ref)  :: ( ((((($Heap_$_2[o_$95_$0,f_$5_$0] == $Heap[o_$95_$0,f_$5_$0]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95_$0] && (f_$5_$0 == Np))) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$0] && (f_$5_$0 == Nt))) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95_$0] && false)) || (RemEl($Heap[subTree,NA],subTree)[o_$95_$0] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$0] && false) ))) && ((forall  o_$95_$1 : ref, f_$5_$1 : field ([ref]Boolean)  :: ( ((((($Heap_$_2[o_$95_$1,f_$5_$1] == $Heap[o_$95_$1,f_$5_$1]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95_$1] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$1] && false)) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95_$1] && (f_$5_$1 == NC))) || (RemEl($Heap[subTree,NA],subTree)[o_$95_$1] && (f_$5_$1 == ND))) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$1] && (f_$5_$1 == NA)) )))) && ((forall  o_$95_$2 : ref, f_$5_$2 : field ([Integer]Integer)  :: ( ((((($Heap_$_2[o_$95_$2,f_$5_$2] == $Heap[o_$95_$2,f_$5_$2]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95_$2] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$2] && false)) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95_$2] && false)) || (RemEl($Heap[subTree,NA],subTree)[o_$95_$2] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$2] && false) )))) && ((forall  o_$95_$3 : ref, f_$5_$3 : field (Integer)  :: ( ((((($Heap_$_2[o_$95_$3,f_$5_$3] == $Heap[o_$95_$3,f_$5_$3]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95_$3] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$3] && false)) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95_$3] && false)) || (RemEl($Heap[subTree,NA],subTree)[o_$95_$3] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$3] && false) )))) && ((forall  o_$95_$4 : ref, f_$5_$4 : field (TNodeState)  :: ( ((((($Heap_$_2[o_$95_$4,f_$5_$4] == $Heap[o_$95_$4,f_$5_$4]) || (RemEl(AddEl($Heap[subTree,NA],subTree),tree)[o_$95_$4] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$4] && false)) || (RemEl(AddEl($Heap[subTree,NA],tree),subTree)[o_$95_$4] && false)) || (RemEl($Heap[subTree,NA],subTree)[o_$95_$4] && false)) || (AddEl($Heap[$Heap_$_2[tree,Lp],ND],$Heap_$_2[tree,Lp])[o_$95_$4] && false) )));
	goto $exit;
}
