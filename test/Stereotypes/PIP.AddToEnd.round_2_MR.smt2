...
;Axioms
   ...
   (assert (! (not (= Lb Nt)) :named ax_127))
   (assert (! (not (= Le Lb)) :named ax_128))
   (assert (! (not (= Le Nt)) :named ax_129))
   (assert (! (not (= LL NC)) :named ax_130))
   (assert (! (not (= LL ND)) :named ax_131))
   (assert (! (not (= Ln Lb)) :named ax_132))
   (assert (! (not (= Ln Le)) :named ax_133))
   (assert (! (not (= Ln Lp)) :named ax_134))
   (assert (! (not (= Ln Nbb)) :named ax_135))
   (assert (! (not (= Ln Nt)) :named ax_136))
   (assert (! (not (= Lp Lb)) :named ax_137))
   (assert (! (not (= Lp Le)) :named ax_138))
   (assert (! (not (= Lp Ln)) :named ax_139))
   (assert (! (not (= Lp Nbb)) :named ax_140))
   (assert (! (not (= Lp Nt)) :named ax_141))
   (assert (! (not (= NA LL)) :named ax_142))
   (assert (! (not (= NA NC)) :named ax_143))
   (assert (! (not (= NA ND)) :named ax_144))
   (assert (! (not (= Nbb Lb)) :named ax_145))
   (assert (! (not (= Nbb Le)) :named ax_146))
   (assert (! (not (= Nbb Ln)) :named ax_147))
   (assert (! (not (= Nbb Lp)) :named ax_148))
   (assert (! (not (= Nbb Nt)) :named ax_149))
   (assert (! (not (= NC LL)) :named ax_150))
   (assert (! (not (= NC NA)) :named ax_151))
   (assert (! (not (= NC ND)) :named ax_152))
   (assert (! (not (= Ncpr Ndpr)) :named ax_153))
   (assert (! (not (= ND LL)) :named ax_154))
   (assert (! (not (= ND NA)) :named ax_155))
   (assert (! (not (= ND NC)) :named ax_156))
   (assert (! (not (= Ndpr Ncpr)) :named ax_157))
   (assert (! (not (= Np Lb)) :named ax_158))
   (assert (! (not (= Np Le)) :named ax_159))
   (assert (! (not (= Np Ln)) :named ax_160))
   (assert (! (not (= Np Lp)) :named ax_161))
   (assert (! (not (= Np Nbb)) :named ax_162))
   (assert (! (not (= Np Nt)) :named ax_163))
   (assert (! (not (= Nt Lb)) :named ax_164))
   (assert (! (not (= Nt Le)) :named ax_165))
   (assert (! (not (= Nt Ln)) :named ax_166))
   (assert (! (not (= Nt Lp)) :named ax_167))
   (assert (! (not (= Nt Nbb)) :named ax_168))
   (assert (! (not (= Nt Np)) :named ax_169))
   (assert (! (not (= null el)) :named ax_170))
   (assert (! (not (= null list)) :named ax_171))
   (assert (! (not (= StF StD)) :named ax_172))
   (assert (! (not (= StF StL)) :named ax_173))
   (assert (! (not (= StL StD)) :named ax_174))
   (assert (! (not (= StL StF)) :named ax_175))
   (assert (! (not (= true false)) :named ax_176))
   (assert (! (not (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 el)) :named ax_177))
   (assert (! true :named ax_178))
