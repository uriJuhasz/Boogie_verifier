...
(let ((anon0 (=> (and true
    (= $Heap@1 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@0 after@0 Lp el))
    (= $Heap@2 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@1 el Lp listEl))
    (= $Heap@3 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@2 el Ln after@0))
    (= $Heap@4 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 el Lb (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@3 listEl Lb)))
    (= $Heap@5 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 el Le (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@4 listEl Le)))
    (= $Heap@6 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 el LPC (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@5 after@0 LPC)))
    (= $Heap@7 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 el LNC (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@6 listEl LNC)))
    (= $Heap@8 (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@7 el LL (AddEl oldList@0 el)))
    (= (MapWrite$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln el) $Heap@0)
    (= (Singleton el) call2formal@r2@0)
    (= (Singleton el) call2formal@r2@0)
    (= (Singleton el) call2formal@r2@0)
    (= after@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap listEl Ln))
    (= call0formal@r1@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 el LNC))
    (= call0formal@r1@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 el LPC))
    (= oldList@0 (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap listEl LL))
    (forall( (|o_$33| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$33|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$33| LL) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$33| LL))))
    (forall( (|o_$34_$0| ref) (|f_$3| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$34_$0| |f_$3|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@8 |o_$34_$0| |f_$3|)))
    (forall( (|o_$34_$1| ref) (|f_$4| field$$@Map@@ref@To@Bool@@$))(or (and (MapRead$$@Map@@ref@To@Bool@@$ oldList@0 |o_$34_$1|) (= LL |f_$4|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$34_$1| |f_$4|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@8 |o_$34_$1| |f_$4|))))
    (forall( (|o_$35| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$35|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$35| LNC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$35| LNC))))
    (forall( (|o_$36_$0| ref) (|f_$0_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@9 |o_$36_$0| |f_$0_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$36_$0| |f_$0_$0|)))
    (forall( (|o_$36_$1| ref) (|f_$0_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LNC |f_$0_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$36_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@9 |o_$36_$1| |f_$0_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$36_$1| |f_$0_$1|))))
    (forall( (|o_$37| ref))(=> (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$37|) (= (Union (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$37| LPC) call2formal@r2@0) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$37| LPC))))
    (forall( (|o_$38_$0| ref) (|f_$1_$0| field$ref$))(= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@11 |o_$38_$0| |f_$1_$0|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$ref$ $Heap@10 |o_$38_$0| |f_$1_$0|)))
    (forall( (|o_$38_$1| ref) (|f_$1_$1| field$$@Map@@ref@To@Bool@@$))(or (and (= LPC |f_$1_$1|) (MapRead$$@Map@@ref@To@Bool@@$ call0formal@r1@0 |o_$38_$1|)) (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@11 |o_$38_$1| |f_$1_$1|) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$$@Map@@ref@To@Bool@@$ $Heap@10 |o_$38_$1| |f_$1_$1|))))
  )(and 
    anon0_assertion
    anon0@1
))))
...
(let (($start (=> (and true
    ...
    (forall( (|h_$23| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvIsGoodRegionsListEx |h_$23| Empty) (InvIsGoodRegionsList |h_$23|)))
    (forall( (|h_$24| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvLEx |h_$24| Empty) (InvL |h_$24|)))
    (forall( (|h_$25| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvNCPCEx |h_$25| Empty) (InvNCPC |h_$25|)))
    (forall( (|h_$26| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvNCn1Ex |h_$26| Empty) (InvNCn1 |h_$26|)))
    (forall( (|h_$27| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvNCn2Ex |h_$27| Empty) (InvNCn2 |h_$27|)))
    (forall( (|h_$28| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvNCoEx |h_$28| Empty) (InvNCo |h_$28|)))
    (forall( (|h_$29| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (Inve1Ex |h_$29| Empty) (Inve1 |h_$29|)))
    ...
    (forall( (|h_$30| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (Inve2Ex |h_$30| Empty) (Inve2 |h_$30|)))
    (forall( (|h_$32| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvPCp1Ex |h_$32| Empty) (InvPCp1 |h_$32|)))
    (forall( (|h_$33| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvPCp2Ex |h_$33| Empty) (InvPCp2 |h_$33|)))
    (forall( (|h_$34| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvPCoEx |h_$34| Empty) (InvPCo |h_$34|)))
    (forall( (|h_$35| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (Invb1Ex |h_$35| Empty) (Invb1 |h_$35|)))
    (forall( (|h_$36| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (Invb2Ex |h_$36| Empty) (Invb2 |h_$36|)))
    (forall( (|h_$38| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvLbEx |h_$38| Empty Empty) (InvLb |h_$38|)))
    (forall( (|h_$39| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvLeEx |h_$39| Empty Empty) (InvLe |h_$39|)))
    ...
    (forall( (|h_$40| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvLL1Ex |h_$40| Empty Empty) (InvLL1 |h_$40|)))
    (forall( (|h_$41| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvLL2Ex |h_$41| Empty Empty) (InvLL2 |h_$41|)))
    (forall( (|h_$42| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvNCNCEx |h_$42| Empty Empty) (InvNCNC |h_$42|)))
    (forall( (|h_$43| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvPCPCEx |h_$43| Empty Empty) (InvPCPC |h_$43|)))
    (forall( (|h_$44| $@Map@@$T0@@ref@field$$T0$@To@$T0@@))(= (InvpEx |h_$44| Empty Empty) (Invp |h_$44|)))
