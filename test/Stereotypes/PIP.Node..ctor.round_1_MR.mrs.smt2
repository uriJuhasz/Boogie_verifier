...
;Axioms
   ...
   (assert (! (not (< priority 0)) :named ax_119))
   (assert (! (not (= Lb Le)) :named ax_120))
   (assert (! (not (= Lb Nt)) :named ax_121))
   (assert (! (not (= Le Lb)) :named ax_122))
   (assert (! (not (= Le Nt)) :named ax_123))
   (assert (! (not (= LL NC)) :named ax_124))
   (assert (! (not (= LL ND)) :named ax_125))
   (assert (! (not (= Ln Lb)) :named ax_126))
   (assert (! (not (= Ln Le)) :named ax_127))
   (assert (! (not (= Ln Lp)) :named ax_128))
   (assert (! (not (= Ln Nt)) :named ax_129))
   (assert (! (not (= Lp Lb)) :named ax_130))
   (assert (! (not (= Lp Le)) :named ax_131))
   (assert (! (not (= Lp Ln)) :named ax_132))
   (assert (! (not (= Lp Nt)) :named ax_133))
   (assert (! (not (= NA LL)) :named ax_134))
   (assert (! (not (= NA NC)) :named ax_135))
   (assert (! (not (= NA ND)) :named ax_136))
   (assert (! (not (= Nbb Lb)) :named ax_137))
   (assert (! (not (= Nbb Le)) :named ax_138))
   (assert (! (not (= Nbb Ln)) :named ax_139))
   (assert (! (not (= Nbb Lp)) :named ax_140))
   (assert (! (not (= Nbb Nt)) :named ax_141))
   (assert (! (not (= NC LL)) :named ax_142))
   (assert (! (not (= NC NA)) :named ax_143))
   (assert (! (not (= NC ND)) :named ax_144))
   (assert (! (not (= Ncpr Ndpr)) :named ax_145))
   (assert (! (not (= ND LL)) :named ax_146))
   (assert (! (not (= ND NA)) :named ax_147))
   (assert (! (not (= ND NC)) :named ax_148))
   (assert (! (not (= Ndpr Ncpr)) :named ax_149))
   (assert (! (not (= Np Lb)) :named ax_150))
   (assert (! (not (= Np Le)) :named ax_151))
   (assert (! (not (= Np Ln)) :named ax_152))
   (assert (! (not (= Np Lp)) :named ax_153))
   (assert (! (not (= Np Nbb)) :named ax_154))
   (assert (! (not (= Np Nt)) :named ax_155))
   (assert (! (not (= Nt Lb)) :named ax_156))
   (assert (! (not (= Nt Le)) :named ax_157))
   (assert (! (not (= Nt Ln)) :named ax_158))
   (assert (! (not (= Nt Lp)) :named ax_159))
   (assert (! (not (= Nt Nbb)) :named ax_160))
   (assert (! (not (= Nt Np)) :named ax_161))
   (assert (! (not (= null this)) :named ax_162))
   (assert (! (not (= StF StD)) :named ax_163))
   (assert (! (not (= StF StL)) :named ax_164))
   (assert (! (not (= StL StD)) :named ax_165))
   (assert (! (not (= StL StF)) :named ax_166))
   (assert (! (not (= true false)) :named ax_167))
   (assert (! true :named ax_168))
...
(assert (! (=> anon0@8 (and true 
   (and true
      ...
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 this NSt) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@2 this NSt))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 this NSt) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@3 this NSt))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 this NSt) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@4 this NSt))
      (= (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@1 this NSt) (MapRead$$@Map@@$T0@@ref@field$$T0$@To@$T0@@$TNodeState$ $Heap@5 this NSt))
