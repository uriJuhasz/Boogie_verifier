...
;Axioms
   ...
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_262))
   ...
   (assert (! (not (= AVLTree.valid forkK)) :named ax_266))
   (assert (! (not (= AVLTree.valid held)) :named ax_267))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_268))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_269))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_270))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_271))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_272))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_273))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_274))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_275))
   ...
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_278))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_279))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_280))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_281))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_282))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_283))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_284))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_285))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_286))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_287))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_288))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_289))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_290))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_291))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_292))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_293))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_294))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_295))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_296))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_297))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_298))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_299))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_300))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_301))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_302))
   (assert (! (not (= channelK 0)) :named ax_303))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_304))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_305))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_306))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_307))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_308))
   (assert (! (not (= forkK held)) :named ax_309))
   (assert (! (not (= forkK joinable)) :named ax_310))
   (assert (! (not (= held AVLTree.valid)) :named ax_311))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_312))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_313))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_314))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_315))
   (assert (! (not (= held forkK)) :named ax_316))
   (assert (! (not (= held joinable)) :named ax_317))
   (assert (! (not (= joinable AVLTree.valid)) :named ax_318))
   (assert (! (not (= joinable AVLTreeNode.balanceFactor)) :named ax_319))
   (assert (! (not (= joinable AVLTreeNode.height)) :named ax_320))
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_321))
   (assert (! (not (= joinable AVLTreeNode.valid)) :named ax_322))
   (assert (! (not (= joinable forkK)) :named ax_323))
   (assert (! (not (= joinable held)) :named ax_324))
   (assert (! (not (= methodK@_11 0)) :named ax_325))
   (assert (! (not (= perm$N perm$R)) :named ax_326))
   (assert (! (not (= perm$R perm$N)) :named ax_327))
   (assert (! (not (= Permission$denominator 0)) :named ax_328))
   (assert (! (not (= Permission$FullFraction 0)) :named ax_329))
