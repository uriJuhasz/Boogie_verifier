...
;Axioms
   ...
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_11))) :named ax_269))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_270))
   ...
   (assert (! (not (= AVLTree.valid forkK)) :named ax_274))
   (assert (! (not (= AVLTree.valid held)) :named ax_275))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_276))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_277))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_278))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_279))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_280))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_281))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_282))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_283))
   (assert (! (not (= AVLTreeNode.height AVLTree.valid)) :named ax_284))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.balanceFactor)) :named ax_285))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_286))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_287))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_288))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_289))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_290))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_291))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_292))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_293))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_294))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_295))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_296))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_297))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_298))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_299))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_300))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_301))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_302))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_303))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_304))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_305))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_306))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_307))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_308))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_309))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_310))
   (assert (! (not (= channelK 0)) :named ax_311))
   ...
   (assert (! (not (= methodK@_11 0)) :named ax_333))
   ...
   (assert (! (not (= Permission$FullFraction 0)) :named ax_337))
   (assert (! (not (= this null)) :named ax_338))
   (assert (! (not (ite$Bool$ false false false)) :named ax_339))
   (assert (! (not (ite$Bool$ false true false)) :named ax_340))
   (assert (! (not (ite$Bool$ true false false)) :named ax_341))
   (assert (! (not (ite$Bool$ true false true)) :named ax_342))
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root)) AVLTreeNode@t)) :named ax_343))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_344))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_345))
   (assert (! (wf Heap Mask SecMask) :named ax_346))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_347))
   (assert (! (wf Heap SecMask SecMask) :named ax_348))
   (assert (! CanAssumeFunctionDefs :named ax_349))
