...
PreconditionGeneratedEntry:
	...
	assume $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,P#y)));
	assume $ptr_neq($read_ptr($s,$dot($ptr(^Node,P#y),Node.left),^Node),$null);
...
anon56:
	...
	assume prestate#71_$_0 == $current_state($s);
	...
	assume (forall  #p_$62 : $ptr :: {$st($s_$_0,#p_$62)} {$ts($s_$_0,#p_$62)} {$set_in(#p_$62,$owns($s,call0formal_$_#l_$_0))} ( $set_in(#p_$62,$owns($s,call0formal_$_#l_$_0)) ==> ((($typed($s,#p_$62) && $wrapped($s_$_0,#p_$62,$typ(#p_$62))) && $timestamp_is_now($s_$_0,#p_$62)) && $is_non_primitive($typ(#p_$62))) ));
	...
	assume (forall  #p_$65 : $ptr :: {$st($s_$_0,#p_$65)} {:weight  0}( (($st($s_$_0,#p_$65) == $st($s,#p_$65)) || ($nested($s,#p_$65) && $set_in(#p_$65,$owns($s,call0formal_$_#l_$_0)))) || (#p_$65 == call0formal_$_#l_$_0) ));
	...
	assume prestate#72_$_0 == $current_state($s_$_0);
	...
	assume prestate#74_$_0 == $current_state($s_$_0);
	assume $local_value_is($s_$_0,#tok$2^0.0,#loc.prestate#74,$state_to_int(prestate#74_$_0),^$#state_t);
	assert  $wrapped($s_$_0,$ptr(^Node,P#y),^Node);
	assert  $top_writable($s_$_0,#wrTime$1^246.1,$ptr(^Node,P#y));
	assume $inv($s_$_0,$ptr(^Node,P#y),^Node);
	...
	assume (forall  #p_$66 : $ptr :: {$st($s_$_1,#p_$66)} {$ts($s_$_1,#p_$66)} {$set_in(#p_$66,$owns($s_$_0,call0formal_$_#l_$_0_$1))} ( $set_in(#p_$66,$owns($s_$_0,call0formal_$_#l_$_0_$1)) ==> ((($typed($s_$_0,#p_$66) && $wrapped($s_$_1,#p_$66,$typ(#p_$66))) && $timestamp_is_now($s_$_1,#p_$66)) && $is_non_primitive($typ(#p_$66))) ));
	...
	assume $timestamp_is_now($s_$_1,call0formal_$_#l_$_0_$1);
	assume $typemap($s_$_0) == $typemap($s_$_1);
	assume (forall  #p_$69 : $ptr :: {$st($s_$_1,#p_$69)} {:weight  0}( (($st($s_$_1,#p_$69) == $st($s_$_0,#p_$69)) || ($nested($s_$_0,#p_$69) && $set_in(#p_$69,$owns($s_$_0,call0formal_$_#l_$_0_$1)))) || (#p_$69 == call0formal_$_#l_$_0_$1) ));
	...
	assert  $typed2($s_$_1,$dot($ptr(^Node,P#y),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_1,$dot($ptr(^Node,P#y),Node.left),$ptr_to(^Node));
	assume L#x_$_0 == $ref($read_ptr($s_$_1,$dot($ptr(^Node,P#y),Node.left),^Node));
	...
	assume prestate#75_$_0 == $current_state($s_$_1);
	...
	assume prestate#77_$_0 == $current_state($s_$_1);
	assume $local_value_is($s_$_1,#tok$2^0.0,#loc.prestate#77,$state_to_int(prestate#77_$_0),^$#state_t);
	assert  $wrapped($s_$_1,$ptr(^Node,L#x_$_0),^Node);
	assert  $top_writable($s_$_1,#wrTime$1^246.1,$ptr(^Node,L#x_$_0));
	assume $inv($s_$_1,$ptr(^Node,L#x_$_0),^Node);
	...
	assume (forall  #p_$70 : $ptr :: {$st($s_$_2,#p_$70)} {$ts($s_$_2,#p_$70)} {$set_in(#p_$70,$owns($s_$_1,call0formal_$_#l_$_0_$2))} ( $set_in(#p_$70,$owns($s_$_1,call0formal_$_#l_$_0_$2)) ==> ((($typed($s_$_1,#p_$70) && $wrapped($s_$_2,#p_$70,$typ(#p_$70))) && $timestamp_is_now($s_$_2,#p_$70)) && $is_non_primitive($typ(#p_$70))) ));
	...
	assume $timestamp_is_now($s_$_2,call0formal_$_#l_$_0_$2);
	assume $typemap($s_$_1) == $typemap($s_$_2);
	assume (forall  #p_$73 : $ptr :: {$st($s_$_2,#p_$73)} {:weight  0}( (($st($s_$_2,#p_$73) == $st($s_$_1,#p_$73)) || ($nested($s_$_1,#p_$73) && $set_in(#p_$73,$owns($s_$_1,call0formal_$_#l_$_0_$2)))) || (#p_$73 == call0formal_$_#l_$_0_$2) ));
	...
	assert  $typed2($s_$_2,$dot($ptr(^Node,P#y),Node.left),$ptr_to(^Node));
	assert  $writable($s_$_2,#wrTime$1^246.1,$dot($ptr(^Node,P#y),Node.left));
	assert  $typed2($s_$_2,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assert  $thread_local2($s_$_2,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assume call0formal_$_p_$_0 == $dot($ptr(^Node,P#y),Node.left);
	assume call1formal_$_v_$_0 == $ref($read_ptr($s_$_2,$dot($ptr(^Node,L#x_$_0),Node.right),^Node));
	...
	assume $full_stop_ext(#tok$1^259.3,$s_$_3);
	assert  $typed2($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assert  $thread_local2($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assume true;
	if ($_$_condition) { goto anon00_Then; } else { goto anon00_Else; }
anon00_Then:
	assume $_$_condition;
	assume $_$_condition <==> $ptr_neq($read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),$null);
	assume $ptr_neq($read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),$null);
	...
	assume prestate#78_$_0 == $current_state($s_$_3);
	...
	assume prestate#80_$_0 == $current_state($s_$_3);
	assume $local_value_is($s_$_3,#tok$2^0.0,#loc.prestate#80,$state_to_int(prestate#80_$_0),^$#state_t);
	assert  $wrapped($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),^Node);
	assert  $top_writable($s_$_3,#wrTime$1^246.1,$read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node));
	assume $inv($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),^Node);
	assume owns#79_$_0 == $owns($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node));
	assume $pre_static_unwrap($s_$_3);
	assume call0formal_$_#l_$_0_$8 == $read_ptr($s_$_3,$dot($ptr(^Node,L#x_$_0),Node.right),^Node);
	...
	assume (forall  #p_$74 : $ptr :: {$st($s_$_4,#p_$74)} {$ts($s_$_4,#p_$74)} {$set_in(#p_$74,$owns($s_$_3,call0formal_$_#l_$_0_$8))} ( $set_in(#p_$74,$owns($s_$_3,call0formal_$_#l_$_0_$8)) ==> ((($typed($s_$_3,#p_$74) && $wrapped($s_$_4,#p_$74,$typ(#p_$74))) && $timestamp_is_now($s_$_4,#p_$74)) && $is_non_primitive($typ(#p_$74))) ));
	...
	assume $timestamp_is_now($s_$_4,call0formal_$_#l_$_0_$8);
	assume $typemap($s_$_3) == $typemap($s_$_4);
	assume (forall  #p_$77 : $ptr :: {$st($s_$_4,#p_$77)} {:weight  0}( (($st($s_$_4,#p_$77) == $st($s_$_3,#p_$77)) || ($nested($s_$_3,#p_$77) && $set_in(#p_$77,$owns($s_$_3,call0formal_$_#l_$_0_$8)))) || (#p_$77 == call0formal_$_#l_$_0_$8) ));
	...
	assert  $typed2($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_4,#wrTime$1^246.1,$dot($read_ptr($s_$_4,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),Node.parent));
	assert  $typed2($s_$_4,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assert  $thread_local2($s_$_4,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$9 == $dot($read_ptr($s_$_4,$dot($ptr(^Node,L#x_$_0),Node.right),^Node),Node.parent);
	...
	assume staticWrapState#81_$_0 == $current_state($s_$_5);
	...
	assert  $top_writable($s_$_5,#wrTime$1^246.1,$read_ptr($s_$_5,$dot($ptr(^Node,L#x_$_0),Node.right),^Node));
	assume $pre_static_wrap($s_$_5);
	assume call0formal_$_#l_$_0_$9 == $read_ptr($s_$_5,$dot($ptr(^Node,L#x_$_0),Node.right),^Node);
	...
	assume $wrapped($s_$_6,call0formal_$_#l_$_0_$9,$typ(call0formal_$_#l_$_0_$9));
	...
	assert  $set_eq($owns($s_$_6,$read_ptr($s_$_6,$dot($ptr(^Node,L#x_$_0),Node.right),^Node)),$set_empty());
...
anon00_Else:
	...
	goto anon57;
anon57:
	assert  $typed2($s_$_7,$dot($ptr(^Node,L#x_$_0),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_7,#wrTime$1^246.1,$dot($ptr(^Node,L#x_$_0),Node.parent));
	assert  $typed2($s_$_7,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_7,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$1 == $dot($ptr(^Node,L#x_$_0),Node.parent);
	assume call1formal_$_v_$_0_$1 == $ref($read_ptr($s_$_7,$dot($ptr(^Node,P#y),Node.parent),^Node));
	...
	assume $full_stop_ext(#tok$1^262.3,$s_$_8);
	assert  $typed2($s_$_8,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_8,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assume true;
	if ($_$_condition_$0) { goto anon01_Then; } else { goto anon01_Else; }
anon01_Then:
	assume $_$_condition_$0;
	assume $_$_condition_$0 <==> $ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),$null);
	assume $ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),$null);
	assert  $typed2($s_$_8,$dot($ptr(^Tree,P#t),Tree.root),$ptr_to(^Node));
	assert  $writable($s_$_8,#wrTime$1^246.1,$dot($ptr(^Tree,P#t),Tree.root));
	...
	assume $full_stop_ext(#tok$1^263.32,$s_$_9);
	assume $s_$_15 == $s_$_9;
	goto anon58;
anon01_Else:
	assume !$_$_condition_$0;
	assume $_$_condition_$0 <==> $ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),$null);
	assume !$ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),$null);
	assert  F#doMark($ref($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node)));
	assume F#doMark($ref($read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node)));
	...
	assume prestate#84_$_0 == $current_state($s_$_8);
	...
	assume prestate#86_$_0 == $current_state($s_$_8);
	assume $local_value_is($s_$_8,#tok$2^0.0,#loc.prestate#86,$state_to_int(prestate#86_$_0),^$#state_t);
	assert  $wrapped($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),^Node);
	assert  $top_writable($s_$_8,#wrTime$1^246.1,$read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node));
	assume $inv($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node),^Node);
	assume owns#85_$_0 == $owns($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node));
	assume $pre_static_unwrap($s_$_8);
	assume call0formal_$_#l_$_0_$3 == $read_ptr($s_$_8,$dot($ptr(^Node,P#y),Node.parent),^Node);
	...
	assume (forall  #p_$78 : $ptr :: {$st($s_$_10,#p_$78)} {$ts($s_$_10,#p_$78)} {$set_in(#p_$78,$owns($s_$_8,call0formal_$_#l_$_0_$3))} ( $set_in(#p_$78,$owns($s_$_8,call0formal_$_#l_$_0_$3)) ==> ((($typed($s_$_8,#p_$78) && $wrapped($s_$_10,#p_$78,$typ(#p_$78))) && $timestamp_is_now($s_$_10,#p_$78)) && $is_non_primitive($typ(#p_$78))) ));
	...
	assume $timestamp_is_now($s_$_10,call0formal_$_#l_$_0_$3);
	assume $typemap($s_$_8) == $typemap($s_$_10);
	assume (forall  #p_$81 : $ptr :: {$st($s_$_10,#p_$81)} {:weight  0}( (($st($s_$_10,#p_$81) == $st($s_$_8,#p_$81)) || ($nested($s_$_8,#p_$81) && $set_in(#p_$81,$owns($s_$_8,call0formal_$_#l_$_0_$3)))) || (#p_$81 == call0formal_$_#l_$_0_$3) ));
	assume (exists  #x_$10 : Integer :: ( $memory($s_$_10) == $store.mem($memory($s_$_8),call0formal_$_#l_$_0_$3,#x_$10) ));
	assume $timestamp_post_strict($s_$_8,$s_$_10);
	assume $post_unwrap($s_$_8,$s_$_10);
	assume $good_state_ext(#tok$1^266.32,$s_$_10);
	assume $full_stop($s_$_10);
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assume true;
	if ($_$_condition_$1) { goto anon02_Then; } else { goto anon02_Else; }
anon58:
	assert  $typed2($s_$_15,$dot($ptr(^Node,L#x_$_0),Node.right),$ptr_to(^Node));
	assert  $writable($s_$_15,#wrTime$1^246.1,$dot($ptr(^Node,L#x_$_0),Node.right));
	...
	assume $timestamp_post_strict($s_$_15,$s_$_16);
	assume $full_stop_ext(#tok$1^273.3,$s_$_16);
	assert  $typed2($s_$_16,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_16,#wrTime$1^246.1,$dot($ptr(^Node,P#y),Node.parent));
	...
	assume staticWrapState#90_$_0 == $current_state($s_$_17);
	...
	assert  $top_writable($s_$_17,#wrTime$1^246.1,$ptr(^Node,L#x_$_0));
	...
	assume $wrapped($s_$_18,call0formal_$_#l_$_0_$5,$typ(call0formal_$_#l_$_0_$5));
	...
	assume prestate#95_$_0 == $current_state($s_$_18);
	...
	assume staticWrapState#93_$_0 == $current_state($s_$_18);
	...
	assert  $top_writable($s_$_18,#wrTime$1^246.1,$ptr(^Node,P#y));
	...
	assume $wrapped($s_$_19,call0formal_$_#l_$_0_$6,$typ(call0formal_$_#l_$_0_$6));
	...
	assume $timestamp_post_strict($s_$_18,$s_$_19);
	assume $good_state_ext(#tok$1^276.43,$s_$_19);
	assert  $set_eq($owns($s_$_19,$ptr(^Node,P#y)),$set_empty());
	assume $full_stop($s_$_19);
	assert  F#doMark($ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node)));
	assume F#doMark($ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node)));
	assert  (forall  Q#m$1^279.26#dt1 : Integer :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#x_$_0))),$ref($ptr(^Node,Q#m$1^279.26#dt1))))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^279.26#dt1)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^279.26#dt1))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^279.26#dt1))) ==> ($mem($s_$_19,$dot($ptr(^Node,Q#m$1^279.26#dt1),Node.key)) < $mem($s_$_19,$dot($ptr(^Node,P#y),Node.key)))) ));
	assume (forall  Q#m$1^279.26#dt1_$0 : Integer :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#x_$_0))),$ref($ptr(^Node,Q#m$1^279.26#dt1_$0))))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^279.26#dt1_$0)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^279.26#dt1_$0))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#y),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^279.26#dt1_$0))) ==> ($mem($s_$_19,$dot($ptr(^Node,Q#m$1^279.26#dt1_$0),Node.key)) < $mem($s_$_19,$dot($ptr(^Node,P#y),Node.key)))) ));
	assert  $typed2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $writable($s_$_19,#wrTime$1^246.1,$dot($ptr(^Tree,P#t),Tree.R));
	assert  $typed2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $typed2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assume call0formal_$_p_$_0_$5 == $dot($ptr(^Tree,P#t),Tree.R);
	assume call1formal_$_v_$_0_$5 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#x_$_0)),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,P#y)))));
	...
	assume $full_stop_ext(#tok$1^282.5,$s_$_20);
	...
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $typed2($s_$_20,$dot($ptr(^Node,P#y),Node.right),$ptr_to(^Node));
	assert  $thread_local2($s_$_20,$dot($ptr(^Node,P#y),Node.right),$ptr_to(^Node));
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $typed2($s_$_20,$dot($ptr(^Node,P#y),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_20,$dot($ptr(^Node,P#y),Node.left),$ptr_to(^Node));
	assume call0formal_$_#l2_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_20,$dot($ptr(^Node,P#y),Node.right),^Node)));
	assume call1formal_$_#l1_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_20,$dot($ptr(^Node,P#y),Node.left),^Node)));
	...
	assume $full_stop_ext(#tok$1^283.15,$s_$_20);
	...
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $writable($s_$_20,#wrTime$1^246.1,$dot($ptr(^Tree,P#t),Tree.R));
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assume call0formal_$_p_$_0_$6 == $dot($ptr(^Tree,P#t),Tree.R);
	assume call1formal_$_v_$_0_$6 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,P#y)),call3formal_$_$result_$_0));
	...
	assume $full_stop_ext(#tok$1^283.5,$s_$_21);
	assume $local_value_is($s_$_21,#tok$2^0.0,#loc.prestate#96,$state_to_int(prestate#96),^$#state_t);
	assume prestate#96_$_0 == $current_state($s_$_21);
	assume $local_value_is($s_$_21,#tok$2^0.0,#loc.prestate#96,$state_to_int(prestate#96_$_0),^$#state_t);
	assume $pre_wrap($s_$_21);
	assert  $top_writable($s_$_21,#wrTime$1^246.1,$ptr(^Tree,P#t));
	assert  (forall  #writes$1^286.19 : $ptr :: {$dont_instantiate(#writes$1^286.19)} ( $set_in(#writes$1^286.19,$owns($s_$_21,$ptr(^Tree,P#t))) ==> $top_writable($s_$_21,#wrTime$1^246.1,#writes$1^286.19) ));
	...
	assert  $typed2($s_$_21,call0formal_$_#l_$_0_$7,^Tree);
	assert  !$closed($s_$_21,call0formal_$_#l_$_0_$7);
	assert  $owner($s_$_21,call0formal_$_#l_$_0_$7) == $me();
	assert  (forall  #p_$82 : $ptr :: {$dont_instantiate(#p_$82)} ( $set_in0(#p_$82,$owns($s_$_21,call0formal_$_#l_$_0_$7)) ==> $wrapped($s_$_21,#p_$82,$typ(#p_$82)) ));
	...
	assume (forall  #p_$83 : $ptr :: {$set_in(#p_$83,$owns($s_$_22,call0formal_$_#l_$_0_$7))} ( $set_in(#p_$83,$owns($s_$_22,call0formal_$_#l_$_0_$7)) ==> ($is_non_primitive($typ(#p_$83)) && $nested_in($s_$_22,#p_$83,call0formal_$_#l_$_0_$7)) ));
	assume $wrapped($s_$_22,call0formal_$_#l_$_0_$7,$typ(call0formal_$_#l_$_0_$7));
	...
	assume (forall  #p_$85 : $ptr :: {$st($s_$_22,#p_$85)} {:weight  0}( (($st($s_$_22,#p_$85) == $st($s_$_21,#p_$85)) || ($wrapped($s_$_21,#p_$85,$typ(#p_$85)) && $set_in(#p_$85,$owns($s_$_21,call0formal_$_#l_$_0_$7)))) || (#p_$85 == call0formal_$_#l_$_0_$7) ));
	...
	assert  (forall  Q#m$1^82.29#dt1_$11 : Integer :: ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$11))) ==> (!$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr_cast($null,^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$11)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$21 : Integer, Q#m$1^82.29#dt1_$12 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$21)))),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$12)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$21))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$12)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$21))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$21)))),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$12))) ==> ($mem($s_$_22,$dot($ptr(^Node,Q#m$1^82.29#dt1_$12),Node.key)) < $mem($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$21),Node.key))))) ));
	assert  (forall  Q#n$1^82.29#dt1_$22 : Integer, Q#m$1^82.29#dt1_$13 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$22)))),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$13)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$22))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$13)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$22))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$22)))),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$13))) ==> ($mem($s_$_22,$dot($ptr(^Node,Q#m$1^82.29#dt1_$13),Node.key)) > $mem($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$22),Node.key))))) ));
	assert  (forall  Q#m$1^82.29#dt1_$14 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$14)))} {F#mark2($ref($ptr(^Node,Q#m$1^82.29#dt1_$14)))} {sk_hack(F#mark2($ref($ptr(^Node,Q#m$1^82.29#dt1_$14))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$14))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$14))) <==> $set_in($ptr(^Node,Q#m$1^82.29#dt1_$14),$owns($s_$_22,$ptr(^Tree,P#t)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$23 : Integer, Q#m$1^82.29#dt1_$15 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$23))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$23))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$23))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$24 : Integer, Q#m$1^82.29#dt1_$16 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$16)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$24))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$16)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$16))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$25 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$25))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$25))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$25))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$25)))),Node.left),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$25))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$25),Node.left),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$26 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$26))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$26))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$26))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$26)))),Node.left),^Node),$null)) ==> $ptr_eq($read_ptr($s_$_22,$dot($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$26),Node.left),^Node),Node.parent),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$26))) ));
	assert  (forall  Q#n$1^82.29#dt1_$27 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$27))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$27))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$27))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$27)))),Node.right),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$27))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$27),Node.right),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$28 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$28))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$28))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$28))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$28)))),Node.right),^Node),$null)) ==> $ptr_eq($read_ptr($s_$_22,$dot($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$28),Node.right),^Node),Node.parent),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$28))) ));
	assert  (forall  Q#n$1^82.29#dt1_$29 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$29))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$29))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$29))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$29)))),Node.parent),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$29),Node.parent),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$30 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$30))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$30))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$30))) && $ptr_neq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$30)))),Node.parent),^Node),$null)) ==> ($ptr_eq($read_ptr($s_$_22,$dot($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$30),Node.parent),^Node),Node.left),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$30)) || $ptr_eq($read_ptr($s_$_22,$dot($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^82.29#dt1_$30),Node.parent),^Node),Node.right),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$30)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$31 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$31))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31)))) ));
	assert  true;
	assert  (forall  Q#m$1^83.29#dt1_$3 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.abs))),$mem($s_$_22,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.key)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^83.29#dt1_$3))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^83.29#dt1_$3))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.abs))),$mem($s_$_22,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.key))) == $mem($s_$_22,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.value)))) ));
	assert  (forall  Q#k$1^83.29#tc2_$1 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.abs))),Q#k$1^83.29#tc2_$1)} ( $in_range_i4(Q#k$1^83.29#tc2_$1) ==> (((forall  Q#m$1^83.29#dt1_$4 : Integer :: ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^83.29#dt1_$4))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^83.29#dt1_$4))) ==> (!($mem($s_$_22,$dot($ptr(^Node,Q#m$1^83.29#dt1_$4),Node.key)) == Q#k$1^83.29#tc2_$1))) ))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.abs))),Q#k$1^83.29#tc2_$1) == 0)) ));
	assert  (forall  Q#n$1^84.29#dt1_$3 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$3))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^84.29#dt1_$3))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^84.29#dt1_$3))) && $ptr_eq($read_ptr($s_$_22,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$3)))),Node.parent),^Node),$null)) ==> ($ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$3),$ptr_cast($null,^Node)) || $ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$3),$read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node)))) ));
	assert  (forall  Q#n$1^84.29#dt1_$4 : Integer, Q#m$1^84.29#dt1_$1 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$4)))))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^84.29#dt1_$4))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$4)))))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1))) <==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^84.29#dt1_$4))) && (((($ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$4),$ptr_cast($null,^Node)) && $ptr_eq($ptr(^Node,Q#m$1^84.29#dt1_$1),$ptr_cast($null,^Node))) || $ptr_eq($ptr(^Node,Q#m$1^84.29#dt1_$1),$ptr(^Node,Q#n$1^84.29#dt1_$4))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^84.29#dt1_$4),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Node,Q#n$1^84.29#dt1_$4),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))))) ));
	assume $full_stop($s_$_22);
	assert  $position_marker();
	assert  $eq.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_22,$dot($ptr(^Tree,P#t),Tree.root),^Node)))) && $eq.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s,$dot($ptr(^Tree,P#t),Tree.abs))),$int_to_map_t..^^i4.^^i4($mem($s_$_22,$dot($ptr(^Tree,P#t),Tree.abs))));
	assert  $wrapped($s_$_22,$ptr(^Tree,P#t),^Tree);
	goto $exit;
anon02_Then:
	assume $_$_condition_$1;
	assume $_$_condition_$1 <==> $ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#y));
	assume $ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#y));
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $writable($s_$_10,#wrTime$1^246.1,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$7 == $dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left);
	...
	assume $timestamp_post_strict($s_$_10,$s_$_11);
	assume $full_stop_ext(#tok$1^268.9,$s_$_11);
...
anon02_Else:
	...
	assume $_$_condition_$1 <==> $ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#y));
	assume !$ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#y));
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.right),$ptr_to(^Node));
	assert  $writable($s_$_10,#wrTime$1^246.1,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.right));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#y),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$2 == $dot($read_ptr($s_$_10,$dot($ptr(^Node,P#y),Node.parent),^Node),Node.right);
	...
	assume $timestamp_post_strict($s_$_10,$s_$_12);
	assume $full_stop_ext(#tok$1^270.9,$s_$_12);
	assume $s_$_13 == $s_$_12;
	goto anon55;
anon55:
	assume $local_value_is($s_$_13,#tok$2^0.0,#loc.prestate#89,$state_to_int(prestate#89),^$#state_t);
	assume prestate#89_$_0 == $current_state($s_$_13);
	...
	assume staticWrapState#87_$_0 == $current_state($s_$_13);
	...
	assert  $top_writable($s_$_13,#wrTime$1^246.1,$read_ptr($s_$_13,$dot($ptr(^Node,P#y),Node.parent),^Node));
	assume $pre_static_wrap($s_$_13);
	assume call0formal_$_#l_$_0_$4 == $read_ptr($s_$_13,$dot($ptr(^Node,P#y),Node.parent),^Node);
	...
	assume $wrapped($s_$_14,call0formal_$_#l_$_0_$4,$typ(call0formal_$_#l_$_0_$4));
	...
	assert  $set_eq($owns($s_$_14,$read_ptr($s_$_14,$dot($ptr(^Node,P#y),Node.parent),^Node)),$set_empty());
