...
anon7:
	...
	assume call1formal_$_v_$_0 == $ref($ptr_cast($null,^Node));
	...
	assume $full_stop_ext(#tok$1^91.3,$s_$_0);
	...
	assume $full_stop_ext(#tok$1^93.12,$s_$_0);
	...
	assert  $typed2($s_$_0,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $writable($s_$_0,#wrTime$1^87.1,$dot($ptr(^Tree,P#t),Tree.R));
	...
	assume $full_stop_ext(#tok$1^93.5,$s_$_1);
	...
	assume $full_stop_ext(#tok$1^94.14,$s_$_1);
	assume $local_value_is($s_$_1,#tok$1^94.14,#loc.res_lambda#3#16,$map_t..^^i4.^^i4_to_int(call0formal_$_$result_$_0_$1),$map_t(^^i4,^^i4));
	assert  $typed2($s_$_1,$dot($ptr(^Tree,P#t),Tree.abs),$map_t(^^i4,^^i4));
	assert  $writable($s_$_1,#wrTime$1^87.1,$dot($ptr(^Tree,P#t),Tree.abs));
	...
	assume $full_stop_ext(#tok$1^94.5,$s_$_2);
	assert  (forall  #writes$1^95.5 : $ptr :: {$dont_instantiate(#writes$1^95.5)} ( $set_in(#writes$1^95.5,$span($ptr(^Tree,P#t))) ==> $top_writable($s_$_2,#wrTime$1^87.1,#writes$1^95.5) ));
	...
	assume $full_stop_ext(#tok$1^95.5,$s_$_3);
	assume $local_value_is($s_$_3,#tok$2^0.0,#loc.prestate#23,$state_to_int(prestate#23),^$#state_t);
	assume prestate#23_$_0 == $current_state($s_$_3);
	assume $local_value_is($s_$_3,#tok$2^0.0,#loc.prestate#23,$state_to_int(prestate#23_$_0),^$#state_t);
	assume $pre_wrap($s_$_3);
	assert  $top_writable($s_$_3,#wrTime$1^87.1,$ptr(^Tree,P#t));
	assert  (forall  #writes$1^97.19 : $ptr :: {$dont_instantiate(#writes$1^97.19)} ( $set_in(#writes$1^97.19,$owns($s_$_3,$ptr(^Tree,P#t))) ==> $top_writable($s_$_3,#wrTime$1^87.1,#writes$1^97.19) ));
	assume call0formal_$_#l_$_0 == $ptr(^Tree,P#t);
	assert  $pre_wrap($s_$_3);
	assert  !($kind_of($typ(call0formal_$_#l_$_0)) == $kind_primitive);
	assert  $typed2($s_$_3,call0formal_$_#l_$_0,^Tree);
	assert  !$closed($s_$_3,call0formal_$_#l_$_0);
	assert  $owner($s_$_3,call0formal_$_#l_$_0) == $me();
	assert  (forall  #p_$63 : $ptr :: {$dont_instantiate(#p_$63)} ( $set_in0(#p_$63,$owns($s_$_3,call0formal_$_#l_$_0)) ==> $wrapped($s_$_3,#p_$63,$typ(#p_$63)) ));
	assume $select.sec.pc($s_$_4) == $select.sec.pc($s_$_3);
	assume $owns($s_$_3,call0formal_$_#l_$_0) == $owns($s_$_4,call0formal_$_#l_$_0);
	assume (forall  #p_$64 : $ptr :: {$set_in(#p_$64,$owns($s_$_4,call0formal_$_#l_$_0))} ( $set_in(#p_$64,$owns($s_$_4,call0formal_$_#l_$_0)) ==> ($is_non_primitive($typ(#p_$64)) && $nested_in($s_$_4,#p_$64,call0formal_$_#l_$_0)) ));
	assume $wrapped($s_$_4,call0formal_$_#l_$_0,$typ(call0formal_$_#l_$_0));
	...
	assume (forall  #p_$66 : $ptr :: {$st($s_$_4,#p_$66)} {:weight  0}( (($st($s_$_4,#p_$66) == $st($s_$_3,#p_$66)) || ($wrapped($s_$_3,#p_$66,$typ(#p_$66)) && $set_in(#p_$66,$owns($s_$_3,call0formal_$_#l_$_0)))) || (#p_$66 == call0formal_$_#l_$_0) ));
	...
	assert  !$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr_cast($null,^Node)));
	assert  $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node),$null) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node)));
	assert  $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node),$null) ==> $ptr_eq($read_ptr($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node),Node.parent),^Node),$null);
	assert  (forall  Q#m$1^82.29#dt1_$11 : Integer :: ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$11))) ==> (!$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr_cast($null,^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$11)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$21 : Integer, Q#m$1^82.29#dt1_$12 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$21)))),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$12)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$21))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$12)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$21))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$21)))),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$12))) ==> ($mem($s_$_4,$dot($ptr(^Node,Q#m$1^82.29#dt1_$12),Node.key)) < $mem($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$21),Node.key))))) ));
	assert  (forall  Q#n$1^82.29#dt1_$22 : Integer, Q#m$1^82.29#dt1_$13 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$22)))),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$13)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$22))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$13)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$22))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$22)))),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$13))) ==> ($mem($s_$_4,$dot($ptr(^Node,Q#m$1^82.29#dt1_$13),Node.key)) > $mem($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$22),Node.key))))) ));
	assert  (forall  Q#m$1^82.29#dt1_$14 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$14)))} {F#mark2($ref($ptr(^Node,Q#m$1^82.29#dt1_$14)))} {sk_hack(F#mark2($ref($ptr(^Node,Q#m$1^82.29#dt1_$14))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$14))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$14))) <==> $set_in($ptr(^Node,Q#m$1^82.29#dt1_$14),$owns($s_$_4,$ptr(^Tree,P#t)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$23 : Integer, Q#m$1^82.29#dt1_$15 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$23))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$23))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$23))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$15)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$24 : Integer, Q#m$1^82.29#dt1_$16 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$16)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$24))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^82.29#dt1_$16)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24))),$ref($ptr(^Node,Q#m$1^82.29#dt1_$16))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$24)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$25 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$25))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$25))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$25))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$25)))),Node.left),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$25))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$25),Node.left),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$26 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$26))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$26))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$26))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$26)))),Node.left),^Node),$null)) ==> $ptr_eq($read_ptr($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$26),Node.left),^Node),Node.parent),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$26))) ));
	assert  (forall  Q#n$1^82.29#dt1_$27 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$27))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$27))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$27))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$27)))),Node.right),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$27))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$27),Node.right),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$28 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$28))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$28))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$28))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$28)))),Node.right),^Node),$null)) ==> $ptr_eq($read_ptr($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$28),Node.right),^Node),Node.parent),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$28))) ));
	assert  (forall  Q#n$1^82.29#dt1_$29 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$29))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$29))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$29))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$29)))),Node.parent),^Node),$null)) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$29),Node.parent),^Node)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$30 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$30))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$30))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$30))) && $ptr_neq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^82.29#dt1_$30)))),Node.parent),^Node),$null)) ==> ($ptr_eq($read_ptr($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$30),Node.parent),^Node),Node.left),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$30)) || $ptr_eq($read_ptr($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^82.29#dt1_$30),Node.parent),^Node),Node.right),^Node),$ptr(^Node,Q#n$1^82.29#dt1_$30)))) ));
	assert  (forall  Q#n$1^82.29#dt1_$31 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^82.29#dt1_$31))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31))) ==> $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31))),$ref($ptr(^Node,Q#n$1^82.29#dt1_$31)))) ));
	assert  true;
	assert  (forall  Q#m$1^83.29#dt1_$3 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.abs))),$mem($s_$_4,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.key)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^83.29#dt1_$3))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^83.29#dt1_$3))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.abs))),$mem($s_$_4,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.key))) == $mem($s_$_4,$dot($ptr(^Node,Q#m$1^83.29#dt1_$3),Node.value)))) ));
	assert  (forall  Q#k$1^83.29#tc2_$1 : Integer :: {$select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.abs))),Q#k$1^83.29#tc2_$1)} ( $in_range_i4(Q#k$1^83.29#tc2_$1) ==> (((forall  Q#m$1^83.29#dt1_$4 : Integer :: ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^83.29#dt1_$4))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#m$1^83.29#dt1_$4))) ==> (!($mem($s_$_4,$dot($ptr(^Node,Q#m$1^83.29#dt1_$4),Node.key)) == Q#k$1^83.29#tc2_$1))) ))) ==> ($select.$map_t..^^i4.^^i4($int_to_map_t..^^i4.^^i4($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.abs))),Q#k$1^83.29#tc2_$1) == 0)) ));
	assert  (forall  Q#n$1^84.29#dt1_$3 : Integer :: {$ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$3))))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#n$1^84.29#dt1_$3))) ==> (($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^84.29#dt1_$3))) && $ptr_eq($read_ptr($s_$_4,$dot($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$3)))),Node.parent),^Node),$null)) ==> ($ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$3),$ptr_cast($null,^Node)) || $ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$3),$read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node)))) ));
	assert  (forall  Q#n$1^84.29#dt1_$4 : Integer, Q#m$1^84.29#dt1_$1 : Integer :: {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$4)))))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))} ( ($in_range_phys_ptr($ref($ptr(^Node,Q#n$1^84.29#dt1_$4))) && $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,F#mark($ref($ptr(^Node,Q#n$1^84.29#dt1_$4)))))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1))) <==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Tree,P#t),Tree.root),^Node))),$ref($ptr(^Node,Q#n$1^84.29#dt1_$4))) && (((($ptr_eq($ptr(^Node,Q#n$1^84.29#dt1_$4),$ptr_cast($null,^Node)) && $ptr_eq($ptr(^Node,Q#m$1^84.29#dt1_$1),$ptr_cast($null,^Node))) || $ptr_eq($ptr(^Node,Q#m$1^84.29#dt1_$1),$ptr(^Node,Q#n$1^84.29#dt1_$4))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^84.29#dt1_$4),Node.left),^Node))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))) || $select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_4,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_4,$dot($ptr(^Node,Q#n$1^84.29#dt1_$4),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^84.29#dt1_$1)))))) ));
	assume $full_stop($s_$_4);
	assert  $position_marker();
	assert  $wrapped($s_$_4,$ptr(^Tree,P#t),^Tree);
	goto $exit;
}
