...
PreconditionGeneratedEntry:
	...
	assume $ptr_neq($read_ptr($s,$dot($ptr(^Node,P#x),Node.right),^Node),$null);
...
anon46:
	...
	assume prestate#45_$_0 == $current_state($s);
	...
	assume prestate#46_$_0 == $current_state($s_$_0);
	...
	assume prestate#48_$_0 == $current_state($s_$_0);
	assume $local_value_is($s_$_0,#tok$2^0.0,#loc.prestate#48,$state_to_int(prestate#48_$_0),^$#state_t);
	assert  $wrapped($s_$_0,$ptr(^Node,P#x),^Node);
	assert  $top_writable($s_$_0,#wrTime$1^203.1,$ptr(^Node,P#x));
	assume $inv($s_$_0,$ptr(^Node,P#x),^Node);
	...
	assert  $thread_local2($s_$_1,$dot($ptr(^Node,P#x),Node.right),$ptr_to(^Node));
	assume L#y_$_0 == $ref($read_ptr($s_$_1,$dot($ptr(^Node,P#x),Node.right),^Node));
	...
	assume prestate#49_$_0 == $current_state($s_$_1);
	...
	assume prestate#51_$_0 == $current_state($s_$_1);
	assume $local_value_is($s_$_1,#tok$2^0.0,#loc.prestate#51,$state_to_int(prestate#51_$_0),^$#state_t);
	assert  $wrapped($s_$_1,$ptr(^Node,L#y_$_0),^Node);
	assert  $top_writable($s_$_1,#wrTime$1^203.1,$ptr(^Node,L#y_$_0));
	assume $inv($s_$_1,$ptr(^Node,L#y_$_0),^Node);
	...
	assert  $typed2($s_$_2,$dot($ptr(^Node,P#x),Node.right),$ptr_to(^Node));
	assert  $writable($s_$_2,#wrTime$1^203.1,$dot($ptr(^Node,P#x),Node.right));
	assert  $typed2($s_$_2,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_2,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assume call0formal_$_p_$_0 == $dot($ptr(^Node,P#x),Node.right);
	assume call1formal_$_v_$_0 == $ref($read_ptr($s_$_2,$dot($ptr(^Node,L#y_$_0),Node.left),^Node));
	...
	assume $full_stop_ext(#tok$1^216.3,$s_$_3);
	assert  $typed2($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assume true;
	if ($_$_condition) { goto anon00_Then; } else { goto anon00_Else; }
anon00_Then:
	assume $ptr_neq($read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),$null);
	...
	assume prestate#52_$_0 == $current_state($s_$_3);
	...
	assume prestate#54_$_0 == $current_state($s_$_3);
	assume $local_value_is($s_$_3,#tok$2^0.0,#loc.prestate#54,$state_to_int(prestate#54_$_0),^$#state_t);
	assert  $wrapped($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),^Node);
	assert  $top_writable($s_$_3,#wrTime$1^203.1,$read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node));
	assume $inv($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),^Node);
	assume owns#53_$_0 == $owns($s_$_3,$read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node));
	assume $pre_static_unwrap($s_$_3);
	assume call0formal_$_#l_$_0_$8 == $read_ptr($s_$_3,$dot($ptr(^Node,L#y_$_0),Node.left),^Node);
	...
	assert  $typed2($s_$_4,$dot($read_ptr($s_$_4,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_4,#wrTime$1^203.1,$dot($read_ptr($s_$_4,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),Node.parent));
	assert  $typed2($s_$_4,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_4,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$9 == $dot($read_ptr($s_$_4,$dot($ptr(^Node,L#y_$_0),Node.left),^Node),Node.parent);
	...
	assume staticWrapState#55_$_0 == $current_state($s_$_5);
	...
	assert  $top_writable($s_$_5,#wrTime$1^203.1,$read_ptr($s_$_5,$dot($ptr(^Node,L#y_$_0),Node.left),^Node));
	assume $pre_static_wrap($s_$_5);
	assume call0formal_$_#l_$_0_$9 == $read_ptr($s_$_5,$dot($ptr(^Node,L#y_$_0),Node.left),^Node);
	...
	assert  $set_eq($owns($s_$_6,$read_ptr($s_$_6,$dot($ptr(^Node,L#y_$_0),Node.left),^Node)),$set_empty());
...
anon00_Else:
	...
	goto anon47;
anon47:
	assert  $typed2($s_$_7,$dot($ptr(^Node,L#y_$_0),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_7,#wrTime$1^203.1,$dot($ptr(^Node,L#y_$_0),Node.parent));
	assert  $typed2($s_$_7,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_7,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$1 == $dot($ptr(^Node,L#y_$_0),Node.parent);
	assume call1formal_$_v_$_0_$1 == $ref($read_ptr($s_$_7,$dot($ptr(^Node,P#x),Node.parent),^Node));
	...
	assume $full_stop_ext(#tok$1^219.3,$s_$_8);
	assert  $typed2($s_$_8,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_8,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assume true;
	if ($_$_condition_$0) { goto anon01_Then; } else { goto anon01_Else; }
anon01_Then:
	assume $ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node),$null);
	assert  $typed2($s_$_8,$dot($ptr(^Tree,P#t),Tree.root),$ptr_to(^Node));
	assert  $writable($s_$_8,#wrTime$1^203.1,$dot($ptr(^Tree,P#t),Tree.root));
	...
	assume $full_stop_ext(#tok$1^221.5,$s_$_9);
	assume $s_$_15 == $s_$_9;
	goto anon48;
anon01_Else:
	assume !$ptr_eq($read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node),$null);
	assert  F#doMark($ref($read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node)));
	assume F#doMark($ref($read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node)));
	...
	assume prestate#58_$_0 == $current_state($s_$_8);
	...
	assume prestate#60_$_0 == $current_state($s_$_8);
	assume $local_value_is($s_$_8,#tok$2^0.0,#loc.prestate#60,$state_to_int(prestate#60_$_0),^$#state_t);
	assert  $wrapped($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node),^Node);
	assert  $top_writable($s_$_8,#wrTime$1^203.1,$read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node));
	assume $inv($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node),^Node);
	assume owns#59_$_0 == $owns($s_$_8,$read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node));
	assume $pre_static_unwrap($s_$_8);
	assume call0formal_$_#l_$_0_$3 == $read_ptr($s_$_8,$dot($ptr(^Node,P#x),Node.parent),^Node);
	...
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assume true;
	if ($_$_condition_$1) { goto anon02_Then; } else { goto anon02_Else; }
anon48:
	assert  $typed2($s_$_15,$dot($ptr(^Node,L#y_$_0),Node.left),$ptr_to(^Node));
	assert  $writable($s_$_15,#wrTime$1^203.1,$dot($ptr(^Node,L#y_$_0),Node.left));
	...
	assume $full_stop_ext(#tok$1^231.3,$s_$_16);
	assert  $typed2($s_$_16,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $writable($s_$_16,#wrTime$1^203.1,$dot($ptr(^Node,P#x),Node.parent));
	...
	assume staticWrapState#64_$_0 == $current_state($s_$_17);
	...
	assert  $top_writable($s_$_17,#wrTime$1^203.1,$ptr(^Node,P#x));
	...
	assume prestate#69_$_0 == $current_state($s_$_18);
	...
	assume staticWrapState#67_$_0 == $current_state($s_$_18);
	...
	assert  $top_writable($s_$_18,#wrTime$1^203.1,$ptr(^Node,L#y_$_0));
	...
	assert  F#doMark($ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node)));
	assume F#doMark($ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node)));
	assert  (forall  Q#m$1^236.26#dt1 : Integer :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#y_$_0))),$ref($ptr(^Node,Q#m$1^236.26#dt1))))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^236.26#dt1)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^236.26#dt1))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^236.26#dt1))) ==> ($mem($s_$_19,$dot($ptr(^Node,Q#m$1^236.26#dt1),Node.key)) > $mem($s_$_19,$dot($ptr(^Node,P#x),Node.key)))) ));
	assume (forall  Q#m$1^236.26#dt1_$0 : Integer :: {sk_hack($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#y_$_0))),$ref($ptr(^Node,Q#m$1^236.26#dt1_$0))))} {$select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^236.26#dt1_$0)))} ( $in_range_phys_ptr($ref($ptr(^Node,Q#m$1^236.26#dt1_$0))) ==> ($select.$map_t..$ptr_to..^Node.^^bool($select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_19,$dot($ptr(^Node,P#x),Node.right),^Node))),$ref($ptr(^Node,Q#m$1^236.26#dt1_$0))) ==> ($mem($s_$_19,$dot($ptr(^Node,Q#m$1^236.26#dt1_$0),Node.key)) > $mem($s_$_19,$dot($ptr(^Node,P#x),Node.key)))) ));
	assert  $typed2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $writable($s_$_19,#wrTime$1^203.1,$dot($ptr(^Tree,P#t),Tree.R));
	assert  $typed2($s_$_19,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	...
	assume call1formal_$_v_$_0_$5 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,L#y_$_0)),$select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_19,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,P#x)))));
	...
	assume $full_stop_ext(#tok$1^239.5,$s_$_20);
	...
	assert  $typed2($s_$_20,$dot($ptr(^Node,P#x),Node.right),$ptr_to(^Node));
	assert  $thread_local2($s_$_20,$dot($ptr(^Node,P#x),Node.right),$ptr_to(^Node));
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $typed2($s_$_20,$dot($ptr(^Node,P#x),Node.left),$ptr_to(^Node));
	assert  $thread_local2($s_$_20,$dot($ptr(^Node,P#x),Node.left),$ptr_to(^Node));
	assume call0formal_$_#l2_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_20,$dot($ptr(^Node,P#x),Node.right),^Node)));
	assume call1formal_$_#l1_$_0 == $select.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($read_ptr($s_$_20,$dot($ptr(^Node,P#x),Node.left),^Node)));
	...
	assume $full_stop_ext(#tok$1^240.15,$s_$_20);
	...
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $writable($s_$_20,#wrTime$1^203.1,$dot($ptr(^Tree,P#t),Tree.R));
	assert  $typed2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assert  $thread_local2($s_$_20,$dot($ptr(^Tree,P#t),Tree.R),$map_t($ptr_to(^Node),$map_t($ptr_to(^Node),^^bool)));
	assume call0formal_$_p_$_0_$6 == $dot($ptr(^Tree,P#t),Tree.R);
	assume call1formal_$_v_$_0_$6 == $map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool_to_int($store.$map_t..$ptr_to..^Node.$map_t..$ptr_to..^Node.^^bool($int_to_map_t..ptr_to..^Node.map_t..ptr_to..^Node.^^bool($mem($s_$_20,$dot($ptr(^Tree,P#t),Tree.R))),$ref($ptr(^Node,P#x)),call3formal_$_$result_$_0));
	...
	assume $full_stop_ext(#tok$1^240.5,$s_$_21);
	assume $local_value_is($s_$_21,#tok$2^0.0,#loc.prestate#70,$state_to_int(prestate#70),^$#state_t);
	assume prestate#70_$_0 == $current_state($s_$_21);
	assume $local_value_is($s_$_21,#tok$2^0.0,#loc.prestate#70,$state_to_int(prestate#70_$_0),^$#state_t);
	assume $pre_wrap($s_$_21);
	assert  $top_writable($s_$_21,#wrTime$1^203.1,$ptr(^Tree,P#t));
	assert  (forall  #writes$1^243.19 : $ptr :: {$dont_instantiate(#writes$1^243.19)} ( $set_in(#writes$1^243.19,$owns($s_$_21,$ptr(^Tree,P#t))) ==> $top_writable($s_$_21,#wrTime$1^203.1,#writes$1^243.19) ));
	...
	goto $exit;
anon02_Then:
	assume $ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#x));
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left),$ptr_to(^Node));
	assert  $writable($s_$_10,#wrTime$1^203.1,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$7 == $dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left);
	...
	assume $full_stop_ext(#tok$1^226.9,$s_$_11);
	assume $s_$_13 == $s_$_11;
	goto anon45;
anon02_Else:
	assume !$ptr_eq($read_ptr($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.left),^Node),$ptr(^Node,P#x));
	assert  $typed2($s_$_10,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.right),$ptr_to(^Node));
	assert  $writable($s_$_10,#wrTime$1^203.1,$dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.right));
	assert  $typed2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assert  $thread_local2($s_$_10,$dot($ptr(^Node,P#x),Node.parent),$ptr_to(^Node));
	assume call0formal_$_p_$_0_$2 == $dot($read_ptr($s_$_10,$dot($ptr(^Node,P#x),Node.parent),^Node),Node.right);
...
anon45:
	...
	assume staticWrapState#61_$_0 == $current_state($s_$_13);
	...
	assert  $top_writable($s_$_13,#wrTime$1^203.1,$read_ptr($s_$_13,$dot($ptr(^Node,P#x),Node.parent),^Node));
	assume $pre_static_wrap($s_$_13);
	assume call0formal_$_#l_$_0_$4 == $read_ptr($s_$_13,$dot($ptr(^Node,P#x),Node.parent),^Node);
	...
	assert  $set_eq($owns($s_$_14,$read_ptr($s_$_14,$dot($ptr(^Node,P#x),Node.parent),^Node)),$set_empty());
