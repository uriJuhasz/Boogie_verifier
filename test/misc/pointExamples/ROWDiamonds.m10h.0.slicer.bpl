...
anon34_Else:
	...
	goto anon12;
anon12:
	assert  heap_$_17[r0] == 0;
	assume heap_$_18 == heap_$_17[r2 := 1];
	if ($_$_condition_$3) { goto anon35_Then; } else { goto anon35_Else; }
anon35_Then:
...
anon15:
	...
	if ($_$_condition_$4) { goto anon36_Then; } else { goto anon36_Else; }
anon36_Then:
...
anon36_Else:
	...
	goto anon18;
anon18:
	assert  heap_$_25[r0] == 0;
	assume heap_$_26 == heap_$_25[r2 := 1];
	if ($_$_condition_$5) { goto anon37_Then; } else { goto anon37_Else; }
anon37_Then:
...
anon37_Else:
	...
	goto anon21;
anon21:
	assert  heap_$_29[r0] == 0;
	assume heap_$_30 == heap_$_29[r2 := 1];
	if ($_$_condition_$6) { goto anon38_Then; } else { goto anon38_Else; }
anon38_Then:
...
anon38_Else:
	...
	goto anon24;
anon24:
	assert  heap_$_33[r0] == 0;
	if ($_$_condition_$7) { goto anon39_Then; } else { goto anon39_Else; }
anon39_Then:
...
anon39_Else:
	...
	goto anon27;
anon27:
	assert  heap_$_36[r0] == 0;
	assume heap_$_37 == heap_$_36[r2 := 1];
	if ($_$_condition_$8) { goto anon40_Then; } else { goto anon40_Else; }
anon40_Then:
