...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@7 T@T) ) (! (= (Ctor (MapType0Type arg0@@7)) 5)
...
(= (type (MapType0Store arg0@@10 arg1@@0 arg2@@0 arg3)) (MapType0Type aVar0)))
 ...
 :weight 0
)))) (= (type heap@6) (MapType0Type refType))) (= (type this) refType)) (= (type heap@4) (MapType0Type refType))) (= (type null) refType)) (= (type heap@5) (MapType0Type refType))) (= (type heap@2) (MapType0Type refType))) (= (type heap@3) (MapType0Type refType))) (= (type r) refType)) (= (type heap) (MapType0Type refType))) (= (type heap@0) (MapType0Type refType))) (= (type heap@1) (MapType0Type refType))))
(push 1)
(set-info :boogie-vc-id m)
(assert (not
(let ((anon6_correct  (=> (! (and %lbl%+190 true) :lblpos +190) (! (or %lbl%@508 (= (U_2_int (MapType0Select heap@6 this f1)) 0)) :lblneg @508))))
(let ((anon8_Else_correct  (=> (! (and %lbl%+188 true) :lblpos +188) (=> (and (= (MapType0Select heap@4 this left) null) (= heap@6 heap@4)) anon6_correct))))
(let ((anon8_Then_correct  (=> (! (and %lbl%+186 true) :lblpos +186) (=> (not (= (MapType0Select heap@4 this left) null)) (=> (and (= heap@5 (MapType0Store heap@4 (MapType0Select heap@4 this left) f2 (int_2_U 2))) (= heap@6 heap@5)) anon6_correct)))))
(let ((anon7_Else_correct  (=> (! (and %lbl%+177 true) :lblpos +177) (=> (and (= (MapType0Select heap@2 this left) null) (= heap@4 heap@2)) (and anon8_Then_correct anon8_Else_correct)))))
(let ((anon7_Then_correct  (=> (! (and %lbl%+175 true) :lblpos +175) (=> (not (= (MapType0Select heap@2 this left) null)) (=> (and (= heap@3 (MapType0Store heap@2 (MapType0Select heap@2 this left) f1 (int_2_U 1))) (= heap@4 heap@3)) (and anon8_Then_correct anon8_Else_correct))))))
(let ((anon0_correct  (=> (! (and %lbl%+173 true) :lblpos +173) (=> (and (and (not (= r this)) (not (= r (MapType0Select heap this left)))) (and (= heap@0 (MapType0Store heap r f1 (int_2_U 1))) (= heap@1 (MapType0Store heap@0 r f2 (int_2_U 2))))) (and (! (or %lbl%@360 (= (U_2_int (MapType0Select heap@1 r f1)) 1)) :lblneg @360) (=> (= (U_2_int (MapType0Select heap@1 r f1)) 1) (=> (not (= this null)) (=> (and (= heap@2 (MapType0Store heap@1 this f1 (int_2_U 0))) (not (= (MapType0Select heap@2 this left) this))) (and anon7_Then_correct anon7_Else_correct)))))))))
(let ((PreconditionGeneratedEntry_correct  (=> (! (and %lbl%+284 true) :lblpos +284) anon0_correct)))
