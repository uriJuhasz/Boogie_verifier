...
;Axioms
   ...
   (assert (! (or $NP@78 $NP@79 (= null call4formal@p@24@0)) :named ax_229))
   (assert (! (or (< call5formal@n@25@0 (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys))) (= null call4formal@p@24@0)) :named ax_230))
   (assert (! (or (= null $rhs@0) (= (dtype $rhs@0) class.Node)) :named ax_231))
   (assert (! (or (= null $rhs@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)) :named ax_232))
   (assert (! (or (= null $rhs@2) (= (dtype $rhs@2) class.Node)) :named ax_233))
   (assert (! (or (= null $rhs@2) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) :named ax_234))
   (assert (! (or (= null call4formal@p@24@0) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0)) call4formal@p@24@0)) :named ax_235))
   (assert (! (or (= null call4formal@p@24@0) (= (dtype call4formal@p@24@0) class.Node)) :named ax_236))
   (assert (! (or (= null call4formal@p@24@0) (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)) :named ax_237))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)) :named ax_238))
   (assert (! (or (= null call4formal@p@24@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)) :named ax_239))
   (assert (! (or (= null call6formal@prev@26@0) (= (dtype call6formal@prev@26@0) class.Node)) :named ax_240))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call6formal@prev@26@0 alloc)) :named ax_241))
   (assert (! (or (= null call6formal@prev@26@0) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call6formal@prev@26@0 alloc)) :named ax_242))
   (assert (! (or (= null p@20) (= (dtype p@20) class.Node)) :named ax_243))
   (assert (! (or (= null p@20) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)) :named ax_244))
   (assert (! (or (= null prev@22) (= (dtype prev@22) class.Node)) :named ax_245))
   (assert (! (or (= null prev@22) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap prev@22 alloc)) :named ax_246))
   (assert (! (or (not $NP@78) (= 0 call5formal@n@25@0)) :named ax_247))
   (assert (! (or (not $NP@78) (= null call6formal@prev@26@0)) :named ax_248))
   ...
   (assert (! (or (not (< call5formal@n@25@0 0)) (= null call4formal@p@24@0)) :named ax_252))
   (assert (! (or (not (= null call4formal@p@24@0)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16))) :named ax_253))
   (assert (! (or (not (= null call6formal@prev@26@0)) (not (= 0 call5formal@n@25@0)) $NP@78) :named ax_254))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) (+ call5formal@n@25@0 1)) key@16)) (= null call4formal@p@24@0)) :named ax_255))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Take$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)) (= null call4formal@p@24@0)) :named ax_256))
