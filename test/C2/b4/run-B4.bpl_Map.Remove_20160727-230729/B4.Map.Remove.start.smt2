...
(let ((anon0@2_assertion (and
    (=> (Map.Valid@canCall $Heap this) (or (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Values)) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys))) (Map.Valid $Heap this)))
)))
(let ((anon0@3_assertion (and
    (=> (Map.Valid@canCall $Heap this) (or (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) 1)) (Map.Valid $Heap this)))
)))
(let ((anon0@4_assertion (and
    (=> (Map.Valid@canCall $Heap this) (or (Map.Valid $Heap this) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) 0)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap this Map.head))))
)))
(let ((anon0@6_assertion (and
    (=> (Map.Valid@canCall $Heap this) (or (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) (- (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) 1)))) (Map.Valid $Heap this)))
)))
...
(let ((anon0@7 (=> (and true
    ...
    ($IsGoodHeap $Heap@0)
    (=> (= null call4formal@p@24@0) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16)))
    (=> (Map.Valid@canCall $Heap this) (or (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) (- (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) 1)))) (Map.Valid $Heap this)))
    (=> (not (= null call4formal@p@24@0)) (< call5formal@n@25@0 (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys))))
    (=> (not (= null call4formal@p@24@0)) (<= 0 call5formal@n@25@0))
    (=> (not (= null call4formal@p@24@0)) (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16))
    (=> (not (= null call4formal@p@24@0)) (= call4formal@p@24@0 ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0))))
    (=> (not (= null call4formal@p@24@0)) (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) (+ call5formal@n@25@0 1)) key@16)))
    (=> (not (= null call4formal@p@24@0)) (not (Seq@Contains$BoxType$ (Seq@Take$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)))
    (=> (not (= null call4formal@p@24@0)) (or (and (= null call6formal@prev@26@0) (= call5formal@n@25@0 0)) (and (= call6formal@prev@26@0 ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (- call5formal@n@25@0 1)))) (< 0 call5formal@n@25@0))))
    (forall( (|$o_$20_$0| ref) (|$f_$12_$0| Field$Bool$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$0| alloc) (not (= null |$o_$20_$0|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$0| |$f_$12_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$20_$0| |$f_$12_$0|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$20_$0| |$f_$12_$0|))))
    (forall( (|$o_$20_$1| ref) (|$f_$12_$1| Field$ref$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$1| alloc) (not (= null |$o_$20_$1|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |$o_$20_$1| |$f_$12_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$20_$1| |$f_$12_$1|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$20_$1| |$f_$12_$1|))))
    (forall( (|$o_$20_$2| ref) (|$f_$12_$2| Field$BoxType$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$2| alloc) (not (= null |$o_$20_$2|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap |$o_$20_$2| |$f_$12_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$20_$2| |$f_$12_$2|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$20_$2| |$f_$12_$2|))))
    (forall( (|$o_$20_$3| ref) (|$f_$12_$3| Field$$@Map@@BoxType@To@Bool@@$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$3| alloc) (not (= null |$o_$20_$3|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap |$o_$20_$3| |$f_$12_$3|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 |$o_$20_$3| |$f_$12_$3|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 |$o_$20_$3| |$f_$12_$3|))))
    (forall( (|$o_$20_$4| ref) (|$f_$12_$4| Field$Seq$BoxType$$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$4| alloc) (not (= null |$o_$20_$4|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap |$o_$20_$4| |$f_$12_$4|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 |$o_$20_$4| |$f_$12_$4|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 |$o_$20_$4| |$f_$12_$4|))))
    (or (= null call4formal@p@24@0) (and (= (dtype call4formal@p@24@0) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)))
    (or (= null call6formal@prev@26@0) (and (= (dtype call6formal@prev@26@0) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call6formal@prev@26@0 alloc)))
  )
...
(let ((anon0@1 (=> (and true
    (or (= null call4formal@p@24@0) (and (= (dtype call4formal@p@24@0) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)))
    (or (= null call6formal@prev@26@0) (and (= (dtype call6formal@prev@26@0) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call6formal@prev@26@0 alloc)))
    true
    true
    true
    true
...
(let ((anon0 (=> (and true
    (= (lambda@8 Map.Repr null $Heap alloc this) $_Frame@0)
  )
    anon0@1
)))
(let ((PreconditionGeneratedEntry (=> (and true
    $InMethodContext
    ($IsGoodHeap $Heap)
    (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) 0)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap this Map.head))
    ...
    (not (= this null))
    (or (= null $rhs@0) (and (= (dtype $rhs@0) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)))
    (or (= null $rhs@2) (and (= (dtype $rhs@2) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)))
    (or (= p@20 null) (and (= (dtype p@20) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)))
    (or (= prev@22 null) (and (= (dtype prev@22) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap prev@22 alloc)))
  )
    anon0
)))
(let (($start (=> (and true
    ...
    (forall( (|$h_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$5| ref))(!(=> (and (and ($IsGoodHeap |$h_$4|) (not (= null |$o_$5|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$4| |$o_$5| alloc)) (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$4| |$o_$5| Node.key) |$h_$4|))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$4| |$o_$5| Node.key))))
    (forall( (|$h_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$6| ref))(!(=> (and (and ($IsGoodHeap |$h_$5|) (not (= null |$o_$6|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$5| |$o_$6| alloc)) (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$5| |$o_$6| Node.val) |$h_$5|))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$5| |$o_$6| Node.val))))
    ...
    (forall( (|a_$14_$0| $@Map@@BoxType@To@Bool@@) (|b_$11_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Equal$BoxType$ |a_$14_$0| |b_$11_$0|) (forall( (|o_$6_$1| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$11_$0| |o_$6_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$6_$1|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$6_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$11_$0| |o_$6_$1|)))))  :pattern ( (Set@Equal$BoxType$ |a_$14_$0| |b_$11_$0|))))
    (forall( (|a_$15_$0| $@Map@@BoxType@To@Bool@@) (|b_$12_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Equal$BoxType$ |a_$15_$0| |b_$12_$0|) (= |b_$12_$0| |a_$15_$0|))  :pattern ( (Set@Equal$BoxType$ |a_$15_$0| |b_$12_$0|))))
    (forall( (|a_$16_$0| $@Map@@BoxType@To@Bool@@) (|b_$13_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Disjoint$BoxType$ |a_$16_$0| |b_$13_$0|) (forall( (|o_$7_$1| BoxType))(!(or (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$7_$1|)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$16_$0| |o_$7_$1|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$16_$0| |o_$7_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$7_$1|)))))  :pattern ( (Set@Disjoint$BoxType$ |a_$16_$0| |b_$13_$0|))))
    ...
    (forall( (|a_$18_$0| Seq$ref$) (|b_$14_$0| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$18_$0| |b_$14_$0|) (= |b_$14_$0| |a_$18_$0|))  :pattern ( (Seq@Equal$ref$ |a_$18_$0| |b_$14_$0|))))
    (forall( (|a_$18_$1| Seq$BoxType$) (|b_$14_$1| Seq$BoxType$))(!(=> (Seq@Equal$BoxType$ |a_$18_$1| |b_$14_$1|) (= |b_$14_$1| |a_$18_$1|))  :pattern ( (Seq@Equal$BoxType$ |a_$18_$1| |b_$14_$1|))))
    (forall( (|a_$19| ClassName) (|b_$21| ClassName))(!(and (= (TypeTupleCdr (TypeTuple |a_$19| |b_$21|)) |b_$21|) (= (TypeTupleCar (TypeTuple |a_$19| |b_$21|)) |a_$19|))  :pattern ( (TypeTuple |a_$19| |b_$21|))))
    (forall( (|a_$2_$0| $@Map@@BoxType@To@Bool@@) (|b_$29| $@Map@@BoxType@To@Bool@@) (|o_$2_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$2_$0| |b_$29|) |o_$2_$0|) (or (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$29| |o_$2_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$2_$0| |o_$2_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$2_$0| |b_$29|) |o_$2_$0|))))
    (forall( (|a_$20| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$27| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|c| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and ($HeapSucc |b_$27| |c|) ($HeapSucc |a_$20| |b_$27|)) ($HeapSucc |a_$20| |c|))  :pattern ( ($HeapSucc |a_$20| |b_$27|) ($HeapSucc |b_$27| |c|))))
    (forall( (|a_$21| Int) (|b_$28| Int) (|d_$1| Int))(!(=> (and (< |a_$21| |b_$28|) (and (<= 2 |d_$1|) (= (mod |b_$28| |d_$1|) (mod |a_$21| |d_$1|)))) (<= (+ |a_$21| |d_$1|) |b_$28|))  :pattern ( (mod |a_$21| |d_$1|) (mod |b_$28| |d_$1|))))
    (forall( (|a_$22| $@Map@@BoxType@To@Bool@@) (|x_$14| BoxType) (|o_$1_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$22| |x_$14|) |o_$1_$0|) (or (= |x_$14| |o_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$22| |o_$1_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$22| |x_$14|) |o_$1_$0|))))
    ...
    (forall( (|a_$5_$0| $@Map@@BoxType@To@Bool@@) (|b_$2_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Disjoint$BoxType$ |a_$5_$0| |b_$2_$0|) (and (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|) |b_$2_$0|) |a_$5_$0|) (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|) |a_$5_$0|) |b_$2_$0|)))  :pattern ( (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|))))
    (forall( (|a_$6_$0| $@Map@@BoxType@To@Bool@@) (|b_$3_$0| $@Map@@BoxType@To@Bool@@) (|o_$3_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$6_$0| |b_$3_$0|) |o_$3_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$3_$0| |o_$3_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$6_$0| |o_$3_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$6_$0| |b_$3_$0|) |o_$3_$0|))))
    ...
    (forall( (|b_$15| BoxType))(!(= |b_$15| ($Box$Int$ ($Unbox$Int$ |b_$15|)))  :pattern ( ($Unbox$Int$ |b_$15|))))
    (forall( (|b_$16| BoxType))(!(= |b_$16| ($Box$ref$ ($Unbox$ref$ |b_$16|)))  :pattern ( ($Unbox$ref$ |b_$16|))))
    (forall( (|b_$17| BoxType))(!(= |b_$17| ($Box$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$17|)))  :pattern ( ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$17|))))
    (forall( (|b_$18| BoxType))(!(= |b_$18| ($Box$Seq$BoxType$$ ($Unbox$Seq$BoxType$$ |b_$18|)))  :pattern ( ($Unbox$Seq$BoxType$$ |b_$18|))))
    (forall( (|b_$19| BoxType))(!(= |b_$19| ($Box$DatatypeType$ ($Unbox$DatatypeType$ |b_$19|)))  :pattern ( ($Unbox$DatatypeType$ |b_$19|))))
    (forall( (|b_$20| BoxType))(!(=> ($IsCanonicalBoolBox |b_$20|) (= |b_$20| ($Box$Bool$ ($Unbox$Bool$ |b_$20|))))  :pattern ( ($Unbox$Bool$ |b_$20|))))
    (forall( (|b_$22| BoxType) (|h_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$22| |h_$1|) (or (= null ($Unbox$ref$ |b_$22|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1| ($Unbox$ref$ |b_$22|) alloc)))  :pattern ( (GenericAlloc |b_$22| |h_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1| ($Unbox$ref$ |b_$22|) alloc))))
    (forall( (|b_$23| BoxType) (|h_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$11| Int))(!(=> (and (< |i_$11| (Seq@Length$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|))) (and (GenericAlloc |b_$23| |h_$2|) (<= 0 |i_$11|))) (GenericAlloc (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|) |i_$11|) |h_$2|))  :pattern ( (GenericAlloc |b_$23| |h_$2|) (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|) |i_$11|))))
    ...
    (forall( (|f_$2| Field$BoxType$) (|i_$10| Int))(!(and (= (MultiIndexField_Inverse1$BoxType$ (MultiIndexField |f_$2| |i_$10|)) |i_$10|) (= (MultiIndexField_Inverse0$BoxType$ (MultiIndexField |f_$2| |i_$10|)) |f_$2|))  :pattern ( (MultiIndexField |f_$2| |i_$10|))))
    ...
    (forall( (|r_$3| ref) (|h_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and (or (= |r_$3| null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$7| |r_$3| alloc)) ($IsGoodHeap |h_$7|)) (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|))  :pattern ( (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|))))
    ...
    (forall( (|s_$10_$0| Seq$ref$) (|n_$6_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (Seq@Length$ref$ |s_$10_$0|)) (and (< |j_$2_$0| |n_$6_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|) (Seq@Index$ref$ |s_$10_$0| |j_$2_$0|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|))))
    (forall( (|s_$10_$1| Seq$BoxType$) (|n_$6_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (Seq@Length$BoxType$ |s_$10_$1|)) (and (< |j_$2_$1| |n_$6_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|) (Seq@Index$BoxType$ |s_$10_$1| |j_$2_$1|)))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|))))
    (forall( (|s_$11_$0| Seq$ref$) (|n_$7_$0| Int))(!(=> (<= 0 |n_$7_$0|) (and (=> (< (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) 0)) (=> (<= |n_$7_$0| (Seq@Length$ref$ |s_$11_$0|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) (- (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)))))
    (forall( (|s_$11_$1| Seq$BoxType$) (|n_$7_$1| Int))(!(=> (<= 0 |n_$7_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) 0)) (=> (<= |n_$7_$1| (Seq@Length$BoxType$ |s_$11_$1|)) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) (- (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|)))))  :pattern ( (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)))))
    (forall( (|s_$12_$0| Seq$ref$) (|n_$8_$0| Int) (|j_$3_$0| Int))(!(=> (and (< |j_$3_$0| (- (Seq@Length$ref$ |s_$12_$0|) |n_$8_$0|)) (and (<= 0 |n_$8_$0|) (<= 0 |j_$3_$0|))) (= (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|) (Seq@Index$ref$ |s_$12_$0| (+ |j_$3_$0| |n_$8_$0|))))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|))))
    (forall( (|s_$12_$1| Seq$BoxType$) (|n_$8_$1| Int) (|j_$3_$1| Int))(!(=> (and (< |j_$3_$1| (- (Seq@Length$BoxType$ |s_$12_$1|) |n_$8_$1|)) (and (<= 0 |n_$8_$1|) (<= 0 |j_$3_$1|))) (= (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|) (Seq@Index$BoxType$ |s_$12_$1| (+ |j_$3_$1| |n_$8_$1|))))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|))))
    (forall( (|s_$13_$0| Seq$ref$) (|t_$1_$0| Seq$ref$))(!(and (= |t_$1_$0| (Seq@Drop$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|))) (= (Seq@Take$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|)) |s_$13_$0|))  :pattern ( (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|))))
    (forall( (|s_$13_$1| Seq$BoxType$) (|t_$1_$1| Seq$BoxType$))(!(and (= |t_$1_$1| (Seq@Drop$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|))) (= (Seq@Take$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|)) |s_$13_$1|))  :pattern ( (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|))))
    ...
    (forall( (|s_$2_$0| Seq$ref$) (|i_$0_$0| Int) (|v_$1_$0| ref) (|len_$0_$0| Int) (|n_$0_$0| Int))(!(=> (and (< |n_$0_$0| |len_$0_$0|) (<= 0 |n_$0_$0|)) (and (=> (= |n_$0_$0| |i_$0_$0|) (= |v_$1_$0| (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|))) (=> (not (= |n_$0_$0| |i_$0_$0|)) (= (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|) (Seq@Index$ref$ |s_$2_$0| |n_$0_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|))))
    (forall( (|s_$2_$1| Seq$BoxType$) (|i_$0_$1| Int) (|v_$1_$1| BoxType) (|len_$0_$1| Int) (|n_$0_$1| Int))(!(=> (and (< |n_$0_$1| |len_$0_$1|) (<= 0 |n_$0_$1|)) (and (=> (= |n_$0_$1| |i_$0_$1|) (= |v_$1_$1| (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|))) (=> (not (= |n_$0_$1| |i_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|) (Seq@Index$BoxType$ |s_$2_$1| |n_$0_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|))))
    (forall( (|s_$3_$0| Seq$ref$) (|i_$1_$0| Int) (|v_$2_$0| ref))(!(=> (and (< |i_$1_$0| (Seq@Length$ref$ |s_$3_$0|)) (<= 0 |i_$1_$0|)) (= (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|)) (Seq@Length$ref$ |s_$3_$0|)))  :pattern ( (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|)))))
    (forall( (|s_$3_$1| Seq$BoxType$) (|i_$1_$1| Int) (|v_$2_$1| BoxType))(!(=> (and (< |i_$1_$1| (Seq@Length$BoxType$ |s_$3_$1|)) (<= 0 |i_$1_$1|)) (= (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|)) (Seq@Length$BoxType$ |s_$3_$1|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|)))))
    (forall( (|s_$4_$0| Seq$ref$) (|i_$2_$0| Int) (|v_$3_$0| ref) (|n_$1_$0| Int))(!(=> (and (< |n_$1_$0| (Seq@Length$ref$ |s_$4_$0|)) (<= 0 |n_$1_$0|)) (and (=> (= |n_$1_$0| |i_$2_$0|) (= |v_$3_$0| (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|))) (=> (not (= |n_$1_$0| |i_$2_$0|)) (= (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|) (Seq@Index$ref$ |s_$4_$0| |n_$1_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|))))
    (forall( (|s_$4_$1| Seq$BoxType$) (|i_$2_$1| Int) (|v_$3_$1| BoxType) (|n_$1_$1| Int))(!(=> (and (< |n_$1_$1| (Seq@Length$BoxType$ |s_$4_$1|)) (<= 0 |n_$1_$1|)) (and (=> (= |n_$1_$1| |i_$2_$1|) (= |v_$3_$1| (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|))) (=> (not (= |n_$1_$1| |i_$2_$1|)) (= (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|) (Seq@Index$BoxType$ |s_$4_$1| |n_$1_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|))))
    (forall( (|s_$5_$0| Seq$ref$) (|x_$2_$0| ref))(!(= (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|) (exists( (|i_$3_$1| Int))(!(and (= |x_$2_$0| (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)) (and (< |i_$3_$1| (Seq@Length$ref$ |s_$5_$0|)) (<= 0 |i_$3_$1|)))  :pattern ( (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)))))  :pattern ( (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|))))
    (forall( (|s_$5_$1| Seq$BoxType$) (|x_$2_$1| BoxType))(!(= (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|) (exists( (|i_$3_$3| Int))(!(and (= |x_$2_$1| (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)) (and (< |i_$3_$3| (Seq@Length$BoxType$ |s_$5_$1|)) (<= 0 |i_$3_$3|)))  :pattern ( (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)))))  :pattern ( (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|))))
    ...
    (forall( (|s_$9_$0| Seq$ref$) (|n_$5_$0| Int))(!(=> (<= 0 |n_$5_$0|) (and (=> (< (Seq@Length$ref$ |s_$9_$0|) |n_$5_$0|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) (Seq@Length$ref$ |s_$9_$0|))) (=> (<= |n_$5_$0| (Seq@Length$ref$ |s_$9_$0|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) |n_$5_$0|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)))))
    (forall( (|s_$9_$1| Seq$BoxType$) (|n_$5_$1| Int))(!(=> (<= 0 |n_$5_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$9_$1|) |n_$5_$1|) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) (Seq@Length$BoxType$ |s_$9_$1|))) (=> (<= |n_$5_$1| (Seq@Length$BoxType$ |s_$9_$1|)) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) |n_$5_$1|))))  :pattern ( (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)))))
    (forall( (|s0_$0_$0| Seq$ref$) (|s1_$0_$0| Seq$ref$) (|n_$9| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$0|) |n_$9|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s1_$0_$0| (- |n_$9| (Seq@Length$ref$ |s0_$0_$0|))))) (=> (< |n_$9| (Seq@Length$ref$ |s0_$0_$0|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s0_$0_$0| |n_$9|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|))))
    (forall( (|s0_$0_$1| Seq$BoxType$) (|s1_$0_$1| Seq$BoxType$) (|n_$10| Int))(!(and (=> (<= (Seq@Length$BoxType$ |s0_$0_$1|) |n_$10|) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s1_$0_$1| (- |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|))))) (=> (< |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s0_$0_$1| |n_$10|))))  :pattern ( (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|))))
    (forall( (|s0_$1_$0| Seq$ref$) (|s1_$1_$0| Seq$ref$) (|x_$4_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|) (or (Seq@Contains$ref$ |s1_$1_$0| |x_$4_$0|) (Seq@Contains$ref$ |s0_$1_$0| |x_$4_$0|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|))))
    (forall( (|s0_$1_$1| Seq$BoxType$) (|s1_$1_$1| Seq$BoxType$) (|x_$4_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|) (or (Seq@Contains$BoxType$ |s1_$1_$1| |x_$4_$1|) (Seq@Contains$BoxType$ |s0_$1_$1| |x_$4_$1|)))  :pattern ( (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|))))
    (forall( (|s0_$2_$0| Seq$ref$) (|s1_$2_$0| Seq$ref$))(!(= (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$ref$ |s1_$2_$0|) (Seq@Length$ref$ |s0_$2_$0|)) (forall( (|j_$0_$1| Int))(!(=> (and (< |j_$0_$1| (Seq@Length$ref$ |s0_$2_$0|)) (<= 0 |j_$0_$1|)) (= (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|) (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)))  :pattern ( (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)) :pattern ( (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|))))))  :pattern ( (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|))))
    ...
    (forall( (|t_$0_$0| ref))(!(= |t_$0_$0| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0))))
    (forall( (|t_$0_$1| BoxType))(!(= |t_$0_$1| (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0))))
    ...
    (forall( (|x_$8_$0| Bool))(!(= |x_$8_$0| ($Unbox$Bool$ ($Box$Bool$ |x_$8_$0|)))  :pattern ( ($Box$Bool$ |x_$8_$0|))))
    (forall( (|x_$8_$1| TickType))(!(= |x_$8_$1| ($Unbox$TickType$ ($Box$TickType$ |x_$8_$1|)))  :pattern ( ($Box$TickType$ |x_$8_$1|))))
    (forall( (|x_$8_$10| Field$BoxType$))(!(= |x_$8_$10| ($Unbox$Field$BoxType$$ ($Box$Field$BoxType$$ |x_$8_$10|)))  :pattern ( ($Box$Field$BoxType$$ |x_$8_$10|))))
    (forall( (|x_$8_$11| Field$Bool$))(!(= |x_$8_$11| ($Unbox$Field$Bool$$ ($Box$Field$Bool$$ |x_$8_$11|)))  :pattern ( ($Box$Field$Bool$$ |x_$8_$11|))))
    (forall( (|x_$8_$12| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= |x_$8_$12| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|))))
    (forall( (|x_$8_$13| Field$Seq$BoxType$$))(!(= |x_$8_$13| ($Unbox$Field$Seq$BoxType$$$ ($Box$Field$Seq$BoxType$$$ |x_$8_$13|)))  :pattern ( ($Box$Field$Seq$BoxType$$$ |x_$8_$13|))))
    (forall( (|x_$8_$14| Field$$@Map@@BoxType@To@Bool@@$))(!(= |x_$8_$14| ($Unbox$Field$$@Map@@BoxType@To@Bool@@$$ ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|)))  :pattern ( ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|))))
    (forall( (|x_$8_$15| Field$ref$))(!(= |x_$8_$15| ($Unbox$Field$ref$$ ($Box$Field$ref$$ |x_$8_$15|)))  :pattern ( ($Box$Field$ref$$ |x_$8_$15|))))
    (forall( (|x_$8_$16| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= |x_$8_$16| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|))))
    (forall( (|x_$8_$2| Int))(!(= |x_$8_$2| ($Unbox$Int$ ($Box$Int$ |x_$8_$2|)))  :pattern ( ($Box$Int$ |x_$8_$2|))))
    (forall( (|x_$8_$3| Seq$ref$))(!(= |x_$8_$3| ($Unbox$Seq$ref$$ ($Box$Seq$ref$$ |x_$8_$3|)))  :pattern ( ($Box$Seq$ref$$ |x_$8_$3|))))
    (forall( (|x_$8_$4| ref))(!(= |x_$8_$4| ($Unbox$ref$ ($Box$ref$ |x_$8_$4|)))  :pattern ( ($Box$ref$ |x_$8_$4|))))
    (forall( (|x_$8_$5| BoxType))(!(= |x_$8_$5| ($Unbox$BoxType$ ($Box$BoxType$ |x_$8_$5|)))  :pattern ( ($Box$BoxType$ |x_$8_$5|))))
    (forall( (|x_$8_$6| $@Map@@BoxType@To@Bool@@))(!(= |x_$8_$6| ($Unbox$$@Map@@BoxType@To@Bool@@$ ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|)))  :pattern ( ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|))))
    (forall( (|x_$8_$7| Seq$BoxType$))(!(= |x_$8_$7| ($Unbox$Seq$BoxType$$ ($Box$Seq$BoxType$$ |x_$8_$7|)))  :pattern ( ($Box$Seq$BoxType$$ |x_$8_$7|))))
    (forall( (|x_$8_$8| DatatypeType))(!(= |x_$8_$8| ($Unbox$DatatypeType$ ($Box$DatatypeType$ |x_$8_$8|)))  :pattern ( ($Box$DatatypeType$ |x_$8_$8|))))
    (forall( (|x_$8_$9| ClassName))(!(= |x_$8_$9| ($Unbox$ClassName$ ($Box$ClassName$ |x_$8_$9|)))  :pattern ( ($Box$ClassName$ |x_$8_$9|))))
