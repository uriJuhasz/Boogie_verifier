...
;Axioms
   ...
   (assert (! (=> (not (= call4formal@p@24@0 null)) (or (and (= call6formal@prev@26@0 null) (= call5formal@n@25@0 0)) (and (= call6formal@prev@26@0 ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ (- 1) call5formal@n@25@0)))) (< 0 call5formal@n@25@0)))) :named ax_47))
...
(let ((anon6_Then@2 (=> (and true
    ...
    (not (= call6formal@prev@26@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 this Map.head)))
  )
    $join_2
)))
...
(let ((anon5_Then@14 (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@2 this Map.nodes))
    (not (< (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes)) call5formal@n@25@0))
  )(and 
