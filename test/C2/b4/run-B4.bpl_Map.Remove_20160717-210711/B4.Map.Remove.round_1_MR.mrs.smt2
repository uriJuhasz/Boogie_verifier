...
(declare-fun $NP@78 ( ) Bool)
(declare-fun $NP@79 ( ) Bool)
...
;Axioms
   ...
   (assert (! ($IsGoodHeap $Heap) :named ax_2))
   (assert (! ($IsGoodHeap $Heap@0) :named ax_3))
   (assert (! (= $_Frame@0 (lambda@8 Map.Repr null $Heap alloc this)) :named ax_4))
   (assert (! (= (- 1) (* (- 1) 1)) :named ax_5))
   (assert (! (= ($Box$Bool$ false) ($Box$Bool$ ($@bf_24 ($Box$Bool$ false)))) :named ax_6))
   (assert (! (= ($Box$Bool$ true) ($Box$Bool$ ($@bf_24 ($Box$Bool$ true)))) :named ax_7))
   (assert (! (= (= true $@bf_22) ($Unbox$Bool$ ($Box$Bool$ true))) :named ax_8))
   (assert (! (= (= true $@bf_23) ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_9))
   (assert (! (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap this Map.head) ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) 0))) :named ax_10))
   (assert (! (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Values))) :named ax_11))
   (assert (! (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) 1)) :named ax_12))
   (assert (! (= 0 $ModuleContextHeight) :named ax_13))
   (assert (! (= 0 (FDim$$@Map@@BoxType@To@Bool@@$ Map.Repr)) :named ax_14))
   (assert (! (= 0 (FDim$Bool$ alloc)) :named ax_15))
   (assert (! (= 0 (FDim$BoxType$ Node.key)) :named ax_16))
   (assert (! (= 0 (FDim$BoxType$ Node.val)) :named ax_17))
   (assert (! (= 0 (FDim$ref$ Map.head)) :named ax_18))
   (assert (! (= 0 (FDim$ref$ Node.next)) :named ax_19))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.Keys)) :named ax_20))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.nodes)) :named ax_21))
   (assert (! (= 0 (FDim$Seq$BoxType$$ Map.Values)) :named ax_22))
   (assert (! (= 0 (Seq@Length$BoxType$ Seq@Empty$BoxType$)) :named ax_23))
   (assert (! (= 0 (Seq@Length$ref$ Seq@Empty$ref$)) :named ax_24))
   (assert (! (= class.Map (DeclType$$@Map@@BoxType@To@Bool@@$ Map.Repr)) :named ax_25))
   (assert (! (= class.Map (DeclType$ref$ Map.head)) :named ax_26))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.Keys)) :named ax_27))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.nodes)) :named ax_28))
   (assert (! (= class.Map (DeclType$Seq$BoxType$$ Map.Values)) :named ax_29))
   (assert (! (= class.Map (dtype this)) :named ax_30))
   (assert (! (= class.Node (DeclType$BoxType$ Node.key)) :named ax_31))
   (assert (! (= class.Node (DeclType$BoxType$ Node.val)) :named ax_32))
   (assert (! (= class.Node (DeclType$ref$ Node.next)) :named ax_33))
   (assert (! (= false $@bf_23) :named ax_34))
   (assert (! (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes)) (- 1))))) :named ax_35))
   (assert (! (= true $@bf_22) :named ax_36))
   ...
   (assert (! (forall( (|$h_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$0| ref))(!(=> (and (and ($IsGoodHeap |$h_$0|) (not (= null |$o_$0|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$0| |$o_$0| alloc)) (forall( (|$i#1| Int))(!(=> (and (<= 0 |$i#1|) (< |$i#1| (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$0| |$o_$0| Map.Values)))) (GenericAlloc (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$0| |$o_$0| Map.Values) |$i#1|) |$h_$0|))  :pattern ( (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$0| |$o_$0| Map.Values) |$i#1|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$0| |$o_$0| Map.Values)))) :named ax_67))
   (assert (! (forall( (|$h_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$1| ref))(!(=> (and (and ($IsGoodHeap |$h_$1|) (not (= null |$o_$1|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$1| |$o_$1| alloc)) (forall( (|$t#2| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h_$1| |$o_$1| Map.Repr) |$t#2|) (or (= null ($Unbox$ref$ |$t#2|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$1| ($Unbox$ref$ |$t#2|) alloc)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h_$1| |$o_$1| Map.Repr) |$t#2|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h_$1| |$o_$1| Map.Repr)))) :named ax_68))
   (assert (! (forall( (|$h_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$2| ref))(!(=> (and (and ($IsGoodHeap |$h_$2|) (not (= null |$o_$2|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$2| |$o_$2| alloc)) (or (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$2| |$o_$2| Map.head)) (and (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$2| |$o_$2| Map.head)) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$2| (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$2| |$o_$2| Map.head) alloc))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$2| |$o_$2| Map.head)))) :named ax_69))
   (assert (! (forall( (|$h_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$3| ref))(!(=> (and (and ($IsGoodHeap |$h_$3|) (not (= null |$o_$3|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$3| |$o_$3| alloc)) (forall( (|$i#3| Int))(!(=> (and (<= 0 |$i#3|) (< |$i#3| (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes)))) (or (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes) |$i#3|))) (and (= (dtype ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes) |$i#3|))) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$3| ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes) |$i#3|)) alloc))))  :pattern ( (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes) |$i#3|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h_$3| |$o_$3| Map.nodes)))) :named ax_70))
   (assert (! (forall( (|$h_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$5| ref))(!(=> (and (and ($IsGoodHeap |$h_$4|) (not (= null |$o_$5|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$4| |$o_$5| alloc)) (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$4| |$o_$5| Node.key) |$h_$4|))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$4| |$o_$5| Node.key)))) :named ax_71))
   (assert (! (forall( (|$h_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$6| ref))(!(=> (and (and ($IsGoodHeap |$h_$5|) (not (= null |$o_$6|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$5| |$o_$6| alloc)) (GenericAlloc (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$5| |$o_$6| Node.val) |$h_$5|))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h_$5| |$o_$6| Node.val)))) :named ax_72))
   (assert (! (forall( (|$h_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o_$7| ref))(!(=> (and (and ($IsGoodHeap |$h_$6|) (not (= null |$o_$7|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$6| |$o_$7| alloc)) (or (= null (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$6| |$o_$7| Node.next)) (and (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$6| |$o_$7| Node.next)) class.Node) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h_$6| (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$6| |$o_$7| Node.next) alloc))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h_$6| |$o_$7| Node.next)))) :named ax_73))
   (assert (! (forall( (|$h| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$o| ref))(!(=> (and (and ($IsGoodHeap |$h|) (not (= null |$o|))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h| |$o| alloc)) (forall( (|$i#0| Int))(!(=> (and (<= 0 |$i#0|) (< |$i#0| (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h| |$o| Map.Keys)))) (GenericAlloc (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h| |$o| Map.Keys) |$i#0|) |$h|))  :pattern ( (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h| |$o| Map.Keys) |$i#0|)))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h| |$o| Map.Keys)))) :named ax_74))
   (assert (! (forall( (|$h0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|$h1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$1| ref))(!(=> (and (and (= (dtype |this_$1|) class.Map) (and (and (= (dtype |this_$1|) class.Map) (and (and (and ($IsGoodHeap |$h1|) ($IsGoodHeap |$h0|)) (not (= |this_$1| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |this_$1| alloc))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |this_$1| alloc))) ($HeapSucc |$h0| |$h1|)) (=> (and (forall( (|$o_$4_$4| ref) (|$f_$17| Field$Seq$BoxType$$))(=> (and (or (= |this_$1| |$o_$4_$4|) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |this_$1| Map.Repr) ($Box$ref$ |$o_$4_$4|))) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$4| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$4| alloc) (not (= null |$o_$4_$4|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h1| |$o_$4_$4| |$f_$17|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$h0| |$o_$4_$4| |$f_$17|)))) (and (forall( (|$o_$4_$3| ref) (|$f_$16| Field$$@Map@@BoxType@To@Bool@@$))(=> (and (or (= |this_$1| |$o_$4_$3|) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |this_$1| Map.Repr) ($Box$ref$ |$o_$4_$3|))) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$3| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$3| alloc) (not (= null |$o_$4_$3|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h1| |$o_$4_$3| |$f_$16|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |$o_$4_$3| |$f_$16|)))) (and (forall( (|$o_$4_$2| ref) (|$f_$15| Field$BoxType$))(=> (and (or (= |this_$1| |$o_$4_$2|) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |this_$1| Map.Repr) ($Box$ref$ |$o_$4_$2|))) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$2| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$2| alloc) (not (= null |$o_$4_$2|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h1| |$o_$4_$2| |$f_$15|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$h0| |$o_$4_$2| |$f_$15|)))) (and (forall( (|$o_$4_$1| ref) (|$f_$14| Field$ref$))(=> (and (or (= |this_$1| |$o_$4_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |this_$1| Map.Repr) ($Box$ref$ |$o_$4_$1|))) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$1| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$1| alloc) (not (= null |$o_$4_$1|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h1| |$o_$4_$1| |$f_$14|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$h0| |$o_$4_$1| |$f_$14|)))) (forall( (|$o_$4_$0| ref) (|$f_$13| Field$Bool$))(=> (and (or (= |this_$1| |$o_$4_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$h0| |this_$1| Map.Repr) ($Box$ref$ |$o_$4_$0|))) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$0| alloc) (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$0| alloc) (not (= null |$o_$4_$0|))))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h1| |$o_$4_$0| |$f_$13|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$h0| |$o_$4_$0| |$f_$13|)))))))) (= (Map.Valid |$h1| |this_$1|) (Map.Valid |$h0| |this_$1|))))  :pattern ( ($HeapSucc |$h0| |$h1|) (Map.Valid |$h1| |this_$1|)))) :named ax_75))
   (assert (! (forall( (|$Heap_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|this_$0| ref))(!(=> (or (Map.Valid@canCall |$Heap_$0| |this_$0|) (and (= (dtype |this_$0|) class.Map) (and (and ($IsGoodHeap |$Heap_$0|) (not (= |this_$0| null))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$0| |this_$0| alloc)))) (= (Map.Valid |$Heap_$0| |this_$0|) (and (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) (- (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes)) 1)))) (and (forall( (|i#0_$1| Int))(=> (and (< |i#0_$1| (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Keys))) (<= 0 |i#0_$1|)) (and (and (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Values) |i#0_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$Heap_$0| ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)) Node.val)) (and (and (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Keys) |i#0_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$Heap_$0| ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)) Node.key)) (and (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$0| |this_$0| Map.Repr) ($Box$ref$ ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)))) (not (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)))))) (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Keys) (+ |i#0_$1| 1)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |$Heap_$0| ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)) Node.key))))) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) (+ |i#0_$1| 1))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$0| ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) |i#0_$1|)) Node.next))))) (and (and (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Keys)) 1)) (and (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Values)) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.Keys))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$0| |this_$0| Map.Repr) ($Box$ref$ |this_$0|)))) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |$Heap_$0| |this_$0| Map.nodes) 0)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |$Heap_$0| |this_$0| Map.head)))))))  :pattern ( (Map.Valid |$Heap_$0| |this_$0|)))) :named ax_76))
   (assert (! (forall( (|$o_$16_$0| ref) (|$f_$8_$0| Field$Bool$) (|Map.Repr_$4_$0| Field$$@Map@@BoxType@To@Bool@@$) (|null_$8_$0| ref) (|$Heap_$9_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$8_$0| Field$Bool$) (|this_$8_$0| ref))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@8 |Map.Repr_$4_$0| |null_$8_$0| |$Heap_$9_$0| |alloc_$8_$0| |this_$8_$0|) |$o_$16_$0| |$f_$8_$0|) (=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9_$0| |$o_$16_$0| |alloc_$8_$0|) (not (= |null_$8_$0| |$o_$16_$0|))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$9_$0| |this_$8_$0| |Map.Repr_$4_$0|) ($Box$ref$ |$o_$16_$0|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Bool$ (lambda@8 |Map.Repr_$4_$0| |null_$8_$0| |$Heap_$9_$0| |alloc_$8_$0| |this_$8_$0|) |$o_$16_$0| |$f_$8_$0|)))) :named ax_77))
   (assert (! (forall( (|$o_$16_$1| ref) (|$f_$8_$1| Field$ref$) (|Map.Repr_$4_$1| Field$$@Map@@BoxType@To@Bool@@$) (|null_$8_$1| ref) (|$Heap_$9_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$8_$1| Field$Bool$) (|this_$8_$1| ref))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@8 |Map.Repr_$4_$1| |null_$8_$1| |$Heap_$9_$1| |alloc_$8_$1| |this_$8_$1|) |$o_$16_$1| |$f_$8_$1|) (=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9_$1| |$o_$16_$1| |alloc_$8_$1|) (not (= |null_$8_$1| |$o_$16_$1|))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$9_$1| |this_$8_$1| |Map.Repr_$4_$1|) ($Box$ref$ |$o_$16_$1|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ (lambda@8 |Map.Repr_$4_$1| |null_$8_$1| |$Heap_$9_$1| |alloc_$8_$1| |this_$8_$1|) |$o_$16_$1| |$f_$8_$1|)))) :named ax_78))
   (assert (! (forall( (|$o_$16_$2| ref) (|$f_$8_$2| Field$BoxType$) (|Map.Repr_$4_$2| Field$$@Map@@BoxType@To@Bool@@$) (|null_$8_$2| ref) (|$Heap_$9_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$8_$2| Field$Bool$) (|this_$8_$2| ref))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@8 |Map.Repr_$4_$2| |null_$8_$2| |$Heap_$9_$2| |alloc_$8_$2| |this_$8_$2|) |$o_$16_$2| |$f_$8_$2|) (=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9_$2| |$o_$16_$2| |alloc_$8_$2|) (not (= |null_$8_$2| |$o_$16_$2|))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$9_$2| |this_$8_$2| |Map.Repr_$4_$2|) ($Box$ref$ |$o_$16_$2|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$BoxType$ (lambda@8 |Map.Repr_$4_$2| |null_$8_$2| |$Heap_$9_$2| |alloc_$8_$2| |this_$8_$2|) |$o_$16_$2| |$f_$8_$2|)))) :named ax_79))
   (assert (! (forall( (|$o_$16_$3| ref) (|$f_$8_$3| Field$$@Map@@BoxType@To@Bool@@$) (|Map.Repr_$4_$3| Field$$@Map@@BoxType@To@Bool@@$) (|null_$8_$3| ref) (|$Heap_$9_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$8_$3| Field$Bool$) (|this_$8_$3| ref))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$$@Map@@BoxType@To@Bool@@$ (lambda@8 |Map.Repr_$4_$3| |null_$8_$3| |$Heap_$9_$3| |alloc_$8_$3| |this_$8_$3|) |$o_$16_$3| |$f_$8_$3|) (=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9_$3| |$o_$16_$3| |alloc_$8_$3|) (not (= |null_$8_$3| |$o_$16_$3|))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$9_$3| |this_$8_$3| |Map.Repr_$4_$3|) ($Box$ref$ |$o_$16_$3|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$$@Map@@BoxType@To@Bool@@$ (lambda@8 |Map.Repr_$4_$3| |null_$8_$3| |$Heap_$9_$3| |alloc_$8_$3| |this_$8_$3|) |$o_$16_$3| |$f_$8_$3|)))) :named ax_80))
   (assert (! (forall( (|$o_$16_$4| ref) (|$f_$8_$4| Field$Seq$BoxType$$) (|Map.Repr_$4_$4| Field$$@Map@@BoxType@To@Bool@@$) (|null_$8_$4| ref) (|$Heap_$9_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|alloc_$8_$4| Field$Bool$) (|this_$8_$4| ref))(!(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Seq$BoxType$$ (lambda@8 |Map.Repr_$4_$4| |null_$8_$4| |$Heap_$9_$4| |alloc_$8_$4| |this_$8_$4|) |$o_$16_$4| |$f_$8_$4|) (=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |$Heap_$9_$4| |$o_$16_$4| |alloc_$8_$4|) (not (= |null_$8_$4| |$o_$16_$4|))) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |$Heap_$9_$4| |this_$8_$4| |Map.Repr_$4_$4|) ($Box$ref$ |$o_$16_$4|))))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$Seq$BoxType$$ (lambda@8 |Map.Repr_$4_$4| |null_$8_$4| |$Heap_$9_$4| |alloc_$8_$4| |this_$8_$4|) |$o_$16_$4| |$f_$8_$4|)))) :named ax_81))
   (assert (! (forall( (|$o_$20_$0| ref) (|$f_$12_$0| Field$Bool$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$0| alloc) (not (= null |$o_$20_$0|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$0| |$f_$12_$0|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$20_$0| |$f_$12_$0|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 |$o_$20_$0| |$f_$12_$0|)))) :named ax_82))
   (assert (! (forall( (|$o_$20_$1| ref) (|$f_$12_$1| Field$ref$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$1| alloc) (not (= null |$o_$20_$1|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap |$o_$20_$1| |$f_$12_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$20_$1| |$f_$12_$1|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 |$o_$20_$1| |$f_$12_$1|)))) :named ax_83))
   (assert (! (forall( (|$o_$20_$2| ref) (|$f_$12_$2| Field$BoxType$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$2| alloc) (not (= null |$o_$20_$2|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap |$o_$20_$2| |$f_$12_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$20_$2| |$f_$12_$2|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap@0 |$o_$20_$2| |$f_$12_$2|)))) :named ax_84))
   (assert (! (forall( (|$o_$20_$3| ref) (|$f_$12_$3| Field$$@Map@@BoxType@To@Bool@@$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$3| alloc) (not (= null |$o_$20_$3|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap |$o_$20_$3| |$f_$12_$3|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 |$o_$20_$3| |$f_$12_$3|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 |$o_$20_$3| |$f_$12_$3|)))) :named ax_85))
   (assert (! (forall( (|$o_$20_$4| ref) (|$f_$12_$4| Field$Seq$BoxType$$))(!(=> (and (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap |$o_$20_$4| alloc) (not (= null |$o_$20_$4|))) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap |$o_$20_$4| |$f_$12_$4|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 |$o_$20_$4| |$f_$12_$4|)))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 |$o_$20_$4| |$f_$12_$4|)))) :named ax_86))
   (assert (! (forall( (|a_$0_$0| $@Map@@BoxType@To@Bool@@) (|x_$0_$0| BoxType))(!(MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$0_$0| |x_$0_$0|) |x_$0_$0|)  :pattern ( (Set@UnionOne$BoxType$ |a_$0_$0| |x_$0_$0|)))) :named ax_87))
   (assert (! (forall( (|a_$1_$0| $@Map@@BoxType@To@Bool@@) (|x_$1_$0| BoxType) (|y_$6| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$1_$0| |x_$1_$0|) |y_$6|))  :pattern ( (Set@UnionOne$BoxType$ |a_$1_$0| |x_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$1_$0| |y_$6|)))) :named ax_88))
   (assert (! (forall( (|a_$10_$0| $@Map@@BoxType@To@Bool@@) (|b_$7_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ |a_$10_$0| (Set@Intersection$BoxType$ |a_$10_$0| |b_$7_$0|)) (Set@Intersection$BoxType$ |a_$10_$0| |b_$7_$0|))  :pattern ( (Set@Intersection$BoxType$ |a_$10_$0| (Set@Intersection$BoxType$ |a_$10_$0| |b_$7_$0|))))) :named ax_89))
   (assert (! (forall( (|a_$11_$0| $@Map@@BoxType@To@Bool@@) (|b_$8_$0| $@Map@@BoxType@To@Bool@@) (|o_$4_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$11_$0| |b_$8_$0|) |o_$4_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$11_$0| |o_$4_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$8_$0| |o_$4_$0|))))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$11_$0| |b_$8_$0|) |o_$4_$0|)))) :named ax_90))
   (assert (! (forall( (|a_$12_$0| $@Map@@BoxType@To@Bool@@) (|b_$9_$0| $@Map@@BoxType@To@Bool@@) (|y_$2_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$9_$0| |y_$2_$0|) (not (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Difference$BoxType$ |a_$12_$0| |b_$9_$0|) |y_$2_$0|)))  :pattern ( (Set@Difference$BoxType$ |a_$12_$0| |b_$9_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$9_$0| |y_$2_$0|)))) :named ax_91))
   (assert (! (forall( (|a_$14_$0| $@Map@@BoxType@To@Bool@@) (|b_$11_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Equal$BoxType$ |a_$14_$0| |b_$11_$0|) (forall( (|o_$6_$1| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$11_$0| |o_$6_$1|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$6_$1|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$14_$0| |o_$6_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$11_$0| |o_$6_$1|)))))  :pattern ( (Set@Equal$BoxType$ |a_$14_$0| |b_$11_$0|)))) :named ax_92))
   (assert (! (forall( (|a_$15_$0| $@Map@@BoxType@To@Bool@@) (|b_$12_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Equal$BoxType$ |a_$15_$0| |b_$12_$0|) (= |b_$12_$0| |a_$15_$0|))  :pattern ( (Set@Equal$BoxType$ |a_$15_$0| |b_$12_$0|)))) :named ax_93))
   (assert (! (forall( (|a_$16_$0| $@Map@@BoxType@To@Bool@@) (|b_$13_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Disjoint$BoxType$ |a_$16_$0| |b_$13_$0|) (forall( (|o_$7_$1| BoxType))(!(or (not (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$7_$1|)) (not (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$16_$0| |o_$7_$1|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$16_$0| |o_$7_$1|)) :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$13_$0| |o_$7_$1|)))))  :pattern ( (Set@Disjoint$BoxType$ |a_$16_$0| |b_$13_$0|)))) :named ax_94))
   (assert (! (forall( (|a_$17_$0| $@Map@@BoxType@To@Bool@@) (|tick_$0| TickType))(!(=> (not (= |a_$17_$0| Set@Empty$BoxType$)) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$17_$0| (Set@Choose$BoxType$ |a_$17_$0| |tick_$0|)))  :pattern ( (Set@Choose$BoxType$ |a_$17_$0| |tick_$0|)))) :named ax_95))
   (assert (! (forall( (|a_$18_$0| Seq$ref$) (|b_$14_$0| Seq$ref$))(!(=> (Seq@Equal$ref$ |a_$18_$0| |b_$14_$0|) (= |b_$14_$0| |a_$18_$0|))  :pattern ( (Seq@Equal$ref$ |a_$18_$0| |b_$14_$0|)))) :named ax_96))
   (assert (! (forall( (|a_$18_$1| Seq$BoxType$) (|b_$14_$1| Seq$BoxType$))(!(=> (Seq@Equal$BoxType$ |a_$18_$1| |b_$14_$1|) (= |b_$14_$1| |a_$18_$1|))  :pattern ( (Seq@Equal$BoxType$ |a_$18_$1| |b_$14_$1|)))) :named ax_97))
   (assert (! (forall( (|a_$19| ClassName) (|b_$21| ClassName))(!(and (= (TypeTupleCdr (TypeTuple |a_$19| |b_$21|)) |b_$21|) (= (TypeTupleCar (TypeTuple |a_$19| |b_$21|)) |a_$19|))  :pattern ( (TypeTuple |a_$19| |b_$21|)))) :named ax_98))
   (assert (! (forall( (|a_$2_$0| $@Map@@BoxType@To@Bool@@) (|b_$29| $@Map@@BoxType@To@Bool@@) (|o_$2_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$2_$0| |b_$29|) |o_$2_$0|) (or (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$29| |o_$2_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$2_$0| |o_$2_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$2_$0| |b_$29|) |o_$2_$0|)))) :named ax_99))
   (assert (! (forall( (|a_$20| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|b_$27| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|c| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and ($HeapSucc |b_$27| |c|) ($HeapSucc |a_$20| |b_$27|)) ($HeapSucc |a_$20| |c|))  :pattern ( ($HeapSucc |a_$20| |b_$27|) ($HeapSucc |b_$27| |c|)))) :named ax_100))
   (assert (! (forall( (|a_$21| Int) (|b_$28| Int) (|d_$1| Int))(!(=> (and (< |a_$21| |b_$28|) (and (<= 2 |d_$1|) (= (mod |b_$28| |d_$1|) (mod |a_$21| |d_$1|)))) (<= (+ |a_$21| |d_$1|) |b_$28|))  :pattern ( (mod |a_$21| |d_$1|) (mod |b_$28| |d_$1|)))) :named ax_101))
   (assert (! (forall( (|a_$22| $@Map@@BoxType@To@Bool@@) (|x_$14| BoxType) (|o_$1_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$22| |x_$14|) |o_$1_$0|) (or (= |x_$14| |o_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$22| |o_$1_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@UnionOne$BoxType$ |a_$22| |x_$14|) |o_$1_$0|)))) :named ax_102))
   (assert (! (forall( (|a_$3_$0| $@Map@@BoxType@To@Bool@@) (|b_$0_$0| $@Map@@BoxType@To@Bool@@) (|y_$0_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$3_$0| |y_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$3_$0| |b_$0_$0|) |y_$0_$0|))  :pattern ( (Set@Union$BoxType$ |a_$3_$0| |b_$0_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$3_$0| |y_$0_$0|)))) :named ax_103))
   (assert (! (forall( (|a_$4_$0| $@Map@@BoxType@To@Bool@@) (|b_$1_$0| $@Map@@BoxType@To@Bool@@) (|y_$1_$0| BoxType))(!(=> (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Union$BoxType$ |a_$4_$0| |b_$1_$0|) |y_$1_$0|))  :pattern ( (Set@Union$BoxType$ |a_$4_$0| |b_$1_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$1_$0| |y_$1_$0|)))) :named ax_104))
   (assert (! (forall( (|a_$5_$0| $@Map@@BoxType@To@Bool@@) (|b_$2_$0| $@Map@@BoxType@To@Bool@@))(!(=> (Set@Disjoint$BoxType$ |a_$5_$0| |b_$2_$0|) (and (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|) |b_$2_$0|) |a_$5_$0|) (= (Set@Difference$BoxType$ (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|) |a_$5_$0|) |b_$2_$0|)))  :pattern ( (Set@Union$BoxType$ |a_$5_$0| |b_$2_$0|)))) :named ax_105))
   (assert (! (forall( (|a_$6_$0| $@Map@@BoxType@To@Bool@@) (|b_$3_$0| $@Map@@BoxType@To@Bool@@) (|o_$3_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$6_$0| |b_$3_$0|) |o_$3_$0|) (and (MapRead$$@Map@@BoxType@To@Bool@@$ |b_$3_$0| |o_$3_$0|) (MapRead$$@Map@@BoxType@To@Bool@@$ |a_$6_$0| |o_$3_$0|)))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Intersection$BoxType$ |a_$6_$0| |b_$3_$0|) |o_$3_$0|)))) :named ax_106))
   (assert (! (forall( (|a_$7_$0| $@Map@@BoxType@To@Bool@@) (|b_$4_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$4_$0|) |b_$4_$0|) (Set@Union$BoxType$ |a_$7_$0| |b_$4_$0|))  :pattern ( (Set@Union$BoxType$ (Set@Union$BoxType$ |a_$7_$0| |b_$4_$0|) |b_$4_$0|)))) :named ax_107))
   (assert (! (forall( (|a_$8_$0| $@Map@@BoxType@To@Bool@@) (|b_$5_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Union$BoxType$ |a_$8_$0| (Set@Union$BoxType$ |a_$8_$0| |b_$5_$0|)) (Set@Union$BoxType$ |a_$8_$0| |b_$5_$0|))  :pattern ( (Set@Union$BoxType$ |a_$8_$0| (Set@Union$BoxType$ |a_$8_$0| |b_$5_$0|))))) :named ax_108))
   (assert (! (forall( (|a_$9_$0| $@Map@@BoxType@To@Bool@@) (|b_$6_$0| $@Map@@BoxType@To@Bool@@))(!(= (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$9_$0| |b_$6_$0|) |b_$6_$0|) (Set@Intersection$BoxType$ |a_$9_$0| |b_$6_$0|))  :pattern ( (Set@Intersection$BoxType$ (Set@Intersection$BoxType$ |a_$9_$0| |b_$6_$0|) |b_$6_$0|)))) :named ax_109))
   (assert (! (forall( (|b_$15| BoxType))(!(= |b_$15| ($Box$Int$ ($Unbox$Int$ |b_$15|)))  :pattern ( ($Unbox$Int$ |b_$15|)))) :named ax_110))
   (assert (! (forall( (|b_$16| BoxType))(!(= |b_$16| ($Box$ref$ ($Unbox$ref$ |b_$16|)))  :pattern ( ($Unbox$ref$ |b_$16|)))) :named ax_111))
   (assert (! (forall( (|b_$17| BoxType))(!(= |b_$17| ($Box$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$17|)))  :pattern ( ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$17|)))) :named ax_112))
   (assert (! (forall( (|b_$18| BoxType))(!(= |b_$18| ($Box$Seq$BoxType$$ ($Unbox$Seq$BoxType$$ |b_$18|)))  :pattern ( ($Unbox$Seq$BoxType$$ |b_$18|)))) :named ax_113))
   (assert (! (forall( (|b_$19| BoxType))(!(= |b_$19| ($Box$DatatypeType$ ($Unbox$DatatypeType$ |b_$19|)))  :pattern ( ($Unbox$DatatypeType$ |b_$19|)))) :named ax_114))
   (assert (! (forall( (|b_$20| BoxType))(!(=> ($IsCanonicalBoolBox |b_$20|) (= |b_$20| ($Box$Bool$ ($Unbox$Bool$ |b_$20|))))  :pattern ( ($Unbox$Bool$ |b_$20|)))) :named ax_115))
   (assert (! (forall( (|b_$22| BoxType) (|h_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$22| |h_$1|) (or (= null ($Unbox$ref$ |b_$22|)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1| ($Unbox$ref$ |b_$22|) alloc)))  :pattern ( (GenericAlloc |b_$22| |h_$1|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$1| ($Unbox$ref$ |b_$22|) alloc)))) :named ax_116))
   (assert (! (forall( (|b_$23| BoxType) (|h_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|i_$11| Int))(!(=> (and (< |i_$11| (Seq@Length$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|))) (and (GenericAlloc |b_$23| |h_$2|) (<= 0 |i_$11|))) (GenericAlloc (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|) |i_$11|) |h_$2|))  :pattern ( (GenericAlloc |b_$23| |h_$2|) (Seq@Index$BoxType$ ($Unbox$Seq$BoxType$$ |b_$23|) |i_$11|)))) :named ax_117))
   (assert (! (forall( (|b_$24| BoxType) (|h_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|t_$2| BoxType))(!(=> (and (GenericAlloc |b_$24| |h_$3|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$24|) |t_$2|)) (GenericAlloc |t_$2| |h_$3|))  :pattern ( (GenericAlloc |b_$24| |h_$3|) (MapRead$$@Map@@BoxType@To@Bool@@$ ($Unbox$$@Map@@BoxType@To@Bool@@$ |b_$24|) |t_$2|)))) :named ax_118))
   (assert (! (forall( (|b_$25| BoxType) (|h_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (GenericAlloc |b_$25| |h_$4|) (DtAlloc ($Unbox$DatatypeType$ |b_$25|) |h_$4|))  :pattern ( (GenericAlloc |b_$25| |h_$4|) (DtType ($Unbox$DatatypeType$ |b_$25|))))) :named ax_119))
   (assert (! (forall( (|b_$26| Bool) (|h_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$5|) (GenericAlloc ($Box$Bool$ |b_$26|) |h_$5|))) :named ax_120))
   (assert (! (forall( (|f_$1| Field$BoxType$) (|i_$9| Int))(!(= (FDim$BoxType$ (MultiIndexField |f_$1| |i_$9|)) (+ (FDim$BoxType$ |f_$1|) 1))  :pattern ( (MultiIndexField |f_$1| |i_$9|)))) :named ax_121))
   (assert (! (forall( (|f_$2| Field$BoxType$) (|i_$10| Int))(!(and (= (MultiIndexField_Inverse1$BoxType$ (MultiIndexField |f_$2| |i_$10|)) |i_$10|) (= (MultiIndexField_Inverse0$BoxType$ (MultiIndexField |f_$2| |i_$10|)) |f_$2|))  :pattern ( (MultiIndexField |f_$2| |i_$10|)))) :named ax_122))
   (assert (! (forall( (|f_$4| Field$Bool$) (|r_$5| ref) (|H_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$5| |f_$4|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$1| |r_$5| |f_$4|))) :named ax_123))
   (assert (! (forall( (|f_$5| Field$ref$) (|r_$6| ref) (|H_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$2| |r_$6| |f_$5|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$2| |r_$6| |f_$5|))) :named ax_124))
   (assert (! (forall( (|f_$6| Field$BoxType$) (|r_$7| ref) (|H_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$3| |r_$7| |f_$6|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$3| |r_$7| |f_$6|))) :named ax_125))
   (assert (! (forall( (|f_$7| Field$$@Map@@BoxType@To@Bool@@$) (|r_$8| ref) (|H_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$4| |r_$8| |f_$7|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$4| |r_$8| |f_$7|))) :named ax_126))
   (assert (! (forall( (|f_$8| Field$Seq$BoxType$$) (|r_$9| ref) (|H_$5| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$5| |r_$9| |f_$8|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$5| |r_$9| |f_$8|))) :named ax_127))
   (assert (! (forall( (|h_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d_$0| BoxType))(!(=> ($HeapSucc |h_$0| |k_$0|) (=> (GenericAlloc |d_$0| |h_$0|) (GenericAlloc |d_$0| |k_$0|)))  :pattern ( ($HeapSucc |h_$0| |k_$0|) (GenericAlloc |d_$0| |h_$0|)) :pattern ( ($HeapSucc |h_$0| |k_$0|) (GenericAlloc |d_$0| |k_$0|)))) :named ax_128))
   (assert (! (forall( (|h_$8_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$4_$0| ref) (|f_$3_$0| Field$Bool$) (|x_$10_$0| Bool))(!($HeapSucc |h_$8_$0| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$8_$0| |r_$4_$0| |f_$3_$0| |x_$10_$0|))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$8_$0| |r_$4_$0| |f_$3_$0| |x_$10_$0|)))) :named ax_129))
   (assert (! (forall( (|h_$8_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$4_$1| ref) (|f_$3_$1| Field$ref$) (|x_$10_$1| ref))(!($HeapSucc |h_$8_$1| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$8_$1| |r_$4_$1| |f_$3_$1| |x_$10_$1|))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |h_$8_$1| |r_$4_$1| |f_$3_$1| |x_$10_$1|)))) :named ax_130))
   (assert (! (forall( (|h_$8_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$4_$2| ref) (|f_$3_$2| Field$BoxType$) (|x_$10_$2| BoxType))(!($HeapSucc |h_$8_$2| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$8_$2| |r_$4_$2| |f_$3_$2| |x_$10_$2|))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |h_$8_$2| |r_$4_$2| |f_$3_$2| |x_$10_$2|)))) :named ax_131))
   (assert (! (forall( (|h_$8_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$4_$3| ref) (|f_$3_$3| Field$$@Map@@BoxType@To@Bool@@$) (|x_$10_$3| $@Map@@BoxType@To@Bool@@))(!($HeapSucc |h_$8_$3| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |h_$8_$3| |r_$4_$3| |f_$3_$3| |x_$10_$3|))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |h_$8_$3| |r_$4_$3| |f_$3_$3| |x_$10_$3|)))) :named ax_132))
   (assert (! (forall( (|h_$8_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|r_$4_$4| ref) (|f_$3_$4| Field$Seq$BoxType$$) (|x_$10_$4| Seq$BoxType$))(!($HeapSucc |h_$8_$4| (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |h_$8_$4| |r_$4_$4| |f_$3_$4| |x_$10_$4|))  :pattern ( (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |h_$8_$4| |r_$4_$4| |f_$3_$4| |x_$10_$4|)))) :named ax_133))
   (assert (! (forall( (|h_$9| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> ($HeapSucc |h_$9| |k_$1|) (forall( (|o_$8| ref))(!(=> (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$9| |o_$8| alloc) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$8| alloc))  :pattern ( (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |k_$1| |o_$8| alloc)))))  :pattern ( ($HeapSucc |h_$9| |k_$1|)))) :named ax_134))
   (assert (! (forall( (|h| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|k| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@) (|d| DatatypeType))(!(=> ($HeapSucc |h| |k|) (=> (DtAlloc |d| |h|) (DtAlloc |d| |k|)))  :pattern ( ($HeapSucc |h| |k|) (DtAlloc |d| |h|)) :pattern ( ($HeapSucc |h| |k|) (DtAlloc |d| |k|)))) :named ax_135))
   (assert (! (forall( (|i#0_$2| Int))(=> (and (< |i#0_$2| (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys))) (<= 0 |i#0_$2|)) (and (and (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Values) |i#0_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)) Node.val)) (and (and (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) |i#0_$2|) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)) Node.key)) (and (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap this Map.Repr) ($Box$ref$ ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)))) (not (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)))))) (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) (+ |i#0_$2| 1)) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ $Heap ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)) Node.key))))) (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) (+ |i#0_$2| 1))) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.nodes) |i#0_$2|)) Node.next))))) :named ax_136))
   (assert (! (forall( (|i_$7| Int))(!(= (FDim$BoxType$ (IndexField |i_$7|)) 1)  :pattern ( (IndexField |i_$7|)))) :named ax_137))
   (assert (! (forall( (|o_$10| BoxType))(!(not (MapRead$$@Map@@BoxType@To@Bool@@$ Set@Empty$BoxType$ |o_$10|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ Set@Empty$BoxType$ |o_$10|)))) :named ax_138))
   (assert (! (forall( (|o_$9| ref))(<= 0 (array.Length |o_$9|))) :named ax_139))
   (assert (! (forall( (|r_$1_$0| BoxType))(!(MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$1_$0|) |r_$1_$0|)  :pattern ( (Set@Singleton$BoxType$ |r_$1_$0|)))) :named ax_140))
   (assert (! (forall( (|r_$2_$0| BoxType) (|o_$0_$0| BoxType))(!(= (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$2_$0|) |o_$0_$0|) (= |r_$2_$0| |o_$0_$0|))  :pattern ( (MapRead$$@Map@@BoxType@To@Bool@@$ (Set@Singleton$BoxType$ |r_$2_$0|) |o_$0_$0|)))) :named ax_141))
   (assert (! (forall( (|r_$3| ref) (|h_$7| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(=> (and (or (= |r_$3| null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |h_$7| |r_$3| alloc)) ($IsGoodHeap |h_$7|)) (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|))  :pattern ( (GenericAlloc ($Box$ref$ |r_$3|) |h_$7|)))) :named ax_142))
   (assert (! (forall( (|s_$0_$0| Seq$ref$))(!(=> (= (Seq@Length$ref$ |s_$0_$0|) 0) (= |s_$0_$0| Seq@Empty$ref$))  :pattern ( (Seq@Length$ref$ |s_$0_$0|)))) :named ax_143))
   (assert (! (forall( (|s_$0_$1| Seq$BoxType$))(!(=> (= (Seq@Length$BoxType$ |s_$0_$1|) 0) (= |s_$0_$1| Seq@Empty$BoxType$))  :pattern ( (Seq@Length$BoxType$ |s_$0_$1|)))) :named ax_144))
   (assert (! (forall( (|s_$1_$0| Seq$ref$) (|i_$12| Int) (|v_$0_$0| ref) (|len_$2| Int))(!(=> (<= 0 |len_$2|) (= (Seq@Length$ref$ (Seq@Build$ref$ |s_$1_$0| |i_$12| |v_$0_$0| |len_$2|)) |len_$2|))  :pattern ( (Seq@Length$ref$ (Seq@Build$ref$ |s_$1_$0| |i_$12| |v_$0_$0| |len_$2|))))) :named ax_145))
   (assert (! (forall( (|s_$1_$1| Seq$BoxType$) (|i_$13| Int) (|v_$0_$1| BoxType) (|len_$3| Int))(!(=> (<= 0 |len_$3|) (= (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$1_$1| |i_$13| |v_$0_$1| |len_$3|)) |len_$3|))  :pattern ( (Seq@Length$BoxType$ (Seq@Build$BoxType$ |s_$1_$1| |i_$13| |v_$0_$1| |len_$3|))))) :named ax_146))
   (assert (! (forall( (|s_$10_$0| Seq$ref$) (|n_$6_$0| Int) (|j_$2_$0| Int))(!(=> (and (< |j_$2_$0| (Seq@Length$ref$ |s_$10_$0|)) (and (< |j_$2_$0| |n_$6_$0|) (<= 0 |j_$2_$0|))) (= (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|) (Seq@Index$ref$ |s_$10_$0| |j_$2_$0|)))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Take$ref$ |s_$10_$0| |n_$6_$0|) |j_$2_$0|)))) :named ax_147))
   (assert (! (forall( (|s_$10_$1| Seq$BoxType$) (|n_$6_$1| Int) (|j_$2_$1| Int))(!(=> (and (< |j_$2_$1| (Seq@Length$BoxType$ |s_$10_$1|)) (and (< |j_$2_$1| |n_$6_$1|) (<= 0 |j_$2_$1|))) (= (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|) (Seq@Index$BoxType$ |s_$10_$1| |j_$2_$1|)))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Take$BoxType$ |s_$10_$1| |n_$6_$1|) |j_$2_$1|)))) :named ax_148))
   (assert (! (forall( (|s_$11_$0| Seq$ref$) (|n_$7_$0| Int))(!(=> (<= 0 |n_$7_$0|) (and (=> (< (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) 0)) (=> (<= |n_$7_$0| (Seq@Length$ref$ |s_$11_$0|)) (= (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|)) (- (Seq@Length$ref$ |s_$11_$0|) |n_$7_$0|)))))  :pattern ( (Seq@Length$ref$ (Seq@Drop$ref$ |s_$11_$0| |n_$7_$0|))))) :named ax_149))
   (assert (! (forall( (|s_$11_$1| Seq$BoxType$) (|n_$7_$1| Int))(!(=> (<= 0 |n_$7_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) 0)) (=> (<= |n_$7_$1| (Seq@Length$BoxType$ |s_$11_$1|)) (= (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|)) (- (Seq@Length$BoxType$ |s_$11_$1|) |n_$7_$1|)))))  :pattern ( (Seq@Length$BoxType$ (Seq@Drop$BoxType$ |s_$11_$1| |n_$7_$1|))))) :named ax_150))
   (assert (! (forall( (|s_$12_$0| Seq$ref$) (|n_$8_$0| Int) (|j_$3_$0| Int))(!(=> (and (< |j_$3_$0| (- (Seq@Length$ref$ |s_$12_$0|) |n_$8_$0|)) (and (<= 0 |n_$8_$0|) (<= 0 |j_$3_$0|))) (= (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|) (Seq@Index$ref$ |s_$12_$0| (+ |j_$3_$0| |n_$8_$0|))))  :weight  25 :pattern ( (Seq@Index$ref$ (Seq@Drop$ref$ |s_$12_$0| |n_$8_$0|) |j_$3_$0|)))) :named ax_151))
   (assert (! (forall( (|s_$12_$1| Seq$BoxType$) (|n_$8_$1| Int) (|j_$3_$1| Int))(!(=> (and (< |j_$3_$1| (- (Seq@Length$BoxType$ |s_$12_$1|) |n_$8_$1|)) (and (<= 0 |n_$8_$1|) (<= 0 |j_$3_$1|))) (= (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|) (Seq@Index$BoxType$ |s_$12_$1| (+ |j_$3_$1| |n_$8_$1|))))  :weight  25 :pattern ( (Seq@Index$BoxType$ (Seq@Drop$BoxType$ |s_$12_$1| |n_$8_$1|) |j_$3_$1|)))) :named ax_152))
   (assert (! (forall( (|s_$13_$0| Seq$ref$) (|t_$1_$0| Seq$ref$))(!(and (= |t_$1_$0| (Seq@Drop$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|))) (= (Seq@Take$ref$ (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|) (Seq@Length$ref$ |s_$13_$0|)) |s_$13_$0|))  :pattern ( (Seq@Append$ref$ |s_$13_$0| |t_$1_$0|)))) :named ax_153))
   (assert (! (forall( (|s_$13_$1| Seq$BoxType$) (|t_$1_$1| Seq$BoxType$))(!(and (= |t_$1_$1| (Seq@Drop$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|))) (= (Seq@Take$BoxType$ (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|) (Seq@Length$BoxType$ |s_$13_$1|)) |s_$13_$1|))  :pattern ( (Seq@Append$BoxType$ |s_$13_$1| |t_$1_$1|)))) :named ax_154))
   (assert (! (forall( (|s_$14| Seq$ref$))(!(<= 0 (Seq@Length$ref$ |s_$14|))  :pattern ( (Seq@Length$ref$ |s_$14|)))) :named ax_155))
   (assert (! (forall( (|s_$15| Seq$BoxType$))(!(<= 0 (Seq@Length$BoxType$ |s_$15|))  :pattern ( (Seq@Length$BoxType$ |s_$15|)))) :named ax_156))
   (assert (! (forall( (|s_$2_$0| Seq$ref$) (|i_$0_$0| Int) (|v_$1_$0| ref) (|len_$0_$0| Int) (|n_$0_$0| Int))(!(=> (and (< |n_$0_$0| |len_$0_$0|) (<= 0 |n_$0_$0|)) (and (=> (= |n_$0_$0| |i_$0_$0|) (= |v_$1_$0| (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|))) (=> (not (= |n_$0_$0| |i_$0_$0|)) (= (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|) (Seq@Index$ref$ |s_$2_$0| |n_$0_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Build$ref$ |s_$2_$0| |i_$0_$0| |v_$1_$0| |len_$0_$0|) |n_$0_$0|)))) :named ax_157))
   (assert (! (forall( (|s_$2_$1| Seq$BoxType$) (|i_$0_$1| Int) (|v_$1_$1| BoxType) (|len_$0_$1| Int) (|n_$0_$1| Int))(!(=> (and (< |n_$0_$1| |len_$0_$1|) (<= 0 |n_$0_$1|)) (and (=> (= |n_$0_$1| |i_$0_$1|) (= |v_$1_$1| (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|))) (=> (not (= |n_$0_$1| |i_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|) (Seq@Index$BoxType$ |s_$2_$1| |n_$0_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Build$BoxType$ |s_$2_$1| |i_$0_$1| |v_$1_$1| |len_$0_$1|) |n_$0_$1|)))) :named ax_158))
   (assert (! (forall( (|s_$3_$0| Seq$ref$) (|i_$1_$0| Int) (|v_$2_$0| ref))(!(=> (and (< |i_$1_$0| (Seq@Length$ref$ |s_$3_$0|)) (<= 0 |i_$1_$0|)) (= (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|)) (Seq@Length$ref$ |s_$3_$0|)))  :pattern ( (Seq@Length$ref$ (Seq@Update$ref$ |s_$3_$0| |i_$1_$0| |v_$2_$0|))))) :named ax_159))
   (assert (! (forall( (|s_$3_$1| Seq$BoxType$) (|i_$1_$1| Int) (|v_$2_$1| BoxType))(!(=> (and (< |i_$1_$1| (Seq@Length$BoxType$ |s_$3_$1|)) (<= 0 |i_$1_$1|)) (= (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|)) (Seq@Length$BoxType$ |s_$3_$1|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Update$BoxType$ |s_$3_$1| |i_$1_$1| |v_$2_$1|))))) :named ax_160))
   (assert (! (forall( (|s_$4_$0| Seq$ref$) (|i_$2_$0| Int) (|v_$3_$0| ref) (|n_$1_$0| Int))(!(=> (and (< |n_$1_$0| (Seq@Length$ref$ |s_$4_$0|)) (<= 0 |n_$1_$0|)) (and (=> (= |n_$1_$0| |i_$2_$0|) (= |v_$3_$0| (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|))) (=> (not (= |n_$1_$0| |i_$2_$0|)) (= (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|) (Seq@Index$ref$ |s_$4_$0| |n_$1_$0|)))))  :pattern ( (Seq@Index$ref$ (Seq@Update$ref$ |s_$4_$0| |i_$2_$0| |v_$3_$0|) |n_$1_$0|)))) :named ax_161))
   (assert (! (forall( (|s_$4_$1| Seq$BoxType$) (|i_$2_$1| Int) (|v_$3_$1| BoxType) (|n_$1_$1| Int))(!(=> (and (< |n_$1_$1| (Seq@Length$BoxType$ |s_$4_$1|)) (<= 0 |n_$1_$1|)) (and (=> (= |n_$1_$1| |i_$2_$1|) (= |v_$3_$1| (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|))) (=> (not (= |n_$1_$1| |i_$2_$1|)) (= (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|) (Seq@Index$BoxType$ |s_$4_$1| |n_$1_$1|)))))  :pattern ( (Seq@Index$BoxType$ (Seq@Update$BoxType$ |s_$4_$1| |i_$2_$1| |v_$3_$1|) |n_$1_$1|)))) :named ax_162))
   (assert (! (forall( (|s_$5_$0| Seq$ref$) (|x_$2_$0| ref))(!(= (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|) (exists( (|i_$3_$1| Int))(!(and (= |x_$2_$0| (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)) (and (< |i_$3_$1| (Seq@Length$ref$ |s_$5_$0|)) (<= 0 |i_$3_$1|)))  :pattern ( (Seq@Index$ref$ |s_$5_$0| |i_$3_$1|)))))  :pattern ( (Seq@Contains$ref$ |s_$5_$0| |x_$2_$0|)))) :named ax_163))
   (assert (! (forall( (|s_$5_$1| Seq$BoxType$) (|x_$2_$1| BoxType))(!(= (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|) (exists( (|i_$3_$3| Int))(!(and (= |x_$2_$1| (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)) (and (< |i_$3_$3| (Seq@Length$BoxType$ |s_$5_$1|)) (<= 0 |i_$3_$3|)))  :pattern ( (Seq@Index$BoxType$ |s_$5_$1| |i_$3_$3|)))))  :pattern ( (Seq@Contains$BoxType$ |s_$5_$1| |x_$2_$1|)))) :named ax_164))
   (assert (! (forall( (|s_$6_$0| Seq$ref$) (|i_$4_$0| Int) (|v_$4_$0| ref) (|len_$1_$0| Int) (|x_$5_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Build$ref$ |s_$6_$0| |i_$4_$0| |v_$4_$0| |len_$1_$0|) |x_$5_$0|) (or (and (= |x_$5_$0| |v_$4_$0|) (and (< |i_$4_$0| |len_$1_$0|) (<= 0 |i_$4_$0|))) (exists( (|j_$5| Int))(!(and (= |x_$5_$0| (Seq@Index$ref$ |s_$6_$0| |j_$5|)) (and (and (< |j_$5| |len_$1_$0|) (and (< |j_$5| (Seq@Length$ref$ |s_$6_$0|)) (<= 0 |j_$5|))) (not (= |j_$5| |i_$4_$0|))))  :pattern ( (Seq@Index$ref$ |s_$6_$0| |j_$5|))))))  :pattern ( (Seq@Contains$ref$ (Seq@Build$ref$ |s_$6_$0| |i_$4_$0| |v_$4_$0| |len_$1_$0|) |x_$5_$0|)))) :named ax_165))
   (assert (! (forall( (|s_$6_$1| Seq$BoxType$) (|i_$4_$1| Int) (|v_$4_$1| BoxType) (|len_$1_$1| Int) (|x_$5_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$6_$1| |i_$4_$1| |v_$4_$1| |len_$1_$1|) |x_$5_$1|) (or (and (= |x_$5_$1| |v_$4_$1|) (and (< |i_$4_$1| |len_$1_$1|) (<= 0 |i_$4_$1|))) (exists( (|j_$7| Int))(!(and (= |x_$5_$1| (Seq@Index$BoxType$ |s_$6_$1| |j_$7|)) (and (and (< |j_$7| |len_$1_$1|) (and (< |j_$7| (Seq@Length$BoxType$ |s_$6_$1|)) (<= 0 |j_$7|))) (not (= |j_$7| |i_$4_$1|))))  :pattern ( (Seq@Index$BoxType$ |s_$6_$1| |j_$7|))))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Build$BoxType$ |s_$6_$1| |i_$4_$1| |v_$4_$1| |len_$1_$1|) |x_$5_$1|)))) :named ax_166))
   (assert (! (forall( (|s_$7_$0| Seq$ref$) (|n_$2_$0| Int) (|x_$6_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Take$ref$ |s_$7_$0| |n_$2_$0|) |x_$6_$0|) (exists( (|i_$5_$1| Int))(!(and (= |x_$6_$0| (Seq@Index$ref$ |s_$7_$0| |i_$5_$1|)) (and (< |i_$5_$1| (Seq@Length$ref$ |s_$7_$0|)) (and (< |i_$5_$1| |n_$2_$0|) (<= 0 |i_$5_$1|))))  :pattern ( (Seq@Index$ref$ |s_$7_$0| |i_$5_$1|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Take$ref$ |s_$7_$0| |n_$2_$0|) |x_$6_$0|)))) :named ax_167))
   (assert (! (forall( (|s_$7_$1| Seq$BoxType$) (|n_$2_$1| Int) (|x_$6_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$7_$1| |n_$2_$1|) |x_$6_$1|) (exists( (|i_$5_$3| Int))(!(and (= |x_$6_$1| (Seq@Index$BoxType$ |s_$7_$1| |i_$5_$3|)) (and (< |i_$5_$3| (Seq@Length$BoxType$ |s_$7_$1|)) (and (< |i_$5_$3| |n_$2_$1|) (<= 0 |i_$5_$3|))))  :pattern ( (Seq@Index$BoxType$ |s_$7_$1| |i_$5_$3|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Take$BoxType$ |s_$7_$1| |n_$2_$1|) |x_$6_$1|)))) :named ax_168))
   (assert (! (forall( (|s_$8_$0| Seq$ref$) (|n_$3_$0| Int) (|x_$7_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$8_$0| |n_$3_$0|) |x_$7_$0|) (exists( (|i_$6_$1| Int))(!(and (= |x_$7_$0| (Seq@Index$ref$ |s_$8_$0| |i_$6_$1|)) (and (< |i_$6_$1| (Seq@Length$ref$ |s_$8_$0|)) (and (<= |n_$3_$0| |i_$6_$1|) (<= 0 |n_$3_$0|))))  :pattern ( (Seq@Index$ref$ |s_$8_$0| |i_$6_$1|)))))  :pattern ( (Seq@Contains$ref$ (Seq@Drop$ref$ |s_$8_$0| |n_$3_$0|) |x_$7_$0|)))) :named ax_169))
   (assert (! (forall( (|s_$8_$1| Seq$BoxType$) (|n_$3_$1| Int) (|x_$7_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$8_$1| |n_$3_$1|) |x_$7_$1|) (exists( (|i_$6_$3| Int))(!(and (= |x_$7_$1| (Seq@Index$BoxType$ |s_$8_$1| |i_$6_$3|)) (and (< |i_$6_$3| (Seq@Length$BoxType$ |s_$8_$1|)) (and (<= |n_$3_$1| |i_$6_$3|) (<= 0 |n_$3_$1|))))  :pattern ( (Seq@Index$BoxType$ |s_$8_$1| |i_$6_$3|)))))  :pattern ( (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ |s_$8_$1| |n_$3_$1|) |x_$7_$1|)))) :named ax_170))
   (assert (! (forall( (|s_$9_$0| Seq$ref$) (|n_$5_$0| Int))(!(=> (<= 0 |n_$5_$0|) (and (=> (< (Seq@Length$ref$ |s_$9_$0|) |n_$5_$0|) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) (Seq@Length$ref$ |s_$9_$0|))) (=> (<= |n_$5_$0| (Seq@Length$ref$ |s_$9_$0|)) (= (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|)) |n_$5_$0|))))  :pattern ( (Seq@Length$ref$ (Seq@Take$ref$ |s_$9_$0| |n_$5_$0|))))) :named ax_171))
   (assert (! (forall( (|s_$9_$1| Seq$BoxType$) (|n_$5_$1| Int))(!(=> (<= 0 |n_$5_$1|) (and (=> (< (Seq@Length$BoxType$ |s_$9_$1|) |n_$5_$1|) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) (Seq@Length$BoxType$ |s_$9_$1|))) (=> (<= |n_$5_$1| (Seq@Length$BoxType$ |s_$9_$1|)) (= (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|)) |n_$5_$1|))))  :pattern ( (Seq@Length$BoxType$ (Seq@Take$BoxType$ |s_$9_$1| |n_$5_$1|))))) :named ax_172))
   (assert (! (forall( (|s0_$0_$0| Seq$ref$) (|s1_$0_$0| Seq$ref$) (|n_$9| Int))(!(and (=> (<= (Seq@Length$ref$ |s0_$0_$0|) |n_$9|) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s1_$0_$0| (- |n_$9| (Seq@Length$ref$ |s0_$0_$0|))))) (=> (< |n_$9| (Seq@Length$ref$ |s0_$0_$0|)) (= (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|) (Seq@Index$ref$ |s0_$0_$0| |n_$9|))))  :pattern ( (Seq@Index$ref$ (Seq@Append$ref$ |s0_$0_$0| |s1_$0_$0|) |n_$9|)))) :named ax_173))
   (assert (! (forall( (|s0_$0_$1| Seq$BoxType$) (|s1_$0_$1| Seq$BoxType$) (|n_$10| Int))(!(and (=> (<= (Seq@Length$BoxType$ |s0_$0_$1|) |n_$10|) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s1_$0_$1| (- |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|))))) (=> (< |n_$10| (Seq@Length$BoxType$ |s0_$0_$1|)) (= (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|) (Seq@Index$BoxType$ |s0_$0_$1| |n_$10|))))  :pattern ( (Seq@Index$BoxType$ (Seq@Append$BoxType$ |s0_$0_$1| |s1_$0_$1|) |n_$10|)))) :named ax_174))
   (assert (! (forall( (|s0_$1_$0| Seq$ref$) (|s1_$1_$0| Seq$ref$) (|x_$4_$0| ref))(!(= (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|) (or (Seq@Contains$ref$ |s1_$1_$0| |x_$4_$0|) (Seq@Contains$ref$ |s0_$1_$0| |x_$4_$0|)))  :pattern ( (Seq@Contains$ref$ (Seq@Append$ref$ |s0_$1_$0| |s1_$1_$0|) |x_$4_$0|)))) :named ax_175))
   (assert (! (forall( (|s0_$1_$1| Seq$BoxType$) (|s1_$1_$1| Seq$BoxType$) (|x_$4_$1| BoxType))(!(= (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|) (or (Seq@Contains$BoxType$ |s1_$1_$1| |x_$4_$1|) (Seq@Contains$BoxType$ |s0_$1_$1| |x_$4_$1|)))  :pattern ( (Seq@Contains$BoxType$ (Seq@Append$BoxType$ |s0_$1_$1| |s1_$1_$1|) |x_$4_$1|)))) :named ax_176))
   (assert (! (forall( (|s0_$2_$0| Seq$ref$) (|s1_$2_$0| Seq$ref$))(!(= (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|) (and (= (Seq@Length$ref$ |s1_$2_$0|) (Seq@Length$ref$ |s0_$2_$0|)) (forall( (|j_$0_$1| Int))(!(=> (and (< |j_$0_$1| (Seq@Length$ref$ |s0_$2_$0|)) (<= 0 |j_$0_$1|)) (= (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|) (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)))  :pattern ( (Seq@Index$ref$ |s0_$2_$0| |j_$0_$1|)) :pattern ( (Seq@Index$ref$ |s1_$2_$0| |j_$0_$1|))))))  :pattern ( (Seq@Equal$ref$ |s0_$2_$0| |s1_$2_$0|)))) :named ax_177))
   ...
   (assert (! (forall( (|s0_$4| Seq$ref$) (|s1_$4| Seq$ref$))(!(= (Seq@Length$ref$ (Seq@Append$ref$ |s0_$4| |s1_$4|)) (+ (Seq@Length$ref$ |s0_$4|) (Seq@Length$ref$ |s1_$4|)))  :pattern ( (Seq@Length$ref$ (Seq@Append$ref$ |s0_$4| |s1_$4|))))) :named ax_179))
   (assert (! (forall( (|s0_$5| Seq$BoxType$) (|s1_$5| Seq$BoxType$))(!(= (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$5| |s1_$5|)) (+ (Seq@Length$BoxType$ |s0_$5|) (Seq@Length$BoxType$ |s1_$5|)))  :pattern ( (Seq@Length$BoxType$ (Seq@Append$BoxType$ |s0_$5| |s1_$5|))))) :named ax_180))
   (assert (! (forall( (|t_$0_$0| ref))(!(= |t_$0_$0| (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0))  :pattern ( (Seq@Index$ref$ (Seq@Singleton$ref$ |t_$0_$0|) 0)))) :named ax_181))
   (assert (! (forall( (|t_$0_$1| BoxType))(!(= |t_$0_$1| (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0))  :pattern ( (Seq@Index$BoxType$ (Seq@Singleton$BoxType$ |t_$0_$1|) 0)))) :named ax_182))
   (assert (! (forall( (|t_$3| ref))(!(= (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|)) 1)  :pattern ( (Seq@Length$ref$ (Seq@Singleton$ref$ |t_$3|))))) :named ax_183))
   (assert (! (forall( (|t_$4| BoxType))(!(= (Seq@Length$BoxType$ (Seq@Singleton$BoxType$ |t_$4|)) 1)  :pattern ( (Seq@Length$BoxType$ (Seq@Singleton$BoxType$ |t_$4|))))) :named ax_184))
   (assert (! (forall( (|v_$5| Bool) (|f_$0_$0| Field$Bool$) (|r_$0_$0| ref) (|H_$0_$0| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$5|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ |H_$0_$0| |r_$0_$0| |f_$0_$0| |v_$5|))) :named ax_185))
   (assert (! (forall( (|v_$6| ref) (|f_$0_$1| Field$ref$) (|r_$0_$1| ref) (|H_$0_$1| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$6|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ |H_$0_$1| |r_$0_$1| |f_$0_$1| |v_$6|))) :named ax_186))
   (assert (! (forall( (|v_$7| BoxType) (|f_$0_$2| Field$BoxType$) (|r_$0_$2| ref) (|H_$0_$2| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$7|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$BoxType$ |H_$0_$2| |r_$0_$2| |f_$0_$2| |v_$7|))) :named ax_187))
   (assert (! (forall( (|v_$8| $@Map@@BoxType@To@Bool@@) (|f_$0_$3| Field$$@Map@@BoxType@To@Bool@@$) (|r_$0_$3| ref) (|H_$0_$3| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$0_$3| |r_$0_$3| |f_$0_$3| |v_$8|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ |H_$0_$3| |r_$0_$3| |f_$0_$3| |v_$8|))) :named ax_188))
   (assert (! (forall( (|v_$9| Seq$BoxType$) (|f_$0_$4| Field$Seq$BoxType$$) (|r_$0_$4| ref) (|H_$0_$4| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$0_$4| |r_$0_$4| |f_$0_$4| |v_$9|) (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ |H_$0_$4| |r_$0_$4| |f_$0_$4| |v_$9|))) :named ax_189))
   (assert (! (forall( (|x_$11| Int) (|y_$3| Int))(!(= (mod |x_$11| |y_$3|) (- |x_$11| (* (div |x_$11| |y_$3|) |y_$3|)))  :pattern ( (mod |x_$11| |y_$3|)) :pattern ( (div |x_$11| |y_$3|)))) :named ax_190))
   (assert (! (forall( (|x_$12| Int) (|y_$4| Int))(!(=> (< 0 |y_$4|) (and (<= 0 (mod |x_$12| |y_$4|)) (< (mod |x_$12| |y_$4|) |y_$4|)))  :pattern ( (mod |x_$12| |y_$4|)))) :named ax_191))
   (assert (! (forall( (|x_$13| Int) (|y_$5| Int))(!(=> (< |y_$5| 0) (and (< |y_$5| (mod |x_$13| |y_$5|)) (<= (mod |x_$13| |y_$5|) 0)))  :pattern ( (mod |x_$13| |y_$5|)))) :named ax_192))
   (assert (! (forall( (|x_$3| ref))(!(not (Seq@Contains$ref$ Seq@Empty$ref$ |x_$3|))  :pattern ( (Seq@Contains$ref$ Seq@Empty$ref$ |x_$3|)))) :named ax_193))
   (assert (! (forall( (|x_$8_$0| Bool))(!(= |x_$8_$0| ($Unbox$Bool$ ($Box$Bool$ |x_$8_$0|)))  :pattern ( ($Box$Bool$ |x_$8_$0|)))) :named ax_194))
   (assert (! (forall( (|x_$8_$1| TickType))(!(= |x_$8_$1| ($Unbox$TickType$ ($Box$TickType$ |x_$8_$1|)))  :pattern ( ($Box$TickType$ |x_$8_$1|)))) :named ax_195))
   (assert (! (forall( (|x_$8_$10| Field$BoxType$))(!(= |x_$8_$10| ($Unbox$Field$BoxType$$ ($Box$Field$BoxType$$ |x_$8_$10|)))  :pattern ( ($Box$Field$BoxType$$ |x_$8_$10|)))) :named ax_196))
   (assert (! (forall( (|x_$8_$11| Field$Bool$))(!(= |x_$8_$11| ($Unbox$Field$Bool$$ ($Box$Field$Bool$$ |x_$8_$11|)))  :pattern ( ($Box$Field$Bool$$ |x_$8_$11|)))) :named ax_197))
   (assert (! (forall( (|x_$8_$12| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(!(= |x_$8_$12| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ |x_$8_$12|)))) :named ax_198))
   (assert (! (forall( (|x_$8_$13| Field$Seq$BoxType$$))(!(= |x_$8_$13| ($Unbox$Field$Seq$BoxType$$$ ($Box$Field$Seq$BoxType$$$ |x_$8_$13|)))  :pattern ( ($Box$Field$Seq$BoxType$$$ |x_$8_$13|)))) :named ax_199))
   (assert (! (forall( (|x_$8_$14| Field$$@Map@@BoxType@To@Bool@@$))(!(= |x_$8_$14| ($Unbox$Field$$@Map@@BoxType@To@Bool@@$$ ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|)))  :pattern ( ($Box$Field$$@Map@@BoxType@To@Bool@@$$ |x_$8_$14|)))) :named ax_200))
   (assert (! (forall( (|x_$8_$15| Field$ref$))(!(= |x_$8_$15| ($Unbox$Field$ref$$ ($Box$Field$ref$$ |x_$8_$15|)))  :pattern ( ($Box$Field$ref$$ |x_$8_$15|)))) :named ax_201))
   (assert (! (forall( (|x_$8_$16| $@Map@@$T0@@ref@Field$$T0$@To@Bool@@))(!(= |x_$8_$16| ($Unbox$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|)))  :pattern ( ($Box$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ |x_$8_$16|)))) :named ax_202))
   (assert (! (forall( (|x_$8_$2| Int))(!(= |x_$8_$2| ($Unbox$Int$ ($Box$Int$ |x_$8_$2|)))  :pattern ( ($Box$Int$ |x_$8_$2|)))) :named ax_203))
   (assert (! (forall( (|x_$8_$3| Seq$ref$))(!(= |x_$8_$3| ($Unbox$Seq$ref$$ ($Box$Seq$ref$$ |x_$8_$3|)))  :pattern ( ($Box$Seq$ref$$ |x_$8_$3|)))) :named ax_204))
   (assert (! (forall( (|x_$8_$4| ref))(!(= |x_$8_$4| ($Unbox$ref$ ($Box$ref$ |x_$8_$4|)))  :pattern ( ($Box$ref$ |x_$8_$4|)))) :named ax_205))
   (assert (! (forall( (|x_$8_$5| BoxType))(!(= |x_$8_$5| ($Unbox$BoxType$ ($Box$BoxType$ |x_$8_$5|)))  :pattern ( ($Box$BoxType$ |x_$8_$5|)))) :named ax_206))
   (assert (! (forall( (|x_$8_$6| $@Map@@BoxType@To@Bool@@))(!(= |x_$8_$6| ($Unbox$$@Map@@BoxType@To@Bool@@$ ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|)))  :pattern ( ($Box$$@Map@@BoxType@To@Bool@@$ |x_$8_$6|)))) :named ax_207))
   (assert (! (forall( (|x_$8_$7| Seq$BoxType$))(!(= |x_$8_$7| ($Unbox$Seq$BoxType$$ ($Box$Seq$BoxType$$ |x_$8_$7|)))  :pattern ( ($Box$Seq$BoxType$$ |x_$8_$7|)))) :named ax_208))
   (assert (! (forall( (|x_$8_$8| DatatypeType))(!(= |x_$8_$8| ($Unbox$DatatypeType$ ($Box$DatatypeType$ |x_$8_$8|)))  :pattern ( ($Box$DatatypeType$ |x_$8_$8|)))) :named ax_209))
   (assert (! (forall( (|x_$8_$9| ClassName))(!(= |x_$8_$9| ($Unbox$ClassName$ ($Box$ClassName$ |x_$8_$9|)))  :pattern ( ($Box$ClassName$ |x_$8_$9|)))) :named ax_210))
   (assert (! (forall( (|x_$9| Int) (|h_$6| $@Map@@$T0@@ref@Field$$T0$@To@$T0@@))(=> ($IsGoodHeap |h_$6|) (GenericAlloc ($Box$Int$ |x_$9|) |h_$6|))) :named ax_211))
   (assert (! (GenericAlloc key@16 $Heap) :named ax_212))
   (assert (! (Map.Valid $Heap this) :named ax_213))
   (assert (! (Map.Valid@canCall $Heap this) :named ax_214))
   (assert (! (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap this alloc) :named ax_215))
   (assert (! (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap this Map.Repr) ($Box$ref$ this)) :named ax_216))
   (assert (! (not ($Unbox$Bool$ ($Box$Bool$ false))) :named ax_217))
   (assert (! (not (= class.Map class.Node)) :named ax_218))
   (assert (! (not (= class.Node class.Map)) :named ax_219))
   (assert (! (not (= Map.Keys Map.nodes)) :named ax_220))
   (assert (! (not (= Map.Keys Map.Values)) :named ax_221))
   (assert (! (not (= Map.nodes Map.Keys)) :named ax_222))
   (assert (! (not (= Map.nodes Map.Values)) :named ax_223))
   (assert (! (not (= Map.Values Map.Keys)) :named ax_224))
   (assert (! (not (= Map.Values Map.nodes)) :named ax_225))
   (assert (! (not (= Node.next Map.head)) :named ax_226))
   (assert (! (not (= Node.val Node.key)) :named ax_227))
   (assert (! (not (= this null)) :named ax_228))
   (assert (! (or $NP@78 $NP@79 (= call4formal@p@24@0 null)) :named ax_229))
   (assert (! (or (< call5formal@n@25@0 (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys))) (= call4formal@p@24@0 null)) :named ax_230))
   (assert (! (or (= $rhs@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@0 alloc)) :named ax_231))
   (assert (! (or (= $rhs@2 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap $rhs@2 alloc)) :named ax_232))
   (assert (! (or (= ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) call5formal@n@25@0)) call4formal@p@24@0) (= call4formal@p@24@0 null)) :named ax_233))
   (assert (! (or (= (dtype $rhs@0) class.Node) (= $rhs@0 null)) :named ax_234))
   (assert (! (or (= (dtype $rhs@2) class.Node) (= $rhs@2 null)) :named ax_235))
   (assert (! (or (= (dtype call4formal@p@24@0) class.Node) (= call4formal@p@24@0 null)) :named ax_236))
   (assert (! (or (= (dtype call6formal@prev@26@0) class.Node) (= call6formal@prev@26@0 null)) :named ax_237))
   (assert (! (or (= (dtype p@20) class.Node) (= p@20 null)) :named ax_238))
   (assert (! (or (= (dtype prev@22) class.Node) (= prev@22 null)) :named ax_239))
   (assert (! (or (= (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16) (= call4formal@p@24@0 null)) :named ax_240))
   (assert (! (or (= call4formal@p@24@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call4formal@p@24@0 alloc)) :named ax_241))
   (assert (! (or (= call4formal@p@24@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call4formal@p@24@0 alloc)) :named ax_242))
   (assert (! (or (= call6formal@prev@26@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap call6formal@prev@26@0 alloc)) :named ax_243))
   (assert (! (or (= call6formal@prev@26@0 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap@0 call6formal@prev@26@0 alloc)) :named ax_244))
   (assert (! (or (= p@20 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap p@20 alloc)) :named ax_245))
   (assert (! (or (= prev@22 null) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Bool$ $Heap prev@22 alloc)) :named ax_246))
   (assert (! (or (not $NP@78) (= 0 call5formal@n@25@0)) :named ax_247))
   (assert (! (or (not $NP@78) (= call6formal@prev@26@0 null)) :named ax_248))
   (assert (! (or (not $NP@79) (< 0 call5formal@n@25@0)) :named ax_249))
   (assert (! (or (not $NP@79) (= call6formal@prev@26@0 ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))))) :named ax_250))
   (assert (! (or (not (< 0 call5formal@n@25@0)) (not (= call6formal@prev@26@0 ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (+ call5formal@n@25@0 (- 1)))))) $NP@79) :named ax_251))
   (assert (! (or (not (< call5formal@n@25@0 0)) (= call4formal@p@24@0 null)) :named ax_252))
   (assert (! (or (not (= 0 call5formal@n@25@0)) (not (= call6formal@prev@26@0 null)) $NP@78) :named ax_253))
   (assert (! (or (not (= call4formal@p@24@0 null)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) key@16))) :named ax_254))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Drop$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) (+ call5formal@n@25@0 1)) key@16)) (= call4formal@p@24@0 null)) :named ax_255))
   (assert (! (or (not (Seq@Contains$BoxType$ (Seq@Take$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys) call5formal@n@25@0) key@16)) (= call4formal@p@24@0 null)) :named ax_256))
...
(assert (! (=> anon5_Then@3 (and true 
   (and true
      ...
      (= $rhs@3@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@1 this Map.Keys))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 this Map.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@1 this Map.Repr))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 call4formal@p@24@0 Node.next) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 call4formal@p@24@0 Node.next))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 this Map.head) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@1 this Map.head))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.nodes) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@1 this Map.nodes))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Values) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@1 this Map.Values))
...
(assert (! (=> anon5_Then@6 (and true 
   (and true
      ...
      (= $rhs@4@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@2 this Map.Values))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 this Map.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@2 this Map.Repr))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 call4formal@p@24@0 Node.next) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 call4formal@p@24@0 Node.next))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 this Map.head) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@2 this Map.head))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@1 this Map.Keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@2 this Map.Keys))
...
(assert (! (=> anon5_Then@15 (and true 
   (and true
      ...
      (= $rhs@5@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.nodes))
      ...
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 this Map.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@3 this Map.Repr))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 call4formal@p@24@0 Node.next) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@3 call4formal@p@24@0 Node.next))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 this Map.head) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@3 this Map.head))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@2 this Map.Keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Keys))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@2 this Map.Values) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Values))
...
(assert (! (=> anon6_Else@2 (and true 
   (and true
      ...
      (= $rhs@7@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 call4formal@p@24@0 Node.next))
      (= $rhs@7@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@3 call4formal@p@24@0 Node.next))
      (= $rhs@7@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@0 this Map.Keys (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Keys)) call4formal@p@24@0 Node.next))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 this Map.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@5 this Map.Repr))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@0 this Map.head) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@5 this Map.head))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@5 this Map.Keys))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.nodes) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@5 this Map.nodes))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Values) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@5 this Map.Values))
      (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@Bool@@$ref$ $_Frame@0 call6formal@prev@26@0 Node.next)
   )
$join_2
...
(assert (! (=> anon6_Then@2 (and true 
   (and true
      ...
      (= $rhs@6@0 (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@4 this Map.head))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@0 this Map.Repr) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@4 this Map.Repr))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@4 this Map.Keys))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.nodes) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@4 this Map.nodes))
      (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@3 this Map.Values) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@4 this Map.Values))
...
(assert (! (=> GeneratedUnifiedExit@1 (and true 
   (and true
      (or (not (Map.Valid@canCall $Heap@6 this)) (Map.Valid $Heap@6 this) (MapRead$$@Map@@BoxType@To@Bool@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$$@Map@@BoxType@To@Bool@@$ $Heap@6 this Map.Repr) ($Box$ref$ this)))
   )
...
(assert (! (=> GeneratedUnifiedExit@2 (and true 
   (and true
      (or (not (Map.Valid@canCall $Heap@6 this)) (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Values)) (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Keys))) (Map.Valid $Heap@6 this))
   )
...
(assert (! (=> GeneratedUnifiedExit@3 (and true 
   (and true
      (or (not (Map.Valid@canCall $Heap@6 this)) (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.nodes)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Keys)) 1)) (Map.Valid $Heap@6 this))
   )
...
(assert (! (=> GeneratedUnifiedExit@4 (and true 
   (and true
      (or (not (Map.Valid@canCall $Heap@6 this)) (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ $Heap@6 this Map.head) ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.nodes) 0))) (Map.Valid $Heap@6 this))
   )
...
(assert (! (=> GeneratedUnifiedExit@6 (and true 
   (and true
      (or (not (Map.Valid@canCall $Heap@6 this)) (= null ($Unbox$ref$ (Seq@Index$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.nodes) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.nodes)) (- 1))))) (Map.Valid $Heap@6 this))
   )
...
(assert (! (=> GeneratedUnifiedExit@10 (and true 
   (and true
      (or (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) key@16) (Seq@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Keys) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)))
   )
...
(assert (! (=> GeneratedUnifiedExit@11 (and true 
   (and true
      (or (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) key@16) (Seq@Equal$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Values) (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Values)))
   )
...
(assert (! (=> GeneratedUnifiedExit@12 (and true 
   (and true
      (or (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) key@16)) (= (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Keys)) (+ (Seq@Length$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys)) (- 1))))
   )
...
(assert (! (=> GeneratedUnifiedExit@13 (and true 
   (and true
      (or (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap this Map.Keys) key@16)) (not (Seq@Contains$BoxType$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Seq$BoxType$$ $Heap@6 this Map.Keys) key@16)))
   )
