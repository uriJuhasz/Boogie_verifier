...
;Axioms
   ...
   (assert (! (NonPredicateField$Bool$ rdheld) :named ax_239))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.balanceFactor) :named ax_240))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.height) :named ax_241))
   (assert (! (NonPredicateField$Int$ AVLTreeNode.key) :named ax_242))
   (assert (! (NonPredicateField$Int$ forkK) :named ax_243))
   (assert (! (NonPredicateField$Int$ held) :named ax_244))
   (assert (! (NonPredicateField$Int$ joinable) :named ax_245))
   (assert (! (NonPredicateField$Mu$ mu) :named ax_246))
   (assert (! (NonPredicateField$ref$ AVLTree.root) :named ax_247))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.left) :named ax_248))
   (assert (! (NonPredicateField$ref$ AVLTreeNode.right) :named ax_249))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTree.keys) :named ax_250))
   (assert (! (NonPredicateField$Seq$Int$$ AVLTreeNode.keys) :named ax_251))
   (assert (! (not (= (Fractions 1) (* 1000 channelK))) :named ax_252))
   (assert (! (not (= (Fractions 1) (* 1000 methodK@_11))) :named ax_253))
   (assert (! (not (= 0 channelK)) :named ax_254))
   (assert (! (not (= 0 Permission$FullFraction)) :named ax_255))
   (assert (! (not (= AVLTree.root AVLTreeNode.right)) :named ax_256))
   (assert (! (not (= AVLTree.valid AVLTreeNode.height)) :named ax_257))
   (assert (! (not (= AVLTree.valid AVLTreeNode.key)) :named ax_258))
   (assert (! (not (= AVLTree.valid AVLTreeNode.valid)) :named ax_259))
   (assert (! (not (= AVLTree.valid forkK)) :named ax_260))
   (assert (! (not (= AVLTree.valid held)) :named ax_261))
   (assert (! (not (= AVLTree.valid joinable)) :named ax_262))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTree.valid)) :named ax_263))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.height)) :named ax_264))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.key)) :named ax_265))
   (assert (! (not (= AVLTreeNode.balanceFactor AVLTreeNode.valid)) :named ax_266))
   (assert (! (not (= AVLTreeNode.balanceFactor forkK)) :named ax_267))
   (assert (! (not (= AVLTreeNode.balanceFactor held)) :named ax_268))
   (assert (! (not (= AVLTreeNode.balanceFactor joinable)) :named ax_269))
   ...
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.key)) :named ax_272))
   (assert (! (not (= AVLTreeNode.height AVLTreeNode.valid)) :named ax_273))
   (assert (! (not (= AVLTreeNode.height forkK)) :named ax_274))
   (assert (! (not (= AVLTreeNode.height held)) :named ax_275))
   (assert (! (not (= AVLTreeNode.height joinable)) :named ax_276))
   (assert (! (not (= AVLTreeNode.key AVLTree.valid)) :named ax_277))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.balanceFactor)) :named ax_278))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.height)) :named ax_279))
   (assert (! (not (= AVLTreeNode.key AVLTreeNode.valid)) :named ax_280))
   (assert (! (not (= AVLTreeNode.key forkK)) :named ax_281))
   (assert (! (not (= AVLTreeNode.key held)) :named ax_282))
   (assert (! (not (= AVLTreeNode.key joinable)) :named ax_283))
   (assert (! (not (= AVLTreeNode.keys AVLTree.keys)) :named ax_284))
   (assert (! (not (= AVLTreeNode.left AVLTree.root)) :named ax_285))
   (assert (! (not (= AVLTreeNode.left AVLTreeNode.right)) :named ax_286))
   (assert (! (not (= AVLTreeNode.right AVLTree.root)) :named ax_287))
   (assert (! (not (= AVLTreeNode.right AVLTreeNode.left)) :named ax_288))
   (assert (! (not (= AVLTreeNode.valid AVLTree.valid)) :named ax_289))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.balanceFactor)) :named ax_290))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.height)) :named ax_291))
   (assert (! (not (= AVLTreeNode.valid AVLTreeNode.key)) :named ax_292))
   (assert (! (not (= AVLTreeNode.valid forkK)) :named ax_293))
   (assert (! (not (= AVLTreeNode.valid held)) :named ax_294))
   (assert (! (not (= AVLTreeNode.valid joinable)) :named ax_295))
   (assert (! (not (= AVLTreeNode@t AVLTree@t)) :named ax_296))
   (assert (! (not (= forkK AVLTree.valid)) :named ax_297))
   (assert (! (not (= forkK AVLTreeNode.balanceFactor)) :named ax_298))
   (assert (! (not (= forkK AVLTreeNode.height)) :named ax_299))
   (assert (! (not (= forkK AVLTreeNode.key)) :named ax_300))
   (assert (! (not (= forkK AVLTreeNode.valid)) :named ax_301))
   (assert (! (not (= forkK held)) :named ax_302))
   (assert (! (not (= forkK joinable)) :named ax_303))
   (assert (! (not (= held AVLTree.valid)) :named ax_304))
   (assert (! (not (= held AVLTreeNode.balanceFactor)) :named ax_305))
   (assert (! (not (= held AVLTreeNode.height)) :named ax_306))
   (assert (! (not (= held AVLTreeNode.key)) :named ax_307))
   (assert (! (not (= held AVLTreeNode.valid)) :named ax_308))
   (assert (! (not (= held forkK)) :named ax_309))
   (assert (! (not (= held joinable)) :named ax_310))
   ...
   (assert (! (not (= joinable AVLTreeNode.key)) :named ax_314))
   (assert (! (not (= joinable AVLTreeNode.valid)) :named ax_315))
   (assert (! (not (= joinable forkK)) :named ax_316))
   (assert (! (not (= joinable held)) :named ax_317))
   (assert (! (not (= methodK@_11 0)) :named ax_318))
   (assert (! (not (= perm$N perm$R)) :named ax_319))
   (assert (! (not (= perm$R perm$N)) :named ax_320))
   (assert (! (not (= Permission$denominator 0)) :named ax_321))
   (assert (! (not (= this null)) :named ax_322))
   (assert (! (not (ite$Bool$ false false false)) :named ax_323))
   (assert (! (not (ite$Bool$ false true false)) :named ax_324))
   (assert (! (not (ite$Bool$ true false false)) :named ax_325))
   (assert (! (not (ite$Bool$ true false true)) :named ax_326))
   (assert (! (or (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root) null) (= (dtype (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$ref$ Heap this AVLTree.root)) AVLTreeNode@t)) :named ax_327))
   (assert (! (PredicateField$Int$ AVLTree.valid) :named ax_328))
   (assert (! (PredicateField$Int$ AVLTreeNode.valid) :named ax_329))
   (assert (! (wf Heap Mask SecMask) :named ax_330))
   (assert (! (wf Heap Mask@0 SecMask) :named ax_331))
   (assert (! (wf Heap SecMask SecMask) :named ax_332))
   (assert (! CanAssumeFunctionDefs :named ax_333))
