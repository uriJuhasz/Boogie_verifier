...
;Axioms
   ...
   (assert (! (not (= perm$R perm$N)) :named ax_1868))
   (assert (! (not (= perm$R perm$N)) :named ax_1869))
   (assert (! (not (= Queue@t Message@t)) :named ax_1870))
   (assert (! (not (= Queue@t Message@t)) :named ax_1871))
...
(let ((anon14_Then_assertion (and
    (not (= null msg@1))
)))
(let ((anon15_Then_assertion (and
    (not (= null msg@1))
)))
(let ((anon16_Then_assertion (and
    (not (= null msg@1))
)))
...
(let ((anon16_Then (=> (and true
    (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@6 msg@1 Message.type) 4)
  )
    anon16_Then_assertion
)))
...
(let ((anon0 (=> (and true
    (< (* 1000 whereK@_18) (Fractions 1))
    (< 0 whereK@_18)
    (= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask msg@1 Message.type (MapWrite$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask msg@1 Message.type) perm$R (+ (MapRead$$@Map@@PermissionComponent@To@Int@@$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$@Map@@PermissionComponent@To@Int@@@@$Int$ ZeroMask msg@1 Message.type) perm$R) channelK))) Mask@0)
    (= (MapWrite$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap msg@1 Message.type (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ inhaleHeap@_19@0 msg@1 Message.type)) Heap@0)
    (> channelK 0)
    (IsGoodInhaleState inhaleHeap@_19@0 Heap ZeroMask)
    (IsGoodMask Mask@0)
    (IsGoodState$Int$ (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ inhaleHeap@_19@0 msg@1 Message.type))
    (not (= null msg@1))
    (not (= null msg@1))
    (wf Heap@0 Mask@0)
    (wf Heap@0 ZeroMask)
    (wf inhaleHeap@_19@0 Mask@0)
  )(and 
    anon0_assertion
    anon0@1
))))
(let ((PreconditionGeneratedEntry (=> (and true
    (IsGoodMask Mask)
    (not (= this null))
    (or (= null msg@1) (= Message@t (dtype msg@1)))
