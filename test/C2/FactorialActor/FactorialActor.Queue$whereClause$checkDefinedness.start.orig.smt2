...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      (IsGoodMask Mask)
      (not (= this null))
      (or (= msg@1 null) (= (dtype msg@1) Message@t))
...
(assert (! (=> anon16_Then (and true 
   (and true
      $@condition_$2
      (= $@condition_$2 (= (MapRead$$@Map@@$T0@@ref@Field$$T0$@To@$T0@@$Int$ Heap@6 msg@1 Message.type) 4))
