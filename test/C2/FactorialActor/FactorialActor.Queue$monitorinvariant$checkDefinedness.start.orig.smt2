...
(assert (! (=> $start (and true 
   (and true
      ...
      (= (= true $@bf_303) (ite$Bool$ true true true))
      (= (= true $@bf_304) (ite$Bool$ true true false))
      (= (= true $@bf_305) (ite$Bool$ true false true))
      (= (= true $@bf_306) (ite$Bool$ true false false))
      (= (= true $@bf_307) (ite$Bool$ false true true))
      (= (= true $@bf_308) (ite$Bool$ false true false))
      (= (= true $@bf_309) (ite$Bool$ false false true))
      (= (= true $@bf_310) (ite$Bool$ false false false))
...
(assert (! (=> PreconditionGeneratedEntry (and true 
   (and true
      (IsGoodMask Mask)
      (not (= this null))
      (or (= this null) (= (dtype this) Queue@t))
      (wf Heap Mask)
   )
anon0
