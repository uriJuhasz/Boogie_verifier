...
procedure Queue$whereClause$checkDefinedness (this : ref,msg#1 : ref)
{
	var whereK#_18 : int;
	var inhaleHeap#_19 : HeapType;
	var inhaleHeap#_19_$_0 : HeapType;
...
PreconditionGeneratedEntry:
	...
	assume (this == null) || (dtype(this) == Queue#t);
	assume (msg#1 == null) || (dtype(msg#1) == Message#t);
	assume !(this == null);
	assume wf(Heap,Mask);
	goto anon0;
anon0:
	assume (0 < whereK#_18) && ((1000 * whereK#_18) < Fractions(1));
	assume IsGoodInhaleState(inhaleHeap#_19_$_0,Heap,ZeroMask);
	assume !(msg#1 == null);
	assume !(msg#1 == null);
	assume Heap_$_0 == Heap[msg#1,Message.type := inhaleHeap#_19_$_0[msg#1,Message.type]];
	assume wf(Heap_$_0,ZeroMask);
	assume true;
	assume channelK > 0;
	assume Mask_$_0 == ZeroMask[msg#1,Message.type := ZeroMask[msg#1,Message.type][perm$R := ZeroMask[msg#1,Message.type][perm$R] + channelK]];
	assume IsGoodMask(Mask_$_0);
	assume IsGoodState(inhaleHeap#_19_$_0[msg#1,Message.type]);
	assume wf(Heap_$_0,Mask_$_0);
	assume wf(inhaleHeap#_19_$_0,Mask_$_0);
	assert { :msg "  10.3: Receiver might be null." } true ==> (!(msg#1 == null));
	assert { :msg "  10.3: Location might not be readable." } true ==> CanRead(Mask_$_0,msg#1,Message.type);
	if ($_$_condition) { goto anon13_Then; } else { goto anon13_Else; }
anon13_Then:
	assume Heap_$_0[msg#1,Message.type] == 1;
	assert { :msg "  10.19: Receiver might be null." } !(msg#1 == null);
	assume !(msg#1 == null);
	assume Heap_$_1 == Heap_$_0[msg#1,Message.invValue := inhaleHeap#_19_$_0[msg#1,Message.invValue]];
	assume wf(Heap_$_1,Mask_$_0);
	assume inhaleHeap#_19_$_0[msg#1,Message.invValue] == Heap_$_1;
	assume Fractions(100) > 0;
	assume Mask_$_1 == Mask_$_0[msg#1,Message.invValue := Mask_$_0[msg#1,Message.invValue][perm$R := Mask_$_0[msg#1,Message.invValue][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_1);
	assume IsGoodState(inhaleHeap#_19_$_0[msg#1,Message.invValue]);
	assume wf(Heap_$_1,Mask_$_1);
	assume wf(inhaleHeap#_19_$_0,Mask_$_1);
	assume Mask_$_2 == Mask_$_1;
	assume Heap_$_2 == Heap_$_1;
	goto anon3;
anon13_Else:
	assume !(Heap_$_0[msg#1,Message.type] == 1);
	assume Mask_$_2 == Mask_$_0;
	assume Heap_$_2 == Heap_$_0;
	goto anon3;
anon3:
	assert { :msg "  11.3: Receiver might be null." } true ==> (!(msg#1 == null));
	assert { :msg "  11.3: Location might not be readable." } true ==> CanRead(Mask_$_2,msg#1,Message.type);
	if ($_$_condition_$0) { goto anon14_Then; } else { goto anon14_Else; }
anon14_Then:
	assume Heap_$_2[msg#1,Message.type] == 2;
	assert { :msg "  11.19: Receiver might be null." } !(msg#1 == null);
	assume !(msg#1 == null);
	assume Heap_$_3 == Heap_$_2[msg#1,Message.invResult1 := inhaleHeap#_19_$_0[msg#1,Message.invResult1]];
	assume wf(Heap_$_3,Mask_$_2);
	assume inhaleHeap#_19_$_0[msg#1,Message.invResult1] == Heap_$_3;
	assume Fractions(100) > 0;
	assume Mask_$_3 == Mask_$_2[msg#1,Message.invResult1 := Mask_$_2[msg#1,Message.invResult1][perm$R := Mask_$_2[msg#1,Message.invResult1][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_3);
	assume IsGoodState(inhaleHeap#_19_$_0[msg#1,Message.invResult1]);
	assume wf(Heap_$_3,Mask_$_3);
	assume wf(inhaleHeap#_19_$_0,Mask_$_3);
...
anon6:
	...
	assert { :msg "  12.3: Location might not be readable." } true ==> CanRead(Mask_$_4,msg#1,Message.type);
	if ($_$_condition_$1) { goto anon15_Then; } else { goto anon15_Else; }
anon15_Then:
	assume Heap_$_4[msg#1,Message.type] == 3;
	assert { :msg "  12.19: Receiver might be null." } !(msg#1 == null);
	assume !(msg#1 == null);
	assume Heap_$_5 == Heap_$_4[msg#1,Message.invResult2 := inhaleHeap#_19_$_0[msg#1,Message.invResult2]];
	assume wf(Heap_$_5,Mask_$_4);
	assume inhaleHeap#_19_$_0[msg#1,Message.invResult2] == Heap_$_5;
	assume Fractions(100) > 0;
	assume Mask_$_5 == Mask_$_4[msg#1,Message.invResult2 := Mask_$_4[msg#1,Message.invResult2][perm$R := Mask_$_4[msg#1,Message.invResult2][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_5);
	assume IsGoodState(inhaleHeap#_19_$_0[msg#1,Message.invResult2]);
	assume wf(Heap_$_5,Mask_$_5);
	assume wf(inhaleHeap#_19_$_0,Mask_$_5);
...
anon9:
	...
	assert { :msg "  13.3: Location might not be readable." } true ==> CanRead(Mask_$_6,msg#1,Message.type);
	if ($_$_condition_$2) { goto anon16_Then; } else { goto anon16_Else; }
anon16_Then:
	assume Heap_$_6[msg#1,Message.type] == 4;
	assert { :msg "  13.19: Receiver might be null." } !(msg#1 == null);
	assume !(msg#1 == null);
	assume Heap_$_7 == Heap_$_6[msg#1,Message.invFinalResult := inhaleHeap#_19_$_0[msg#1,Message.invFinalResult]];
	assume wf(Heap_$_7,Mask_$_6);
	assume inhaleHeap#_19_$_0[msg#1,Message.invFinalResult] == Heap_$_7;
	assume Fractions(100) > 0;
	assume Mask_$_7 == Mask_$_6[msg#1,Message.invFinalResult := Mask_$_6[msg#1,Message.invFinalResult][perm$R := Mask_$_6[msg#1,Message.invFinalResult][perm$R] + Fractions(100)]];
	assume IsGoodMask(Mask_$_7);
	assume IsGoodState(inhaleHeap#_19_$_0[msg#1,Message.invFinalResult]);
	assume wf(Heap_$_7,Mask_$_7);
	assume wf(inhaleHeap#_19_$_0,Mask_$_7);
