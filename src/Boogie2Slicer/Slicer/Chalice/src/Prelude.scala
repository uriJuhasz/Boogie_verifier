...
axiom (forall<T>  s0: Seq T, s1: Seq T, s2: Seq T ::
  { Seq#Append(Seq#Append(s0, s1),s2)}
  Seq#Equal(Seq#Append(s0, Seq#Append(s1, s2)),Seq#Append(Seq#Append(s0, s1),s2))
 );
/*
axiom (forall<T>  s0: Seq T, s1: Seq T::
  { Seq#Equal(a,b)}
  Seq#Equal(a,b) ==> Seq#Equal(b,a)
 );
 */
axiom (forall<T> x : T ::
