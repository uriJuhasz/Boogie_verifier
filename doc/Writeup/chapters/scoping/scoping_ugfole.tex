...
We also perform the standard equality resolution as a simplification - eagerly replacing \m{[C]_n \lor [s]_n \neq [s]_n} with \m{[C]_n}
%,and factoring - eagerly replacing \m{[C]_n \lor [A]_n \lor [A]_n} with \m{[C]_n \lor [A]_n}
.\\
