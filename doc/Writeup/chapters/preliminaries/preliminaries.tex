...
We assume as input a program in the Boogie (\cite{BarnettCDJL05}) intermediate verification language(IVL) (or a similar IVL) that has been generated as a verification condition (VC) for some \newdef{source program} (and potentially some annotation).
